...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-7444959e><section class="ed-doc__hero" data-v-7444959e><div class="ed-doc__inner" data-v-7444959e><div class="ed-doc__eyebrow" data-v-7444959e><span class="ed-doc__eyebrow-dash" data-v-7444959e></span> LFI · API Hub · Headless Heimdall </div><h1 class="ed-doc__title" data-v-7444959e> Headless Heimdall Auth Server <span class="ed-doc__read" data-v-7444959e>2 min read</span></h1><p class="ed-doc__lede" data-v-7444959e> The <strong data-v-7444959e>Headless Heimdall Auth Server</strong> is an API provided by the API Hub that powers the consent authorisation journey. It shields your authorisation server from the complexity of raw OIDC and FAPI 2.0 — your system calls three endpoints at the appropriate points in the customer journey and the API Hub handles the rest. </p></div></section>`);
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-7444959e${_scopeId2}><thead data-v-7444959e${_scopeId2}><tr data-v-7444959e${_scopeId2}><th data-v-7444959e${_scopeId2}>Environment</th><th data-v-7444959e${_scopeId2}>URL</th></tr></thead><tbody data-v-7444959e${_scopeId2}><tr data-v-7444959e${_scopeId2}><td data-v-7444959e${_scopeId2}>Pre-production</td><td data-v-7444959e${_scopeId2}><code data-v-7444959e${_scopeId2}>https://hh.{lfiCode}.preprod.apihub.openfinance.ae</code></td></tr><tr data-v-7444959e${_scopeId2}><td data-v-7444959e${_scopeId2}>Production</td><td data-v-7444959e${_scopeId2}><code data-v-7444959e${_scopeId2}>https://hh.{lfiCode}.apihub.openfinance.ae</code></td></tr></tbody></table>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Where <code data-v-7444959e${_scopeId2}>{lfiCode}</code> is the LFI Code assigned during <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/prerequisites#lfi-code" data-v-7444959e${_scopeId2}>API Hub onboarding</a>. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` All requests to the Headless Heimdall Auth Server MUST be made using the <strong data-v-7444959e${_scopeId2}>C3-hh-cm-client</strong> application registered in the Trust Framework. This is the same client used to call the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/" data-v-7444959e${_scopeId2}>Consent Manager</a>. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Requests MUST be made over <strong data-v-7444959e${_scopeId2}>mutual TLS</strong> using the <strong data-v-7444959e${_scopeId2}>C3</strong> transport client certificate. If your API Hub is configured for <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/configuring-authentication/jwt-client" data-v-7444959e${_scopeId2}>JWT Auth</a>, you MUST also include a signed JWT in the <code data-v-7444959e${_scopeId2}>Authorization</code> header, signed with the <strong data-v-7444959e${_scopeId2}>Sig4</strong> signing key. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` See <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/connectivity/" data-v-7444959e${_scopeId2}>Connectivity &amp; Certificates</a> for the full certificate mapping, and <a href="/tech/lfi-api-hub/trust-framework/creating-c3-application" data-v-7444959e${_scopeId2}>Creating the C3-hh-cm-client Application</a> for setup instructions. `);
            } else {
              return [
                createTextVNode(" See "),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-7444959e${_scopeId2}><strong data-v-7444959e${_scopeId2}><span class="endpoint" data-v-7444959e${_scopeId2}><span class="http-method http-method--get" data-v-7444959e${_scopeId2}>GET</span><code data-v-7444959e${_scopeId2}>/auth</code></span></strong> — Your authorisation server calls this at the start of every authorisation code grant. The API Hub validates the FAPI/OIDC request and returns the interaction context and the decoded consent details. Your system uses these details to present the consent to the end user for approval. </li><li data-v-7444959e${_scopeId2}><strong data-v-7444959e${_scopeId2}><span class="endpoint" data-v-7444959e${_scopeId2}><span class="http-method http-method--post" data-v-7444959e${_scopeId2}>POST</span><code data-v-7444959e${_scopeId2}>/auth/{interactionId}/doConfirm</code></span></strong> — After the end user has authenticated and authorised the consent, your system calls this to complete the interaction. The API Hub updates the consent state and issues tokens to the TPP. </li><li data-v-7444959e${_scopeId2}><strong data-v-7444959e${_scopeId2}><span class="endpoint" data-v-7444959e${_scopeId2}><span class="http-method http-method--post" data-v-7444959e${_scopeId2}>POST</span><code data-v-7444959e${_scopeId2}>/auth/{interactionId}/doFail</code></span></strong> — If authentication fails or the end user rejects the consent, your system calls this to end the interaction. The API Hub initiates an error redirect back to the TPP. </li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-7444959e${_scopeId2}> During the authorisation journey, your system will typically also call the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/" data-v-7444959e${_scopeId2}>Consent Manager</a> to read the full consent object and update its state. Both APIs work together to complete the journey. </p>`);
            } else {
              return [
                createVNode("p", null, [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For the full API flow, see the <a href="/tech/lfi-api-hub/v2.2-rc1/consent-journey/api-guide" data-v-7444959e${_scopeId2}>Consent Journey API Guide</a>. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The full API reference for each endpoint is available in the sidebar under <strong data-v-7444959e${_scopeId2}>API Reference</strong>. Use <span class="endpoint" data-v-7444959e${_scopeId2}><span class="http-method http-method--get" data-v-7444959e${_scopeId2}>GET</span><code data-v-7444959e${_scopeId2}>/hello-mtls</code></span> to verify your mTLS connectivity before calling other endpoints. `);
            } else {
              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-7444959e"]]);
export {
  index as default
};
