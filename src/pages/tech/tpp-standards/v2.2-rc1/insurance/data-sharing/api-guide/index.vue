  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdNote type="tip" title="User Experience">
        <p>
          See <a href="/tech/tpp-standards/v2.2-rc1/insurance/data-sharing/user-journeys">User Experience</a>
    ...
    >
      ...
      <EdProse>
        ...
        every sector under
        <a href="/tech/tpp-standards/v2.2-rc1/insurance/data-sharing/">Insurance Data Sharing</a>.
      </EdProse>
    </EdSectionBand>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>ReadInsurancePremium</code></td><td>The <code>Premium</code> field. Returned as a JWE that the customer device decrypts &mdash; see <a href="/tech/tpp-standards/v2.2-rc1/insurance/data-sharing/api-guide/premiums">Encrypted Premiums</a>.</td></tr>
          </tbody>
        </table>
      </EdRefTable>
