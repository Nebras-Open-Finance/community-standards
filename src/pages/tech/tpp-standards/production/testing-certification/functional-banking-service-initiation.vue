<route lang="yaml">
meta:
  title: Functional Evidence — Banking Service Initiation
</route>
    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <h1 class="ed-doc__title">
          Functional Evidence &mdash; Banking Service Initiation
        </h1>
        <p class="ed-doc__lede">
          Documented evidence that your payment initiation proposition calls only the APIs it needs,
          requests only the minimum permissions required, and handles consent and payment states
          correctly.
        </p>
      </div>
    </section>
