...
import { W as WireframePreview, A as AccountSetup, U as UIBehaviour, E as ExampleJourneys } from "./ExampleJourneys-C79qQqaO.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-4634d432><section class="ed-doc__hero" data-v-4634d432><div class="ed-doc__inner" data-v-4634d432><div class="ed-doc__eyebrow" data-v-4634d432><span class="ed-doc__eyebrow-dash" data-v-4634d432></span> Banking · Data Sharing · UX </div><h1 class="ed-doc__title" data-v-4634d432> Bank Data Sharing — User Experience <span class="ed-doc__read" data-v-4634d432>2 min read</span></h1><p class="ed-doc__lede" data-v-4634d432> When a customer is redirected to you to authorize an Open Finance consent for data sharing, you must present an <strong data-v-4634d432>Authorization Page</strong> that clearly explains what the customer is authorizing. The page must collect the customer&#39;s explicit and informed consent, and it must accurately reflect the scope and nature of the data being shared. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-4634d432> The examples and interactive wireframes provided below define the expected structure, content, and behavior of the Authorization Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-4634d432> While you may adapt visual elements such as color palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the consent content. The representation of <strong data-v-4634d432>AlTareq</strong> (including logos, naming, and action buttons) must be preserved at all times. Your Authorization Page must be submitted as part of <strong data-v-4634d432>CX certification</strong> prior to production. Any material changes to a production Authorization Page must also be resubmitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the <code data-v-4634d432${_scopeId2}>consentBody</code> object below and watch the wireframes above update live. Try changing permissions, account types, date ranges, or the TPP name to see how the pages respond, or pick one of the scenarios beside the editor to load a preset consent. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/banking/data-sharing/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4634d432"]]);
export {
