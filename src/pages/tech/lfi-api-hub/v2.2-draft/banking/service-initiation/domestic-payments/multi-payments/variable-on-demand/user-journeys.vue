...
import WireframePreview from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/variable-on-demand/_shared/WireframePreview.vue'
import AccountSetup from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/variable-on-demand/_shared/AccountSetup.vue'
import UIBehaviour from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/variable-on-demand/_shared/UIBehaviour.vue'
import ExampleJourneys from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/variable-on-demand/_shared/ExampleJourneys.vue'
...
const myCustomValidator = (value) => {
  ...
  if (
    ...
    value?.Data?.ControlParameters?.ConsentSchedule?.MultiPayment?.PeriodicSchedule?.Type !== 'VariableOnDemand' ||
  ...
  if (
    !value?.Data?.ControlParameters?.ConsentSchedule?.MultiPayment?.PeriodicSchedule?.Controls?.MaximumIndividualAmount &&
    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          When a customer is redirected to you to authorize a Variable On Demand payment consent through Open
          Finance, you must present an <strong>Authorization Page</strong> that clearly explains the payment
          the customer is authorizing &mdash; that multiple payments of varying amounts will be made at any
          time of the TPP's choosing. The page must collect the customer's explicit and informed consent, and
          it must accurately reflect the key details of the consent (payee, the maximum amount per individual
          payment, etc.)
        </p>
