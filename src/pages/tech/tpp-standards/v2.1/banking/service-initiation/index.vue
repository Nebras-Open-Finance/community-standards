...
const sectionEndpoints = allEndpoints.filter(
  (e) => e.surface === 'standards' && e.sectionSlug === 'service-initiation',
)
</script>
    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
          ...
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/banking/service-initiation/refunds/" :style="{ '--card-color': 'var(--at-teal)' }">
            <span class="ed-link-card__top" />
            <div class="ed-link-card__meta"><span class="ed-link-card__cat">Sub-section</span></div>
            <h3 class="ed-link-card__title">Refunds</h3>
            <p class="ed-link-card__desc">Refund initiation against a previously-executed payment consent.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/" :style="{ '--card-color': 'var(--at-navy)' }">
            <span class="ed-link-card__top" />
            <div class="ed-link-card__meta"><span class="ed-link-card__cat">Sub-section</span></div>
            <h3 class="ed-link-card__title">Personal Identifiable Information</h3>
            <p class="ed-link-card__desc">How creditor and debtor PII is presented and validated across payment consents.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/banking/service-initiation/multi-authorization" :style="{ '--card-color': '#5b21b6' }">
            <span class="ed-link-card__top" />
            ...
            <p class="ed-link-card__desc">Subsequent-authoriser flows for payments requiring approval from more than one PSU.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
