...
const servers = [
  ...
  {
    organisationId: "8c21e663-1d34-45cd-91fa-86d7c2d240f4",
    organisationName: "National Bank of Fujairah PJSC",
    legalEntityName: "National Bank of Fujairah PJSC",
    sector: "bank",
    authorisationServerId: "f2682d3e-4a40-4891-8947-001665855734",
    customerFriendlyName: "National Bank of Fujairah",
    customerFriendlyDescription: "NBF Production Auth Server",
    logoUri: "https://data.directory.openfinance.ae/logos/8c21e663-1d34-45cd-91fa-86d7c2d240f4/authorisationservers/f2682d3e-4a40-4891-8947-001665855734.png",
    issuer: "https://auth1.nbfrt.apihub.openfinance.ae",
    discoveryUri: "https://auth1.nbfrt.apihub.openfinance.ae/.well-known/openid-configuration",
    lfiCode: "nbfrt",
    accountTypes: [
      "Retail"
    ],
    ...
    authorizationEndpoint: "https://auth.nbf.ae",
    parEndpoint: "https://as1.nbfrt.apihub.openfinance.ae/par",
    tokenEndpoint: "https://as1.nbfrt.apihub.openfinance.ae/token",
    verification: {
      origin: "https://auth.nbf.ae",
      android: {
        url: "https://auth.nbf.ae/.well-known/assetlinks.json",
        status: null,
        contentType: null,
        jsonValid: false,
        verdict: "fail",
      ...
      ios: {
        url: "https://auth.nbf.ae/.well-known/apple-app-site-association",
        status: null,
        contentType: null,
        jsonValid: false,
        verdict: "fail",
      ...
      huawei: {
        url: "https://auth.nbf.ae/.well-known/applinking.json",
        status: null,
        contentType: null,
        jsonValid: false,
        verdict: "fail",
