...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-ef9d0682><section class="ed-doc__hero" data-v-ef9d0682><div class="ed-doc__inner" data-v-ef9d0682><div class="ed-doc__eyebrow" data-v-ef9d0682><span class="ed-doc__eyebrow-dash" data-v-ef9d0682></span> LFI · API Hub · Onboarding · Environment-Specific </div><h1 class="ed-doc__title" data-v-ef9d0682> Certificate Walkthroughs <span class="ed-doc__read" data-v-ef9d0682>4 min read</span></h1><p class="ed-doc__lede" data-v-ef9d0682> This page provides step-by-step walkthroughs for creating certificates required during <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/" data-v-ef9d0682>environment-specific onboarding</a>. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-ef9d0682>Two representative examples are covered:</p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ef9d0682${_scopeId2}><strong data-v-ef9d0682${_scopeId2}>S1</strong> — an Ozone-held certificate where the LFI uploads a CSR provided by Ozone</li><li data-v-ef9d0682${_scopeId2}><strong data-v-ef9d0682${_scopeId2}>S4</strong> — an LFI-held certificate where the LFI generates the key, CSR, and certificate</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The same patterns apply to the other certificates listed in the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/" data-v-ef9d0682${_scopeId2}>Environment Specific Configuration</a> — refer to that page to determine which process applies to each certificate. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-ef9d0682${_scopeId2}>S1</strong> identifies the LFI&#39;s API Hub instance to TPPs. Ozone holds the private key and generates the CSR. The LFI uploads the CSR to their Trust Framework organisation to generate the certificate. `);
                } else {
                  return [
                    createVNode("strong", null, "S1"),
            ...
            _push2(`<h3 data-v-ef9d0682${_scopeId}>Prerequisites</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ef9d0682${_scopeId2}>You have received the S1 CSR file from Ozone (provided via the Service Desk ticket).</li><li data-v-ef9d0682${_scopeId2}> You are signed in to the correct Trust Framework directory: <ul data-v-ef9d0682${_scopeId2}><li data-v-ef9d0682${_scopeId2}><strong data-v-ef9d0682${_scopeId2}>Pre-production</strong> → Sandbox Trust Framework (<code data-v-ef9d0682${_scopeId2}>web.sandbox.directory.openfinance.ae</code>)</li><li data-v-ef9d0682${_scopeId2}><strong data-v-ef9d0682${_scopeId2}>Production</strong> → Production Trust Framework (<code data-v-ef9d0682${_scopeId2}>web.directory.openfinance.ae</code>)</li></ul></li>`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-ef9d0682${_scopeId}>Steps</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ef9d0682${_scopeId2}>Navigate to your <strong data-v-ef9d0682${_scopeId2}>Organisation</strong> in the Trust Framework.</li><li data-v-ef9d0682${_scopeId2}>Open the <strong data-v-ef9d0682${_scopeId2}>Organisation Certificates</strong> section.</li><li data-v-ef9d0682${_scopeId2}>Click <strong data-v-ef9d0682${_scopeId2}>+ New Certificate</strong>.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ef9d0682${_scopeId2}>Select <strong data-v-ef9d0682${_scopeId2}>OPF UAE SERVER TRANSPORT</strong> as the certificate type.</li><li data-v-ef9d0682${_scopeId2}>Set the description to <strong data-v-ef9d0682${_scopeId2}>S1 - Ozone holds Private Key - TPP-APIHub</strong></li><li data-v-ef9d0682${_scopeId2}>Skip the step to generate the private key and CSR.</li><li data-v-ef9d0682${_scopeId2}>Upload the CSR provided by Ozone.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ef9d0682${_scopeId2}> The Trust Framework will generate the certificate. Once complete, the certificate detail page will display: <ul data-v-ef9d0682${_scopeId2}><li data-v-ef9d0682${_scopeId2}>The <strong data-v-ef9d0682${_scopeId2}>Key ID (KID)</strong> — copy this value exactly as shown (it is case-sensitive).</li><li data-v-ef9d0682${_scopeId2}>The <strong data-v-ef9d0682${_scopeId2}>JWKS URL</strong> — this is your organisation&#39;s transport JWKS URL.</li></ul></li><li data-v-ef9d0682${_scopeId2}>Provide the <strong data-v-ef9d0682${_scopeId2}>KID</strong> and <strong data-v-ef9d0682${_scopeId2}>JWKS URL</strong> back to Ozone via the Service Desk ticket.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ef9d0682${_scopeId2}>Your organisation&#39;s transport JWKS URL follows this pattern:</p>`);
                  _push3(ssrRenderComponent(_component_EdCode, {
                    lang: "text",
                    code: jwksUrlTemplate
                  }, null, _parent3, _scopeId2));
                  _push3(`<p data-v-ef9d0682${_scopeId2}>You can also find it on the Organisation Certificates page in the Trust Framework.</p>`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-ef9d0682${_scopeId}>What happens next</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-ef9d0682${_scopeId2}>S4</strong> identifies the LFI&#39;s Ozone Connect server to the API Hub. The LFI holds the private key and is responsible for generating the key, CSR, and certificate. `);
                } else {
                  return [
                    createVNode("strong", null, "S4"),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ef9d0682${_scopeId2}>You have your organisation&#39;s <strong data-v-ef9d0682${_scopeId2}>Legal Name</strong> and <strong data-v-ef9d0682${_scopeId2}>Organisation ID</strong> from the Trust Framework.</li><li data-v-ef9d0682${_scopeId2}> You are signed in to the correct Trust Framework directory: <ul data-v-ef9d0682${_scopeId2}><li data-v-ef9d0682${_scopeId2}><strong data-v-ef9d0682${_scopeId2}>Pre-production</strong> → Sandbox Trust Framework (<code data-v-ef9d0682${_scopeId2}>web.sandbox.directory.openfinance.ae</code>)</li><li data-v-ef9d0682${_scopeId2}><strong data-v-ef9d0682${_scopeId2}>Production</strong> → Production Trust Framework (<code data-v-ef9d0682${_scopeId2}>web.directory.openfinance.ae</code>)</li></ul></li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 data-v-ef9d0682${_scopeId}>Step 1 — Generate the private key and CSR</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ef9d0682${_scopeId2}><code data-v-ef9d0682${_scopeId2}>&lt;LegalName&gt;</code> with your organisation&#39;s legal name as it appears in the Trust Framework</li><li data-v-ef9d0682${_scopeId2}><code data-v-ef9d0682${_scopeId2}>&lt;OrganisationId&gt;</code> with your organisation&#39;s ID from the Trust Framework</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ef9d0682${_scopeId2}> The OpenSSL command shown is for demonstration. In production, private key generation and CSR creation MUST be performed within your HSM or equivalent secure key management infrastructure, in accordance with your institution&#39;s security policies. </p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Store the <code data-v-ef9d0682${_scopeId2}>.key</code> file securely — it MUST never be shared. See <a href="/policy/secure-management" data-v-ef9d0682${_scopeId2}>Secure Management</a> for requirements. `);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-ef9d0682${_scopeId}>Step 2 — Upload the CSR to the Trust Framework</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ef9d0682${_scopeId2}>Navigate to your <strong data-v-ef9d0682${_scopeId2}>Organisation</strong> in the Trust Framework.</li><li data-v-ef9d0682${_scopeId2}>Open the <strong data-v-ef9d0682${_scopeId2}>Organisation Certificates</strong> section.</li><li data-v-ef9d0682${_scopeId2}>Click <strong data-v-ef9d0682${_scopeId2}>+ New Certificate</strong>.</li>`);
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ef9d0682${_scopeId2}>Select <strong data-v-ef9d0682${_scopeId2}>OPF UAE SERVER TRANSPORT</strong> as the certificate type.</li><li data-v-ef9d0682${_scopeId2}>Set the description to <strong data-v-ef9d0682${_scopeId2}>S4 - I hold Private Key - APIHub-OzoneConnect</strong></li><li data-v-ef9d0682${_scopeId2}>Click <strong data-v-ef9d0682${_scopeId2}>Next</strong>.</li><li data-v-ef9d0682${_scopeId2}>Upload the <code data-v-ef9d0682${_scopeId2}>.csr</code> file generated in Step 1.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      createTextVNode("Select "),
            ...
            _push2(`<h3 data-v-ef9d0682${_scopeId}>Step 3 — Record the KID and JWKS URL</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ef9d0682${_scopeId2}>The certificate detail page will display the <strong data-v-ef9d0682${_scopeId2}>Key ID (KID)</strong> — copy this value exactly (case-sensitive).</li><li data-v-ef9d0682${_scopeId2}>Note your organisation&#39;s <strong data-v-ef9d0682${_scopeId2}>transport JWKS URL</strong>.</li><li data-v-ef9d0682${_scopeId2}>Provide the <strong data-v-ef9d0682${_scopeId2}>KID</strong> and <strong data-v-ef9d0682${_scopeId2}>JWKS URL</strong> to Ozone via the Service Desk ticket.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 data-v-ef9d0682${_scopeId}>Step 4 — Deploy the certificate</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Deploy the certificate (<code data-v-ef9d0682${_scopeId2}>.pem</code>) and private key (<code data-v-ef9d0682${_scopeId2}>.key</code>) to your Ozone Connect server infrastructure. The API Hub will validate this certificate during mTLS connections to your Ozone Connect endpoints. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` For detailed guidance on generating keys and certificates in the Trust Framework, see <a href="/tech/lfi-api-hub/trust-framework/certificates/" data-v-ef9d0682${_scopeId2}>Keys &amp; Certificates</a>. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/certificate-walkthroughs.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const certificateWalkthroughs = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ef9d0682"]]);
export {
