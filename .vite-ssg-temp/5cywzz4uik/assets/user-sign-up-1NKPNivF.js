...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-f051fb0e><section class="ed-doc__hero" data-v-f051fb0e><div class="ed-doc__inner" data-v-f051fb0e><div class="ed-doc__eyebrow" data-v-f051fb0e><span class="ed-doc__eyebrow-dash" data-v-f051fb0e></span> TPP · Trust Framework · Onboarding </div><h1 class="ed-doc__title" data-v-f051fb0e> Sign Up <span class="ed-doc__read" data-v-f051fb0e>2 min read</span></h1><p class="ed-doc__lede" data-v-f051fb0e> This guide walks through the steps a newly invited Organisation Admin or User must complete after receiving an invitation to the Trust Framework platform. </p></div></section>`);
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<ol class="ed-doc__steps" data-v-f051fb0e${_scopeId}><li data-v-f051fb0e${_scopeId}><h3 data-v-f051fb0e${_scopeId}>Receive Onboarding Email</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Once you have been invited, you will receive an email from the <strong data-v-f051fb0e${_scopeId2}>Al Tareq Trust Framework Sandbox</strong>. This email contains a registration link — keep it to hand before proceeding. `);
            } else {
              return [
        ...
        _push2(`</li><li data-v-f051fb0e${_scopeId}><h3 data-v-f051fb0e${_scopeId}>Open the Registration Link</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(`</li><li data-v-f051fb0e${_scopeId}><h3 data-v-f051fb0e${_scopeId}>Access the Sign-In Page</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` You will be redirected to the Trust Framework Sandbox sign-in page. Click <strong data-v-f051fb0e${_scopeId2}>Registration</strong> to begin the registration process. `);
            } else {
              return [
        ...
        _push2(`</li><li data-v-f051fb0e${_scopeId}><h3 data-v-f051fb0e${_scopeId}>Complete Registration</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdNote, { type: "warning" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-f051fb0e${_scopeId2}> Make sure the email address you register with exactly matches the email address you were invited with. </p>`);
            } else {
              return [
        ...
        _push2(`</li><li data-v-f051fb0e${_scopeId}><h3 data-v-f051fb0e${_scopeId}>Set Up Two-Factor Authentication</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Scan the QR code displayed on screen using <strong data-v-f051fb0e${_scopeId2}>Google Authenticator</strong> or another authenticator app of your choice. Enter the one-time code generated by the app to complete the setup. `);
            } else {
              return [
        ...
        _push2(`</li><li data-v-f051fb0e${_scopeId}><h3 data-v-f051fb0e${_scopeId}>Accept Terms of Acceptance</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` After successful registration, you will receive another email at your registered email address requesting you to review and accept the <strong data-v-f051fb0e${_scopeId2}>Terms of Acceptance</strong> from the Al Tareq Platform. `);
            } else {
              return [
        ...
        _push2(`</li><li data-v-f051fb0e${_scopeId}><h3 data-v-f051fb0e${_scopeId}>Review and Sign the Document</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(`</li><li data-v-f051fb0e${_scopeId}><h3 data-v-f051fb0e${_scopeId}>Check Your Request Status</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Return to the <a href="https://web.sandbox.directory.openfinance.ae/" data-v-f051fb0e${_scopeId2}>Trust Framework Sandbox portal</a> and check the status of your registration request. `);
            } else {
              return [
        ...
        _push2(`</li><li data-v-f051fb0e${_scopeId}><h3 data-v-f051fb0e${_scopeId}>Log In to the Platform</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/trust-framework/user-sign-up.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userSignUp = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-f051fb0e"]]);
export {
