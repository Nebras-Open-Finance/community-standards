...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-kb" }, _attrs))} data-v-e93bd306><section class="ed-kb-hero" data-v-e93bd306><div class="ed-kb-hero__inner" data-v-e93bd306><div class="ed-kb-hero__label" data-v-e93bd306><span class="ed-kb-hero__label-dash" data-v-e93bd306></span> Govern · Operate · Evolve </div><h1 class="ed-kb-hero__title" data-v-e93bd306>Policies</h1><p class="ed-kb-hero__sub" data-v-e93bd306> Governance and operational policies for participants in the UAE Open Finance ecosystem — Licensed Financial Institutions, Third-Party Providers, and the technology service providers that support them. </p><div class="ed-kb-search" data-v-e93bd306><svg class="ed-kb-search__icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e93bd306><circle cx="11" cy="11" r="8" data-v-e93bd306></circle><path d="m21 21-4.35-4.35" data-v-e93bd306></path></svg><input${ssrRenderAttr("value", unref(query))} class="ed-kb-search__input" type="search" placeholder="Search policies…" aria-label="Search policies" data-v-e93bd306>`);
      if (unref(query)) {
        _push(`<button class="ed-kb-search__clear" aria-label="Clear search" data-v-e93bd306>×</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></section><section class="ed-kb-filter" data-v-e93bd306><div class="ed-kb-filter__inner" data-v-e93bd306><!--[-->`);
      ssrRenderList(unref(categories), (cat) => {
        _push(`<button class="${ssrRenderClass([{ "ed-kb-chip--active": unref(activeCategory) === cat.id }, "ed-kb-chip"])}" style="${ssrRenderStyle(unref(activeCategory) === cat.id ? { background: cat.color, borderColor: cat.color, color: "var(--at-bg-cream)" } : { borderColor: "var(--at-grid-line)", color: "var(--at-navy)" })}" data-v-e93bd306>${ssrInterpolate(cat.label)} · ${ssrInterpolate(cat.count)}</button>`);
      });
      _push(`<!--]--></div></section><section class="ed-kb-articles" data-v-e93bd306><div class="ed-kb-articles__inner" data-v-e93bd306><div class="ed-kb-count" style="${ssrRenderStyle({ color: unref(activeColor) })}" data-v-e93bd306>${ssrInterpolate(unref(filteredPolicies).length)} ${ssrInterpolate(unref(filteredPolicies).length === 1 ? "Policy" : "Policies")} `);
      if (unref(query)) {
      ...
      if (unref(filteredPolicies).length > 0) {
        _push(`<div class="ed-kb-grid" data-v-e93bd306><!--[-->`);
        ssrRenderList(unref(filteredPolicies), (policy) => {
          _push(`<a${ssrRenderAttr("href", policy.url)} class="ed-kb-card" style="${ssrRenderStyle({ "--kb-card-color": colorFor(policy.category) })}" data-v-e93bd306><span class="ed-kb-card__top" style="${ssrRenderStyle({ background: colorFor(policy.category) })}" data-v-e93bd306></span><div class="ed-kb-card__meta" data-v-e93bd306><span class="ed-kb-card__cat" style="${ssrRenderStyle({ color: colorFor(policy.category) })}" data-v-e93bd306>${ssrInterpolate(policy.category || "Uncategorised")}</span>`);
          if (policy.readTime) {
            _push(`<span class="ed-kb-card__dot" data-v-e93bd306>·</span>`);
          } else {
            _push(`<!---->`);
          }
          if (policy.readTime) {
            _push(`<span class="ed-kb-card__read" data-v-e93bd306>${ssrInterpolate(policy.readTime)}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div><h3 class="ed-kb-card__title" data-v-e93bd306>${ssrInterpolate(policy.title)}</h3><p class="ed-kb-card__desc" data-v-e93bd306>${ssrInterpolate(policy.purpose)}</p>`);
          if (policy.appliesToShort && policy.appliesToShort.length) {
            _push(`<div class="ed-kb-card__tags" data-v-e93bd306><!--[-->`);
            ssrRenderList(policy.appliesToShort, (tag) => {
              ...
              })}" data-v-e93bd306>${ssrInterpolate(tag)}</span>`);
            });
            _push(`<!--]--></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="ed-kb-card__foot" data-v-e93bd306>`);
          if (policy.updated) {
            _push(`<span class="ed-kb-card__updated" data-v-e93bd306> Updated ${ssrInterpolate(formatUpdated(policy.updated))}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<span class="ed-kb-card__arrow" style="${ssrRenderStyle({ color: colorFor(policy.category) })}" data-v-e93bd306>→</span></div></a>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<div class="ed-kb-empty" data-v-e93bd306><div class="ed-kb-empty__icon" data-v-e93bd306>⌕</div><h3 class="ed-kb-empty__title" data-v-e93bd306>No policies found</h3><p class="ed-kb-empty__sub" data-v-e93bd306>`);
        if (unref(query)) {
          _push(`<!--[-->No matches for <strong data-v-e93bd306>&quot;${ssrInterpolate(unref(query))}&quot;</strong>. <!--]-->`);
        } else {
          _push(`<!---->`);
        }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e93bd306"]]);
export {
  index as default
};
