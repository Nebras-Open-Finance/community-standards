...
<template>
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        <li><strong>Yes &mdash; CAAP.</strong> When a TPP creates a consent, the end user is redirected to CAAP for authentication and consent approval, and CAAP delivers the Consent Management Interface. You do not provide an Authorization Endpoint URL, and you do not implement the LFI-side Consent Management Interface or build directly against Headless Heimdall. You MUST implement the CAAP Operations endpoints on Ozone Connect &mdash; see <a href="/tech/lfi-api-hub/v2.2-rc1/caap/">CAAP</a>.</li>
        <li><strong>No &mdash; LFI-operated.</strong> The end user is redirected to your <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/auth-endpoint">Authorization Endpoint</a>; you implement the <a href="/tech/lfi-api-hub/v2.2-rc1/consent-journey/authentication">authentication and consent authorisation</a> UX and the <a href="/tech/lfi-api-hub/v2.2-rc1/consent-management-interface/">Consent Management Interface</a> yourself.</li>
      </EdBullets>
    ...
    >
      ...
      <EdProse>
        ...
        See
        <a href="/tech/lfi-api-hub/v2.2-rc1/health-check/">Ozone Connect &mdash; Health Check</a>
    ...
    >
      ...
      <EdProse>
        See
        <a href="/tech/lfi-api-hub/v2.2-rc1/consent-events/">Consent Events &amp; Actions</a>
        for details.
      </EdProse>
