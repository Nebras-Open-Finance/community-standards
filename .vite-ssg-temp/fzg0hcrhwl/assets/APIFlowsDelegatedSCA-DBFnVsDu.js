...
`;
const _sfc_main = {
  __name: "APIFlowsDelegatedSCA",
  __ssrInlineRender: true,
  setup(__props) {
    useMermaidDiagram(mermaidDefinition, "delegated-sca-diagram");
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/common/api-flows/APIFlowsDelegatedSCA.vue");
