...
import { _ as _sfc_main$1, a as _sfc_main$2 } from "./APIFlowsConnectivityCertificates-D7XW0Vva.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-3e317908><section class="ed-doc__hero" data-v-3e317908><div class="ed-doc__inner" data-v-3e317908><div class="ed-doc__eyebrow" data-v-3e317908><span class="ed-doc__eyebrow-dash" data-v-3e317908></span> LFI · API Hub · Connectivity </div><h1 class="ed-doc__title" data-v-3e317908> API Hub Connectivity &amp; Certificates <span class="ed-doc__read" data-v-3e317908>5 min read</span></h1><p class="ed-doc__lede" data-v-3e317908> This page describes the network architecture of the API Hub and the certificates that secure communication between all parties in the ecosystem. </p></div></section>`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` All connections between the API Hub and external parties use <strong data-v-3e317908${_scopeId2}>mutual TLS (mTLS)</strong>. Each certificate has a specific role in securing a particular connection path. The certificates are created and stored within the Trust Framework, and the private keys are held by the party responsible for that connection. `);
            } else {
              return [
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h3 data-v-3e317908${_scopeId}>TPP to API Hub</h3>`);
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-3e317908${_scopeId2}><thead data-v-3e317908${_scopeId2}><tr data-v-3e317908${_scopeId2}><th data-v-3e317908${_scopeId2}>Connection</th><th data-v-3e317908${_scopeId2}>Certificate</th><th data-v-3e317908${_scopeId2}>Description</th></tr></thead><tbody data-v-3e317908${_scopeId2}><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>TPP → API Hub</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>C1</strong> (TPP client cert)</td><td data-v-3e317908${_scopeId2}>The TPP presents its client certificate to identify itself to the API Hub.</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>API Hub → TPP</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>S1</strong> (API Hub server cert)</td><td data-v-3e317908${_scopeId2}>The API Hub presents this server certificate to identify the LFI&#39;s API Hub instance to the TPP.</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>Request signing</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig1</strong></td><td data-v-3e317908${_scopeId2}>The TPP signs request JWTs (e.g. PAR request objects and <code data-v-3e317908${_scopeId2}>private_key_jwt</code> client assertions) sent to the API Hub. The API Hub verifies using the public key in the TPP&#39;s JWKS.</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>Response signing</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig2</strong></td><td data-v-3e317908${_scopeId2}>The API Hub signs responses and <code data-v-3e317908${_scopeId2}>id_token</code> payloads sent to the TPP. The TPP verifies using the public key in the JWKS.</td></tr></tbody></table>`);
            } else {
              return [
        ...
        _push2(`<h3 data-v-3e317908${_scopeId}>API Hub to LFI (Ozone Connect)</h3>`);
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-3e317908${_scopeId2}><thead data-v-3e317908${_scopeId2}><tr data-v-3e317908${_scopeId2}><th data-v-3e317908${_scopeId2}>Connection</th><th data-v-3e317908${_scopeId2}>Certificate</th><th data-v-3e317908${_scopeId2}>Description</th></tr></thead><tbody data-v-3e317908${_scopeId2}><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>API Hub → LFI</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>C4</strong> (API Hub client cert)</td><td data-v-3e317908${_scopeId2}>The API Hub presents this client certificate when calling the LFI&#39;s Ozone Connect endpoints.</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>LFI → API Hub</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>S4</strong> (LFI server cert)</td><td data-v-3e317908${_scopeId2}>The LFI&#39;s Ozone Connect server presents this certificate to identify itself to the API Hub.</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>Request signing (JWT Auth)</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig3</strong></td><td data-v-3e317908${_scopeId2}> The API Hub signs JWT Auth headers on Ozone Connect requests. Only applicable when <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/application-layer-auth#jwt-auth" data-v-3e317908${_scopeId2}>JWT Auth</a> is selected. </td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>Response signing (JWT Auth)</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig4</strong></td><td data-v-3e317908${_scopeId2}>The LFI signs JWT Auth headers on Ozone Connect responses. Only applicable when JWT Auth is selected.</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
        ...
        _push2(`<h3 data-v-3e317908${_scopeId}>LFI to API Hub (Consent Manager &amp; Headless Heimdall)</h3>`);
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-3e317908${_scopeId2}><thead data-v-3e317908${_scopeId2}><tr data-v-3e317908${_scopeId2}><th data-v-3e317908${_scopeId2}>Connection</th><th data-v-3e317908${_scopeId2}>Certificate</th><th data-v-3e317908${_scopeId2}>Description</th></tr></thead><tbody data-v-3e317908${_scopeId2}><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>LFI → API Hub</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>C3</strong> (LFI client cert)</td><td data-v-3e317908${_scopeId2}>The LFI presents this client certificate when calling the Consent Manager and Headless Heimdall Auth Server.</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>API Hub → LFI</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>S3</strong> (API Hub server cert)</td><td data-v-3e317908${_scopeId2}>The Consent Manager and Headless Heimdall servers present this certificate to identify themselves to the LFI.</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>Request signing (JWT Auth)</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig4</strong></td><td data-v-3e317908${_scopeId2}>The LFI signs JWT Auth headers on requests to the Consent Manager and Headless Heimdall. Only applicable when JWT Auth is selected.</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}>Response signing (JWT Auth)</td><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig3</strong></td><td data-v-3e317908${_scopeId2}>The API Hub signs JWT Auth headers on Consent Manager and Headless Heimdall responses. Only applicable when JWT Auth is selected.</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Payload encryption is separate from transport: <strong data-v-3e317908${_scopeId2}>Enc1</strong> and <strong data-v-3e317908${_scopeId2}>Enc2</strong> are JWE keys applied to the message body, not to the TLS connection. The sequence below shows how each one is used. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-3e317908${_scopeId2}><thead data-v-3e317908${_scopeId2}><tr data-v-3e317908${_scopeId2}><th data-v-3e317908${_scopeId2}>Certificate</th><th data-v-3e317908${_scopeId2}>Description</th></tr></thead><tbody data-v-3e317908${_scopeId2}><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Enc1</strong> (LFI encryption key)</td><td data-v-3e317908${_scopeId2}>Used by the TPP to encrypt Personally Identifiable Information (PII) sent via the API Hub. Only the LFI can decrypt this data using its private key.</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Enc2</strong> (TPP encryption key)</td><td data-v-3e317908${_scopeId2}>Used by the API Hub to encrypt webhook event payloads sent to the TPP. Only the TPP can decrypt using its private key.</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-3e317908${_scopeId2}><thead data-v-3e317908${_scopeId2}><tr data-v-3e317908${_scopeId2}><th data-v-3e317908${_scopeId2}>Certificate</th><th data-v-3e317908${_scopeId2}>Type</th><th data-v-3e317908${_scopeId2}>Private Key Held By</th><th data-v-3e317908${_scopeId2}>Trust Framework Location</th><th data-v-3e317908${_scopeId2}>Purpose</th></tr></thead><tbody data-v-3e317908${_scopeId2}><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>S1</strong></td><td data-v-3e317908${_scopeId2}>Server Transport</td><td data-v-3e317908${_scopeId2}>Ozone</td><td data-v-3e317908${_scopeId2}>LFI&#39;s organisation</td><td data-v-3e317908${_scopeId2}>Identifies the LFI&#39;s API Hub instance to TPPs</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>S3</strong></td><td data-v-3e317908${_scopeId2}>Server Transport</td><td data-v-3e317908${_scopeId2}>Ozone</td><td data-v-3e317908${_scopeId2}>LFI&#39;s organisation</td><td data-v-3e317908${_scopeId2}>Identifies the CM &amp; HH servers to the LFI</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>S4</strong></td><td data-v-3e317908${_scopeId2}>Server Transport</td><td data-v-3e317908${_scopeId2}>LFI</td><td data-v-3e317908${_scopeId2}>LFI&#39;s organisation</td><td data-v-3e317908${_scopeId2}>Identifies the LFI&#39;s Ozone Connect server to the API Hub</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>C1</strong></td><td data-v-3e317908${_scopeId2}>Client Transport</td><td data-v-3e317908${_scopeId2}>TPP</td><td data-v-3e317908${_scopeId2}>TPP&#39;s organisation</td><td data-v-3e317908${_scopeId2}>Identifies the TPP when calling the API Hub</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>C3</strong></td><td data-v-3e317908${_scopeId2}>Client Transport</td><td data-v-3e317908${_scopeId2}>LFI</td><td data-v-3e317908${_scopeId2}>LFI&#39;s organisation (<code data-v-3e317908${_scopeId2}>C3-hh-cm-client</code> application)</td><td data-v-3e317908${_scopeId2}>Identifies the LFI when calling CM &amp; HH</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>C4</strong></td><td data-v-3e317908${_scopeId2}>Client Transport</td><td data-v-3e317908${_scopeId2}>Ozone</td><td data-v-3e317908${_scopeId2}>Ozone&#39;s organisation</td><td data-v-3e317908${_scopeId2}>Identifies the API Hub when calling Ozone Connect</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig1</strong></td><td data-v-3e317908${_scopeId2}>Signing</td><td data-v-3e317908${_scopeId2}>TPP</td><td data-v-3e317908${_scopeId2}>TPP&#39;s organisation</td><td data-v-3e317908${_scopeId2}>Signs TPP request JWTs (e.g. PAR request objects, <code data-v-3e317908${_scopeId2}>private_key_jwt</code>)</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig2</strong></td><td data-v-3e317908${_scopeId2}>Signing</td><td data-v-3e317908${_scopeId2}>Ozone</td><td data-v-3e317908${_scopeId2}>LFI&#39;s organisation</td><td data-v-3e317908${_scopeId2}>Signs API Hub responses and <code data-v-3e317908${_scopeId2}>id_token</code> sent to TPPs</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig3</strong></td><td data-v-3e317908${_scopeId2}>Signing</td><td data-v-3e317908${_scopeId2}>Ozone</td><td data-v-3e317908${_scopeId2}>Ozone&#39;s organisation</td><td data-v-3e317908${_scopeId2}>Signs JWT Auth headers on API Hub requests/responses to the LFI</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig4</strong></td><td data-v-3e317908${_scopeId2}>Signing</td><td data-v-3e317908${_scopeId2}>LFI</td><td data-v-3e317908${_scopeId2}>LFI&#39;s organisation (<code data-v-3e317908${_scopeId2}>C3-hh-cm-client</code> application)</td><td data-v-3e317908${_scopeId2}>Signs JWT Auth headers on LFI requests/responses to the API Hub</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Enc1</strong></td><td data-v-3e317908${_scopeId2}>Server Encryption</td><td data-v-3e317908${_scopeId2}>LFI</td><td data-v-3e317908${_scopeId2}>LFI&#39;s organisation</td><td data-v-3e317908${_scopeId2}>Encrypts PII — only the LFI can decrypt</td></tr><tr data-v-3e317908${_scopeId2}><td data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Enc2</strong></td><td data-v-3e317908${_scopeId2}>Client Encryption</td><td data-v-3e317908${_scopeId2}>TPP</td><td data-v-3e317908${_scopeId2}>TPP&#39;s organisation</td><td data-v-3e317908${_scopeId2}>Encrypts webhook event payloads — only the TPP can decrypt</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-3e317908${_scopeId2}>When creating these certificates in the Trust Framework, select the following types:</p><ul data-v-3e317908${_scopeId2}><li data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>C1, C3, C4</strong> — <code data-v-3e317908${_scopeId2}>OPF UAE CLIENT TRANSPORT</code></li><li data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>S1, S3, S4</strong> — <code data-v-3e317908${_scopeId2}>OPF UAE SERVER TRANSPORT</code></li><li data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Sig1, Sig2, Sig3, Sig4</strong> — <code data-v-3e317908${_scopeId2}>OPF UAE CLIENT SIGNING</code></li><li data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Enc1</strong> — <code data-v-3e317908${_scopeId2}>SERVER ENCKEY</code></li><li data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>Enc2</strong> — <code data-v-3e317908${_scopeId2}>OPF UAE CLIENT ENCRYPTION</code></li></ul>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-3e317908${_scopeId2}> The <strong data-v-3e317908${_scopeId2}>Sig3</strong> and <strong data-v-3e317908${_scopeId2}>Sig4</strong> certificates are only required when <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/application-layer-auth#jwt-auth" data-v-3e317908${_scopeId2}>JWT Auth</a> is selected as the application layer authentication method. </p>`);
            } else {
              return [
                createVNode("p", null, [
                  createTextVNode(" The "),
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h3 data-v-3e317908${_scopeId}>Ozone-held certificates (S1, S3, Sig2, C4, Sig3)</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For certificates where <strong data-v-3e317908${_scopeId2}>Ozone holds the private key</strong>, the process is: `);
            } else {
              return [
        ...
        _push2(`<h3 data-v-3e317908${_scopeId}>LFI-held certificates (C3, S4, Sig4, Enc1)</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For certificates where the <strong data-v-3e317908${_scopeId2}>LFI holds the private key</strong>, the process is: `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-3e317908${_scopeId2}>The LFI generates the private key and CSR.</li><li data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>For C3 and Sig4:</strong> The LFI creates the certificate in the <code data-v-3e317908${_scopeId2}>C3-hh-cm-client</code> application in the Trust Framework. See <a href="/tech/lfi-api-hub/trust-framework/creating-c3-application" data-v-3e317908${_scopeId2}>Creating the C3-hh-cm-client Application</a> and <a href="/tech/lfi-api-hub/trust-framework/certificates/" data-v-3e317908${_scopeId2}>Keys &amp; Certificates</a>. </li><li data-v-3e317908${_scopeId2}><strong data-v-3e317908${_scopeId2}>For S4 and Enc1:</strong> The LFI creates the certificate under Organisation Certificates in the Trust Framework.</li><li data-v-3e317908${_scopeId2}>The LFI provides the JWKS URL and KID to Ozone.</li>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-3e317908${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/" data-v-3e317908${_scopeId2}>Environment Specific Configuration</a> — the onboarding form where all certificate details are exchanged </li><li data-v-3e317908${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/application-layer-auth" data-v-3e317908${_scopeId2}>Application Layer Authentication</a> — choose your application layer authentication method (determines whether Sig3/Sig4 are required) </li><li data-v-3e317908${_scopeId2}><a href="/tech/lfi-api-hub/trust-framework/certificates/" data-v-3e317908${_scopeId2}>Keys &amp; Certificates</a> — how to generate keys and upload CSRs in the Trust Framework </li>`);
            } else {
              return [
                createVNode("li", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/api-hub/connectivity/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-3e317908"]]);
export {
  index as default
};
