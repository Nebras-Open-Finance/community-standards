...
// product information. Aligned with `/program/whats-live?family=product`.
  ...
  <div class="ed-landing">
    <section class="ed-landing__hero">
      <div class="ed-landing__inner">
        ...
        <p class="ed-landing__lede">The Products &amp; Leads API lets a TPP fetch the banking product catalogues published by LFIs and forward customer leads back to them. Products are aggregated across LFIs and presented to the user; leads are submitted on demand when the user requests follow-up.</p>
      </div>
    </section>
    ...
    <section class="ed-landing__role">
      <div class="ed-landing__inner">
        <div class="ed-landing__role-card">
          ...
          <p class="ed-landing__role-body">Access to the Products &amp; Leads API requires the <strong>BDSP</strong> role. This role must be assigned to your application in the Trust Framework before calling the endpoints. See <a href="/tech/tpp-standards/trust-framework/roles">Roles</a> for the full list of scopes and grant types this role permits.</p>
        </div>
        ...
        <p class="ed-landing__role-body" style="margin-bottom: 1rem;">The TPP fetches products from each LFI in parallel. The results are aggregated and presented to the user together. Once a user selects a product, they have two options:</p>
    <p class="ed-landing__role-body" style="margin-bottom: 0.85rem;"><strong>Apply Now</strong> &mdash; the TPP directs the user to apply using whichever channel the LFI has configured: a redirect URI, a phone number, an email address, or a written description of the application process.</p>
    <p class="ed-landing__role-body"><strong>Request contact from bank</strong> &mdash; the TPP submits a <span class="endpoint"><span class="http-method http-method--post">POST</span><code>/leads</code></span> with the user's contact details. The API Hub forwards the lead to the LFI and does not retain the data. The LFI is expected to follow up within 30 days.</p>
      </div>
    </section>
    ...
    <section class="ed-landing__live">
      <div class="ed-landing__inner">
        <div class="ed-landing__live-head">
          ...
          <h2 class="ed-landing__live-title">Which LFIs are live for Products & Leads</h2>
          <p class="ed-landing__live-sub">LFIs currently publishing product catalogues across UAE Open Finance.</p>
        </div>
    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        <div class="ed-landing__contents-head">
          ...
          <p class="ed-landing__contents-sub">The full set of pages for the Products & Leads API.</p>
        </div>

        <div class="ed-landing__contents-grid">
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/banking/products-leads/requirements" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
            <span class="ed-link-card__top" />
            <div class="ed-link-card__meta"><span class="ed-link-card__cat">Requirements</span></div>
            <h3 class="ed-link-card__title">Products & Leads — Requirements</h3>
            <p class="ed-link-card__desc">Validation rules and behaviour every Products &amp; Leads request must follow.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/banking/products-leads/api-guide" :style="{ '--card-color': 'var(--at-teal)' }">
            <span class="ed-link-card__top" />
            <div class="ed-link-card__meta"><span class="ed-link-card__cat">API Guide</span></div>
            <h3 class="ed-link-card__title">Products & Leads — API Guide</h3>
            <p class="ed-link-card__desc">Implementation notes, payload structure, and worked examples.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/banking/products-leads/user-journeys" :style="{ '--card-color': 'var(--at-navy)' }">
            <span class="ed-link-card__top" />
            <div class="ed-link-card__meta"><span class="ed-link-card__cat">User Journeys</span></div>
            <h3 class="ed-link-card__title">Products & Leads — User Journeys</h3>
            <p class="ed-link-card__desc">How users browse products and submit leads through your application.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
        </div>
      </div>
