...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-e9eababf><section class="ed-doc__hero" data-v-e9eababf><div class="ed-doc__inner" data-v-e9eababf><div class="ed-doc__eyebrow" data-v-e9eababf><span class="ed-doc__eyebrow-dash" data-v-e9eababf></span> LFI · Banking · Service Initiation · Fixed On Demand </div><h1 class="ed-doc__title" data-v-e9eababf> Fixed On Demand — API Guide <span class="ed-doc__read" data-v-e9eababf>15 min read</span></h1><p class="ed-doc__lede" data-v-e9eababf> Fixed On Demand lets a TPP initiate <strong data-v-e9eababf>multiple</strong> domestic payments at a <strong data-v-e9eababf>fixed amount</strong> from a customer&#39;s account at your LFI via the API Hub. The customer authorises the consent once — approving a specific per-payment amount and periodic limits — and the TPP can then submit individual payments on-demand without re-authorisation. Payments run on AANI as the primary rail with UAEFTS as the fallback. This guide covers the Ozone Connect endpoints your LFI MUST implement so the Hub can serve every payment under the consent from creation through to execution and status retrieval. </p><p class="ed-doc__lede" data-v-e9eababf> The behavioural rules for each endpoint — validation conditions, error mappings, post-execution lifecycle — are in the <a href="./requirements" data-v-e9eababf>Fixed On Demand Requirements</a>. This guide covers the request and response shape of each endpoint, with code walkthroughs for the parts that need them: decrypting the PII, validating the creditor, matching the payment-time PII against the consent, and applying the duplicate-in-flight check that is specific to on-demand consent types. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>API Hub onboarded</strong> — Your API Hub instance is provisioned and your <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/" data-v-e9eababf${_scopeId2}>environment-specific configuration</a> is complete.</li><li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>Enc1 key pair generated and registered</strong> — The TPP encrypts PII to your LFI&#39;s <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/#enc1-encryption-key" data-v-e9eababf${_scopeId2}>Enc1 public key</a>. Your LFI MUST hold the corresponding private key and be able to look it up by <code data-v-e9eababf${_scopeId2}>kid</code>.</li><li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>Consent Journey implemented</strong> — The <a href="/tech/lfi-api-hub/v2.1/consent-journey/api-guide" data-v-e9eababf${_scopeId2}>Consent Journey API Guide</a> MUST be implemented first. A payment cannot be initiated without an authorized consent.</li><li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>Ozone Connect connectivity verified</strong> — Bidirectional mTLS connectivity is confirmed between the API Hub and your Ozone Connect base URL. See <a href="/tech/lfi-api-hub/v2.1/api-hub/connectivity/" data-v-e9eababf${_scopeId2}>Connectivity &amp; Certificates</a>.</li><li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>Fixed On Demand advertised</strong> — <code data-v-e9eababf${_scopeId2}>ApiMetadata.FixedOnDemand.Supported</code> is set to <code data-v-e9eababf${_scopeId2}>true</code> on your authorisation server entry in the Trust Framework.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When a TPP creates a payment consent, the API Hub calls your <a href="/tech/lfi-api-hub/v2.1/consent-events/open-api/validate" class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--post" data-v-e9eababf${_scopeId2}>POST</span><code data-v-e9eababf${_scopeId2}>/consent/action/validate</code></a> endpoint <strong data-v-e9eababf${_scopeId2}>before</strong> the consent is created. Your LFI MUST validate the consent and respond with <code data-v-e9eababf${_scopeId2}>data.status: &quot;valid&quot;</code> or <code data-v-e9eababf${_scopeId2}>data.status: &quot;invalid&quot;</code>. An <code data-v-e9eababf${_scopeId2}>invalid</code> response prevents the consent being created and the TPP receives an error. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The full set of validation rules is enumerated in <a href="./requirements#consent-validation" data-v-e9eababf${_scopeId2}>Fixed On Demand Requirements — Consent Validation</a>. The two parts that need a code walkthrough are <strong data-v-e9eababf${_scopeId2}>decrypting the PII</strong> and <strong data-v-e9eababf${_scopeId2}>validating the creditor</strong>; both are covered below. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Decrypting and validating the PII</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-e9eababf${_scopeId2}>consent.PersonalIdentifiableInformation</code> field arrives as a JWE compact string encrypted by the TPP to your LFI&#39;s Enc1 public key. Decryption, schema validation, and field-level checks are entirely the LFI&#39;s responsibility. `);
                } else {
                  return [
                    createTextVNode(" The "),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e9eababf${_scopeId2}>Read the <code data-v-e9eababf${_scopeId2}>kid</code> from the JWE protected header and look up the matching Enc1 private key.</li><li data-v-e9eababf${_scopeId2}>Decrypt the JWE → recover the inner JWS.</li><li data-v-e9eababf${_scopeId2}>Decode the JWS payload (signature verification is <strong data-v-e9eababf${_scopeId2}>optional</strong>).</li><li data-v-e9eababf${_scopeId2}>Validate the decoded payload against the consent-time PII schema — <code data-v-e9eababf${_scopeId2}>AEBankServiceInitiationRichAuthorizationRequests.AEDomesticPaymentPII</code>.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` For the per-step deep dive see <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/personal-identifiable-information/api-guide/decrypt-pii" data-v-e9eababf${_scopeId2}>How to Decrypt PII</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If decryption fails, schema validation fails, or any required field is missing, respond with <code data-v-e9eababf${_scopeId2}>invalid</code> per <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/personal-identifiable-information/creditor#rejecting-an-invalid-consent" data-v-e9eababf${_scopeId2}>Rejecting an invalid consent</a>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Validating the Creditor</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` For Fixed On Demand, <code data-v-e9eababf${_scopeId2}>Initiation.Creditor</code> MUST be an array of exactly <strong data-v-e9eababf${_scopeId2}>one</strong> entry — the single creditor that every payment under this consent will pay. The full Creditor rules are in <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/personal-identifiable-information/creditor" data-v-e9eababf${_scopeId2}>Creditor</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>Cardinality</strong> — exactly one entry.</li><li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>Mandatory fields</strong> — <code data-v-e9eababf${_scopeId2}>CreditorAccount.SchemeName == &quot;IBAN&quot;</code>, valid UAE IBAN, at least one of <code data-v-e9eababf${_scopeId2}>Name.en</code> or <code data-v-e9eababf${_scopeId2}>Name.ar</code>.</li><li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>BIC consistency</strong> — derive the BIC from the IBAN; if <code data-v-e9eababf${_scopeId2}>CreditorAgent.Identification</code> was supplied it MUST match.</li><li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>Domestic rail reachability</strong> — the receiving bank is reachable on AANI or UAEFTS.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Validating the DebtorAccount</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If the TPP supplied <code data-v-e9eababf${_scopeId2}>Initiation.DebtorAccount</code> in the consent PII, your LFI MUST also validate it before approving the consent: <code data-v-e9eababf${_scopeId2}>SchemeName</code> is <code data-v-e9eababf${_scopeId2}>IBAN</code>, the IBAN corresponds to an account held at this LFI, and the account is in a state that permits payment initiation. Customer ownership is checked later during the authorisation journey. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The full check list and the <code data-v-e9eababf${_scopeId2}>invalid</code> response shape (with <code data-v-e9eababf${_scopeId2}>code: InvalidDebtorAccount</code>) are in <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/personal-identifiable-information/debtor-account" data-v-e9eababf${_scopeId2}>Debtor Account</a>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Returning the validate response</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/lfi-api-hub/v2.1/consent-events/api-guide#validate-post-consent-action-validate" data-v-e9eababf${_scopeId2}>Consent Events &amp; Actions — API Guide</a> for the full validate request and response schema. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` After consent creation passes validation, the TPP redirects the customer to your LFI&#39;s <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/auth-endpoint" data-v-e9eababf${_scopeId2}>authorization endpoint</a> and your LFI runs the standard consent journey. Full details are in the <a href="/tech/lfi-api-hub/v2.1/consent-journey/api-guide" data-v-e9eababf${_scopeId2}>Consent Journey API Guide</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}>Endpoint</th><th data-v-e9eababf${_scopeId2}>Direction</th><th data-v-e9eababf${_scopeId2}>Purpose</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/open-api/auth" class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--get" data-v-e9eababf${_scopeId2}>GET</span><code data-v-e9eababf${_scopeId2}>/auth</code></a></td><td data-v-e9eababf${_scopeId2}>LFI → API Hub</td><td data-v-e9eababf${_scopeId2}>Initiate the authorization interaction</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId" class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--get" data-v-e9eababf${_scopeId2}>GET</span><code data-v-e9eababf${_scopeId2}>/consents/{consentId}</code></a></td><td data-v-e9eababf${_scopeId2}>LFI → API Hub</td><td data-v-e9eababf${_scopeId2}>Retrieve the full consent details</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/patch-consents-consentId" class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--patch" data-v-e9eababf${_scopeId2}>PATCH</span><code data-v-e9eababf${_scopeId2}>/consents/{consentId}</code></a></td><td data-v-e9eababf${_scopeId2}>LFI → API Hub</td><td data-v-e9eababf${_scopeId2}>Update consent status, customer identifiers, and the selected debtor account</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm" class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--post" data-v-e9eababf${_scopeId2}>POST</span><code data-v-e9eababf${_scopeId2}>/auth/{interactionId}/doConfirm</code></a></td><td data-v-e9eababf${_scopeId2}>LFI → API Hub</td><td data-v-e9eababf${_scopeId2}>Complete the interaction successfully</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/open-api/auth-interactionId-doFail" class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--post" data-v-e9eababf${_scopeId2}>POST</span><code data-v-e9eababf${_scopeId2}>/auth/{interactionId}/doFail</code></a></td><td data-v-e9eababf${_scopeId2}>LFI → API Hub</td><td data-v-e9eababf${_scopeId2}>Complete the interaction with a failure</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>After the consent is authorized</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When the TPP submits a payment instruction to the API Hub&#39;s resource server, the API Hub validates the access token, checks the consent is <code data-v-e9eababf${_scopeId2}>Authorised</code>, checks the amount/currency match the consent control parameters (for Fixed On Demand this means the instructed amount equals <code data-v-e9eababf${_scopeId2}>PeriodicSchedule.Amount</code> and the per-period count has not been exceeded), and validates the request against the OpenAPI schema — all before forwarding to your Ozone Connect <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/open-api/payments" class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--post" data-v-e9eababf${_scopeId2}>POST</span><code data-v-e9eababf${_scopeId2}>/payments</code></a> endpoint covered in the next section. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The Hub does <strong data-v-e9eababf${_scopeId2}>not</strong> decrypt or inspect the PII. Re-validating the PII and matching it against the consent at payment time is the LFI&#39;s responsibility, covered below. `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-e9eababf${_scopeId}><a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/open-api/payments" class="endpoint" data-v-e9eababf${_scopeId}><span class="http-method http-method--post" data-v-e9eababf${_scopeId}>POST</span><code data-v-e9eababf${_scopeId}>/payments</code></a> is the central endpoint your LFI implements for payment execution. The API Hub calls it each time the TPP submits a payment under an authorized Fixed On Demand consent. Your LFI MUST decrypt and validate the PII, match it against the consent, run the synchronous validations listed in <a href="./requirements#post-payments-payment-execution" data-v-e9eababf${_scopeId}>POST <code data-v-e9eababf${_scopeId}>/payments</code> Requirements</a> — including the duplicate-in-flight check that is specific to on-demand consent types — create the payment record, and return <code data-v-e9eababf${_scopeId}>201</code> with the assigned <code data-v-e9eababf${_scopeId}>PaymentId</code>. </p>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Screening, rail submission, and status propagation happen <strong data-v-e9eababf${_scopeId2}>after</strong> the <code data-v-e9eababf${_scopeId2}>201</code> response — see <a href="#after-returning-201" data-v-e9eababf${_scopeId2}>After returning 201</a>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Common request headers</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}>Header</th><th data-v-e9eababf${_scopeId2}>Required</th><th data-v-e9eababf${_scopeId2}>Description</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-provider-id</code></td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>Identifier for your LFI registered in the Hub</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-aspsp-id</code></td><td data-v-e9eababf${_scopeId2}>Yes <em data-v-e9eababf${_scopeId2}>(deprecated)</em></td><td data-v-e9eababf${_scopeId2}>Deprecated alias for <code data-v-e9eababf${_scopeId2}>o3-provider-id</code></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-caller-org-id</code></td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>Organisation ID of the TPP making the underlying request</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-caller-client-id</code></td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>OIDC client ID of the TPP application</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-caller-software-statement-id</code></td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>Software statement ID of the TPP application</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-api-uri</code></td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>The parameterised URL of the API being called by the TPP</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-api-operation</code></td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>The HTTP method (<code data-v-e9eababf${_scopeId2}>POST</code>)</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-ozone-interaction-id</code></td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>Hub-generated interaction ID</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-consent-id</code></td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>The <code data-v-e9eababf${_scopeId2}>consentId</code> for which this call is being made</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-psu-identifier</code></td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>Base64-encoded customer identifier JSON object</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>o3-caller-interaction-id</code></td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>Interaction ID passed in by the TPP, if present</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-e9eababf${_scopeId2}> The headers the TPP set on its original call to the API Hub — including <code data-v-e9eababf${_scopeId2}>x-fapi-interaction-id</code>, <code data-v-e9eababf${_scopeId2}>x-fapi-auth-date</code>, <code data-v-e9eababf${_scopeId2}>x-customer-user-agent</code>, and <code data-v-e9eababf${_scopeId2}>x-idempotency-key</code> — are forwarded to your LFI <strong data-v-e9eababf${_scopeId2}>inside the request body</strong> as <code data-v-e9eababf${_scopeId2}>requestHeaders</code>, not on the HTTP headers of the API Hub → LFI call. Unlike Single Instant Payment, Fixed On Demand does <strong data-v-e9eababf${_scopeId2}>not</strong> require <code data-v-e9eababf${_scopeId2}>x-fapi-customer-ip-address</code> — the customer may not be present at the time the TPP submits an on-demand payment. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Request body</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-e9eababf${_scopeId2}>Content-Type: application/json</code>`);
                } else {
                  return [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}>Top-level fields</h4>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}>Field</th><th data-v-e9eababf${_scopeId2}>Type</th><th data-v-e9eababf${_scopeId2}>Required</th><th data-v-e9eababf${_scopeId2}>Description</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>requestUrl</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>The TPP-facing resource URL the TPP called</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>paymentType</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>MUST be <code data-v-e9eababf${_scopeId2}>cbuae-payment</code> for domestic Fixed On Demand</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>request.Data</code></td><td data-v-e9eababf${_scopeId2}>object</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>The payment payload</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>requestHeaders</code></td><td data-v-e9eababf${_scopeId2}>object</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>The complete set of HTTP headers the TPP sent to the API Hub</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>tpp</code></td><td data-v-e9eababf${_scopeId2}>object</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>The TPP&#39;s directory record. See <a href="/knowledge-base/articles/tpp-context-block" data-v-e9eababf${_scopeId2}>The <code data-v-e9eababf${_scopeId2}>tpp</code> and <code data-v-e9eababf${_scopeId2}>decodedSsa</code> Context Blocks</a></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>supplementaryInformation</code></td><td data-v-e9eababf${_scopeId2}>object</td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>Free-form pass-through context</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}><code data-v-e9eababf${_scopeId}>request.Data</code></h4>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}>Field</th><th data-v-e9eababf${_scopeId2}>Type</th><th data-v-e9eababf${_scopeId2}>Required</th><th data-v-e9eababf${_scopeId2}>Description</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>ConsentId</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>MUST equal the <code data-v-e9eababf${_scopeId2}>o3-consent-id</code> header</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Instruction.Amount.Amount</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>For Fixed On Demand this MUST equal the consent&#39;s <code data-v-e9eababf${_scopeId2}>PeriodicSchedule.Amount</code> — the Hub enforces this before forwarding</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Instruction.Amount.Currency</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>MUST be <code data-v-e9eababf${_scopeId2}>AED</code> for domestic payments</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>PaymentPurposeCode</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>3-letter ISO 20022 purpose code, e.g. <code data-v-e9eababf${_scopeId2}>SUBS</code></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>PersonalIdentifiableInformation</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>Encrypted PII payload as a JWE compact string</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>DebtorReference</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>Reference shown on the debtor&#39;s statement</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>CreditorReference</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>Reference shown on the creditor&#39;s statement</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>OpenFinanceBilling.Type</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>Billing type</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>OpenFinanceBilling.MerchantId</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>Optional merchant identifier</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}>Request example</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: postPaymentsRequestExample,
              lang: "json",
              filename: "POST /payments request body"
            }, null, _parent2, _scopeId));
            _push2(`<h3 id="reading-the-pii-at-payment-time" class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Reading the PII at payment time</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Initiation.Creditor</code> is a single object</strong>, not an array.</li><li data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>DebtorAccount</code> is absent</strong>.</li><li data-v-e9eababf${_scopeId2}>The schema is <code data-v-e9eababf${_scopeId2}>AEBankServiceInitiation.AEDomesticPaymentPIIProperties</code>.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If decryption fails, reject with <code data-v-e9eababf${_scopeId2}>400 JWE.DecryptionError</code>. If schema validation fails, reject with <code data-v-e9eababf${_scopeId2}>400 Body.InvalidFormat</code>. `);
                } else {
                  return [
            ...
            _push2(`<h3 id="matching-the-pii-against-the-consent" class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Matching the PII against the consent</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Per <a href="./requirements#post-payments-payment-execution" data-v-e9eababf${_scopeId2}>POST <code data-v-e9eababf${_scopeId2}>/payments</code> Requirements</a> rule 2, the submitted creditor MUST exactly match the single creditor that was on the consent at consent time. Mismatch → <code data-v-e9eababf${_scopeId2}>400 Consent.FailsControlParameters</code>. `);
                } else {
                  return [
                    createTextVNode(" Per "),
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}>Pattern A — LFI persisted the decrypted creditor at consent time</h4>`);
            _push2(ssrRenderComponent(_component_EdCodeGroup, { tabs: matchPatternATabs }, null, _parent2, _scopeId));
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}>Pattern B — LFI did not persist the consent-time PII</h4><p data-v-e9eababf${_scopeId}> If your LFI did not persist the decrypted PII at consent time, fetch the consent from the API Hub via <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId" class="endpoint" data-v-e9eababf${_scopeId}><span class="http-method http-method--get" data-v-e9eababf${_scopeId}>GET</span><code data-v-e9eababf${_scopeId}>/consents/{consentId}</code></a>, decrypt the consent&#39;s <code data-v-e9eababf${_scopeId}>PersonalIdentifiableInformation</code> field, and run the same <code data-v-e9eababf${_scopeId}>isExactMatch</code> comparison against <code data-v-e9eababf${_scopeId}>Initiation.Creditor[0]</code>. </p><h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Duplicate-in-flight check</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Per <a href="./requirements#post-payments-payment-execution" data-v-e9eababf${_scopeId2}>POST <code data-v-e9eababf${_scopeId2}>/payments</code> Requirements</a> rule 6, Fixed On Demand payments are subject to a duplicate-in-flight check that on-demand consent types carry but one-off and scheduled payments do not. Before the payment record is created, your LFI MUST check whether another payment under the same consent, with the same creditor and the same instructed amount, is currently in <code data-v-e9eababf${_scopeId2}>Pending</code> status. If so, reject the new request with <code data-v-e9eababf${_scopeId2}>409 Payment.DuplicateInFlight</code>. `);
                } else {
                  return [
                    createTextVNode(" Per "),
                    createVNode("a", { href: "./requirements#post-payments-payment-execution" }, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` This is distinct from <code data-v-e9eababf${_scopeId2}>x-idempotency-key</code> handling: the idempotency key catches TPP retries of the same HTTP request, while this rule catches genuinely separate payment intents that happen to duplicate a still-in-flight one. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Once the prior payment has left <code data-v-e9eababf${_scopeId2}>Pending</code> (reached <code data-v-e9eababf${_scopeId2}>AcceptedSettlementCompleted</code>, <code data-v-e9eababf${_scopeId2}>AcceptedCreditSettlementCompleted</code>, <code data-v-e9eababf${_scopeId2}>AcceptedWithoutPosting</code>, or <code data-v-e9eababf${_scopeId2}>Rejected</code>), a subsequent identical payment is permitted. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Response</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-e9eababf${_scopeId2}>Content-Type: application/json</code>`);
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Return <code data-v-e9eababf${_scopeId2}>201</code> on successful payment record creation.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}>Field</th><th data-v-e9eababf${_scopeId2}>Type</th><th data-v-e9eababf${_scopeId2}>Required</th><th data-v-e9eababf${_scopeId2}>Description</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>data.id</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>The LFI-assigned <code data-v-e9eababf${_scopeId2}>PaymentId</code></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>data.consentId</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>The consent under which the payment was created</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>data.paymentTransactionId</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>End-to-end identifier from the rail</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>data.status</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>One of <code data-v-e9eababf${_scopeId2}>Pending</code>, <code data-v-e9eababf${_scopeId2}>AcceptedSettlementCompleted</code>, <code data-v-e9eababf${_scopeId2}>AcceptedCreditSettlementCompleted</code>, <code data-v-e9eababf${_scopeId2}>AcceptedWithoutPosting</code>, <code data-v-e9eababf${_scopeId2}>Rejected</code>, <code data-v-e9eababf${_scopeId2}>Received</code></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>data.statusUpdateDateTime</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>ISO 8601 timestamp</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>data.creationDateTime</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>ISO 8601 timestamp</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>data.instruction.Amount</code></td><td data-v-e9eababf${_scopeId2}>object</td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>The payment amount and currency</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>data.paymentPurposeCode</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>The purpose code from the request</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>data.openFinanceBilling.Type</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}>The billing type from the request</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}>Example — successful initiation</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: postPaymentsResponseExample,
              lang: "json",
              filename: "201 Created"
            }, null, _parent2, _scopeId));
            _push2(`<h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Error responses</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Only return an error when the request is invalid. The <code data-v-e9eababf${_scopeId2}>errorCode</code> values are drawn from the <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/open-api/payments" data-v-e9eababf${_scopeId2}>POST <code data-v-e9eababf${_scopeId2}>/payments</code> OpenAPI schema</a> <code data-v-e9eababf${_scopeId2}>Error400</code> / <code data-v-e9eababf${_scopeId2}>Error403</code> / <code data-v-e9eababf${_scopeId2}>Error409</code> enums. `);
                } else {
                  return [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}><code data-v-e9eababf${_scopeId}>400</code> — Bad request</h4>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>errorCode</code></th><th data-v-e9eababf${_scopeId2}>When to use</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Body.InvalidFormat</code></td><td data-v-e9eababf${_scopeId2}>Body fails schema validation</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Resource.InvalidFormat</code></td><td data-v-e9eababf${_scopeId2}>A field is present but not syntactically valid</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Consent.Invalid</code></td><td data-v-e9eababf${_scopeId2}>The consent referenced is unknown to the LFI or has been revoked</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Consent.FailsControlParameters</code></td><td data-v-e9eababf${_scopeId2}>The payment-time creditor does not match the consent-time creditor</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Consent.BusinessRuleViolation</code></td><td data-v-e9eababf${_scopeId2}>An LFI-side business rule blocks the payment</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>JWE.DecryptionError</code></td><td data-v-e9eababf${_scopeId2}>PII JWE cannot be decrypted with any registered Enc1 key</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>JWE.InvalidHeader</code></td><td data-v-e9eababf${_scopeId2}>PII JWE header is malformed</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>JWS.InvalidSignature</code> / <code data-v-e9eababf${_scopeId2}>JWS.Malformed</code> / <code data-v-e9eababf${_scopeId2}>JWS.InvalidClaim</code> / <code data-v-e9eababf${_scopeId2}>JWS.InvalidHeader</code></td><td data-v-e9eababf${_scopeId2}>PII inner JWS fails verification</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>GenericRecoverableError</code> / <code data-v-e9eababf${_scopeId2}>GenericError</code></td><td data-v-e9eababf${_scopeId2}>Other validation errors</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}><code data-v-e9eababf${_scopeId}>403</code> — Forbidden</h4>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>errorCode</code></th><th data-v-e9eababf${_scopeId2}>When to use</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>AccessToken.InvalidScope</code></td><td data-v-e9eababf${_scopeId2}>The Hub&#39;s token does not include the required scope</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Consent.AccountTemporarilyBlocked</code></td><td data-v-e9eababf${_scopeId2}>Debtor account is <code data-v-e9eababf${_scopeId2}>Inactive</code>, <code data-v-e9eababf${_scopeId2}>Dormant</code>, or <code data-v-e9eababf${_scopeId2}>Suspended</code></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Consent.PermanentAccountAccessFailure</code></td><td data-v-e9eababf${_scopeId2}>Debtor account is <code data-v-e9eababf${_scopeId2}>Closed</code>, <code data-v-e9eababf${_scopeId2}>Deceased</code>, or <code data-v-e9eababf${_scopeId2}>Unclaimed</code></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Consent.TransientAccountAccessFailure</code></td><td data-v-e9eababf${_scopeId2}>Debtor account temporarily inaccessible</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}><code data-v-e9eababf${_scopeId}>409</code> — Conflict</h4>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>errorCode</code></th><th data-v-e9eababf${_scopeId2}>When to use</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Payment.DuplicateInFlight</code></td><td data-v-e9eababf${_scopeId2}>Another payment with the same creditor and amount under the same consent is still <code data-v-e9eababf${_scopeId2}>Pending</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}>Example error response</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: errorResponseExample,
              lang: "json",
              filename: "error response"
            }, null, _parent2, _scopeId));
            _push2(`<h3 id="after-returning-201" class="ed-doc__subhead" data-v-e9eababf${_scopeId}>After returning 201</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-e9eababf${_scopeId2}>201</code> means the payment record exists at your LFI; it does <strong data-v-e9eababf${_scopeId2}>not</strong> mean the payment has settled. The lifecycle from here is asynchronous and is the LFI&#39;s responsibility: `);
                } else {
                  return [
                    createTextVNode(" The "),
                    createVNode("code", null, "201"),
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}>Stage</th><th data-v-e9eababf${_scopeId2}>LFI behaviour</th><th data-v-e9eababf${_scopeId2}>Reference</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}>Screening</td><td data-v-e9eababf${_scopeId2}>Run fraud / sanctions / AML controls. SHOULD complete within 3 seconds. On failure, PATCH the payment to <code data-v-e9eababf${_scopeId2}>Rejected</code> with an <code data-v-e9eababf${_scopeId2}>LFI.</code>-namespaced reject reason</td><td data-v-e9eababf${_scopeId2}><a href="./requirements#screening-checks" data-v-e9eababf${_scopeId2}>Screening Checks</a></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}>Rail submission</td><td data-v-e9eababf${_scopeId2}>Submit to AANI as primary. Fall back to UAEFTS automatically if AANI is unavailable</td><td data-v-e9eababf${_scopeId2}><a href="./requirements#rail-submission" data-v-e9eababf${_scopeId2}>Rail Submission</a></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}>Status propagation</td><td data-v-e9eababf${_scopeId2}>On every rail status change, call <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/payment-log" class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--patch" data-v-e9eababf${_scopeId2}>PATCH</span><code data-v-e9eababf${_scopeId2}>/payment-log/{id}</code></a></td><td data-v-e9eababf${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/domestic-payments/overview/payment-status" data-v-e9eababf${_scopeId2}>Payment Status</a></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}>Rail rejection</td><td data-v-e9eababf${_scopeId2}>If the rail rejects the payment, PATCH <code data-v-e9eababf${_scopeId2}>paymentResponse.status: Rejected</code> with <code data-v-e9eababf${_scopeId2}>RejectReasonCode</code> namespaced as <code data-v-e9eababf${_scopeId2}>AANI.</code> or <code data-v-e9eababf${_scopeId2}>FTS.</code></td><td data-v-e9eababf${_scopeId2}><a href="./requirements#rail-submission" data-v-e9eababf${_scopeId2}>Rail Submission</a></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}>Status retrieval</td><td data-v-e9eababf${_scopeId2}>Continue serving <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/open-api/payments-PaymentId" class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--get" data-v-e9eababf${_scopeId2}>GET</span><code data-v-e9eababf${_scopeId2}>/payments/{paymentId}</code></a> for at least 1 year</td><td data-v-e9eababf${_scopeId2}><a href="#behavioural-rules" data-v-e9eababf${_scopeId2}>GET <code data-v-e9eababf${_scopeId2}>/payments/{paymentId}</code> rules below</a></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-e9eababf${_scopeId}><a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/payment-log" class="endpoint" data-v-e9eababf${_scopeId}><span class="http-method http-method--patch" data-v-e9eababf${_scopeId}>PATCH</span><code data-v-e9eababf${_scopeId}>/payment-log/:id</code></a> updates the payment status on the API Hub. The Hub uses the update to send asynchronous notifications to TPPs and to maintain accurate state for billing and limit calculations. </p><h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Request body</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}>Field</th><th data-v-e9eababf${_scopeId2}>Type</th><th data-v-e9eababf${_scopeId2}>Required</th><th data-v-e9eababf${_scopeId2}>Description</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>paymentResponse.status</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes</td><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Pending</code>, <code data-v-e9eababf${_scopeId2}>AcceptedSettlementCompleted</code>, <code data-v-e9eababf${_scopeId2}>AcceptedCreditSettlementCompleted</code>, <code data-v-e9eababf${_scopeId2}>AcceptedWithoutPosting</code>, or <code data-v-e9eababf${_scopeId2}>Rejected</code></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>paymentResponse.paymentTransactionId</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Conditional</td><td data-v-e9eababf${_scopeId2}>The end-to-end identifier assigned by the rail. Once set, MUST NOT change</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>paymentResponse.OpenFinanceBilling.numberOfSuccessfulTransactions</code></td><td data-v-e9eababf${_scopeId2}>integer</td><td data-v-e9eababf${_scopeId2}>No</td><td data-v-e9eababf${_scopeId2}>Number of successful transactions (typically <code data-v-e9eababf${_scopeId2}>1</code> per payment)</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>paymentResponse.RejectReasonCode[]</code></td><td data-v-e9eababf${_scopeId2}>array</td><td data-v-e9eababf${_scopeId2}>Conditional</td><td data-v-e9eababf${_scopeId2}>Required when status is <code data-v-e9eababf${_scopeId2}>Rejected</code></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>paymentResponse.RejectReasonCode[].Code</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes (in array)</td><td data-v-e9eababf${_scopeId2}>Pattern: <code data-v-e9eababf${_scopeId2}>^(LFI|AANI|FTS)\\.[A-Za-z0-9]+$</code></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>paymentResponse.RejectReasonCode[].Message</code></td><td data-v-e9eababf${_scopeId2}>string</td><td data-v-e9eababf${_scopeId2}>Yes (in array)</td><td data-v-e9eababf${_scopeId2}>Sanitised, customer-relayable description</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}>Example — successful settlement</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: patchSettlementExample,
              lang: "json",
              filename: "successful settlement"
            }, null, _parent2, _scopeId));
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}>Example — rail rejection</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: patchRailRejectionExample,
              lang: "json",
              filename: "rail rejection"
            }, null, _parent2, _scopeId));
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-e9eababf${_scopeId}>Example — LFI screening rejection</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`A successful PATCH returns <code data-v-e9eababf${_scopeId2}>204 No Content</code> with no body.`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-e9eababf${_scopeId}><a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/open-api/payments-PaymentId" class="endpoint" data-v-e9eababf${_scopeId}><span class="http-method http-method--get" data-v-e9eababf${_scopeId}>GET</span><code data-v-e9eababf${_scopeId}>/payments/:paymentId</code></a> backs the TPP request <code data-v-e9eababf${_scopeId}>GET https://rs1.LFICODE.apihub.openfinance.ae/open-finance/payment/v2.1/payments/{PaymentId}</code>. The TPP polls this to observe screening outcomes, rail settlement, and any subsequent rejection. </p><h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Response</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The response shape mirrors the <span class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--post" data-v-e9eababf${_scopeId2}>POST</span><code data-v-e9eababf${_scopeId2}>/payments</code></span> <code data-v-e9eababf${_scopeId2}>201</code> response. `);
                } else {
                  return [
            ...
            _push2(`<h3 id="behavioural-rules" class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Behavioural rules</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}>#</th><th data-v-e9eababf${_scopeId2}>Rule</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}>1</td><td data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>Sustain period</strong> — Serve <span class="endpoint" data-v-e9eababf${_scopeId2}><span class="http-method http-method--get" data-v-e9eababf${_scopeId2}>GET</span><code data-v-e9eababf${_scopeId2}>/payments/{paymentId}</code></span> for at least <strong data-v-e9eababf${_scopeId2}>1 year from the payment&#39;s creation date</strong></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}>2</td><td data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}>Status consistency with the API Hub</strong> — The <code data-v-e9eababf${_scopeId2}>Status</code> returned MUST exactly match the most recent value PATCHed to the API Hub</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}>3</td><td data-v-e9eababf${_scopeId2}><strong data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>paymentTransactionId</code> consistency</strong> — Once the rail has assigned the end-to-end identifier, this endpoint MUST return the same value</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-e9eababf${_scopeId}>Errors</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e9eababf${_scopeId2}><thead data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><th data-v-e9eababf${_scopeId2}>Status</th><th data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>errorCode</code></th><th data-v-e9eababf${_scopeId2}>When to use</th></tr></thead><tbody data-v-e9eababf${_scopeId2}><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>404</code></td><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Resource.NotFound</code></td><td data-v-e9eababf${_scopeId2}>No payment exists for the supplied <code data-v-e9eababf${_scopeId2}>paymentId</code></td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>403</code></td><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>Consent.AccountTemporarilyBlocked</code> / <code data-v-e9eababf${_scopeId2}>Consent.PermanentAccountAccessFailure</code></td><td data-v-e9eababf${_scopeId2}>Debtor account inaccessible</td></tr><tr data-v-e9eababf${_scopeId2}><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>500</code></td><td data-v-e9eababf${_scopeId2}><code data-v-e9eababf${_scopeId2}>GenericRecoverableError</code> / <code data-v-e9eababf${_scopeId2}>GenericError</code></td><td data-v-e9eababf${_scopeId2}>Transient or unrecoverable server error</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/banking/service-initiation/domestic-payments/multi-payments/fixed-on-demand/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e9eababf"]]);
export {
  apiGuide as default
};
