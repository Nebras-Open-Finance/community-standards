...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-1db9d9f2>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-1db9d9f2${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-1db9d9f2${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
      ...
      _push(`<div class="ed-page__intro" data-v-1db9d9f2>`);
      _push(ssrRenderComponent(_component_EdProse, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` The <a href="/tech/tpp-standards/security/request-headers" data-v-1db9d9f2${_scopeId}>Request Headers reference</a> covers the full rules. This article explains the intent behind each one. `);
          } else {
            return [
              createTextVNode(" The "),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h3 data-v-1db9d9f2${_scopeId}>How it works in practice</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-1db9d9f2${_scopeId2}>Generate a fresh UUID v4 for each request — never reuse across requests.</li><li data-v-1db9d9f2${_scopeId2}>Send it as <code data-v-1db9d9f2${_scopeId2}>x-fapi-interaction-id: 7b5b4e3c-1d2a-4f5e-8c3b-9a0d6e2f1b4c</code>.</li><li data-v-1db9d9f2${_scopeId2}>The API Hub echoes the exact value back in the <code data-v-1db9d9f2${_scopeId2}>x-fapi-interaction-id</code> response header. If you omit it, the API Hub generates one for you — but you won&#39;t know what it is until you read the response header, and any log lines emitted <em data-v-1db9d9f2${_scopeId2}>before</em> the response arrives will have no ID to correlate against.</li><li data-v-1db9d9f2${_scopeId2}>Log the interaction ID the moment you compose the request, not when you receive the response. This ensures it appears in your logs even if the request never returns.</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-1db9d9f2${_scopeId2}>When debugging:</strong> if a request fails, search your logs for the interaction ID to pull the full request and response together. Pass it to Nebras when raising a support case — it is the single fastest way to get an end-to-end trace.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-1db9d9f2${_scopeId2}>The header is defined as <em data-v-1db9d9f2${_scopeId2}>recommended</em> in FAPI 2.0, but in practice it is essential. There is no meaningful cost to sending it and significant cost to omitting it when you need to investigate a problem.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-1db9d9f2${_scopeId}><code data-v-1db9d9f2${_scopeId}>x-fapi-customer-ip-address</code></h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<h3 data-v-1db9d9f2${_scopeId}><code data-v-1db9d9f2${_scopeId}>x-fapi-auth-date</code></h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<h3 data-v-1db9d9f2${_scopeId}><code data-v-1db9d9f2${_scopeId}>x-customer-user-agent</code></h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`See the <a href="/tech/tpp-standards/security/request-headers" data-v-1db9d9f2${_scopeId2}>Request Headers reference</a> for format rules, exact conditions, and validation requirements.`);
                } else {
                  return [
...
const requestHeaders = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1db9d9f2"]]);
export {
