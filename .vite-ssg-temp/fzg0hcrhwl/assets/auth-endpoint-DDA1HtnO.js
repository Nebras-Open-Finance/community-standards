...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-216aed59><section class="ed-doc__hero" data-v-216aed59><div class="ed-doc__inner" data-v-216aed59><div class="ed-doc__eyebrow" data-v-216aed59><span class="ed-doc__eyebrow-dash" data-v-216aed59></span> LFI · API Hub · Onboarding · Environment-Specific </div><h1 class="ed-doc__title" data-v-216aed59> Authorization Endpoint <span class="ed-doc__read" data-v-216aed59>8 min read</span></h1><p class="ed-doc__lede" data-v-216aed59> The <strong data-v-216aed59>Authorization Endpoint</strong> is the HTTPS URL to which the end user (customer) is redirected during consent authorisation flows. It is the entry point to the LFI&#39;s authentication and consent authorisation experience. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-216aed59> The TPP constructs the redirect URL and sends the end user there directly — the API Hub does not perform this redirect. The URL MUST therefore be a stable, publicly accessible HTTPS endpoint that works reliably across all devices and browsers. </p></div></section>`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-216aed59${_scopeId2}><thead data-v-216aed59${_scopeId2}><tr data-v-216aed59${_scopeId2}><th data-v-216aed59${_scopeId2}>Environment</th><th data-v-216aed59${_scopeId2}>Example</th></tr></thead><tbody data-v-216aed59${_scopeId2}><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>Pre-production</td><td data-v-216aed59${_scopeId2}><code data-v-216aed59${_scopeId2}>https://openbanking-uat.example.com/authorize</code></td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>Production</td><td data-v-216aed59${_scopeId2}><code data-v-216aed59${_scopeId2}>https://openbanking.example.com/authorize</code></td></tr></tbody></table>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`There is exactly <strong data-v-216aed59${_scopeId2}>one</strong> Authorization Endpoint URL per API Hub instance.`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-216aed59${_scopeId2}>A TPP initiates a consent request via Pushed Authorization Request (PAR) to the API Hub.</li><li data-v-216aed59${_scopeId2}>The API Hub creates the consent and returns a <code data-v-216aed59${_scopeId2}>request_uri</code> to the TPP.</li><li data-v-216aed59${_scopeId2}>The TPP constructs the authorization URL and redirects the end user to <strong data-v-216aed59${_scopeId2}>your Authorization Endpoint</strong>.</li><li data-v-216aed59${_scopeId2}> Your system calls <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/" class="endpoint" data-v-216aed59${_scopeId2}><span class="http-method http-method--get" data-v-216aed59${_scopeId2}>GET</span><code data-v-216aed59${_scopeId2}>/auth</code></a> on the Headless Heimdall Auth Server, passing through the query parameters received from the redirect. </li><li data-v-216aed59${_scopeId2}>Headless Heimdall validates the FAPI/OIDC request and returns the interaction context and decoded consent details.</li><li data-v-216aed59${_scopeId2}>Your system authenticates the end user and presents the consent for approval.</li><li data-v-216aed59${_scopeId2}>Your system calls <code data-v-216aed59${_scopeId2}>doConfirm</code> or <code data-v-216aed59${_scopeId2}>doFail</code> on the Headless Heimdall Auth Server with the result.</li><li data-v-216aed59${_scopeId2}>The end user is redirected back to the TPP.</li>`);
            } else {
              return [
                ...
                createVNode("li", null, [
                  ...
                  createVNode("a", {
                    href: "/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/",
                    class: "endpoint"
                  }, [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-216aed59${_scopeId2}> The API Hub handles all FAPI 2.0 and OIDC protocol complexity through the Headless Heimdall Auth Server. Your Authorization Endpoint does not need to implement FAPI validation, token binding, or OIDC protocol logic directly — these are handled when you call <span class="endpoint" data-v-216aed59${_scopeId2}><span class="http-method http-method--get" data-v-216aed59${_scopeId2}>GET</span><code data-v-216aed59${_scopeId2}>/auth</code></span>. Your endpoint&#39;s role is to receive the redirect, invoke <span class="endpoint" data-v-216aed59${_scopeId2}><span class="http-method http-method--get" data-v-216aed59${_scopeId2}>GET</span><code data-v-216aed59${_scopeId2}>/auth</code></span>, authenticate the end user, and complete the consent journey. </p><p data-v-216aed59${_scopeId2}> For full details on the authorization flow, see the <a href="/tech/lfi-api-hub/v2.1/consent-journey/api-guide" data-v-216aed59${_scopeId2}>Consent Journey API Guide</a>. </p>`);
            } else {
              return [
                createVNode("p", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-216aed59${_scopeId2}>Use <strong data-v-216aed59${_scopeId2}>HTTPS</strong> — HTTP is not permitted</li><li data-v-216aed59${_scopeId2}>Be a clean base URL with <strong data-v-216aed59${_scopeId2}>no query parameters</strong> — the TPP appends OIDC query parameters (<code data-v-216aed59${_scopeId2}>client_id</code>, <code data-v-216aed59${_scopeId2}>response_type</code>, <code data-v-216aed59${_scopeId2}>request_uri</code>) during the redirect</li><li data-v-216aed59${_scopeId2}>Be accessible to end user browsers over the <strong data-v-216aed59${_scopeId2}>public internet</strong></li><li data-v-216aed59${_scopeId2}>Resolve to infrastructure <strong data-v-216aed59${_scopeId2}>owned and operated by the LFI</strong></li><li data-v-216aed59${_scopeId2}>Be stable — the URL MUST NOT change without coordinated reconfiguration of the API Hub instance</li>`);
            } else {
              return [
                createVNode("li", null, [
                  createTextVNode("Use "),
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Where <code data-v-216aed59${_scopeId2}>request_uri</code> is the value returned from the API Hub&#39;s <code data-v-216aed59${_scopeId2}>/par</code> response. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The Authorization Endpoint URL MUST be configured as a <strong data-v-216aed59${_scopeId2}>deep link</strong> that opens the LFI&#39;s native mobile app when it is installed on the end user&#39;s device. This is the primary authentication channel — most end users will authenticate via the LFI&#39;s mobile banking app. `);
            } else {
              return [
        ...
        _push2(`<h3 data-v-216aed59${_scopeId}>Required approach: Universal Links and App Links</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-216aed59${_scopeId2}><thead data-v-216aed59${_scopeId2}><tr data-v-216aed59${_scopeId2}><th data-v-216aed59${_scopeId2}>Platform</th><th data-v-216aed59${_scopeId2}>Mechanism</th><th data-v-216aed59${_scopeId2}>Verification file</th></tr></thead><tbody data-v-216aed59${_scopeId2}><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>iOS</strong></td><td data-v-216aed59${_scopeId2}>Universal Links</td><td data-v-216aed59${_scopeId2}><code data-v-216aed59${_scopeId2}>/.well-known/apple-app-site-association</code></td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>Android</strong></td><td data-v-216aed59${_scopeId2}>Android App Links</td><td data-v-216aed59${_scopeId2}><code data-v-216aed59${_scopeId2}>/.well-known/assetlinks.json</code></td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
        ...
        _push2(`<h3 data-v-216aed59${_scopeId}>How verified deep linking works</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>The LFI hosts a verification file</strong> on the Authorization Endpoint domain, proving ownership of both the domain and the app.</li><li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>The LFI&#39;s mobile app declares</strong> that it handles URLs for the Authorization Endpoint domain.</li><li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>The operating system verifies</strong> the association at app install time by fetching the verification file from the domain.</li><li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>When the end user navigates to the URL</strong>, the OS opens the LFI app directly — no browser page is loaded, no disambiguation dialog is shown.</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(`<h4 data-v-216aed59${_scopeId}>iOS — Apple App Site Association</h4>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The LFI MUST host an <code data-v-216aed59${_scopeId2}>apple-app-site-association</code> file at the root of the Authorization Endpoint domain: `);
            } else {
              return [
        ...
        _push2(`<h4 data-v-216aed59${_scopeId}>Android — Digital Asset Links</h4>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The LFI MUST host an <code data-v-216aed59${_scopeId2}>assetlinks.json</code> file at the root of the Authorization Endpoint domain: `);
            } else {
              return [
                createTextVNode(" The LFI MUST host an "),
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-216aed59${_scopeId2}> The operating system fetches and verifies the association file when the app is installed or updated. If verification fails (e.g. the file is missing, malformed, or the certificate fingerprint doesn&#39;t match), the OS will fall back to opening the URL in the browser — which defeats the purpose of deep linking. LFIs MUST ensure the verification files are correctly configured and accessible <strong data-v-216aed59${_scopeId2}>before</strong> publishing the app. </p>`);
            } else {
              return [
                createVNode("p", null, [
        ...
        _push2(`<h3 data-v-216aed59${_scopeId}>Fallback when the app is not installed</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` If the LFI app is not installed on the end user&#39;s device, the URL opens in the device&#39;s browser. In this case, the Authorization Endpoint MUST serve a <strong data-v-216aed59${_scopeId2}>mobile-optimised web page</strong> that allows the end user to complete authentication. See the <a href="/tech/lfi-api-hub/v2.1/consent-journey/authentication/implementation#fallback-scenarios-when-the-app-is-not-available" data-v-216aed59${_scopeId2}>Authentication Implementation Guide</a> for the detailed fallback flows, including browser-based authentication, app handoff via push notification, and QR code handoff from desktop. `);
            } else {
              return [
                ...
                createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-journey/authentication/implementation#fallback-scenarios-when-the-app-is-not-available" }, "Authentication Implementation Guide"),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>QR code handoff</strong> — the page displays a QR code that the end user scans with their mobile device, opening the LFI app to complete authentication</li><li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>Push notification handoff</strong> — the page collects identifying information and triggers a push notification to the end user&#39;s bound device</li><li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>Browser-based authentication</strong> — if the LFI supports web-based authentication in its existing digital channels, the end user MUST be able to complete the entire journey in the desktop browser</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For implementation details, see the <a href="/tech/lfi-api-hub/v2.1/consent-journey/authentication/implementation#desktop-browser--qr-code-or-push-notification" data-v-216aed59${_scopeId2}>Authentication Implementation Guide</a>. `);
            } else {
              return [
                createTextVNode(" For implementation details, see the "),
                createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-journey/authentication/implementation#desktop-browser--qr-code-or-push-notification" }, "Authentication Implementation Guide"),
                createTextVNode(". ")
              ];
            }
          }),
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<h3 data-v-216aed59${_scopeId}>What the LFI MUST support</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>Across mobile platforms</strong> — iOS and Android, including current and recent OS versions</li><li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>Across mobile browsers</strong> — Safari, Chrome, Samsung Internet, Firefox, and any other browser with meaningful market share in the UAE. The deep link MUST open the app regardless of which browser the TPP is using. If the app is not installed, the browser fallback MUST render correctly in all of these browsers.</li><li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>Across desktop browsers</strong> — Chrome, Safari, Edge, and Firefox on Windows, macOS, and common Linux distributions</li><li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>Regardless of how the TPP opens the redirect</strong> — the endpoint MUST work whether the TPP opens the URL in the current browser tab, a new browser tab, or a system browser view (e.g. <code data-v-216aed59${_scopeId2}>SFSafariViewController</code> on iOS, Chrome Custom Tabs on Android). The behaviour MUST be seamless in all cases.</li><li data-v-216aed59${_scopeId2}><strong data-v-216aed59${_scopeId2}>On both mobile and desktop</strong> — the same URL serves the appropriate experience based on the device context</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(`<h3 data-v-216aed59${_scopeId}>What the LFI MUST test</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-216aed59${_scopeId2}>Deep linking correctly opens the native app on both iOS and Android when the app is installed, across all major browsers</li><li data-v-216aed59${_scopeId2}>The browser fallback renders and functions correctly on both iOS and Android when the app is not installed, across all major browsers</li><li data-v-216aed59${_scopeId2}>The desktop experience works across all major desktop browsers</li><li data-v-216aed59${_scopeId2}>The flow completes successfully regardless of whether the TPP opens the redirect in the current tab, a new tab, or a system browser view</li><li data-v-216aed59${_scopeId2}>Navigation behaviour is sensible — for example, pressing the device back button during the flow does not leave the end user stranded on a blank page</li><li data-v-216aed59${_scopeId2}>The flow works on devices with different screen sizes, orientations, and accessibility settings</li>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-216aed59${_scopeId2}> Any failure of the Authorization Endpoint to function on a device or browser that end users commonly use will be treated as a <strong data-v-216aed59${_scopeId2}>certification failure</strong>. The LFI is responsible for ensuring broad compatibility. The CX certification process, managed by Nebras, will verify this as part of production readiness. </p>`);
            } else {
              return [
                createVNode("p", null, [
        ...
        _push2(`<h3 data-v-216aed59${_scopeId}>App disambiguation</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` LFIs MUST ensure that only the production app is verified against the production Authorization Endpoint domain. Development and staging builds MUST use separate domains (e.g. <code data-v-216aed59${_scopeId2}>openbanking-dev.example.com</code>) and MUST NOT be registered against the production domain&#39;s <code data-v-216aed59${_scopeId2}>assetlinks.json</code>. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-216aed59${_scopeId2}><thead data-v-216aed59${_scopeId2}><tr data-v-216aed59${_scopeId2}><th style="${ssrRenderStyle({ "width": "3rem" })}" data-v-216aed59${_scopeId2}>#</th><th data-v-216aed59${_scopeId2}>Requirement</th></tr></thead><tbody data-v-216aed59${_scopeId2}><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>1</td><td data-v-216aed59${_scopeId2}>HTTPS only — no HTTP, no custom URL schemes</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>2</td><td data-v-216aed59${_scopeId2}>No query parameters in the base URL</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>3</td><td data-v-216aed59${_scopeId2}>Publicly accessible over the internet</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>4</td><td data-v-216aed59${_scopeId2}>Universal Links (iOS) and App Links (Android) configured for the domain</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>5</td><td data-v-216aed59${_scopeId2}><code data-v-216aed59${_scopeId2}>apple-app-site-association</code> and <code data-v-216aed59${_scopeId2}>assetlinks.json</code> hosted and verified</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>6</td><td data-v-216aed59${_scopeId2}>App opens directly when installed — no intermediate pages or disambiguation dialogs</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>7</td><td data-v-216aed59${_scopeId2}>Mobile-optimised web fallback when app is not installed</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>8</td><td data-v-216aed59${_scopeId2}>Desktop web experience with handoff to mobile app (QR, push) or browser-based auth</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>9</td><td data-v-216aed59${_scopeId2}>Works across all major browsers on iOS, Android, and desktop</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>10</td><td data-v-216aed59${_scopeId2}>Works regardless of TPP redirect method (current tab, new tab, system browser view)</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>11</td><td data-v-216aed59${_scopeId2}>Production app disambiguation resolved — only one app handles the production domain</td></tr><tr data-v-216aed59${_scopeId2}><td data-v-216aed59${_scopeId2}>12</td><td data-v-216aed59${_scopeId2}>CX certified by Nebras as part of production readiness</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/auth-endpoint.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const authEndpoint = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-216aed59"]]);
export {
