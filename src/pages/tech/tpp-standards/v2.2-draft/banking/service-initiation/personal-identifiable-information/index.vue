...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          ...
          <a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/personal-identifiable-information/creditor">Creditor</a> for the full breakdown.
        </p>
      </div>
    </section>
    ...
    >
      ...
      <EdBullets>
        <li><a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/personal-identifiable-information/debtor-account">Debtor Account</a> &mdash; optional at <span class="endpoint"><span class="http-method http-method--post">POST</span><code>/par</code></span> only; not part of the <span class="endpoint"><span class="http-method http-method--post">POST</span><code>/payments</code></span> PII</li>
        <li><a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/personal-identifiable-information/creditor">Creditor</a> &mdash; consent-time models (single/multiple/open), payment-time structure, and match requirements</li>
        <li><a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/personal-identifiable-information/risk">Risk</a> &mdash; debtor and creditor risk indicators</li>
      </EdBullets>
    </EdSectionBand>
    ...
    >
      ...
      <EdNote type="warning" title="TPPs must understand LFI validation">
        ...
        <p>
          See <a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/personal-identifiable-information/creditor">Creditor</a> for the specific validation rules that LFIs apply to the
