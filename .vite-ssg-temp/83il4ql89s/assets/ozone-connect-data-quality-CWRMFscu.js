import { _ as __unplugin_components_6$1, a as __unplugin_components_7$1 } from "./EdRelatedCards-D4uHHv56.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-6ffcad51>`);
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-6ffcad51${_scopeId}>In scope (examples)</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6ffcad51${_scopeId2}>Bank Data Sharing reads (<code data-v-6ffcad51${_scopeId2}>GET /accounts</code>, <code data-v-6ffcad51${_scopeId2}>GET /accounts/{accountId}/balances</code>, <code data-v-6ffcad51${_scopeId2}>GET /accounts/{accountId}/transactions</code>, and related endpoints)</li><li data-v-6ffcad51${_scopeId2}>Products and Leads reads (<code data-v-6ffcad51${_scopeId2}>GET /products</code>, and the data returned after lead creation)</li><li data-v-6ffcad51${_scopeId2}>Insurance policy and related data reads</li><li data-v-6ffcad51${_scopeId2}>Any future Ozone Connect endpoint whose primary purpose is to return data about a customer, account, product, or service</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 data-v-6ffcad51${_scopeId}>Out of scope</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6ffcad51${_scopeId2}>Action and initiation endpoints that do not return domain data (for example <code data-v-6ffcad51${_scopeId2}>POST /payments</code>, <code data-v-6ffcad51${_scopeId2}>POST /customers/action/cop-query</code>, and similar). These are governed by the <a href="/policy/ozone-connect-availability" data-v-6ffcad51${_scopeId2}>Availability Policy</a> and the <a href="/policy/api-response-time" data-v-6ffcad51${_scopeId2}>API Response Time Policy</a>, not this one.</li><li data-v-6ffcad51${_scopeId2}>Internal system data that is not part of the published Ozone Connect OpenAPI specifications</li>`);
                } else {
                  return [
                    createVNode("li", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-6ffcad51${_scopeId3}><li data-v-6ffcad51${_scopeId3}>Fields marked as required in the Ozone Connect OpenAPI specification <strong data-v-6ffcad51${_scopeId3}>must</strong> be delivered on every response where the endpoint returns data for the relevant resource</li><li data-v-6ffcad51${_scopeId3}>A required field is required because TPPs and downstream use cases cannot function reliably without it</li><li data-v-6ffcad51${_scopeId3}>Missing or null required fields are treated as a <strong data-v-6ffcad51${_scopeId3}>data quality defect</strong> regardless of the underlying cause in the LFI&#39;s systems</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                            createVNode("li", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-6ffcad51${_scopeId3}><li data-v-6ffcad51${_scopeId3}>Fields that are optional in the spec <strong data-v-6ffcad51${_scopeId3}>must</strong> be delivered whenever the underlying data exists in the LFI&#39;s systems and can be mapped to the specification</li><li data-v-6ffcad51${_scopeId3}>&quot;Exists and can be mapped&quot; means the data is held by the LFI in some form, and there is a reasonable mapping from the LFI&#39;s internal representation to the specified field</li><li data-v-6ffcad51${_scopeId3}>LFIs are not expected to invent data they do not hold, but are expected to deliver data they do hold</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                            createVNode("li", null, [
            ...
            _push2(`<h3 data-v-6ffcad51${_scopeId}>Accuracy</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Data returned on in-scope responses <strong data-v-6ffcad51${_scopeId2}>must</strong> match the LFI&#39;s system of record. Values that are present must be correct — amounts, identifiers, dates, statuses, names, and every other specified field.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6ffcad51${_scopeId2}><strong data-v-6ffcad51${_scopeId2}>Field values</strong> — the value returned is the value held in the LFI&#39;s systems</li><li data-v-6ffcad51${_scopeId2}><strong data-v-6ffcad51${_scopeId2}>Units and formats</strong> — currency, precision, date-time format, status enumerations, and identifiers conform to the specification</li><li data-v-6ffcad51${_scopeId2}><strong data-v-6ffcad51${_scopeId2}>Relationships between fields</strong> — values that relate to one another remain consistent (for example available balance consistent with booked and pending movements)</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 data-v-6ffcad51${_scopeId}>Real-time data</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Data returned on in-scope responses <strong data-v-6ffcad51${_scopeId2}>must</strong> reflect the current state of the LFI&#39;s systems at the time of the request. TPPs and their customers act on what they see; stale data breaks that trust.`);
                } else {
                  return [
                    createTextVNode("Data returned on in-scope responses "),
                    createVNode("strong", null, "must"),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6ffcad51${_scopeId2}>Data must be sourced from systems that reflect the current position of the customer, account, product, or service</li><li data-v-6ffcad51${_scopeId2}>Where caching is used in the LFI&#39;s implementation, it must be bounded such that the data returned remains current for the purpose of the endpoint</li><li data-v-6ffcad51${_scopeId2}>End-of-day or overnight batch propagation is <strong data-v-6ffcad51${_scopeId2}>not acceptable</strong> for any in-scope field unless explicitly recorded in the Data Mapping Commitment and agreed with Nebras</li>`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-6ffcad51${_scopeId}>Forward commitment</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6ffcad51${_scopeId2}>Reviewed and updated when the LFI makes material changes to its core systems, when new Ozone Connect endpoints or fields are introduced, or when Nebras identifies gaps through monitoring</li><li data-v-6ffcad51${_scopeId2}>LFIs are accountable for delivering against their Data Mapping Commitment. <strong data-v-6ffcad51${_scopeId2}>Under-delivery against the commitment is treated as a data quality defect.</strong></li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Before an LFI is signed off as compliant with this policy and approved to go live on the ecosystem, the LFI must complete a <strong data-v-6ffcad51${_scopeId2}>live proving period</strong> with one or more TPPs.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6ffcad51${_scopeId2}>The LFI operates its Ozone Connect endpoints against real TPP traffic in production</li><li data-v-6ffcad51${_scopeId2}>Field presence, accuracy, and real-time behaviour are observed across the proving period and compared against the LFI&#39;s Data Mapping Commitment and the specification</li><li data-v-6ffcad51${_scopeId2}>Nebras reviews the results and confirms, or withholds, sign-off before the LFI is approved for general availability</li>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-6ffcad51${_scopeId}>What is monitored</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6ffcad51${_scopeId2}><strong data-v-6ffcad51${_scopeId2}>Required field presence</strong> — the rate at which required fields are delivered on in-scope responses</li><li data-v-6ffcad51${_scopeId2}><strong data-v-6ffcad51${_scopeId2}>Optional field presence</strong> — the rate at which optional fields are delivered, measured against the LFI&#39;s Data Mapping Commitment</li><li data-v-6ffcad51${_scopeId2}><strong data-v-6ffcad51${_scopeId2}>Accuracy and consistency</strong> — signals that indicate data divergence from the LFI&#39;s system of record, including internal inconsistencies in the response and divergence from expected formats</li><li data-v-6ffcad51${_scopeId2}><strong data-v-6ffcad51${_scopeId2}>Freshness</strong> — signals that indicate data is not reflecting current state, including staleness patterns across endpoints</li><li data-v-6ffcad51${_scopeId2}><strong data-v-6ffcad51${_scopeId2}>Peer benchmarks</strong> — each LFI&#39;s delivery is compared against similar LFIs in the ecosystem, so that outliers are visible</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 data-v-6ffcad51${_scopeId}>When delivery falls short</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6ffcad51${_scopeId2}>Reviewing the specific fields, records, or time windows in question and the underlying cause</li><li data-v-6ffcad51${_scopeId2}>Updating the Data Mapping Commitment where a field is genuinely not available in the LFI&#39;s systems</li><li data-v-6ffcad51${_scopeId2}>Agreeing remediation plans and timelines where a field is available but not being delivered, or is being delivered incorrectly or with delay</li><li data-v-6ffcad51${_scopeId2}>Escalating persistent or material non-delivery to the relevant regulatory authority where appropriate</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6ffcad51${_scopeId2}>Treat gaps identified through Nebras&#39;s monitoring as inputs into their own technology roadmaps</li><li data-v-6ffcad51${_scopeId2}>Prioritise closing data gaps that affect multiple TPP use cases or that place the LFI behind its peer group</li><li data-v-6ffcad51${_scopeId2}>Communicate planned improvements to Nebras so that ecosystem expectations can be set accordingly</li>`);
                } else {
                  return [
...
const ozoneConnectDataQuality = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6ffcad51"]]);
export {
