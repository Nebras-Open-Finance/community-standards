...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-4443b386><div class="imd-screen-name" data-v-4443b386><div class="imd-screen-bar" data-v-4443b386></div><button type="button" class="imd-back-button" aria-label="Back" data-v-4443b386><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-v-4443b386><path d="M14.5 5.5L8.5 12L14.5 18.5" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path></svg></button><div class="imd-screen-title" data-v-4443b386>${ssrInterpolate(barTitle.value)}</div></div>`);
      if (confirmAction.value === null && !showUpdates.value) {
        _push(`<!--[--><div class="imd-card-shell" data-v-4443b386><div class="imd-meta-card" data-v-4443b386><div class="imd-meta-header" data-v-4443b386><div class="imd-meta-lfi" data-v-4443b386>[${ssrInterpolate(entityLabel.value)} ${ssrInterpolate(__props.connection.lfiDigit)}]</div><div class="${ssrRenderClass([statusClass.value, "imd-status"])}" data-v-4443b386>${ssrInterpolate(displayStatus.value)}</div></div><div class="imd-meta-rows" data-v-4443b386><button type="button" class="${ssrRenderClass([{ "is-copied": copied.value }, "imd-meta-row imd-consent-id"])}"${ssrRenderAttr("aria-label", `Consent ID: ${CONSENT_ID}. Click to copy.`)} data-v-4443b386><span class="imd-meta-row-label" data-v-4443b386>Consent ID</span><span class="imd-consent-id-right" data-v-4443b386><span class="imd-consent-id-action" data-v-4443b386>${ssrInterpolate(copied.value ? "Copied!" : "Copy")}</span><span class="imd-consent-id-value" data-v-4443b386>${ssrInterpolate(truncatedConsentId)}</span></span></button><div class="imd-meta-row" data-v-4443b386><span class="imd-meta-row-label" data-v-4443b386>Last data received</span><span class="imd-meta-row-value" data-v-4443b386>${ssrInterpolate(LAST_DATA_RECEIVED)}</span></div></div></div><div class="imd-section-card" data-v-4443b386><div class="imd-section-header" data-v-4443b386><div class="imd-section-title" data-v-4443b386>Policies</div></div>`);
        if (totalPolicies.value > 0) {
          _push(`<div class="imd-policies-list" data-v-4443b386><!--[-->`);
          ssrRenderList(policyGroups.value, (group) => {
            _push(`<!--[--><!--[-->`);
            ssrRenderList(group.policies, (policy) => {
              _push(`<div class="${ssrRenderClass([{ "imd-policy-card--inactive": !policyIsActive(policy) }, "imd-policy-card"])}" data-v-4443b386><span class="imd-policy-status-icon"${ssrRenderAttr("title", policyIsActive(policy) ? "Active policy" : "Inactive policy")} data-v-4443b386>`);
              if (policyIsActive(policy)) {
                _push(`<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-v-4443b386><circle cx="8.5" cy="8.5" r="6.95" fill="#22A35D" fill-opacity="0.4" data-v-4443b386></circle><path d="M5.5 8.7L7.7 10.9L11.7 6.5" stroke="#22A35D" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" fill="none" data-v-4443b386></path></svg>`);
              } else {
                _push(`<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-v-4443b386><circle cx="8.5" cy="8.5" r="6.95" fill="#FDAA35" fill-opacity="0.4" data-v-4443b386></circle><path d="M8.5 5.2V8.5L10.3 9.7" stroke="#FDAA35" stroke-width="1.4" stroke-linecap="round" fill="none" data-v-4443b386></path></svg>`);
              }
              _push(`</span><div class="imd-policy-body" data-v-4443b386><div class="imd-policy-title-text" data-v-4443b386>${ssrInterpolate(group.label)}</div><div class="imd-policy-subtext" data-v-4443b386>${ssrInterpolate(policy.policyNumber)}</div><div class="imd-policy-row" data-v-4443b386><span class="imd-policy-row-label" data-v-4443b386>Premium</span>`);
          ...
          _push(`<div class="imd-policies-empty" data-v-4443b386> No linked policies for this consent. </div>`);
        }
        _push(`</div><div class="imd-section-card" data-v-4443b386>`);
        if (consentTypes.value.length === 1) {
          _push(`<div class="imd-section-header" data-v-4443b386><div class="imd-section-title" data-v-4443b386>Data we can access</div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="imd-type-sections" data-v-4443b386><!--[-->`);
        ssrRenderList(consentTypes.value, (entry) => {
          _push(`<div class="imd-type-section" data-v-4443b386>`);
          if (consentTypes.value.length > 1) {
            _push(`<div class="imd-section-title" data-v-4443b386>${ssrInterpolate(unref(insuranceTypeLabels)[entry.type] || `${entry.type} Insurance`)}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="imd-permissions-list" data-v-4443b386><!--[-->`);
          ssrRenderList(unref(insurancePermissionGroups), (row) => {
            _push(`<!--[-->`);
            if (entry.permissions.includes(row.permission)) {
              _push(`<div class="imd-permission-row" data-v-4443b386><button type="button" class="imd-permission-toggle"${ssrRenderAttr("aria-expanded", isOpen(entry.type, row.permission))} data-v-4443b386><span class="imd-permission-label-section" data-v-4443b386>`);
              ...
              _push(`<span class="imd-permission-label" data-v-4443b386>${ssrInterpolate(row.label)}</span></span><svg class="${ssrRenderClass([{ "is-open": isOpen(entry.type, row.permission) }, "imd-permission-arrow"])}" width="8" height="15" viewBox="0 0 8 15" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-v-4443b386><path d="M0.21967 13.4197C-0.0732232 13.7126 -0.0732232 14.1874 0.21967 14.4803C0.512563 14.7732 0.987437 14.7732 1.28033 14.4803L0.21967 13.4197ZM1.28033 0.219683C0.987437 -0.0732107 0.512563 -0.0732107 0.21967 0.219683C-0.0732232 0.512576 -0.0732232 0.987449 0.21967 1.28034L1.28033 0.219683ZM1.28033 14.4803L6.71366 9.04701L5.653 7.98635L0.21967 13.4197L1.28033 14.4803ZM6.71366 9.04701C7.64822 8.11245 7.64822 6.58757 6.71366 5.65302L5.653 6.71368C6.00178 7.06245 6.00178 7.63758 5.653 7.98635L6.71366 9.04701ZM6.71366 5.65302L1.28033 0.219683L0.21967 1.28034L5.653 6.71368L6.71366 5.65302Z" fill="black" fill-opacity="0.8" data-v-4443b386></path></svg></button>`);
              if (isOpen(entry.type, row.permission)) {
                _push(`<div class="imd-permission-description" data-v-4443b386>${ssrInterpolate(unref(insurancePermissionDescriptions)[row.permission])}</div>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</div>`);
        ...
        if (!isLfi.value && __props.connection.status !== "Rejected") {
          _push(`<div class="imd-usage-card" data-v-4443b386><div class="imd-usage-header" data-v-4443b386><div class="imd-usage-title" data-v-4443b386>${ssrInterpolate(__props.connection.status === "Revoked" ? "You cancelled this connection" : "How we are using your data")}</div><div class="imd-usage-subtitle" data-v-4443b386>[Detail purpose for which insurance data will be used].</div></div><div class="imd-usage-dates" data-v-4443b386><div class="imd-usage-date-block" data-v-4443b386><div class="imd-usage-date-row" data-v-4443b386><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="${ssrRenderStyle({ "flex-shrink": "0" })}" data-v-4443b386><path d="M5.33301 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path><path d="M10.667 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path><path d="M2.33301 6.05859H13.6663" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path><path d="M14 5.66536V11.332C14 13.332 13 14.6654 10.6667 14.6654H5.33333C3 14.6654 2 13.332 2 11.332V5.66536C2 3.66536 3 2.33203 5.33333 2.33203H10.6667C13 2.33203 14 3.66536 14 5.66536Z" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path></svg><span class="imd-usage-date-label" data-v-4443b386>First Connected</span></div><div class="imd-usage-date-value" data-v-4443b386>${ssrInterpolate(LAST_DATA_RECEIVED)}</div></div><div class="imd-usage-date-block" data-v-4443b386><div class="imd-usage-date-row" data-v-4443b386><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="${ssrRenderStyle({ "flex-shrink": "0" })}" data-v-4443b386><path d="M5.33301 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path><path d="M10.667 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path><path d="M2.33301 6.05859H13.6663" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path><path d="M14 5.66536V11.332C14 13.332 13 14.6654 10.6667 14.6654H5.33333C3 14.6654 2 13.332 2 11.332V5.66536C2 3.66536 3 2.33203 5.33333 2.33203H10.6667C13 2.33203 14 3.66536 14 5.66536Z" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path></svg><span class="imd-usage-date-label" data-v-4443b386>${ssrInterpolate(__props.connection.status === "Expired" ? "Connection Expired" : "Connection Expires")}</span></div><div class="imd-usage-date-value" data-v-4443b386>${ssrInterpolate(unref(formatDate)(EXPIRATION_ISO))}</div></div>`);
          if (__props.connection.baseConsentId) {
            _push(`<div class="imd-usage-date-block" data-v-4443b386><div class="imd-usage-date-row" data-v-4443b386><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="${ssrRenderStyle({ "flex-shrink": "0" })}" data-v-4443b386><rect x="1.33301" y="1.33203" width="13.334" height="13.334" rx="2" stroke="#36BFD4" stroke-width="1.5" data-v-4443b386></rect><path d="M10.167 6.16536C9.667 5.33203 8.667 4.66536 7.5 4.83203C6.167 5.0487 5.167 6.16536 5.0003 7.4987C4.8003 9.16536 6.0003 10.6654 7.6003 10.832C8.667 10.9487 9.6003 10.4987 10.167 9.83203" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path><path d="M10.5 4.5V6.5H8.5" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4443b386></path></svg><span class="imd-usage-date-label" data-v-4443b386>Last Updated</span></div><div class="imd-usage-date-value" data-v-4443b386>${ssrInterpolate(LAST_DATA_RECEIVED)}</div><div class="imd-usage-updates-link" data-v-4443b386>List of Updates</div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div>`);
        ...
        if (showDisconnect.value || showReactivate.value) {
          _push(`<div class="imd-footer" data-v-4443b386>`);
          if (showReactivate.value) {
            _push(`<button type="button" class="imd-reactivate-btn" data-v-4443b386>Reactivate</button>`);
          } else {
            _push(`<!---->`);
          }
          if (showPause.value) {
            _push(`<button type="button" class="imd-pause-btn" data-v-4443b386>Pause</button>`);
          } else {
            _push(`<!---->`);
          }
          if (showDisconnect.value) {
            _push(`<button type="button" class="imd-revoke-btn" data-v-4443b386>Stop Sharing</button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        _push(`<div class="imd-card-shell" data-v-4443b386><div class="imd-section-card" data-v-4443b386><div class="imd-section-header" data-v-4443b386><div class="imd-section-title" data-v-4443b386>List of Updates</div></div><div class="imd-updates-subtitle" data-v-4443b386>List of all changes that you made to this connection since first authorization.</div></div>`);
        if (relatedConsents.value.length > 0) {
          _push(`<div class="imd-updates-list" data-v-4443b386><!--[-->`);
          ssrRenderList(relatedConsents.value, (related, idx) => {
            _push(`<div class="imd-updates-item" role="button" tabindex="0" data-v-4443b386><div class="imd-updates-item-name" data-v-4443b386>${ssrInterpolate(LAST_DATA_RECEIVED)}</div><div class="imd-updates-item-count" data-v-4443b386>[${ssrInterpolate(entityLabel.value)} ${ssrInterpolate(related.lfiDigit)}]</div><div class="imd-updates-item-meta imd-updates-item-meta-row" data-v-4443b386><span class="imd-updates-item-meta-label" data-v-4443b386>Insurance Type:</span><span class="imd-updates-item-meta-value" data-v-4443b386>${ssrInterpolate(relatedTypesLabel(related))}</span></div><svg class="imd-updates-chevron" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" data-v-4443b386><path d="M9 18l6-6-6-6" data-v-4443b386></path></svg></div>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<div class="imd-updates-empty" data-v-4443b386>No related updates found.</div>`);
        }
        _push(`</div>`);
      } else {
        _push(`<!--[--><div class="imd-confirm-card imd-confirm-title-card" data-v-4443b386><div class="imd-confirm-title" data-v-4443b386>${ssrInterpolate(confirmTitle.value)}</div><div class="imd-confirm-subtitle" data-v-4443b386>Are you sure you want to proceed?</div></div><div class="imd-confirm-card" data-v-4443b386><div class="imd-confirm-impact-header" data-v-4443b386>What this will mean</div><p class="imd-confirm-impact-text" data-v-4443b386>${ssrInterpolate(confirmImpactText.value)}</p></div><div class="imd-confirm-footer" data-v-4443b386><button type="button" class="${ssrRenderClass([confirmAction.value === "pause" ? "imd-confirm-btn-pause" : confirmAction.value === "reactivate" ? "imd-confirm-btn-reactivate" : "imd-confirm-btn-revoke", "imd-confirm-btn"])}" data-v-4443b386>${ssrInterpolate(confirmButtonLabel.value)}</button><button type="button" class="imd-confirm-back-btn" data-v-4443b386>Go back</button></div><!--]-->`);
      }
      _push(`</div>`);
    };
  }
...
const InsuranceManagementDetail = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4443b386"]]);
