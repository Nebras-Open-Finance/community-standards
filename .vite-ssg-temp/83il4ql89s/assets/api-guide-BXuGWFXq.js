...
import { _ as _sfc_main$1 } from "./APIFlowConsentEvent-BGZgxP6f.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-caec8104><section class="ed-doc__hero" data-v-caec8104><div class="ed-doc__inner" data-v-caec8104><div class="ed-doc__eyebrow" data-v-caec8104><span class="ed-doc__eyebrow-dash" data-v-caec8104></span> Webhooks · Consent Status </div><h1 class="ed-doc__title" data-v-caec8104> Consent Status Event — API Guide <span class="ed-doc__read" data-v-caec8104>3 min read</span></h1><p class="ed-doc__lede" data-v-caec8104> When a consent&#39;s status changes — for example, when a User revokes it or it expires — the API Hub delivers a <strong data-v-caec8104>Consent Status Event</strong> to your registered webhook URL as a JWE-encrypted POST. Events fire for both Bank Data Sharing and Bank Service Initiation consents, and the <code data-v-caec8104>Data</code> object mirrors the full consent resource at the time of the change. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-caec8104${_scopeId2}><strong data-v-caec8104${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-caec8104${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the appropriate role as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-caec8104${_scopeId2}>Roles</a>. </li><li data-v-caec8104${_scopeId2}><strong data-v-caec8104${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-caec8104${_scopeId2}>Encryption Certificate</a></strong> — an active encryption certificate must be issued and registered in the Trust Framework to receive the event as an encrypted JWE. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Events are sent for both <strong data-v-caec8104${_scopeId2}>Bank Data Sharing</strong> and <strong data-v-caec8104${_scopeId2}>Bank Service Initiation</strong> consents. The <code data-v-caec8104${_scopeId2}>Data</code> object mirrors the full consent resource at the time of the status change. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The JWE is encrypted using your public <strong data-v-caec8104${_scopeId2}>Encryption Certificate</strong> registered in the Trust Framework. You must respond with <code data-v-caec8104${_scopeId2}>202 Accepted</code> immediately and decrypt the event payload asynchronously. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The Hub delivers the event as an HTTP POST to your registered webhook URL. The request body is a JWE compact serialisation string and the <code data-v-caec8104${_scopeId2}>Content-Type</code> is <code data-v-caec8104${_scopeId2}>application/jwe</code>. `);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-caec8104${_scopeId}>Request headers you will receive</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-caec8104${_scopeId2}><thead data-v-caec8104${_scopeId2}><tr data-v-caec8104${_scopeId2}><th data-v-caec8104${_scopeId2}>Header</th><th data-v-caec8104${_scopeId2}>Description</th></tr></thead><tbody data-v-caec8104${_scopeId2}><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>Content-Type</code></td><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>application/jwe</code></td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>x-fapi-interaction-id</code></td><td data-v-caec8104${_scopeId2}>RFC4122 UUID used as a correlation ID for this event delivery</td></tr></tbody></table>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` You must respond with <code data-v-caec8104${_scopeId2}>202 Accepted</code> and an <strong data-v-caec8104${_scopeId2}>empty body</strong> before performing any processing. The Hub expects an immediate acknowledgement — do not wait for decryption or business logic before responding. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, { type: "warning" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-caec8104${_scopeId2}> Failure to respond with <code data-v-caec8104${_scopeId2}>202</code> promptly may cause the Hub to retry delivery. Process the event payload asynchronously after acknowledging receipt. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The event is a JWE compact serialisation encrypted with your public <strong data-v-caec8104${_scopeId2}>Encryption Certificate</strong>. The JWE header contains a <code data-v-caec8104${_scopeId2}>kid</code> that identifies which of your registered encryption keys was used — decode the header first to select the correct private key, then decrypt. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/fapi/receiving-events" data-v-caec8104${_scopeId2}>Receiving Event Notifications</a> for the full FAPI-aligned guidance, including key selection by <code data-v-caec8104${_scopeId2}>kid</code>, JWS signature verification, and required security checks. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The decrypted and decoded event payload contains the following structure under the <code data-v-caec8104${_scopeId2}>message</code> claim. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-caec8104${_scopeId2}><thead data-v-caec8104${_scopeId2}><tr data-v-caec8104${_scopeId2}><th data-v-caec8104${_scopeId2}>Field</th><th data-v-caec8104${_scopeId2}>Type</th><th data-v-caec8104${_scopeId2}>Description</th></tr></thead><tbody data-v-caec8104${_scopeId2}><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>EventDateTime</code></td><td data-v-caec8104${_scopeId2}>string (date-time)</td><td data-v-caec8104${_scopeId2}>When the event was generated</td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>EventResource</code></td><td data-v-caec8104${_scopeId2}>string</td><td data-v-caec8104${_scopeId2}>The resource URI that triggered the event</td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>EventType</code></td><td data-v-caec8104${_scopeId2}>string</td><td data-v-caec8104${_scopeId2}>One of: <code data-v-caec8104${_scopeId2}>Resource.Created</code>, <code data-v-caec8104${_scopeId2}>Resource.Updated</code>, <code data-v-caec8104${_scopeId2}>Resource.Deleted</code></td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>ConsentId</code></td><td data-v-caec8104${_scopeId2}>string</td><td data-v-caec8104${_scopeId2}>The consent identifier associated with the event</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` A replica of the consent resource at the time of the status change, with <code data-v-caec8104${_scopeId2}>Status</code> and <code data-v-caec8104${_scopeId2}>StatusUpdateDateTime</code> updated to reflect the new state. Where the consent was revoked, <code data-v-caec8104${_scopeId2}>RevokedBy</code> will indicate who initiated the revocation. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The shape of <code data-v-caec8104${_scopeId2}>Data</code> depends on the consent type:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-caec8104${_scopeId2}><strong data-v-caec8104${_scopeId2}>Bank Data Sharing Consent</strong> — includes <code data-v-caec8104${_scopeId2}>Permissions</code>, <code data-v-caec8104${_scopeId2}>AccountType</code>, <code data-v-caec8104${_scopeId2}>AccountSubType</code>, and <code data-v-caec8104${_scopeId2}>ExpirationDateTime</code></li><li data-v-caec8104${_scopeId2}><strong data-v-caec8104${_scopeId2}>Bank Service Initiation Consent</strong> — includes <code data-v-caec8104${_scopeId2}>ControlParameters</code>, <code data-v-caec8104${_scopeId2}>PaymentPurposeCode</code>, and optionally <code data-v-caec8104${_scopeId2}>PaymentConsumption</code> tracking cumulative payment usage</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 data-v-caec8104${_scopeId}>Consent <code data-v-caec8104${_scopeId}>Status</code> values</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-caec8104${_scopeId2}><thead data-v-caec8104${_scopeId2}><tr data-v-caec8104${_scopeId2}><th data-v-caec8104${_scopeId2}>Status</th><th data-v-caec8104${_scopeId2}>Description</th></tr></thead><tbody data-v-caec8104${_scopeId2}><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>AwaitingAuthorization</code></td><td data-v-caec8104${_scopeId2}>The consent is awaiting User authorization</td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>Authorized</code></td><td data-v-caec8104${_scopeId2}>The consent has been successfully authorized by the User</td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>Rejected</code></td><td data-v-caec8104${_scopeId2}>The unauthorized consent was rejected at the LFI</td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>Revoked</code></td><td data-v-caec8104${_scopeId2}>The consent has been revoked — check <code data-v-caec8104${_scopeId2}>RevokedBy</code> for who initiated it</td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>Expired</code></td><td data-v-caec8104${_scopeId2}>The consent has passed its <code data-v-caec8104${_scopeId2}>ExpirationDateTime</code></td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>Consumed</code></td><td data-v-caec8104${_scopeId2}>The consented action(s) have been completed (payment consents)</td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>Suspended</code></td><td data-v-caec8104${_scopeId2}>The consent has been suspended pending further enquiry</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 data-v-caec8104${_scopeId}><code data-v-caec8104${_scopeId}>RevokedBy</code> values</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Present when <code data-v-caec8104${_scopeId2}>Status</code> is <code data-v-caec8104${_scopeId2}>Revoked</code>:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-caec8104${_scopeId2}><thead data-v-caec8104${_scopeId2}><tr data-v-caec8104${_scopeId2}><th data-v-caec8104${_scopeId2}>Value</th><th data-v-caec8104${_scopeId2}>Description</th></tr></thead><tbody data-v-caec8104${_scopeId2}><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>LFI</code></td><td data-v-caec8104${_scopeId2}>Revoked by the LFI without User initiation</td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>TPP</code></td><td data-v-caec8104${_scopeId2}>Revoked by the TPP without User initiation</td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>LFI.InitiatedByUser</code></td><td data-v-caec8104${_scopeId2}>User initiated revocation via the LFI</td></tr><tr data-v-caec8104${_scopeId2}><td data-v-caec8104${_scopeId2}><code data-v-caec8104${_scopeId2}>TPP.InitiatedByUser</code></td><td data-v-caec8104${_scopeId2}>User initiated revocation via the TPP</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/webhooks/consent-status/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-caec8104"]]);
export {
  apiGuide as default
};
