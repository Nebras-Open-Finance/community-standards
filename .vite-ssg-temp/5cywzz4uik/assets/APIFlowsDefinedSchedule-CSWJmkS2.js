...
sequenceDiagram
    ...
    loop Each scheduled date (1 payment per date)
...
`;
const _sfc_main = {
  __name: "APIFlowsDefinedSchedule",
  __ssrInlineRender: true,
  setup(__props) {
    useMermaidDiagram(mermaidDefinition, "defined-schedule-diagram");
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/common/api-flows/APIFlowsDefinedSchedule.vue");
