...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-337432c0><section class="ed-doc__hero" data-v-337432c0><div class="ed-doc__inner" data-v-337432c0><div class="ed-doc__eyebrow" data-v-337432c0><span class="ed-doc__eyebrow-dash" data-v-337432c0></span> LFI · Banking · Service Initiation · PII · API Guide </div><h1 class="ed-doc__title" data-v-337432c0> Verifying the TPP JWS Signature <span class="ed-doc__read" data-v-337432c0>3 min read</span></h1>`);
      _push(ssrRenderComponent(_component_EdNote, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-337432c0${_scopeId}> The <code data-v-337432c0${_scopeId}>PersonalIdentifiableInformation</code> field is embedded within a request that the API Hub has already verified was signed by the TPP. The outer JWS signature confirms that the PII was submitted by the authenticated TPP and has not been modified in transit. </p><p data-v-337432c0${_scopeId}> Verifying the inner JWS signature on the PII payload is therefore <strong data-v-337432c0${_scopeId}>not required</strong>, but LFIs may choose to implement it as a defence-in-depth measure. </p>`);
          } else {
            return [
              createVNode("p", null, [
                createTextVNode(" The "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-337432c0${_scopeId2}>Your security policy requires independent verification of all signed payloads, regardless of upstream validation.</li><li data-v-337432c0${_scopeId2}>You want to confirm the specific TPP identity that constructed the PII (available in the <code data-v-337432c0${_scopeId2}>iss</code> and <code data-v-337432c0${_scopeId2}>sub</code> claims).</li><li data-v-337432c0${_scopeId2}>You are building an audit trail that requires cryptographic proof tied to the TPP&#39;s signing key.</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The inner JWS (the result of decrypting the JWE) is signed by the TPP using their signing key. The JWS header contains the <code data-v-337432c0${_scopeId2}>kid</code> of the TPP&#39;s signing key, and the <code data-v-337432c0${_scopeId2}>iss</code> / <code data-v-337432c0${_scopeId2}>sub</code> claims identify the TPP&#39;s <code data-v-337432c0${_scopeId2}>client_id</code>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-337432c0${_scopeId}>Step 1 — Discover the TPP&#39;s JWKS</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The TPP&#39;s public signing keys are published through the Trust Framework directory. You can resolve the TPP&#39;s JWKS URI using the <code data-v-337432c0${_scopeId2}>o3-caller-software-statement-id</code> header from the inbound request: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-337432c0${_scopeId2}> The URL above returns the TPP&#39;s <strong data-v-337432c0${_scopeId2}>currently active</strong> keys. That is sufficient only if you verify at <code data-v-337432c0${_scopeId2}>/consent/action/validate</code> or the <code data-v-337432c0${_scopeId2}>post</code> consent event, where the signature is seconds old — <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/api-guide/decrypt-pii#two-patterns" data-v-337432c0${_scopeId2}>Pattern A</a> on the decryption guide. </p><p data-v-337432c0${_scopeId2}> A TPP may rotate its signing key at any time, and a rotated <code data-v-337432c0${_scopeId2}>kid</code> leaves the active set. If you verify during the authorisation journey, on <code data-v-337432c0${_scopeId2}>/consent/event/patch</code>, or at <code data-v-337432c0${_scopeId2}>POST /payments</code>, you MUST fall back to the parallel <code data-v-337432c0${_scopeId2}>inactive/</code> JWKS when the <code data-v-337432c0${_scopeId2}>kid</code> is not in the active set. See <a href="/knowledge-base/articles/pii-signature-verification" data-v-337432c0${_scopeId2}>Verifying the PII Signature — Rotated Keys and the Inactive JWKS</a>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      ...
                      createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/api-guide/decrypt-pii#two-patterns" }, "Pattern A"),
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-337432c0${_scopeId2}> Published JWKS entries carry <code data-v-337432c0${_scopeId2}>kty</code>, <code data-v-337432c0${_scopeId2}>use</code>, <code data-v-337432c0${_scopeId2}>kid</code> and <code data-v-337432c0${_scopeId2}>x5c</code>, but no <code data-v-337432c0${_scopeId2}>alg</code>. Pin <strong data-v-337432c0${_scopeId2}>PS256</strong> — the only signing algorithm in the UAE Open Finance FAPI profile — rather than accepting whatever the JWS header proposes. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-337432c0${_scopeId}>Step 2 — Verify the JWS</h3>`);
            _push2(ssrRenderComponent(_component_EdCodeGroup, { tabs: verifyTabs }, null, _parent2, _scopeId));
            _push2(`<h3 class="ed-doc__subhead" data-v-337432c0${_scopeId}>Claims to validate</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-337432c0${_scopeId2}><thead data-v-337432c0${_scopeId2}><tr data-v-337432c0${_scopeId2}><th data-v-337432c0${_scopeId2}>Claim</th><th data-v-337432c0${_scopeId2}>Validation</th></tr></thead><tbody data-v-337432c0${_scopeId2}><tr data-v-337432c0${_scopeId2}><td data-v-337432c0${_scopeId2}><code data-v-337432c0${_scopeId2}>iss</code></td><td data-v-337432c0${_scopeId2}>Must match the TPP&#39;s <code data-v-337432c0${_scopeId2}>client_id</code> (available in the <code data-v-337432c0${_scopeId2}>o3-caller-client-id</code> request header)</td></tr><tr data-v-337432c0${_scopeId2}><td data-v-337432c0${_scopeId2}><code data-v-337432c0${_scopeId2}>sub</code></td><td data-v-337432c0${_scopeId2}>Must match the TPP&#39;s <code data-v-337432c0${_scopeId2}>client_id</code></td></tr><tr data-v-337432c0${_scopeId2}><td data-v-337432c0${_scopeId2}><code data-v-337432c0${_scopeId2}>aud</code></td><td data-v-337432c0${_scopeId2}>Must contain your LFI&#39;s issuer identifier</td></tr><tr data-v-337432c0${_scopeId2}><td data-v-337432c0${_scopeId2}><code data-v-337432c0${_scopeId2}>exp</code></td><td data-v-337432c0${_scopeId2}>Evaluate against the consent&#39;s <code data-v-337432c0${_scopeId2}>CreationDateTime</code>, not the current time — see below</td></tr><tr data-v-337432c0${_scopeId2}><td data-v-337432c0${_scopeId2}><code data-v-337432c0${_scopeId2}>nbf</code></td><td data-v-337432c0${_scopeId2}>Evaluate against the consent&#39;s <code data-v-337432c0${_scopeId2}>CreationDateTime</code>, not the current time — see below</td></tr><tr data-v-337432c0${_scopeId2}><td data-v-337432c0${_scopeId2}><code data-v-337432c0${_scopeId2}>iat</code></td><td data-v-337432c0${_scopeId2}>Must be in the past, and consistent with the consent&#39;s <code data-v-337432c0${_scopeId2}>CreationDateTime</code></td></tr><tr data-v-337432c0${_scopeId2}><td data-v-337432c0${_scopeId2}><code data-v-337432c0${_scopeId2}>jti</code></td><td data-v-337432c0${_scopeId2}>Record for replay detection if required by your security policy</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-337432c0${_scopeId2}><code data-v-337432c0${_scopeId2}>exp</code>, <code data-v-337432c0${_scopeId2}>iat</code> and <code data-v-337432c0${_scopeId2}>nbf</code> on the PII JWS are set by the TPP when it signs the PII, and they bound the <strong data-v-337432c0${_scopeId2}>PAR submission window</strong> — not the moment you happen to be verifying. The same PII is replayed unchanged on every payment made under the consent, so on a long-lived consent those claims will normally have lapsed long before execution. </p><p data-v-337432c0${_scopeId2}><code data-v-337432c0${_scopeId2}>jwtVerify</code> and its equivalents enforce <code data-v-337432c0${_scopeId2}>exp</code> and <code data-v-337432c0${_scopeId2}>nbf</code> against the current time <strong data-v-337432c0${_scopeId2}>by default</strong>. If you verify anywhere other than consent creation, evaluate them against the consent&#39;s <code data-v-337432c0${_scopeId2}>CreationDateTime</code> or disable the check — otherwise valid PII will start failing verification as consents age. Whether the consent is still usable today is answered by the API Hub&#39;s consent validation on every request, not by a claim inside the PII. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createVNode("code", null, "exp"),
...
const verifyTppSignature = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-337432c0"]]);
export {
