...
When a customer is redirected to you to authorize an Open Finance consent for a single instant payment, you must present an Authorization Page that clearly explains the payment the customer is authorizing. The page must collect the customer's explicit and informed consent, and it must accurately reflect the payee, amount, schedule, and all material terms of the payment consent.
...
<div style="border: 1px solid #bfdbfe; border-radius: 10px; overflow: hidden; margin: 1.5rem 0; box-shadow: 0 2px 8px rgba(0,39,127,0.06);">
  <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.65rem 1rem; background: rgba(0,39,127,0.04); border-bottom: 1px solid #bfdbfe; flex-wrap: wrap; gap: 0.5rem;">
    ...
    <a href="/openapi/v2.1/api-hub/uae-api-hub-consent-manager-openapi.yaml" style="font-size: 0.75rem; color: rgba(0,39,127,0.6); text-decoration: none; display: flex; align-items: center; gap: 3px;">View Consent endpoint ↗</a>
  </div>
...
<!--@include: ../../../../../../tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/_shared/live-preview.md-->

<!--@include: ../../../../../../tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/_shared/ui-behaviour.md-->

<!--@include: ../../../../../../tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/_shared/example-journeys.md-->