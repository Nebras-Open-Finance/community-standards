<template>
  ...
  <EdProse><strong>Per-period limits</strong> (set at <code>ControlParameters.ConsentSchedule.MultiPayment.PeriodicSchedule</code>):</EdProse>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><em>Payments per Period</em></td>
          <td>Only 1 payment is allowed per period. Always shown.</td>
        </tr>
      </tbody>
    </table>
  </EdRefTable>
