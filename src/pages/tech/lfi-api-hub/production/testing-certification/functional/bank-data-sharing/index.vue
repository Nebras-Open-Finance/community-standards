...
const sampleBaseUrl = bankDataSharingArea.tppBaseUrlTemplate
...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          Functional Certification proves that your Ozone Connect implementation of the Bank Data
          Sharing endpoints returns correct, complete data — endpoint by endpoint — and that the same
        ...
        <div class="ed-doc__cta">
          <a class="ed-doc__cta-btn" href="/tech/lfi-api-hub/production/testing-certification/functional/bank-data-sharing/submission">
    ...
    >
      <EdProse>
        The portal walks you through {{ endpointCount }} Bank Data Sharing endpoints. For every endpoint
        your implementation exposes, have the following ready:
      </EdProse>

      <EdBullets>
        <li>
          <strong>Testing Tool output</strong> &mdash; the HTML report the Testing Tool produces for
          your Ozone Connect endpoint (e.g. <code>GET /accounts/&#123;AccountId&#125;/balances</code>).
        </li>
        <li>
        ...
        <li>
          ...
          server (e.g.
          <code>{{ sampleBaseUrl }}/accounts</code>).
        </li>
        <li>
