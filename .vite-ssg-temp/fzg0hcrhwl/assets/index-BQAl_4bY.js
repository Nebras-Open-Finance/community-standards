...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-30a62751><section class="ed-doc__hero" data-v-30a62751><div class="ed-doc__inner" data-v-30a62751><div class="ed-doc__eyebrow" data-v-30a62751><span class="ed-doc__eyebrow-dash" data-v-30a62751></span> LFI · Trust Framework · Directory </div><h1 class="ed-doc__title" data-v-30a62751> Trust Framework <span class="ed-doc__read" data-v-30a62751>2 min read</span></h1><p class="ed-doc__lede" data-v-30a62751> The Trust Framework facilitates secure data sharing between Licensed Financial Institutions (LFIs) and Third-Party Providers (TPPs) by delivering key services such as API discovery, client onboarding, and client authentication. </p></div></section>`);
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-30a62751${_scopeId}>Sandbox Trust Framework</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-30a62751${_scopeId2}>Web Application: <a href="https://web.sandbox.directory.openfinance.ae/" data-v-30a62751${_scopeId2}>https://web.sandbox.directory.openfinance.ae/</a></li><li data-v-30a62751${_scopeId2}>OIDC Discovery API: <a href="https://auth.sandbox.directory.openfinance.ae/.well-known/openid-configuration" data-v-30a62751${_scopeId2}>https://auth.sandbox.directory.openfinance.ae/.well-known/openid-configuration</a></li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 data-v-30a62751${_scopeId}>Production Trust Framework</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-30a62751${_scopeId2}>Web Application: <a href="https://web.directory.openfinance.ae/" data-v-30a62751${_scopeId2}>https://web.directory.openfinance.ae/</a></li><li data-v-30a62751${_scopeId2}>OIDC Discovery API: <a href="https://auth.directory.openfinance.ae/.well-known/openid-configuration" data-v-30a62751${_scopeId2}>https://auth.directory.openfinance.ae/.well-known/openid-configuration</a></li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      createTextVNode("Web Application: "),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-30a62751${_scopeId}>Trust Anchors</h3>`);
            ...
            _push2(`<h3 data-v-30a62751${_scopeId}>API Portal for Discovery</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<h3 data-v-30a62751${_scopeId}>Keystore</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<h3 data-v-30a62751${_scopeId}>Public Key Infrastructure (PKI)</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-30a62751${_scopeId2}>Licensed Financial Institutions (LFIs)</strong> provide capabilities into the Open Finance ecosystem. For example, an institution such as ADCB may expose payment initiation services or account information APIs for consumption by authorised participants. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-30a62751${_scopeId2}>Third Party Providers (TPPs)</strong> consume the capabilities made available through Open Finance. For example, a fintech organisation such as Spare Technologies may access payment or data services provided by LFIs to deliver customer-facing solutions. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/trust-framework/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-30a62751"]]);
export {
  index as default
};
