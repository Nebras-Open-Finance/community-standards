...
import { _ as _sfc_main$1 } from "./APIFlowsRefunds-DziMUNED.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-f354c252><section class="ed-doc__hero" data-v-f354c252><div class="ed-doc__inner" data-v-f354c252><div class="ed-doc__eyebrow" data-v-f354c252><span class="ed-doc__eyebrow-dash" data-v-f354c252></span> TPP · Banking · Service Initiation · Refunds </div><h1 class="ed-doc__title" data-v-f354c252> Payment Refunds — API Guide <span class="ed-doc__read" data-v-f354c252>2 min read</span></h1><p class="ed-doc__lede" data-v-f354c252> The Refunds API lets a TPP retrieve the debtor&#39;s payment account details from the LFI after a payment has been made, so a merchant can initiate a refund back to the original payer. This guide starts <strong data-v-f354c252>after a payment consent has been created</strong> with the <code data-v-f354c252>ReadRefundAccount</code> permission and the underlying payment has been authorised. </p><p class="ed-doc__lede" data-v-f354c252> Unlike the payment consent flow, retrieving refund details does <strong data-v-f354c252>not</strong> require a user redirect — the TPP authenticates directly using a client credentials grant. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-f354c252${_scopeId2}><strong data-v-f354c252${_scopeId2}>Completed payment consent with <code data-v-f354c252${_scopeId2}>ReadRefundAccount</code> permission</strong> — the original payment consent must have been created with <code data-v-f354c252${_scopeId2}>ReadRefundAccount</code> in the <code data-v-f354c252${_scopeId2}>Permissions</code> array, and the payment must have been authorised by the user. See the <a href="/tech/tpp-standards/v2.1/consent/api-guide" data-v-f354c252${_scopeId2}>Payment Consent API Guide</a>. </li><li data-v-f354c252${_scopeId2}><strong data-v-f354c252${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-f354c252${_scopeId2}>Application</a></strong> — the application must be assigned the <strong data-v-f354c252${_scopeId2}>BSIP role</strong> in the Trust Framework. See <a href="/tech/tpp-standards/trust-framework/roles" data-v-f354c252${_scopeId2}>Roles</a>. </li><li data-v-f354c252${_scopeId2}><strong data-v-f354c252${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-f354c252${_scopeId2}>Transport Certificate</a></strong> — an active transport certificate for mTLS communication with the LFI. </li><li data-v-f354c252${_scopeId2}><strong data-v-f354c252${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-f354c252${_scopeId2}>Signing Certificate</a></strong> — an active signing certificate for signing client assertions. </li><li data-v-f354c252${_scopeId2}><strong data-v-f354c252${_scopeId2}>LFI token endpoint</strong> — you should already hold the LFI&#39;s <code data-v-f354c252${_scopeId2}>token_endpoint</code> and <code data-v-f354c252${_scopeId2}>ResourceServerUrl</code> from the original payment consent flow. If not, fetch the LFI&#39;s <code data-v-f354c252${_scopeId2}>.well-known/openid-configuration</code> to resolve them. </li><li data-v-f354c252${_scopeId2}><strong data-v-f354c252${_scopeId2}>Understanding of <a href="/tech/tpp-standards/security/tokens/" data-v-f354c252${_scopeId2}>Tokens &amp; Assertions</a></strong> — familiarise yourself with <code data-v-f354c252${_scopeId2}>private_key_jwt</code> client authentication before calling the token endpoint. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      ...
                      createVNode("a", { href: "/tech/tpp-standards/v2.1/consent/api-guide" }, "Payment Consent API Guide"),
                      createTextVNode(". ")
                    ]),
                    createVNode("li", null, [
                      createVNode("strong", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Retrieving refund details uses the OAuth 2.0 <strong data-v-f354c252${_scopeId2}>client credentials</strong> grant — no user consent or redirect is required. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Use the <a href="/tech/tpp-standards/security/fapi/message-signing#signing-a-jwt" data-v-f354c252${_scopeId2}><code data-v-f354c252${_scopeId2}>signJWT()</code></a> helper to build a client assertion proving your application&#39;s identity: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/tokens/client-assertion" data-v-f354c252${_scopeId2}>Client Assertion</a> for the full claims reference. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` POST to the LFI&#39;s token endpoint with <code data-v-f354c252${_scopeId2}>scope=payments</code>: `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-f354c252${_scopeId}><span class="http-badge http-get" data-v-f354c252${_scopeId}>GET</span><code class="ed-doc__endpoint-path" data-v-f354c252${_scopeId}>/payment-consents/{ConsentId}/refund</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Call the LFI&#39;s refund endpoint using the <code data-v-f354c252${_scopeId2}>ConsentId</code> from the original payment consent. Include <code data-v-f354c252${_scopeId2}>x-fapi-interaction-id</code> on every request. See <a href="/tech/tpp-standards/security/request-headers" data-v-f354c252${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-f354c252${_scopeId}>Response</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-f354c252${_scopeId2}><thead data-v-f354c252${_scopeId2}><tr data-v-f354c252${_scopeId2}><th data-v-f354c252${_scopeId2}>Field</th><th data-v-f354c252${_scopeId2}>Type</th><th data-v-f354c252${_scopeId2}>Description</th></tr></thead><tbody data-v-f354c252${_scopeId2}><tr data-v-f354c252${_scopeId2}><td data-v-f354c252${_scopeId2}><code data-v-f354c252${_scopeId2}>Data.ConsentId</code></td><td data-v-f354c252${_scopeId2}>string</td><td data-v-f354c252${_scopeId2}>The ConsentId of the original payment consent</td></tr><tr data-v-f354c252${_scopeId2}><td data-v-f354c252${_scopeId2}><code data-v-f354c252${_scopeId2}>Data.BaseConsentId</code></td><td data-v-f354c252${_scopeId2}>string</td><td data-v-f354c252${_scopeId2}>The BaseConsentId, if the consent was part of a multi-payment arrangement</td></tr><tr data-v-f354c252${_scopeId2}><td data-v-f354c252${_scopeId2}><code data-v-f354c252${_scopeId2}>Data.RefundAccount.SchemeName</code></td><td data-v-f354c252${_scopeId2}>enum</td><td data-v-f354c252${_scopeId2}>Account identifier type — always <code data-v-f354c252${_scopeId2}>IBAN</code></td></tr><tr data-v-f354c252${_scopeId2}><td data-v-f354c252${_scopeId2}><code data-v-f354c252${_scopeId2}>Data.RefundAccount.Identification</code></td><td data-v-f354c252${_scopeId2}>string</td><td data-v-f354c252${_scopeId2}>The debtor&#39;s IBAN</td></tr><tr data-v-f354c252${_scopeId2}><td data-v-f354c252${_scopeId2}><code data-v-f354c252${_scopeId2}>Data.RefundAccount.Name</code></td><td data-v-f354c252${_scopeId2}>object</td><td data-v-f354c252${_scopeId2}>The debtor&#39;s account name</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-f354c252${_scopeId}>Example decoded payload</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: exampleResponse,
              lang: "json",
              filename: "decoded payload"
            }, null, _parent2, _scopeId));
            _push2(`<h3 class="ed-doc__subhead" data-v-f354c252${_scopeId}>Decoding the JWS</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The response body is a compact JWS — three base64url-encoded segments separated by <code data-v-f354c252${_scopeId2}>.</code>: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="../open-api/payment-consents-ConsentId-refund" data-v-f354c252${_scopeId2}>GET /payment-consents/{ConsentId}/refund</a> API reference for the full request and response schema. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Once you have the debtor&#39;s <code data-v-f354c252${_scopeId2}>RefundAccount</code> details, use the returned IBAN and name as the <strong data-v-f354c252${_scopeId2}>creditor</strong> in a new payment consent to initiate the refund. The refund payment follows the same initiation flow as any other payment. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/creditor" data-v-f354c252${_scopeId2}>Creditor PII</a> for how to populate the creditor fields using the retrieved account details. `);
                } else {
                  return [
                    createTextVNode(" See "),
                    createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/creditor" }, "Creditor PII"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/refunds/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f354c252"]]);
export {
  apiGuide as default
};
