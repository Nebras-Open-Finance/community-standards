  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/tpp-standards/v2.2-draft/webhooks/payment-status/api-guide">Payment Status Event API Guide</a>
      ...
      <EdProse>
        ...
        <a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/open-api/payments-PaymentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/payments/{paymentId}</code></a>
    ...
    >
      ...
      <EdNote type="info" title="Received status">
        <p>
          ...
          Bulk and batch payments are not yet documented in v2.2 &mdash; for the domestic single and
