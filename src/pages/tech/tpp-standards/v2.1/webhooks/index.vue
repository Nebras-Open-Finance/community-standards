        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td><a href="/tech/tpp-standards/v2.1/webhooks/consent-status/api-guide">Consent Status Event</a></td>
            </tr>
            <tr>
    ...
    <section class="ed-doc__contents">
      <div class="ed-doc__inner">
        ...
        <div class="ed-doc__contents-grid">
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/webhooks/consent-status/api-guide" :style="{ '--card-color': 'var(--at-teal)' }">
          ...
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/webhooks/payment-status/api-guide" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
            <span class="ed-link-card__top" />
            <div class="ed-link-card__meta"><span class="ed-link-card__cat">Sub-section</span></div>
