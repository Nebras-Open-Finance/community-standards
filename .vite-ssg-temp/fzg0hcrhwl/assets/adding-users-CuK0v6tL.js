...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-5ba1adad><section class="ed-doc__hero" data-v-5ba1adad><div class="ed-doc__inner" data-v-5ba1adad><div class="ed-doc__eyebrow" data-v-5ba1adad><span class="ed-doc__eyebrow-dash" data-v-5ba1adad></span> LFI · Trust Framework · Onboarding </div><h1 class="ed-doc__title" data-v-5ba1adad> Adding Users <span class="ed-doc__read" data-v-5ba1adad>2 min read</span></h1><p class="ed-doc__lede" data-v-5ba1adad>Organisation Administrators can onboard Users.</p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-5ba1adad${_scopeId2}><thead data-v-5ba1adad${_scopeId2}><tr data-v-5ba1adad${_scopeId2}><th data-v-5ba1adad${_scopeId2}>User Type</th><th data-v-5ba1adad${_scopeId2}>Access Scope</th></tr></thead><tbody data-v-5ba1adad${_scopeId2}><tr data-v-5ba1adad${_scopeId2}><td data-v-5ba1adad${_scopeId2}><strong data-v-5ba1adad${_scopeId2}>Primary Technical Contact (PTC)</strong></td><td data-v-5ba1adad${_scopeId2}>Can manage all technical resources of an Organisation — Applications and Certificates.</td></tr><tr data-v-5ba1adad${_scopeId2}><td data-v-5ba1adad${_scopeId2}><strong data-v-5ba1adad${_scopeId2}>Secondary Technical Contact (STC)</strong></td><td data-v-5ba1adad${_scopeId2}>Can manage Data Providers, adding and removing API Endpoints and Certifications. Cannot manage Applications and Certificates.</td></tr><tr data-v-5ba1adad${_scopeId2}><td data-v-5ba1adad${_scopeId2}><strong data-v-5ba1adad${_scopeId2}>Primary Business Contact (PBC)</strong></td><td data-v-5ba1adad${_scopeId2}>Can manage Contacts in the Organisation. Cannot manage Technical Resources.</td></tr><tr data-v-5ba1adad${_scopeId2}><td data-v-5ba1adad${_scopeId2}><strong data-v-5ba1adad${_scopeId2}>Secondary Business Contact (SBC)</strong></td><td data-v-5ba1adad${_scopeId2}>Has read-only access to Trust Framework resources. Cannot manage Applications, Certificates or any other resource in the Trust Framework.</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-5ba1adad${_scopeId2}> Onboarding a user as a Secondary Business Contact (SBC) in the Sandbox Trust Framework (<a href="https://web.sandbox.directory.openfinance.ae/" data-v-5ba1adad${_scopeId2}>https://web.sandbox.directory.openfinance.ae/</a>) is recommended if the user only needs access to the Nebras Jira Service Desk via Trust Framework SSO. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-5ba1adad${_scopeId2}>Creating and configuring applications</li><li data-v-5ba1adad${_scopeId2}>Managing certificates (Transport, Signing, and Encryption) for each application</li><li data-v-5ba1adad${_scopeId2}>Keeping keys and certificates current and renewing them before expiry</li><li data-v-5ba1adad${_scopeId2}>Ensuring applications are correctly configured with the required roles and certificates</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/lfi-api-hub/trust-framework/application" data-v-5ba1adad${_scopeId2}>Applications</a> for more on creating and managing applications, and <a href="/tech/lfi-api-hub/trust-framework/certificates/" data-v-5ba1adad${_scopeId2}>Keys &amp; Certificates</a> for certificate management. `);
                } else {
                  return [
                    createTextVNode(" See "),
                    createVNode("a", { href: "/tech/lfi-api-hub/trust-framework/application" }, "Applications"),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<ol class="ed-doc__substeps" data-v-5ba1adad${_scopeId}><li data-v-5ba1adad${_scopeId}>Log in to the Trust Framework and navigate to the <strong data-v-5ba1adad${_scopeId}>Roles</strong> section within your organisation.</li><li data-v-5ba1adad${_scopeId}>Navigate to a role within your organisation.</li></ol>`);
            _push2(ssrRenderComponent(_component_EdNote, { type: "tip" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-5ba1adad${_scopeId2}>Users can be added under any role, but for easier management it is recommended to add all users consistently under the same role.</p>`);
                } else {
                  return [
            ...
            _push2(`<ol class="ed-doc__substeps" start="3" data-v-5ba1adad${_scopeId}><li data-v-5ba1adad${_scopeId}>Navigate to the <strong data-v-5ba1adad${_scopeId}>Domain Users</strong> section of your organisation.</li><li data-v-5ba1adad${_scopeId}>Click <strong data-v-5ba1adad${_scopeId}>+ New Domain User</strong>.</li><li data-v-5ba1adad${_scopeId}>Select the System as <strong data-v-5ba1adad${_scopeId}>AlTareq Trust Framework</strong> and select the relevant user role — <strong data-v-5ba1adad${_scopeId}>PTC</strong>, <strong data-v-5ba1adad${_scopeId}>PBC</strong>, <strong data-v-5ba1adad${_scopeId}>STC</strong>, or <strong data-v-5ba1adad${_scopeId}>SBC</strong>.</li><li data-v-5ba1adad${_scopeId}>Enter the new user&#39;s email address and confirm.</li></ol>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The invited user will receive an email with a registration link. They must use the same email address to complete registration. For a full walkthrough of what the user must do next, see <a href="/tech/lfi-api-hub/trust-framework/user-sign-up" data-v-5ba1adad${_scopeId2}>Sign Up</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, { type: "tip" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-5ba1adad${_scopeId2}>If a user does not receive the invitation email, ask them to check their spam folder.</p>`);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/trust-framework/adding-users.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const addingUsers = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5ba1adad"]]);
export {
