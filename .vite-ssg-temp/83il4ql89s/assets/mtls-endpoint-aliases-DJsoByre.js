...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-f7877bf1>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-f7877bf1${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-f7877bf1${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_EdNote, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-f7877bf1${_scopeId}>This is an FYI article. On the current sandbox the values inside <code data-v-f7877bf1${_scopeId}>mtls_endpoint_aliases</code> are identical to the top-level endpoints, so a TPP that ignores this object will work today. The article exists so that the day an LFI separates the two, you already know what to look for.</p>`);
          } else {
            return [
              createVNode("p", null, [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-f7877bf1${_scopeId2}>mtls_endpoint_aliases</code> comes from <a href="https://datatracker.ietf.org/doc/html/rfc8705#section-5" data-v-f7877bf1${_scopeId2}>RFC 8705 §5</a> — <em data-v-f7877bf1${_scopeId2}>OAuth 2.0 Mutual-TLS Client Authentication and Certificate-Bound Access Tokens</em>.`);
                } else {
                  return [
                    createVNode("code", null, "mtls_endpoint_aliases"),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`When <code data-v-f7877bf1${_scopeId2}>tls_client_certificate_bound_access_tokens: true</code> is set (as it is in UAE Open Finance), all token-related calls — <code data-v-f7877bf1${_scopeId2}>/par</code>, <code data-v-f7877bf1${_scopeId2}>/token</code>, <code data-v-f7877bf1${_scopeId2}>/introspection</code>, <code data-v-f7877bf1${_scopeId2}>/revocation</code> — must be made with your transport certificate so the issued token can be cryptographically bound to the cert. The aliases let the AS publish a separate URL set for those mTLS-bound calls if it ever needs to.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`In UAE Open Finance today, the values inside <code data-v-f7877bf1${_scopeId2}>mtls_endpoint_aliases</code> are <strong data-v-f7877bf1${_scopeId2}>identical</strong> to the top-level values. Posting your PAR or token request to either URL works equivalently and produces the same cert-bound token.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The same pattern applies to <code data-v-f7877bf1${_scopeId2}>introspection_endpoint</code> and <code data-v-f7877bf1${_scopeId2}>revocation_endpoint</code>.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-f7877bf1${_scopeId2}>The <code data-v-f7877bf1${_scopeId2}>authorization_endpoint</code> is browser-driven (the end user is redirected there) — it is not an mTLS call and does not appear in <code data-v-f7877bf1${_scopeId2}>mtls_endpoint_aliases</code>. Always use the top-level value.</li><li data-v-f7877bf1${_scopeId2}>You do not need to call discovery twice or maintain two endpoint sets in code. One discovery fetch with the alias-fallback pattern above is enough.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      createTextVNode("The "),
...
const mtlsEndpointAliases = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f7877bf1"]]);
export {
