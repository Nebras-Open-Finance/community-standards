...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-4737ffa4><section class="ed-doc__hero" data-v-4737ffa4><div class="ed-doc__inner" data-v-4737ffa4><div class="ed-doc__eyebrow" data-v-4737ffa4><span class="ed-doc__eyebrow-dash" data-v-4737ffa4></span> Banking · Service Initiation · Single Instant Payment · UX </div><h1 class="ed-doc__title" data-v-4737ffa4> Single Instant Payment — User Experience <span class="ed-doc__read" data-v-4737ffa4>4 min read</span></h1><p class="ed-doc__lede" data-v-4737ffa4> Before a customer authorises a payment through Open Finance, you must present a <strong data-v-4737ffa4>Consent Page</strong> that clearly explains the payment they are consenting to. This page must accurately reflect the payee, amount, schedule, and all material terms of the payment consent. The examples and interactive wireframes below define the expected structure, content, and behaviour of the Consent Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-4737ffa4> While you may adapt visual elements such as colour palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the payment information shown, and the representation of <strong data-v-4737ffa4>AlTareq</strong> (including logos, naming, and action buttons) must be preserved. The customer must always be able to clearly understand what payment they are consenting to and that it is part of the AlTareq ecosystem. Your Consent Page must be submitted as part of <strong data-v-4737ffa4>CX certification</strong> prior to production, and any material changes to a production Consent Page must be re-submitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the request body fields below and watch the <strong data-v-4737ffa4${_scopeId2}>Consent</strong> and <strong data-v-4737ffa4${_scopeId2}>Authorisation</strong> page previews update live. `);
                } else {
                  return [
            ...
            _push2(`<div class="sim-card" data-v-4737ffa4${_scopeId}><div class="sim-card__head" data-v-4737ffa4${_scopeId}>Simulated Accounts Behaviour</div><div class="sim-card__body" data-v-4737ffa4${_scopeId}><label class="sim-card__row" data-v-4737ffa4${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(simulateDuplicatePayment)) ? ssrLooseContain(unref(simulateDuplicatePayment), null) : unref(simulateDuplicatePayment)) ? " checked" : ""} data-v-4737ffa4${_scopeId}><span data-v-4737ffa4${_scopeId}>Duplicate Payment Alert</span></label><label class="sim-card__row" data-v-4737ffa4${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(simulatePaymentLimitExceeded)) ? ssrLooseContain(unref(simulatePaymentLimitExceeded), null) : unref(simulatePaymentLimitExceeded)) ? " checked" : ""} data-v-4737ffa4${_scopeId}><span data-v-4737ffa4${_scopeId}>Payment Limit Exceeded</span></label><label class="sim-card__row" data-v-4737ffa4${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(simulateAlreadyTrustedPayee)) ? ssrLooseContain(unref(simulateAlreadyTrustedPayee), null) : unref(simulateAlreadyTrustedPayee)) ? " checked" : ""} data-v-4737ffa4${_scopeId}><span data-v-4737ffa4${_scopeId}>Already a Trusted Payee</span></label></div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/single-instant-payment/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4737ffa4"]]);
export {
