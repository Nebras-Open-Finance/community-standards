import { _ as __unplugin_components_2, a as __unplugin_components_1 } from "./ConsentPeriodicSchedule-BPOYiTnI.js";
...
import { _ as __unplugin_components_3 } from "./ServiceInitiationPermissionText-D2yhOB-_.js";
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  ...
  const _component_ConsentPeriodicSchedule = __unplugin_components_1;
  const _component_AuthorizationPeriodicSchedule = __unplugin_components_2;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "wf-frame" }, _attrs))} data-v-8c125901>`);
  _push(ssrRenderComponent(_component_ConsentAuthLayout, null, {
    consent: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_ConsentPeriodicSchedule, null, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_ConsentPeriodicSchedule)
        ];
      }
    }),
    auth: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_AuthorizationPeriodicSchedule, null, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_AuthorizationPeriodicSchedule)
        ];
      }
    }),
    _: 1
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-periodic-schedule/_shared/WireframePreview.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const WireframePreview = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-8c125901"]]);
const _sfc_main$2 = {};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-periodic-schedule/_shared/AccountSetup.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_EdProse, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<strong${_scopeId}>Per-period limits</strong> (set at <code${_scopeId}>ControlParameters.ConsentSchedule.MultiPayment.PeriodicSchedule</code>):`);
      } else {
        return [
          createVNode("strong", null, "Per-period limits"),
          createTextVNode(" (set at "),
          createVNode("code", null, "ControlParameters.ConsentSchedule.MultiPayment.PeriodicSchedule"),
          createTextVNode("):")
        ];
      }
    }),
  ...
  _push(ssrRenderComponent(_component_EdRefTable, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<table${_scopeId}><thead${_scopeId}><tr${_scopeId}><th${_scopeId}>Field</th><th${_scopeId}>UI Label</th><th${_scopeId}>Behaviour</th></tr></thead><tbody${_scopeId}><tr${_scopeId}><td${_scopeId}><code${_scopeId}>Amount</code></td><td${_scopeId}><em${_scopeId}>Per Payment</em></td><td${_scopeId}>The amount allowed for a single payment. Always shown.</td></tr><tr${_scopeId}><td${_scopeId}><em${_scopeId}>(implicit)</em></td><td${_scopeId}><em${_scopeId}>Payments per Period</em></td><td${_scopeId}>Only 1 payment is allowed per period. Always shown.</td></tr></tbody></table>`);
      } else {
        return [
          createVNode("table", null, [
            createVNode("thead", null, [
            ...
            createVNode("tbody", null, [
              createVNode("tr", null, [
                ...
                createVNode("td", null, [
                  createVNode("em", null, "Per Payment")
                ]),
                createVNode("td", null, "The amount allowed for a single payment. Always shown.")
              ]),
              createVNode("tr", null, [
                createVNode("td", null, [
                ...
                createVNode("td", null, [
                  createVNode("em", null, "Payments per Period")
                ]),
                createVNode("td", null, "Only 1 payment is allowed per period. Always shown.")
              ])
            ])
          ])
        ];
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-periodic-schedule/_shared/UIBehaviour.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_ImageViewer, {
    src: "/images/user-experience/fixed-periodic-schedule/1.png",
    alt: "variable-periodic-schedule"
  }, null, _parent));
  _push(`<h3>Example 2 — Account Selected at LFI</h3>`);
  _push(ssrRenderComponent(_component_ImageViewer, {
    src: "/images/user-experience/fixed-periodic-schedule/2.png",
    alt: "variable-periodic-schedule"
  }, null, _parent));
  _push(`<h3>Example 3 — Account Selected at LFI (Less Control Parameters)</h3>`);
  _push(ssrRenderComponent(_component_ImageViewer, {
    src: "/images/user-experience/fixed-periodic-schedule/3.png",
    alt: "fixed-periodic-schedule"
  }, null, _parent));
  _push(`<!--]-->`);
}
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-periodic-schedule/_shared/ExampleJourneys.vue");
