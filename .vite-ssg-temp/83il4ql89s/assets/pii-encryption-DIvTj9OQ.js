...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-2e729bdb>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-2e729bdb${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-2e729bdb${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The core reason is <strong data-v-2e729bdb${_scopeId2}>data privacy</strong>: the PII inside a payment consent contains account holder names, IBANs, and other personal details that have no business being visible to any party other than the LFI processing the payment.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-2e729bdb${_scopeId2}><thead data-v-2e729bdb${_scopeId2}><tr data-v-2e729bdb${_scopeId2}><th data-v-2e729bdb${_scopeId2}>When</th><th data-v-2e729bdb${_scopeId2}>Where</th><th data-v-2e729bdb${_scopeId2}>Contains</th></tr></thead><tbody data-v-2e729bdb${_scopeId2}><tr data-v-2e729bdb${_scopeId2}><td data-v-2e729bdb${_scopeId2}>Consent creation</td><td data-v-2e729bdb${_scopeId2}><code data-v-2e729bdb${_scopeId2}>POST /par</code> — inside <code data-v-2e729bdb${_scopeId2}>authorization_details</code></td><td data-v-2e729bdb${_scopeId2}>Debtor account details, creditor account(s), risk indicators</td></tr><tr data-v-2e729bdb${_scopeId2}><td data-v-2e729bdb${_scopeId2}>Each payment request</td><td data-v-2e729bdb${_scopeId2}><code data-v-2e729bdb${_scopeId2}>POST /payments</code></td><td data-v-2e729bdb${_scopeId2}>The specific creditor for that payment, risk indicators</td></tr></tbody></table>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-2e729bdb${_scopeId2}>Confirming that the PII payload conforms to the schema (<code data-v-2e729bdb${_scopeId2}>AEDomesticPaymentPIIProperties</code> for domestic payments).</li><li data-v-2e729bdb${_scopeId2}>Validating mandatory fields — at minimum <code data-v-2e729bdb${_scopeId2}>CreditorAccount.Identification</code> (a valid UAE IBAN) and at least one of <code data-v-2e729bdb${_scopeId2}>CreditorAccount.Name.en</code> or <code data-v-2e729bdb${_scopeId2}>CreditorAccount.Name.ar</code>.</li><li data-v-2e729bdb${_scopeId2}>Comparing the creditor supplied at <code data-v-2e729bdb${_scopeId2}>POST /payments</code> against the creditor(s) recorded in the consent PII, and rejecting the payment if they do not match.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Because PII validation happens entirely inside the LFI after decryption, errors in the encrypted payload <strong data-v-2e729bdb${_scopeId2}>are not caught centrally</strong>. A consent or payment may be accepted by the API Hub and then rejected by the LFI.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2e729bdb${_scopeId2}>A successful <code data-v-2e729bdb${_scopeId2}>POST /par</code> response only means the API Hub accepted the request — it does not mean the LFI successfully decrypted and validated the PII inside it.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-2e729bdb${_scopeId}>Single-beneficiary payment types</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The following payment types accept <strong data-v-2e729bdb${_scopeId2}>exactly one creditor entry</strong> in <code data-v-2e729bdb${_scopeId2}>Initiation.Creditor[]</code>. The consent is bound to that single recipient — all payments under the consent must go to that account.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-2e729bdb${_scopeId2}>Single Instant Payment</li><li data-v-2e729bdb${_scopeId2}>Fixed Defined Schedule</li><li data-v-2e729bdb${_scopeId2}>Variable Defined Schedule</li><li data-v-2e729bdb${_scopeId2}>Fixed On-Demand</li><li data-v-2e729bdb${_scopeId2}>Fixed Periodic Schedule</li><li data-v-2e729bdb${_scopeId2}>Variable Periodic Schedule</li>`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-2e729bdb${_scopeId}>Flexible beneficiary payment types</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-2e729bdb${_scopeId2}><thead data-v-2e729bdb${_scopeId2}><tr data-v-2e729bdb${_scopeId2}><th data-v-2e729bdb${_scopeId2}>Model</th><th data-v-2e729bdb${_scopeId2}><code data-v-2e729bdb${_scopeId2}>Initiation.Creditor[]</code></th><th data-v-2e729bdb${_scopeId2}>Effect</th></tr></thead><tbody data-v-2e729bdb${_scopeId2}><tr data-v-2e729bdb${_scopeId2}><td data-v-2e729bdb${_scopeId2}><strong data-v-2e729bdb${_scopeId2}>Open beneficiary</strong></td><td data-v-2e729bdb${_scopeId2}>Omitted</td><td data-v-2e729bdb${_scopeId2}>No creditor fixed at consent time — each <code data-v-2e729bdb${_scopeId2}>POST /payments</code> specifies a fresh creditor</td></tr><tr data-v-2e729bdb${_scopeId2}><td data-v-2e729bdb${_scopeId2}><strong data-v-2e729bdb${_scopeId2}>Single beneficiary</strong></td><td data-v-2e729bdb${_scopeId2}>1 entry</td><td data-v-2e729bdb${_scopeId2}>All payments under the consent go to that one account</td></tr><tr data-v-2e729bdb${_scopeId2}><td data-v-2e729bdb${_scopeId2}><strong data-v-2e729bdb${_scopeId2}>Multiple beneficiaries</strong></td><td data-v-2e729bdb${_scopeId2}>2–10 entries</td><td data-v-2e729bdb${_scopeId2}>Each payment specifies one of the pre-approved accounts</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-2e729bdb${_scopeId2}><strong data-v-2e729bdb${_scopeId2}>Variable On-Demand</strong></li><li data-v-2e729bdb${_scopeId2}><strong data-v-2e729bdb${_scopeId2}>Delegated SCA</strong></li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`See <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/creditor" data-v-2e729bdb${_scopeId2}>Creditor</a> for the full matching rules and field validation requirements, and <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/" data-v-2e729bdb${_scopeId2}>Personal Identifiable Information</a> for the complete schema reference.`);
                } else {
                  return [
                    createTextVNode("See "),
...
const piiEncryption = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2e729bdb"]]);
export {
