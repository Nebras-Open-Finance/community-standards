...
The table below lists the validation rules that apply to a Fixed Periodic Schedule consent. The **Validated by** column indicates where each rule is enforced.
