  ...
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede ed-doc__lede--tight">
          ...
          <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/#connectivity-validation">onboarding connectivity validation</a>,
    ...
    >
      <EdBullets>
        <li>
          ...
          Connect server. See
          <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/#connectivity-validation">Environment Specific &mdash; end-to-end validation</a>.
        </li>
        <li>
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/#optional-api-family-base-paths">Environment Specific &mdash; optional API family base paths</a>.
      </EdProse>
    </EdSectionBand>
  </div>
</template>
