...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-bfcef41e><section class="ed-doc__hero" data-v-bfcef41e><div class="ed-doc__inner" data-v-bfcef41e><div class="ed-doc__eyebrow" data-v-bfcef41e><span class="ed-doc__eyebrow-dash" data-v-bfcef41e></span> LFI · Banking · Service Initiation · PII · API Guide </div><h1 class="ed-doc__title" data-v-bfcef41e> How to Decrypt PII <span class="ed-doc__read" data-v-bfcef41e>5 min read</span></h1><p class="ed-doc__lede" data-v-bfcef41e> The <code data-v-bfcef41e>PersonalIdentifiableInformation</code> field is a compact JWE (JSON Web Encryption) string. It was encrypted by the TPP using your LFI&#39;s public encryption key (<a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/#enc1-encryption-key" data-v-bfcef41e>Enc1</a>). To decrypt it, you need the corresponding <strong data-v-bfcef41e>Enc1 private key</strong>. </p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-bfcef41e${_scopeId2}><thead data-v-bfcef41e${_scopeId2}><tr data-v-bfcef41e${_scopeId2}><th data-v-bfcef41e${_scopeId2}>Where the PII reaches you</th><th data-v-bfcef41e${_scopeId2}>Age of the PII</th><th data-v-bfcef41e${_scopeId2}>Pattern</th></tr></thead><tbody data-v-bfcef41e${_scopeId2}><tr data-v-bfcef41e${_scopeId2}><td data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>POST /consent/action/validate</code></td><td data-v-bfcef41e${_scopeId2}>Seconds</td><td data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}>A</strong> — at creation</td></tr><tr data-v-bfcef41e${_scopeId2}><td data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>POST /consent/event/post</code></td><td data-v-bfcef41e${_scopeId2}>Seconds</td><td data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}>A</strong> — at creation</td></tr><tr data-v-bfcef41e${_scopeId2}><td data-v-bfcef41e${_scopeId2}>The consent authorisation journey</td><td data-v-bfcef41e${_scopeId2}>Minutes to hours</td><td data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}>B</strong> — later</td></tr><tr data-v-bfcef41e${_scopeId2}><td data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>POST /consent/event/patch</code></td><td data-v-bfcef41e${_scopeId2}>Minutes to hours</td><td data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}>B</strong> — later</td></tr><tr data-v-bfcef41e${_scopeId2}><td data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>POST /payments</code></td><td data-v-bfcef41e${_scopeId2}>Up to the consent lifetime</td><td data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}>B</strong> — later</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-bfcef41e${_scopeId}>Pattern A — decrypt at consent creation</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-bfcef41e${_scopeId2}>/consent/action/validate</code> is called by the API Hub synchronously, inside the TPP’s PAR request and before the consent exists. The PII is at most seconds old, and the <code data-v-bfcef41e${_scopeId2}>post</code> consent event fires at the same moment in the lifecycle. Nothing can have rotated in between, so: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-bfcef41e${_scopeId2}>The <code data-v-bfcef41e${_scopeId2}>kid</code> in the JWE header names an Enc1 key you currently hold.</li><li data-v-bfcef41e${_scopeId2}>If you verify the TPP’s signature, the TPP’s <strong data-v-bfcef41e${_scopeId2}>active</strong> JWKS is sufficient.</li><li data-v-bfcef41e${_scopeId2}>The JWS <code data-v-bfcef41e${_scopeId2}>exp</code>, <code data-v-bfcef41e${_scopeId2}>iat</code> and <code data-v-bfcef41e${_scopeId2}>nbf</code> claims can be evaluated against the current time, because now <em data-v-bfcef41e${_scopeId2}>is</em> the moment of signing. Library defaults are correct here.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      createTextVNode("The "),
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-bfcef41e${_scopeId}>Pattern B — decrypt later</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}>Your own Enc1 key.</strong> The JWE was encrypted to whichever Enc1 public key you had published when the consent was created. The recommended <strong data-v-bfcef41e${_scopeId2}>Server ENCKEY</strong> certificate type does not expire, so routine rotation is avoided — but if you do replace Enc1, you MUST retain the retired private key for as long as consents encrypted under it remain in force. Step 1 below exists for exactly this reason: resolve the private key from the <code data-v-bfcef41e${_scopeId2}>kid</code>, never from “the current one”. </li><li data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}>The TPP’s signing key</strong> — only if you verify the signature. TPPs rotate signing keys freely and without notice, and a rotated <code data-v-bfcef41e${_scopeId2}>kid</code> leaves the active JWKS. Resolve the <code data-v-bfcef41e${_scopeId2}>kid</code> against the active set and then against the <code data-v-bfcef41e${_scopeId2}>inactive/</code> set, and pin <code data-v-bfcef41e${_scopeId2}>PS256</code> yourself — published JWKS entries carry no <code data-v-bfcef41e${_scopeId2}>alg</code>. </li><li data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}>The timing claims.</strong> <code data-v-bfcef41e${_scopeId2}>exp</code>, <code data-v-bfcef41e${_scopeId2}>iat</code> and <code data-v-bfcef41e${_scopeId2}>nbf</code> on the PII JWS bound the <strong data-v-bfcef41e${_scopeId2}>PAR submission window</strong> — the moment the TPP created the consent — not the moment you are decrypting. On a long-lived consent they will normally have lapsed. Evaluate them against the consent’s <code data-v-bfcef41e${_scopeId2}>CreationDateTime</code>, or do not evaluate them at all. Whether the consent is still usable today is answered by the API Hub’s consent validation on every request, not by a claim inside the PII. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-bfcef41e${_scopeId2}><a href="/knowledge-base/articles/pii-signature-verification" data-v-bfcef41e${_scopeId2}>Verifying the PII Signature — Rotated Keys and the Inactive JWKS</a> covers the signing-key half of Pattern B in full: the active and <code data-v-bfcef41e${_scopeId2}>inactive/</code> keystore URL pair, the lookup order, and what membership of the inactive set does and does not tell you. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The JWE protected header contains the <code data-v-bfcef41e${_scopeId2}>kid</code> (Key ID) of the encryption key that was used. Decode the first segment of the JWE to identify which private key to use — under <a href="#two-patterns" data-v-bfcef41e${_scopeId2}>Pattern B</a> this may be a retired Enc1 key rather than your current one, so always resolve by <code data-v-bfcef41e${_scopeId2}>kid</code>: `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-bfcef41e${_scopeId2}> The JWS is signed by the TPP. You may optionally verify this signature against the TPP&#39;s public signing key. However, this is <strong data-v-bfcef41e${_scopeId2}>not required</strong> — the entire request containing the PII field is itself sent as a JWS that the API Hub has already verified was signed by the TPP. The PII therefore cannot have been tampered with in transit. </p><p data-v-bfcef41e${_scopeId2}> If you choose to implement JWS verification for defence-in-depth, see <a href="./verify-tpp-signature" data-v-bfcef41e${_scopeId2}>Verify TPP Signature (Optional)</a>. Under <a href="#two-patterns" data-v-bfcef41e${_scopeId2}>Pattern B</a> you must also resolve the signing <code data-v-bfcef41e${_scopeId2}>kid</code> against the TPP’s <code data-v-bfcef41e${_scopeId2}>inactive/</code> JWKS, and stop your library checking <code data-v-bfcef41e${_scopeId2}>exp</code>, <code data-v-bfcef41e${_scopeId2}>iat</code> and <code data-v-bfcef41e${_scopeId2}>nbf</code> against the current time — see <a href="/knowledge-base/articles/pii-signature-verification" data-v-bfcef41e${_scopeId2}>Verifying the PII Signature</a>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-bfcef41e${_scopeId2}><thead data-v-bfcef41e${_scopeId2}><tr data-v-bfcef41e${_scopeId2}><th data-v-bfcef41e${_scopeId2}>Stage</th><th data-v-bfcef41e${_scopeId2}>Spec file</th><th data-v-bfcef41e${_scopeId2}>Schema</th></tr></thead><tbody data-v-bfcef41e${_scopeId2}><tr data-v-bfcef41e${_scopeId2}><td data-v-bfcef41e${_scopeId2}>Consent</td><td data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>uae-api-hub-consent-manager-openapi.yaml</code></td><td data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>AEBankServiceInitiationRichAuthorizationRequests.AEDomesticPaymentPII</code></td></tr><tr data-v-bfcef41e${_scopeId2}><td data-v-bfcef41e${_scopeId2}>Payment</td><td data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>uae-ozone-connect-bank-service-initiation-openapi.yaml</code></td><td data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>AEBankServiceInitiation.AEDomesticPaymentPIIProperties</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-bfcef41e${_scopeId}>Obtaining the OpenAPI specification</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<p data-v-bfcef41e${_scopeId}><a href="https://github.com/Nebras-Open-Finance/api-specs" target="_blank" rel="noopener" class="ed-doc__github-link" data-v-bfcef41e${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="18" height="18" aria-hidden="true" data-v-bfcef41e${_scopeId}><path d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.31 2.69.94 0 .67.01 1.3.01 1.49 0 .21-.15.45-.55.38A7.995 7.995 0 0 1 0 8c0-4.42 3.58-8 8-8Z" data-v-bfcef41e${_scopeId}></path></svg> Nebras-Open-Finance/api-specs </a></p>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Spec files are located under <code data-v-bfcef41e${_scopeId2}>dist/</code> by category:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-bfcef41e${_scopeId2}><thead data-v-bfcef41e${_scopeId2}><tr data-v-bfcef41e${_scopeId2}><th data-v-bfcef41e${_scopeId2}>Stage</th><th data-v-bfcef41e${_scopeId2}>Path</th></tr></thead><tbody data-v-bfcef41e${_scopeId2}><tr data-v-bfcef41e${_scopeId2}><td data-v-bfcef41e${_scopeId2}>Consent</td><td data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>dist/api-hub/{version}/openapi/uae-api-hub-consent-manager-openapi.yaml</code></td></tr><tr data-v-bfcef41e${_scopeId2}><td data-v-bfcef41e${_scopeId2}>Payment</td><td data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>dist/ozone-connect/{version}/openapi/uae-ozone-connect-bank-service-initiation-openapi.yaml</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-bfcef41e${_scopeId2}> Specifications may have errata releases (e.g. <code data-v-bfcef41e${_scopeId2}>v2.1.x-errata1</code>) that contain targeted corrections. When multiple version folders exist for the same major.minor version, use the <strong data-v-bfcef41e${_scopeId2}>highest errata</strong> that contains the file you need. If a file is not present in an errata folder, fall back to the base version. Always check for errata before bundling a spec into your service. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-bfcef41e${_scopeId}>Validating against the schema</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Extract the relevant <code data-v-bfcef41e${_scopeId2}>components/schemas</code> entry from the YAML file and validate the decrypted PII payload against it. The PII schemas in the OpenAPI specification already declare the constraints needed for validation: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>additionalProperties: false</code></strong> is set at every level of the PII schema — any unexpected fields will cause validation to fail.</li><li data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>required</code> arrays</strong> are declared on sub-schemas (e.g. <code data-v-bfcef41e${_scopeId2}>CreditorAccount</code> is required on each creditor entry, <code data-v-bfcef41e${_scopeId2}>SchemeName</code> and <code data-v-bfcef41e${_scopeId2}>Identification</code> are required on account objects) — missing mandatory fields will cause validation to fail.</li><li data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>enum</code> constraints</strong> restrict values to allowed options (e.g. <code data-v-bfcef41e${_scopeId2}>SchemeName</code> must be <code data-v-bfcef41e${_scopeId2}>IBAN</code>).</li><li data-v-bfcef41e${_scopeId2}><strong data-v-bfcef41e${_scopeId2}><code data-v-bfcef41e${_scopeId2}>$ref</code> pointers</strong> link to nested schemas (creditor, debtor, risk). For validation to work correctly, all <code data-v-bfcef41e${_scopeId2}>components/schemas</code> entries from the spec MUST be registered with the validator so that <code data-v-bfcef41e${_scopeId2}>$ref</code> pointers resolve.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When you register the full set of component schemas and compile the PII schema, standard JSON Schema validators (<code data-v-bfcef41e${_scopeId2}>ajv</code> for Node.js, <code data-v-bfcef41e${_scopeId2}>jsonschema</code> for Python) will enforce all of these constraints automatically. No custom validation logic is needed for schema conformance — the OpenAPI spec is the single source of truth. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-bfcef41e${_scopeId2}> If the decrypted PII fails schema validation, the LFI MUST reject the consent or payment. Do not attempt to process a payment with malformed PII — return an appropriate error response. See <a href="../" data-v-bfcef41e${_scopeId2}>Personal Identifiable Information</a> for the full set of validation rules. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` This example resolves the Enc1 private key from the JWE <code data-v-bfcef41e${_scopeId2}>kid</code>, so it is correct under both patterns. It does not verify the TPP’s signature; if you add that step, follow <a href="#two-patterns" data-v-bfcef41e${_scopeId2}>Pattern B</a> unless you are certain the code path only ever runs at consent creation. `);
                } else {
                  return [
...
const decryptPii = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bfcef41e"]]);
export {
