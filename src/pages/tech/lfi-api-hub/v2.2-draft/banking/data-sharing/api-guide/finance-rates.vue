  ...
  <div class="ed-doc">
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-products">
          ...
          <tbody>
            <tr>
              ...
              <td>The LFI persists consent records locally as the Hub calls
                  <a href="/tech/lfi-api-hub/v2.2-draft/consent-events/api-guide"><code>/consent/event/{operation}</code></a>
            ...
            <tr>
              ...
              <td>The LFI calls
                  <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/consents-consentId">
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/api-guide/finance-rates">TPP API
    ...
    >
      ...
      <EdNote type="info" title="The Hub passes 429 through unchanged">
        <p>
          ...
          corresponding <a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/api-guide/finance-rates#rate-limits">TPP API guide</a>
