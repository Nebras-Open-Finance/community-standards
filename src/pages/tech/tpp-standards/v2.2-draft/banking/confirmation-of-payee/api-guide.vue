...
<template>
  <div class="ed-doc">
    ...
    >
      <div class="ed-doc__endpoint">
        <span class="http-badge http-post">POST</span>
        <code class="ed-doc__endpoint-path">/open-finance/confirmation-of-payee/v2.2/confirmation</code>
      </div>
    ...
    >
      ...
      <EdProse>
        See <a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/personal-identifiable-information/creditor">Creditor</a>
        for the full PII creditor schema and the creditor models (single, multiple, and open beneficiary).
      </EdProse>

      <EdProse>
        See <a href="/tech/tpp-standards/v2.2-draft/banking/confirmation-of-payee/user-journeys">Confirmation of
