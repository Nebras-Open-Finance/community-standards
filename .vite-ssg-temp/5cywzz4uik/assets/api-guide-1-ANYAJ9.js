  ...
  setup(__props) {
    ...
    const altOps = [
      ...
      },
      {
        ...
        href: "/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/accounts-accountId-consents",
        useWhen: "You need all consents linked to a specific account"
      },
      {
        method: "GET",
        path: "/consents",
        href: "/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents",
    ...
    const dataSharingRows = [
      ...
      },
      {
        ...
        guidelines: 'Map to user-friendly label per <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/bank-service-initiation/requirements#status-labels">Status labels</a>.'
      },
      {
        num: 5,
        field: "Consent ID",
    ...
    const sipRows = [
      ...
      },
      {
        ...
        guidelines: 'The displayed properties depend on the values found in control parameters, which differ by payment type. Refer to the <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/psu-userId-consents">API spec</a> for available properties.'
      },
      {
        num: 11,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-7843475e><section class="ed-doc__hero" data-v-7843475e><div class="ed-doc__inner" data-v-7843475e><div class="ed-doc__eyebrow" data-v-7843475e><span class="ed-doc__eyebrow-dash" data-v-7843475e></span> LFI · Consent Management Interface · API Guide </div><h1 class="ed-doc__title" data-v-7843475e> Consent Management Interface — API Guide <span class="ed-doc__read" data-v-7843475e>6 min read</span></h1><p class="ed-doc__lede" data-v-7843475e> This guide explains how to use the API Hub&#39;s Consent Manager API to retrieve and manage the data needed to populate each page of the LFI Consent Management Interface (CMI). See the per-product Requirements pages (<a href="/tech/lfi-api-hub/v2.1/consent-management-interface/bank-data-sharing/requirements" data-v-7843475e>Bank Data Sharing</a>, <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/bank-service-initiation/requirements" data-v-7843475e>Bank Service Initiation</a>, <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/insurance-data-sharing/requirements" data-v-7843475e>Insurance Data Sharing</a>) for what each page must display, and the matching User Experience pages for interactive wireframes. </p></div></section>`);
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<ol class="ed-doc__steps" data-v-7843475e${_scopeId}><li data-v-7843475e${_scopeId}> Have a working mTLS connection to the API Hub — verify with <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/hello-mtls" class="endpoint" data-v-7843475e${_scopeId}><span class="http-method http-method--get" data-v-7843475e${_scopeId}>GET</span><code data-v-7843475e${_scopeId}>/hello-mtls</code></a></li><li data-v-7843475e${_scopeId}> Patch the end user identifier onto each consent using <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/patch-consents-consentId" class="endpoint" data-v-7843475e${_scopeId}><span class="http-method http-method--patch" data-v-7843475e${_scopeId}>PATCH</span><code data-v-7843475e${_scopeId}>/consents/{consentId}</code></a> so that consents can be retrieved by user </li></ol>`);
          } else {
            return [
              ...
              createVNode("ol", { class: "ed-doc__steps" }, [
                createVNode("li", null, [
                  ...
                  createVNode("a", {
                    href: "/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/hello-mtls",
                    class: "endpoint"
                  }, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="ed-doc__endpoint" data-v-7843475e${_scopeId}><span class="http-badge http-get" data-v-7843475e${_scopeId}>GET</span><a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/psu-userId-consents" class="ed-doc__endpoint-path" data-v-7843475e${_scopeId}><code data-v-7843475e${_scopeId}>/psu/{userId}/consents</code></a></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` where <code data-v-7843475e${_scopeId2}>userId</code> is the LFI&#39;s unique identifier for the customer. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The response returns a paginated array of consent objects. Each consent object contains the fields needed to populate the dashboard cards and detail pages described in the per-product Requirements pages (<a href="/tech/lfi-api-hub/v2.1/consent-management-interface/bank-data-sharing/requirements" data-v-7843475e${_scopeId2}>Bank Data Sharing</a>, <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/bank-service-initiation/requirements" data-v-7843475e${_scopeId2}>Bank Service Initiation</a>, <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/insurance-data-sharing/requirements" data-v-7843475e${_scopeId2}>Insurance Data Sharing</a>). `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__sub" data-v-7843475e${_scopeId}>Query parameters</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7843475e${_scopeId2}><thead data-v-7843475e${_scopeId2}><tr data-v-7843475e${_scopeId2}><th data-v-7843475e${_scopeId2}>Parameter</th><th data-v-7843475e${_scopeId2}>Required</th><th data-v-7843475e${_scopeId2}>Description</th></tr></thead><tbody data-v-7843475e${_scopeId2}><!--[-->`);
                  ssrRenderList(queryParams, (q) => {
                    _push3(`<tr data-v-7843475e${_scopeId2}><td data-v-7843475e${_scopeId2}><code data-v-7843475e${_scopeId2}>${ssrInterpolate(q.name)}</code></td><td data-v-7843475e${_scopeId2}>${ssrInterpolate(q.required ? "Yes" : "No")}</td><td data-v-7843475e${_scopeId2}>${ssrInterpolate(q.description)}</td></tr>`);
                  });
                  _push3(`<!--]--></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__sub" data-v-7843475e${_scopeId}>Alternative retrieval operations</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7843475e${_scopeId2}><thead data-v-7843475e${_scopeId2}><tr data-v-7843475e${_scopeId2}><th data-v-7843475e${_scopeId2}>Operation</th><th data-v-7843475e${_scopeId2}>Use when</th></tr></thead><tbody data-v-7843475e${_scopeId2}><!--[-->`);
                  ssrRenderList(altOps, (op) => {
                    _push3(`<tr data-v-7843475e${_scopeId2}><td data-v-7843475e${_scopeId2}><span class="${ssrRenderClass([`http-${op.method.toLowerCase()}`, "http-badge"])}" data-v-7843475e${_scopeId2}>${ssrInterpolate(op.method)}</span><a${ssrRenderAttr("href", op.href)} data-v-7843475e${_scopeId2}><code data-v-7843475e${_scopeId2}>${ssrInterpolate(op.path)}</code></a></td><td data-v-7843475e${_scopeId2}>${ssrInterpolate(op.useWhen)}</td></tr>`);
                  });
                  _push3(`<!--]--></tbody></table>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The sections below map each CMI field from the per-product Requirements (<a href="/tech/lfi-api-hub/v2.1/consent-management-interface/bank-data-sharing/requirements#dashboard-card-content" data-v-7843475e${_scopeId2}>Bank Data Sharing</a>, <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/bank-service-initiation/requirements#dashboard-card-content" data-v-7843475e${_scopeId2}>Bank Service Initiation</a>, <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/insurance-data-sharing/requirements#dashboard-card-content" data-v-7843475e${_scopeId2}>Insurance Data Sharing</a>) to the API response property and any transformation the LFI must apply. `);
                } else {
                  return [
                    createTextVNode(" The sections below map each CMI field from the per-product Requirements ("),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-management-interface/bank-data-sharing/requirements#dashboard-card-content" }, "Bank Data Sharing"),
                    createTextVNode(", "),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-management-interface/bank-service-initiation/requirements#dashboard-card-content" }, "Bank Service Initiation"),
                    createTextVNode(", "),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-management-interface/insurance-data-sharing/requirements#dashboard-card-content" }, "Insurance Data Sharing"),
            ...
            _push2(`<h3 class="ed-doc__sub" data-v-7843475e${_scopeId}>Data Sharing</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7843475e${_scopeId2}><thead data-v-7843475e${_scopeId2}><tr data-v-7843475e${_scopeId2}><th data-v-7843475e${_scopeId2}>#</th><th data-v-7843475e${_scopeId2}>CMI field</th><th data-v-7843475e${_scopeId2}>Operation</th><th data-v-7843475e${_scopeId2}>JSONPath</th><th data-v-7843475e${_scopeId2}>Guidelines</th></tr></thead><tbody data-v-7843475e${_scopeId2}><!--[-->`);
                  ssrRenderList(dataSharingRows, (r) => {
                    _push3(`<tr data-v-7843475e${_scopeId2}><td data-v-7843475e${_scopeId2}>${ssrInterpolate(r.num)}</td><td data-v-7843475e${_scopeId2}><strong data-v-7843475e${_scopeId2}>${ssrInterpolate(r.field)}</strong></td><td data-v-7843475e${_scopeId2}>${`<code>${r.operation}</code>` ?? ""}</td><td data-v-7843475e${_scopeId2}>${`<code>${r.jsonPath}</code>` ?? ""}</td><td data-v-7843475e${_scopeId2}>${r.guidelines ?? ""}</td></tr>`);
                  });
                  _push3(`<!--]--></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__sub" data-v-7843475e${_scopeId}>Single Instant Payment</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7843475e${_scopeId2}><thead data-v-7843475e${_scopeId2}><tr data-v-7843475e${_scopeId2}><th data-v-7843475e${_scopeId2}>#</th><th data-v-7843475e${_scopeId2}>CMI field</th><th data-v-7843475e${_scopeId2}>Operation</th><th data-v-7843475e${_scopeId2}>JSONPath</th><th data-v-7843475e${_scopeId2}>Guidelines</th></tr></thead><tbody data-v-7843475e${_scopeId2}><!--[-->`);
            ...
            _push2(`<h3 class="ed-doc__sub" data-v-7843475e${_scopeId}>Multi Payment (all subtypes)</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` To provide the <strong data-v-7843475e${_scopeId2}>List of Updates</strong> view described in the <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/bank-data-sharing/requirements#detail-page" data-v-7843475e${_scopeId2}>Bank Data Sharing Requirements</a>, use: `);
                } else {
                  return [
                    createTextVNode(" To provide the "),
                    createVNode("strong", null, "List of Updates"),
                    createTextVNode(" view described in the "),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-management-interface/bank-data-sharing/requirements#detail-page" }, "Bank Data Sharing Requirements"),
                    createTextVNode(", use: ")
                  ];
                }
              }),
            ...
            _push2(`<div class="ed-doc__endpoint" data-v-7843475e${_scopeId}><span class="http-badge http-get" data-v-7843475e${_scopeId}>GET</span><a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consent-groups-consentGroupId-consents" class="ed-doc__endpoint-path" data-v-7843475e${_scopeId}><code data-v-7843475e${_scopeId}>/consent-groups/{consentGroupId}/consents</code></a></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` where <code data-v-7843475e${_scopeId2}>consentGroupId</code> is the value of <code data-v-7843475e${_scopeId2}>BaseConsentId</code> on the current consent. `);
                } else {
                  return [
                    createTextVNode(" where "),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` This returns all consents in a consent group — consents that are linked by the same <code data-v-7843475e${_scopeId2}>BaseConsentId</code>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__sub" data-v-7843475e${_scopeId}>How <code data-v-7843475e${_scopeId}>BaseConsentId</code> works</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Connection history is driven by “revisions” to consents orchestrated by TPPs: an existing consent is replaced by a new consent with updated permissions or data-access terms. The TPP links the new consent to the original by setting <code data-v-7843475e${_scopeId2}>BaseConsentId</code> on the new consent to the <code data-v-7843475e${_scopeId2}>ConsentId</code> of the original consent. All subsequent consents sharing the same history use the same <code data-v-7843475e${_scopeId2}>BaseConsentId</code> value. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-7843475e${_scopeId2}> When a consent is created it contains no customer information — the end user identity is only added later when the LFI patches in the end user ID. This means two consents sharing the same <code data-v-7843475e${_scopeId2}>BaseConsentId</code> are <strong data-v-7843475e${_scopeId2}>not</strong> guaranteed to belong to the same customer. LFIs must ensure that only consents belonging to the same end user are returned when resolving related consents. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, { type: "info" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-7843475e${_scopeId2}> The <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId-audit" class="endpoint" data-v-7843475e${_scopeId2}><span class="http-method http-method--get" data-v-7843475e${_scopeId2}>GET</span><code data-v-7843475e${_scopeId2}>/consents/{consentId}/audit</code></a> operation is <strong data-v-7843475e${_scopeId2}>not</strong> the correct way to retrieve connection history. It relates to changes within a single consent, not changes across multiple consents linked by <code data-v-7843475e${_scopeId2}>BaseConsentId</code>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" The "),
                      createVNode("a", {
                        href: "/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId-audit",
                        class: "endpoint"
                      }, [
                        createVNode("span", { class: "http-method http-method--get" }, "GET"),
            ...
            _push2(`<h3 class="ed-doc__sub" data-v-7843475e${_scopeId}>Connection history — Data Sharing &amp; Insurance</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7843475e${_scopeId2}><thead data-v-7843475e${_scopeId2}><tr data-v-7843475e${_scopeId2}><th data-v-7843475e${_scopeId2}>#</th><th data-v-7843475e${_scopeId2}>CMI field</th><th data-v-7843475e${_scopeId2}>JSONPath</th><th data-v-7843475e${_scopeId2}>Guidelines</th></tr></thead><tbody data-v-7843475e${_scopeId2}><!--[-->`);
                  ssrRenderList(historyDataSharingRows, (r) => {
                    _push3(`<tr data-v-7843475e${_scopeId2}><td data-v-7843475e${_scopeId2}>${ssrInterpolate(r.num)}</td><td data-v-7843475e${_scopeId2}><strong data-v-7843475e${_scopeId2}>${ssrInterpolate(r.field)}</strong></td><td data-v-7843475e${_scopeId2}>${`<code>${r.jsonPath}</code>` ?? ""}</td><td data-v-7843475e${_scopeId2}>${r.guidelines ?? ""}</td></tr>`);
                  });
                  _push3(`<!--]--></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__sub" data-v-7843475e${_scopeId}>Connection history — Service Initiation</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7843475e${_scopeId2}><thead data-v-7843475e${_scopeId2}><tr data-v-7843475e${_scopeId2}><th data-v-7843475e${_scopeId2}>#</th><th data-v-7843475e${_scopeId2}>CMI field</th><th data-v-7843475e${_scopeId2}>JSONPath</th><th data-v-7843475e${_scopeId2}>Guidelines</th></tr></thead><tbody data-v-7843475e${_scopeId2}><!--[-->`);
            ...
            return [
              ...
              createVNode("div", { class: "ed-doc__endpoint" }, [
                createVNode("span", { class: "http-badge http-get" }, "GET"),
                createVNode("a", {
                  href: "/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consent-groups-consentGroupId-consents",
                  class: "ed-doc__endpoint-path"
                }, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` To provide the <strong data-v-7843475e${_scopeId2}>Payment History</strong> tab described in the <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/bank-service-initiation/requirements#detail-page" data-v-7843475e${_scopeId2}>Bank Service Initiation Requirements</a>, use: `);
                } else {
                  return [
                    createTextVNode(" To provide the "),
                    createVNode("strong", null, "Payment History"),
                    createTextVNode(" tab described in the "),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-management-interface/bank-service-initiation/requirements#detail-page" }, "Bank Service Initiation Requirements"),
                    createTextVNode(", use: ")
                  ];
                }
              }),
            ...
            _push2(`<div class="ed-doc__endpoint" data-v-7843475e${_scopeId}><span class="http-badge http-get" data-v-7843475e${_scopeId}>GET</span><a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/payment-log" class="ed-doc__endpoint-path" data-v-7843475e${_scopeId}><code data-v-7843475e${_scopeId}>/payment-log?consentId={consentId}</code></a></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` This returns a summary of all payments for a given consent. Each payment log entry contains the fields needed to populate a single row in the Payment History tab. `);
                } else {
                  return [
                    createTextVNode(" This returns a summary of all payments for a given consent. Each payment log entry contains the fields needed to populate a single row in the Payment History tab. ")
                  ];
                }
              }),
              _: 1
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="ed-doc__endpoint" data-v-7843475e${_scopeId}><span class="http-badge http-post" data-v-7843475e${_scopeId}>POST</span><a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId-action-revoke" class="ed-doc__endpoint-path" data-v-7843475e${_scopeId}><code data-v-7843475e${_scopeId}>/consents/{consentId}/action/revoke</code></a></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` This also revokes any associated tokens. The request body must include <code data-v-7843475e${_scopeId2}>revokedBy</code> set to <code data-v-7843475e${_scopeId2}>LFI.InitiatedByUser</code>. `);
                } else {
                  return [
            ...
            _push2(`<div class="ed-doc__endpoint" data-v-7843475e${_scopeId}><span class="http-badge http-post" data-v-7843475e${_scopeId}>POST</span><a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consent-groups-consentGroupId-consents-action-revoke" class="ed-doc__endpoint-path" data-v-7843475e${_scopeId}><code data-v-7843475e${_scopeId}>/consent-groups/{consentGroupId}/consents/action/revoke</code></a></div>`);
          } else {
            return [
              createVNode(_component_EdProse, null, {
                default: withCtx(() => [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="ed-doc__endpoint" data-v-7843475e${_scopeId}><span class="http-badge http-get" data-v-7843475e${_scopeId}>GET</span><a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId-audit" class="ed-doc__endpoint-path" data-v-7843475e${_scopeId}><code data-v-7843475e${_scopeId}>/consents/{consentId}/audit</code></a></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` This returns a chronological list of all operations performed on the consent, including the caller details and patch content. This is useful for debugging and compliance but is <strong data-v-7843475e${_scopeId2}>not</strong> the same as <a href="#connection-history" data-v-7843475e${_scopeId2}>connection history</a>. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The Consent Manager API returns status codes that must be mapped to user-friendly labels. See <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/bank-service-initiation/requirements#status-labels" data-v-7843475e${_scopeId2}>Status labels (Bank Service Initiation)</a> for the full mapping table. `);
                } else {
                  return [
                    createTextVNode(" The Consent Manager API returns status codes that must be mapped to user-friendly labels. See "),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-management-interface/bank-service-initiation/requirements#status-labels" }, "Status labels (Bank Service Initiation)"),
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7843475e${_scopeId2}><thead data-v-7843475e${_scopeId2}><tr data-v-7843475e${_scopeId2}><th data-v-7843475e${_scopeId2}>API status</th><th data-v-7843475e${_scopeId2}>CMI label</th></tr></thead><tbody data-v-7843475e${_scopeId2}><!--[-->`);
                  ssrRenderList(statusRows, (s) => {
                    _push3(`<tr data-v-7843475e${_scopeId2}><td data-v-7843475e${_scopeId2}><code data-v-7843475e${_scopeId2}>${ssrInterpolate(s.api)}</code></td><td data-v-7843475e${_scopeId2}>${ssrInterpolate(s.cmi)}</td></tr>`);
                  });
                  _push3(`<!--]--></tbody></table>`);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/consent-management-interface/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7843475e"]]);
export {
  apiGuide as default
};
