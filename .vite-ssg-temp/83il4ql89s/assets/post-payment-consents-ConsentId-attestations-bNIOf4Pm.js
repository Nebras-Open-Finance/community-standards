...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "post-payment-consents-ConsentId-attestations",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/consent/data-deletion-confirmation/open-api/post-payment-consents-ConsentId-attestations.vue");
