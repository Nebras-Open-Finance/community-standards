...
import { _ as _sfc_main$1 } from "./APIFlowsProductsLeads-mGTKDr0_.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-8e6efa19><section class="ed-doc__hero" data-v-8e6efa19><div class="ed-doc__inner" data-v-8e6efa19><div class="ed-doc__eyebrow" data-v-8e6efa19><span class="ed-doc__eyebrow-dash" data-v-8e6efa19></span> TPP · Banking · Products &amp; Leads </div><h1 class="ed-doc__title" data-v-8e6efa19> Products &amp; Leads — API Guide <span class="ed-doc__read" data-v-8e6efa19>3 min read</span></h1><p class="ed-doc__lede" data-v-8e6efa19> The Products &amp; Leads API lets a TPP retrieve publicly available banking products from participating LFIs and present them to a user. Products are fetched from each LFI individually and aggregated for display. No user consent or redirect is required — the TPP authenticates directly with a client credentials grant. </p><p class="ed-doc__lede" data-v-8e6efa19> Once the user selects a product they have two options: <strong data-v-8e6efa19>Apply Now</strong>, which directs them to the LFI using whichever application channel the LFI has configured, or <strong data-v-8e6efa19>Request contact from bank</strong>, which submits a lead to the LFI on the user&#39;s behalf. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-8e6efa19${_scopeId2}><strong data-v-8e6efa19${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-8e6efa19${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the <strong data-v-8e6efa19${_scopeId2}>BDSP role</strong> as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-8e6efa19${_scopeId2}>Roles</a>. </li><li data-v-8e6efa19${_scopeId2}><strong data-v-8e6efa19${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-8e6efa19${_scopeId2}>Transport Certificate</a></strong> — an active transport certificate must be issued and registered in the Trust Framework to establish secure <strong data-v-8e6efa19${_scopeId2}>mTLS communication</strong>. </li><li data-v-8e6efa19${_scopeId2}><strong data-v-8e6efa19${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-8e6efa19${_scopeId2}>Signing Certificate</a></strong> — an active signing certificate must be issued and registered in the Trust Framework for client authentication. </li><li data-v-8e6efa19${_scopeId2}><strong data-v-8e6efa19${_scopeId2}>Understanding of <a href="/tech/tpp-standards/security/tokens/" data-v-8e6efa19${_scopeId2}>Tokens &amp; Assertions</a></strong> — you should understand how client authentication works with <code data-v-8e6efa19${_scopeId2}>private_key_jwt</code> before calling the token endpoint. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Each LFI has its own authorisation server, so the TPP must obtain a separate access token for every LFI it intends to query. Because the token endpoint and <code data-v-8e6efa19${_scopeId2}>aud</code> claim differ per LFI, a new client assertion must also be built for each one. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/tokens/client-assertion" data-v-8e6efa19${_scopeId2}>Client Assertion</a> for the full claims reference. `);
                } else {
                  return [
                    createTextVNode(" See "),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-8e6efa19${_scopeId}><span class="http-badge http-get" data-v-8e6efa19${_scopeId}>GET</span><code class="ed-doc__endpoint-path" data-v-8e6efa19${_scopeId}>/products</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` With a token for each LFI, call <span class="endpoint" data-v-8e6efa19${_scopeId2}><span class="http-method http-method--get" data-v-8e6efa19${_scopeId2}>GET</span><code data-v-8e6efa19${_scopeId2}>/products</code></span> for all of them simultaneously. Aggregate the results into a single list before presenting them to the user. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Include <code data-v-8e6efa19${_scopeId2}>x-fapi-interaction-id</code> and <code data-v-8e6efa19${_scopeId2}>x-fapi-customer-ip-address</code> on every request. The <code data-v-8e6efa19${_scopeId2}>x-fapi-customer-ip-address</code> header is required because <span class="endpoint" data-v-8e6efa19${_scopeId2}><span class="http-method http-method--get" data-v-8e6efa19${_scopeId2}>GET</span><code data-v-8e6efa19${_scopeId2}>/products</code></span> can only be called while a customer is in a live session with the TPP. See <a href="/tech/tpp-standards/security/request-headers" data-v-8e6efa19${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Each LFI&#39;s <code data-v-8e6efa19${_scopeId2}>apiBase</code> is its API Hub resource server — <code data-v-8e6efa19${_scopeId2}>https://rs1.&lt;lfiCode&gt;.apihub.openfinance.ae</code> (production) or <code data-v-8e6efa19${_scopeId2}>https://rs1.&lt;lfiCode&gt;.sandbox.apihub.openfinance.ae</code> (sandbox). Resolve the <code data-v-8e6efa19${_scopeId2}>&lt;lfiCode&gt;</code> from the <a href="/tech/tpp-standards/trust-framework/api-discovery" data-v-8e6efa19${_scopeId2}>Trust Framework Directory</a>. See <a href="/tech/tpp-standards/trust-framework/api-resources" data-v-8e6efa19${_scopeId2}>API Resources</a> for the full endpoint format. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-8e6efa19${_scopeId}>Query parameters</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-8e6efa19${_scopeId2}><thead data-v-8e6efa19${_scopeId2}><tr data-v-8e6efa19${_scopeId2}><th data-v-8e6efa19${_scopeId2}>Parameter</th><th data-v-8e6efa19${_scopeId2}>Type</th><th data-v-8e6efa19${_scopeId2}>Description</th></tr></thead><tbody data-v-8e6efa19${_scopeId2}><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ProductCategory</code></td><td data-v-8e6efa19${_scopeId2}>string</td><td data-v-8e6efa19${_scopeId2}>Filter by category — <code data-v-8e6efa19${_scopeId2}>SavingsAccount</code>, <code data-v-8e6efa19${_scopeId2}>CurrentAccount</code>, <code data-v-8e6efa19${_scopeId2}>CreditCard</code>, <code data-v-8e6efa19${_scopeId2}>Finance</code>, or <code data-v-8e6efa19${_scopeId2}>Mortgage</code></td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>IsShariaCompliant</code></td><td data-v-8e6efa19${_scopeId2}>boolean</td><td data-v-8e6efa19${_scopeId2}>Filter to Sharia-compliant products only</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>LastUpdatedDateTime</code></td><td data-v-8e6efa19${_scopeId2}>date-time</td><td data-v-8e6efa19${_scopeId2}>Return only products updated after this timestamp</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>SortField</code></td><td data-v-8e6efa19${_scopeId2}>string</td><td data-v-8e6efa19${_scopeId2}>Sort by <code data-v-8e6efa19${_scopeId2}>LastUpdatedDateTime</code> (default) or <code data-v-8e6efa19${_scopeId2}>ProductId</code></td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>SortOrder</code></td><td data-v-8e6efa19${_scopeId2}>string</td><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>asc</code> (default) or <code data-v-8e6efa19${_scopeId2}>desc</code></td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-8e6efa19${_scopeId}>Response structure</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Products are returned grouped by LFI. The <code data-v-8e6efa19${_scopeId2}>Data</code> array groups products by <code data-v-8e6efa19${_scopeId2}>LFIId</code>: `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-8e6efa19${_scopeId}>Application fields</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` At least one of the following fields <strong data-v-8e6efa19${_scopeId2}>must</strong> be returned by the LFI for every product. This determines how the TPP presents the page for the end user to apply for their selected product: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-8e6efa19${_scopeId2}><thead data-v-8e6efa19${_scopeId2}><tr data-v-8e6efa19${_scopeId2}><th data-v-8e6efa19${_scopeId2}>Field</th><th data-v-8e6efa19${_scopeId2}>Type</th><th data-v-8e6efa19${_scopeId2}>Description</th></tr></thead><tbody data-v-8e6efa19${_scopeId2}><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ApplicationUri</code></td><td data-v-8e6efa19${_scopeId2}>string &lt;uri&gt;</td><td data-v-8e6efa19${_scopeId2}>A link to apply for the product.</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ApplicationPhoneNumber</code></td><td data-v-8e6efa19${_scopeId2}>string</td><td data-v-8e6efa19${_scopeId2}>A phone number to apply for the product.</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ApplicationEmail</code></td><td data-v-8e6efa19${_scopeId2}>string</td><td data-v-8e6efa19${_scopeId2}>An email address to apply for the product.</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ApplicationDescription</code></td><td data-v-8e6efa19${_scopeId2}>string</td><td data-v-8e6efa19${_scopeId2}>A free text description of the application process for the product, with ways to contact the LFI if applicable.</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-8e6efa19${_scopeId2}> Use the LFI&#39;s logo and brand name from the Trust Framework Directory. Do not rank or order products based on commercial agreements with specific LFIs — ordering must reflect the user&#39;s own preferences. </p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="./open-api/products" data-v-8e6efa19${_scopeId2}>GET /products</a> API reference for the full response schema. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-8e6efa19${_scopeId2}><thead data-v-8e6efa19${_scopeId2}><tr data-v-8e6efa19${_scopeId2}><th data-v-8e6efa19${_scopeId2}>Field</th><th data-v-8e6efa19${_scopeId2}>Present</th><th data-v-8e6efa19${_scopeId2}>Action</th></tr></thead><tbody data-v-8e6efa19${_scopeId2}><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ApplicationUri</code></td><td data-v-8e6efa19${_scopeId2}>Yes</td><td data-v-8e6efa19${_scopeId2}>Redirect the user to this URL to complete the application on the LFI&#39;s own platform</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ApplicationPhoneNumber</code></td><td data-v-8e6efa19${_scopeId2}>Yes</td><td data-v-8e6efa19${_scopeId2}>Display the phone number for the user to call the LFI</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ApplicationEmail</code></td><td data-v-8e6efa19${_scopeId2}>Yes</td><td data-v-8e6efa19${_scopeId2}>Display the email address for the user to contact the LFI</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ApplicationDescription</code></td><td data-v-8e6efa19${_scopeId2}>Yes</td><td data-v-8e6efa19${_scopeId2}>Display the free-text description of the LFI&#39;s application process</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` An LFI may provide more than one of these fields. <code data-v-8e6efa19${_scopeId2}>ApplicationUri</code> is the preferred channel where available; the others provide fallback options for LFIs that do not have a direct online application. `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-8e6efa19${_scopeId}><span class="http-badge http-post" data-v-8e6efa19${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-8e6efa19${_scopeId}>/leads</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If the user instead chooses to request that the LFI contact them, the TPP submits a lead. The API Hub forwards it to the LFI and does <strong data-v-8e6efa19${_scopeId2}>not</strong> retain the data. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` As with <span class="endpoint" data-v-8e6efa19${_scopeId2}><span class="http-method http-method--get" data-v-8e6efa19${_scopeId2}>GET</span><code data-v-8e6efa19${_scopeId2}>/products</code></span>, include <code data-v-8e6efa19${_scopeId2}>x-fapi-customer-ip-address</code> on every request — leads can only be submitted while a customer is in a live session with the TPP. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-8e6efa19${_scopeId}>Lead request fields</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-8e6efa19${_scopeId2}><thead data-v-8e6efa19${_scopeId2}><tr data-v-8e6efa19${_scopeId2}><th data-v-8e6efa19${_scopeId2}>Field</th><th data-v-8e6efa19${_scopeId2}>Required</th><th data-v-8e6efa19${_scopeId2}>Description</th></tr></thead><tbody data-v-8e6efa19${_scopeId2}><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>Email</code></td><td data-v-8e6efa19${_scopeId2}>Yes</td><td data-v-8e6efa19${_scopeId2}>User&#39;s email address</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>EmiratesId</code></td><td data-v-8e6efa19${_scopeId2}>Yes</td><td data-v-8e6efa19${_scopeId2}>UAE Emirates ID number</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>MarketingOptOut</code></td><td data-v-8e6efa19${_scopeId2}>Yes</td><td data-v-8e6efa19${_scopeId2}>Whether the user has opted out of marketing communications</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ProductCategories</code></td><td data-v-8e6efa19${_scopeId2}>Yes</td><td data-v-8e6efa19${_scopeId2}>One or more product categories the user is interested in</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>Name</code></td><td data-v-8e6efa19${_scopeId2}>Yes</td><td data-v-8e6efa19${_scopeId2}>User&#39;s name — <code data-v-8e6efa19${_scopeId2}>GivenName</code> + <code data-v-8e6efa19${_scopeId2}>LastName</code>, <code data-v-8e6efa19${_scopeId2}>FullName</code>, or <code data-v-8e6efa19${_scopeId2}>BusinessName</code> for business accounts</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>PhoneNumber</code></td><td data-v-8e6efa19${_scopeId2}>No</td><td data-v-8e6efa19${_scopeId2}>E.164 format, e.g. <code data-v-8e6efa19${_scopeId2}>+971501234567</code></td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>Nationality</code></td><td data-v-8e6efa19${_scopeId2}>No</td><td data-v-8e6efa19${_scopeId2}>ISO 3166-1 alpha-2 country code</td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>ResidentialAddress</code></td><td data-v-8e6efa19${_scopeId2}>No</td><td data-v-8e6efa19${_scopeId2}>Structured address including <code data-v-8e6efa19${_scopeId2}>AddressLine</code>, <code data-v-8e6efa19${_scopeId2}>Country</code>, and optionally UAE <code data-v-8e6efa19${_scopeId2}>CountrySubDivision</code></td></tr><tr data-v-8e6efa19${_scopeId2}><td data-v-8e6efa19${_scopeId2}><code data-v-8e6efa19${_scopeId2}>LeadInformation</code></td><td data-v-8e6efa19${_scopeId2}>No</td><td data-v-8e6efa19${_scopeId2}>Free-text notes about the lead</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-8e6efa19${_scopeId2}> Only submit a lead when the user has explicitly opted in to being contacted by the LFI. The <code data-v-8e6efa19${_scopeId2}>MarketingOptOut</code> field must accurately reflect the user&#39;s marketing preferences. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="./open-api/leads" data-v-8e6efa19${_scopeId2}>POST /leads</a> API reference for the full request and response schema. `);
                } else {
                  return [
                    createTextVNode(" See the "),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/products-leads/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8e6efa19"]]);
export {
  apiGuide as default
};
