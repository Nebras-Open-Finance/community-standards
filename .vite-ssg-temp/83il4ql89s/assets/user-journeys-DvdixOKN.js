...
import { W as WireframePreview, A as AccountSetup, U as UIBehaviour, E as ExampleJourneys } from "./ExampleJourneys-CNhBRWcb.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-87631aa8><section class="ed-doc__hero" data-v-87631aa8><div class="ed-doc__inner" data-v-87631aa8><div class="ed-doc__eyebrow" data-v-87631aa8><span class="ed-doc__eyebrow-dash" data-v-87631aa8></span> Banking · Service Initiation · Variable Periodic Schedule · UX </div><h1 class="ed-doc__title" data-v-87631aa8> Variable Periodic Schedule — User Experience <span class="ed-doc__read" data-v-87631aa8>4 min read</span></h1><p class="ed-doc__lede" data-v-87631aa8> When a customer is redirected to you to authorize a Variable Periodic Schedule payment consent through Open Finance, you must present an <strong data-v-87631aa8>Authorization Page</strong> that clearly explains the payment the customer is authorizing — that recurring payments of varying amounts will be made at a set frequency. The page must collect the customer&#39;s explicit and informed consent, and it must accurately reflect the key details of the consent (payee, the maximum amount per payment, payment frequency, etc.) </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-87631aa8> The examples and interactive wireframes provided below define the expected structure, content, and behavior of the Authorization Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-87631aa8> While you may adapt visual elements such as color palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the payment information shown. The representation of <strong data-v-87631aa8>AlTareq</strong> (including logos, naming, and action buttons) must be preserved at all times. The customer must be able to clearly understand what payment they are authorizing and that the authorization is part of the AlTareq ecosystem. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-87631aa8> Your Authorization Page must be submitted as part of <strong data-v-87631aa8>CX certification</strong> prior to production. Any material changes to a production Authorization Page must also be resubmitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the request body fields below and watch the <strong data-v-87631aa8${_scopeId2}>Consent</strong> and <strong data-v-87631aa8${_scopeId2}>Authorisation</strong> page previews update live. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/banking/service-initiation/domestic-payments/multi-payments/variable-periodic-schedule/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-87631aa8"]]);
export {
