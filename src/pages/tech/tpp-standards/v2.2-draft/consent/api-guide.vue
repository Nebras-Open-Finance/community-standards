...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          TPP Standards · v2.2-draft · Consent · API Guide
        </div>
    ...
    >
      ...
      <EdBullets>
        <li>
          <a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/api-guide/">Bank Data Sharing &mdash; API Guide</a>
        </li>
        <li>
          <a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/single-instant-payment/api-guide">
            Single Instant Payment &mdash; API Guide
          </a>
        </li>
        <li>
          <a href="/tech/tpp-standards/v2.2-draft/insurance/data-sharing/api-guide/">Insurance Data Sharing &mdash; API Guide</a>
        </li>
      </EdBullets>
      ...
      <EdProse>
        ...
        <a href="/tech/tpp-standards/v2.2-draft/consent/open-api/par" class="endpoint"><span class="http-method http-method--post">POST</span><code>/par</code></a> for the
        full API reference.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <div class="ed-doc__option">
        ...
        <p class="ed-doc__option-body">
          ...
          <a href="/tech/tpp-standards/v2.2-draft/webhooks/consent-status/api-guide">Consent Status Event</a>
        ...
        <p class="ed-doc__option-body">
          ...
          <a href="/tech/tpp-standards/v2.2-draft/webhooks/consent-status/api-guide">Consent Status Event &mdash; API Guide</a>
          for the full flow.
        </p>
      </div>
      ...
      <div class="ed-doc__option">
        ...
        <EdProse>
          See
          <a href="/tech/tpp-standards/v2.2-draft/consent/open-api/account-access-consents-ConsentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/account-access-consents/{ConsentId}</code></a>
        ...
        <EdProse>
          ...
          <a href="/tech/tpp-standards/v2.2-draft/consent/open-api/account-access-consents" class="endpoint"><span class="http-method http-method--get">GET</span><code>/account-access-consents</code></a>.
        </EdProse>
        ...
        <EdProse>
          ...
          <code>baseConsentId</code> as a query parameter to
          <a href="/tech/tpp-standards/v2.2-draft/consent/open-api/payment-consents" class="endpoint"><span class="http-method http-method--get">GET</span><code>/payment-consents</code></a>.
        </EdProse>
        ...
        <EdProse>
          See
          <a href="/tech/tpp-standards/v2.2-draft/consent/open-api/insurance-consents-ConsentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/insurance-consents/{ConsentId}</code></a>
          for the full response schema.
        </EdProse>
        <EdProse>
          You can also retrieve all insurance consents under a long-lived base consent by passing
          <code>baseConsentId</code> as a query parameter to
          <a href="/tech/tpp-standards/v2.2-draft/consent/open-api/insurance-consents" class="endpoint"><span class="http-method http-method--get">GET</span><code>/insurance-consents</code></a>.
        </EdProse>
      </div>
      ...
      <EdNote type="info" title="Consent States">
        <p>
          ...
          <a href="/tech/tpp-standards/v2.2-draft/consent/">Consent Overview</a> for the full state
