  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        ...
        <li>
          ...
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/">Headless Heimdall</a> and
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/">Consent Manager</a> base URLs to
          verify. See <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/connectivity/">Connectivity &amp; Certificates</a>
        </li>
        <li>
    ...
    >
      ...
      <EdProse>
        ...
        Request JWT. See the
        <a href="/tech/tpp-standards/v2.2-draft/consent/api-guide">TPP Consent API Guide</a>
        for the TPP's API Guide and
        <a href="/tech/tpp-standards/v2.2-draft/consent/open-api/par" class="endpoint"><span class="http-method http-method--post">POST</span><code>/par</code></a>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-events/open-api/validate">Validate Consent API Reference</a>
      ...
      <EdProse>
        If your LFI has configured the
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-events/open-api/event-op" class="endpoint"><span class="http-method http-method--post">POST</span><code>/consent/event/{operation}</code></a>
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/auth-endpoint">environment-specific configuration</a>.
      </EdProse>
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/">Headless Heimdall</a>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/open-api/auth"><span class="endpoint"><span class="http-method http-method--get">GET</span><code>/auth</code></span> API Reference</a>
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/">Consent Manager</a>
      ...
      <EdNote type="info" title="Encrypted PII">
        <p>
          ...
          <a href="/tech/lfi-api-hub/v2.2-draft/banking/service-initiation/personal-identifiable-information/">Personal Identifiable Information</a>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/consents-consentId"><span class="endpoint"><span class="http-method http-method--get">GET</span><code>/consents/{consentId}</code></span> API Reference</a>
        for the full response schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-journey/authentication/requirements">Authentication Requirements</a>.
      </EdProse>
    </EdSectionBand>
    ...
    >
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td><a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/user-journeys">User Experience</a></td>
            </tr>
            <tr>
              <td>Single Instant Payment</td>
              <td><a href="/tech/lfi-api-hub/v2.2-draft/banking/service-initiation/domestic-payments/single-instant-payment/user-journeys">User Experience</a></td>
            </tr>
            <tr>
              <td>Insurance Data Sharing</td>
              <td><a href="/tech/lfi-api-hub/v2.2-draft/insurance/data-sharing/user-journeys">User Experience</a></td>
            </tr>
          </tbody>
        </table>
      </EdRefTable>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/patch-consents-consentId"><span class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/consents/{consentId}</code></span> API Reference</a>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm"><span class="endpoint"><span class="http-method http-method--post">POST</span><code>/auth/{interactionId}/doConfirm</code></span> API Reference</a>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/open-api/auth-interactionId-doFail"><span class="endpoint"><span class="http-method http-method--post">POST</span><code>/auth/{interactionId}/doFail</code></span> API Reference</a>
        for the full specification.
      </EdProse>
    </EdSectionBand>
