  ...
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          TPP Standards · v2.2-draft · Consent
        </div>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <code>type: urn:openfinanceuae:account-access-consent:v2.2</code>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <code>authorization_details</code> with
                <code>type: urn:openfinanceuae:payment-consent:v2.2</code>
              </td>
            </tr>
          </tbody>
        </table>
    ...
    >
      <EdProse>
        ...
        (e.g.
        <a href="/tech/tpp-standards/v2.2-draft/consent/open-api/account-access-consents"><code>/account-access-consents</code></a>)
