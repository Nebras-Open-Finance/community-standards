...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/consent/open-api/insurance-consents.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const insuranceConsents = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  insuranceConsents as default
};
