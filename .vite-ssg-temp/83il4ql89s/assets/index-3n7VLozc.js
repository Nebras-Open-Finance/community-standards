...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-0d77750c><section class="ed-doc__hero" data-v-0d77750c><div class="ed-doc__inner" data-v-0d77750c><div class="ed-doc__eyebrow" data-v-0d77750c><span class="ed-doc__eyebrow-dash" data-v-0d77750c></span> TPP Standards · v2.2-rc1 · Consent </div><h1 class="ed-doc__title" data-v-0d77750c> Consent <span class="ed-doc__read" data-v-0d77750c>4 min read</span></h1><p class="ed-doc__lede" data-v-0d77750c> A <strong data-v-0d77750c>Consent</strong> is an authorisation object that represents a user&#39;s explicit permission for a TPP to access their data or initiate services at an LFI. Every protected resource request in UAE Open Finance is bound to a consent — there is no access without one. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-0d77750c${_scopeId2}><thead data-v-0d77750c${_scopeId2}><tr data-v-0d77750c${_scopeId2}><th data-v-0d77750c${_scopeId2}>Type</th><th data-v-0d77750c${_scopeId2}>Used for</th><th data-v-0d77750c${_scopeId2}>Created via</th></tr></thead><tbody data-v-0d77750c${_scopeId2}><tr data-v-0d77750c${_scopeId2}><td data-v-0d77750c${_scopeId2}><strong data-v-0d77750c${_scopeId2}>Bank Data Sharing</strong></td><td data-v-0d77750c${_scopeId2}>Reading account data, balances, transactions, and related resources</td><td data-v-0d77750c${_scopeId2}><code data-v-0d77750c${_scopeId2}>authorization_details</code> with <code data-v-0d77750c${_scopeId2}>type: urn:openfinanceuae:account-access-consent:v2.2</code></td></tr><tr data-v-0d77750c${_scopeId2}><td data-v-0d77750c${_scopeId2}><strong data-v-0d77750c${_scopeId2}>Bank Service Initiation</strong></td><td data-v-0d77750c${_scopeId2}>Initiating payments</td><td data-v-0d77750c${_scopeId2}><code data-v-0d77750c${_scopeId2}>authorization_details</code> with <code data-v-0d77750c${_scopeId2}>type: urn:openfinanceuae:payment-consent:v2.2</code></td></tr></tbody></table>`);
                } else {
                  return [
                      ...
                      createVNode("tbody", null, [
                        createVNode("tr", null, [
                          ...
                          createVNode("td", null, [
                            ...
                            createVNode("code", null, "type: urn:openfinanceuae:account-access-consent:v2.2")
                          ])
                        ]),
                        createVNode("tr", null, [
                          createVNode("td", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("code", null, "authorization_details"),
                            createTextVNode(" with "),
                            createVNode("code", null, "type: urn:openfinanceuae:payment-consent:v2.2")
                          ])
                        ])
                      ])
                    ])
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Before any <code data-v-0d77750c${_scopeId2}>UserOAuth2Security</code> protected resource can be accessed, a consent must go through a two-phase flow: <strong data-v-0d77750c${_scopeId2}>staging</strong> and <strong data-v-0d77750c${_scopeId2}>authorization</strong>. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The API Hub maintains all Open Finance consents and acts as the <strong data-v-0d77750c${_scopeId2}>authoritative system of record</strong> for consents across the ecosystem. All consent creation, modification, and revocation events are recorded within the API Hub to ensure a single, consistent source of truth. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Once a consent is staged, the <strong data-v-0d77750c${_scopeId2}>only field under <code data-v-0d77750c${_scopeId2}>Data</code> that may change is <code data-v-0d77750c${_scopeId2}>Status</code></strong>. All other <code data-v-0d77750c${_scopeId2}>Data</code> values are fixed for the lifetime of that consent. <code data-v-0d77750c${_scopeId2}>Subscription</code> and <code data-v-0d77750c${_scopeId2}>Meta</code> may be patched, but they sit outside the <code data-v-0d77750c${_scopeId2}>Data</code> object. See the request/response models in the OpenAPI (e.g. <a href="/tech/tpp-standards/v2.2-rc1/consent/open-api/account-access-consents" data-v-0d77750c${_scopeId2}><code data-v-0d77750c${_scopeId2}>/account-access-consents</code></a>) for the canonical structure. `);
                } else {
                  return [
                    ...
                    createVNode("a", { href: "/tech/tpp-standards/v2.2-rc1/consent/open-api/account-access-consents" }, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If a user needs to change any <code data-v-0d77750c${_scopeId2}>Data</code> value (for example, to adjust <code data-v-0d77750c${_scopeId2}>ExpirationDateTime</code> or add or remove a permission), the TPP must create a <strong data-v-0d77750c${_scopeId2}>new consent</strong>, revoke the previous one, and link the two via <code data-v-0d77750c${_scopeId2}>BaseConsentId</code>. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Resources secured with <code data-v-0d77750c${_scopeId2}>UserOAuth2Security</code> require user involvement — the user must authenticate with the LFI and explicitly authorise the consent before the TPP can access any resource on their behalf. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Two independent conditions must <strong data-v-0d77750c${_scopeId2}>both</strong> be satisfied before the API Hub will serve a <code data-v-0d77750c${_scopeId2}>UserOAuth2Security</code> resource: `);
                } else {
                  return [
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-0d77750c${_scopeId3}> Requests must carry a Bearer access token in the <code data-v-0d77750c${_scopeId3}>Authorization</code> header: </p><pre class="ed-doc__pre" data-v-0d77750c${_scopeId3}><code data-v-0d77750c${_scopeId3}>Authorization: Bearer &lt;access_token&gt;</code></pre><p data-v-0d77750c${_scopeId3}> Access tokens are short-lived (10-minute lifetime) and are bound to the consent they were issued for. See <a href="/tech/tpp-standards/security/tokens/" data-v-0d77750c${_scopeId3}>Tokens &amp; Assertions</a> for the full token lifecycle. </p>`);
                      } else {
                        return [
                          createVNode("p", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-0d77750c${_scopeId3}> The consent referenced in the access token&#39;s <code data-v-0d77750c${_scopeId3}>authorization_details</code> must be in the <code data-v-0d77750c${_scopeId3}>Authorized</code> state. The <code data-v-0d77750c${_scopeId3}>authorization_details</code> object defines the exact scope of access — which permissions are granted, to which endpoints, for which accounts, and for how long. </p>`);
                      } else {
                        return [
                          createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, { type: "warning" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-0d77750c${_scopeId2}> The API Hub <strong data-v-0d77750c${_scopeId2}>must</strong> reject all requests to <code data-v-0d77750c${_scopeId2}>UserOAuth2Security</code> resources where the associated consent is not in the <code data-v-0d77750c${_scopeId2}>Authorized</code> state — including consents that are <code data-v-0d77750c${_scopeId2}>AwaitingAuthorization</code>, <code data-v-0d77750c${_scopeId2}>Suspended</code>, <code data-v-0d77750c${_scopeId2}>Expired</code>, <code data-v-0d77750c${_scopeId2}>Revoked</code>, <code data-v-0d77750c${_scopeId2}>Rejected</code>, or <code data-v-0d77750c${_scopeId2}>Consumed</code>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="ed-doc__states" data-v-0d77750c${_scopeId}><!--[-->`);
            ssrRenderList(states, (s) => {
              _push2(`<article${ssrRenderAttr("id", s.id)} class="${ssrRenderClass([`ed-doc__state--${s.kind}`, "ed-doc__state"])}" data-v-0d77750c${_scopeId}><header class="ed-doc__state-head" data-v-0d77750c${_scopeId}><h3 class="ed-doc__state-name" data-v-0d77750c${_scopeId}>${ssrInterpolate(s.name)}</h3><span class="ed-doc__state-pill" data-v-0d77750c${_scopeId}>${ssrInterpolate(pillLabel(s.kind))}</span></header><p class="ed-doc__state-body" data-v-0d77750c${_scopeId}>${s.intro ?? ""}</p>`);
              if (s.bullets && s.bullets.length) {
                _push2(`<ul class="ed-doc__state-bullets" data-v-0d77750c${_scopeId}><!--[-->`);
                ssrRenderList(s.bullets, (b, bi) => {
                  _push2(`<li data-v-0d77750c${_scopeId}>${b ?? ""}</li>`);
                });
                _push2(`<!--]--></ul>`);
              } else {
                _push2(`<!---->`);
              ...
              if (s.detail) {
                _push2(`<p class="ed-doc__state-body" data-v-0d77750c${_scopeId}>${s.detail ?? ""}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</article>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/consent/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0d77750c"]]);
export {
  index as default
};
