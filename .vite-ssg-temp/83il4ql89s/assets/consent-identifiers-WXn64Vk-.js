import { _ as __unplugin_components_6$3, a as __unplugin_components_7 } from "./EdRelatedCards-D4uHHv56.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-ec278fde>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-ec278fde${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-ec278fde${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Because these values live outside the LFI&#39;s own systems, they <strong data-v-ec278fde${_scopeId2}>MUST</strong> be <strong data-v-ec278fde${_scopeId2}>opaque internal references</strong> — never the underlying personal or account data they point to. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Any value patched onto a consent <strong data-v-ec278fde${_scopeId2}>MUST NOT</strong> be a sensitive or personally identifiable value. An LFI <strong data-v-ec278fde${_scopeId2}>MUST NOT</strong> use any of the following as an identifier on the consent: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ec278fde${_scopeId2}>Emirates ID, passport number, or any regulated national identifier</li><li data-v-ec278fde${_scopeId2}>Full name, date of birth, email, or mobile number</li><li data-v-ec278fde${_scopeId2}>IBAN, account number, card number, or PAN</li><li data-v-ec278fde${_scopeId2}>CIF number or any other internal identifier that maps 1:1 to regulated data</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The identifier <strong data-v-ec278fde${_scopeId2}>MUST</strong> be an LFI-defined opaque reference that is meaningful only inside the LFI&#39;s own systems. The LFI resolves it back to the real customer or account internally when processing a request. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdCallout, { color: "var(--at-gold)" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ec278fde${_scopeId2}> Storing sensitive values on the consent would <strong data-v-ec278fde${_scopeId2}>leak PII outside the LFI&#39;s boundary</strong>, create a durable record of regulated data the LFI cannot unwind, and break the trust model where the API Hub receives only opaque handles from the LFI. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The same principle governs payment PII, which is encrypted end-to-end to keep personal data opaque to the hub — see <a href="/knowledge-base/articles/pii-encryption" data-v-ec278fde${_scopeId2}>PII Encryption</a>. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-ec278fde${_scopeId2}><thead data-v-ec278fde${_scopeId2}><tr data-v-ec278fde${_scopeId2}><th data-v-ec278fde${_scopeId2}>Identifier</th><th data-v-ec278fde${_scopeId2}>Requirement</th></tr></thead><tbody data-v-ec278fde${_scopeId2}><tr data-v-ec278fde${_scopeId2}><td data-v-ec278fde${_scopeId2}><code data-v-ec278fde${_scopeId2}>psuIdentifiers.userId</code></td><td data-v-ec278fde${_scopeId2}>Opaque string. Stable per end user (same value across all their consents). Unique within the LFI. UUID v4 recommended.</td></tr><tr data-v-ec278fde${_scopeId2}><td data-v-ec278fde${_scopeId2}><code data-v-ec278fde${_scopeId2}>accountIds[]</code></td><td data-v-ec278fde${_scopeId2}>Array of opaque strings, 1–40 chars each, <code data-v-ec278fde${_scopeId2}>minItems: 1</code>. Each value <strong data-v-ec278fde${_scopeId2}>MUST</strong> match the <code data-v-ec278fde${_scopeId2}>AccountId</code> the LFI returns from its <code data-v-ec278fde${_scopeId2}>/accounts</code> APIs. Immutable once issued. UUID v4 recommended.</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` For Bank Service Initiation consents, <code data-v-ec278fde${_scopeId2}>accountIds</code> <strong data-v-ec278fde${_scopeId2}>MUST</strong> contain exactly one element — the debtor account. For Bank Data Sharing, it <strong data-v-ec278fde${_scopeId2}>MUST</strong> contain every account the end user selected. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ec278fde${_scopeId2}> The consent is a central record, not a private LFI record. Anything the LFI puts on it <strong data-v-ec278fde${_scopeId2}>MUST</strong> be meaningless to any party other than the LFI itself. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
...
const consentIdentifiers = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ec278fde"]]);
export {
