...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_EndpointPage, mergeProps({
    eyebrow: "LFI · Banking · Products & Leads",
    title: "Get Products",
    version: "v2.2-rc1",
    method: "GET",
    path: "/products"
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_RedocWrapper, {
          spec: "/openapi/v2.2-rc1/ozone-connect/uae-ozone-connect-bank-products-data-openapi.yaml",
          filterPath: "/products",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/banking/products-and-leads/open-api/products.vue");
