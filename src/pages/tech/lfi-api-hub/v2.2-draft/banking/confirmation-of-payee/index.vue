...
// Live-ecosystem mini-feed — TPPs that called CoP endpoints in the last 30
// days. Aligned with `/program/whats-live?family=confirmation&type=tpp`.
...
const sectionEndpoints = allEndpoints.filter(
  (e) => e.surface === 'ozone-connect' && e.sectionSlug === 'confirmation-of-payee',
)
</script>
    ...
    <section class="ed-landing__role">
      <div class="ed-landing__inner">
        <div class="ed-landing__role-card">
          ...
          <p class="ed-landing__role-body">Access to the Confirmation of Payee API requires TPPs to hold the <strong>BSIP</strong> role. The API Hub validates the role on every request before proxying it to the LFI.</p>
        </div>
      </div>
    </section>
    ...
    <section class="ed-landing__live">
      <div class="ed-landing__inner">
        <div class="ed-landing__live-head">
          ...
          <h2 class="ed-landing__live-title">Who's using Confirmation of Payee</h2>
          <p class="ed-landing__live-sub">TPPs currently calling the Confirmation of Payee API across UAE Open Finance.</p>
        </div>
    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a class="ed-link-card" href="/tech/lfi-api-hub/v2.2-draft/banking/confirmation-of-payee/requirements" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
            ...
            <p class="ed-link-card__desc">Validation rules and behaviour your Ozone Connect CoP endpoint must follow.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
          <a class="ed-link-card" href="/tech/lfi-api-hub/v2.2-draft/banking/confirmation-of-payee/api-guide" :style="{ '--card-color': 'var(--at-teal)' }">
            <span class="ed-link-card__top" />
          ...
          <a class="ed-link-card" href="/tech/lfi-api-hub/v2.2-draft/banking/confirmation-of-payee/user-journeys" :style="{ '--card-color': 'var(--at-navy)' }">
            <span class="ed-link-card__top" />
            ...
            <p class="ed-link-card__desc">The end-to-end flows your customer experiences when CoP runs against your account data.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
