...
import { _ as _sfc_main$1 } from "./APIFlowsConsentFlow-C9wHlRpm.js";
...
return redirect(redirect_uri)`
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-51a53dd6><section class="ed-doc__hero" data-v-51a53dd6><div class="ed-doc__inner" data-v-51a53dd6><div class="ed-doc__eyebrow" data-v-51a53dd6><span class="ed-doc__eyebrow-dash" data-v-51a53dd6></span> LFI · Consent Journey · API Guide </div><h1 class="ed-doc__title" data-v-51a53dd6> Consent Journey — API Guide <span class="ed-doc__read" data-v-51a53dd6>6 min read</span></h1><p class="ed-doc__lede" data-v-51a53dd6> End-to-end implementation guide for the consent authorization journey: from the TPP&#39;s <span class="endpoint" data-v-51a53dd6><span class="http-method http-method--post" data-v-51a53dd6>POST</span><code data-v-51a53dd6>/par</code></span> through your Authorization Endpoint, the Headless Heimdall and Consent Manager API calls, and the final <code data-v-51a53dd6>doConfirm</code>/<code data-v-51a53dd6>doFail</code> redirect back to the TPP. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}>API Hub onboarded</strong> — Your API Hub instance is provisioned and your <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/" data-v-51a53dd6${_scopeId2}>environment-specific configuration</a> is complete </li><li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}>C3-hh-cm-client application created</strong> — Registered in the Trust Framework with mTLS connectivity established in both directions. See <a href="/tech/lfi-api-hub/trust-framework/creating-c3-application" data-v-51a53dd6${_scopeId2}>Creating the C3-hh-cm-client Application</a></li><li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}>Connectivity verified</strong> — Bidirectional mTLS connectivity confirmed between your systems and the API Hub. Use <span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/hello-mtls</code></span> on both the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/" data-v-51a53dd6${_scopeId2}>Headless Heimdall</a> and <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/" data-v-51a53dd6${_scopeId2}>Consent Manager</a> base URLs to verify. See <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/connectivity/" data-v-51a53dd6${_scopeId2}>Connectivity &amp; Certificates</a></li><li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}>Authorization Endpoint registered</strong> — Your <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/auth-endpoint" data-v-51a53dd6${_scopeId2}>Authorization Endpoint</a> is configured in the API Hub to receive TPP user redirects </li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 data-v-51a53dd6${_scopeId}>Required API implementations</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-51a53dd6${_scopeId2}><thead data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><th data-v-51a53dd6${_scopeId2}>Endpoint</th><th data-v-51a53dd6${_scopeId2}>Direction</th><th data-v-51a53dd6${_scopeId2}>Purpose</th></tr></thead><tbody data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth" class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/auth</code></a></td><td data-v-51a53dd6${_scopeId2}>LFI → API Hub</td><td data-v-51a53dd6${_scopeId2}>Initiate the authorization interaction</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/consents-consentId" class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/consents/{consentId}</code></a></td><td data-v-51a53dd6${_scopeId2}>LFI → API Hub</td><td data-v-51a53dd6${_scopeId2}>Retrieve the full consent details</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/patch-consents-consentId" class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--patch" data-v-51a53dd6${_scopeId2}>PATCH</span><code data-v-51a53dd6${_scopeId2}>/consents/{consentId}</code></a></td><td data-v-51a53dd6${_scopeId2}>LFI → API Hub</td><td data-v-51a53dd6${_scopeId2}>Update consent status, end user identifiers, and account IDs</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm" class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/auth/{interactionId}/doConfirm</code></a></td><td data-v-51a53dd6${_scopeId2}>LFI → API Hub</td><td data-v-51a53dd6${_scopeId2}>Complete the authorization interaction and redirect back to TPP successfully</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doFail" class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/auth/{interactionId}/doFail</code></a></td><td data-v-51a53dd6${_scopeId2}>LFI → API Hub</td><td data-v-51a53dd6${_scopeId2}>Complete the authorization interaction and redirect back to TPP with a failure</td></tr></tbody></table>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-51a53dd6${_scopeId}>Step 1 — TPP creates the consent via <code data-v-51a53dd6${_scopeId}>/par</code></h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The consent journey begins when a TPP sends a Pushed Authorization Request (<span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/par</code></span>) to the API Hub. The TPP embeds the consent definition inside a signed Request JWT. See the <a href="/tech/tpp-standards/v2.2-rc1/consent/api-guide" data-v-51a53dd6${_scopeId2}>TPP Consent API Guide</a> for the TPP&#39;s API Guide and <a href="/tech/tpp-standards/v2.2-rc1/consent/open-api/par" class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/par</code></a> for the full <code data-v-51a53dd6${_scopeId2}>/par</code> request structure. `);
                } else {
                  return [
                    ...
                    createVNode("a", { href: "/tech/tpp-standards/v2.2-rc1/consent/api-guide" }, "TPP Consent API Guide"),
                    createTextVNode(" for the TPP's API Guide and "),
                    createVNode("a", {
                      href: "/tech/tpp-standards/v2.2-rc1/consent/open-api/par",
                      class: "endpoint"
                    }, [
                      createVNode("span", { class: "http-method http-method--post" }, "POST"),
                      createVNode("code", null, "/par")
            ...
            _push2(`<h3 data-v-51a53dd6${_scopeId}>Step 2 — (Optional) Validate the consent</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If your LFI has configured the <a href="/tech/lfi-api-hub/v2.2-rc1/consent-events/open-api/validate" class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/consent/action/validate</code></a> endpoint in the API Hub, the API Hub will call your Ozone Connect server with the full consent payload <strong data-v-51a53dd6${_scopeId2}>before</strong> the consent is created. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Your LFI MUST return <code data-v-51a53dd6${_scopeId2}>data.status</code> set to one of:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-51a53dd6${_scopeId2}><thead data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><th data-v-51a53dd6${_scopeId2}>Status</th><th data-v-51a53dd6${_scopeId2}>Effect</th></tr></thead><tbody data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>valid</code></td><td data-v-51a53dd6${_scopeId2}>The consent is created and processing continues</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>invalid</code></td><td data-v-51a53dd6${_scopeId2}>The consent is rejected and an error is returned to the TPP</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-51a53dd6${_scopeId2}> If you have not configured the <span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/consent/action/validate</code></span> endpoint, the API Hub assumes all consents are valid and creates them immediately. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="/tech/lfi-api-hub/v2.2-rc1/consent-events/open-api/validate" data-v-51a53dd6${_scopeId2}>Validate Consent API Reference</a> for the full request and response schemas. `);
                } else {
                  return [
                    createTextVNode(" See the "),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/consent-events/open-api/validate" }, "Validate Consent API Reference"),
            ...
            _push2(`<h3 data-v-51a53dd6${_scopeId}>Step 3 — (Optional) Receive the consent event</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If your LFI has configured the <a href="/tech/lfi-api-hub/v2.2-rc1/consent-events/open-api/event-op" class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/consent/event/{operation}</code></a> endpoint, the API Hub will call <span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/consent/event/post</code></span> on your Ozone Connect server once the consent has been successfully created. `);
                } else {
                  return [
                    createTextVNode(" If your LFI has configured the "),
                    createVNode("a", {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` This is an informational notification — the API Hub does not expect a response body. Return <code data-v-51a53dd6${_scopeId2}>204 No Content</code> to acknowledge receipt. `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-51a53dd6${_scopeId}>Step 4 — End user is redirected to your Authorization Endpoint</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` After the consent is created via <span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/par</code></span>, the TPP redirects the end user to your <strong data-v-51a53dd6${_scopeId2}>Authorization Endpoint</strong> with the following query parameters: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Where <code data-v-51a53dd6${_scopeId2}>request_uri</code> is the value returned from the <code data-v-51a53dd6${_scopeId2}>/par</code> response. Your Authorization Endpoint is the URL you registered during <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/auth-endpoint" data-v-51a53dd6${_scopeId2}>environment-specific configuration</a>. `);
                } else {
                  return [
                    ...
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/auth-endpoint" }, "environment-specific configuration"),
                    createTextVNode(". ")
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-51a53dd6${_scopeId2}> Your Authorization Endpoint MUST NOT reject the redirect based on the query parameters it receives. If a TPP appends additional parameters beyond <code data-v-51a53dd6${_scopeId2}>client_id</code>, <code data-v-51a53dd6${_scopeId2}>response_type</code>, and <code data-v-51a53dd6${_scopeId2}>request_uri</code>, simply ignore them — do not treat the redirect as malformed. </p><p data-v-51a53dd6${_scopeId2}> The authoritative authorization request is the signed Request JWT referenced by <code data-v-51a53dd6${_scopeId2}>request_uri</code>; the API Hub validates it when you call <span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/auth</code></span> in Step 5. Forward whatever you receive and let Headless Heimdall be the source of truth. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 data-v-51a53dd6${_scopeId}>Step 5 — Call <span class="endpoint" data-v-51a53dd6${_scopeId}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId}>GET</span><code data-v-51a53dd6${_scopeId}>/auth</code></span></h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Upon receiving the end user redirect, your authorization server MUST immediately call <span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/auth</code></span> on the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/" data-v-51a53dd6${_scopeId2}>Headless Heimdall</a> base URL, passing through <strong data-v-51a53dd6${_scopeId2}>all</strong> the query parameters received from the redirect. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The <code data-v-51a53dd6${_scopeId2}>200</code> response contains:`);
                } else {
                  return [
                    createTextVNode("The "),
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-51a53dd6${_scopeId2}><thead data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><th data-v-51a53dd6${_scopeId2}>Field</th><th data-v-51a53dd6${_scopeId2}>Description</th></tr></thead><tbody data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>interaction.interactionId</code></td><td data-v-51a53dd6${_scopeId2}>Unique identifier for this authorization interaction — required for <code data-v-51a53dd6${_scopeId2}>doConfirm</code> and <code data-v-51a53dd6${_scopeId2}>doFail</code></td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>interaction.consentIdsList</code></td><td data-v-51a53dd6${_scopeId2}>Array of consent IDs associated with this interaction (currently one element)</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>tpp</code></td><td data-v-51a53dd6${_scopeId2}>TPP details including <code data-v-51a53dd6${_scopeId2}>clientId</code>, <code data-v-51a53dd6${_scopeId2}>tppName</code>, <code data-v-51a53dd6${_scopeId2}>orgId</code>, and directory record</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-51a53dd6${_scopeId2}><span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/auth</code></span> can return three outcomes:</p><ul data-v-51a53dd6${_scopeId2}><li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>200</code></strong> — Success. Continue with the authorization journey.</li><li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>303</code></strong> — Redirectable failure. The OIDC client was valid but the authorization request parameters failed validation. You MUST redirect the end user to the URI in the <code data-v-51a53dd6${_scopeId2}>Location</code> header <strong data-v-51a53dd6${_scopeId2}>without modification</strong>.</li><li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>400</code></strong> — Non-redirectable failure. The OIDC client could not be verified. You MUST render an error page and MUST NOT redirect back to the TPP.</li></ul>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createVNode("span", { class: "endpoint" }, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth" data-v-51a53dd6${_scopeId2}><span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/auth</code></span> API Reference</a> for the full response schema. `);
                } else {
                  return [
                    createTextVNode(" See the "),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth" }, [
                      createVNode("span", { class: "endpoint" }, [
                        createVNode("span", { class: "http-method http-method--get" }, "GET"),
                        createVNode("code", null, "/auth")
                      ]),
            ...
            _push2(`<h3 data-v-51a53dd6${_scopeId}>Step 6 — Retrieve the consent details</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Using the <code data-v-51a53dd6${_scopeId2}>consentId</code> from the <span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/auth</code></span> response, call <span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/consents/{consentId}</code></span> on the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/" data-v-51a53dd6${_scopeId2}>Consent Manager</a> to retrieve the full consent object. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-51a53dd6${_scopeId2}> Some consent types include encrypted personally identifiable information (PII) — for example, debtor or creditor details on payment consents. If the consent contains encrypted PII fields, your LFI MUST decrypt the data and validate that the decrypted values align exactly with the Open Finance API specification. See <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/" data-v-51a53dd6${_scopeId2}>Personal Identifiable Information</a> for decryption and validation details. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      ...
                      createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/" }, "Personal Identifiable Information"),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/consents-consentId" data-v-51a53dd6${_scopeId2}><span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/consents/{consentId}</code></span> API Reference</a> for the full response schema. `);
                } else {
                  return [
                    createTextVNode(" See the "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Your LFI MUST authenticate the end user using your standard authentication mechanisms. The authentication MUST satisfy the requirements defined in the <a href="/tech/lfi-api-hub/v2.2-rc1/consent-journey/authentication/requirements" data-v-51a53dd6${_scopeId2}>Authentication Requirements</a>. `);
                } else {
                  return [
                    ...
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/consent-journey/authentication/requirements" }, "Authentication Requirements"),
                    createTextVNode(". ")
                  ];
                }
              }),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-51a53dd6${_scopeId}>Step 8 — Present the authorization page</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-51a53dd6${_scopeId2}><thead data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><th data-v-51a53dd6${_scopeId2}>Consent Type</th><th data-v-51a53dd6${_scopeId2}>User Experience</th></tr></thead><tbody data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Bank Data Sharing</td><td data-v-51a53dd6${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/banking/data-sharing/user-journeys" data-v-51a53dd6${_scopeId2}>User Experience</a></td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Single Instant Payment</td><td data-v-51a53dd6${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/single-instant-payment/user-journeys" data-v-51a53dd6${_scopeId2}>User Experience</a></td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Insurance Data Sharing</td><td data-v-51a53dd6${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/insurance/data-sharing/user-journeys" data-v-51a53dd6${_scopeId2}>User Experience</a></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
                      ...
                      createVNode("tbody", null, [
                        createVNode("tr", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/banking/data-sharing/user-journeys" }, "User Experience")
                          ])
                        ]),
                        createVNode("tr", null, [
                          createVNode("td", null, "Single Instant Payment"),
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/single-instant-payment/user-journeys" }, "User Experience")
                          ])
                        ]),
                        createVNode("tr", null, [
                          createVNode("td", null, "Insurance Data Sharing"),
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/insurance/data-sharing/user-journeys" }, "User Experience")
                          ])
                        ])
                      ])
                    ])
            ...
            _push2(`<h3 data-v-51a53dd6${_scopeId}>Step 9a — end user authorizes: PATCH consent and doConfirm</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}>PATCH the consent</strong> to <code data-v-51a53dd6${_scopeId2}>Authorized</code> status, providing the end user identifiers, account IDs, and authorization channel</li><li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}>Call <code data-v-51a53dd6${_scopeId2}>doConfirm</code></strong> to complete the interaction and redirect the end user back to the TPP</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h4 data-v-51a53dd6${_scopeId}>PATCH the consent</h4>`);
            _push2(ssrRenderComponent(_component_EdCodeGroup, { tabs: patchAuthorizedTabs }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The <code data-v-51a53dd6${_scopeId2}>PATCH</code> returns <code data-v-51a53dd6${_scopeId2}>204 No Content</code> on success.`);
                } else {
                  return [
                    createTextVNode("The "),
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-51a53dd6${_scopeId2}><thead data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><th data-v-51a53dd6${_scopeId2}>Field</th><th style="${ssrRenderStyle({ "text-align": "center" })}" data-v-51a53dd6${_scopeId2}>Required</th><th data-v-51a53dd6${_scopeId2}>Description</th></tr></thead><tbody data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>status</code></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-51a53dd6${_scopeId2}>Yes</td><td data-v-51a53dd6${_scopeId2}>Set to <code data-v-51a53dd6${_scopeId2}>Authorized</code></td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>psuIdentifiers</code></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-51a53dd6${_scopeId2}>Yes</td><td data-v-51a53dd6${_scopeId2}>Object containing your internal end user identifier fields</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>accountIds</code></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-51a53dd6${_scopeId2}>Yes (Bank consents)</td><td data-v-51a53dd6${_scopeId2}>Array of account IDs the end user selected. For Bank Data Sharing, one or more accounts. For Bank Service Initiation, exactly one debtor account. Not patched for Insurance Data Sharing — use <code data-v-51a53dd6${_scopeId2}>insurancePolicyIds</code> instead</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>insurancePolicyIds</code></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-51a53dd6${_scopeId2}>Yes (Insurance Data Sharing)</td><td data-v-51a53dd6${_scopeId2}>Array of <code data-v-51a53dd6${_scopeId2}>InsurancePolicyId</code> values the end user selected. The Consent Manager mirrors this into <code data-v-51a53dd6${_scopeId2}>accountIds</code> automatically so downstream identifier handling stays uniform across consent types</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>authorizationChannel</code></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-51a53dd6${_scopeId2}>Yes</td><td data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>App</code> or <code data-v-51a53dd6${_scopeId2}>Web</code> — the channel on which the end user authorized the consent</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/patch-consents-consentId" data-v-51a53dd6${_scopeId2}><span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--patch" data-v-51a53dd6${_scopeId2}>PATCH</span><code data-v-51a53dd6${_scopeId2}>/consents/{consentId}</code></span> API Reference</a> for the full request schema. `);
                } else {
                  return [
                    createTextVNode(" See the "),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/patch-consents-consentId" }, [
                      createVNode("span", { class: "endpoint" }, [
                        createVNode("span", { class: "http-method http-method--patch" }, "PATCH"),
                        createVNode("code", null, "/consents/{consentId}")
                      ]),
            ...
            _push2(`<h4 data-v-51a53dd6${_scopeId}>Call doConfirm</h4>`);
            _push2(ssrRenderComponent(_component_EdCodeGroup, { tabs: doConfirmTabs }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The API Hub responds with a <strong data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>303 See Other</code></strong> containing the redirect URI back to the TPP. Your LFI MUST redirect the end user to this URI to complete the journey. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm" data-v-51a53dd6${_scopeId2}><span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/auth/{interactionId}/doConfirm</code></span> API Reference</a> for the full specification. `);
                } else {
                  return [
                    createTextVNode(" See the "),
            ...
            _push2(`<h3 data-v-51a53dd6${_scopeId}>Step 9b — end user rejects: PATCH consent and doFail</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}>PATCH the consent</strong> to <code data-v-51a53dd6${_scopeId2}>Rejected</code> status, providing the end user identifiers (but <strong data-v-51a53dd6${_scopeId2}>not</strong> account IDs)</li><li data-v-51a53dd6${_scopeId2}><strong data-v-51a53dd6${_scopeId2}>Call <code data-v-51a53dd6${_scopeId2}>doFail</code></strong> to complete the interaction and redirect the end user back to the TPP with an error</li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      createVNode("strong", null, "PATCH the consent"),
            ...
            _push2(`<h4 data-v-51a53dd6${_scopeId}>Call doFail</h4>`);
            _push2(ssrRenderComponent(_component_EdCodeGroup, { tabs: doFailTabs }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The API Hub responds with a <strong data-v-51a53dd6${_scopeId2}><code data-v-51a53dd6${_scopeId2}>303 See Other</code></strong> containing the redirect URI back to the TPP with OAuth 2.0 error parameters. Your LFI MUST redirect the end user to this URI. If you omit <code data-v-51a53dd6${_scopeId2}>error</code> and <code data-v-51a53dd6${_scopeId2}>error_description</code>, the API Hub will return default error values. `);
                } else {
                  return [
                    createTextVNode(" The API Hub responds with a "),
                    createVNode("strong", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doFail" data-v-51a53dd6${_scopeId2}><span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--post" data-v-51a53dd6${_scopeId2}>POST</span><code data-v-51a53dd6${_scopeId2}>/auth/{interactionId}/doFail</code></span> API Reference</a> for the full specification. `);
                } else {
                  return [
                    createTextVNode(" See the "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The values the LFI patches onto the consent — <code data-v-51a53dd6${_scopeId2}>psuIdentifiers</code> and <code data-v-51a53dd6${_scopeId2}>accountIds</code> — are stored centrally in the API Hub. They MUST be <strong data-v-51a53dd6${_scopeId2}>opaque, non-sensitive, LFI-defined references</strong>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-51a53dd6${_scopeId2}> The LFI MUST NOT use Emirates ID, passport number, name, email, phone number, IBAN, account number, card number, CIF, or any other value that on its own identifies a natural person or a real-world account. </p><p data-v-51a53dd6${_scopeId2}> See <a href="/knowledge-base/articles/consent-identifiers" data-v-51a53dd6${_scopeId2}>Consent Identifiers</a> for the full rationale. </p>`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-51a53dd6${_scopeId}><code data-v-51a53dd6${_scopeId}>psuIdentifiers.userId</code></h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-51a53dd6${_scopeId2}><thead data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><th data-v-51a53dd6${_scopeId2}>Rule</th><th data-v-51a53dd6${_scopeId2}>Requirement</th></tr></thead><tbody data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Type</td><td data-v-51a53dd6${_scopeId2}>String (required field on <code data-v-51a53dd6${_scopeId2}>psuIdentifiers</code>)</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Pattern</td><td data-v-51a53dd6${_scopeId2}>LFI-defined opaque string. UUID (v4) recommended</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Uniqueness</td><td data-v-51a53dd6${_scopeId2}>MUST uniquely identify a single end user within the LFI</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Stability</td><td data-v-51a53dd6${_scopeId2}>MUST be the same value for the same end user across every consent they authorise — used by <span class="endpoint" data-v-51a53dd6${_scopeId2}><span class="http-method http-method--get" data-v-51a53dd6${_scopeId2}>GET</span><code data-v-51a53dd6${_scopeId2}>/psu/{userId}/consents</code></span></td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Sensitive values</td><td data-v-51a53dd6${_scopeId2}>MUST NOT be an Emirates ID, email, phone, CIF, or any other PII</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Additional custom fields on <code data-v-51a53dd6${_scopeId2}>psuIdentifiers</code> are permitted but MUST follow the same non-sensitive rule. `);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-51a53dd6${_scopeId}><code data-v-51a53dd6${_scopeId}>accountIds[]</code></h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-51a53dd6${_scopeId2}><thead data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><th data-v-51a53dd6${_scopeId2}>Rule</th><th data-v-51a53dd6${_scopeId2}>Requirement</th></tr></thead><tbody data-v-51a53dd6${_scopeId2}><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Type</td><td data-v-51a53dd6${_scopeId2}>Array of strings, <code data-v-51a53dd6${_scopeId2}>minItems: 1</code></td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Item format</td><td data-v-51a53dd6${_scopeId2}>String, 1–40 characters. UUID (v4) recommended</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Value</td><td data-v-51a53dd6${_scopeId2}>MUST match the <code data-v-51a53dd6${_scopeId2}>AccountId</code> the LFI returns from its own <code data-v-51a53dd6${_scopeId2}>/accounts</code> APIs — the API Hub uses it to enrich downstream TPP requests</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Immutability</td><td data-v-51a53dd6${_scopeId2}>Once issued, the <code data-v-51a53dd6${_scopeId2}>AccountId</code> for an account MUST NOT change</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Uniqueness</td><td data-v-51a53dd6${_scopeId2}>MUST uniquely identify a single account within the LFI</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Sensitive values</td><td data-v-51a53dd6${_scopeId2}>MUST NOT be an IBAN, account number, card number, or any externally-meaningful account identifier</td></tr><tr data-v-51a53dd6${_scopeId2}><td data-v-51a53dd6${_scopeId2}>Cardinality</td><td data-v-51a53dd6${_scopeId2}>Bank Service Initiation: exactly one (the debtor account). Bank Data Sharing: one or more selected accounts. Insurance Data Sharing: not patched directly — the Consent Manager mirrors <code data-v-51a53dd6${_scopeId2}>insurancePolicyIds</code> into <code data-v-51a53dd6${_scopeId2}>accountIds</code> via trigger</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/consent-journey/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-51a53dd6"]]);
export {
  apiGuide as default
};
