...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          Single Instant Payment lets a TPP initiate a one-off domestic payment from a customer's
          account at your LFI via the API Hub. The payment runs on AANI as the primary rail with
          UAEFTS as the fallback. This guide covers the Ozone Connect endpoints your LFI MUST
          implement so the Hub can serve a TPP payment from consent creation through to execution and
          status retrieval.
        </p>
        <p class="ed-doc__lede">
          ...
          <a href="./requirements">Single Instant Payment Requirements</a>. This guide covers the
          request and response shape of each endpoint, with code walkthroughs for the parts that need
          them: decrypting the PII, validating the creditor, matching the payment-time PII against the
          consent, and reading the FAPI customer headers.
        </p>
      </div>
    </section>
    ...
    <EdSectionBand
      ...
      tone="cream"
    >
      <EdProse>Before implementing Single Instant Payment, ensure the following are in place:</EdProse>

      <EdBullets>
        <li>
          <strong>API Hub onboarded</strong> &mdash; Your API Hub instance is provisioned and your
          <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/">environment-specific
          configuration</a> is complete.
        </li>
        <li>
          <strong>Enc1 key pair generated and registered</strong> &mdash; The TPP encrypts PII to your
          LFI's <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/#enc1-encryption-key">Enc1
          public key</a>. Your LFI MUST hold the corresponding private key and be able to look it up
          by <code>kid</code>.
        </li>
        <li>
        ...
        <li>
          <strong>Single Instant Payment advertised</strong> &mdash;
          <code>ApiMetadata.SingleInstantPayment.Supported</code> is set to <code>true</code> on your
    ...
    >
      ...
      <EdProse>
        ...
        <code>Initiation.DebtorAccount</code>, <code>BaseConsentId</code>,
        <code>CurrencyRequest</code>, payment-type support, PII conformance, creditor checks &mdash;
        is enumerated in
        <a href="./requirements#consent-validation">Single Instant Payment Requirements &mdash;
        Consent Validation</a>. The two parts that need a code walkthrough are <strong>decrypting the
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/api-guide/decrypt-pii">How
        to Decrypt PII</a>.
      </EdProse>

      <EdProse>The decrypted consent-time PII for a Single Instant Payment looks like:</EdProse>
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/creditor#rejecting-an-invalid-consent">Rejecting
        an invalid consent</a>.
      </EdProse>

      <h3 class="ed-doc__subhead">Validating the Creditor</h3>
      <EdProse>
        For Single Instant Payment, <code>Initiation.Creditor</code> MUST be an array of exactly
        <strong>one</strong> entry. The full Creditor rules &mdash; cardinality, mandatory fields, BIC
        derivation &mdash; are in
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/creditor">Creditor</a>.
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/debtor-account">Debtor
        Account</a>.
      </EdProse>
      ...
      <EdProse>
        See
        <a href="/tech/lfi-api-hub/v2.2-rc1/consent-events/api-guide#validate-post-consent-action-validate">Consent
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/auth-endpoint">authorization
        endpoint</a> and your LFI runs the standard consent journey: authenticate the customer, retrieve
        the consent, present the debtor account selection screen subject to the rules in
        <a href="./requirements#authorization-account-selection">Authorization &mdash; Account
        Selection</a>, patch the selected debtor account and customer identifier onto the consent, and
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            <tr><td><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth" class="endpoint"><span class="http-method http-method--get">GET</span><code>/auth</code></a></td><td>LFI &rarr; API Hub</td><td>Initiate the authorization interaction</td></tr>
            <tr><td><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/consents-consentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/consents/{consentId}</code></a></td><td>LFI &rarr; API Hub</td><td>Retrieve the full consent details</td></tr>
            <tr><td><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/patch-consents-consentId" class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/consents/{consentId}</code></a></td><td>LFI &rarr; API Hub</td><td>Update consent status, customer identifiers, and the selected debtor account</td></tr>
            <tr><td><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm" class="endpoint"><span class="http-method http-method--post">POST</span><code>/auth/{interactionId}/doConfirm</code></a></td><td>LFI &rarr; API Hub</td><td>Complete the interaction and redirect back to the TPP successfully</td></tr>
      ...
      <EdProse>
        ...
        amount/currency match the consent control parameters, and validates the request against the
        OpenAPI schema &mdash; all before forwarding to your Ozone Connect
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments" class="endpoint"><span class="http-method http-method--post">POST</span><code>/payments</code></a>
    ...
    >
      ...
      <EdProse>
        <span class="endpoint"><span class="http-method http-method--post">POST</span><code>/payments</code></span> is the central endpoint your LFI implements for payment execution.
        The API Hub calls it after a TPP payment instruction has passed all Hub-side validations. Your
        LFI MUST decrypt and validate the PII, match it against the consent, run the synchronous
        validations listed in
        <a href="./requirements#post-payments-payment-execution">POST <code>/payments</code>
        Requirements</a>, create the payment record, and return <code>201</code> with the assigned
        <code>PaymentId</code>.
      </EdProse>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>o3-consent-id</code></td><td>Yes</td><td>The <code>consentId</code> for which this call is being made &mdash; the lookup key for the stored consent context (see <a href="#matching-the-pii-against-the-consent">Matching the PII against the consent</a>)</td></tr>
      ...
      <EdNote type="warning" title="Customer-set FAPI headers are inside the body, not the HTTP request">
        <p>
          ...
          <code>x-fapi-customer-ip-address</code>, <code>x-fapi-auth-date</code>,
          <code>x-fapi-interaction-id</code>, <code>x-customer-user-agent</code>, and
          <code>x-idempotency-key</code> &mdash; are forwarded to your LFI <strong>inside the request
          body</strong> as <code>requestHeaders</code>, not on the HTTP headers of the API Hub
          &rarr; LFI call. See
          <a href="#reading-the-fapi-customer-headers">Reading the FAPI customer headers</a>.
        </p>
      </EdNote>
      ...
      <EdProse>
        The Hub sends a plain JSON payload (not a JWS) containing the payment details, the headers
        the TPP supplied, and the TPP's directory record.
      </EdProse>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>paymentType</code></td><td>string</td><td>Yes</td><td>The payment type. MUST be <code>cbuae-payment</code> for domestic Single Instant Payment</td></tr>
            ...
            <tr><td><code>requestHeaders</code></td><td>object</td><td>Yes</td><td>The complete set of HTTP headers the TPP sent to the API Hub. The TPP's FAPI headers live here &mdash; see <a href="#reading-the-fapi-customer-headers">Reading the FAPI customer headers</a></td></tr>
            <tr><td><code>tpp</code></td><td>object</td><td>Yes</td><td>The TPP's directory record (<code>clientId</code>, <code>orgId</code>, <code>tppId</code>, <code>tppName</code>, <code>softwareStatementId</code>, <code>decodedSsa</code>, optional <code>directoryRecord</code>). Not required for payment execution &mdash; see <a href="/knowledge-base/articles/tpp-context-block">The <code>tpp</code> and <code>decodedSsa</code> Context Blocks</a> for field-by-field detail and the situations where an LFI uses them</td></tr>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>Instruction.Amount.Amount</code></td><td>string</td><td>Yes</td><td>Decimal amount with two fraction digits, e.g. <code>100.00</code></td></tr>
            ...
            <tr><td><code>PaymentPurposeCode</code></td><td>string</td><td>Yes</td><td>3-letter ISO 20022 purpose code, e.g. <code>ACM</code></td></tr>
            <tr><td><code>PersonalIdentifiableInformation</code></td><td>string</td><td>No</td><td>Encrypted PII payload as a JWE compact string. Required for the Creditor at payment time &mdash; see <a href="#reading-the-pii-at-payment-time">Reading the PII at payment time</a></td></tr>
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments">POST
        <code>/payments</code> API Reference</a>.
      </EdProse>
      ...
      <EdProse>
        ...
        Requirements</a> rule 2, the submitted creditor at payment time MUST exactly match the single
        creditor entry that was on the consent at consent time. Mismatch &rarr;
      ...
      <EdProse>
        ...
        Hub via
        <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/consents-consentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/consents/{consentId}</code></a>,
      ...
      <h3 id="reading-the-fapi-customer-headers" class="ed-doc__subhead">Reading the FAPI customer headers</h3>
      <EdProse>
        The TPP's FAPI headers (<code>x-fapi-customer-ip-address</code>,
        <code>x-fapi-auth-date</code>, <code>x-fapi-interaction-id</code>,
        <code>x-customer-user-agent</code>, <code>x-idempotency-key</code>) are forwarded inside
        <code>body.requestHeaders</code> &mdash; they are not on the actual HTTP headers of the API
        Hub &rarr; LFI call. Read them off the body.
      </EdProse>

      <EdProse>
        Per <a href="./requirements#post-payments-payment-execution">POST <code>/payments</code>
        Requirements</a> rule 3, <code>x-fapi-customer-ip-address</code> MUST be present on a Single
        Instant Payment (the customer is actively present at the time of the call) and MUST be a
        valid IPv4 or IPv6 address. Missing or malformed &rarr; <code>400 Body.InvalidFormat</code>.
      </EdProse>

      <EdCodeGroup :tabs="fapiHeaderTabs" />

      <EdProse>
        The validated IP is typically logged on the payment record and surfaced to fraud and
        screening systems alongside <code>x-fapi-auth-date</code> and
      ...
      <EdRefTable>
        <table>
          <thead><tr><th>Field</th><th>Type</th><th>Required</th><th>Description</th></tr></thead>
          <tbody>
            <tr><td><code>data.id</code></td><td>string</td><td>Yes</td><td>The LFI-assigned <code>PaymentId</code>. MUST be unique within your payment system, MUST NOT be reassigned, and MUST resolve to the same payment for the full 1-year <span class="endpoint"><span class="http-method http-method--get">GET</span><code>/payments/{paymentId}</code></span> sustain window &mdash; see <a href="./requirements#post-payments-payment-execution">Rule 7 of POST <code>/payments</code> Requirements</a></td></tr>
      ...
      <EdProse>
        ...
        responding. All error bodies MUST include <code>errorCode</code> and
        <code>errorMessage</code>. The <code>errorCode</code> values are drawn from the
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments">POST
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            <tr><td><code>Body.InvalidFormat</code></td><td>Body is absent, not valid JSON, fails schema validation, or <code>x-fapi-customer-ip-address</code> is missing/malformed</td></tr>
      ...
      <h4 class="ed-doc__subhead ed-doc__subhead--small"><code>409</code> / <code>500</code></h4>
      <EdProse>
        <code>409</code> for conflict conditions and <code>500</code> for transient/unrecoverable
        server errors. Use <code>GenericRecoverableError</code> if the Hub may retry,
        <code>GenericError</code> otherwise.
      </EdProse>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td>Status propagation</td><td>On every rail status change that maps to an Open Finance status, call <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/payment-log" class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/payment-log/{id}</code></a> on the API Hub Consent Manager. Once AANI/UAEFTS assigns the end-to-end identifier, include it as <code>paymentTransactionId</code> on the next PATCH</td><td><a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/overview/payment-status">Payment Status</a></td></tr>
            ...
            <tr><td>Status retrieval</td><td>Continue serving <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments-PaymentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/payments/{paymentId}</code></a> for at least 1 year, with <code>Status</code> and <code>paymentTransactionId</code> consistent with the most recent PATCH</td><td><a href="#behavioural-rules">GET <code>/payments/{paymentId}</code> rules below</a></td></tr>
          </tbody>
        </table>
      </EdRefTable>
    ...
    >
      ...
      <EdProse>
        ...
        <code>201</code> has been returned to the Hub on <span class="endpoint"><span class="http-method http-method--post">POST</span><code>/payments</code></span>.
      </EdProse>
      ...
      <EdRefTable>
        <table>
          <thead><tr><th>Field</th><th>Type</th><th>Required</th><th>Description</th></tr></thead>
          <tbody>
            <tr><td><code>paymentResponse.status</code></td><td>string</td><td>Yes</td><td><code>Pending</code>, <code>AcceptedSettlementCompleted</code>, <code>AcceptedCreditSettlementCompleted</code>, <code>AcceptedWithoutPosting</code>, or <code>Rejected</code>. See <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/overview/payment-status">Payment Status</a></td></tr>
            ...
            <tr><td><code>paymentResponse.OpenFinanceBilling.numberOfSuccessfulTransactions</code></td><td>integer</td><td>No</td><td>Number of successful transactions (typically <code>1</code> for a Single Instant Payment)</td></tr>
      ...
      <EdProse><code>Content-Type: application/json</code></EdProse>
      <EdProse>
        A successful PATCH returns <code>204 No Content</code> with no body. See the
        <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/payment-log">PATCH
        <code>/payment-log/:id</code> API Reference</a> for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        Returns the current state of a payment your LFI created via <span class="endpoint"><span class="http-method http-method--post">POST</span><code>/payments</code></span>. The
        TPP polls this to observe screening outcomes, rail settlement, and any subsequent rejection.
      </EdProse>

      <h3 class="ed-doc__subhead">Request headers</h3>
      <EdProse>See <a href="#post-payments">Common request headers</a>.</EdProse>
      ...
      <EdProse><code>Content-Type: application/json</code></EdProse>
      <EdProse>
        The response shape mirrors the <span class="endpoint"><span class="http-method http-method--post">POST</span><code>/payments</code></span> <code>201</code> response &mdash;
        same <code>data</code> envelope, with the current <code>Status</code>,
        <code>paymentTransactionId</code> (once assigned by the rail), and any rejection details.
      </EdProse>
      ...
      <EdProse>
        Per <a href="./requirements#get-payments-paymentid-payment-status-retrieval">GET
        <code>/payments/{paymentId}</code> Requirements</a>:
      </EdProse>
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td>2</td><td><strong>Status consistency with the API Hub</strong> &mdash; The <code>Status</code> returned MUST exactly match the most recent value PATCHed to the API Hub Consent Manager via <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/payment-log" class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/payment-log/{id}</code></a>. Any change in the LFI's systems MUST be reflected on both surfaces before it becomes observable to the TPP</td></tr>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments-PaymentId">GET
        <code>/payments/{paymentId}</code> API Reference</a> for the full schema.
      </EdProse>
    </EdSectionBand>
  </div>
</template>
