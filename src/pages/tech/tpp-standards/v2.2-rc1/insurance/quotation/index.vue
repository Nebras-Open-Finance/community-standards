    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a
            class="ed-link-card"
            href="/tech/tpp-standards/v2.2-rc1/insurance/quotation/requirements"
          ...
          <a
            class="ed-link-card"
            href="/tech/tpp-standards/v2.2-rc1/insurance/quotation/api-guide/"
          ...
          <a
            class="ed-link-card"
            href="/tech/tpp-standards/v2.2-rc1/insurance/quotation/user-journeys"
