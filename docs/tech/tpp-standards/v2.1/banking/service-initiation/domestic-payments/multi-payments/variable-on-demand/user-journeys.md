...
Before a customer authorises a Variable On Demand payment consent through Open Finance, you must present a Consent Page that clearly explains that you are seeking permission to make multiple payments of varying amounts at any time of your choosing. This page must accurately reflect the key details of the consent (payee, the maximum amount per individual payment, etc.). The examples and interactive wireframes below define the expected structure, content, and behaviour of the Consent Page and must be followed.
