<template>
    <div class="consent-page-frame">
      ...
      <div class="consent-page-text-inner-frame-2">
                ...
                <div class="consent-page-date-range" style="height:auto;">
                    ...
                    <div class="consent-page-dropdown" style="cursor: default;">
                        <div class="consent-page-date" >
                             ...
                             <div class="consent-page-date-text" style="height: auto;">Permission to make payments from this account will last until</div>



 <div class="consent-page-date-2">
                            <div class="consent-page-date-3">
