...
`;
const _sfc_main = {
  __name: "APIFlowsPeriodicSchedule",
  __ssrInlineRender: true,
  setup(__props) {
    useMermaidDiagram(mermaidDefinition, "periodic-schedule-diagram");
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/common/api-flows/APIFlowsPeriodicSchedule.vue");
