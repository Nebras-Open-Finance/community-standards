...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-469e02f7><section class="ed-doc__hero" data-v-469e02f7><div class="ed-doc__inner" data-v-469e02f7><div class="ed-doc__eyebrow" data-v-469e02f7><span class="ed-doc__eyebrow-dash" data-v-469e02f7></span> TPP · Banking · Bank Data Sharing </div><h1 class="ed-doc__title" data-v-469e02f7> Bank Data Sharing — API Guide <span class="ed-doc__read" data-v-469e02f7>5 min read</span></h1><p class="ed-doc__lede" data-v-469e02f7> Create a Bank Data Sharing consent, redirect the user to authenticate at their LFI, exchange the authorization code for tokens, and call the account APIs — an end-to-end walkthrough of the customer-present data-sharing flow. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-469e02f7${_scopeId2}><strong data-v-469e02f7${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-469e02f7${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the <strong data-v-469e02f7${_scopeId2}>BDSP role</strong> as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-469e02f7${_scopeId2}>Roles</a>. </li><li data-v-469e02f7${_scopeId2}><strong data-v-469e02f7${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-469e02f7${_scopeId2}>Transport Certificate</a></strong> — an active transport certificate must be issued and registered in the Trust Framework to establish secure <strong data-v-469e02f7${_scopeId2}>mTLS communication</strong>. </li><li data-v-469e02f7${_scopeId2}><strong data-v-469e02f7${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-469e02f7${_scopeId2}>Signing Certificate</a></strong> — an active signing certificate must be issued and registered in the Trust Framework. This certificate is used to sign request objects and client assertions. </li><li data-v-469e02f7${_scopeId2}><strong data-v-469e02f7${_scopeId2}>Registration with the relevant <a href="/tech/tpp-standards/registration/api-guide" data-v-469e02f7${_scopeId2}>API Hub (Authorisation Server)</a></strong> — the application must be registered with the API Hub (Server) of the LFI for which you intend to create a Bank Data Sharing consent. </li><li data-v-469e02f7${_scopeId2}><strong data-v-469e02f7${_scopeId2}>Understanding of the <a href="/tech/tpp-standards/security/fapi/" data-v-469e02f7${_scopeId2}>FAPI Security Profile</a></strong> and <strong data-v-469e02f7${_scopeId2}><a href="/tech/tpp-standards/security/tokens/" data-v-469e02f7${_scopeId2}>Tokens &amp; Assertions</a></strong> — you should understand how request object signing, client authentication, and access token validation underpin secure API interactions. </li><li data-v-469e02f7${_scopeId2}><strong data-v-469e02f7${_scopeId2}>Understanding of <a href="/tech/tpp-standards/v2.1/consent/" data-v-469e02f7${_scopeId2}>Consents</a></strong> — you should understand how to create, retrieve, and manage consents, including consent states and lifecycle transitions. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-469e02f7${_scopeId}><span class="http-badge http-post" data-v-469e02f7${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-469e02f7${_scopeId}>/par</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` To send a <code data-v-469e02f7${_scopeId2}>/par</code> request, first we need to generate the <code data-v-469e02f7${_scopeId2}>request JWT</code>. We do this by first constructing <code data-v-469e02f7${_scopeId2}>authorization_details</code> of type (<code data-v-469e02f7${_scopeId2}>urn:openfinanceuae:account-access-consent:v2.1</code>). `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-469e02f7${_scopeId}>authorization_details</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-469e02f7${_scopeId2}><thead data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><th data-v-469e02f7${_scopeId2}>Field</th><th data-v-469e02f7${_scopeId2}>Type</th><th data-v-469e02f7${_scopeId2}>Description</th><th data-v-469e02f7${_scopeId2}>Example</th></tr></thead><tbody data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>type</code>*</td><td data-v-469e02f7${_scopeId2}>enum</td><td data-v-469e02f7${_scopeId2}>Must be <code data-v-469e02f7${_scopeId2}>urn:openfinanceuae:account-access-consent:v2.1</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>urn:openfinanceuae:account-access-consent:v2.1</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>consent</code>*</td><td data-v-469e02f7${_scopeId2}>object</td><td data-v-469e02f7${_scopeId2}>Properties of the consent agreed by the User with the TPP. <em data-v-469e02f7${_scopeId2}>Described below.</em></td><td data-v-469e02f7${_scopeId2}><em data-v-469e02f7${_scopeId2}>Described below</em></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>subscription</code></td><td data-v-469e02f7${_scopeId2}>object</td><td data-v-469e02f7${_scopeId2}>Optional subscription to Event Notifications, to be sent to the TPP Webhook Url. <em data-v-469e02f7${_scopeId2}>Described below.</em></td><td data-v-469e02f7${_scopeId2}><em data-v-469e02f7${_scopeId2}>Described below</em></td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-469e02f7${_scopeId}>consent (Required) | <code data-v-469e02f7${_scopeId}>authorization_details.consent</code></h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-469e02f7${_scopeId2}><thead data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><th data-v-469e02f7${_scopeId2}>Field</th><th data-v-469e02f7${_scopeId2}>Type</th><th data-v-469e02f7${_scopeId2}>Description</th><th data-v-469e02f7${_scopeId2}>Example</th></tr></thead><tbody data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ConsentId</code>*</td><td data-v-469e02f7${_scopeId2}>string (uuid)</td><td data-v-469e02f7${_scopeId2}>Unique ID assigned by the TPP (1–128 chars)</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>123e4567-e89b-12d3-a456-426614174001</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>BaseConsentId</code></td><td data-v-469e02f7${_scopeId2}>string (uuid)</td><td data-v-469e02f7${_scopeId2}>Used when renewing or modifying an existing consent</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>123e4567-e89b-12d3-a456-426614174000</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Permissions</code>*</td><td data-v-469e02f7${_scopeId2}>array&lt;enum&gt;</td><td data-v-469e02f7${_scopeId2}>List of account access permissions being consented by the user</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ReadAccountsBasic</code>, <code data-v-469e02f7${_scopeId2}>ReadBalances</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ExpirationDateTime</code>*</td><td data-v-469e02f7${_scopeId2}>date-time</td><td data-v-469e02f7${_scopeId2}>Expiry date/time (ISO 8601 with timezone, max 1 year)</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>2025-11-03T15:46:00+00:00</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>FromDate</code></td><td data-v-469e02f7${_scopeId2}>date</td><td data-v-469e02f7${_scopeId2}>Start date for transaction access (ISO 8601 format)</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>2023-11-03</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ToDate</code></td><td data-v-469e02f7${_scopeId2}>date</td><td data-v-469e02f7${_scopeId2}>End date for transaction access (ISO 8601 format)</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>2025-11-03</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>AccountType</code></td><td data-v-469e02f7${_scopeId2}>array&lt;enum&gt;</td><td data-v-469e02f7${_scopeId2}>Allowed: <code data-v-469e02f7${_scopeId2}>Retail</code>, <code data-v-469e02f7${_scopeId2}>SME</code>, <code data-v-469e02f7${_scopeId2}>Corporate</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Retail</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>AccountSubType</code></td><td data-v-469e02f7${_scopeId2}>array&lt;enum&gt;</td><td data-v-469e02f7${_scopeId2}>Allowed: <code data-v-469e02f7${_scopeId2}>CurrentAccount</code>, <code data-v-469e02f7${_scopeId2}>Savings</code>, <code data-v-469e02f7${_scopeId2}>CreditCard</code>, <code data-v-469e02f7${_scopeId2}>Mortgage</code>, <code data-v-469e02f7${_scopeId2}>Finance</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Savings</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>OpenFinanceBilling</code>*</td><td data-v-469e02f7${_scopeId2}>object</td><td data-v-469e02f7${_scopeId2}>Billing parameters specified by the TPP. <em data-v-469e02f7${_scopeId2}>Described below.</em></td><td data-v-469e02f7${_scopeId2}><em data-v-469e02f7${_scopeId2}>Described below</em></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>OnBehalfOf</code></td><td data-v-469e02f7${_scopeId2}>object</td><td data-v-469e02f7${_scopeId2}>Provided when TPP is acting for another regulated entity. <em data-v-469e02f7${_scopeId2}>Described below.</em></td><td data-v-469e02f7${_scopeId2}><em data-v-469e02f7${_scopeId2}>Described below</em></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-469e02f7${_scopeId}>OpenFinanceBilling (Required) | <code data-v-469e02f7${_scopeId}>authorization_details.consent.OpenFinanceBilling</code></h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-469e02f7${_scopeId2}><thead data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><th data-v-469e02f7${_scopeId2}>Field</th><th data-v-469e02f7${_scopeId2}>Type</th><th data-v-469e02f7${_scopeId2}>Allowed Values</th><th data-v-469e02f7${_scopeId2}>Example</th></tr></thead><tbody data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>UserType</code>*</td><td data-v-469e02f7${_scopeId2}>enum</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Retail</code>, <code data-v-469e02f7${_scopeId2}>SME</code>, <code data-v-469e02f7${_scopeId2}>Corporate</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Retail</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Purpose</code>*</td><td data-v-469e02f7${_scopeId2}>enum</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>AccountAggregation</code>, <code data-v-469e02f7${_scopeId2}>RiskAssessment</code>, <code data-v-469e02f7${_scopeId2}>TaxFiling</code>, <code data-v-469e02f7${_scopeId2}>Onboarding</code>, <code data-v-469e02f7${_scopeId2}>Verification</code>, <code data-v-469e02f7${_scopeId2}>QuoteComparison</code>, <code data-v-469e02f7${_scopeId2}>BudgetingAnalysis</code>, <code data-v-469e02f7${_scopeId2}>FinancialAdvice</code>, <code data-v-469e02f7${_scopeId2}>AuditReconciliation</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>AccountAggregation</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-469e02f7${_scopeId}>OnBehalfOf (Optional) | <code data-v-469e02f7${_scopeId}>authorization_details.consent.OnBehalfOf</code></h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-469e02f7${_scopeId2}><thead data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><th data-v-469e02f7${_scopeId2}>Field</th><th data-v-469e02f7${_scopeId2}>Type</th><th data-v-469e02f7${_scopeId2}>Description</th><th data-v-469e02f7${_scopeId2}>Example</th></tr></thead><tbody data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>TradingName</code></td><td data-v-469e02f7${_scopeId2}>string</td><td data-v-469e02f7${_scopeId2}>Trading name if acting on behalf of another entity</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Acme Ltd</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>LegalName</code></td><td data-v-469e02f7${_scopeId2}>string</td><td data-v-469e02f7${_scopeId2}>Legal name of represented entity</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Acme Legal Name</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>IdentifierType</code></td><td data-v-469e02f7${_scopeId2}>enum</td><td data-v-469e02f7${_scopeId2}>Only <code data-v-469e02f7${_scopeId2}>Other</code> currently supported</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Other</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Identifier</code></td><td data-v-469e02f7${_scopeId2}>string</td><td data-v-469e02f7${_scopeId2}>Identifier value</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>9876543210</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-469e02f7${_scopeId}>subscription (Optional) | <code data-v-469e02f7${_scopeId}>authorization_details.subscription</code></h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-469e02f7${_scopeId2}><thead data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><th data-v-469e02f7${_scopeId2}>Field</th><th data-v-469e02f7${_scopeId2}>Type</th><th data-v-469e02f7${_scopeId2}>Description</th><th data-v-469e02f7${_scopeId2}>Example</th></tr></thead><tbody data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Webhook</code>*</td><td data-v-469e02f7${_scopeId2}>object</td><td data-v-469e02f7${_scopeId2}><em data-v-469e02f7${_scopeId2}>Described below.</em></td><td data-v-469e02f7${_scopeId2}><em data-v-469e02f7${_scopeId2}>Described below</em></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-469e02f7${_scopeId}>Webhook (Required) | <code data-v-469e02f7${_scopeId}>authorization_details.subscription.Webhook</code></h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-469e02f7${_scopeId2}><thead data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><th data-v-469e02f7${_scopeId2}>Field</th><th data-v-469e02f7${_scopeId2}>Type</th><th data-v-469e02f7${_scopeId2}>Description</th><th data-v-469e02f7${_scopeId2}>Example</th></tr></thead><tbody data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>Url</code>*</td><td data-v-469e02f7${_scopeId2}>string</td><td data-v-469e02f7${_scopeId2}>HTTPS callback URL</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>https://tpp.example.com/webhook</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>IsActive</code>*</td><td data-v-469e02f7${_scopeId2}>boolean</td><td data-v-469e02f7${_scopeId2}>Whether webhook is active</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>true</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-469e02f7${_scopeId}>Example request</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See an example of a valid <code data-v-469e02f7${_scopeId2}>authorization_details</code> for <code data-v-469e02f7${_scopeId2}>urn:openfinanceuae:account-access-consent:v2.1</code>: `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` With your <code data-v-469e02f7${_scopeId2}>authorization_details</code> ready, generate a PKCE code pair then use the <a href="/tech/tpp-standards/security/fapi/request-jwt#building-the-request-jwt" data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>buildRequestJWT()</code></a> helper from the FAPI page, passing <code data-v-469e02f7${_scopeId2}>accounts openid</code> as the scope. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-469e02f7${_scopeId2}> Save <code data-v-469e02f7${_scopeId2}>codeVerifier</code> in your server-side session or an <code data-v-469e02f7${_scopeId2}>httpOnly</code> cookie. You will need it in <a href="#step-7-post-token-authorization-code" data-v-469e02f7${_scopeId2}>Step 7</a> to exchange the authorization code for tokens. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/fapi/request-jwt" data-v-469e02f7${_scopeId2}>Preparing the Request JWT</a> for the full JWT claim reference and PKCE helpers. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Every call to the API Hub (Authorisation Server) requires a <strong data-v-469e02f7${_scopeId2}>client assertion</strong> — a short-lived signed JWT that proves your application&#39;s identity in place of a client secret. Use the <a href="/tech/tpp-standards/security/fapi/message-signing#signing-a-jwt" data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>signJWT()</code></a> helper from the FAPI Message Signing page: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/tokens/#generating-a-client-assertion" data-v-469e02f7${_scopeId2}>Tokens &amp; Assertions</a> for the full claims reference and <a href="/tech/tpp-standards/security/tokens/client-assertion" data-v-469e02f7${_scopeId2}>Preparing Your Client Assertion</a> for a step-by-step walkthrough. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` With your signed Request JWT and client assertion ready, POST both to the API Hub&#39;s <code data-v-469e02f7${_scopeId2}>/par</code> endpoint. The connection must use your <strong data-v-469e02f7${_scopeId2}>mTLS transport certificate</strong>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Include <code data-v-469e02f7${_scopeId2}>x-fapi-interaction-id</code> — a UUID v4 you generate per request. The API Hub echoes it in the response, enabling end-to-end traceability. See <a href="/tech/tpp-standards/security/request-headers" data-v-469e02f7${_scopeId2}>Request Headers</a> for the full header reference. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-469e02f7${_scopeId2}> You must present your <strong data-v-469e02f7${_scopeId2}>transport certificate</strong> on every connection to the API Hub and resource APIs. In Node.js, configure an <code data-v-469e02f7${_scopeId2}>https.Agent</code> with your PEM certificate and private key. See <a href="/tech/tpp-standards/trust-framework/certificates" data-v-469e02f7${_scopeId2}>Certificates</a> for how to obtain and configure your transport certificate. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The <code data-v-469e02f7${_scopeId2}>/par</code> response contains:`);
                } else {
                  return [
                    createTextVNode("The "),
                    createVNode("code", null, "/par"),
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-469e02f7${_scopeId2}><thead data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><th data-v-469e02f7${_scopeId2}>Field</th><th data-v-469e02f7${_scopeId2}>Description</th><th data-v-469e02f7${_scopeId2}>Example</th></tr></thead><tbody data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>request_uri</code></td><td data-v-469e02f7${_scopeId2}>A single-use reference to your pushed authorization request</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>urn:ietf:params:oauth:request-uri:bwc4JDpSd7</code></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>expires_in</code></td><td data-v-469e02f7${_scopeId2}>Seconds until the <code data-v-469e02f7${_scopeId2}>request_uri</code> expires — redirect the user before this window closes</td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>90</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Use the <code data-v-469e02f7${_scopeId2}>request_uri</code> returned by <code data-v-469e02f7${_scopeId2}>/par</code> to build the redirect URL. The <code data-v-469e02f7${_scopeId2}>authorization_endpoint</code> is found in the LFI&#39;s <code data-v-469e02f7${_scopeId2}>.well-known/openid-configuration</code> — not constructed from the issuer URL directly. All authorization parameters are already inside the signed Request JWT, so the only query parameters needed are <code data-v-469e02f7${_scopeId2}>client_id</code>, <code data-v-469e02f7${_scopeId2}>response_type</code>, and <code data-v-469e02f7${_scopeId2}>request_uri</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-469e02f7${_scopeId2}> See <a href="/tech/tpp-standards/v2.1/banking/data-sharing/user-journeys" data-v-469e02f7${_scopeId2}>User Experience</a> for screen mockups of the <strong data-v-469e02f7${_scopeId2}>Consent</strong> and <strong data-v-469e02f7${_scopeId2}>Authorization</strong> pages the user sees at the bank, including an interactive example where you can edit the consent JSON and preview the resulting UI. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" See "),
                      createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/user-journeys" }, "User Experience"),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-469e02f7${_scopeId2}>Authenticate with their bank.</li><li data-v-469e02f7${_scopeId2}>Review the consent — accounts, permissions, and expiry — on the bank&#39;s authorization screen.</li><li data-v-469e02f7${_scopeId2}>Approve or decline.</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` After the user approves, the bank redirects them back to your <code data-v-469e02f7${_scopeId2}>redirect_uri</code>. The callback includes an authorization <code data-v-469e02f7${_scopeId2}>code</code>, the <code data-v-469e02f7${_scopeId2}>state</code> you sent in your Request JWT, and the <code data-v-469e02f7${_scopeId2}>iss</code> (issuer) of the API Hub Authorisation Server: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Extract all three parameters and validate <code data-v-469e02f7${_scopeId2}>state</code> and <code data-v-469e02f7${_scopeId2}>iss</code> before proceeding: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/fapi/handling-callback" data-v-469e02f7${_scopeId2}>Handling Authorization Callbacks</a> for a full guide on security best practices including issuer verification, replay prevention, and keeping callback logic minimal. `);
                } else {
                  return [
                    createTextVNode(" See "),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-469e02f7${_scopeId}><span class="http-badge http-post" data-v-469e02f7${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-469e02f7${_scopeId}>/token</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Exchange the authorization code for an access token and refresh token. Include the <code data-v-469e02f7${_scopeId2}>code_verifier</code> from Step 2 — the API Hub will verify it against the <code data-v-469e02f7${_scopeId2}>code_challenge</code> in your Request JWT before issuing tokens. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Store both tokens securely. The <strong data-v-469e02f7${_scopeId2}>access token</strong> expires in <strong data-v-469e02f7${_scopeId2}>10 minutes</strong>; the <strong data-v-469e02f7${_scopeId2}>refresh token</strong> remains valid for the lifetime of the consent. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-469e02f7${_scopeId2}> Never store tokens in <code data-v-469e02f7${_scopeId2}>localStorage</code>. Use <code data-v-469e02f7${_scopeId2}>httpOnly</code> cookies or a server-side session store. See <a href="/tech/tpp-standards/security/tokens/" data-v-469e02f7${_scopeId2}>Tokens &amp; Assertions</a> for the full token lifecycle and expiry guidance. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-469e02f7${_scopeId}><span class="http-badge http-get" data-v-469e02f7${_scopeId}>GET</span><code class="ed-doc__endpoint-path" data-v-469e02f7${_scopeId}>/accounts</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` With a valid access token, retrieve all accounts the user consented to share. Include <code data-v-469e02f7${_scopeId2}>x-fapi-interaction-id</code> on every request, and when the customer is present also send <code data-v-469e02f7${_scopeId2}>x-fapi-customer-ip-address</code> and <code data-v-469e02f7${_scopeId2}>x-customer-user-agent</code> and <code data-v-469e02f7${_scopeId2}>x-fapi-auth-date</code> if the customer has been authenticated. See <a href="/tech/tpp-standards/security/request-headers" data-v-469e02f7${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts" data-v-469e02f7${_scopeId2}>GET /accounts</a> API reference for the full response schema. `);
                } else {
                  return [
                    createTextVNode(" See the "),
                    createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts" }, "GET /accounts"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Use a stored <code data-v-469e02f7${_scopeId2}>AccountId</code> to fetch data from a specific account&#39;s sub-resources. Each endpoint requires the matching <code data-v-469e02f7${_scopeId2}>Read*</code> permission in your consent. Apply the same FAPI headers as Step 8. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-469e02f7${_scopeId2}><thead data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><th data-v-469e02f7${_scopeId2}>Endpoint</th><th data-v-469e02f7${_scopeId2}>Required Permission</th><th data-v-469e02f7${_scopeId2}>API Reference</th></tr></thead><tbody data-v-469e02f7${_scopeId2}><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>/accounts/{AccountId}/balances</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ReadBalances</code></td><td data-v-469e02f7${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-balances" data-v-469e02f7${_scopeId2}>reference</a></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>/accounts/{AccountId}/transactions</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ReadTransactionsBasic</code></td><td data-v-469e02f7${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-transactions" data-v-469e02f7${_scopeId2}>reference</a></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>/accounts/{AccountId}/beneficiaries</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ReadBeneficiariesBasic</code></td><td data-v-469e02f7${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-beneficiaries" data-v-469e02f7${_scopeId2}>reference</a></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>/accounts/{AccountId}/direct-debits</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ReadDirectDebits</code></td><td data-v-469e02f7${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-direct-debits" data-v-469e02f7${_scopeId2}>reference</a></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>/accounts/{AccountId}/standing-orders</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ReadStandingOrdersBasic</code></td><td data-v-469e02f7${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-standing-orders" data-v-469e02f7${_scopeId2}>reference</a></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>/accounts/{AccountId}/scheduled-payments</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ReadScheduledPaymentsBasic</code></td><td data-v-469e02f7${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-scheduled-payments" data-v-469e02f7${_scopeId2}>reference</a></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>/accounts/{AccountId}/statements</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ReadStatements</code></td><td data-v-469e02f7${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-statements" data-v-469e02f7${_scopeId2}>reference</a></td></tr><tr data-v-469e02f7${_scopeId2}><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>/accounts/{AccountId}/parties</code></td><td data-v-469e02f7${_scopeId2}><code data-v-469e02f7${_scopeId2}>ReadParty</code></td><td data-v-469e02f7${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-parties" data-v-469e02f7${_scopeId2}>reference</a></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
                      ...
                      createVNode("tbody", null, [
                        createVNode("tr", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-balances" }, "reference")
                          ])
                        ]),
                        createVNode("tr", null, [
                          createVNode("td", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-transactions" }, "reference")
                          ])
                        ]),
                        createVNode("tr", null, [
                          createVNode("td", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-beneficiaries" }, "reference")
                          ])
                        ]),
                        createVNode("tr", null, [
                          createVNode("td", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-direct-debits" }, "reference")
                          ])
                        ]),
                        createVNode("tr", null, [
                          createVNode("td", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-standing-orders" }, "reference")
                          ])
                        ]),
                        createVNode("tr", null, [
                          createVNode("td", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-scheduled-payments" }, "reference")
                          ])
                        ]),
                        createVNode("tr", null, [
                          createVNode("td", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-statements" }, "reference")
                          ])
                        ]),
                        createVNode("tr", null, [
                          createVNode("td", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/open-api/accounts-AccountId-parties" }, "reference")
                          ])
                        ])
                      ])
                    ])
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-469e02f7${_scopeId2}> For <code data-v-469e02f7${_scopeId2}>/transactions</code> and <code data-v-469e02f7${_scopeId2}>/statements</code>, an LFI MUST make at least <strong data-v-469e02f7${_scopeId2}>two years</strong> of history available. A <code data-v-469e02f7${_scopeId2}>200</code> response with an empty <code data-v-469e02f7${_scopeId2}>data</code> array therefore only means <em data-v-469e02f7${_scopeId2}>no records exist</em> when your query range falls <strong data-v-469e02f7${_scopeId2}>within that guaranteed two-year window</strong>. </p><p data-v-469e02f7${_scopeId2}> If you query a period older than two years, an empty or partial result does <strong data-v-469e02f7${_scopeId2}>not</strong> imply the customer had no activity then — the LFI may simply not retain data that far back (it MAY return older records, but is not required to). Do not infer absence of spend, income, or other activity for any period beyond the two-year guarantee. </p><p data-v-469e02f7${_scopeId2}> The API Hub rejects a date-range query with <code data-v-469e02f7${_scopeId2}>400</code><code data-v-469e02f7${_scopeId2}>Resource.InvalidFormat</code> before it reaches the LFI when <code data-v-469e02f7${_scopeId2}>fromBookingDateTime</code> is after <code data-v-469e02f7${_scopeId2}>toBookingDateTime</code>, or when <code data-v-469e02f7${_scopeId2}>toBookingDateTime</code> / <code data-v-469e02f7${_scopeId2}>toStatementDate</code> is in the future. A <code data-v-469e02f7${_scopeId2}>fromBookingDateTime</code> in the future is not rejected but serves no purpose — the range can never match a record. See <a href="/knowledge-base/articles/transaction-date-filters" data-v-469e02f7${_scopeId2}>Date Filters</a> for the full behaviour. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" For "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Access tokens expire after <strong data-v-469e02f7${_scopeId2}>10 minutes</strong>. Track the <code data-v-469e02f7${_scopeId2}>expires_in</code> value returned by <code data-v-469e02f7${_scopeId2}>/token</code> and refresh proactively rather than waiting for a <code data-v-469e02f7${_scopeId2}>401 Unauthorized</code>. Each refresh requires a fresh client assertion. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-469e02f7${_scopeId2}> Always replace both <code data-v-469e02f7${_scopeId2}>access_token</code> and <code data-v-469e02f7${_scopeId2}>refresh_token</code> from the response. If the API Hub rotates refresh tokens, continuing to use the old one will return <code data-v-469e02f7${_scopeId2}>400 invalid_grant</code>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The refresh token remains valid until the consent&#39;s <code data-v-469e02f7${_scopeId2}>ExpirationDateTime</code>. Once expired, the user must go through the full authorization flow again — send a new <code data-v-469e02f7${_scopeId2}>/par</code> request with a new <code data-v-469e02f7${_scopeId2}>ConsentId</code>. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/data-sharing/api-guide/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-469e02f7"]]);
export {
  index as default
};
