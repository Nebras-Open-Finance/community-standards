...
<template>
  <div class="ed-doc">
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm" class="endpoint"><span class="http-method http-method--post">POST</span><code>/auth/{interactionId}/doConfirm</code></a></td><td>LFI &rarr; API Hub</td><td>Complete the interaction successfully</td></tr>
            <tr><td><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doFail" class="endpoint"><span class="http-method http-method--post">POST</span><code>/auth/{interactionId}/doFail</code></a></td><td>LFI &rarr; API Hub</td><td>Complete the interaction with a failure</td></tr>
          </tbody>
        </table>
      </EdRefTable>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td>Status propagation</td><td>On every rail status change, call <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/payment-log" class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/payment-log/{id}</code></a></td><td><a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/overview/payment-status">Payment Status</a></td></tr>
            ...
            <tr><td>Status retrieval</td><td>Continue serving <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments-PaymentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/payments/{paymentId}</code></a> for at least 1 year</td><td><a href="#behavioural-rules">GET <code>/payments/{paymentId}</code> rules below</a></td></tr>
          </tbody>
        </table>
      </EdRefTable>
    </EdSectionBand>
    ...
    >
      <p>
        <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/payment-log" class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/payment-log/:id</code></a>
    ...
    >
      <p>
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments-PaymentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/payments/:paymentId</code></a>
