...
import WireframePreview from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/delegated-sca/_shared/WireframePreview.vue'
import AccountSetup from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/delegated-sca/_shared/AccountSetup.vue'
import UIBehaviour from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/delegated-sca/_shared/UIBehaviour.vue'
import ExampleJourneys from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/delegated-sca/_shared/ExampleJourneys.vue'
...
if (
    ...
    value?.Data?.ControlParameters?.IsDelegatedAuthentication !== true
    ) {
    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          When a customer is redirected to you to authorize a Delegated SCA payment consent through Open
          Finance, you must present an <strong>Authorization Page</strong> that clearly explains the payment
          the customer is authorizing &mdash; that the TPP is seeking permission to initiate payments on
          their behalf, but the customer will be required to authenticate and approve each individual payment
          before it is executed &mdash; no payment will be taken automatically. The page must accurately
          reflect the payee and the nature of the delegated consent being granted.
        </p>
