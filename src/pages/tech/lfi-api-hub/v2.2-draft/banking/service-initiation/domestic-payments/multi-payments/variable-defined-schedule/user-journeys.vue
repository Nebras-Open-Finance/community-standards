...
import WireframePreview from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/variable-defined-schedule/_shared/WireframePreview.vue'
import AccountSetup from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/variable-defined-schedule/_shared/AccountSetup.vue'
import UIBehaviour from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/variable-defined-schedule/_shared/UIBehaviour.vue'
import ExampleJourneys from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/variable-defined-schedule/_shared/ExampleJourneys.vue'
    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          When a customer is redirected to you to authorize a Variable Defined Schedule payment consent
          through Open Finance, you must present an <strong>Authorization Page</strong> that clearly explains
          the payment the customer is authorizing &mdash; that a pre-defined series of payments will be made,
          each on a specific date and up to a variable maximum amount. The page must collect the customer's
          explicit and informed consent, and it must accurately reflect the key details of the consent
          (payee, the complete list of scheduled payment dates and the maximum amount for each, etc.)
        </p>
