...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-62922326>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-62922326${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-62922326${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`UAE Open Finance treats customer identity as <strong data-v-62922326${_scopeId2}>verified claims</strong> — assertions about a person or organisation that the LFI has checked under a known framework. OIDC IDA is the standards-track JSON format for exactly this: claims grouped inside a <code data-v-62922326${_scopeId2}>verifiedClaims</code> object, each group labelled with the <code data-v-62922326${_scopeId2}>verification.trustFramework</code> under which it was verified.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-62922326${_scopeId2}><em data-v-62922326${_scopeId2}>Party Identity Assurance (Response) Schema — Based on the <a href="https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html" data-v-62922326${_scopeId2}>OpenID Connect for Identity Assurance 1.0 Specification</a></em></p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createVNode("em", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-62922326${_scopeId2}><thead data-v-62922326${_scopeId2}><tr data-v-62922326${_scopeId2}><th data-v-62922326${_scopeId2}>Level</th><th data-v-62922326${_scopeId2}>Purpose</th></tr></thead><tbody data-v-62922326${_scopeId2}><tr data-v-62922326${_scopeId2}><td data-v-62922326${_scopeId2}><code data-v-62922326${_scopeId2}>verifiedClaims[]</code></td><td data-v-62922326${_scopeId2}>Array — allows multiple claim groups for the same subject, each verified under a different framework or evidence path. Most LFIs return a single element</td></tr><tr data-v-62922326${_scopeId2}><td data-v-62922326${_scopeId2}><code data-v-62922326${_scopeId2}>verification</code></td><td data-v-62922326${_scopeId2}>Describes how the claims were verified. <code data-v-62922326${_scopeId2}>trustFramework</code> is the primary discriminator</td></tr><tr data-v-62922326${_scopeId2}><td data-v-62922326${_scopeId2}><code data-v-62922326${_scopeId2}>claims</code></td><td data-v-62922326${_scopeId2}>The actual identity attributes — name, Emirates ID, address, business name, trade licence, etc.</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-62922326${_scopeId}><code data-v-62922326${_scopeId}>verification.trustFramework</code></h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`For UAE Open Finance, the canonical value is <code data-v-62922326${_scopeId2}>UAE.FI</code> — the Trust Framework under which UAE Licensed Financial Institutions verify customer identity to onboarding standards set by the CBUAE.`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-62922326${_scopeId}><code data-v-62922326${_scopeId}>claims</code> — person vs. organisation</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The shape of <code data-v-62922326${_scopeId2}>claims</code> depends on whether the subject is a natural person or an organisation. <code data-v-62922326${_scopeId2}>identityType</code> discriminates:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-62922326${_scopeId2}><thead data-v-62922326${_scopeId2}><tr data-v-62922326${_scopeId2}><th data-v-62922326${_scopeId2}><code data-v-62922326${_scopeId2}>identityType</code></th><th data-v-62922326${_scopeId2}>Used for</th><th data-v-62922326${_scopeId2}>Key claims</th></tr></thead><tbody data-v-62922326${_scopeId2}><tr data-v-62922326${_scopeId2}><td data-v-62922326${_scopeId2}><code data-v-62922326${_scopeId2}>Person</code></td><td data-v-62922326${_scopeId2}>Retail customers</td><td data-v-62922326${_scopeId2}><code data-v-62922326${_scopeId2}>fullName</code>, <code data-v-62922326${_scopeId2}>givenName</code>, <code data-v-62922326${_scopeId2}>familyName</code>, <code data-v-62922326${_scopeId2}>emiratesId</code>, <code data-v-62922326${_scopeId2}>emiratesIdExpiryDate</code>, <code data-v-62922326${_scopeId2}>birthDate</code>, <code data-v-62922326${_scopeId2}>nationality</code>, <code data-v-62922326${_scopeId2}>mobileNumber</code>, <code data-v-62922326${_scopeId2}>email</code>, <code data-v-62922326${_scopeId2}>residentialAddress</code></td></tr><tr data-v-62922326${_scopeId2}><td data-v-62922326${_scopeId2}><code data-v-62922326${_scopeId2}>Organisation</code></td><td data-v-62922326${_scopeId2}>SME / Corporate customers</td><td data-v-62922326${_scopeId2}><code data-v-62922326${_scopeId2}>businessName</code>, <code data-v-62922326${_scopeId2}>tradeLicenceNumber</code>, <code data-v-62922326${_scopeId2}>taxIdentificationNumber</code>, <code data-v-62922326${_scopeId2}>dateOfIncorporation</code>, <code data-v-62922326${_scopeId2}>countryOfIncorporation</code>, <code data-v-62922326${_scopeId2}>corporateAddress</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-62922326${_scopeId}><code data-v-62922326${_scopeId}>GET /customer</code></h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The record for the end user who authenticated the consent. The LFI identifies the end user from the <code data-v-62922326${_scopeId2}>o3-psu-identifier</code> header and returns <strong data-v-62922326${_scopeId2}>one</strong> customer record:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Single object under <code data-v-62922326${_scopeId2}>data</code>, not an array.`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-62922326${_scopeId}><code data-v-62922326${_scopeId}>GET /accounts/{accountId}/customer</code></h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Returns <strong data-v-62922326${_scopeId2}>one record per customer</strong> associated with the account. Joint accounts produce one record per joint holder. Each record carries <code data-v-62922326${_scopeId2}>customerType</code> (<code data-v-62922326${_scopeId2}>Sole</code>, <code data-v-62922326${_scopeId2}>Joint</code>, <code data-v-62922326${_scopeId2}>Delegate</code>) and <code data-v-62922326${_scopeId2}>accountRole</code> (<code data-v-62922326${_scopeId2}>Principal</code>, <code data-v-62922326${_scopeId2}>SecondaryOwner</code>, <code data-v-62922326${_scopeId2}>PowerOfAttorney</code>, etc.) in addition to the shared envelope:`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-62922326${_scopeId}><code data-v-62922326${_scopeId}>POST /customers/action/cop-query</code></h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Returns <strong data-v-62922326${_scopeId2}>one record per customer</strong> on the account being looked up. The schema uses a slightly leaner shape — only the <code data-v-62922326${_scopeId2}>verifiedClaims</code> envelope with the name-related claims the Hub needs to run the CoP match:`);
                } else {
                  return [
                    createTextVNode("Returns "),
                    createVNode("strong", null, "one record per customer"),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`For business accounts, CoP uses <code data-v-62922326${_scopeId2}>verifiedClaims[].organisationClaims.name</code> in place of <code data-v-62922326${_scopeId2}>claims</code>:`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`CoP and <code data-v-62922326${_scopeId2}>GET /customer</code> have very different use cases — a name-match check before a payment vs. the full identity of a consented end user — but the shape of the answer is the same because the <strong data-v-62922326${_scopeId2}>question</strong> is the same at its core: &quot;under which trust framework has this institution verified this party&#39;s identity, and what are the claims?&quot;`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-62922326${_scopeId2}><thead data-v-62922326${_scopeId2}><tr data-v-62922326${_scopeId2}><th data-v-62922326${_scopeId2}>Aspect</th><th data-v-62922326${_scopeId2}>Rule</th></tr></thead><tbody data-v-62922326${_scopeId2}><tr data-v-62922326${_scopeId2}><td data-v-62922326${_scopeId2}>Response envelope</td><td data-v-62922326${_scopeId2}><code data-v-62922326${_scopeId2}>verifiedClaims[]</code> → <code data-v-62922326${_scopeId2}>verification</code> + <code data-v-62922326${_scopeId2}>claims</code> (or <code data-v-62922326${_scopeId2}>organisationClaims</code> for CoP businesses)</td></tr><tr data-v-62922326${_scopeId2}><td data-v-62922326${_scopeId2}>Trust framework</td><td data-v-62922326${_scopeId2}><code data-v-62922326${_scopeId2}>UAE.FI</code> for UAE Open Finance</td></tr><tr data-v-62922326${_scopeId2}><td data-v-62922326${_scopeId2}>Person vs. organisation</td><td data-v-62922326${_scopeId2}>Discriminated by <code data-v-62922326${_scopeId2}>identityType</code> (<code data-v-62922326${_scopeId2}>Person</code> / <code data-v-62922326${_scopeId2}>Organisation</code>)</td></tr><tr data-v-62922326${_scopeId2}><td data-v-62922326${_scopeId2}>Field population</td><td data-v-62922326${_scopeId2}>Every claim the LFI holds or can derive <strong data-v-62922326${_scopeId2}>MUST</strong> be populated</td></tr><tr data-v-62922326${_scopeId2}><td data-v-62922326${_scopeId2}>Source specification</td><td data-v-62922326${_scopeId2}><a href="https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html" data-v-62922326${_scopeId2}>OpenID Connect for Identity Assurance 1.0</a></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
...
const identityAssuranceClaims = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-62922326"]]);
export {
