...
const capabilities: Capability[] = [
  {
    href: '/tech/tpp-standards/v2.2-draft/banking/data-sharing/',
  ...
  {
    href: '/tech/tpp-standards/v2.2-draft/banking/service-initiation/',
  ...
  {
    href: '/tech/tpp-standards/v2.2-draft/banking/confirmation-of-payee/',
  ...
  {
    href: '/tech/tpp-standards/v2.2-draft/banking/products-leads/',
    cat: 'Products & Leads',
    color: 'var(--at-navy)',
  ...
  {
    href: '/tech/tpp-standards/v2.2-draft/banking/atms/',
    cat: 'ATMs',
    ...
    <section class="ed-landing__hero">
      <div class="ed-landing__inner">
        <div class="ed-landing__eyebrow">
          ...
          TPP Standards &middot; v2.2-draft &middot; Banking
        </div>
