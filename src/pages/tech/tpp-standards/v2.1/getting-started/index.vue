      ...
      <ol class="ed-doc__steps">
        <li>
          ...
          <ol class="ed-doc__substeps">
            <li>Send <strong>O3 Util: Prepare Encrypted PII</strong> &mdash; encrypts the <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/">PII payload</a> required for the consent.</li>
        ...
        <li>
          ...
          <ol class="ed-doc__substeps">
            <li>Send the <a href="/tech/tpp-standards/v2.1/consent/open-api/par" class="endpoint"><span class="http-method http-method--post">POST</span><code>/par</code></a> request to stage the payment consent.</li>
        ...
        <li>
          ...
          <ol class="ed-doc__substeps">
            <li>Send <strong>O3 Util: Prepare Encrypted PII</strong> &mdash; encrypts the <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/">payment PII</a>.</li>
            ...
            <li>Send <a href="/tech/tpp-standards/v2.1/banking/service-initiation/open-api/payments" class="endpoint"><span class="http-method http-method--post">POST</span><code>/payments</code></a>.</li>
          </ol>
