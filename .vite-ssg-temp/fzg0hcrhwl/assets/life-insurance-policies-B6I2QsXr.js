...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/insurance/data-sharing/open-api/life-insurance-policies.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const lifeInsurancePolicies = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  lifeInsurancePolicies as default
};
