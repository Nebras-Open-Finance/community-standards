    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          LFI · API Hub · v2.2-rc1 · Consent Management Interface
        </div>
      ...
      <div class="ed-doc__levels">
        <article class="ed-doc__level">
          ...
          <p class="ed-doc__level-body">
            ...
            <a href="/tech/lfi-api-hub/v2.2-rc1/consent-management-interface/bank-service-initiation/requirements">Bank Service Initiation</a>, and
