...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const myCustomValidator = (value) => {
      ...
      const periodStartDate2 = (_F = (_E = (_D = (_C = (_B = value == null ? void 0 : value.consent) == null ? void 0 : _B.ControlParameters) == null ? void 0 : _C.ConsentSchedule) == null ? void 0 : _D.MultiPayment) == null ? void 0 : _E.PeriodicSchedule) == null ? void 0 : _F.PeriodStartDate;
      if (periodStartDate2) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-fd270ff7><section class="ed-doc__hero" data-v-fd270ff7><div class="ed-doc__inner" data-v-fd270ff7><div class="ed-doc__eyebrow" data-v-fd270ff7><span class="ed-doc__eyebrow-dash" data-v-fd270ff7></span> Banking · Service Initiation · Fixed Periodic Schedule · UX </div><h1 class="ed-doc__title" data-v-fd270ff7> Fixed Periodic Schedule — User Experience <span class="ed-doc__read" data-v-fd270ff7>4 min read</span></h1><p class="ed-doc__lede" data-v-fd270ff7> Before a customer authorises a Fixed Periodic Schedule payment consent through Open Finance, you must present a <strong data-v-fd270ff7>Consent Page</strong> that clearly explains that you are seeking permission to make recurring payments of a fixed amount at a set frequency. This page must accurately reflect the key details of the consent (payee, amount per payment, payment frequency, etc.) The examples and interactive wireframes below define the expected structure, content, and behaviour of the Consent Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-fd270ff7> While you may adapt visual elements such as colour palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the payment information shown, and the representation of <strong data-v-fd270ff7>AlTareq</strong> (including logos, naming, and action buttons) must be preserved. The customer must always be able to clearly understand what payment they are consenting to and that it is part of the AlTareq ecosystem. Your Consent Page must be submitted as part of <strong data-v-fd270ff7>CX certification</strong> prior to production, and any material changes to a production Consent Page must be re-submitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the request body fields below and watch the <strong data-v-fd270ff7${_scopeId2}>Consent</strong> and <strong data-v-fd270ff7${_scopeId2}>Authorisation</strong> page previews update live. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-periodic-schedule/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fd270ff7"]]);
export {
