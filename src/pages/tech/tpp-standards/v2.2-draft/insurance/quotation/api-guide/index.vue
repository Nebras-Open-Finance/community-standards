  ...
  <div class="ed-doc">
    ...
    >
      <div class="ed-doc__cards">
        <a class="ed-doc__card" href="/tech/tpp-standards/v2.2-draft/insurance/quotation/api-guide/lfi-led">
        ...
        <a class="ed-doc__card" href="/tech/tpp-standards/v2.2-draft/insurance/quotation/api-guide/tpp-led">
    ...
    >
      <EdProse>
        ...
        is documented in
        <a href="/tech/tpp-standards/v2.2-draft/webhooks/insurance-status/api-guide">Insurance Quote Status
        Event &mdash; API Guide</a>, with the OpenAPI schema at
        <a href="/tech/tpp-standards/v2.2-draft/webhooks/insurance-status/open-api">Insurance Quote Status
        Change Event</a>.
      </EdProse>
    ...
    >
      <EdProse>
        ...
        shared <a href="/tech/lfi-api-hub/v2.2-draft/insurance/quotation/quote-types">Quote Types</a>
