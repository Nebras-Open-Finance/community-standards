...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-164f2581><section class="ed-doc__hero" data-v-164f2581><div class="ed-doc__inner" data-v-164f2581><div class="ed-doc__eyebrow" data-v-164f2581><span class="ed-doc__eyebrow-dash" data-v-164f2581></span> LFI · API Hub · Onboarding · Application Layer Auth </div><h1 class="ed-doc__title" data-v-164f2581> Application Layer Authentication <span class="ed-doc__read" data-v-164f2581>4 min read</span></h1><p class="ed-doc__lede" data-v-164f2581> All communication between the API Hub and an LFI is secured at the transport layer using <strong data-v-164f2581>mutual TLS (mTLS)</strong>. In addition to mTLS, the API Hub supports several <strong data-v-164f2581>application layer authentication</strong> methods that provide defense-in-depth. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-164f2581> LFIs MUST select an application layer authentication method during onboarding. If you are unsure which method to choose, we recommend <strong data-v-164f2581>JWT Auth</strong>. </p></div></section>`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-164f2581${_scopeId2}><thead data-v-164f2581${_scopeId2}><tr data-v-164f2581${_scopeId2}><th data-v-164f2581${_scopeId2}>Direction</th><th data-v-164f2581${_scopeId2}>Description</th></tr></thead><tbody data-v-164f2581${_scopeId2}><tr data-v-164f2581${_scopeId2}><td data-v-164f2581${_scopeId2}><strong data-v-164f2581${_scopeId2}>API Hub to LFI</strong> (Ozone Connect)</td><td data-v-164f2581${_scopeId2}>Requests the API Hub sends to your Ozone Connect endpoints when proxying TPP API calls.</td></tr><tr data-v-164f2581${_scopeId2}><td data-v-164f2581${_scopeId2}><strong data-v-164f2581${_scopeId2}>LFI to API Hub</strong> (Consent Manager &amp; Headless Heimdall Auth Server)</td><td data-v-164f2581${_scopeId2}>Requests your authorisation server sends to the API Hub&#39;s Consent Manager and Headless Heimdall Auth Server during consent and authorisation flows.</td></tr></tbody></table>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-164f2581${_scopeId2}><thead data-v-164f2581${_scopeId2}><tr data-v-164f2581${_scopeId2}><th data-v-164f2581${_scopeId2}>Method</th><th style="${ssrRenderStyle({ "text-align": "center" })}" data-v-164f2581${_scopeId2}>API Hub to LFI (Ozone Connect)</th><th style="${ssrRenderStyle({ "text-align": "center" })}" data-v-164f2581${_scopeId2}>LFI to API Hub (CM &amp; Headless Heimdall)</th></tr></thead><tbody data-v-164f2581${_scopeId2}><tr data-v-164f2581${_scopeId2}><td data-v-164f2581${_scopeId2}><a href="#mtls-only" data-v-164f2581${_scopeId2}>mTLS Only (Off)</a></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-164f2581${_scopeId2}>Yes</td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-164f2581${_scopeId2}>Yes</td></tr><tr data-v-164f2581${_scopeId2}><td data-v-164f2581${_scopeId2}><a href="#api-key" data-v-164f2581${_scopeId2}>API Key</a></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-164f2581${_scopeId2}>Yes</td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-164f2581${_scopeId2}>No</td></tr><tr data-v-164f2581${_scopeId2}><td data-v-164f2581${_scopeId2}><a href="#client-credentials" data-v-164f2581${_scopeId2}>Client Credentials Grant</a></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-164f2581${_scopeId2}>Yes</td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-164f2581${_scopeId2}>No</td></tr><tr data-v-164f2581${_scopeId2}><td data-v-164f2581${_scopeId2}><a href="#jwt-auth" data-v-164f2581${_scopeId2}>JWT Auth</a></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-164f2581${_scopeId2}>Yes</td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-164f2581${_scopeId2}>Yes</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-164f2581${_scopeId2}> If you are unsure which method to select, choose <strong data-v-164f2581${_scopeId2}>JWT Auth</strong>. It offers strong security without requiring additional infrastructure, and is the only method (besides mTLS only) that is supported in both directions. </p>`);
            } else {
              return [
                createVNode("p", null, [
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<h3 data-v-164f2581${_scopeId}>Constraints</h3>`);
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-164f2581${_scopeId2}>Supported for <strong data-v-164f2581${_scopeId2}>Ozone Connect only</strong> (API Hub to LFI direction).</li><li data-v-164f2581${_scopeId2}>NOT supported for Consent Manager or Headless Heimdall Auth Server APIs.</li><li data-v-164f2581${_scopeId2}>The API Key MUST have a validity of 12 months or more. Key rotation is supported annually.</li>`);
            } else {
              return [
                createVNode("li", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-164f2581${_scopeId2}>Supported for <strong data-v-164f2581${_scopeId2}>Ozone Connect only</strong> (API Hub to LFI direction).</li><li data-v-164f2581${_scopeId2}>NOT supported for Consent Manager or Headless Heimdall Auth Server APIs.</li><li data-v-164f2581${_scopeId2}>Requires the LFI to operate its own authorisation server.</li><li data-v-164f2581${_scopeId2}>MAY result in a small increase in latency, as the API Hub makes an additional call to obtain the access token.</li><li data-v-164f2581${_scopeId2}>Where a <code data-v-164f2581${_scopeId2}>client_secret</code> is used, it MUST have a validity of 12 months or more. Secret rotation is supported annually.</li><li data-v-164f2581${_scopeId2}><code data-v-164f2581${_scopeId2}>scope</code> values are configured during onboarding based on LFI requirements.</li>`);
            } else {
              return [
                createVNode("li", null, [
                  createTextVNode("Supported for "),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` JWT Auth is the <strong data-v-164f2581${_scopeId2}>recommended</strong> method. It offers the following advantages: `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-164f2581${_scopeId2}>Uses <strong data-v-164f2581${_scopeId2}>PS256</strong> — a secure asymmetric algorithm that does not rely on shared secrets.</li><li data-v-164f2581${_scopeId2}>No additional infrastructure is required — signing keys are generated and managed through the Trust Framework.</li><li data-v-164f2581${_scopeId2}>Key rotation is managed by the sending party; the receiver uses the JWKS for verification.</li><li data-v-164f2581${_scopeId2}>JWT claims bind the token to the certificates used in the underlying mTLS layer, providing strong binding between transport and application layers.</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-164f2581${_scopeId2}>LFIs MUST implement JWT creation (as client) and JWT validation (as server) in their integration.</li>`);
            } else {
              return [
        ...
        _push2(`<h3 data-v-164f2581${_scopeId}>Supported in both directions</h3>`);
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-164f2581${_scopeId2}><strong data-v-164f2581${_scopeId2}>API Hub to LFI</strong> (Ozone Connect) — the API Hub sends a JWT Auth token with each request to your Ozone Connect endpoints. Your server validates the token.</li><li data-v-164f2581${_scopeId2}><strong data-v-164f2581${_scopeId2}>LFI to API Hub</strong> (Consent Manager &amp; Headless Heimdall Auth Server) — if you choose to enable this, your authorisation server sends a JWT Auth token with each request to the Consent Manager and Headless Heimdall Auth Server. The API Hub validates the token.</li>`);
            } else {
              return [
                createVNode("li", null, [
                  createVNode("strong", null, "API Hub to LFI"),
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-164f2581${_scopeId2}> When selecting JWT Auth, you MAY also choose to send JWT Auth headers on your requests to the Consent Manager and Headless Heimdall Auth Server. This is configured separately — indicate your preference on the Service Desk ticket. </p>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For full technical detail on constructing and validating JWT Auth tokens, see <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/configuring-authentication/jwt-server" data-v-164f2581${_scopeId2}>JWT Auth — Server-side</a> (your Ozone Connect server validating tokens from the API Hub) and <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/configuring-authentication/jwt-client" data-v-164f2581${_scopeId2}>JWT Auth — Client-side</a> (your authorisation server sending tokens to the API Hub). `);
            } else {
              return [
                createTextVNode(" For full technical detail on constructing and validating JWT Auth tokens, see "),
                createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/configuring-authentication/jwt-server" }, "JWT Auth — Server-side"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/application-layer-auth.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const applicationLayerAuth = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-164f2581"]]);
export {
