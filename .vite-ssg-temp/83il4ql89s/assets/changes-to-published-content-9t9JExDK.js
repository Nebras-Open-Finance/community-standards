  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        role: "note",
        "aria-live": "polite"
      }, _attrs))} data-v-0aadf716>`);
      if (__props.affected && __props.errataId && __props.errataUrl) {
        _push(`<div class="errata-banner" data-v-0aadf716><strong data-v-0aadf716>This section has been modified by Errata ${ssrInterpolate(__props.errataId)}.</strong><a${ssrRenderAttr("href", __props.errataUrl)} target="_blank" rel="noopener noreferrer" class="errata-link" data-v-0aadf716> View Errata </a></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="errata-content" data-v-0aadf716>`);
...
const __unplugin_components_7 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-0aadf716"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-2feaa34d>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`This policy defines how published documentation may be changed for <strong data-v-2feaa34d${_scopeId2}>TPP — Open Finance Standards</strong> and <strong data-v-2feaa34d${_scopeId2}>LFI — Integration Guide</strong>, ensuring that every post-publication change is traceable, auditable, and surfaced to readers.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdCallout, { color: "var(--at-gold)" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2feaa34d${_scopeId2}>For any <strong data-v-2feaa34d${_scopeId2}>published</strong> documentation version, content may only be changed through a formally published <strong data-v-2feaa34d${_scopeId2}>Errata</strong>.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 data-v-2feaa34d${_scopeId}>Errata example</h3>`);
            _push2(ssrRenderComponent(_component_ErrataNotice, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h3 data-v-2feaa34d${_scopeId2}>Consent State Transitions</h3><p data-v-2feaa34d${_scopeId2}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><p data-v-2feaa34d${_scopeId2}>Original content that now no longer applies as the Errata clearly says their is new content that supersedes this.</p><p data-v-2feaa34d${_scopeId2}>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`For <strong data-v-2feaa34d${_scopeId2}>non-published</strong> versions (for example <code data-v-2feaa34d${_scopeId2}>v3.1-rc</code> or <code data-v-2feaa34d${_scopeId2}>v3.1-rc-final</code>), content may be updated without issuing an Errata.`);
                } else {
                  return [
                    createTextVNode("For "),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-2feaa34d${_scopeId2}>These versions remain draft / pre-publication artifacts</li><li data-v-2feaa34d${_scopeId2}>Normal review and approval controls still apply</li><li data-v-2feaa34d${_scopeId2}>Once the version is published, post-publication changes <strong data-v-2feaa34d${_scopeId2}>must</strong> follow the Errata process</li>`);
                } else {
                  return [
...
const changesToPublishedContent = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2feaa34d"]]);
export {
