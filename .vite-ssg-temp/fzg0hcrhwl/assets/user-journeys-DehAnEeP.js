...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-a37165e6><section class="ed-doc__hero" data-v-a37165e6><div class="ed-doc__inner" data-v-a37165e6><div class="ed-doc__eyebrow" data-v-a37165e6><span class="ed-doc__eyebrow-dash" data-v-a37165e6></span> Insurance · Quotation · TPP screens </div><h1 class="ed-doc__title" data-v-a37165e6> User Journeys <span class="ed-doc__read" data-v-a37165e6>4 min read</span></h1><p class="ed-doc__lede" data-v-a37165e6> The customer-facing flow in your TPP application, broken down by mode. Insurance Quotation has no Hub-mediated consent journey — the screens below are entirely yours to design (LFI-Led: minimal handoff; TPP-Led: full application capture before redirect to the LFI for payment). </p></div></section>`);
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Regardless of mode, you collect the data needed to request quotes in your own UI: sector, <code data-v-a37165e6${_scopeId2}>QuoteType</code>, sector-specific risk data (vehicle, property, trip, etc.), and customer identifiers. POST <code data-v-a37165e6${_scopeId2}>/{type}-insurance-quotes</code> may return one or more quotes from each LFI; present them so the customer can compare and choose. `);
            } else {
              return [
        ...
        _push2(`<h3 class="ed-doc__subhead" data-v-a37165e6${_scopeId}>Screens in your app</h3>`);
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Quote inputs</strong> — collect sector, <code data-v-a37165e6${_scopeId2}>QuoteType</code>, and sector-specific risk inputs. Validate locally before submission. </li><li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Quote comparison</strong> — render the returned quotes. Surface premium, coverage, exclusions, and any sector-specific selling points. Indicate which LFI declined (received <code data-v-a37165e6${_scopeId2}>204</code>) so the customer is not left wondering. </li><li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Quote acceptance</strong> — the customer picks one quote. Confirm the selection before sending the PATCH Accept Quote. </li>`);
            } else {
              return [
                createVNode("li", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` PATCH <code data-v-a37165e6${_scopeId2}>/{type}-insurance-quotes/{QuoteId}</code> carries both the accept payload and (optionally) a <code data-v-a37165e6${_scopeId2}>Subscription.Webhook</code> object. Subscribe at accept time so you receive every subsequent status change — <code data-v-a37165e6${_scopeId2}>ApplicationPending</code> through <code data-v-a37165e6${_scopeId2}>Completed</code> — on your webhook endpoint without polling. `);
            } else {
              return [
        ...
        _push2(`<h3 class="ed-doc__subhead" data-v-a37165e6${_scopeId}>Where the flow forks</h3>`);
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>LFI-Led mode</strong> — the response is <code data-v-a37165e6${_scopeId2}>204</code>. The customer is handed to the LFI for KYC, payment, and document delivery. Your app waits for status events (or returns control to the customer with a &quot;we\\&#39;ll let you know when your policy is ready&quot; screen). </li><li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>TPP-Led mode</strong> — the response is <code data-v-a37165e6${_scopeId2}>200</code> with <code data-v-a37165e6${_scopeId2}>PolicyIssuanceAllowed</code> declaring you handle <code data-v-a37165e6${_scopeId2}>CustomerVerification</code>, <code data-v-a37165e6${_scopeId2}>Payment</code>, and/or <code data-v-a37165e6${_scopeId2}>PolicyDocuments</code>. Continue in your app with KYC capture. </li>`);
            } else {
              return [
                createVNode("li", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For TPP-Led quotes where <code data-v-a37165e6${_scopeId2}>PolicyIssuanceAllowed.CustomerVerification: true</code>, your app collects the customer\\&#39;s KYC data — Emirates ID, address, occupation, etc., per the sector\\&#39;s accept-quote schema — and submits it via a second PATCH on the same quote endpoint. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Identity capture</strong> — Emirates ID front/back scan or manual entry. UAE PASS integration is encouraged where available. </li><li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Declarations</strong> — any sector-specific declarations the LFI requires (claims history, smoking status for Life/Health, named drivers for Motor, etc.). </li><li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Review &amp; submit</strong> — surface the gathered data for the customer to confirm before transmission. This submission is treated as the customer\\&#39;s instruction to proceed. </li>`);
            } else {
              return [
                createVNode("li", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` After the LFI emits <code data-v-a37165e6${_scopeId2}>ApplicationApproved</code> on the quote-log (delivered to your webhook or visible via polling), the event carries a <code data-v-a37165e6${_scopeId2}>BrokerInstructions.Url</code>. This is the LFI\\&#39;s hosted payment page. Redirect the customer to it; payment is collected by the LFI. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Handoff confirmation</strong> — a short screen explaining the customer is being taken to the insurer\\&#39;s secure payment page. Show the LFI brand so the customer recognises where they\\&#39;re going. </li><li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Return landing</strong> — the LFI redirects the customer back to a URL you control after payment. Show a &quot;your policy is being finalised&quot; state until the <code data-v-a37165e6${_scopeId2}>PolicyIssued</code> / <code data-v-a37165e6${_scopeId2}>Completed</code> events arrive. </li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-a37165e6${_scopeId2}> The <code data-v-a37165e6${_scopeId2}>BrokerInstructions.Url</code> is single-use and time-bound. Do not store, log, or replay it. If the customer abandons and returns later, request a fresh URL from the LFI (typically via a new <code data-v-a37165e6${_scopeId2}>PaymentRequired</code> event) rather than reusing the stale one. </p>`);
            } else {
              return [
                createVNode("p", null, [
                  createTextVNode(" The "),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` On <code data-v-a37165e6${_scopeId2}>PolicyIssued</code>, you receive the policy reference and (in TPP-Led mode) the full set of policy documents as base64-encoded <code data-v-a37165e6${_scopeId2}>Documents</code> entries. Verify each document\\&#39;s SHA-256 hash, then present them to the customer. `);
            } else {
              return [
                createTextVNode(" On "),
                createVNode("code", null, "PolicyIssued"),
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Policy summary</strong> — the issued policy with key terms surfaced (sums insured, premium, coverage dates, beneficiaries). In LFI-Led mode you receive an <code data-v-a37165e6${_scopeId2}>InsurancePolicyId</code>; in TPP-Led mode the documents themselves are authoritative. </li><li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Document downloads</strong> — Policy Booklet, Terms &amp; Conditions, IPID, etc. Allow the customer to download each PDF and offer to email them on demand. </li><li data-v-a37165e6${_scopeId2}><strong data-v-a37165e6${_scopeId2}>Lifecycle hooks</strong> — surface &quot;manage your policy&quot; links that take the customer back to the LFI (or your own broker-of-record surface) for claims, mid-term adjustments, and renewal. </li>`);
            } else {
              return [
                createVNode("li", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/insurance/quotation/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-a37165e6"]]);
export {
