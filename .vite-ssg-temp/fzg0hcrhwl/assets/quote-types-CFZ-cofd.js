...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-168ccbd4><section class="ed-doc__hero" data-v-168ccbd4><div class="ed-doc__inner" data-v-168ccbd4><div class="ed-doc__eyebrow" data-v-168ccbd4><span class="ed-doc__eyebrow-dash" data-v-168ccbd4></span> Insurance · Quotation · Shared explainer </div><h1 class="ed-doc__title" data-v-168ccbd4> Quote Types <span class="ed-doc__read" data-v-168ccbd4>4 min read</span></h1><p class="ed-doc__lede" data-v-168ccbd4> Every quote request carries a <code data-v-168ccbd4>QuoteType</code> of <code data-v-168ccbd4>New</code>, <code data-v-168ccbd4>Renewal</code>, or <code data-v-168ccbd4>Switch</code>. The three values determine what data the TPP MUST supply, what the LFI MAY assume about the customer, and how the resulting policy relates to any prior policy. This page is the single source of truth referenced from both the LFI Integration Guide and TPP Standards. </p></div></section>`);
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<h3 class="ed-doc__subhead" data-v-168ccbd4${_scopeId}>What the TPP must supply</h3>`);
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-168ccbd4${_scopeId2}> A unique <code data-v-168ccbd4${_scopeId2}>QuoteReference</code> — TPP-generated, used by the TPP to thread the quote through its own systems. Distinct from <code data-v-168ccbd4${_scopeId2}>QuoteId</code>, which the LFI mints. </li><li data-v-168ccbd4${_scopeId2}> Sector-specific risk data (vehicle for Motor, property address for Home, trip details for Travel, salary band for Health, etc.). </li><li data-v-168ccbd4${_scopeId2}> Customer identifying data sufficient for the LFI to KYC and underwrite (Emirates ID, date of birth, etc.). </li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(`<h3 class="ed-doc__subhead" data-v-168ccbd4${_scopeId}>What the LFI may assume</h3>`);
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-168ccbd4${_scopeId2}>No prior policy history with this LFI for this customer at this sector.</li><li data-v-168ccbd4${_scopeId2}> The LFI MUST run its full new-business underwriting process — risk scoring, screening, pricing — from the supplied data alone. </li>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-168ccbd4${_scopeId2}> The <code data-v-168ccbd4${_scopeId2}>InsurancePolicyId</code> of the prior policy at this LFI, retrieved through Insurance Data Sharing under a customer consent. The TPP MUST have held a valid consent at the time of the policy retrieval — the LFI MAY refuse to renew where it cannot evidence prior data sharing. </li><li data-v-168ccbd4${_scopeId2}> Any data the customer wishes to update at renewal (address change, vehicle change, beneficiary update, etc.). </li><li data-v-168ccbd4${_scopeId2}> The same <code data-v-168ccbd4${_scopeId2}>QuoteReference</code> shape as for <code data-v-168ccbd4${_scopeId2}>New</code>. </li>`);
            } else {
              return [
                createVNode("li", null, [
                  createTextVNode(" The "),
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-168ccbd4${_scopeId2}>The customer is already known — KYC may be lighter-touch.</li><li data-v-168ccbd4${_scopeId2}> The prior policy\\&#39;s claims history, no-claims discount, and risk rating may be carried forward where appropriate. </li><li data-v-168ccbd4${_scopeId2}> The LFI MAY decline to renew where its underwriting appetite has changed — <code data-v-168ccbd4${_scopeId2}>204</code> is the correct response, not a <code data-v-168ccbd4${_scopeId2}>201</code> with adverse pricing. </li>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-168ccbd4${_scopeId2}><code data-v-168ccbd4${_scopeId2}>Renewal</code> always references a policy held at <strong data-v-168ccbd4${_scopeId2}>this LFI</strong>. If the customer is moving from a different insurer, the correct <code data-v-168ccbd4${_scopeId2}>QuoteType</code> is <code data-v-168ccbd4${_scopeId2}>Switch</code>. </p>`);
            } else {
              return [
                createVNode("p", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The customer holds an existing policy at a <strong data-v-168ccbd4${_scopeId2}>different LFI</strong> (the incumbent) and wishes to move. The TPP supplies enough information about the incumbent policy for the LFI to price competitively and, where applicable, coordinate the switch (handing back NCD, avoiding double-coverage). `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-168ccbd4${_scopeId2}> The incumbent policy\\&#39;s details — insurer name, policy number, sums insured, premium, renewal date — retrieved through Insurance Data Sharing against the incumbent under a customer consent. </li><li data-v-168ccbd4${_scopeId2}> The customer\\&#39;s demographic and risk data, the same way as for <code data-v-168ccbd4${_scopeId2}>New</code>. Switching does not exempt the new LFI from underwriting. </li><li data-v-168ccbd4${_scopeId2}> Any switch-specific instructions (effective date, overlap window). </li>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-168ccbd4${_scopeId2}> Claims history from the incumbent is <strong data-v-168ccbd4${_scopeId2}>declared</strong>, not authoritative — the LFI MUST run its own screening and, where required, request additional declarations. </li><li data-v-168ccbd4${_scopeId2}> The incumbent policy is not yet cancelled. The LFI MAY make policy issuance contingent on the customer cancelling the incumbent within the policy effective date. </li>`);
            } else {
              return [
                createVNode("li", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` If the LFI does not offer a particular combination of sector and quote type (e.g. switching is not supported for Travel, or the LFI does not renew expired policies older than 30 days), the Create Quote endpoint MUST return <code data-v-168ccbd4${_scopeId2}>204</code> with an empty body. <strong data-v-168ccbd4${_scopeId2}>Do not return <code data-v-168ccbd4${_scopeId2}>201</code> with no quotes</strong> — a <code data-v-168ccbd4${_scopeId2}>201</code> implies success and breaks the TPP\\&#39;s ability to surface a &quot;no quote available&quot; outcome cleanly to the customer. `);
            } else {
              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/insurance/quotation/quote-types.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const quoteTypes = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-168ccbd4"]]);
export {
