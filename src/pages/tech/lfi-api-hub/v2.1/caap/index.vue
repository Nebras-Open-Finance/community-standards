  ...
  <div class="ed-doc">
    ...
    >
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>LFI &mdash; see <a href="/tech/lfi-api-hub/v2.1/consent-journey/authentication">Consent Journey &rarr; Authentication</a> and <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/auth-endpoint">Authorization Endpoint</a>.</td>
              <td>CAAP</td>
            </tr>
            <tr>
              <td><strong>Consent Management Interface</strong></td>
              <td>LFI &mdash; see <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/">Consent Management Interface</a>.</td>
              <td>CAAP</td>
            </tr>
            <tr>
              <td><strong>Headless Heimdall and Consent Manager integration</strong></td>
              <td>LFI &mdash; see <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/">Headless Heimdall</a> and <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/">Consent Manager</a>.</td>
              <td>CAAP</td>
            </tr>
          </tbody>
        </table>
      ...
      <EdNote type="info" title="Still in scope for the LFI">
        <p>
          The LFI MUST still implement its Ozone Connect endpoints for <a href="/tech/lfi-api-hub/v2.1/banking/data-sharing/">Bank Data Sharing</a>,
          <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/">Bank Service Initiation</a>,
          <a href="/tech/lfi-api-hub/v2.1/insurance/">Insurance Data Sharing</a>, and the other
