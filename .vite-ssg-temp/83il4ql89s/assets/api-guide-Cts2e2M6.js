...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-c47e0632><section class="ed-doc__hero" data-v-c47e0632><div class="ed-doc__inner" data-v-c47e0632><div class="ed-doc__eyebrow" data-v-c47e0632><span class="ed-doc__eyebrow-dash" data-v-c47e0632></span> TPP · Banking · Service Initiation · Single Instant Payment </div><h1 class="ed-doc__title" data-v-c47e0632> Single Instant Payment — API Guide <span class="ed-doc__read" data-v-c47e0632>5 min read</span></h1><p class="ed-doc__lede" data-v-c47e0632> A Single Instant Payment is a one-time, immediate domestic payment initiated by the TPP on behalf of the user. The payment amount and destination are fixed at the point of consent — the user approves once, and the payment executes immediately after authorization. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-c47e0632${_scopeId2}><strong data-v-c47e0632${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-c47e0632${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the <strong data-v-c47e0632${_scopeId2}>BSIP role</strong> as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-c47e0632${_scopeId2}>Roles</a>. </li><li data-v-c47e0632${_scopeId2}><strong data-v-c47e0632${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-c47e0632${_scopeId2}>Transport Certificate</a></strong> — an active transport certificate must be issued and registered in the Trust Framework to establish secure <strong data-v-c47e0632${_scopeId2}>mTLS communication</strong>. </li><li data-v-c47e0632${_scopeId2}><strong data-v-c47e0632${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-c47e0632${_scopeId2}>Signing Certificate</a></strong> — an active signing certificate must be issued and registered in the Trust Framework. This certificate is used to sign request objects and client assertions. </li><li data-v-c47e0632${_scopeId2}><strong data-v-c47e0632${_scopeId2}>Registration with the relevant <a href="/tech/tpp-standards/registration/api-guide" data-v-c47e0632${_scopeId2}>API Hub (Authorisation Server)</a></strong> — the application must be registered with the API Hub (Server) of the LFI with which you intend to initiate payments. </li><li data-v-c47e0632${_scopeId2}><strong data-v-c47e0632${_scopeId2}>Understanding of the <a href="/tech/tpp-standards/security/fapi/" data-v-c47e0632${_scopeId2}>FAPI Security Profile</a></strong> and <strong data-v-c47e0632${_scopeId2}><a href="/tech/tpp-standards/security/tokens/" data-v-c47e0632${_scopeId2}>Tokens &amp; Assertions</a></strong> — you should understand how request object signing, client authentication, and access token validation underpin secure API interactions. </li><li data-v-c47e0632${_scopeId2}><strong data-v-c47e0632${_scopeId2}>Understanding of <a href="/tech/tpp-standards/security/fapi/message-encryption" data-v-c47e0632${_scopeId2}>Message Encryption</a></strong> — PII (creditor name and account details) must be encrypted as a JWE before being embedded in the consent. You will need the LFI&#39;s public encryption key from their JWKS. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-c47e0632${_scopeId}><span class="http-badge http-post" data-v-c47e0632${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-c47e0632${_scopeId}>/par</code></div>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` With the encrypted PII ready, construct the <code data-v-c47e0632${_scopeId2}>authorization_details</code> of type <code data-v-c47e0632${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.1</code>. The encrypted PII is embedded as <code data-v-c47e0632${_scopeId2}>consent.PersonalIdentifiableInformation</code>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c47e0632${_scopeId}>authorization_details</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c47e0632${_scopeId2}><thead data-v-c47e0632${_scopeId2}><tr data-v-c47e0632${_scopeId2}><th data-v-c47e0632${_scopeId2}>Field</th><th data-v-c47e0632${_scopeId2}>Type</th><th data-v-c47e0632${_scopeId2}>Description</th><th data-v-c47e0632${_scopeId2}>Example</th></tr></thead><tbody data-v-c47e0632${_scopeId2}><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>type</code>*</td><td data-v-c47e0632${_scopeId2}>enum</td><td data-v-c47e0632${_scopeId2}>Must be <code data-v-c47e0632${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.1</code></td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.1</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>consent</code>*</td><td data-v-c47e0632${_scopeId2}>object</td><td data-v-c47e0632${_scopeId2}>Consent properties agreed by the User with the TPP. <em data-v-c47e0632${_scopeId2}>Described below.</em></td><td data-v-c47e0632${_scopeId2}>—</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>subscription</code></td><td data-v-c47e0632${_scopeId2}>object</td><td data-v-c47e0632${_scopeId2}>Optional subscription to Event Notifications via Webhook. <em data-v-c47e0632${_scopeId2}>Described below.</em></td><td data-v-c47e0632${_scopeId2}>—</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c47e0632${_scopeId}>consent (Required) | <code data-v-c47e0632${_scopeId}>authorization_details.consent</code></h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c47e0632${_scopeId2}><thead data-v-c47e0632${_scopeId2}><tr data-v-c47e0632${_scopeId2}><th data-v-c47e0632${_scopeId2}>Field</th><th data-v-c47e0632${_scopeId2}>Type</th><th data-v-c47e0632${_scopeId2}>Description</th><th data-v-c47e0632${_scopeId2}>Example</th></tr></thead><tbody data-v-c47e0632${_scopeId2}><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>ConsentId</code>*</td><td data-v-c47e0632${_scopeId2}>string (uuid)</td><td data-v-c47e0632${_scopeId2}>Unique ID assigned by the TPP (1–128 chars)</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>b8f42378-10ac-46a1-8d20-4e020484216d</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>IsSingleAuthorization</code>*</td><td data-v-c47e0632${_scopeId2}>boolean</td><td data-v-c47e0632${_scopeId2}>Whether the payment requires only one authorizing party</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>true</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>ExpirationDateTime</code>*</td><td data-v-c47e0632${_scopeId2}>date-time</td><td data-v-c47e0632${_scopeId2}>Consent expiry (ISO 8601 with timezone, max 1 year)</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>2026-05-03T15:46:00+00:00</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>AuthorizationExpirationDateTime</code></td><td data-v-c47e0632${_scopeId2}>date-time</td><td data-v-c47e0632${_scopeId2}>Deadline by which all authorizers must have acted (multi-authorization only). SHOULD be set when <code data-v-c47e0632${_scopeId2}>IsSingleAuthorization</code> is <code data-v-c47e0632${_scopeId2}>false</code>; SHOULD NOT be set when <code data-v-c47e0632${_scopeId2}>IsSingleAuthorization</code> is <code data-v-c47e0632${_scopeId2}>true</code>. MUST NOT be after <code data-v-c47e0632${_scopeId2}>ExpirationDateTime</code>.</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>2026-05-03T16:00:00+00:00</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>BaseConsentId</code></td><td data-v-c47e0632${_scopeId2}>string (uuid)</td><td data-v-c47e0632${_scopeId2}>Used when amending or renewing an existing consent</td><td data-v-c47e0632${_scopeId2}>—</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>Permissions</code></td><td data-v-c47e0632${_scopeId2}>array&lt;enum&gt;</td><td data-v-c47e0632${_scopeId2}>Optional access permissions granted alongside the payment consent</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>ReadAccountsBasic</code>, <code data-v-c47e0632${_scopeId2}>ReadBalances</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>ControlParameters</code>*</td><td data-v-c47e0632${_scopeId2}>object</td><td data-v-c47e0632${_scopeId2}>Payment schedule and amount. <em data-v-c47e0632${_scopeId2}>Described below.</em></td><td data-v-c47e0632${_scopeId2}>—</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>PersonalIdentifiableInformation</code>*</td><td data-v-c47e0632${_scopeId2}>string (JWE)</td><td data-v-c47e0632${_scopeId2}>Encrypted creditor and risk data — the <code data-v-c47e0632${_scopeId2}>encryptedPII</code> string from Step 1</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>eyJhbGci...</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>PaymentPurposeCode</code>*</td><td data-v-c47e0632${_scopeId2}>string (3 chars)</td><td data-v-c47e0632${_scopeId2}>AANI payment purpose code</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>ACM</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>DebtorReference</code></td><td data-v-c47e0632${_scopeId2}>string</td><td data-v-c47e0632${_scopeId2}>Reference shown on the debtor&#39;s statement</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>Test Purchase</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>CreditorReference</code></td><td data-v-c47e0632${_scopeId2}>string</td><td data-v-c47e0632${_scopeId2}>Reference shown on the creditor&#39;s statement</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>Test Purchase</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c47e0632${_scopeId}>ControlParameters.ConsentSchedule.SinglePayment (Required)</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c47e0632${_scopeId2}><thead data-v-c47e0632${_scopeId2}><tr data-v-c47e0632${_scopeId2}><th data-v-c47e0632${_scopeId2}>Field</th><th data-v-c47e0632${_scopeId2}>Type</th><th data-v-c47e0632${_scopeId2}>Description</th><th data-v-c47e0632${_scopeId2}>Example</th></tr></thead><tbody data-v-c47e0632${_scopeId2}><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>Type</code>*</td><td data-v-c47e0632${_scopeId2}>enum</td><td data-v-c47e0632${_scopeId2}>Must be <code data-v-c47e0632${_scopeId2}>SingleInstantPayment</code></td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>SingleInstantPayment</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>Amount.Amount</code>*</td><td data-v-c47e0632${_scopeId2}>string</td><td data-v-c47e0632${_scopeId2}>Payment amount (decimal, max 2 d.p.)</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>100.00</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>Amount.Currency</code>*</td><td data-v-c47e0632${_scopeId2}>string</td><td data-v-c47e0632${_scopeId2}>ISO 4217 currency code</td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>AED</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c47e0632${_scopeId}>Example request</h3>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-c47e0632${_scopeId2}> Save <code data-v-c47e0632${_scopeId2}>codeVerifier</code> in your server-side session or an <code data-v-c47e0632${_scopeId2}>httpOnly</code> cookie — you will need it in <a href="#step-8-post-token-authorization-code" data-v-c47e0632${_scopeId2}>Step 8</a> to exchange the authorization code for tokens. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/fapi/request-jwt" data-v-c47e0632${_scopeId2}>Preparing the Request JWT</a> for the full JWT claim reference and PKCE helpers. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-c47e0632${_scopeId2}>authorization_endpoint</code> is found in the LFI&#39;s <code data-v-c47e0632${_scopeId2}>.well-known/openid-configuration</code> — not constructed from the issuer URL directly. `);
                } else {
                  return [
                    createTextVNode(" The "),
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-c47e0632${_scopeId2}> See <a href="./user-journeys" data-v-c47e0632${_scopeId2}>User Experience</a> for screen mockups of the <strong data-v-c47e0632${_scopeId2}>Consent</strong> and <strong data-v-c47e0632${_scopeId2}>Authorization</strong> pages the user sees at the bank, including an interactive form where you can edit the consent JSON and PII and preview the resulting UI. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" See "),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-c47e0632${_scopeId2}>Authenticate with their bank.</li><li data-v-c47e0632${_scopeId2}>Review the payment details — amount, recipient, and purpose — on the bank&#39;s authorization screen.</li><li data-v-c47e0632${_scopeId2}>Approve or decline.</li>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-c47e0632${_scopeId}><span class="http-badge http-post" data-v-c47e0632${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-c47e0632${_scopeId}>/token</code></div>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Before constructing the payment request, you must encrypt a fresh PII token specifically for the payment. This follows the <strong data-v-c47e0632${_scopeId2}>Domestic Payment PII Schema Object</strong> (<code data-v-c47e0632${_scopeId2}>AEBankServiceInitiation.AEDomesticPaymentPIIProperties</code>) — the same JWS-inside-JWE pattern used in Step 1, but submitted on the payment itself rather than on the <code data-v-c47e0632${_scopeId2}>/par</code> consent. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-c47e0632${_scopeId2}> The <code data-v-c47e0632${_scopeId2}>Creditor</code> object inside the payment PII — including <code data-v-c47e0632${_scopeId2}>CreditorAccount.SchemeName</code>, <code data-v-c47e0632${_scopeId2}>CreditorAccount.Identification</code>, <code data-v-c47e0632${_scopeId2}>CreditorAccount.Name</code>, and any <code data-v-c47e0632${_scopeId2}>Creditor.Name</code> or <code data-v-c47e0632${_scopeId2}>CreditorAgent</code> fields — <strong data-v-c47e0632${_scopeId2}>must be byte-for-byte identical</strong> to the Creditor you encrypted in Step 1. The LFI decrypts both PII tokens and compares them; any discrepancy can result in rejection. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" The "),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Build the PII object according to the schema, then encrypt it using the same <code data-v-c47e0632${_scopeId2}>encryptPII</code> helper from Step 1: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/" data-v-c47e0632${_scopeId2}>Personal Identifiable Information</a> for the complete field reference, required vs optional fields, and creditor models for each domestic payment type. `);
                } else {
                  return [
                    createTextVNode(" See "),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/fapi/message-encryption" data-v-c47e0632${_scopeId2}>Message Encryption</a> for details on fetching the LFI&#39;s JWKS and selecting the correct encryption key. `);
                } else {
                  return [
                    createTextVNode(" See "),
                    createVNode("a", { href: "/tech/tpp-standards/security/fapi/message-encryption" }, "Message Encryption"),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-c47e0632${_scopeId}><span class="http-badge http-post" data-v-c47e0632${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-c47e0632${_scopeId}>/payments</code></div>`);
            _push2(ssrRenderComponent(_component_EdNote, {
              type: "warning",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-c47e0632${_scopeId2}> For a <code data-v-c47e0632${_scopeId2}>SingleInstantPayment</code>, the TPP MUST submit <code data-v-c47e0632${_scopeId2}>POST /payments</code> without undue delay after completing the token exchange in <a href="#step-8-post-token-authorization-code" data-v-c47e0632${_scopeId2}>Step 8</a>. Although the access token is valid for 10 minutes, the User has just authorized the payment at the LFI and is waiting for the TPP to confirm the outcome — avoidable delay creates uncertainty about whether the payment has been initiated and degrades the User experience. </p><p data-v-c47e0632${_scopeId2}> Where practicable, prepare work that can be done before the callback (PII encryption, JWT signing key loading) in advance so the call to <code data-v-c47e0632${_scopeId2}>POST /payments</code> can fire as soon as the access token is returned. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Include <code data-v-c47e0632${_scopeId2}>x-fapi-interaction-id</code> and <code data-v-c47e0632${_scopeId2}>x-idempotency-key</code>. As the customer is present at this point in the flow, also send <code data-v-c47e0632${_scopeId2}>x-fapi-customer-ip-address</code>, <code data-v-c47e0632${_scopeId2}>x-customer-user-agent</code> and <code data-v-c47e0632${_scopeId2}>x-fapi-auth-date</code> if the customer has been authenticated. See <a href="/tech/tpp-standards/security/request-headers" data-v-c47e0632${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The POST /payments body is sent as <code data-v-c47e0632${_scopeId2}>Content-Type: application/jwt</code> — the payment payload is wrapped in a signed JWT (<code data-v-c47e0632${_scopeId2}>AEPaymentRequestSigned</code>) using your private signing key. The LFI verifies the signature before processing the payment. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Every field in the request <strong data-v-c47e0632${_scopeId2}>must exactly match</strong> the corresponding value from the authorized consent: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c47e0632${_scopeId2}><thead data-v-c47e0632${_scopeId2}><tr data-v-c47e0632${_scopeId2}><th data-v-c47e0632${_scopeId2}>Field</th><th data-v-c47e0632${_scopeId2}>Must match</th></tr></thead><tbody data-v-c47e0632${_scopeId2}><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>ConsentId</code></td><td data-v-c47e0632${_scopeId2}>The <code data-v-c47e0632${_scopeId2}>ConsentId</code> from the authorized consent</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>Instruction.Amount.Amount</code></td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>consent.ControlParameters.ConsentSchedule.SinglePayment.Amount.Amount</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>Instruction.Amount.Currency</code></td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>consent.ControlParameters.ConsentSchedule.SinglePayment.Amount.Currency</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>PaymentPurposeCode</code></td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>consent.PaymentPurposeCode</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>OpenFinanceBilling</code></td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>consent.OpenFinanceBilling</code> (including <code data-v-c47e0632${_scopeId2}>Type</code> and, if present, <code data-v-c47e0632${_scopeId2}>MerchantId</code>)</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>DebtorReference</code></td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>consent.DebtorReference</code></td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>CreditorReference</code></td><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>consent.CreditorReference</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-c47e0632${_scopeId2}> The payment request is validated at two points. The API Hub checks that <code data-v-c47e0632${_scopeId2}>ConsentId</code>, <code data-v-c47e0632${_scopeId2}>Instruction.Amount</code>, <code data-v-c47e0632${_scopeId2}>PaymentPurposeCode</code>, <code data-v-c47e0632${_scopeId2}>DebtorReference</code>, <code data-v-c47e0632${_scopeId2}>CreditorReference</code>, and <code data-v-c47e0632${_scopeId2}>OpenFinanceBilling</code> exactly match the authorized consent — a mismatch returns <code data-v-c47e0632${_scopeId2}>400</code> before the request reaches the LFI. The LFI then decrypts the payment PII and verifies that all creditor fields match the PII from the consent. Either validation failure results in rejection. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c47e0632${_scopeId}>A successful POST /payments</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` A <code data-v-c47e0632${_scopeId2}>201 Created</code> response is returned as a signed JWT (<code data-v-c47e0632${_scopeId2}>application/jwt</code>). The verified JWT body is a <code data-v-c47e0632${_scopeId2}>message</code> envelope wrapping <code data-v-c47e0632${_scopeId2}>Data</code> and <code data-v-c47e0632${_scopeId2}>Links</code> per <code data-v-c47e0632${_scopeId2}>AEPaymentIdResponseSigned</code>. `);
                } else {
                  return [
                    createTextVNode(" A "),
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c47e0632${_scopeId}>Response body — <code data-v-c47e0632${_scopeId}>Data</code></h4>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c47e0632${_scopeId2}><thead data-v-c47e0632${_scopeId2}><tr data-v-c47e0632${_scopeId2}><th data-v-c47e0632${_scopeId2}>Field</th><th data-v-c47e0632${_scopeId2}>Required</th><th data-v-c47e0632${_scopeId2}>Description</th></tr></thead><tbody data-v-c47e0632${_scopeId2}><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>PaymentId</code></td><td data-v-c47e0632${_scopeId2}>Yes</td><td data-v-c47e0632${_scopeId2}>LFI-assigned unique identifier for this payment resource (use this to poll for status)</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>ConsentId</code></td><td data-v-c47e0632${_scopeId2}>Yes</td><td data-v-c47e0632${_scopeId2}>The consent this payment is bound to</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>Status</code></td><td data-v-c47e0632${_scopeId2}>Yes</td><td data-v-c47e0632${_scopeId2}>Current payment status — see status lifecycle below</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>StatusUpdateDateTime</code></td><td data-v-c47e0632${_scopeId2}>Yes</td><td data-v-c47e0632${_scopeId2}>ISO 8601 datetime of the last status change</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>CreationDateTime</code></td><td data-v-c47e0632${_scopeId2}>Yes</td><td data-v-c47e0632${_scopeId2}>ISO 8601 datetime when the payment resource was created</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>Instruction.Amount</code></td><td data-v-c47e0632${_scopeId2}>Yes</td><td data-v-c47e0632${_scopeId2}>Echoes back the amount and currency from the request</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>PaymentPurposeCode</code></td><td data-v-c47e0632${_scopeId2}>Yes</td><td data-v-c47e0632${_scopeId2}>Echoes back the payment purpose code</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>OpenFinanceBilling</code></td><td data-v-c47e0632${_scopeId2}>Yes</td><td data-v-c47e0632${_scopeId2}>Echoes back the billing parameters</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>PaymentTransactionId</code></td><td data-v-c47e0632${_scopeId2}>No</td><td data-v-c47e0632${_scopeId2}>End-to-end transaction ID generated by the Aani payment rails once the payment is submitted for settlement. Not present at <code data-v-c47e0632${_scopeId2}>Pending</code>.</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>DebtorReference</code></td><td data-v-c47e0632${_scopeId2}>No</td><td data-v-c47e0632${_scopeId2}>Echoes back the debtor reference if provided</td></tr><tr data-v-c47e0632${_scopeId2}><td data-v-c47e0632${_scopeId2}><code data-v-c47e0632${_scopeId2}>RejectReasonCode</code></td><td data-v-c47e0632${_scopeId2}>No</td><td data-v-c47e0632${_scopeId2}>Array of <code data-v-c47e0632${_scopeId2}>{ Code, Message }</code> objects — present only when <code data-v-c47e0632${_scopeId2}>Status</code> is <code data-v-c47e0632${_scopeId2}>Rejected</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="/tech/tpp-standards/v2.1/banking/service-initiation/open-api/payments" data-v-c47e0632${_scopeId2}>POST /payments</a> API reference for the full request and response schema. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c47e0632"]]);
export {
  apiGuide as default
};
