...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-fd64cff2><section class="ed-doc__hero" data-v-fd64cff2><div class="ed-doc__inner" data-v-fd64cff2><div class="ed-doc__eyebrow" data-v-fd64cff2><span class="ed-doc__eyebrow-dash" data-v-fd64cff2></span> Insurance · Data Sharing · UX </div><h1 class="ed-doc__title" data-v-fd64cff2> Insurance Data Sharing — User Experience <span class="ed-doc__read" data-v-fd64cff2>2 min read</span></h1><p class="ed-doc__lede" data-v-fd64cff2> Before a customer is redirected to Open Finance to consent to Insurance Data Sharing, you must present a <strong data-v-fd64cff2>Consent Page</strong> that clearly explains what the customer is consenting to and collects their explicit, informed consent. The page must accurately reflect each insurance type requested and the permissions selected within it. The interactive wireframe below defines the expected structure, content, and behaviour of the Consent Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-fd64cff2> While you may adapt visual elements such as colour palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the consent content, and the representation of <strong data-v-fd64cff2>AlTareq</strong> (including logos, naming, and action buttons) must be preserved. Your Consent Page must be submitted as part of <strong data-v-fd64cff2>CX certification</strong> prior to production, and any material changes to a production Consent Page must be re-submitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the <code data-v-fd64cff2${_scopeId2}>authorization_details</code> object below and watch the wireframes above update live. Each entry in <code data-v-fd64cff2${_scopeId2}>consent.Permissions</code> is an <code data-v-fd64cff2${_scopeId2}>InsuranceType</code> paired with the permissions requested for it — add, remove, or change types to see how the pages respond. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/insurance/data-sharing/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fd64cff2"]]);
export {
