...
export const data: RequirementsPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        { kind: 'prose', html: 'The rules above assume the account is in a readable state. The table below summarises how each value of <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts#aeaccountstatuscode"><code>AEAccountStatusCode</code></a> maps to a response for endpoints under <code>/accounts/{accountId}</code>.' },
        { kind: 'table', table: {
