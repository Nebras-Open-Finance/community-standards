...
const previews: CmiPreview[] = [
  { label: 'AlTareq Connections (Data Sharing and Payments)', mode: 'all', headerColor: 'var(--at-navy-deep)' },
  { label: 'AlTareq Connections (Data Sharing)', mode: 'data-sharing', headerColor: 'var(--at-teal-deep)' },
  { label: 'AlTareq Connections (Payments)', mode: 'payments', headerColor: 'var(--at-gold)' },
]
...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          TPP &middot; Consent Management Interface &middot; UX
        </div>
        ...
        <p class="ed-doc__lede">
          TPPs must provide a consent management interface where users can see their existing
          connections, review status, and manage active consent relationships.
        </p>
    ...
    <EdSectionBand
      ...
      title="The AlTareq Connections page across three views"
      tone="cream"
    >
      <EdProse>
        The components below represent the AlTareq Connections page layout across three views:
    ...
    <EdSectionBand
      ...
      num="03"
      color="var(--at-blue-deep, #1d4ed8)"
      eyebrow="How it differs from the LFI CMI"
      title="TPP CMI vs LFI CMI at a glance"
      tone="cream"
    >
      <EdProse>
        The TPP CMI is functionally similar to the
        <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/user-experience">LFI CMI</a>.
        The differences below reflect the fact that the TPP sees the relationship from the third
        party provider&rsquo;s side rather than the account provider&rsquo;s side.
      </EdProse>
