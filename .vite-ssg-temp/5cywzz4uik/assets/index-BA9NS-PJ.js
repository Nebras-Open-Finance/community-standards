...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const capabilities = [
      {
        href: "/tech/tpp-standards/v2.2-rc1/banking/data-sharing/",
      ...
      {
        href: "/tech/tpp-standards/v2.2-rc1/banking/service-initiation/",
      ...
      {
        href: "/tech/tpp-standards/v2.2-rc1/banking/confirmation-of-payee/",
      ...
      {
        href: "/tech/tpp-standards/v2.2-rc1/banking/products-leads/",
        cat: "Products & Leads",
        color: "var(--at-navy)",
      ...
      {
        href: "/tech/tpp-standards/v2.2-rc1/banking/atms/",
        cat: "ATMs",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-landing" }, _attrs))} data-v-3771044b><section class="ed-landing__hero" data-v-3771044b><div class="ed-landing__inner" data-v-3771044b><div class="ed-landing__eyebrow" data-v-3771044b><span class="ed-landing__eyebrow-dash" data-v-3771044b></span> TPP Standards · v2.2-rc1 · Banking </div><h1 class="ed-landing__title" data-v-3771044b> Banking <span class="ed-landing__read" data-v-3771044b>2 min read</span></h1><p class="ed-landing__lede" data-v-3771044b> The Open Finance Banking capabilities enable secure and efficient financial data sharing, payment initiation, and verification, empowering third-party providers (TPPs) with the necessary tools to enhance user experience and financial services. </p><p class="ed-landing__lede ed-landing__lede--tight" data-v-3771044b> All services are provided with strict consent management and detailed data access permissions. </p></div></section><section class="ed-landing__live" data-v-3771044b><div class="ed-landing__inner" data-v-3771044b><div class="ed-landing__live-head" data-v-3771044b><div class="ed-landing__live-eyebrow" data-v-3771044b><span class="ed-landing__eyebrow-dash" data-v-3771044b></span> Live ecosystem </div><h2 class="ed-landing__live-title" data-v-3771044b>Which LFIs are live on Open Finance Banking</h2><p class="ed-landing__live-sub" data-v-3771044b> LFIs currently serving Banking requests — across data sharing, payments, CoP, products, and ATMs — on UAE Open Finance. </p></div>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {
        placeholder: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-landing__live-grid" data-v-3771044b${_scopeId}><!--[-->`);
            ssrRenderList(6, (i) => {
              _push2(`<div class="ed-landing__tpp ed-landing__tpp--skel" data-v-3771044b${_scopeId}></div>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            if (unref(liveLfis).length) {
              ...
              ssrRenderList(unref(liveLfis), (lfi) => {
                _push2(`<a class="ed-landing__tpp"${ssrRenderAttr("title", lfi.legalName)} href="/program/whats-live" data-v-3771044b${_scopeId}><div class="ed-landing__tpp-logo" data-v-3771044b${_scopeId}>`);
                if (lfi.logoUri) {
                  _push2(`<img${ssrRenderAttr("src", lfi.logoUri)}${ssrRenderAttr("alt", lfi.legalName)} data-v-3771044b${_scopeId}>`);
                } else {
                  _push2(`<span class="ed-landing__tpp-initials" data-v-3771044b${_scopeId}>${ssrInterpolate(initials(lfi.name))}</span>`);
                }
                _push2(`</div><div class="ed-landing__tpp-name" data-v-3771044b${_scopeId}>${ssrInterpolate(lfi.name)}</div></a>`);
              });
              _push2(`<!--]-->`);
              if (unref(totalLfiCount) > unref(liveLfis).length) {
                _push2(`<a class="ed-landing__tpp ed-landing__tpp--more" href="/program/whats-live"${ssrRenderAttr("title", `See all ${unref(totalLfiCount)} LFIs`)} data-v-3771044b${_scopeId}><span class="ed-landing__tpp-more-dots" data-v-3771044b${_scopeId}>…</span><span class="ed-landing__tpp-more-label" data-v-3771044b${_scopeId}>+${ssrInterpolate(unref(totalLfiCount) - unref(liveLfis).length)} more</span></a>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            } else if (unref(loadError)) {
              _push2(`<p class="ed-landing__live-empty" data-v-3771044b${_scopeId}>Live data is currently unavailable.</p>`);
            } else {
              _push2(`<p class="ed-landing__live-empty" data-v-3771044b${_scopeId}>No LFIs are currently live for Banking capabilities.</p>`);
            }
            if (unref(totalLfiCount) > 0) {
              _push2(`<a class="ed-landing__live-cta" href="/program/whats-live" data-v-3771044b${_scopeId}>`);
              if (unref(totalLfiCount) > unref(liveLfis).length) {
                _push2(`<span data-v-3771044b${_scopeId}> See all ${ssrInterpolate(unref(totalLfiCount))} LFIs in the live ecosystem </span>`);
              } else {
                _push2(`<span data-v-3771044b${_scopeId}>View in the live ecosystem dashboard</span>`);
              }
              _push2(`<span class="ed-landing__live-cta-arrow" aria-hidden="true" data-v-3771044b${_scopeId}>→</span></a>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`</div></section><section class="ed-landing__contents" data-v-3771044b><div class="ed-landing__inner" data-v-3771044b><div class="ed-landing__contents-head" data-v-3771044b><div class="ed-landing__contents-eyebrow" data-v-3771044b><span class="ed-landing__eyebrow-dash" data-v-3771044b></span> Capabilities </div><h2 class="ed-landing__contents-title" data-v-3771044b>Browse the Banking capabilities</h2><p class="ed-landing__contents-sub" data-v-3771044b>The full set of capability areas covered by the TPP Banking standards.</p></div><div class="ed-landing__contents-grid ed-landing__contents-grid--lg" data-v-3771044b><!--[-->`);
      ssrRenderList(capabilities, (cap) => {
        _push(`<a class="ed-link-card ed-link-card--lg"${ssrRenderAttr("href", cap.href)} style="${ssrRenderStyle({ "--card-color": cap.color })}" data-v-3771044b><span class="ed-link-card__top" data-v-3771044b></span><div class="ed-link-card__meta" data-v-3771044b><span class="ed-link-card__cat" data-v-3771044b>${ssrInterpolate(cap.cat)}</span></div><h3 class="ed-link-card__title" data-v-3771044b>${ssrInterpolate(cap.title)}</h3><p class="ed-link-card__desc" data-v-3771044b>${cap.body ?? ""}</p><ul class="ed-link-card__highlights" data-v-3771044b><!--[-->`);
        ssrRenderList(cap.highlights, (h) => {
          _push(`<li data-v-3771044b>${ssrInterpolate(h)}</li>`);
        });
        _push(`<!--]--></ul><div class="ed-link-card__foot" data-v-3771044b><span class="ed-link-card__cta" data-v-3771044b>Open</span><span class="ed-link-card__arrow" data-v-3771044b>→</span></div></a>`);
      });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3771044b"]]);
export {
  index as default
};
