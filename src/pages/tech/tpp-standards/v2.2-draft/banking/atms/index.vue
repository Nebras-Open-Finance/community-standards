  ...
  <div class="ed-landing">
    <section class="ed-landing__hero">
      <div class="ed-landing__inner">
        ...
        <p class="ed-landing__lede">The ATM API lets a TPP retrieve ATM location and service data published by LFIs. It is a read-only, public-data API &mdash; no user consent or redirect is required.</p>
      </div>
    </section>
    ...
    <section class="ed-landing__role">
      <div class="ed-landing__inner">
        <div class="ed-landing__role-card">
          ...
          <p class="ed-landing__role-body">Access to the ATM API requires the <strong>BDSP</strong> role. This role must be assigned to your application in the Trust Framework before calling the endpoint. See <a href="/tech/tpp-standards/trust-framework/roles">Roles</a> for the full list of scopes and grant types this role permits.</p>
        </div>
        ...
        <p class="ed-landing__role-body" style="margin-bottom: 1rem;">A single <span class="endpoint"><span class="http-method http-method--get">GET</span><code>/atms</code></span> call returns all ATMs published by an LFI. Each ATM record includes:</p>
    <div class="ed-cov" role="table" style="grid-template-columns: minmax(14rem, 22rem) 1fr;">
      <div class="ed-cov__row ed-cov__row--head" role="row">
        <div class="ed-cov__cell ed-cov__cell--label">Field</div>
        <div class="ed-cov__cell" style="text-align: left;">Description</div>
      </div>
      
      <div class="ed-cov__row" role="row">
        <div class="ed-cov__cell ed-cov__cell--label"><code>ATMId</code></div>
        <div class="ed-cov__cell" style="text-align: left;">Unique terminal identifier</div>
      </div>
      <div class="ed-cov__row" role="row">
        <div class="ed-cov__cell ed-cov__cell--label"><code>LFIId</code> / <code>LFIBrandId</code></div>
        <div class="ed-cov__cell" style="text-align: left;">Identifies the owning LFI and brand</div>
      </div>
      <div class="ed-cov__row" role="row">
        <div class="ed-cov__cell ed-cov__cell--label"><code>Location</code></div>
        <div class="ed-cov__cell" style="text-align: left;">Address and GPS coordinates</div>
      </div>
      <div class="ed-cov__row" role="row">
        <div class="ed-cov__cell ed-cov__cell--label"><code>Services</code></div>
        <div class="ed-cov__cell" style="text-align: left;">Supported transaction types (e.g. <code>CashWithdrawal</code>, <code>Balance</code>, <code>PINChange</code>)</div>
      </div>
      <div class="ed-cov__row" role="row">
        <div class="ed-cov__cell ed-cov__cell--label"><code>Accessibility</code></div>
        <div class="ed-cov__cell" style="text-align: left;">Accessibility features (e.g. <code>WheelchairAccess</code>, <code>AudioCashMachine</code>)</div>
      </div>
      <div class="ed-cov__row" role="row">
        <div class="ed-cov__cell ed-cov__cell--label"><code>SupportedCurrencies</code></div>
        <div class="ed-cov__cell" style="text-align: left;">ISO 4217 currency codes accepted</div>
      </div>
      <div class="ed-cov__row" role="row">
        <div class="ed-cov__cell ed-cov__cell--label"><code>Availability</code></div>
        <div class="ed-cov__cell" style="text-align: left;">Operational status and opening hours</div>
      </div>
      <div class="ed-cov__row" role="row">
        <div class="ed-cov__cell ed-cov__cell--label"><code>ATMFee</code></div>
        <div class="ed-cov__cell" style="text-align: left;">Fee schedule for cross-bank and international transactions</div>
      </div>
      <div class="ed-cov__row" role="row">
        <div class="ed-cov__cell ed-cov__cell--label"><code>MinimumPossibleAmount</code> / <code>MaximumPossibleAmount</code></div>
        <div class="ed-cov__cell" style="text-align: left;">Withdrawal amount limits</div>
      </div>
    </div>
      </div>
    </section>
    ...
    <section class="ed-landing__live">
      <div class="ed-landing__inner">
        <div class="ed-landing__live-head">
          ...
          <h2 class="ed-landing__live-title">Which LFIs are live with ATM data</h2>
          <p class="ed-landing__live-sub">LFIs currently publishing ATM data across UAE Open Finance.</p>
        </div>
    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        <div class="ed-landing__contents-head">
          ...
          <p class="ed-landing__contents-sub">The full set of pages for the ATMs API.</p>
        </div>

        <div class="ed-landing__contents-grid">
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/banking/atms/requirements" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
            <span class="ed-link-card__top" />
            <div class="ed-link-card__meta"><span class="ed-link-card__cat">Requirements</span></div>
            <h3 class="ed-link-card__title">ATMs — Requirements</h3>
            <p class="ed-link-card__desc">Validation rules and behaviour the ATM endpoint enforces.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/banking/atms/api-guide" :style="{ '--card-color': 'var(--at-teal)' }">
            <span class="ed-link-card__top" />
            <div class="ed-link-card__meta"><span class="ed-link-card__cat">API Guide</span></div>
            <h3 class="ed-link-card__title">ATMs — API Guide</h3>
            <p class="ed-link-card__desc">Implementation notes, payload structure, and worked examples.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
