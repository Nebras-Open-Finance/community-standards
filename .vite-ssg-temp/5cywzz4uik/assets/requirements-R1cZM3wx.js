...
const data = {
  ...
  version: "v2.2-rc1",
  readTime: "15 min",
  lede: 'The validation rules that apply to Bank Data Sharing. The <strong>Validated by</strong> column on each table indicates where each rule is enforced. Read alongside the <a href="/tech/tpp-standards/v2.2-rc1/consent/requirements">Consent requirements</a> and the <a href="./user-journeys">User Journeys</a>.',
  ...
  sections: [
    {
      ...
      rules: [
        ...
        { field: "<code>authorization_details[0].type</code> (in Request JWT)", rule: "Must be <code>urn:openfinanceuae:account-access-consent:v2.2</code>.", validatedBy: "API Hub" },
        { field: "API version supported", rule: 'The consent version in <code>authorization_details[0].type</code> (e.g. <code>urn:openfinanceuae:account-access-consent:v2.2</code>) restricts the version of the Account Information endpoints the consent can be used to call (specified in the path, e.g. <code>/open-finance/v2.2/accounts</code>). It MUST resolve to an <code>ApiVersion</code> the LFI has published in the <a href="/tech/tpp-standards/trust-framework/api-discovery">Trust Framework</a> for the Account Information API family.', validatedBy: "LFI (/consent/action/validate)" },
    ...
    },
    {
      ...
      rules: [
        ...
        { field: "URL version", rule: "The version in the request URL path (e.g. <code>v2.2</code> in <code>/open-finance/account-information/v2.2/accounts</code>) must match the version in the consent's <code>authorization_details[0].type</code> (<code>urn:openfinanceuae:account-access-consent:v2.2</code>).", validatedBy: "API Hub" },
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-req" }, _attrs))} data-v-e4bc4783><section class="ed-req-hero" data-v-e4bc4783><div class="ed-req-hero__inner" data-v-e4bc4783><div class="ed-req-hero__label" data-v-e4bc4783><span class="ed-req-hero__label-dash" data-v-e4bc4783></span> ${ssrInterpolate(unref(eyebrow))}</div><h1 class="ed-req-hero__title" data-v-e4bc4783>${ssrInterpolate(unref(data).title)} `);
      if (unref(data).version) {
        _push(`<span class="ed-req-hero__badge" data-v-e4bc4783>${ssrInterpolate(unref(data).version)}</span>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(data).readTime) {
        _push(`<span class="ed-req-hero__read" data-v-e4bc4783>${ssrInterpolate(unref(data).readTime)} read</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</h1><p class="ed-req-hero__sub" data-v-e4bc4783>${unref(data).lede ?? ""}</p>`);
      if (unref(data).preconditions) {
        _push(`<p class="ed-req-hero__sub ed-req-hero__sub--tight" data-v-e4bc4783>${unref(data).preconditions ?? ""}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></section><!--[-->`);
      ssrRenderList(unref(data).sections, (s, i) => {
        _push(ssrRenderComponent(_component_EdSectionBand, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (s.method && s.path) {
                _push2(`<div class="ed-req-endpoint" data-v-e4bc4783${_scopeId}><span class="${ssrRenderClass([methodClass(s.method), "http-badge"])}" data-v-e4bc4783${_scopeId}>${ssrInterpolate(s.method)}</span><code class="ed-req-endpoint__path" data-v-e4bc4783${_scopeId}>${ssrInterpolate(s.path)}</code></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--[-->`);
              ssrRenderList(s.callouts || [], (c, ci) => {
                _push2(`<div class="${ssrRenderClass([`ed-req-callout--${c.kind}`, "ed-req-callout"])}" data-v-e4bc4783${_scopeId}>`);
                if (c.title) {
                  _push2(`<div class="ed-req-callout__title" data-v-e4bc4783${_scopeId}>${ssrInterpolate(c.title)}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<div class="ed-req-callout__body" data-v-e4bc4783${_scopeId}>${c.html ?? ""}</div></div>`);
              });
              _push2(`<!--]--><!--[-->`);
              ssrRenderList(s.blocks || [], (b, bi) => {
                _push2(`<!--[-->`);
                if (b.kind === "prose") {
                  _push2(`<p class="ed-req-intro" data-v-e4bc4783${_scopeId}>${b.html ?? ""}</p>`);
                } else if (b.kind === "table") {
                  _push2(`<div class="ed-req-table ed-req-table--generic" role="table"${ssrRenderAttr("aria-label", s.title)} style="${ssrRenderStyle({ gridTemplateColumns: genericGridTemplate(b.table.headers) })}" data-v-e4bc4783${_scopeId}><div class="ed-req-row ed-req-row--head" role="row" data-v-e4bc4783${_scopeId}><!--[-->`);
                  ssrRenderList(b.table.headers, (h, hi) => {
                    _push2(`<div class="ed-req-cell" role="columnheader" data-v-e4bc4783${_scopeId}>${ssrInterpolate(h)}</div>`);
                  });
                  _push2(`<!--]--></div><!--[-->`);
                  ssrRenderList(b.table.rows, (r, ri) => {
                    _push2(`<div class="ed-req-row" role="row" data-v-e4bc4783${_scopeId}><!--[-->`);
                    ssrRenderList(r.cells, (c, ci) => {
                      _push2(`<div class="ed-req-cell ed-req-cell--generic" role="cell" data-v-e4bc4783${_scopeId}>${c ?? ""}</div>`);
                    });
                    _push2(`<!--]--></div>`);
                  });
                  _push2(`<!--]--></div>`);
              ...
              if (s.rules && s.rules.length) {
                _push2(`<div class="ed-req-table" role="table"${ssrRenderAttr("aria-label", s.title)} data-v-e4bc4783${_scopeId}><div class="ed-req-row ed-req-row--head" role="row" data-v-e4bc4783${_scopeId}><div class="ed-req-cell ed-req-cell--num" role="columnheader" data-v-e4bc4783${_scopeId}>#</div><div class="ed-req-cell ed-req-cell--field" role="columnheader" data-v-e4bc4783${_scopeId}>Field</div><div class="ed-req-cell ed-req-cell--rule" role="columnheader" data-v-e4bc4783${_scopeId}>Rule</div><div class="ed-req-cell ed-req-cell--validator" role="columnheader" data-v-e4bc4783${_scopeId}>Validated by</div></div><!--[-->`);
                ssrRenderList(s.rules, (r, idx) => {
                  _push2(`<div class="ed-req-row" role="row" data-v-e4bc4783${_scopeId}><div class="ed-req-cell ed-req-cell--num" role="cell" data-v-e4bc4783${_scopeId}>${ssrInterpolate(idx + 1)}</div><div class="ed-req-cell ed-req-cell--field" role="cell" data-v-e4bc4783${_scopeId}>${r.field ?? ""}</div><div class="ed-req-cell ed-req-cell--rule" role="cell" data-v-e4bc4783${_scopeId}>${r.rule ?? ""}</div><div class="ed-req-cell ed-req-cell--validator" role="cell" data-v-e4bc4783${_scopeId}><span class="${ssrRenderClass([validatorClass(r.validatedBy), "ed-req-validator"])}" data-v-e4bc4783${_scopeId}><span class="ed-req-validator__label" data-v-e4bc4783${_scopeId}>${ssrInterpolate(splitValidator(r.validatedBy).label)}</span>`);
                  if (splitValidator(r.validatedBy).detail) {
                    _push2(`<span class="ed-req-validator__detail" data-v-e4bc4783${_scopeId}>${ssrInterpolate(splitValidator(r.validatedBy).detail)}</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</span></div></div>`);
              ...
              if (s.table) {
                _push2(`<div class="ed-req-table ed-req-table--generic" role="table"${ssrRenderAttr("aria-label", s.title)} style="${ssrRenderStyle({ gridTemplateColumns: genericGridTemplate(s.table.headers) })}" data-v-e4bc4783${_scopeId}><div class="ed-req-row ed-req-row--head" role="row" data-v-e4bc4783${_scopeId}><!--[-->`);
              ...
              ssrRenderList(s.subsections || [], (sub, si) => {
                _push2(`<div class="ed-req-sub" data-v-e4bc4783${_scopeId}><h3 class="ed-req-sub__heading" data-v-e4bc4783${_scopeId}>${ssrInterpolate(sub.heading)}</h3><!--[-->`);
                ...
                ssrRenderList(sub.blocks || [], (b, bi) => {
                  _push2(`<!--[-->`);
                  if (b.kind === "prose") {
                    _push2(`<p class="ed-req-sub__intro" data-v-e4bc4783${_scopeId}>${b.html ?? ""}</p>`);
                  } else if (b.kind === "table") {
                    _push2(`<div class="ed-req-table ed-req-table--generic ed-req-table--sub" role="table"${ssrRenderAttr("aria-label", sub.heading)} style="${ssrRenderStyle({ gridTemplateColumns: genericGridTemplate(b.table.headers) })}" data-v-e4bc4783${_scopeId}><div class="ed-req-row ed-req-row--head" role="row" data-v-e4bc4783${_scopeId}><!--[-->`);
                    ssrRenderList(b.table.headers, (h, hi) => {
                      _push2(`<div class="ed-req-cell" role="columnheader" data-v-e4bc4783${_scopeId}>${ssrInterpolate(h)}</div>`);
                    });
                    _push2(`<!--]--></div><!--[-->`);
                ...
                ssrRenderList(sub.subsections || [], (sub2, s2i) => {
                  _push2(`<div class="ed-req-sub ed-req-sub--nested" data-v-e4bc4783${_scopeId}><h4 class="ed-req-sub__heading ed-req-sub__heading--nested" data-v-e4bc4783${_scopeId}>${ssrInterpolate(sub2.heading)}</h4><!--[-->`);
                  ...
                  ssrRenderList(sub2.blocks || [], (b, bi) => {
                    ...
                    if (b.kind === "prose") {
                      ...
                      _push2(`<div class="ed-req-table ed-req-table--generic ed-req-table--sub" role="table"${ssrRenderAttr("aria-label", sub2.heading)} style="${ssrRenderStyle({ gridTemplateColumns: genericGridTemplate(b.table.headers) })}" data-v-e4bc4783${_scopeId}><div class="ed-req-row ed-req-row--head" role="row" data-v-e4bc4783${_scopeId}><!--[-->`);
                      ssrRenderList(b.table.headers, (h, hi) => {
                        _push2(`<div class="ed-req-cell" role="columnheader" data-v-e4bc4783${_scopeId}>${ssrInterpolate(h)}</div>`);
                      });
                      _push2(`<!--]--></div><!--[-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/data-sharing/requirements.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const requirements = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e4bc4783"]]);
export {
