...
<template>
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        <li><strong>Yes &mdash; CAAP.</strong> When a TPP creates a consent, the end user is redirected to CAAP for authentication and consent approval, and CAAP delivers the Consent Management Interface. You do not provide an Authorization Endpoint URL, and you do not implement the LFI-side Consent Management Interface or build directly against Headless Heimdall. You MUST implement the CAAP Operations endpoints on Ozone Connect &mdash; see <a href="/tech/lfi-api-hub/v2.2-draft/caap/">CAAP</a>.</li>
        <li><strong>No &mdash; LFI-operated.</strong> The end user is redirected to your <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/auth-endpoint">Authorization Endpoint</a>; you implement the <a href="/tech/lfi-api-hub/v2.2-draft/consent-journey/authentication">authentication and consent authorisation</a> UX and the <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/">Consent Management Interface</a> yourself.</li>
      </EdBullets>
    ...
    >
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.2-draft/health-check/open-api/hello" class="endpoint"><span class="http-method http-method--get">GET</span><code>/hello</code></a></td>
              <td>Basic connectivity check.</td>
            </tr>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.2-draft/health-check/open-api/hello-mtls" class="endpoint"><span class="http-method http-method--get">GET</span><code>/hello-mtls</code></a></td>
              <td>Verifies mutual TLS is correctly configured.</td>
            </tr>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.2-draft/health-check/open-api/echo-cert" class="endpoint"><span class="http-method http-method--get">GET</span><code>/echo-cert</code></a></td>
      ...
      <EdProse>
        ...
        See
        <a href="/tech/lfi-api-hub/v2.2-draft/health-check/">Ozone Connect &mdash; Health Check</a>
    ...
    >
      ...
      <EdProse>
        See
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-events/">Consent Events &amp; Actions</a>
        for details.
      </EdProse>
