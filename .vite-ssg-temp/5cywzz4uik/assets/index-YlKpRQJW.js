...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-510717af><section class="ed-doc__hero" data-v-510717af><div class="ed-doc__inner" data-v-510717af><div class="ed-doc__eyebrow" data-v-510717af><span class="ed-doc__eyebrow-dash" data-v-510717af></span> TPP · Getting Started · Sandbox </div><h1 class="ed-doc__title" data-v-510717af> Getting Started for TPPs (Sandbox) <span class="ed-doc__read" data-v-510717af>6 min read</span></h1><p class="ed-doc__lede" data-v-510717af> A guided walkthrough that takes you from a freshly onboarded sandbox application to a successful end-to-end payment, using the Postman collection and the included O3 sandbox utilities. </p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-510717af${_scopeId2}> You are onboarded to the sandbox Trust Framework. If not, see <a href="/tech/tpp-standards/trust-framework/onboarding" data-v-510717af${_scopeId2}>Trust Framework Onboarding</a>. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Fill in the values below using an Application (Client) you have created in the <strong data-v-510717af${_scopeId2}>Sandbox Trust Framework</strong>. `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<ol class="ed-doc__steps" data-v-510717af${_scopeId}><li data-v-510717af${_scopeId}><h3 data-v-510717af${_scopeId}>Install Postman</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Download Postman from <a href="https://www.postman.com/downloads/" data-v-510717af${_scopeId2}>postman.com/downloads</a>. Launch Postman and sign in (or create a free account). `);
                } else {
                  return [
            ...
            _push2(`</li><li data-v-510717af${_scopeId}><h3 data-v-510717af${_scopeId}>Import the collection</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-510717af${_scopeId2}>In Postman, click <strong data-v-510717af${_scopeId2}>Import</strong> (top left).</li><li data-v-510717af${_scopeId2}>Select the downloaded <code data-v-510717af${_scopeId2}>.json</code> file.</li><li data-v-510717af${_scopeId2}>The collection will appear in your Collections sidebar.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`</li><li data-v-510717af${_scopeId}><h3 data-v-510717af${_scopeId}>Configure mTLS certificates in Postman</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-510717af${_scopeId2}>Open Postman settings: gear icon (top right) → <strong data-v-510717af${_scopeId2}>Settings</strong> → <strong data-v-510717af${_scopeId2}>Certificates</strong> tab.</li><li data-v-510717af${_scopeId2}>Click <strong data-v-510717af${_scopeId2}>Add Certificate</strong>.</li><li data-v-510717af${_scopeId2}> Enter the host of the LFI Discovery URL, e.g. <code data-v-510717af${_scopeId2}>*.altareq1.sandbox.apihub.openfinance.ae</code> or <code data-v-510717af${_scopeId2}>*.[LFI CODE].preprod.apihub.openfinance.ae</code>. Leave port blank (defaults to 443). </li><li data-v-510717af${_scopeId2}>Attach <strong data-v-510717af${_scopeId2}>CRT</strong>: <code data-v-510717af${_scopeId2}>client_transport.pem</code>.</li><li data-v-510717af${_scopeId2}>Attach <strong data-v-510717af${_scopeId2}>KEY</strong>: <code data-v-510717af${_scopeId2}>client_transport.key</code>.</li><li data-v-510717af${_scopeId2}>Save the certificate entry.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h4 data-v-510717af${_scopeId}>Test by registering</h4>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Send a request to the TPP&#39;s registration endpoint. A <code data-v-510717af${_scopeId2}>204 (No Content)</code> response confirms the certificate is correctly attached. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, { class: "ed-doc__note" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<em data-v-510717af${_scopeId2}>Note: if you are testing multiple LFIs in sandbox/pre-prod you may need to change the host in the Add Certificate step.</em>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<ol class="ed-doc__steps" data-v-510717af${_scopeId}><li data-v-510717af${_scopeId}><h3 data-v-510717af${_scopeId}>Prepare the requests for /par</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Navigate to the <strong data-v-510717af${_scopeId2}>Auth Flow</strong> folder within <strong data-v-510717af${_scopeId2}>Single Instant Payment</strong> and run the three <a href="/tech/tpp-standards/security/fapi/o3-utils" data-v-510717af${_scopeId2}>O3 utility requests</a> in order: `);
                } else {
                  return [
            ...
            _push2(`<ol class="ed-doc__substeps" data-v-510717af${_scopeId}><li data-v-510717af${_scopeId}>Send <strong data-v-510717af${_scopeId}>O3 Util: Prepare Encrypted PII</strong> — encrypts the <a href="/tech/tpp-standards/v2.2-rc1/banking/service-initiation/personal-identifiable-information/" data-v-510717af${_scopeId}>PII payload</a> required for the consent.</li><li data-v-510717af${_scopeId}>Send <strong data-v-510717af${_scopeId}>O3 Util: Prepare Request Object JWT</strong> — builds the <a href="/tech/tpp-standards/security/fapi/request-jwt" data-v-510717af${_scopeId}>signed request object</a> for the <code data-v-510717af${_scopeId}>/par</code> call.</li><li data-v-510717af${_scopeId}>Send <strong data-v-510717af${_scopeId}>O3 Util: Prepare Private Key JWT</strong> — creates the client assertion used for authentication.</li></ol>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`</li><li data-v-510717af${_scopeId}><h3 data-v-510717af${_scopeId}>Stage the consent and redirect to the LFI</h3><ol class="ed-doc__substeps" data-v-510717af${_scopeId}><li data-v-510717af${_scopeId}>Send the <a href="/tech/tpp-standards/v2.2-rc1/consent/open-api/par" class="endpoint" data-v-510717af${_scopeId}><span class="http-method http-method--post" data-v-510717af${_scopeId}>POST</span><code data-v-510717af${_scopeId}>/par</code></a> request to stage the payment consent.</li><li data-v-510717af${_scopeId}>Click <strong data-v-510717af${_scopeId}>Visualize</strong> in the Postman response panel — this renders the response as a clickable redirect link.</li><li data-v-510717af${_scopeId}>Copy the link and open it in a browser to start the authorization redirect to the LFI.</li></ol>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`</li><li data-v-510717af${_scopeId}><h3 data-v-510717af${_scopeId}>Authenticate and authorize</h3><ol class="ed-doc__substeps" data-v-510717af${_scopeId}><li data-v-510717af${_scopeId}>Authenticate with the LFI.</li></ol>`);
            if (unref(creds)) {
              _push2(ssrRenderComponent(_component_EdNote, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-510717af${_scopeId2}> If you are using the <a href="/tech/tpp-standards/sandbox/model-bank" data-v-510717af${_scopeId2}>Model Bank</a>, the sandbox credentials are: </p><table class="ed-doc__creds" data-v-510717af${_scopeId2}><thead data-v-510717af${_scopeId2}><tr data-v-510717af${_scopeId2}><th data-v-510717af${_scopeId2}>Username</th><th data-v-510717af${_scopeId2}>Password</th></tr></thead><tbody data-v-510717af${_scopeId2}><tr data-v-510717af${_scopeId2}><td data-v-510717af${_scopeId2}><code data-v-510717af${_scopeId2}>${ssrInterpolate(unref(creds).username)}</code></td><td data-v-510717af${_scopeId2}><code data-v-510717af${_scopeId2}>${ssrInterpolate(unref(creds).password)}</code></td></tr></tbody></table>`);
                  } else {
                    return [
                      createVNode("p", null, [
            ...
            _push2(`<ol class="ed-doc__substeps" start="2" data-v-510717af${_scopeId}><li data-v-510717af${_scopeId}>Select the account to debit and authorize the payment consent.</li></ol>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`</li><li data-v-510717af${_scopeId}><h3 data-v-510717af${_scopeId}>Exchange the authorization code for a token</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` After the LFI redirects back to your <code data-v-510717af${_scopeId2}>redirect_uri</code>, the URL will contain a <code data-v-510717af${_scopeId2}>code</code> query parameter. `);
                } else {
                  return [
            ...
            _push2(`<ol class="ed-doc__substeps" data-v-510717af${_scopeId}><li data-v-510717af${_scopeId}>Copy the <code data-v-510717af${_scopeId}>code</code> value from the redirect URL.</li><li data-v-510717af${_scopeId}>Set it as the <code data-v-510717af${_scopeId}>authorizationCode</code> <a href="/tech/tpp-standards/security/tokens/" data-v-510717af${_scopeId}>collection variable</a> in Postman.</li><li data-v-510717af${_scopeId}>Send the <strong data-v-510717af${_scopeId}>token request</strong> to exchange the code for an access token.</li></ol>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`</li><li data-v-510717af${_scopeId}><h3 data-v-510717af${_scopeId}>Initiate the payment</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Navigate to the <strong data-v-510717af${_scopeId2}>Payments</strong> folder and run the O3 utility requests, then submit the payment: `);
                } else {
                  return [
                    createTextVNode(" Navigate to the "),
            ...
            _push2(`<ol class="ed-doc__substeps" data-v-510717af${_scopeId}><li data-v-510717af${_scopeId}>Send <strong data-v-510717af${_scopeId}>O3 Util: Prepare Encrypted PII</strong> — encrypts the <a href="/tech/tpp-standards/v2.2-rc1/banking/service-initiation/personal-identifiable-information/" data-v-510717af${_scopeId}>payment PII</a>.</li><li data-v-510717af${_scopeId}>Send <strong data-v-510717af${_scopeId}>O3 Util: Prepare Request Object JWT for SIP</strong> — builds the signed request object for the payment.</li><li data-v-510717af${_scopeId}>Send <a href="/tech/tpp-standards/v2.2-rc1/banking/service-initiation/open-api/payments" class="endpoint" data-v-510717af${_scopeId}><span class="http-method http-method--post" data-v-510717af${_scopeId}>POST</span><code data-v-510717af${_scopeId}>/payments</code></a>.</li></ol>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`A <code data-v-510717af${_scopeId2}>201</code> response confirms the payment was successfully initiated.`);
                } else {
                  return [
                    createTextVNode("A "),
            ...
            _push2(`</li><li data-v-510717af${_scopeId}><h3 data-v-510717af${_scopeId}>Retrieve the Payment ID and status</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Decode the <a href="/knowledge-base/articles/jwt-claims" data-v-510717af${_scopeId2}>JWT</a> received in the <span class="endpoint" data-v-510717af${_scopeId2}><span class="http-method http-method--post" data-v-510717af${_scopeId2}>POST</span><code data-v-510717af${_scopeId2}>/payments</code></span> response to retrieve the <code data-v-510717af${_scopeId2}>PaymentId</code> and <code data-v-510717af${_scopeId2}>Status</code>. The status will typically start as <code data-v-510717af${_scopeId2}>Pending</code>. `);
                } else {
                  return [
                ...
                createVNode("li", null, [
                  ...
                  createVNode("ol", { class: "ed-doc__substeps" }, [
                    createVNode("li", null, [
                      ...
                      createVNode("a", { href: "/tech/tpp-standards/v2.2-rc1/banking/service-initiation/personal-identifiable-information/" }, "PII payload"),
                ...
                createVNode("li", null, [
                  ...
                  createVNode("ol", { class: "ed-doc__substeps" }, [
                    createVNode("li", null, [
                      ...
                      createVNode("strong", null, "O3 Util: Prepare Encrypted PII"),
                      createTextVNode(" — encrypts the "),
                      createVNode("a", { href: "/tech/tpp-standards/v2.2-rc1/banking/service-initiation/personal-identifiable-information/" }, "payment PII"),
                      createTextVNode(".")
                    ]),
                    createVNode("li", null, [
                      createTextVNode("Send "),
                    ...
                    createVNode("li", null, [
                      createTextVNode("Send "),
                      createVNode("a", {
                        href: "/tech/tpp-standards/v2.2-rc1/banking/service-initiation/open-api/payments",
                        class: "endpoint"
                      }, [
                        createVNode("span", { class: "http-method http-method--post" }, "POST"),
                        createVNode("code", null, "/payments")
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/getting-started/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-510717af"]]);
export {
  index as default
};
