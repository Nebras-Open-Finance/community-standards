...
<template>
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        ...
        <li>
          ...
          (<a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm"><code>/doConfirm</code></a>
          or
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/open-api/auth-interactionId-doFail"><code>/doFail</code></a>)
    ...
    >
      ...
      <EdBullets>
        <li>
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/ozone-connect-url"><strong>Ozone Connect Base URL</strong></a>
        ...
        <li>
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/auth-endpoint"><strong>Authorization Endpoint</strong></a>
    ...
    >
      <EdProse>
        The Hub provides an
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/admin-portal/"><strong>Admin Portal</strong></a>
        where your team can:
      </EdProse>
