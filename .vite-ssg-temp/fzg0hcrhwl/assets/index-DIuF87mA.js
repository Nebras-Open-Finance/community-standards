...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-b338892e><section class="ed-doc__hero" data-v-b338892e><div class="ed-doc__inner" data-v-b338892e><div class="ed-doc__eyebrow" data-v-b338892e><span class="ed-doc__eyebrow-dash" data-v-b338892e></span> LFI · API Hub · Admin Portal </div><h1 class="ed-doc__title" data-v-b338892e> Admin Portal <span class="ed-doc__read" data-v-b338892e>2 min read</span></h1><p class="ed-doc__lede" data-v-b338892e> Each API Hub includes a dedicated <strong data-v-b338892e>Admin Portal</strong> — a web-based management interface where LFI teams can manage TPP access, investigate API traffic, and review operational reports. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-b338892e> The following key areas of the Admin Portal are covered in detail on their own pages: </p></div></section>`);
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-b338892e${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/tpp-activation" data-v-b338892e${_scopeId2}><strong data-v-b338892e${_scopeId2}>TPP Management</strong></a> — view, activate, and block TPPs, software statements, and clients </li><li data-v-b338892e${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/logs" data-v-b338892e${_scopeId2}><strong data-v-b338892e${_scopeId2}>Logs</strong></a> — audit logs and API request tracing </li><li data-v-b338892e${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/reports" data-v-b338892e${_scopeId2}><strong data-v-b338892e${_scopeId2}>Reports</strong></a> — performance metrics, call volumes, and consent statistics </li>`);
            } else {
              return [
                createVNode("li", null, [
                  createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/tpp-activation" }, [
                    createVNode("strong", null, "TPP Management")
                  ]),
                  createTextVNode(" — view, activate, and block TPPs, software statements, and clients ")
                ]),
                createVNode("li", null, [
                  createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/logs" }, [
                    createVNode("strong", null, "Logs")
                  ]),
                  createTextVNode(" — audit logs and API request tracing ")
                ]),
                createVNode("li", null, [
                  createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/reports" }, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-b338892e${_scopeId2}><thead data-v-b338892e${_scopeId2}><tr data-v-b338892e${_scopeId2}><th data-v-b338892e${_scopeId2}>Environment</th><th data-v-b338892e${_scopeId2}>URL</th><th data-v-b338892e${_scopeId2}>SSO Provider</th></tr></thead><tbody data-v-b338892e${_scopeId2}><tr data-v-b338892e${_scopeId2}><td data-v-b338892e${_scopeId2}><strong data-v-b338892e${_scopeId2}>Production</strong></td><td data-v-b338892e${_scopeId2}><code data-v-b338892e${_scopeId2}>https://admin.{lficode}.apihub.openfinance.ae</code></td><td data-v-b338892e${_scopeId2}>Production Trust Framework</td></tr><tr data-v-b338892e${_scopeId2}><td data-v-b338892e${_scopeId2}><strong data-v-b338892e${_scopeId2}>Pre-production</strong></td><td data-v-b338892e${_scopeId2}><code data-v-b338892e${_scopeId2}>https://admin.{lficode}.preprod.apihub.openfinance.ae</code></td><td data-v-b338892e${_scopeId2}>Sandbox Trust Framework</td></tr></tbody></table>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-b338892e${_scopeId2}><code data-v-b338892e${_scopeId2}>{lficode}</code> is the unique identifier assigned to your organisation. Your Nebras onboarding contact will confirm your LFI code. </p>`);
            } else {
              return [
                createVNode("p", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-b338892e${_scopeId2}><strong data-v-b338892e${_scopeId2}>Production</strong> portal authenticates against the <strong data-v-b338892e${_scopeId2}>Production Trust Framework</strong></li><li data-v-b338892e${_scopeId2}><strong data-v-b338892e${_scopeId2}>Pre-production</strong> portal authenticates against the <strong data-v-b338892e${_scopeId2}>Sandbox Trust Framework</strong></li>`);
            } else {
              return [
                createVNode("li", null, [
                  createVNode("strong", null, "Production"),
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` There is no separate user management within the portal itself. To grant or revoke portal access, manage the user&#39;s roles in the Trust Framework. The portal&#39;s <strong data-v-b338892e${_scopeId2}>User Management</strong> section displays all users who currently have access and their roles. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The dashboard is the landing page after login. It provides a summary of API Hub health and request distribution. While useful for a quick overview, the <strong data-v-b338892e${_scopeId2}>Reports</strong> and <strong data-v-b338892e${_scopeId2}>Logs</strong> sections provide the detailed data needed for day-to-day operations and debugging. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-b338892e${_scopeId2}><strong data-v-b338892e${_scopeId2}>Consent type</strong> — data sharing or service initiation</li><li data-v-b338892e${_scopeId2}><strong data-v-b338892e${_scopeId2}>Status</strong> — e.g. <code data-v-b338892e${_scopeId2}>Authorised</code>, <code data-v-b338892e${_scopeId2}>Rejected</code>, <code data-v-b338892e${_scopeId2}>Expired</code>, <code data-v-b338892e${_scopeId2}>Revoked</code>, <code data-v-b338892e${_scopeId2}>Consumed</code></li><li data-v-b338892e${_scopeId2}><strong data-v-b338892e${_scopeId2}>Created date</strong> — ascending or descending</li>`);
            } else {
              return [
                createVNode("li", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The portal includes an <strong data-v-b338892e${_scopeId2}>Outage Management</strong> section where LFIs can register planned downtime windows. When you schedule maintenance that will affect API availability: `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-b338892e${_scopeId2}>Navigate to the outage management section</li><li data-v-b338892e${_scopeId2}>Select your organisation</li><li data-v-b338892e${_scopeId2}>Enter the date, time, duration, and description of the planned outage</li>`);
            } else {
              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-b338892e"]]);
export {
  index as default
};
