      ...
      blocks: [
        { kind: 'table', table: {
          ...
          rows: [
            ...
            { cells: ['7', 'Account access', 'For every <code>accountId</code> in the <code>accountIds</code> query parameter, validate that the account is held by the PSU resolved from <code>o3-psu-identifier</code>. Apply the <a href="#account-access-validation">Account Access Validation</a> check before returning — if any of the requested accounts is not held by the PSU, return <code>403</code> with <code>errorCode</code>: <code>Consent.PermanentAccountAccessFailure</code>.'] },
      ...
      blocks: [
        { kind: 'table', table: {
          ...
          rows: [
            ...
            { cells: ['6', 'Account access', 'Validate that the account in the <code>accountId</code> path parameter is held by the PSU resolved from <code>o3-psu-identifier</code>. Apply the <a href="#account-access-validation">Account Access Validation</a> check before status handling — a non-held account MUST return <code>403</code> with <code>errorCode</code>: <code>Consent.PermanentAccountAccessFailure</code>.'] },
      ...
      blocks: [
        { kind: 'table', table: {
          ...
          rows: [
            ...
            { cells: ['10', 'Account access', 'Validate that the account in the <code>accountId</code> path parameter is held by the PSU resolved from <code>o3-psu-identifier</code>. Apply the <a href="#account-access-validation">Account Access Validation</a> check before status handling — a non-held account MUST return <code>403</code> with <code>errorCode</code>: <code>Consent.PermanentAccountAccessFailure</code>.'] },
            { cells: ['11', 'Account status', 'If the account is not <code>Active</code>, do not return the resource. Apply the <a href="#account-status-handling">Account Status Handling</a> mapping to return <code>403</code> with the corresponding <code>errorCode</code> and <code>errorMessage</code>.'] },
          ],
        } },
      ],
    },
      ...
      blocks: [
        { kind: 'table', table: {
          ...
          rows: [
            ...
            { cells: ['12', 'Account access', 'Validate that the account in the <code>accountId</code> path parameter is held by the PSU resolved from <code>o3-psu-identifier</code>. Apply the <a href="#account-access-validation">Account Access Validation</a> check before status handling — a non-held account MUST return <code>403</code> with <code>errorCode</code>: <code>Consent.PermanentAccountAccessFailure</code>.'] },
      ...
      blocks: [
        { kind: 'table', table: {
          ...
          rows: [
            ...
            { cells: ['6', '<code>AccountSubType</code>', 'Supported for all account subtypes: <code>CurrentAccount</code>, <code>Savings</code>, <code>CreditCard</code>, <code>Finance</code>, and <code>Mortgage</code>.'] },
            { cells: ['7', 'Account access', 'Validate that the account in the <code>accountId</code> path parameter is held by the PSU resolved from <code>o3-psu-identifier</code>. Apply the <a href="#account-access-validation">Account Access Validation</a> check before status handling — a non-held account MUST return <code>403</code> with <code>errorCode</code>: <code>Consent.PermanentAccountAccessFailure</code>.'] },
      ...
      blocks: [
        { kind: 'table', table: {
          ...
          rows: [
            ...
            { cells: ['8', 'Account access', 'Validate that the account in the <code>accountId</code> path parameter is held by the PSU resolved from <code>o3-psu-identifier</code>. Apply the <a href="#account-access-validation">Account Access Validation</a> check before status handling — a non-held account MUST return <code>403</code> with <code>errorCode</code>: <code>Consent.PermanentAccountAccessFailure</code>.'] },
