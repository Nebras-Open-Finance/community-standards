    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/banking/products-leads/requirements" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
          ...
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/banking/products-leads/api-guide" :style="{ '--card-color': 'var(--at-teal)' }">
            <span class="ed-link-card__top" />
          ...
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/banking/products-leads/user-journeys" :style="{ '--card-color': 'var(--at-navy)' }">
            <span class="ed-link-card__top" />
