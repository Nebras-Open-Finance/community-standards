...
import { _ as __unplugin_components_4$1 } from "./EdProse-D3vi_RS_.js";
import { _ as __unplugin_components_3$1 } from "./ServiceInitiationPermissionText-D2yhOB-_.js";
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "wf-frame" }, _attrs))} data-v-57ae3c7b>`);
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/_shared/WireframePreview.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const WireframePreview = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-57ae3c7b"]]);
const _sfc_main$2 = {};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/_shared/AccountSetup.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<!--[--><h3 data-v-c0a8f0fe>Debtor Account Selection</h3>`);
  _push(ssrRenderComponent(_component_EdProse, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`The presence or absence of <code data-v-c0a8f0fe${_scopeId}>Initiation.DebtorAccount</code> in <code data-v-c0a8f0fe${_scopeId}>domestic_payment_pii</code> determines whether the user selects their account at the LFI or if it is pre-selected by the TPP.`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_EdNote, { type: "tip" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p data-v-c0a8f0fe${_scopeId}>Passing a <code data-v-c0a8f0fe${_scopeId}>DebtorAccount</code> reduces friction for users who have already selected their account within the TPP&#39;s own interface, but removes the user&#39;s ability to choose a different account at the LFI.</p>`);
      } else {
        return [
          createVNode("p", null, [
  ...
  _push(`<h3 data-v-c0a8f0fe>Merchant Details</h3>`);
  _push(ssrRenderComponent(_component_EdProse, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`When a TPP processes payments on behalf of a merchant (e.g. a payment aggregator), <code data-v-c0a8f0fe${_scopeId}>Risk.CreditorIndicators.MerchantDetails.MerchantName</code> can be passed to identify the merchant to the user on the LFI Authorisation Page.`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_EdRefTable, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<table data-v-c0a8f0fe${_scopeId}><thead data-v-c0a8f0fe${_scopeId}><tr data-v-c0a8f0fe${_scopeId}><th data-v-c0a8f0fe${_scopeId}><code data-v-c0a8f0fe${_scopeId}>Risk.CreditorIndicators.MerchantDetails.MerchantName</code></th><th data-v-c0a8f0fe${_scopeId}>LFI Authorisation Page Behaviour</th></tr></thead><tbody data-v-c0a8f0fe${_scopeId}><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><strong data-v-c0a8f0fe${_scopeId}>Passed in</strong></td><td data-v-c0a8f0fe${_scopeId}>The merchant name is displayed on the Authorisation Page alongside the creditor details, indicating that the payment is being made on behalf of that merchant. <em data-v-c0a8f0fe${_scopeId}>(See Example 4)</em></td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><strong data-v-c0a8f0fe${_scopeId}>Not passed in</strong></td><td data-v-c0a8f0fe${_scopeId}>No merchant information is shown. Only the creditor details are displayed. <em data-v-c0a8f0fe${_scopeId}>(See Examples 1, 2 &amp; 3)</em></td></tr></tbody></table>`);
      } else {
        return [
  ...
  _push(`<h3 data-v-c0a8f0fe>Creditor Configuration</h3>`);
  _push(ssrRenderComponent(_component_EdProse, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`The presence or absence of creditors in <code data-v-c0a8f0fe${_scopeId}>Initiation.Creditor</code> in <code data-v-c0a8f0fe${_scopeId}>domestic_payment_pii</code> determines how the LFI presents payment recipient information to the user.`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_EdRefTable, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<table data-v-c0a8f0fe${_scopeId}><thead data-v-c0a8f0fe${_scopeId}><tr data-v-c0a8f0fe${_scopeId}><th data-v-c0a8f0fe${_scopeId}><code data-v-c0a8f0fe${_scopeId}>Initiation.Creditor</code></th><th data-v-c0a8f0fe${_scopeId}>LFI Authorisation Page Behaviour</th></tr></thead><tbody data-v-c0a8f0fe${_scopeId}><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><strong data-v-c0a8f0fe${_scopeId}>1 creditor</strong></td><td data-v-c0a8f0fe${_scopeId}>The single payee&#39;s name and account details are displayed under &quot;Who you&#39;re paying&quot;. <em data-v-c0a8f0fe${_scopeId}>(See Example 1)</em></td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><strong data-v-c0a8f0fe${_scopeId}>2–10 defined creditors</strong></td><td data-v-c0a8f0fe${_scopeId}>Not Supported</td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><strong data-v-c0a8f0fe${_scopeId}>Undefined</strong> (absent or empty)</td><td data-v-c0a8f0fe${_scopeId}>Not Supported</td></tr></tbody></table>`);
      } else {
        return [
          createVNode("table", null, [
            createVNode("thead", null, [
  ...
  _push(`<h3 data-v-c0a8f0fe>Trusted Payees Wording</h3>`);
  _push(ssrRenderComponent(_component_EdProse, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`The wording of the &quot;Add to my list of Trusted Payees&quot; checkbox is driven by <code data-v-c0a8f0fe${_scopeId}>Initiation.Creditor[].CreditorAccount.Type</code> in <code data-v-c0a8f0fe${_scopeId}>domestic_payment_pii</code>. Whether the checkbox is shown at all is a separate, account-driven behaviour — see Trusted Payees under <em data-v-c0a8f0fe${_scopeId}>UI Behaviour Driven by Account State</em>.`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_EdRefTable, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<table data-v-c0a8f0fe${_scopeId}><thead data-v-c0a8f0fe${_scopeId}><tr data-v-c0a8f0fe${_scopeId}><th data-v-c0a8f0fe${_scopeId}><code data-v-c0a8f0fe${_scopeId}>CreditorAccount.Type</code></th><th data-v-c0a8f0fe${_scopeId}>Checkbox Text</th></tr></thead><tbody data-v-c0a8f0fe${_scopeId}><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><code data-v-c0a8f0fe${_scopeId}>Individual</code></td><td data-v-c0a8f0fe${_scopeId}>Add person to my list of Trusted Payees</td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><code data-v-c0a8f0fe${_scopeId}>Merchant</code></td><td data-v-c0a8f0fe${_scopeId}>Add merchant to my list of Trusted Payees</td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><code data-v-c0a8f0fe${_scopeId}>Business</code></td><td data-v-c0a8f0fe${_scopeId}>Add business to my list of Trusted Payees</td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><code data-v-c0a8f0fe${_scopeId}>Charity</code></td><td data-v-c0a8f0fe${_scopeId}>Add charity to my list of Trusted Payees</td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><code data-v-c0a8f0fe${_scopeId}>GovernmentBody</code></td><td data-v-c0a8f0fe${_scopeId}>Add government body to my list of Trusted Payees</td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><code data-v-c0a8f0fe${_scopeId}>Other</code> or not provided</td><td data-v-c0a8f0fe${_scopeId}>Add to my list of Trusted Payees</td></tr></tbody></table>`);
      } else {
        return [
          createVNode("table", null, [
            createVNode("thead", null, [
  ...
  _push(`<h3 data-v-c0a8f0fe>Permissions and Data Access</h3>`);
  _push(ssrRenderComponent(_component_ServiceInitiationPermissionText, null, null, _parent));
  _push(`<div class="ui-break" data-v-c0a8f0fe><span class="ui-break__eyebrow" data-v-c0a8f0fe>Account-Driven Behaviour</span><h3 class="ui-break__title" data-v-c0a8f0fe>UI Behaviour Driven by Account State</h3></div>`);
  _push(ssrRenderComponent(_component_EdProse, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
  ...
  _push(ssrRenderComponent(_component_EdProse, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Use the <strong data-v-c0a8f0fe${_scopeId}>Simulated Accounts Behaviour</strong> panel above to preview each state.`);
      } else {
        return [
  ...
  _push(`<h3 data-v-c0a8f0fe>Warnings &amp; Priority</h3>`);
  _push(ssrRenderComponent(_component_EdProse, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
  ...
  _push(ssrRenderComponent(_component_EdRefTable, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<table data-v-c0a8f0fe${_scopeId}><thead data-v-c0a8f0fe${_scopeId}><tr data-v-c0a8f0fe${_scopeId}><th data-v-c0a8f0fe${_scopeId}>Priority</th><th data-v-c0a8f0fe${_scopeId}>Warning</th><th data-v-c0a8f0fe${_scopeId}>Warning Text</th></tr></thead><tbody data-v-c0a8f0fe${_scopeId}><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><strong data-v-c0a8f0fe${_scopeId}>1 (highest)</strong></td><td data-v-c0a8f0fe${_scopeId}>Payment Limit Exceeded</td><td data-v-c0a8f0fe${_scopeId}><em data-v-c0a8f0fe${_scopeId}>Payment limit exceeded — The amount exceeds the payment limit you&#39;ve set on your account. You may need to change your settings or try a smaller amount.</em></td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><strong data-v-c0a8f0fe${_scopeId}>2</strong></td><td data-v-c0a8f0fe${_scopeId}>Overdraft</td><td data-v-c0a8f0fe${_scopeId}><em data-v-c0a8f0fe${_scopeId}>This payment will take your selected account into an overdraft/unarranged overdraft.</em></td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><strong data-v-c0a8f0fe${_scopeId}>3</strong></td><td data-v-c0a8f0fe${_scopeId}>Duplicate Payment Alert</td><td data-v-c0a8f0fe${_scopeId}><em data-v-c0a8f0fe${_scopeId}>Duplicate Payment Alert — Our systems indicate that you have already made a payment of the same amount to this beneficiary in the last 24 hours. Please check and ensure that you are not making a duplicate payment.</em></td></tr></tbody></table>`);
      } else {
        return [
          createVNode("table", null, [
            createVNode("thead", null, [
  ...
  _push(`<h3 data-v-c0a8f0fe>Trusted Payees</h3>`);
  _push(ssrRenderComponent(_component_EdProse, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`The LFI shows the &quot;Add to my list of Trusted Payees&quot; checkbox only if the creditor is not already a trusted payee on the customer&#39;s account. If the creditor is already a trusted payee, the checkbox is suppressed. The wording of the checkbox label is driven by an API field — see Trusted Payees Wording under <em data-v-c0a8f0fe${_scopeId}>UI Behaviour Driven by API Fields</em>.`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_EdRefTable, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<table data-v-c0a8f0fe${_scopeId}><thead data-v-c0a8f0fe${_scopeId}><tr data-v-c0a8f0fe${_scopeId}><th data-v-c0a8f0fe${_scopeId}>Creditor status on the customer&#39;s account</th><th data-v-c0a8f0fe${_scopeId}>Authorisation Page Behaviour</th></tr></thead><tbody data-v-c0a8f0fe${_scopeId}><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><strong data-v-c0a8f0fe${_scopeId}>Not</strong> already a trusted payee</td><td data-v-c0a8f0fe${_scopeId}>The checkbox is shown.</td></tr><tr data-v-c0a8f0fe${_scopeId}><td data-v-c0a8f0fe${_scopeId}><strong data-v-c0a8f0fe${_scopeId}>Already</strong> a trusted payee</td><td data-v-c0a8f0fe${_scopeId}>The checkbox is suppressed.</td></tr></tbody></table>`);
      } else {
        return [
          createVNode("table", null, [
            createVNode("thead", null, [
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/_shared/UIBehaviour.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const UIBehaviour = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-c0a8f0fe"]]);
const _sfc_main = {};
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/_shared/ExampleJourneys.vue");
