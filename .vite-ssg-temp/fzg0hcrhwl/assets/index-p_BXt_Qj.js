...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-7f87bd0c><section class="ed-doc__hero" data-v-7f87bd0c><div class="ed-doc__inner" data-v-7f87bd0c><div class="ed-doc__eyebrow" data-v-7f87bd0c><span class="ed-doc__eyebrow-dash" data-v-7f87bd0c></span> LFI · API Hub · Consent Manager </div><h1 class="ed-doc__title" data-v-7f87bd0c> Consent Manager <span class="ed-doc__read" data-v-7f87bd0c>2 min read</span></h1><p class="ed-doc__lede" data-v-7f87bd0c> The <strong data-v-7f87bd0c>Consent Manager</strong> is an API provided by the API Hub that gives the LFI read and write access to the consent records held centrally by the API Hub. The API Hub is the single source of truth for all consents — the Consent Manager is how your systems interact with that source of truth. </p></div></section>`);
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-7f87bd0c${_scopeId2}><thead data-v-7f87bd0c${_scopeId2}><tr data-v-7f87bd0c${_scopeId2}><th data-v-7f87bd0c${_scopeId2}>Environment</th><th data-v-7f87bd0c${_scopeId2}>URL</th></tr></thead><tbody data-v-7f87bd0c${_scopeId2}><tr data-v-7f87bd0c${_scopeId2}><td data-v-7f87bd0c${_scopeId2}>Pre-production</td><td data-v-7f87bd0c${_scopeId2}><code data-v-7f87bd0c${_scopeId2}>https://cm.{lfiCode}.preprod.apihub.openfinance.ae</code></td></tr><tr data-v-7f87bd0c${_scopeId2}><td data-v-7f87bd0c${_scopeId2}>Production</td><td data-v-7f87bd0c${_scopeId2}><code data-v-7f87bd0c${_scopeId2}>https://cm.{lfiCode}.apihub.openfinance.ae</code></td></tr></tbody></table>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Where <code data-v-7f87bd0c${_scopeId2}>{lfiCode}</code> is the LFI Code assigned during <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/prerequisites#lfi-code" data-v-7f87bd0c${_scopeId2}>API Hub onboarding</a>. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` All requests to the Consent Manager MUST be made using the <strong data-v-7f87bd0c${_scopeId2}>C3-hh-cm-client</strong> application registered in the Trust Framework. This is the same client used to call the <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/" data-v-7f87bd0c${_scopeId2}>Headless Heimdall Auth Server</a>. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Requests MUST be made over <strong data-v-7f87bd0c${_scopeId2}>mutual TLS</strong> using the <strong data-v-7f87bd0c${_scopeId2}>C3</strong> transport client certificate. If your API Hub is configured for <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/configuring-authentication/jwt-client" data-v-7f87bd0c${_scopeId2}>JWT Auth</a>, you MUST also include a signed JWT in the <code data-v-7f87bd0c${_scopeId2}>Authorization</code> header, signed with the <strong data-v-7f87bd0c${_scopeId2}>Sig4</strong> signing key. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` See <a href="/tech/lfi-api-hub/v2.1/api-hub/connectivity/" data-v-7f87bd0c${_scopeId2}>Connectivity &amp; Certificates</a> for the full certificate mapping, and <a href="/tech/lfi-api-hub/trust-framework/creating-c3-application" data-v-7f87bd0c${_scopeId2}>Creating the C3-hh-cm-client Application</a> for setup instructions. `);
            } else {
              return [
                createTextVNode(" See "),
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<h3 data-v-7f87bd0c${_scopeId}>1. Authentication and authorisation journey</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For full details on the end-to-end flow — including how the Consent Manager fits alongside the Headless Heimdall Auth Server — see the <a href="/tech/lfi-api-hub/v2.1/consent-journey/api-guide" data-v-7f87bd0c${_scopeId2}>Consent Journey API Guide</a>. `);
            } else {
              return [
        ...
        _push2(`<h3 data-v-7f87bd0c${_scopeId}>2. Consent Management Interface</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For the requirements, user experience specifications, and a detailed API guide for building the CMI, see the <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/" data-v-7f87bd0c${_scopeId2}>Consent Management Interface</a>. `);
            } else {
              return [
        ...
        _push2(`<h3 data-v-7f87bd0c${_scopeId}>3. Payment status updates</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For every Open Finance payment executed under a consent, the LFI MUST update the payment status on the API Hub by calling <span class="endpoint" data-v-7f87bd0c${_scopeId2}><span class="http-method http-method--patch" data-v-7f87bd0c${_scopeId2}>PATCH</span><code data-v-7f87bd0c${_scopeId2}>/payment-log/{id}</code></span>. This keeps the API Hub&#39;s payment log accurate and ensures the CMI can display up-to-date payment history to the customer. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The full API reference for each endpoint is available in the sidebar under <strong data-v-7f87bd0c${_scopeId2}>API Reference</strong>. Use <span class="endpoint" data-v-7f87bd0c${_scopeId2}><span class="http-method http-method--get" data-v-7f87bd0c${_scopeId2}>GET</span><code data-v-7f87bd0c${_scopeId2}>/hello-mtls</code></span> to verify your mTLS connectivity before calling other endpoints. `);
            } else {
              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/api-hub/consent-manager/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-7f87bd0c"]]);
export {
  index as default
};
