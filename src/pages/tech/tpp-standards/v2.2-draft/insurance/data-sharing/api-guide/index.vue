  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        ...
        <li>
          ...
          <a href="/tech/tpp-standards/v2.2-draft/insurance/data-sharing/api-guide/premiums">Encrypted Premiums</a>.
        </li>
        <li>
    ...
    >
      ...
      <EdProse>
        ...
        (<code>urn:openfinanceuae:insurance-consent:v2.2</code>).
      </EdProse>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>enum</td>
              <td>Must be <code>urn:openfinanceuae:insurance-consent:v2.2</code></td>
    ...
    >
      ...
      <EdNote type="tip" title="User Experience">
        <p>
          See <a href="/tech/tpp-standards/v2.2-draft/insurance/data-sharing/user-journeys">User Experience</a>
    ...
    >
      ...
      <EdProse>
        ...
        every sector under
        <a href="/tech/tpp-standards/v2.2-draft/insurance/data-sharing/">Insurance Data Sharing</a>.
      </EdProse>
    </EdSectionBand>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>ReadInsurancePremium</code></td><td>The <code>Premium</code> field. Returned as a JWE that the customer device decrypts &mdash; see <a href="/tech/tpp-standards/v2.2-draft/insurance/data-sharing/api-guide/premiums">Encrypted Premiums</a>.</td></tr>
          </tbody>
        </table>
      </EdRefTable>
