...
<template>
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        <li>
          <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/ozone-connect-url"><strong>Ozone Connect Base URL</strong></a>
        ...
        <li>
          <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/auth-endpoint"><strong>Authorization Endpoint</strong></a>
    ...
    >
      <EdProse>
        The Hub provides an
        <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/"><strong>Admin Portal</strong></a>
        where your team can:
      </EdProse>
