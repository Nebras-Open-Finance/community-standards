 ...
 *
 * The chargeable-endpoints page (`/pricing/endpoints/`) renders from this
 * file, and `supporting/tests/chargeable-endpoints.test.mjs` fails the build
 * if any TPP-standards ReDoc page is missing or extra. To add or remove an
 * endpoint, edit this file and the test will tell you if you've drifted.
 *
