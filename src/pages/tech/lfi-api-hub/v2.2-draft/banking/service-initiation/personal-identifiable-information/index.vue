  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/service-initiation/personal-identifiable-information/api-schema/pii-par">PII (Consent &mdash; Consent Manager)</a> and
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/service-initiation/personal-identifiable-information/api-schema/pii-payments">PII (Payments &mdash; Ozone Connect)</a> for the full
        schemas.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        ...
        (<a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/#enc1-encryption-key">Enc1</a>).
    ...
    >
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            <tr><td><strong>Decryption</strong></td><td>Decrypt the JWE using the Enc1 private key &mdash; see <a href="/tech/lfi-api-hub/v2.2-draft/banking/service-initiation/personal-identifiable-information/api-guide/decrypt-pii">How to Decrypt PII</a></td></tr>
            ...
            <tr><td><strong>Field validation</strong></td><td>Verify mandatory fields, IBAN format, BIC consistency, and creditor matching rules &mdash; see <a href="/tech/lfi-api-hub/v2.2-draft/banking/service-initiation/personal-identifiable-information/debtor-account">Debtor Account</a> and <a href="/tech/lfi-api-hub/v2.2-draft/banking/service-initiation/personal-identifiable-information/creditor">Creditor</a></td></tr>
