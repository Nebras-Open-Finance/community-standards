...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-7b7fc4d7>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-7b7fc4d7${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-7b7fc4d7${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
      ...
      _push(`<div class="ed-page__intro" data-v-7b7fc4d7>`);
      _push(ssrRenderComponent(_component_EdProse, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` This article uses <code data-v-7b7fc4d7${_scopeId}>GET /accounts/{accountId}/transactions</code> as the worked example. The same behaviour applies to <code data-v-7b7fc4d7${_scopeId}>GET /accounts/{accountId}/statements</code> — and to any other endpoint where the LFI chooses to paginate. `);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-7b7fc4d7${_scopeId}>Request from the Hub</h3>`);
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-7b7fc4d7${_scopeId2}>page</code> is 1-indexed; <code data-v-7b7fc4d7${_scopeId2}>page-size</code> defaults to <code data-v-7b7fc4d7${_scopeId2}>100</code>. Filtering parameters (<code data-v-7b7fc4d7${_scopeId2}>fromBookingDateTime</code>, <code data-v-7b7fc4d7${_scopeId2}>toBookingDateTime</code>) are applied <strong data-v-7b7fc4d7${_scopeId2}>before</strong> pagination — <code data-v-7b7fc4d7${_scopeId2}>totalRecords</code> and <code data-v-7b7fc4d7${_scopeId2}>totalPages</code> reflect the filtered result set, not the whole table.`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-7b7fc4d7${_scopeId}>Response to the Hub</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The LFI returns the slice for the requested page, plus a <code data-v-7b7fc4d7${_scopeId2}>meta</code> block describing the full filtered result set:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7b7fc4d7${_scopeId2}><thead data-v-7b7fc4d7${_scopeId2}><tr data-v-7b7fc4d7${_scopeId2}><th data-v-7b7fc4d7${_scopeId2}>Field</th><th data-v-7b7fc4d7${_scopeId2}>Meaning</th></tr></thead><tbody data-v-7b7fc4d7${_scopeId2}><tr data-v-7b7fc4d7${_scopeId2}><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>meta.paginated</code></td><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>true</code> if the response is a page of a larger result set. <code data-v-7b7fc4d7${_scopeId2}>false</code> or omitted if the LFI returned the full result set in a single response</td></tr><tr data-v-7b7fc4d7${_scopeId2}><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>meta.totalPages</code></td><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>ceil(totalRecords / page-size)</code> — the last page number the Hub may request</td></tr><tr data-v-7b7fc4d7${_scopeId2}><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>meta.totalRecords</code></td><td data-v-7b7fc4d7${_scopeId2}>The total number of records in the filtered result set across all pages</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The LFI <strong data-v-7b7fc4d7${_scopeId2}>MUST</strong> return records in a deterministic order so pagination is stable across successive page requests.`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-7b7fc4d7${_scopeId}>Request from the TPP</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: tppRequest,
              lang: "http"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The TPP does not send <code data-v-7b7fc4d7${_scopeId2}>page</code> or <code data-v-7b7fc4d7${_scopeId2}>page-size</code>. Pagination is expressed through the Hub&#39;s URL parameters on the <code data-v-7b7fc4d7${_scopeId2}>Links</code> returned in the previous response.`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-7b7fc4d7${_scopeId}>Response to the TPP</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The Hub converts the LFI&#39;s <code data-v-7b7fc4d7${_scopeId2}>meta</code> into <code data-v-7b7fc4d7${_scopeId2}>Meta</code> and <code data-v-7b7fc4d7${_scopeId2}>Links</code>:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The Hub derives each link from the LFI&#39;s <code data-v-7b7fc4d7${_scopeId2}>meta.totalPages</code> and the current <code data-v-7b7fc4d7${_scopeId2}>page</code>:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7b7fc4d7${_scopeId2}><thead data-v-7b7fc4d7${_scopeId2}><tr data-v-7b7fc4d7${_scopeId2}><th data-v-7b7fc4d7${_scopeId2}>TPP field</th><th data-v-7b7fc4d7${_scopeId2}>Derived from</th></tr></thead><tbody data-v-7b7fc4d7${_scopeId2}><tr data-v-7b7fc4d7${_scopeId2}><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>Links.Self</code></td><td data-v-7b7fc4d7${_scopeId2}>The URL that produced this response</td></tr><tr data-v-7b7fc4d7${_scopeId2}><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>Links.First</code></td><td data-v-7b7fc4d7${_scopeId2}>Current URL with <code data-v-7b7fc4d7${_scopeId2}>page=1</code></td></tr><tr data-v-7b7fc4d7${_scopeId2}><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>Links.Prev</code></td><td data-v-7b7fc4d7${_scopeId2}>Current URL with <code data-v-7b7fc4d7${_scopeId2}>page = currentPage - 1</code>. Omitted on the first page</td></tr><tr data-v-7b7fc4d7${_scopeId2}><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>Links.Next</code></td><td data-v-7b7fc4d7${_scopeId2}>Current URL with <code data-v-7b7fc4d7${_scopeId2}>page = currentPage + 1</code>. Omitted on the last page</td></tr><tr data-v-7b7fc4d7${_scopeId2}><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>Links.Last</code></td><td data-v-7b7fc4d7${_scopeId2}>Current URL with <code data-v-7b7fc4d7${_scopeId2}>page = meta.totalPages</code></td></tr><tr data-v-7b7fc4d7${_scopeId2}><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>Meta.TotalPages</code></td><td data-v-7b7fc4d7${_scopeId2}><code data-v-7b7fc4d7${_scopeId2}>meta.totalPages</code> from the LFI</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 data-v-7b7fc4d7${_scopeId}>When the LFI returns an unpaginated response</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`If the LFI returns <code data-v-7b7fc4d7${_scopeId2}>meta.paginated: false</code> (or omits <code data-v-7b7fc4d7${_scopeId2}>paginated</code>), the full result set is in a single response. The Hub emits <code data-v-7b7fc4d7${_scopeId2}>Meta.TotalPages: 1</code>, a <code data-v-7b7fc4d7${_scopeId2}>Links.Self</code>, and no <code data-v-7b7fc4d7${_scopeId2}>First</code> / <code data-v-7b7fc4d7${_scopeId2}>Prev</code> / <code data-v-7b7fc4d7${_scopeId2}>Next</code> / <code data-v-7b7fc4d7${_scopeId2}>Last</code>.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The Hub propagates this as an empty <code data-v-7b7fc4d7${_scopeId2}>Data</code> array with <code data-v-7b7fc4d7${_scopeId2}>Meta.TotalPages: 0</code>. <code data-v-7b7fc4d7${_scopeId2}>404</code> <strong data-v-7b7fc4d7${_scopeId2}>MUST NOT</strong> be returned.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The TPP standards follow UK Open Banking conventions — opaque <code data-v-7b7fc4d7${_scopeId2}>Links</code> let the Hub evolve its pagination strategy (cursor-based, time-sliced, etc.) without breaking TPP clients. The LFI side is deliberately simpler: page/page-size is the lowest-common-denominator interface that every core banking system can serve cheaply. The Hub absorbs the translation.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-7b7fc4d7${_scopeId2}>GET /accounts/{accountId}/statements</code> works identically: the LFI paginates by <code data-v-7b7fc4d7${_scopeId2}>page</code> / <code data-v-7b7fc4d7${_scopeId2}>page-size</code> and returns <code data-v-7b7fc4d7${_scopeId2}>meta.totalPages</code> / <code data-v-7b7fc4d7${_scopeId2}>meta.totalRecords</code>; the Hub emits <code data-v-7b7fc4d7${_scopeId2}>Links</code> and <code data-v-7b7fc4d7${_scopeId2}>Meta.TotalPages</code> on the TPP side.`);
                } else {
                  return [
                    createVNode("code", null, "GET /accounts/{accountId}/statements"),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Other list endpoints (<code data-v-7b7fc4d7${_scopeId2}>/beneficiaries</code>, <code data-v-7b7fc4d7${_scopeId2}>/direct-debits</code>, <code data-v-7b7fc4d7${_scopeId2}>/scheduled-payments</code>, <code data-v-7b7fc4d7${_scopeId2}>/standing-orders</code>, <code data-v-7b7fc4d7${_scopeId2}>/products</code>, <code data-v-7b7fc4d7${_scopeId2}>/accounts/{accountId}/customer</code>) may pursue the same model if the LFI chooses to paginate them, but the expectation is that the full result set is returned in a single response.`);
                } else {
                  return [
...
const pagination = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7b7fc4d7"]]);
export {
