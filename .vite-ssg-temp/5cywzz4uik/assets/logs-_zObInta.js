...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-90f8e6df><section class="ed-doc__hero" data-v-90f8e6df><div class="ed-doc__inner" data-v-90f8e6df><div class="ed-doc__eyebrow" data-v-90f8e6df><span class="ed-doc__eyebrow-dash" data-v-90f8e6df></span> LFI · API Hub · Admin Portal · Logs </div><h1 class="ed-doc__title" data-v-90f8e6df> Logs <span class="ed-doc__read" data-v-90f8e6df>3 min read</span></h1><p class="ed-doc__lede" data-v-90f8e6df> The Admin Portal provides two types of logs: <strong data-v-90f8e6df>Audit Logs</strong> that track all portal activity, and <strong data-v-90f8e6df>API Logs</strong> that trace every request processed by the API Hub. </p></div></section>`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>User</strong> — the portal user who performed the action</li><li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Action</strong> — the operation performed (e.g. read, update, activate, block)</li><li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Target</strong> — the resource affected (e.g. TPP, client, consent)</li><li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Timestamp</strong> — when the action occurred</li>`);
            } else {
              return [
                createVNode("li", null, [
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<h3 data-v-90f8e6df${_scopeId}>Searching by interaction ID</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Every API request carries an <code data-v-90f8e6df${_scopeId2}>x-fapi-interaction-id</code> header. To trace a request, enter this interaction ID in the API logs search field. The portal will return <strong data-v-90f8e6df${_scopeId2}>every log entry</strong> associated with that request — typically hundreds of entries covering every stage of processing. `);
            } else {
              return [
        ...
        _push2(`<h3 data-v-90f8e6df${_scopeId}>What the logs show</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Inbound request</strong> — the TPP&#39;s request arriving at the API Hub, including headers, certificate details, and the original URL</li><li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Validation and enrichment</strong> — each step of token validation, consent checking, schema enforcement, and request enrichment</li><li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Outbound request to LFI</strong> — the request forwarded to the LFI&#39;s Ozone Connect endpoint</li><li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>LFI response</strong> — the response received from the LFI</li><li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Response processing</strong> — normalization, error mapping, and response construction</li><li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Outbound response to TPP</strong> — the final response returned to the TPP</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-90f8e6df${_scopeId2}><thead data-v-90f8e6df${_scopeId2}><tr data-v-90f8e6df${_scopeId2}><th data-v-90f8e6df${_scopeId2}>Header / Field</th><th data-v-90f8e6df${_scopeId2}>Information</th></tr></thead><tbody data-v-90f8e6df${_scopeId2}><tr data-v-90f8e6df${_scopeId2}><td data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Host</strong></td><td data-v-90f8e6df${_scopeId2}>Which API Hub endpoint received the request (resource server, authorization server, etc.)</td></tr><tr data-v-90f8e6df${_scopeId2}><td data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>X-Original-URL</strong></td><td data-v-90f8e6df${_scopeId2}>The API path called, including the API version and resource (e.g. <code data-v-90f8e6df${_scopeId2}>/account-information/v1.2/accounts/{AccountId}/beneficiaries</code>)</td></tr><tr data-v-90f8e6df${_scopeId2}><td data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>X-Cert-DN</strong></td><td data-v-90f8e6df${_scopeId2}>The certificate distinguished name, identifying which TPP made the request</td></tr></tbody></table>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The log entries follow the <strong data-v-90f8e6df${_scopeId2}>same pattern for every request</strong>. After reviewing a few traces, you will quickly learn which entries correspond to which stage of processing. Common debugging scenarios: `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Unexpected error response</strong> — search by interaction ID, locate the LFI response entry, and inspect the status code and body returned by your Ozone Connect endpoint</li><li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Schema validation failure</strong> — the log will show the validation step that rejected the request or response, with the specific schema error</li><li data-v-90f8e6df${_scopeId2}><strong data-v-90f8e6df${_scopeId2}>Consent or token issue</strong> — the validation entries will indicate whether consent or token checks failed, and why</li>`);
            } else {
              return [
                createVNode("li", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/logs.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const logs = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-90f8e6df"]]);
export {
  logs as default
};
