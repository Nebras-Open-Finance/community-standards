    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a
            class="ed-link-card"
            href="/tech/tpp-standards/v2.1/insurance/quotation/requirements"
          ...
          <a
            class="ed-link-card"
            href="/tech/lfi-api-hub/v2.1/insurance/quotation/quote-types"
          ...
          <a
            class="ed-link-card"
            href="/tech/tpp-standards/v2.1/insurance/quotation/api-guide/"
          ...
          <a
            class="ed-link-card"
            href="/tech/tpp-standards/v2.1/insurance/quotation/user-journeys"
