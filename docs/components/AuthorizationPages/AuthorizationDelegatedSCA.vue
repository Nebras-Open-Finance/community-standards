        ...
        <div class="auth-page-text-frame">
            <div class="auth-page-text-inner-frame">
                ...
                <div class="auth-page-accounts-section">
                    ...
                    <div class="auth-page-date" style="margin-top: 14px;">
                        <div class="auth-page-date-text" style="height: auto;">Permission to make payments from this account will last until</div>
