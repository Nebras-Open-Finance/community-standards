...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({ title: "OFP-001 · PAR File Payment consent (draft)" });
    ...
    const spec = sources["./par-file-payment-schema.yaml"] ?? "";
    function downloadYaml() {
      ...
      a.href = url;
      a.download = "ofp-001-par-file-payment-schema.yaml";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_EndpointPage, mergeProps({
        eyebrow: "OFP-001 · Draft schema · PAR consent",
        title: "PAR File Payment consent",
        version: "Draft · V2.2",
        method: "POST",
        path: "/par"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ofp-schema-toolbar" data-v-87c180db${_scopeId}>`);
            _push2(ssrRenderComponent(_component_RouterLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span aria-hidden="true" data-v-87c180db${_scopeId2}>←</span> Back to OFP-001 `);
                } else {
                  return [
            ...
            _push2(`<button type="button" class="ofp-schema-download" data-v-87c180db${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-87c180db${_scopeId}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" data-v-87c180db${_scopeId}></path><polyline points="7 10 12 15 17 10" data-v-87c180db${_scopeId}></polyline><line x1="12" y1="15" x2="12" y2="3" data-v-87c180db${_scopeId}></line></svg> Download .yaml </button></div>`);
            _push2(ssrRenderComponent(_component_RedocWrapper, {
              "spec-text": unref(spec),
              "override-servers": [],
              "hide-security": "",
              "container-id": "redoc-ofp001-par"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/proposals/ofp-001/par-schema.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const parSchema = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-87c180db"]]);
export {
  parSchema as default
};
