  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/tpp-standards/v2.2-rc1/webhooks/payment-status/api-guide">Payment Status Event API Guide</a>
      ...
      <EdProse>
        ...
        <a href="/tech/tpp-standards/v2.2-rc1/banking/service-initiation/open-api/payments-PaymentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/payments/{paymentId}</code></a>
