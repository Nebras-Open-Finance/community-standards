                ...
                <div class="consent-page-progress">
                    <div class="consent-page-progress-1">
                        <div class="consent-page-progress-icon-active">
                            <div class="consent-page-progress-icon-text-active">1</div>
                        </div>
                        <div class="consent-page-progress-text">Consent</div>
                    </div>
                    <div class="consent-page-progress-2">
                        <div class="consent-page-progress-icon">
                            <div class="consent-page-progress-icon-text">2</div>
                        </div>
                        <div class="consent-page-progress-text">Authorize</div>
                    </div>
                    <div class="consent-page-progress-3">
                        <div class="consent-page-progress-icon">
                            <div class="consent-page-progress-icon-text">3</div>
                        </div>
                        <div class="consent-page-progress-text">Complete</div>
                    </div>
            ...
            <div class="consent-page-text-inner-frame">
                ...
                <div class="consent-page-text-section">
                    <div class="consent-page-text">
                        ...
                        need to access information from your insurance policy(ies).
                    </div>
                    ...
                    <div class="consent-page-dropdown-container">
                        ...
                        <div v-if="show_tpp_why" class="consent-page-dropdown-subtext-section">
                            <div class="consent-page-dropdown-subtext">
                                These details will vary depending on the nature of the TPP&rsquo;s service. It is the
                                TPP&rsquo;s responsibility to determine how best to describe why Insurance Data Sharing
                                is required to deliver their service.
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            >
                                ...
                                >
                                    <div class="consent-page-dropdown-text-section">
                                        ...
                                        <div class="consent-page-dropdown-text">{{ row.label }}</div>
                                    </div>
                                    <svg
                                        class="consent-page-dropdown-arrow"
                                ...
                                <div
                                    ...
                                    class="consent-page-dropdown-subtext-section"
                                >
                                    <div class="consent-page-dropdown-subtext">
                ...
                <div class="consent-page-button-text-section">
                    <svg class="consent-page-button-icon" width="22" height="23" viewBox="0 0 22 23" fill="none"
                        ...
                        <defs>
                            ...
                            <linearGradient id="paint1_linear_ins_2_496" x1="5.42781" y1="11.0305" x2="16.5723" y2="11.0305"
                                gradientUnits="userSpaceOnUse">
                            ...
                            <linearGradient id="paint2_linear_ins_2_496" x1="3.65987" y1="11.0305" x2="18.3404" y2="11.0305"
                                gradientUnits="userSpaceOnUse">
                                <stop stop-color="#BFD6F5" />
                                <stop offset="0.55" stop-color="#BBE7ED" />
                                <stop offset="1" stop-color="#BAF0E9" />
                            </linearGradient>
                            <radialGradient id="paint3_radial_ins_2_496" cx="0" cy="0" r="1"
                    ...
                    <div class="consent-page-button-text">Proceed using AlTareq</div>
                </div>
            </div>
            <div class="consent-page-button-description">
                Continue to [YOUR LFI] to share the specified policy(ies) information
            </div>
        </div>
    </div>
</template>
...
// Normalises Permissions into an array of { InsuranceType, Permissions[] }, even if the
// editor temporarily produces a single object or non-array value while being typed.
...
// Per-permission icons matching the Figma source. Returned as functional render
// components so the template can interpolate them without 7 separate <svg> blocks.
...
/* Insurance-only: tighten the gap between the type-name heading and the
   permission rows. The shared 28px gap was sized for the (now removed)
   'Insurance Type' mini-header sitting above the sub-header. */
.consent-page-text-inner-frame-2 {
    gap: 8px;
}

/* Insurance-only: tighten the gap between permission rows inside each
   per-type card (matches the Figma spec of 4px). Scoped to text-frame-2
   so the top 'Why we share your data' frame keeps its breathing room. */
.consent-page-text-frame-2 .consent-page-text-section {
    gap: 4px;
}

/* Insurance-only: shrink each row's vertical space and the expanded
   panel's padding so the per-type cards feel compact rather than airy. */
.consent-page-text-frame-2 .consent-page-dropdown {
    height: auto;
    min-height: 32px;
}

.consent-page-text-frame-2 .consent-page-dropdown-subtext-section {
    padding: 8px 10px;
}

.consent-page-text-frame-2 .consent-page-dropdown-subtext {
    line-height: 130%;
}

/* Insurance-only: in the bottom 'expiration' card the date-range is the
   only child, but the shared rule pins its height to 54px while its
   inner content is ~40px — that 14px of dead space pushed everything to
   the top of the card. Let it hug its content so card padding is even
   top/bottom. */
