  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdNote type="info" title="Other consent types adjust the authorization page">
        <p>
          ...
          <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/user-journeys">Bank Service Initiation</a>
          and
          <a href="/tech/lfi-api-hub/v2.1/insurance/data-sharing/user-journeys">Insurance Data Sharing</a>.
        </p>
      </EdNote>
    </EdSectionBand>
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.1/consent-events">Ozone Connect Consent Events</a> path.
      </EdProse>

      <EdNote type="info" title="Not applicable with CAAP">
        <p>
          The LFI&apos;s own <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/">Consent Management Interface</a>
