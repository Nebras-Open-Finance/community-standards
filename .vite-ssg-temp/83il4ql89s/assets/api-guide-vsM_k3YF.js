...
import { _ as _sfc_main$1, a as _sfc_main$2 } from "./APIFlowsConsentValidate-C6ZBYkRf.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-d6d47ef1><section class="ed-doc__hero" data-v-d6d47ef1><div class="ed-doc__inner" data-v-d6d47ef1><div class="ed-doc__eyebrow" data-v-d6d47ef1><span class="ed-doc__eyebrow-dash" data-v-d6d47ef1></span> LFI · Ozone Connect · Consent Events &amp; Actions · API Guide </div><h1 class="ed-doc__title" data-v-d6d47ef1> Consent Events &amp; Actions — API Guide <span class="ed-doc__read" data-v-d6d47ef1>3 min read</span></h1><p class="ed-doc__lede" data-v-d6d47ef1> This guide covers the implementation of the Consent Events &amp; Actions endpoints on your Ozone Connect server. These are endpoints <strong data-v-d6d47ef1>your LFI exposes</strong> and the <strong data-v-d6d47ef1>API Hub calls</strong>. </p></div></section>`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-d6d47ef1${_scopeId2}><strong data-v-d6d47ef1${_scopeId2}>API Hub onboarded</strong> — Your API Hub instance is provisioned and your <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/" data-v-d6d47ef1${_scopeId2}>environment-specific configuration</a> is complete </li><li data-v-d6d47ef1${_scopeId2}><strong data-v-d6d47ef1${_scopeId2}>Ozone Connect base URL configured</strong> — The API Hub knows the base URL of your Ozone Connect server. See <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/ozone-connect-url" data-v-d6d47ef1${_scopeId2}>Ozone Connect Base URL</a></li><li data-v-d6d47ef1${_scopeId2}><strong data-v-d6d47ef1${_scopeId2}>Connectivity verified</strong> — Bidirectional mTLS connectivity confirmed between your systems and the API Hub. See <a href="/tech/lfi-api-hub/v2.1/api-hub/connectivity/" data-v-d6d47ef1${_scopeId2}>Connectivity &amp; Certificates</a></li>`);
            } else {
              return [
                createVNode("li", null, [
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h3 data-v-d6d47ef1${_scopeId}>API Sequence Flow</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The API Hub calls this endpoint during consent creation, <strong data-v-d6d47ef1${_scopeId2}>before</strong> the consent is stored. The trigger is a TPP submitting a <span class="endpoint" data-v-d6d47ef1${_scopeId2}><span class="http-method http-method--post" data-v-d6d47ef1${_scopeId2}>POST</span><code data-v-d6d47ef1${_scopeId2}>/par</code></span> request to the API Hub. `);
            } else {
              return [
        ...
        _push2(`<h3 data-v-d6d47ef1${_scopeId}>What to validate</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-d6d47ef1${_scopeId2}>Does the consent version match what your LFI supports?</li><li data-v-d6d47ef1${_scopeId2}>Are the requested permissions within the scope of what your LFI offers?</li>`);
            } else {
              return [
        ...
        _push2(`<h3 data-v-d6d47ef1${_scopeId}>Response schema</h3>`);
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-d6d47ef1${_scopeId2}><thead data-v-d6d47ef1${_scopeId2}><tr data-v-d6d47ef1${_scopeId2}><th data-v-d6d47ef1${_scopeId2}>Field</th><th data-v-d6d47ef1${_scopeId2}>Type</th><th style="${ssrRenderStyle({ "text-align": "center" })}" data-v-d6d47ef1${_scopeId2}>Required</th><th data-v-d6d47ef1${_scopeId2}>Description</th></tr></thead><tbody data-v-d6d47ef1${_scopeId2}><tr data-v-d6d47ef1${_scopeId2}><td data-v-d6d47ef1${_scopeId2}><code data-v-d6d47ef1${_scopeId2}>data.status</code></td><td data-v-d6d47ef1${_scopeId2}><code data-v-d6d47ef1${_scopeId2}>string</code></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-d6d47ef1${_scopeId2}>Yes</td><td data-v-d6d47ef1${_scopeId2}><code data-v-d6d47ef1${_scopeId2}>valid</code> or <code data-v-d6d47ef1${_scopeId2}>invalid</code></td></tr><tr data-v-d6d47ef1${_scopeId2}><td data-v-d6d47ef1${_scopeId2}><code data-v-d6d47ef1${_scopeId2}>data.code</code></td><td data-v-d6d47ef1${_scopeId2}><code data-v-d6d47ef1${_scopeId2}>string</code></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-d6d47ef1${_scopeId2}>No</td><td data-v-d6d47ef1${_scopeId2}>An error code — returned when status is <code data-v-d6d47ef1${_scopeId2}>invalid</code></td></tr><tr data-v-d6d47ef1${_scopeId2}><td data-v-d6d47ef1${_scopeId2}><code data-v-d6d47ef1${_scopeId2}>data.description</code></td><td data-v-d6d47ef1${_scopeId2}><code data-v-d6d47ef1${_scopeId2}>string</code></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-d6d47ef1${_scopeId2}>No</td><td data-v-d6d47ef1${_scopeId2}>A human-readable description of why the consent was rejected</td></tr><tr data-v-d6d47ef1${_scopeId2}><td data-v-d6d47ef1${_scopeId2}><code data-v-d6d47ef1${_scopeId2}>meta</code></td><td data-v-d6d47ef1${_scopeId2}><code data-v-d6d47ef1${_scopeId2}>object</code></td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-d6d47ef1${_scopeId2}>Yes</td><td data-v-d6d47ef1${_scopeId2}>Empty object <code data-v-d6d47ef1${_scopeId2}>{}</code></td></tr></tbody></table>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` See the <a href="/tech/lfi-api-hub/v2.1/consent-events/open-api/validate" data-v-d6d47ef1${_scopeId2}><span class="endpoint" data-v-d6d47ef1${_scopeId2}><span class="http-method http-method--post" data-v-d6d47ef1${_scopeId2}>POST</span><code data-v-d6d47ef1${_scopeId2}>/consent/action/validate</code></span> API Reference</a> for the full request and response schemas. `);
            } else {
              return [
                createTextVNode(" See the "),
                createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-events/open-api/validate" }, [
                  createVNode("span", { class: "endpoint" }, [
                    createVNode("span", { class: "http-method http-method--post" }, "POST"),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-d6d47ef1${_scopeId2}><thead data-v-d6d47ef1${_scopeId2}><tr data-v-d6d47ef1${_scopeId2}><th data-v-d6d47ef1${_scopeId2}>Operation</th><th data-v-d6d47ef1${_scopeId2}>Trigger</th></tr></thead><tbody data-v-d6d47ef1${_scopeId2}><tr data-v-d6d47ef1${_scopeId2}><td data-v-d6d47ef1${_scopeId2}><span class="endpoint" data-v-d6d47ef1${_scopeId2}><span class="http-method http-method--post" data-v-d6d47ef1${_scopeId2}>POST</span><code data-v-d6d47ef1${_scopeId2}>/consent/event/post</code></span></td><td data-v-d6d47ef1${_scopeId2}>A consent has been <strong data-v-d6d47ef1${_scopeId2}>created</strong> — i.e. after <span class="endpoint" data-v-d6d47ef1${_scopeId2}><span class="http-method http-method--post" data-v-d6d47ef1${_scopeId2}>POST</span><code data-v-d6d47ef1${_scopeId2}>/par</code></span> succeeds (and after validation, if configured)</td></tr><tr data-v-d6d47ef1${_scopeId2}><td data-v-d6d47ef1${_scopeId2}><span class="endpoint" data-v-d6d47ef1${_scopeId2}><span class="http-method http-method--post" data-v-d6d47ef1${_scopeId2}>POST</span><code data-v-d6d47ef1${_scopeId2}>/consent/event/patch</code></span></td><td data-v-d6d47ef1${_scopeId2}>A consent has been <strong data-v-d6d47ef1${_scopeId2}>updated</strong> — e.g. status changed to <code data-v-d6d47ef1${_scopeId2}>Authorized</code>, <code data-v-d6d47ef1${_scopeId2}>Rejected</code>, <code data-v-d6d47ef1${_scopeId2}>Revoked</code>, or <code data-v-d6d47ef1${_scopeId2}>Expired</code></td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
        ...
        _push2(`<h3 data-v-d6d47ef1${_scopeId}>What to do with the event</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-d6d47ef1${_scopeId2}><strong data-v-d6d47ef1${_scopeId2}>On <code data-v-d6d47ef1${_scopeId2}>post</code></strong> — Store the new consent in your local system</li><li data-v-d6d47ef1${_scopeId2}><strong data-v-d6d47ef1${_scopeId2}>On <code data-v-d6d47ef1${_scopeId2}>patch</code></strong> — Update your local consent record to reflect the latest state</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The request body contains the <strong data-v-d6d47ef1${_scopeId2}>full consent object</strong> as stored in the API Hub&#39;s Consent Manager — not a diff. Your LFI can replace its local record entirely with the received payload. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-d6d47ef1${_scopeId2}> The API Hub is the <strong data-v-d6d47ef1${_scopeId2}>single source of truth</strong> for consent state. Your local copy is a convenience cache. If there is ever a discrepancy, the Hub&#39;s state takes precedence. </p>`);
            } else {
              return [
                createVNode("p", null, [
        ...
        _push2(`<h3 data-v-d6d47ef1${_scopeId}>Response</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`Your LFI MUST return <code data-v-d6d47ef1${_scopeId2}>204 No Content</code> to acknowledge receipt.`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-d6d47ef1${_scopeId2}> If your endpoint returns an error (e.g. <code data-v-d6d47ef1${_scopeId2}>400</code> or <code data-v-d6d47ef1${_scopeId2}>500</code>), the API Hub will <strong data-v-d6d47ef1${_scopeId2}>not</strong> retry the notification and will <strong data-v-d6d47ef1${_scopeId2}>not</strong> roll back the consent change. The consent state in the Hub proceeds regardless. </p><p data-v-d6d47ef1${_scopeId2}> Because the Hub is the source of truth and your local copy is a cache, any missed event can be reconciled by reading from the Consent Manager: </p><ul data-v-d6d47ef1${_scopeId2}><li data-v-d6d47ef1${_scopeId2}><strong data-v-d6d47ef1${_scopeId2}>Handler received the payload but failed to process it</strong> — you have the <code data-v-d6d47ef1${_scopeId2}>consentId</code>, so call <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId" class="endpoint" data-v-d6d47ef1${_scopeId2}><span class="http-method http-method--get" data-v-d6d47ef1${_scopeId2}>GET</span><code data-v-d6d47ef1${_scopeId2}>/consents/{consentId}</code></a> to fetch the latest state. </li><li data-v-d6d47ef1${_scopeId2}><strong data-v-d6d47ef1${_scopeId2}>Your system was offline and never received the event</strong> — reconcile lazily at end user login by calling <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/psu-userId-consents" class="endpoint" data-v-d6d47ef1${_scopeId2}><span class="http-method http-method--get" data-v-d6d47ef1${_scopeId2}>GET</span><code data-v-d6d47ef1${_scopeId2}>/psu/{userId}/consents</code></a> before rendering the CMI. </li></ul><p data-v-d6d47ef1${_scopeId2}> LFIs that do not maintain a local consent cache do not need to reconcile — read from the Consent Manager on demand. </p>`);
            } else {
              return [
                createVNode("p", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-d6d47ef1${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/consent-events/open-api/validate" class="endpoint" data-v-d6d47ef1${_scopeId2}><span class="http-method http-method--post" data-v-d6d47ef1${_scopeId2}>POST</span><code data-v-d6d47ef1${_scopeId2}>/consent/action/validate</code></a> — Full request and response schema</li><li data-v-d6d47ef1${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/consent-events/open-api/event-op" class="endpoint" data-v-d6d47ef1${_scopeId2}><span class="http-method http-method--post" data-v-d6d47ef1${_scopeId2}>POST</span><code data-v-d6d47ef1${_scopeId2}>/consent/event/{operation}</code></a> — Full request and response schema</li>`);
            } else {
              return [
                createVNode("li", null, [
                  createVNode("a", {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/consent-events/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-d6d47ef1"]]);
export {
  apiGuide as default
};
