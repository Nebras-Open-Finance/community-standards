...
const sipRows: MapRow[] = [
  ...
  },
  {
    ...
    guidelines:
      'The displayed properties depend on the values found in control parameters, which differ by payment type. Refer to the <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/psu-userId-consents">API spec</a> for available properties.',
  },
  {
    num: 11,
  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdNote type="info">
        <p>
          The
          <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId-audit" class="endpoint"><span class="http-method http-method--get">GET</span><code>/consents/{consentId}/audit</code></a>
    ...
    >
      ...
      <EdProse>
        This returns a summary of all payments for a given consent. Each payment log entry contains
        the fields needed to populate a single row in the Payment History tab.
      </EdProse>
