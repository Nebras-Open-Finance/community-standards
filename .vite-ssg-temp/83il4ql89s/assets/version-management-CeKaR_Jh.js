import { _ as __unplugin_components_6$3, a as __unplugin_components_7$2 } from "./EdRelatedCards-D4uHHv56.js";
import { _ as __unplugin_components_4, a as __unplugin_components_13 } from "./EdPillList-DubOhIC0.js";
import { _ as __unplugin_components_7$1, a as __unplugin_components_8$1 } from "./EdStages-DCt0xGCI.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_EdRelatedCards = __unplugin_components_6$3;
      const _component_EdRelatedCard = __unplugin_components_7$2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-03ef11f1>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdCallout, { color: "var(--at-gold)" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-03ef11f1${_scopeId2}> This policy takes effect from <strong data-v-03ef11f1${_scopeId2}>V2.1</strong> of the UAE Open Finance Standard. Standards, specifications, and documentation published prior to V2.1 — including V2.0 and any earlier errata — are not governed by this policy. Breaking changes introduced before V2.1 do not constitute non-compliance. </p><p data-v-03ef11f1${_scopeId2}> The stability guarantees set out in this policy — in particular, the restriction of breaking changes to major version releases and the scope constraints on errata — apply only to <strong data-v-03ef11f1${_scopeId2}>Live capabilities</strong>. A capability is Live when Nebras has formally declared it in production use within the UAE Open Finance ecosystem. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 data-v-03ef11f1${_scopeId}>Capabilities not yet declared Live</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-03ef11f1${_scopeId2}>Breaking changes <strong data-v-03ef11f1${_scopeId2}>MAY</strong> be introduced in minor versions or errata without requiring a major version increment</li><li data-v-03ef11f1${_scopeId2}>The release cadence defined below continues to apply</li><li data-v-03ef11f1${_scopeId2}>Once a capability is declared Live, all subsequent changes <strong data-v-03ef11f1${_scopeId2}>MUST</strong> comply with this policy in full</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<p class="ed-aside" data-v-03ef11f1${_scopeId}> Nebras is responsible for maintaining and publishing the register of Live capabilities. </p>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-03ef11f1${_scopeId3}><li data-v-03ef11f1${_scopeId3}><strong data-v-03ef11f1${_scopeId3}>MAY</strong> include breaking changes that are not backward compatible</li><li data-v-03ef11f1${_scopeId3}><strong data-v-03ef11f1${_scopeId3}>MUST NOT</strong> be released more frequently than every 18 months from the last major release</li><li data-v-03ef11f1${_scopeId3}><strong data-v-03ef11f1${_scopeId3}>MUST</strong> include a comprehensive record of all breaking changes, with migration guidance and a clear deprecation timeline for the prior major version</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                            createVNode("li", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-03ef11f1${_scopeId3}><li data-v-03ef11f1${_scopeId3}><strong data-v-03ef11f1${_scopeId3}>MUST NOT</strong> include breaking changes</li><li data-v-03ef11f1${_scopeId3}><strong data-v-03ef11f1${_scopeId3}>MUST NOT</strong> be released more frequently than every 6 months from the previous release</li><li data-v-03ef11f1${_scopeId3}><strong data-v-03ef11f1${_scopeId3}>MAY</strong> include non-breaking enhancements such as additional optional fields, additional GET response fields, additional endpoints, or non-breaking changes to field types</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                            createVNode("li", null, [
            ...
            _push2(`<h3 data-v-03ef11f1${_scopeId}>Version documentation</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Every major and minor version <strong data-v-03ef11f1${_scopeId2}>MUST</strong> be accompanied by:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-03ef11f1${_scopeId2}>A complete change log covering all modifications since the previous version</li><li data-v-03ef11f1${_scopeId2}>Implementer guidance describing how to adopt the new version</li><li data-v-03ef11f1${_scopeId2}>For major versions, migration guidance for each breaking change</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-03ef11f1${_scopeId2}>UI elements <strong data-v-03ef11f1${_scopeId2}>MUST NOT</strong> rely on API versioning for core functionality</li><li data-v-03ef11f1${_scopeId2}>Where UI behaviour depends on new data in a consent object, LFIs and TPPs <strong data-v-03ef11f1${_scopeId2}>MUST</strong> implement logic based on the presence of the data itself, not on the consent version</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdExample, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-03ef11f1${_scopeId2}> If a new consent permission <code data-v-03ef11f1${_scopeId2}>ReadStatements</code> is added in V2.1, the UI <strong data-v-03ef11f1${_scopeId2}>SHOULD</strong> check whether <code data-v-03ef11f1${_scopeId2}>ReadStatements</code> is present on the consent rather than checking whether the consent version equals V2.1. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 data-v-03ef11f1${_scopeId}>UI adoption</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-03ef11f1${_scopeId2}>LFIs <strong data-v-03ef11f1${_scopeId2}>MAY</strong> adopt visual or branding changes from a future version before upgrading their API version. <em data-v-03ef11f1${_scopeId2}>Example:</em> new UI requirements published in V2.0 may be implemented while still serving API V1.2</li><li data-v-03ef11f1${_scopeId2}>Adoption of new UI elements requires successful Customer Experience (CX) certification</li><li data-v-03ef11f1${_scopeId2}>When an LFI upgrades its API to a given version, the UI <strong data-v-03ef11f1${_scopeId2}>MUST</strong> also align with that version. UI enhancements <strong data-v-03ef11f1${_scopeId2}>MAY</strong> precede API version upgrades but <strong data-v-03ef11f1${_scopeId2}>MUST NOT</strong> lag behind them</li>`);
                } else {
                  return [
                    createVNode("li", null, [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-03ef11f1${_scopeId3}>A standards version <strong data-v-03ef11f1${_scopeId3}>MAY</strong> only be declared published once it is fully available to TPPs via the API Hub.</p>`);
                      } else {
                        return [
                          createVNode("p", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-03ef11f1${_scopeId3}> A release candidate (e.g. <code data-v-03ef11f1${_scopeId3}>V1.2-rc</code>) <strong data-v-03ef11f1${_scopeId3}>MAY</strong> be issued ahead of official publication. Once a version is agreed but not yet delivered into the API Hub, it carries a <code data-v-03ef11f1${_scopeId3}>-rc-final</code> suffix to indicate fixed-but-not-yet-published state. </p>`);
                      } else {
                        return [
                          createVNode("p", null, [
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_EdBullets, { tight: "" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<li data-v-03ef11f1${_scopeId4}>Post-publication changes are limited to guidance clarifications or bug fixes, and <strong data-v-03ef11f1${_scopeId4}>MUST</strong> follow the <a href="/policy/changes-to-published-content" data-v-03ef11f1${_scopeId4}>Changes to Published Documentation Policy</a></li><li data-v-03ef11f1${_scopeId4}>No functional changes affecting LFI or TPP implementations may be introduced after publication; such changes require a new minor or major version</li><li data-v-03ef11f1${_scopeId4}>Errata <strong data-v-03ef11f1${_scopeId4}>MUST NOT</strong> introduce breaking changes</li><li data-v-03ef11f1${_scopeId4}>Errata <strong data-v-03ef11f1${_scopeId4}>MUST NOT</strong> introduce new functionality — additive enhancements <strong data-v-03ef11f1${_scopeId4}>MUST</strong> be delivered through a new minor version</li>`);
                            } else {
                              return [
                                createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdTwoCol, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div data-v-03ef11f1${_scopeId2}><h3 data-v-03ef11f1${_scopeId2}>Compliance</h3>`);
                  ...
                  _push3(`</div><div data-v-03ef11f1${_scopeId2}><h3 data-v-03ef11f1${_scopeId2}>Review and updates</h3>`);
                  _push3(ssrRenderComponent(_component_EdProse, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
...
const versionManagement = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-03ef11f1"]]);
export {
