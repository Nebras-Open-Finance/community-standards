...
import { W as WireframePreview, A as AccountSetup, U as UIBehaviour, E as ExampleJourneys } from "./ExampleJourneys-TF43AQJH.js";
import { _ as _export_sfc, b as block0 } from "../main.mjs";
import "yaml";
import "./useSharedState-qc0PNim7.js";
import "./ConsentPeriodicSchedule-BPOYiTnI.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const myCustomValidator = (value) => {
      ...
      const periodStartDate2 = (_F = (_E = (_D = (_C = (_B = value == null ? void 0 : value.Data) == null ? void 0 : _B.ControlParameters) == null ? void 0 : _C.ConsentSchedule) == null ? void 0 : _D.MultiPayment) == null ? void 0 : _E.PeriodicSchedule) == null ? void 0 : _F.PeriodStartDate;
      if (periodStartDate2) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-e501cb8f><section class="ed-doc__hero" data-v-e501cb8f><div class="ed-doc__inner" data-v-e501cb8f><div class="ed-doc__eyebrow" data-v-e501cb8f><span class="ed-doc__eyebrow-dash" data-v-e501cb8f></span> Banking · Service Initiation · Variable Periodic Schedule · UX </div><h1 class="ed-doc__title" data-v-e501cb8f> Variable Periodic Schedule — User Experience <span class="ed-doc__read" data-v-e501cb8f>4 min read</span></h1><p class="ed-doc__lede" data-v-e501cb8f> When a customer is redirected to you to authorize a Variable Periodic Schedule payment consent through Open Finance, you must present an <strong data-v-e501cb8f>Authorization Page</strong> that clearly explains the payment the customer is authorizing — that recurring payments of varying amounts will be made at a set frequency. The page must collect the customer&#39;s explicit and informed consent, and it must accurately reflect the key details of the consent (payee, the maximum amount per payment, payment frequency, etc.) </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-e501cb8f> The examples and interactive wireframes provided below define the expected structure, content, and behavior of the Authorization Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-e501cb8f> While you may adapt visual elements such as color palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the payment information shown. The representation of <strong data-v-e501cb8f>AlTareq</strong> (including logos, naming, and action buttons) must be preserved at all times. The customer must be able to clearly understand what payment they are authorizing and that the authorization is part of the AlTareq ecosystem. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-e501cb8f> Your Authorization Page must be submitted as part of <strong data-v-e501cb8f>CX certification</strong> prior to production. Any material changes to a production Authorization Page must also be resubmitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the request body fields below and watch the <strong data-v-e501cb8f${_scopeId2}>Consent</strong> and <strong data-v-e501cb8f${_scopeId2}>Authorisation</strong> page previews update live. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/variable-periodic-schedule/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e501cb8f"]]);
export {
