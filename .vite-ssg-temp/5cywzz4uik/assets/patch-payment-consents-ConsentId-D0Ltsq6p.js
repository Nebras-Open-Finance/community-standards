...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "patch-payment-consents-ConsentId",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/consent/open-api/patch-payment-consents-ConsentId.vue");
