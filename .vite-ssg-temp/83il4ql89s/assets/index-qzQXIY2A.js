...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-landing" }, _attrs))} data-v-1e4659e8><section class="ed-landing__hero" data-v-1e4659e8><div class="ed-landing__inner" data-v-1e4659e8><div class="ed-landing__eyebrow" data-v-1e4659e8><span class="ed-landing__eyebrow-dash" data-v-1e4659e8></span> Banking · LFI capability </div><h1 class="ed-landing__title" data-v-1e4659e8> Payments (Service Initiation) <span class="ed-landing__read" data-v-1e4659e8>2 min read</span></h1><p class="ed-landing__lede" data-v-1e4659e8>The Payment Service Initiation capabilities allow customers to authorise payments at their LFI which a TPP then submits within the bounds of that authorisation. Payment types range from one-time instant payments through to long-running multi-payment consents with variable amounts, schedules, or delegated authentication.</p></div></section><section class="ed-landing__role" data-v-1e4659e8><div class="ed-landing__inner" data-v-1e4659e8><div class="ed-landing__role-card" data-v-1e4659e8><div class="ed-landing__role-meta" data-v-1e4659e8><span class="ed-landing__role-tag" data-v-1e4659e8>Access control</span> Required role </div><div class="ed-landing__role-head" data-v-1e4659e8><span class="ed-landing__role-chip" data-v-1e4659e8>BSIP</span><h2 class="ed-landing__role-title" data-v-1e4659e8>Bank Service Initiation Provider</h2></div><p class="ed-landing__role-body" data-v-1e4659e8>Access to the Payment Service Initiation APIs requires TPPs to hold the <strong data-v-1e4659e8>BSIP</strong> role. The API Hub validates the role on every request before proxying it to the LFI. If the consent also includes data-sharing permissions (<code data-v-1e4659e8>ReadAccountsBasic</code>, <code data-v-1e4659e8>ReadAccountsDetail</code>, <code data-v-1e4659e8>ReadBalances</code>), TPPs additionally require the <strong data-v-1e4659e8>BDSP</strong> role.</p></div></div></section><section class="ed-landing__live" data-v-1e4659e8><div class="ed-landing__inner" data-v-1e4659e8><div class="ed-landing__live-head" data-v-1e4659e8><div class="ed-landing__live-eyebrow" data-v-1e4659e8><span class="ed-landing__eyebrow-dash" data-v-1e4659e8></span> Live ecosystem </div><h2 class="ed-landing__live-title" data-v-1e4659e8>Who&#39;s initiating Payments</h2><p class="ed-landing__live-sub" data-v-1e4659e8>TPPs currently submitting payments across UAE Open Finance.</p></div>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {
        placeholder: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-landing__live-grid" data-v-1e4659e8${_scopeId}><!--[-->`);
            ssrRenderList(4, (i) => {
              _push2(`<div class="ed-landing__tpp ed-landing__tpp--skel" data-v-1e4659e8${_scopeId}></div>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            if (unref(liveTpps).length) {
              ...
              ssrRenderList(unref(liveTpps), (tpp) => {
                _push2(`<a class="ed-landing__tpp"${ssrRenderAttr("title", tpp.legalName)} href="/program/whats-live?type=tpp&amp;family=payment" data-v-1e4659e8${_scopeId}><div class="ed-landing__tpp-logo" data-v-1e4659e8${_scopeId}>`);
                if (tpp.logoUri) {
                  _push2(`<img${ssrRenderAttr("src", tpp.logoUri)}${ssrRenderAttr("alt", tpp.legalName)} data-v-1e4659e8${_scopeId}>`);
                } else {
                  _push2(`<span class="ed-landing__tpp-initials" data-v-1e4659e8${_scopeId}>${ssrInterpolate(initials(tpp.name))}</span>`);
                }
                _push2(`</div><div class="ed-landing__tpp-name" data-v-1e4659e8${_scopeId}>${ssrInterpolate(tpp.name)}</div></a>`);
              });
              _push2(`<!--]-->`);
              if (unref(totalTppCount) > unref(liveTpps).length) {
                _push2(`<a class="ed-landing__tpp ed-landing__tpp--more" href="/program/whats-live?type=tpp&amp;family=payment"${ssrRenderAttr("title", `See all ${unref(totalTppCount)} TPPs`)} data-v-1e4659e8${_scopeId}><span class="ed-landing__tpp-more-dots" data-v-1e4659e8${_scopeId}>…</span><span class="ed-landing__tpp-more-label" data-v-1e4659e8${_scopeId}>+${ssrInterpolate(unref(totalTppCount) - unref(liveTpps).length)} more</span></a>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            } else if (unref(loadError)) {
              _push2(`<p class="ed-landing__live-empty" data-v-1e4659e8${_scopeId}>Live data is currently unavailable.</p>`);
            } else {
              _push2(`<p class="ed-landing__live-empty" data-v-1e4659e8${_scopeId}>No TPPs are currently active for this capability.</p>`);
            }
            if (unref(totalTppCount) > 0) {
              _push2(`<a class="ed-landing__live-cta" href="/program/whats-live?type=tpp&amp;family=payment" data-v-1e4659e8${_scopeId}>`);
              if (unref(totalTppCount) > unref(liveTpps).length) {
                _push2(`<span data-v-1e4659e8${_scopeId}> See all ${ssrInterpolate(unref(totalTppCount))} TPPs in the live ecosystem </span>`);
              } else {
                _push2(`<span data-v-1e4659e8${_scopeId}>View in the live ecosystem dashboard</span>`);
              }
              _push2(`<span class="ed-landing__live-cta-arrow" aria-hidden="true" data-v-1e4659e8${_scopeId}>→</span></a>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`</div></section><section class="ed-landing__contents" data-v-1e4659e8><div class="ed-landing__inner" data-v-1e4659e8><div class="ed-landing__contents-head" data-v-1e4659e8><div class="ed-landing__contents-eyebrow" data-v-1e4659e8><span class="ed-landing__eyebrow-dash" data-v-1e4659e8></span> Section contents </div><h2 class="ed-landing__contents-title" data-v-1e4659e8>Browse this section</h2><p class="ed-landing__contents-sub" data-v-1e4659e8>The full set of pages for the Payments (Service Initiation) API.</p></div><div class="ed-cap-grid" data-v-1e4659e8><!--[-->`);
      ssrRenderList(cards, (card) => {
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(card.url ? "a" : "div"), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="ed-cap-card__top" data-v-1e4659e8${_scopeId}></span><div class="ed-cap-card__head" data-v-1e4659e8${_scopeId}><div class="ed-cap-card__meta" data-v-1e4659e8${_scopeId}><span class="ed-cap-card__meta-dot" data-v-1e4659e8${_scopeId}></span> ${ssrInterpolate(card.category)}</div><h3 class="ed-cap-card__title" data-v-1e4659e8${_scopeId}>${ssrInterpolate(card.title)}</h3><p class="ed-cap-card__desc" data-v-1e4659e8${_scopeId}>${ssrInterpolate(card.desc)}</p></div>`);
              if (card.subs.length) {
                _push2(`<ul class="ed-cap-card__subs" data-v-1e4659e8${_scopeId}><!--[-->`);
                ssrRenderList(card.subs, (sub) => {
                  _push2(`<li data-v-1e4659e8${_scopeId}><a${ssrRenderAttr("href", sub.url)} class="ed-cap-card__sub" data-v-1e4659e8${_scopeId}><span class="ed-cap-card__sub-marker" data-v-1e4659e8${_scopeId}></span><span class="ed-cap-card__sub-main" data-v-1e4659e8${_scopeId}><span class="ed-cap-card__sub-title" data-v-1e4659e8${_scopeId}>${ssrInterpolate(sub.title)}</span><span class="ed-cap-card__sub-hint" data-v-1e4659e8${_scopeId}>${ssrInterpolate(sub.hint)}</span></span><span class="ed-cap-card__sub-arrow" aria-hidden="true" data-v-1e4659e8${_scopeId}>→</span></a></li>`);
                });
                _push2(`<!--]--></ul>`);
              } else {
                _push2(`<!---->`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1e4659e8"]]);
export {
  index as default
};
