  ...
  sections: [
    {
      ...
      rules: [
        ...
        { field: '<code>QuoteType</code>', rule: 'Must be one of <code>New</code>, <code>Renewal</code>, or <code>Switch</code>. See <a href="/tech/lfi-api-hub/v2.2-draft/insurance/quotation/quote-types">Quote Types</a> for the per-type field requirements (<code>Renewal</code> references the prior policy; <code>Switch</code> references the incumbent insurer).', validatedBy: 'API Hub (schema) + LFI (logic)' },
