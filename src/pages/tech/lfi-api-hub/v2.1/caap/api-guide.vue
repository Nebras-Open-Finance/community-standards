  ...
  <div class="ed-doc">
    ...
    >
      <EdProse>
        ...
        see <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/ozone-connect-url">Ozone Connect Base URL</a>.
      </EdProse>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.1/caap/open-api/consent-actions-validate" class="endpoint"><span class="http-method http-method--post">POST</span><code>/consent/actions/validate</code></a></td>
            ...
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.1/caap/open-api/users-register-initialize" class="endpoint"><span class="http-method http-method--post">POST</span><code>/users/actions/register/initialize</code></a></td>
              <td>CAAP &rarr; LFI</td>
              <td>Identify the end user at the LFI from an encrypted Emirates ID; return the end user&apos;s LFI userId.</td>
            </tr>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.1/caap/open-api/users-register-complete" class="endpoint"><span class="http-method http-method--post">POST</span><code>/users/actions/register/complete</code></a></td>
              <td>CAAP &rarr; LFI</td>
              <td>Complete registration after the end user has answered the LFI&apos;s OTP challenge.</td>
            </tr>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.1/caap/open-api/accounts" class="endpoint"><span class="http-method http-method--get">GET</span><code>/accounts</code></a></td>
              <td>CAAP &rarr; LFI</td>
              <td>Return every account the end user can share or initiate from, depending on the use case.</td>
            </tr>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.1/caap/open-api/employment-insurance-policies" class="endpoint"><span class="http-method http-method--get">GET</span><code>/{type}-insurance-policies</code></a></td>
              <td>CAAP &rarr; LFI</td>
      ...
      <EdNote type="info" title="Hub-side endpoints CAAP calls">
        <p>
          CAAP also calls the API Hub&apos;s <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/">Headless Heimdall</a>
          and <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/">Consent Manager</a> at the end of the
    ...
    >
      <EdProse>
        ...
        <a href="/tech/tpp-standards/v2.1/consent/open-api/par" class="endpoint"><span class="http-method http-method--post">POST</span><code>/par</code></a>
        flow &mdash; including the API Hub&apos;s gating call to
        <a href="/tech/lfi-api-hub/v2.1/caap/open-api/consent-actions-validate" class="endpoint"><span class="http-method http-method--post">POST</span><code>/consent/actions/validate</code></a>
        on the LFI before the consent is created. See
        <a href="/tech/lfi-api-hub/v2.1/consent-journey/api-guide">Consent Journey &mdash; API Guide</a>
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.1/caap/open-api/users-register-initialize" class="endpoint"><span class="http-method http-method--post">POST</span><code>/users/actions/register/initialize</code></a>
      ...
      <EdProse>
        ...
        rules described in
        <a href="/tech/lfi-api-hub/v2.1/consent-journey/api-guide#identifier-requirements">Consent Journey &mdash; Identifier requirements</a>.
      </EdProse>
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.1/caap/open-api/users-register-complete" class="endpoint"><span class="http-method http-method--post">POST</span><code>/users/actions/register/complete</code></a>.
      </EdProse>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <a href="/tech/lfi-api-hub/v2.1/caap/open-api/accounts" class="endpoint"><span class="http-method http-method--get">GET</span><code>/accounts</code></a>
            ...
            <tr>
              ...
              <td>
                <a href="/tech/lfi-api-hub/v2.1/caap/open-api/employment-insurance-policies" class="endpoint"><span class="http-method http-method--get">GET</span><code>/{type}-insurance-policies</code></a>,
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.1/caap/user-experience#end-to-end">User Experience</a>
      ...
      <EdNote type="info" title="The LFI is no longer on the path">
        <p>
          ...
          the API Hub to the LFI&apos;s Ozone Connect endpoints (<a href="/tech/lfi-api-hub/v2.1/banking/data-sharing/">Bank Data Sharing</a>,
          <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/">Bank Service Initiation</a>,
          <a href="/tech/lfi-api-hub/v2.1/insurance/">Insurance Data Sharing</a>) as normal.
