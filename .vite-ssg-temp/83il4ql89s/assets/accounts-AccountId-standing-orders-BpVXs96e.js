...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_FieldMapEndpointPage, mergeProps({
    slug: "bank-data-sharing__accounts--id--standing-orders",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/banking/data-sharing/field-mapping/accounts-AccountId-standing-orders.vue");
