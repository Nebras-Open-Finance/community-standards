...
const bankingRows: BankingRow[] = [
  { folder: 'Data Sharing',                       href: '/tech/tpp-standards/v2.2-draft/banking/data-sharing/',          role: 'BDSP', desc: 'Consent lifecycle plus account, balance, transaction, beneficiary, standing order, and party data. Available in <code>application/json</code> and <code>application/jwt</code> formats.' },
  { folder: 'Service Initiation — Domestic',      href: '/tech/tpp-standards/v2.2-draft/banking/service-initiation/',    role: 'BSIP', desc: 'All <a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/#multi-payment-consents">payment consent types</a>: single instant (including CoP and multi-auth variants), all six multi-payment schedule types, delegated SCA, and refunds.' },
  { folder: 'Service Initiation — International', href: '/tech/tpp-standards/v2.2-draft/banking/service-initiation/',    role: 'BSIP', desc: 'Single instant and fixed periodic schedule for cross-border transfers.' },
  { folder: 'Confirmation of Payee',              href: '/tech/tpp-standards/v2.2-draft/banking/confirmation-of-payee/', role: 'BSIP', desc: 'Two-step name verification: discovery (API Hub) then confirmation (resolved LFI). Client credentials flow, <code>application/jwt</code> throughout.' },
  { folder: 'Products, Leads',                    href: '/tech/tpp-standards/v2.2-draft/banking/products-leads/',        role: 'BDSP', desc: 'Open data endpoints — no user consent required.' },
  { folder: 'ATMs',                               href: '/tech/tpp-standards/v2.2-draft/banking/atms/',                  role: 'BDSP', desc: 'ATM location and service data published by LFIs. No user consent required.' },
  { folder: 'Webhooks',                           href: '/tech/tpp-standards/v2.2-draft/webhooks/',                       role: '—',    desc: 'Simulate JWE-encrypted event receipt and <code>202 Accepted</code> response.' },
]
    ...
    <section class="pg__hero">
      <div class="pg__inner">
        ...
        <p class="pg__lede">
          ...
          from the <a href="/tech/tpp-standards/v2.2-draft/getting-started/">Getting Started</a> page.
        </p>
      </div>
    </section>
