...
const scaValidateTabs          = [{ label: 'Node.js', lang: 'typescript', code: scaValidateNode },          { label: 'Python', lang: 'python', code: scaValidatePython }] as const
...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          LFI &middot; Banking &middot; Service Initiation &middot; Multi-Payments &middot; Delegated SCA
        </div>
        <h1 class="ed-doc__title">
          Delegated SCA &mdash; API Guide
          <span class="ed-doc__read">18 min read</span>
        </h1>
        <p class="ed-doc__lede">
          ...
          as the primary rail with UAEFTS as the fallback. This guide covers the Ozone Connect endpoints
          your LFI MUST implement so the Hub can serve every payment under the consent from creation
          through to execution and status retrieval.
        </p>
        <p class="ed-doc__lede">
          ...
          <a href="./requirements">Delegated SCA Requirements</a>. This guide covers the request and
          response shape of each endpoint, with code walkthroughs for the parts that need them:
          decrypting the PII, validating the creditor list (or confirming it is open), matching the
          payment-time PII against the consent, validating the delegated authentication assertion, and
          applying the duplicate-in-flight check that is specific to on-demand consent types.
        </p>
      </div>
    </section>
    ...
    <EdSectionBand
      ...
      tone="cream"
    >
      <EdProse>Before implementing Delegated SCA, ensure the following are in place:</EdProse>
      ...
      <EdBullets>
        ...
        <li>
          ...
          LFI's
          <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/#enc1-encryption-key">Enc1 public key</a>.
        ...
        <li>
          <strong>Delegated SCA beneficiary models advertised</strong> &mdash; For each beneficiary
          ...
          <code>ApiMetadata.DelegatedAuthentication.SingleBeneficiarySupported</code> (consents
          carrying exactly 1 creditor),
          <code>ApiMetadata.DelegatedAuthentication.MultipleBeneficiariesSupported</code> (consents
          carrying 2&ndash;10 creditors), and/or
          <code>ApiMetadata.DelegatedAuthentication.OpenBeneficiariesSupported</code> (consents that
    ...
    >
      ...
      <EdProse>
        ...
        <a href="./requirements#consent-validation">Delegated SCA Requirements &mdash; Consent Validation</a>.
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/api-guide/decrypt-pii">How to Decrypt PII</a>.
      </EdProse>

      <EdProse>
        The decrypted consent-time PII for a Delegated SCA consent &mdash; shown here in the
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/creditor#rejecting-an-invalid-consent">Rejecting an invalid consent</a>.
      </EdProse>
      ...
      <EdBullets>
        <li><strong>Single beneficiary</strong> &mdash; <code>Initiation.Creditor</code> is an array of exactly <strong>1</strong> entry (<code>ApiMetadata.DelegatedAuthentication.SingleBeneficiarySupported</code>)</li>
        <li><strong>Multiple beneficiaries</strong> &mdash; <code>Initiation.Creditor</code> is an array of <strong>2&ndash;10</strong> entries (<code>ApiMetadata.DelegatedAuthentication.MultipleBeneficiariesSupported</code>)</li>
        <li><strong>Open beneficiaries</strong> &mdash; <code>Initiation.Creditor</code> is <strong>omitted</strong> entirely (<code>ApiMetadata.DelegatedAuthentication.OpenBeneficiariesSupported</code>). The creditor is supplied and validated at payment time &mdash; see <a href="#open-beneficiary">Validating an open-beneficiary creditor at payment time</a></li>
      </EdBullets>
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/debtor-account">Debtor Account</a>.
      </EdProse>
      ...
      <EdProse>
        See
        <a href="/tech/lfi-api-hub/v2.2-rc1/consent-events/api-guide#validate-post-consent-action-validate">Consent Events &amp; Actions &mdash; API Guide</a>
    ...
    >
      ...
      <EdProse>
        The Hub does <strong>not</strong> decrypt or inspect the PII, and it does <strong>not</strong>
        validate the delegated-SCA authentication assertion carried in
        <code>Risk.DebtorIndicators.Authentication</code>. Re-validating the PII, matching it against
        the consent, and verifying the SCA assertion at payment time are all the LFI's responsibility.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        ...
        time the TPP submits a payment under an authorized Delegated SCA consent. Your LFI MUST decrypt
        and validate the PII, match it against the consent's creditor list (or validate the
        freshly-supplied creditor for open-beneficiary consents), verify the delegated-SCA assertion in
        <code>Risk.DebtorIndicators.Authentication</code>, run the synchronous validations listed in
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>paymentType</code></td><td>string</td><td>Yes</td><td>The payment type. MUST be <code>cbuae-payment</code> for domestic Delegated SCA</td></tr>
            ...
            <tr><td><code>requestHeaders</code></td><td>object</td><td>Yes</td><td>The complete set of HTTP headers the TPP sent to the API Hub. The TPP's FAPI headers live here &mdash; both <code>x-fapi-auth-date</code> and <code>x-fapi-customer-ip-address</code> MUST be present</td></tr>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>PersonalIdentifiableInformation</code></td><td>string</td><td>Yes</td><td>Encrypted PII payload as a JWE compact string. Carries the creditor and the <code>Risk.DebtorIndicators.Authentication</code> block &mdash; required whether the consent fixed a list or left beneficiaries open &mdash; see <a href="#read-pii">Reading the PII at payment time</a></td></tr>
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments">POST <code>/payments</code> API Reference</a>.
      </EdProse>
      ...
      <EdProse>
        ...
        fails (missing required field &mdash; including <code>Risk.DebtorIndicators.Authentication</code>
        for Delegated SCA &mdash; wrong type, or additional property), reject with
        <code>400 Body.InvalidFormat</code>.
      </EdProse>

      <EdProse>A decrypted payment-time PII for Delegated SCA looks like:</EdProse>
      ...
      <EdProse>
        The full rule set &mdash; <code>Method</code> values, required <code>Factors</code>,
        <code>AuthenticatedAt</code> freshness window, <code>AssertionId</code> uniqueness &mdash; is
        in
        <a href="./requirements#authentication-validation">Delegated SCA Requirements &mdash; Authentication Validation</a>.
        The check has four parts:
      </EdProse>
      <EdBullets>
        <li><strong>Method</strong> &mdash; MUST be <code>MFA</code>. Any other value &rarr; <code>400 Consent.FailsControlParameters</code></li>
        <li><strong>Factors</strong> &mdash; MUST list at least two distinct SCA categories from <code>Knowledge</code>, <code>Possession</code>, <code>Inherence</code></li>
        <li><strong>AuthenticatedAt freshness</strong> &mdash; MUST be within 5 minutes of the current server time. Stale assertions &rarr; <code>400 Consent.FailsControlParameters</code>. This MUST also be consistent with the <code>x-fapi-auth-date</code> FAPI header</li>
        <li><strong>AssertionId</strong> &mdash; MUST be present, and MUST not have been seen under this <code>consentId</code> before (replay prevention). A duplicate &rarr; <code>400 Consent.FailsControlParameters</code></li>
      </EdBullets>

      <EdCodeGroup :tabs="scaValidateTabs" />
      ...
      <EdProse>
        Per
        <a href="./requirements#post-payments-payment-execution">POST <code>/payments</code> Requirements</a>
        rule 2, Delegated SCA splits into two flows at payment time depending on whether the consent
      ...
      <EdProse>
        Per
        <a href="./requirements#post-payments-payment-execution">POST <code>/payments</code> Requirements</a>
        rule 6, Delegated SCA payments are subject to a duplicate-in-flight check that on-demand
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments">POST <code>/payments</code> OpenAPI schema</a>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>Consent.FailsControlParameters</code></td><td>The payment-time creditor does not match any entry on a fixed-list consent, fails open-beneficiary creditor validation, or the delegated-SCA assertion fails method / factor / freshness / replay checks</td></tr>
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/payment-log">PATCH <code>/payment-log/:id</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments-PaymentId">GET <code>/payments/{paymentId}</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
  </div>
