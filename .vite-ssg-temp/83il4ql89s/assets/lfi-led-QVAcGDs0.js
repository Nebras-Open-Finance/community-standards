...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-62c6c155><section class="ed-doc__hero" data-v-62c6c155><div class="ed-doc__inner" data-v-62c6c155><div class="ed-doc__eyebrow" data-v-62c6c155><span class="ed-doc__eyebrow-dash" data-v-62c6c155></span> LFI · Insurance · Quotation · LFI-Led </div><h1 class="ed-doc__title" data-v-62c6c155> LFI-Led Flow <span class="ed-doc__read" data-v-62c6c155>5 min read</span></h1><p class="ed-doc__lede" data-v-62c6c155> The TPP creates a quote and hands the customer to your LFI on accept. Your LFI hosts customer verification, payment, and document delivery; the TPP’s only role after acceptance is to observe lifecycle events through the quote-log. </p></div></section>`);
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-62c6c155${_scopeId}>QuoteId minting</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Mint a unique <code data-v-62c6c155${_scopeId2}>QuoteId</code> per quote — UUIDv4 is recommended. Persist it for at least the policy retention period of the sector. The <code data-v-62c6c155${_scopeId2}>QuoteId</code> threads the rest of the lifecycle: TPP retrievals, the accept PATCH, policy creation, and every status event you emit to the quote-log. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` For LFI-Led mode, respond <code data-v-62c6c155${_scopeId2}>204 No Content</code>. You are signalling: the TPP has done its part; the LFI will drive everything from here. Then immediately PATCH the quote-log with <code data-v-62c6c155${_scopeId2}>ApplicationPending</code> so the TPP (subscribed or polling) sees the application has been registered. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-62c6c155${_scopeId2}> The <code data-v-62c6c155${_scopeId2}>Subscription.Webhook</code> object on the PATCH body is consumed by the Hub for its own event delivery to the TPP. Your LFI MUST NOT act on it — just emit quote-log status updates as normal, and the Hub fans them out. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" The "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` After PATCH Accept, your LFI presents the customer with the quote summary, KYC capture, and payment screens. These are entirely under your control — the Hub is not in the loop. See the <a href="../user-journeys" data-v-62c6c155${_scopeId2}>User Journeys</a> page for the screens you typically host. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Once your hosted flow completes (KYC passed, payment confirmed), the TPP calls POST to create the policy. In LFI-Led mode the body is minimal — just the originating <code data-v-62c6c155${_scopeId2}>QuoteId</code>: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Run your standard policy issuance. Return <code data-v-62c6c155${_scopeId2}>201 Created</code>. The <code data-v-62c6c155${_scopeId2}>InsurancePolicyId</code> is delivered to the TPP via the <code data-v-62c6c155${_scopeId2}>PolicyIssued</code> event, not in this response body — this keeps the API symmetric with TPP-Led mode. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Emit a Pending Completion event carrying the issued policy reference. In LFI-Led mode the documents stay with your LFI (you have already delivered them to the customer via your hosted screens), so only the <code data-v-62c6c155${_scopeId2}>InsurancePolicyId</code> is needed. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/insurance/quotation/api-guide/lfi-led.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const lfiLed = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-62c6c155"]]);
export {
  lfiLed as default
};
