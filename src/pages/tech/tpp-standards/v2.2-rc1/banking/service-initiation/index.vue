...
<template>
  <div class="ed-landing">
    ...
    <p class="ed-landing__role-body">Delegated SCA is a variant of multi-payment consent where Strong Customer Authentication is performed by the TPP rather than the LFI. This enables a frictionless in-app payment experience &mdash; the customer authenticates once within the TPP's interface, and the LFI accepts that authentication for subsequent payments. Delegated SCA requires the TPP to hold an explicit delegation from the LFI and is subject to additional requirements. See <a href="/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/delegated-sca/requirements">Delegated SCA</a> for details.</p>
      </div>
    </section>
