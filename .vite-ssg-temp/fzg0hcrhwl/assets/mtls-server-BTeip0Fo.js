...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-884d2ee6><section class="ed-doc__hero" data-v-884d2ee6><div class="ed-doc__inner" data-v-884d2ee6><div class="ed-doc__eyebrow" data-v-884d2ee6><span class="ed-doc__eyebrow-dash" data-v-884d2ee6></span> LFI · API Hub · Onboarding · Configuring Auth </div><h1 class="ed-doc__title" data-v-884d2ee6> Configuring Inbound mTLS <span class="ed-doc__read" data-v-884d2ee6>5 min read</span></h1><p class="ed-doc__lede" data-v-884d2ee6> This page describes how the LFI MUST configure inbound mutual TLS (mTLS) on its Ozone Connect server so that calls from the API Hub are authenticated and all other calls are rejected. </p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Every request the API Hub sends to the LFI is a mutual TLS connection in which the API Hub presents the <strong data-v-884d2ee6${_scopeId2}>C4</strong> transport client certificate. The LFI&#39;s Ozone Connect server — or whichever component terminates TLS in front of it (reverse proxy, load balancer, WAF, API gateway) — MUST be configured to: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Require</strong> a client certificate on every inbound connection, and</li><li data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Trust</strong> certificates signed by the Trust Framework Issuing CA for the relevant environment.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-884d2ee6${_scopeId2}>If the server accepts connections that do not present a client certificate, unauthenticated callers reach Ozone Connect endpoints — a critical security failure.</li><li data-v-884d2ee6${_scopeId2}>If the server&#39;s default trust store is used (operating system CA bundle, public Web PKI roots), the Trust Framework roots are not present and <strong data-v-884d2ee6${_scopeId2}>every</strong> API Hub call is rejected at the handshake.</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-884d2ee6${_scopeId2}> The API Hub does not terminate TLS on the LFI&#39;s behalf for the API Hub → Ozone Connect leg. Ozone Connect is the party that validates the API Hub&#39;s C4 client certificate. LFIs sometimes assume the Hub handles all mTLS — it does not. </p>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Production</strong> API Hub → <strong data-v-884d2ee6${_scopeId2}>Production</strong> Trust Framework</li><li data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Pre-production</strong> API Hub → <strong data-v-884d2ee6${_scopeId2}>Sandbox</strong> Trust Framework</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 data-v-884d2ee6${_scopeId}>Production</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The Production API Hub uses certificates issued by the <strong data-v-884d2ee6${_scopeId2}>Production Trust Framework</strong>. Its CAs are below. `);
                } else {
                  return [
            ...
            _push2(`<h4 data-v-884d2ee6${_scopeId}>Root CA</h4>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-884d2ee6${_scopeId2}><thead data-v-884d2ee6${_scopeId2}><tr data-v-884d2ee6${_scopeId2}><th data-v-884d2ee6${_scopeId2}>Field</th><th data-v-884d2ee6${_scopeId2}>Value</th></tr></thead><tbody data-v-884d2ee6${_scopeId2}><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Distinguished Name</strong></td><td data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>C=AE, O=Nebras Open Finance Company, OU=Al Tareq Trust Framework, CN=Al Tareq Production Trust Framework Root CA - G1</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>PEM</strong></td><td data-v-884d2ee6${_scopeId2}><a href="https://crl.pki.openfinance.ae/root-ca.pem" data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>https://crl.pki.openfinance.ae/root-ca.pem</code></a></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Algorithm</strong></td><td data-v-884d2ee6${_scopeId2}>RSA 2048, signed with <code data-v-884d2ee6${_scopeId2}>sha512WithRSAEncryption</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Valid from</strong></td><td data-v-884d2ee6${_scopeId2}>2024-10-01</td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Valid until</strong></td><td data-v-884d2ee6${_scopeId2}>2039-09-28</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h4 data-v-884d2ee6${_scopeId}>Issuing CA</h4>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-884d2ee6${_scopeId2}><thead data-v-884d2ee6${_scopeId2}><tr data-v-884d2ee6${_scopeId2}><th data-v-884d2ee6${_scopeId2}>Field</th><th data-v-884d2ee6${_scopeId2}>Value</th></tr></thead><tbody data-v-884d2ee6${_scopeId2}><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Distinguished Name</strong></td><td data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>C=AE, O=Nebras Open Finance Company, OU=Al Tareq Trust Framework, CN=Al Tareq Production Trust Framework Issuing CA - G1</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Issued by</strong></td><td data-v-884d2ee6${_scopeId2}>Al Tareq Production Trust Framework Root CA - G1</td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>PEM</strong></td><td data-v-884d2ee6${_scopeId2}><a href="https://crl.pki.openfinance.ae/issuer-ca.pem" data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>https://crl.pki.openfinance.ae/issuer-ca.pem</code></a></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>OCSP responder</strong></td><td data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>http://ocsp.pki.openfinance.ae</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>CRL distribution point</strong></td><td data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>http://crl.pki.openfinance.ae/issuer.crl</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Algorithm</strong></td><td data-v-884d2ee6${_scopeId2}>RSA 2048, signed with <code data-v-884d2ee6${_scopeId2}>sha512WithRSAEncryption</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Valid from</strong></td><td data-v-884d2ee6${_scopeId2}>2024-10-01</td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Valid until</strong></td><td data-v-884d2ee6${_scopeId2}>2034-09-29</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 data-v-884d2ee6${_scopeId}>Pre-production</h3><h4 data-v-884d2ee6${_scopeId}>Root CA</h4>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-884d2ee6${_scopeId2}><thead data-v-884d2ee6${_scopeId2}><tr data-v-884d2ee6${_scopeId2}><th data-v-884d2ee6${_scopeId2}>Field</th><th data-v-884d2ee6${_scopeId2}>Value</th></tr></thead><tbody data-v-884d2ee6${_scopeId2}><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Distinguished Name</strong></td><td data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>C=AE, O=Nebras Open Finance Company, OU=Al Tareq Trust Framework, CN=Al Tareq Sandbox Trust Framework Root CA - G1</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>PEM</strong></td><td data-v-884d2ee6${_scopeId2}><a href="https://crl.sandbox.pki.openfinance.ae/root-ca.pem" data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>https://crl.sandbox.pki.openfinance.ae/root-ca.pem</code></a></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Algorithm</strong></td><td data-v-884d2ee6${_scopeId2}>RSA 2048, signed with <code data-v-884d2ee6${_scopeId2}>sha512WithRSAEncryption</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Valid from</strong></td><td data-v-884d2ee6${_scopeId2}>2024-08-22</td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Valid until</strong></td><td data-v-884d2ee6${_scopeId2}>2039-08-19</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-884d2ee6${_scopeId2}><thead data-v-884d2ee6${_scopeId2}><tr data-v-884d2ee6${_scopeId2}><th data-v-884d2ee6${_scopeId2}>Field</th><th data-v-884d2ee6${_scopeId2}>Value</th></tr></thead><tbody data-v-884d2ee6${_scopeId2}><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Distinguished Name</strong></td><td data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>C=AE, O=Nebras Open Finance Company, OU=Al Tareq Trust Framework, CN=Al Tareq Sandbox Trust Framework Issuing CA - G1</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Issued by</strong></td><td data-v-884d2ee6${_scopeId2}>Al Tareq Sandbox Trust Framework Root CA - G1</td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>PEM</strong></td><td data-v-884d2ee6${_scopeId2}><a href="https://crl.sandbox.pki.openfinance.ae/issuer-ca.pem" data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>https://crl.sandbox.pki.openfinance.ae/issuer-ca.pem</code></a></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>OCSP responder</strong></td><td data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>http://ocsp.sandbox.pki.openfinance.ae</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>CRL distribution point</strong></td><td data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>http://crl.sandbox.pki.openfinance.ae/issuer.crl</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Algorithm</strong></td><td data-v-884d2ee6${_scopeId2}>RSA 2048, signed with <code data-v-884d2ee6${_scopeId2}>sha512WithRSAEncryption</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Valid from</strong></td><td data-v-884d2ee6${_scopeId2}>2024-08-22</td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Valid until</strong></td><td data-v-884d2ee6${_scopeId2}>2034-08-20</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Trust the Trust Framework CA bundle</strong> so the handshake accepts C4 and is rejected for anything not signed by the Trust Framework.</li><li data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Pin the connection to the API Hub&#39;s C4 client</strong> so that a certificate signed by the same Trust Framework — but belonging to a different participant — cannot reach your endpoints.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(`<h3 id="trust-ca-bundle" data-v-884d2ee6${_scopeId}>3a. Trust the CA bundle</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Assemble a single PEM bundle containing the <strong data-v-884d2ee6${_scopeId2}>Issuing CA</strong> first, then the <strong data-v-884d2ee6${_scopeId2}>Root CA</strong>. This bundle is what your TLS-terminating component loads as its trusted client-CA file. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<p data-v-884d2ee6${_scopeId2}>For Production, fetch the equivalent files from <code data-v-884d2ee6${_scopeId2}>https://crl.pki.openfinance.ae/</code>.</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Configure the component that terminates TLS in front of Ozone Connect to <strong data-v-884d2ee6${_scopeId2}>require</strong> a client certificate and to validate it against this bundle. The LFI is responsible for mapping the requirement to their own infrastructure — common patterns include: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-884d2ee6${_scopeId2}><thead data-v-884d2ee6${_scopeId2}><tr data-v-884d2ee6${_scopeId2}><th data-v-884d2ee6${_scopeId2}>Platform</th><th data-v-884d2ee6${_scopeId2}>Configuration surface</th></tr></thead><tbody data-v-884d2ee6${_scopeId2}><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>nginx</strong></td><td data-v-884d2ee6${_scopeId2}><code data-v-884d2ee6${_scopeId2}>ssl_client_certificate</code> (path to the bundle) and <code data-v-884d2ee6${_scopeId2}>ssl_verify_client on</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>AWS Network Load Balancer / API Gateway</strong></td><td data-v-884d2ee6${_scopeId2}>Trust store referencing the bundle, with <code data-v-884d2ee6${_scopeId2}>MutualAuthentication = verify</code></td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Google Cloud Load Balancing</strong></td><td data-v-884d2ee6${_scopeId2}>Backend service client TLS policy with a server-side TLS trust configuration</td></tr><tr data-v-884d2ee6${_scopeId2}><td data-v-884d2ee6${_scopeId2}><strong data-v-884d2ee6${_scopeId2}>Azure Application Gateway</strong></td><td data-v-884d2ee6${_scopeId2}>Trusted client CA certificate on the listener, with client-authentication enabled</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-884d2ee6${_scopeId2}> The Trust Framework roots are <strong data-v-884d2ee6${_scopeId2}>private</strong> — they are not present in operating-system or browser trust stores. Your component MUST be configured with the Trust Framework bundle explicitly. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Once the bundle is in place, the API Hub&#39;s C4 certificate will validate on every inbound call. The handshake will now also validate <strong data-v-884d2ee6${_scopeId2}>any</strong> other Trust Framework participant&#39;s certificate — which is what section 3b addresses. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The subject of the C4 certificate contains the Ozone organisation&#39;s identifier in its <code data-v-884d2ee6${_scopeId2}>OU</code>. Ozone provides this identifier as part of <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/#c4-transport-client-certificate" data-v-884d2ee6${_scopeId2}>environment-specific onboarding</a> — the JWKS URL and KID for C4 are supplied by Ozone on the Service Desk ticket; the OU of the certificate in that keystore is the value to pin against. `);
                } else {
                  return [
                    ...
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/#c4-transport-client-certificate" }, "environment-specific onboarding"),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Most reverse proxies expose the client-certificate subject as a variable during the request — for example, nginx exposes <code data-v-884d2ee6${_scopeId2}>$ssl_client_s_dn</code>. The LFI rejects any request whose client certificate subject <code data-v-884d2ee6${_scopeId2}>OU</code> does not equal the documented Ozone organisation OU. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Pinning by the C4 leaf certificate&#39;s SHA-256 fingerprint is <strong data-v-884d2ee6${_scopeId2}>not</strong> required. The OU pin above is sufficient and survives C4 rotation without any LFI-side configuration change. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Ozone verifies both layers of your inbound mTLS configuration end-to-end as part of <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/#connectivity-validation" data-v-884d2ee6${_scopeId2}>Connectivity Validation</a>. The API Hub is only considered set up for an environment once <strong data-v-884d2ee6${_scopeId2}>both</strong> of the following are exercised successfully: `);
                } else {
                  return [
                    createTextVNode(" Ozone verifies both layers of your inbound mTLS configuration end-to-end as part of "),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/#connectivity-validation" }, "Connectivity Validation"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/configuring-authentication/mtls-server.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const mtlsServer = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-884d2ee6"]]);
export {
