...
| **ISP**<br/>*Insurance Service Provider* | Assigned to insurers offering insurance data sharing services. Used to test insurance data flows as a TPP. | `client_credentials`<br/>`authorization_code`<br/>`refresh_token` |
