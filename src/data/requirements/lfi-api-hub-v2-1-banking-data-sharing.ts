      ...
      blocks: [
        { kind: 'table', table: {
          ...
          rows: [
            ...
            { cells: ['9', 'Account access', 'Validate that the account in the <code>accountId</code> path parameter is held by the PSU resolved from <code>o3-psu-identifier</code>. Apply the <a href="#account-access-validation">Account Access Validation</a> check before status handling — a non-held account MUST return <code>403</code> with <code>errorCode</code>: <code>Consent.PermanentAccountAccessFailure</code>.'] },
