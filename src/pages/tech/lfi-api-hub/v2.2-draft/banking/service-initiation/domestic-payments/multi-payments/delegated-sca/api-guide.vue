    ...
    >
      ...
      <EdBullets>
        <li>
          ...
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/">environment-specific configuration</a>
          is complete.
        </li>
        <li>
          <strong>Enc1 key pair generated and registered</strong> &mdash; The TPP encrypts PII to your
          LFI's
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/#enc1-encryption-key">Enc1 public key</a>.
