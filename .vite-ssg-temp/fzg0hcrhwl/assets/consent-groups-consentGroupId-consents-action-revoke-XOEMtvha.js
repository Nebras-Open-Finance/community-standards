    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_RedocWrapper, {
          ...
          filterMethod: "post",
          overrideServers: [{ url: "https://cm.[LFICODE].apihub.openfinance.ae" }, { url: "https://cm.[LFICODE].preprod.apihub.openfinance.ae" }]
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/consent-groups-consentGroupId-consents-action-revoke.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const consentGroupsConsentGroupIdConsentsActionRevoke = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  consentGroupsConsentGroupIdConsentsActionRevoke as default
};
