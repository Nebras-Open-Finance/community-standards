...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          TPP · Trust Framework · Keys & Certificates
        </div>
    ...
    >
      ...
      <h3>3. Encryption Certificate &mdash; Optional <em>(required for participants subscribing to receive events)</em></h3>
      <EdProse>Used to <strong>encrypt data</strong> such as an event.</EdProse>
      <EdBullets>
        <li><strong>Purpose:</strong> Ensuring only your application can read sensitive data</li>
        <li><strong>Usage:</strong> Decrypting encrypted responses</li>
      </EdBullets>

      <EdProse>
        Each certificate plays a critical role in securing communication, asserting identity, and
        protecting data in transit. Once you understand the different certificate types, you can generate
        the required keys and CSRs according to the Trust Framework specifications.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/tpp-standards/trust-framework/creating-an-application#your-client-id">Creating an Application</a>).
    ...
    >
      <ol class="ed-doc__steps">
        ...
        <li>
          ...
          <ol class="ed-doc__substeps">
            <li>Select the type of certificate you want to generate: <strong>Transport</strong>, <strong>Signing</strong>, or <strong>Encryption</strong>. You will need to repeat this process for each type.</li>
          </ol>
          <ClientOnly>
    ...
    >
      ...
      <EdProse>
        You will need a separate <code>kid</code> for each certificate type (Transport, Signing,
        Encryption). When signing JWTs, always use the <code>kid</code> of your <strong>Signing</strong>
        certificate.
      </EdProse>
    </EdSectionBand>
  </div>
