  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.config.component === "volume") {
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "chart-card" }, _attrs))} data-v-393044a8><div class="chart-card__title" data-v-393044a8>${ssrInterpolate(__props.config.title)}</div><div class="chart-card__meta" data-v-393044a8>${ssrInterpolate(unref(avgErrorRate))}% avg error rate</div><div class="chart-card__canvas" data-v-393044a8><canvas data-v-393044a8></canvas></div></div>`);
      } else if (__props.config.component === "error-codes") {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "chart-card" }, _attrs))} data-v-393044a8><div class="chart-card__title" data-v-393044a8>${ssrInterpolate(__props.config.title)}</div><div class="chart-card__canvas" data-v-393044a8><canvas data-v-393044a8></canvas></div></div>`);
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "chart-card" }, _attrs))} data-v-393044a8><div class="chart-card__title" data-v-393044a8>${ssrInterpolate(__props.config.title)}</div><div class="ranked-list" data-v-393044a8><!--[-->`);
        ssrRenderList(unref(slowestEndpoints), (item, idx) => {
          _push(`<div class="ranked-row" data-v-393044a8><span class="rank-num" data-v-393044a8>${ssrInterpolate(String(idx + 1).padStart(2, "0"))}</span><div class="rank-content" data-v-393044a8><div class="rank-top" data-v-393044a8><span class="rank-label" data-v-393044a8>${ssrInterpolate(item.endpoint)}</span><span class="rank-value" data-v-393044a8>${ssrInterpolate(item.avgMs)}ms</span></div><div class="rank-bar-track" data-v-393044a8><div class="rank-bar-fill" style="${ssrRenderStyle({ width: `${item.avgMs / unref(topRankedAvgMs) * 100}%` })}" data-v-393044a8></div></div></div></div>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
...
const __unplugin_components_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-393044a8"]]);
const SECTORS = [
