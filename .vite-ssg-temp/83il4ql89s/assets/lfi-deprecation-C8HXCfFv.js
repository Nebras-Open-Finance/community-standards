...
import { _ as __unplugin_components_6$1 } from "./EdExample-CVSw4jQj.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-5d0140d6>`);
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-5d0140d6${_scopeId}>When dual-running does not apply</h3>`);
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-5d0140d6${_scopeId2}><strong data-v-5d0140d6${_scopeId2}>Minor (non-breaking) API version updates</strong></li><li data-v-5d0140d6${_scopeId2}><strong data-v-5d0140d6${_scopeId2}>Errata or corrective changes</strong></li><li data-v-5d0140d6${_scopeId2}><strong data-v-5d0140d6${_scopeId2}>UI components or presentation-layer changes</strong></li><li data-v-5d0140d6${_scopeId2}><strong data-v-5d0140d6${_scopeId2}>Downstream system or internal implementation changes</strong></li>`);
                } else {
                  return [
                    createVNode("li", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-5d0140d6${_scopeId}>How dual-running works</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-5d0140d6${_scopeId2}>Deploy two active versions of their API Hub implementation simultaneously (e.g. V1.x and V2.0)</li><li data-v-5d0140d6${_scopeId2}>Route incoming API requests to the correct implementation based on the version the TPP requested — currently via the <code data-v-5d0140d6${_scopeId2}>o3-api-uri</code> header</li><li data-v-5d0140d6${_scopeId2}>Ensure each implementation is independently maintained and supported, with no cross-version dependencies that could cause instability</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdExample, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-5d0140d6${_scopeId2}>An LFI running V1.2 and V2.1 simultaneously would route a request to <code data-v-5d0140d6${_scopeId2}>https://api.bank.ae/open-finance/v1.2/accounts</code> to the V1.2 implementation, and a request to <code data-v-5d0140d6${_scopeId2}>https://api.bank.ae/open-finance/v2.1/accounts</code> to the V2.1 implementation.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-5d0140d6${_scopeId3}><strong data-v-5d0140d6${_scopeId3}>Stand up the new version</strong> — The LFI deploys and validates the new major version of their API Hub implementation in production.</p><p data-v-5d0140d6${_scopeId3}><strong data-v-5d0140d6${_scopeId3}>Validate readiness</strong> — The LFI confirms the new version is functioning correctly, including end-to-end consent flows, data sharing, and service initiation (as applicable).</p><p data-v-5d0140d6${_scopeId3}><strong data-v-5d0140d6${_scopeId3}>Formal communication via Nebras</strong> — Nebras issues a formal ecosystem-wide communication informing all TPPs that the new version is available, that they are expected to begin migrating, and that the prior version will be deprecated in accordance with this policy.</p>`);
                      } else {
                        return [
                          createVNode("p", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-5d0140d6${_scopeId3}>From the date of the formal communication, LFIs must actively monitor the creation of new consents across both versions.</p><p data-v-5d0140d6${_scopeId3}>At the <strong data-v-5d0140d6${_scopeId3}>3-month mark</strong>, LFIs must report to Nebras on the status of TPP migration, specifically identifying any TPPs that are still raising new consents on the prior version. Nebras will use this information to engage directly with non-migrated TPPs.</p>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-5d0140d6${_scopeId3}>With Nebras approval, the LFI may <strong data-v-5d0140d6${_scopeId3}>restrict the creation of new consents</strong> on the prior version. This means:</p>`);
                        _push4(ssrRenderComponent(_component_EdBullets, { tight: "" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<li data-v-5d0140d6${_scopeId4}>Existing consents on the prior version remain valid and must continue to be honoured</li><li data-v-5d0140d6${_scopeId4}>No new consent journeys can be initiated against the prior version</li><li data-v-5d0140d6${_scopeId4}>TPPs with active consents on the prior version may continue to exercise those consents until they expire</li>`);
                            } else {
                              return [
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-5d0140d6${_scopeId3}>From the point at which new consent creation is restricted, the prior version must remain operational for a further <strong data-v-5d0140d6${_scopeId3}>12 months</strong>, providing sufficient time for all existing consents on the prior version to expire naturally.</p><p data-v-5d0140d6${_scopeId3}>After this 12-month period, and once Nebras confirms that no active consents remain on the prior version, the LFI may decommission the prior version entirely.</p>`);
                      } else {
                        return [
                          createVNode("p", null, [
            ...
            _push2(`<h3 data-v-5d0140d6${_scopeId}>Milestone summary</h3><div class="ed-milestones" data-v-5d0140d6${_scopeId}><!--[-->`);
            ssrRenderList(milestones, (m) => {
              _push2(`<div class="ed-milestone" data-v-5d0140d6${_scopeId}><span class="ed-milestone__stage" data-v-5d0140d6${_scopeId}>${ssrInterpolate(m.stage)}</span><span class="ed-milestone__label" data-v-5d0140d6${_scopeId}>${ssrInterpolate(m.label)}</span></div>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Where TPPs have not completed migration to the new version by the <strong data-v-5d0140d6${_scopeId2}>6-month mark</strong> from the date of formal communication, Nebras will take an active role in managing the deprecation.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-5d0140d6${_scopeId2}>Directly engaging with non-migrated TPPs to understand technical or operational blockers</li><li data-v-5d0140d6${_scopeId2}>Setting individual migration deadlines for non-migrated TPPs, with formal written notice</li><li data-v-5d0140d6${_scopeId2}>Escalating persistent non-compliance to the relevant regulatory authority where appropriate</li><li data-v-5d0140d6${_scopeId2}>Coordinating with the LFI to ensure migration support is available to affected TPPs</li><li data-v-5d0140d6${_scopeId2}>Retaining oversight of the LFI&#39;s deprecation timeline and adjusting it where necessary to protect TPPs and their customers</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-5d0140d6${_scopeId2}><strong data-v-5d0140d6${_scopeId2}>Incident management</strong> — Both API versions must be covered by the LFI&#39;s standard incident management and response procedures, with equivalent SLAs applied to both</li><li data-v-5d0140d6${_scopeId2}><strong data-v-5d0140d6${_scopeId2}>Monitoring and alerting</strong> — LFIs must maintain active monitoring across both API versions, including availability, error rates, and latency</li><li data-v-5d0140d6${_scopeId2}><strong data-v-5d0140d6${_scopeId2}>Change management</strong> — Any changes to either version during the dual-running period must be assessed for impact on the other version and communicated to Nebras in accordance with standard change management procedures</li><li data-v-5d0140d6${_scopeId2}><strong data-v-5d0140d6${_scopeId2}>TPP support</strong> — LFIs must be able to provide technical support to TPPs migrating between versions, including guidance on breaking changes and access to sandbox environments running both versions</li><li data-v-5d0140d6${_scopeId2}><strong data-v-5d0140d6${_scopeId2}>Consent data integrity</strong> — LFIs must ensure that consent records associated with the prior version are preserved and remain accessible for the full duration of those consents&#39; validity, regardless of the deprecation status of the API version</li>`);
                } else {
                  return [
                    createVNode("li", null, [
...
const lfiDeprecation = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5d0140d6"]]);
export {
