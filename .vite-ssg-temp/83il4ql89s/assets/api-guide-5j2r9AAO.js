...
import { _ as _sfc_main$1 } from "./APIFlowsConfirmationOfPayee-CYl8N-3d.js";
...
const discoveryResponse = await fetch(
  \`\${LFI_BASE_URL}/open-finance/confirmation-of-payee/v2.2/discovery\`,
  {
    method:  'POST',
    headers: {
...
discovery_response = httpx.post(
    f"{LFI_BASE_URL}/open-finance/confirmation-of-payee/v2.2/discovery",
    headers={
...
const copResponse = await fetch(
  \`\${ResourceServerUrl}/open-finance/confirmation-of-payee/v2.2/confirmation\`,
  {
    method:  'POST',
    headers: {
...
cop_response = httpx.post(
    f"{resource_server_url}/open-finance/confirmation-of-payee/v2.2/confirmation",
    headers={
        "Authorization":         f"Bearer {access_token}",
        "Content-Type":          "application/jwt",
        "Accept":                "application/jwt",
...
const decodedPayload = `{
  ...
  "message": {
    ...
    "Links": {
      "Self": "https://rs1.altareq1.sandbox.apihub.openfinance.ae/open-finance/confirmation-of-payee/v2.2/confirmation"
    },
    "Meta": {}
  }
}
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-66945252><section class="ed-doc__hero" data-v-66945252><div class="ed-doc__inner" data-v-66945252><div class="ed-doc__eyebrow" data-v-66945252><span class="ed-doc__eyebrow-dash" data-v-66945252></span> TPP · Banking · Confirmation of Payee </div><h1 class="ed-doc__title" data-v-66945252> Confirmation of Payee — API Guide <span class="ed-doc__read" data-v-66945252>4 min read</span></h1><p class="ed-doc__lede" data-v-66945252> Confirmation of Payee (CoP) lets a TPP verify that an IBAN belongs to the named individual or business before initiating a payment. Unlike payment flows, CoP does <strong data-v-66945252>not</strong> require user authorization — the TPP authenticates directly using a client credentials grant and the LFI responds with a match result in seconds. </p><p class="ed-doc__lede" data-v-66945252> CoP is served by each participating LFI independently. Before calling an LFI directly, the TPP first calls the API Hub&#39;s <strong data-v-66945252>discovery</strong> endpoint to identify which LFI holds the destination account and retrieve its endpoint URLs. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-66945252${_scopeId2}><strong data-v-66945252${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-66945252${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the <strong data-v-66945252${_scopeId2}>BSIP role</strong> as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-66945252${_scopeId2}>Roles</a>. </li><li data-v-66945252${_scopeId2}><strong data-v-66945252${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-66945252${_scopeId2}>Transport Certificate</a></strong> — an active transport certificate must be issued and registered in the Trust Framework to establish secure <strong data-v-66945252${_scopeId2}>mTLS communication</strong>. </li><li data-v-66945252${_scopeId2}><strong data-v-66945252${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-66945252${_scopeId2}>Signing Certificate</a></strong> — an active signing certificate must be issued and registered in the Trust Framework. This certificate is used to sign the confirmation request JWT and client assertions. </li><li data-v-66945252${_scopeId2}><strong data-v-66945252${_scopeId2}>Registration with the relevant <a href="/tech/tpp-standards/registration/api-guide" data-v-66945252${_scopeId2}>API Hub (Authorisation Server)</a></strong> — the application must be registered with the API Hub (Server) of the LFI that holds the destination account. </li><li data-v-66945252${_scopeId2}><strong data-v-66945252${_scopeId2}>Understanding of <a href="/tech/tpp-standards/security/tokens/" data-v-66945252${_scopeId2}>Tokens &amp; Assertions</a></strong> — you should understand how client authentication works with <code data-v-66945252${_scopeId2}>private_key_jwt</code> before calling the token endpoint. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` CoP is served by individual LFIs — the <code data-v-66945252${_scopeId2}>/discovery</code> endpoint resolves a payee IBAN to the correct LFI and returns two URLs you will need for the rest of the flow: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-66945252${_scopeId2}><thead data-v-66945252${_scopeId2}><tr data-v-66945252${_scopeId2}><th data-v-66945252${_scopeId2}>Field</th><th data-v-66945252${_scopeId2}>Description</th></tr></thead><tbody data-v-66945252${_scopeId2}><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>DiscoveryEndpointUrl</code></td><td data-v-66945252${_scopeId2}>The <code data-v-66945252${_scopeId2}>.well-known</code> endpoint for the LFI&#39;s Authorisation Server. Fetch this to obtain the <code data-v-66945252${_scopeId2}>token_endpoint</code> and <code data-v-66945252${_scopeId2}>issuer</code> used in later steps.</td></tr><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>ResourceServerUrl</code></td><td data-v-66945252${_scopeId2}>The base URL of the LFI&#39;s API Hub resource server. Use this as the base URL when calling <code data-v-66945252${_scopeId2}>/confirmation</code>.</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Before calling <code data-v-66945252${_scopeId2}>/discovery</code> you must obtain an access token from any LFI you are registered with using a client credentials grant. The API Hub does not make any requests to the LFI when processing <code data-v-66945252${_scopeId2}>/discovery</code> — it resolves the IBAN centrally — so the response is the same regardless of which LFI you authenticate with. You only need to perform discovery once, and the <span class="endpoint" data-v-66945252${_scopeId2}><span class="http-method http-method--post" data-v-66945252${_scopeId2}>POST</span><code data-v-66945252${_scopeId2}>/discovery</code></span> request must be sent to the LFI whose token you are using. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Use the <a href="/tech/tpp-standards/security/fapi/message-signing#signing-a-jwt" data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>signJWT()</code></a> helper to build a client assertion proving your application&#39;s identity: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/tokens/client-assertion" data-v-66945252${_scopeId2}>Client Assertion</a> for the full claims reference. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` POST to any LFI&#39;s token endpoint with <code data-v-66945252${_scopeId2}>scope=confirmation-of-payee</code>: `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-66945252${_scopeId}><span class="http-badge http-post" data-v-66945252${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-66945252${_scopeId}>/discovery</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Include <code data-v-66945252${_scopeId2}>x-fapi-interaction-id</code> on the request. See <a href="/tech/tpp-standards/security/request-headers" data-v-66945252${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="./open-api/discovery" data-v-66945252${_scopeId2}>POST /discovery</a> API reference for the full request and response schema. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Fetch the <code data-v-66945252${_scopeId2}>DiscoveryEndpointUrl</code> directly to read the LFI&#39;s OpenID configuration. This gives you the <code data-v-66945252${_scopeId2}>token_endpoint</code> and <code data-v-66945252${_scopeId2}>issuer</code> needed for the next steps: `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` POST to the token endpoint (resolved in Step 6) with <code data-v-66945252${_scopeId2}>scope=confirmation-of-payee</code>: `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-66945252${_scopeId}><span class="http-badge http-post" data-v-66945252${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-66945252${_scopeId}>/open-finance/confirmation-of-payee/v2.2/confirmation</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The confirmation request is sent as a <strong data-v-66945252${_scopeId2}>signed JWT</strong> (<code data-v-66945252${_scopeId2}>Content-Type: application/jwt</code>). Build the JWT payload containing the account details you want to verify, then sign it with your signing key. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-66945252${_scopeId}>Request payload fields</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-66945252${_scopeId2}><thead data-v-66945252${_scopeId2}><tr data-v-66945252${_scopeId2}><th data-v-66945252${_scopeId2}>Field</th><th data-v-66945252${_scopeId2}>Type</th><th data-v-66945252${_scopeId2}>Description</th><th data-v-66945252${_scopeId2}>Example</th></tr></thead><tbody data-v-66945252${_scopeId2}><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Data.SchemeName</code>*</td><td data-v-66945252${_scopeId2}>enum</td><td data-v-66945252${_scopeId2}>Account identifier type — always <code data-v-66945252${_scopeId2}>IBAN</code></td><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>IBAN</code></td></tr><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Data.Identification</code>*</td><td data-v-66945252${_scopeId2}>string</td><td data-v-66945252${_scopeId2}>The IBAN to verify</td><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>AE070331234567890123456</code></td></tr><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Data.Name.FullName</code>*</td><td data-v-66945252${_scopeId2}>string</td><td data-v-66945252${_scopeId2}>Full name of the account holder</td><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Ibrahim Al Suwaidi</code></td></tr><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Data.Name.GivenName</code></td><td data-v-66945252${_scopeId2}>string</td><td data-v-66945252${_scopeId2}>Given (first) name — individual accounts</td><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Ibrahim</code></td></tr><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Data.Name.LastName</code></td><td data-v-66945252${_scopeId2}>string</td><td data-v-66945252${_scopeId2}>Family name — individual accounts</td><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Al Suwaidi</code></td></tr><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Data.Name.BusinessName</code></td><td data-v-66945252${_scopeId2}>string</td><td data-v-66945252${_scopeId2}>Registered business name — use instead of personal name fields for business accounts</td><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Business Inc.</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-66945252${_scopeId2}> Provide <code data-v-66945252${_scopeId2}>GivenName</code> + <code data-v-66945252${_scopeId2}>LastName</code> for personal accounts, or <code data-v-66945252${_scopeId2}>BusinessName</code> for business accounts. Do not mix both. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-66945252${_scopeId}>Example payload (inside the JWT <code data-v-66945252${_scopeId}>message</code> claim)</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: examplePayload,
              lang: "json",
              filename: "message claim"
            }, null, _parent2, _scopeId));
            _push2(`<h3 class="ed-doc__subhead" data-v-66945252${_scopeId}>Signing the request</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Use the <a href="/tech/tpp-standards/security/fapi/message-signing#signing-a-jwt" data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>signJWT()</code></a> helper, wrapping the payload in a <code data-v-66945252${_scopeId2}>message</code> claim: `);
                } else {
                  return [
                    createTextVNode(" Use the "),
                    createVNode("a", { href: "/tech/tpp-standards/security/fapi/message-signing#signing-a-jwt" }, [
            ...
            return [
              createVNode("div", { class: "ed-doc__endpoint" }, [
                createVNode("span", { class: "http-badge http-post" }, "POST"),
                createVNode("code", { class: "ed-doc__endpoint-path" }, "/open-finance/confirmation-of-payee/v2.2/confirmation")
              ]),
              createVNode(_component_EdProse, null, {
                default: withCtx(() => [
                  createTextVNode(" The confirmation request is sent as a "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Send the signed JWT to the LFI&#39;s CoP endpoint using the <code data-v-66945252${_scopeId2}>ResourceServerUrl</code> resolved in Step 5. Both the request body and the response are JWTs. Include <code data-v-66945252${_scopeId2}>x-fapi-interaction-id</code> on every request. See <a href="/tech/tpp-standards/security/request-headers" data-v-66945252${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-66945252${_scopeId}>Response</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-66945252${_scopeId2}><thead data-v-66945252${_scopeId2}><tr data-v-66945252${_scopeId2}><th data-v-66945252${_scopeId2}>Field</th><th data-v-66945252${_scopeId2}>Type</th><th data-v-66945252${_scopeId2}>Description</th></tr></thead><tbody data-v-66945252${_scopeId2}><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Data.NameMatchIndicator</code></td><td data-v-66945252${_scopeId2}>string</td><td data-v-66945252${_scopeId2}>The result of the name match check — see enum below</td></tr><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>Data.MaskedName</code></td><td data-v-66945252${_scopeId2}>string</td><td data-v-66945252${_scopeId2}>The account holder&#39;s name, partially masked. Returned on <code data-v-66945252${_scopeId2}>ConfirmationOfPayee.Partial</code> and <code data-v-66945252${_scopeId2}>ConfirmationOfPayee.No</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-66945252${_scopeId2}><thead data-v-66945252${_scopeId2}><tr data-v-66945252${_scopeId2}><th data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>NameMatchIndicator</code></th><th data-v-66945252${_scopeId2}>Meaning</th></tr></thead><tbody data-v-66945252${_scopeId2}><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>ConfirmationOfPayee.Yes</code></td><td data-v-66945252${_scopeId2}>Name and account match — safe to proceed</td></tr><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>ConfirmationOfPayee.Partial</code></td><td data-v-66945252${_scopeId2}>Name partially matches — present the <code data-v-66945252${_scopeId2}>MaskedName</code> to the payer</td></tr><tr data-v-66945252${_scopeId2}><td data-v-66945252${_scopeId2}><code data-v-66945252${_scopeId2}>ConfirmationOfPayee.No</code></td><td data-v-66945252${_scopeId2}>Name does not match — present the <code data-v-66945252${_scopeId2}>MaskedName</code> to the payer</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-66945252${_scopeId2}> A <code data-v-66945252${_scopeId2}>ConfirmationOfPayee.Partial</code> or <code data-v-66945252${_scopeId2}>ConfirmationOfPayee.No</code> result must be surfaced to the payer — along with the <code data-v-66945252${_scopeId2}>MaskedName</code> — before initiating a payment. Proceeding without informing the user may increase the risk of authorised push payment fraud. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" A "),
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-66945252${_scopeId}>Decoding the JWS</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-66945252${_scopeId2}>/confirmation</code> response body is a compact JWS — three base64url-encoded segments separated by <code data-v-66945252${_scopeId2}>.</code>: `);
                } else {
                  return [
                    createTextVNode(" The "),
                    createVNode("code", null, "/confirmation"),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The decoded payload contains a <code data-v-66945252${_scopeId2}>message</code> object with the CoP result under <code data-v-66945252${_scopeId2}>message.Data</code>: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="./open-api/confirmation" data-v-66945252${_scopeId2}>POST /confirmation</a> API reference for the full request and response schema. `);
                } else {
                  return [
                    createTextVNode(" See the "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Where Confirmation of Payee has been performed for a creditor, include the <strong data-v-66945252${_scopeId2}>full raw JWS response string</strong> returned by the <code data-v-66945252${_scopeId2}>/confirmation</code> endpoint in the <code data-v-66945252${_scopeId2}>ConfirmationOfPayeeResponse</code> field of the creditor entry inside the payment consent PII. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/v2.2-rc1/banking/service-initiation/personal-identifiable-information/creditor" data-v-66945252${_scopeId2}>Creditor</a> for the full PII creditor schema and the creditor models (single, multiple, and open beneficiary). `);
                } else {
                  return [
                    createTextVNode(" See "),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/v2.2-rc1/banking/confirmation-of-payee/user-journeys" data-v-66945252${_scopeId2}>Confirmation of Payee — User Experience</a> for consent and authorisation page examples across different match results. `);
                } else {
                  return [
                    createTextVNode(" See "),
                    createVNode("a", { href: "/tech/tpp-standards/v2.2-rc1/banking/confirmation-of-payee/user-journeys" }, "Confirmation of Payee — User Experience"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/confirmation-of-payee/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-66945252"]]);
export {
  apiGuide as default
};
