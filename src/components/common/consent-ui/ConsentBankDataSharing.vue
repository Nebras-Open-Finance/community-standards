            ...
            <div class="consent-page-text-inner-frame">
                ...
                <div class="consent-page-text-section">
                    <div class="consent-page-text">
                        For you to use this service, {{consentData?.OnBehalfOf?.TradingName || '[TPP Trading Name]'}} need to access information from your
                    ...
                    <div class="consent-page-text-section">
                        ...
                        <div v-if="consentData?.Permissions?.some(item => ['ReadAccountsBasic', 'ReadAccountsDetail', 'ReadBalances'].includes(item))"
                            ...
                            <div v-if="show_account_details" class="consent-page-dropdown-subtext-section">
                                ...
                                <div v-if="consentData?.Permissions?.includes('ReadAccountsDetail')">{{ permissionDescriptions['ReadAccountsDetail'] }}</div>
                                <div v-else-if="consentData?.Permissions?.includes('ReadAccountsBasic')">{{ permissionDescriptions['ReadAccountsBasic'] }}</div>
                                <div v-if="consentData?.Permissions?.includes('ReadBalances')">{{ permissionDescriptions['ReadBalances'] }}</div>
</div>
                        ...
                        <div v-if="consentData?.Permissions?.some(item => ['ReadBeneficiariesBasic', 'ReadBeneficiariesDetail', 'ReadStandingOrdersBasic', 'ReadStandingOrdersDetail', 'ReadDirectDebits', 'ReadScheduledPaymentsBasic', 'ReadScheduledPaymentsDetail'].includes(item))"
                            ...
                            <div v-if="show_regular_payments" class="consent-page-dropdown-subtext-section">
                                <div class="consent-page-dropdown-subtext">
                                    <div v-if="consentData?.Permissions?.includes('ReadBeneficiariesDetail')">{{ permissionDescriptions['ReadBeneficiariesDetail'] }}</div>
                                    <div v-else-if="consentData?.Permissions?.includes('ReadBeneficiariesBasic')">{{ permissionDescriptions['ReadBeneficiariesBasic'] }}</div>
                                    <div v-if="consentData?.Permissions?.includes('ReadStandingOrdersDetail')">{{ permissionDescriptions['ReadStandingOrdersDetail'] }}</div>
                                    <div v-else-if="consentData?.Permissions?.includes('ReadStandingOrdersBasic')">{{ permissionDescriptions['ReadStandingOrdersBasic'] }}</div>
                                    <div v-if="consentData?.Permissions?.includes('ReadScheduledPaymentsDetail')">{{ permissionDescriptions['ReadScheduledPaymentsDetail'] }}</div>
                                    <div v-else-if="consentData?.Permissions?.includes('ReadScheduledPaymentsBasic')">{{ permissionDescriptions['ReadScheduledPaymentsBasic'] }}</div>
                                    <div v-if="consentData?.Permissions?.includes('ReadDirectDebits')">{{ permissionDescriptions['ReadDirectDebits'] }}</div>
                                </div>
                            </div>
                        ...
                        <div v-if="consentData?.Permissions?.some(item => ['ReadTransactionsBasic', 'ReadTransactionsDetail'].includes(item))"
                            ...
                            <div v-if="show_account_trans" class="consent-page-dropdown-subtext-section">
                                <div v-if="consentData?.Permissions?.includes('ReadTransactionsDetail')" class="consent-page-dropdown-subtext">{{ permissionDescriptions['ReadTransactionsDetail'] }}</div>
                                <div v-else-if="consentData?.Permissions?.includes('ReadTransactionsBasic')" class="consent-page-dropdown-subtext">{{ permissionDescriptions['ReadTransactionsBasic'] }}</div>
                            </div>
                        </div>
                        ...
                        <div v-if="consentData?.Permissions?.some(item => ['ReadPartyUser', 'ReadPartyUserIdentity', 'ReadParty'].includes(item))"
                            ...
                            <div v-if="show_parties" class="consent-page-dropdown-subtext-section">
                                <div v-if="consentData?.Permissions?.includes('ReadPartyUserIdentity')" class="consent-page-dropdown-subtext">{{ permissionDescriptions['ReadPartyUserIdentity'] }}</div>
                                <div v-else-if="consentData?.Permissions?.includes('ReadPartyUser')" class="consent-page-dropdown-subtext">{{ permissionDescriptions['ReadPartyUser'] }}</div>
                                <div v-else-if="consentData?.Permissions?.includes('ReadParty')" class="consent-page-dropdown-subtext">{{ permissionDescriptions['ReadParty'] }}</div>
                            </div>
