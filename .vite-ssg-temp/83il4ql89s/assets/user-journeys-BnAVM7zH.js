...
import { W as WireframePreview, A as AccountSetup, U as UIBehaviour, E as ExampleJourneys } from "./ExampleJourneys-DlczOHGK.js";
  ...
  setup(__props) {
    ...
    const myCustomValidator = (value) => {
      if ((() => {
        ...
        var _a;
        const perms = ((_a = value.Data) == null ? void 0 : _a.Permissions) || [];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-a992cd6e><section class="ed-doc__hero" data-v-a992cd6e><div class="ed-doc__inner" data-v-a992cd6e><div class="ed-doc__eyebrow" data-v-a992cd6e><span class="ed-doc__eyebrow-dash" data-v-a992cd6e></span> Banking · Data Sharing · UX </div><h1 class="ed-doc__title" data-v-a992cd6e> Bank Data Sharing — User Experience <span class="ed-doc__read" data-v-a992cd6e>2 min read</span></h1><p class="ed-doc__lede" data-v-a992cd6e> When a customer is redirected to you to authorize an Open Finance consent for data sharing, you must present an <strong data-v-a992cd6e>Authorization Page</strong> that clearly explains what the customer is authorizing. The page must collect the customer&#39;s explicit and informed consent, and it must accurately reflect the scope and nature of the data being shared. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-a992cd6e> The examples and interactive wireframes provided below define the expected structure, content, and behavior of the Authorization Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-a992cd6e> While you may adapt visual elements such as color palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the consent content. The representation of <strong data-v-a992cd6e>AlTareq</strong> (including logos, naming, and action buttons) must be preserved at all times. Your Authorization Page must be submitted as part of <strong data-v-a992cd6e>CX certification</strong> prior to production. Any material changes to a production Authorization Page must also be resubmitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the <code data-v-a992cd6e${_scopeId2}>consentBody</code> object below and watch the wireframes above update live. Try changing permissions, account types, date ranges, or the TPP name to see how the pages respond, or pick one of the scenarios beside the editor to load a preset consent. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/banking/data-sharing/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a992cd6e"]]);
export {
