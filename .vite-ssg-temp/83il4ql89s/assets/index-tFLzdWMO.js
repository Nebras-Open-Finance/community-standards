...
import "vue-router";
import "@unhead/vue";
const SI_BASE = "/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-landing" }, _attrs))} data-v-a827598a><section class="ed-landing__hero" data-v-a827598a><div class="ed-landing__inner" data-v-a827598a><div class="ed-landing__eyebrow" data-v-a827598a><span class="ed-landing__eyebrow-dash" data-v-a827598a></span> Banking · LFI capability </div><h1 class="ed-landing__title" data-v-a827598a> Payments (Service Initiation) <span class="ed-landing__read" data-v-a827598a>2 min read</span></h1><p class="ed-landing__lede" data-v-a827598a>The Payment Service Initiation capabilities allow customers to authorise payments at their LFI which a TPP then submits within the bounds of that authorisation. Payment types range from one-time instant payments through to long-running multi-payment consents with variable amounts, schedules, or delegated authentication.</p></div></section><section class="ed-landing__role" data-v-a827598a><div class="ed-landing__inner" data-v-a827598a><div class="ed-landing__role-card" data-v-a827598a><div class="ed-landing__role-meta" data-v-a827598a><span class="ed-landing__role-tag" data-v-a827598a>Access control</span> Required role </div><div class="ed-landing__role-head" data-v-a827598a><span class="ed-landing__role-chip" data-v-a827598a>BSIP</span><h2 class="ed-landing__role-title" data-v-a827598a>Bank Service Initiation Provider</h2></div><p class="ed-landing__role-body" data-v-a827598a>Access to the Payment Service Initiation APIs requires TPPs to hold the <strong data-v-a827598a>BSIP</strong> role. The API Hub validates the role on every request before proxying it to the LFI. If the consent also includes data-sharing permissions (<code data-v-a827598a>ReadAccountsBasic</code>, <code data-v-a827598a>ReadAccountsDetail</code>, <code data-v-a827598a>ReadBalances</code>), TPPs additionally require the <strong data-v-a827598a>BDSP</strong> role.</p></div></div></section><section class="ed-landing__live" data-v-a827598a><div class="ed-landing__inner" data-v-a827598a><div class="ed-landing__live-head" data-v-a827598a><div class="ed-landing__live-eyebrow" data-v-a827598a><span class="ed-landing__eyebrow-dash" data-v-a827598a></span> Live ecosystem </div><h2 class="ed-landing__live-title" data-v-a827598a>Who&#39;s initiating Payments</h2><p class="ed-landing__live-sub" data-v-a827598a>TPPs currently submitting payments across UAE Open Finance.</p></div>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {
        placeholder: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-landing__live-grid" data-v-a827598a${_scopeId}><!--[-->`);
            ssrRenderList(4, (i) => {
              _push2(`<div class="ed-landing__tpp ed-landing__tpp--skel" data-v-a827598a${_scopeId}></div>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            if (unref(liveTpps).length) {
              ...
              ssrRenderList(unref(liveTpps), (tpp) => {
                _push2(`<a class="ed-landing__tpp"${ssrRenderAttr("title", tpp.legalName)} href="/program/whats-live?type=tpp&amp;family=payment" data-v-a827598a${_scopeId}><div class="ed-landing__tpp-logo" data-v-a827598a${_scopeId}>`);
                if (tpp.logoUri) {
                  _push2(`<img${ssrRenderAttr("src", tpp.logoUri)}${ssrRenderAttr("alt", tpp.legalName)} data-v-a827598a${_scopeId}>`);
                } else {
                  _push2(`<span class="ed-landing__tpp-initials" data-v-a827598a${_scopeId}>${ssrInterpolate(initials(tpp.name))}</span>`);
                }
                _push2(`</div><div class="ed-landing__tpp-name" data-v-a827598a${_scopeId}>${ssrInterpolate(tpp.name)}</div></a>`);
              });
              _push2(`<!--]-->`);
              if (unref(totalTppCount) > unref(liveTpps).length) {
                _push2(`<a class="ed-landing__tpp ed-landing__tpp--more" href="/program/whats-live?type=tpp&amp;family=payment"${ssrRenderAttr("title", `See all ${unref(totalTppCount)} TPPs`)} data-v-a827598a${_scopeId}><span class="ed-landing__tpp-more-dots" data-v-a827598a${_scopeId}>…</span><span class="ed-landing__tpp-more-label" data-v-a827598a${_scopeId}>+${ssrInterpolate(unref(totalTppCount) - unref(liveTpps).length)} more</span></a>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            } else if (unref(loadError)) {
              _push2(`<p class="ed-landing__live-empty" data-v-a827598a${_scopeId}>Live data is currently unavailable.</p>`);
            } else {
              _push2(`<p class="ed-landing__live-empty" data-v-a827598a${_scopeId}>No TPPs are currently active for this capability.</p>`);
            }
            if (unref(totalTppCount) > 0) {
              _push2(`<a class="ed-landing__live-cta" href="/program/whats-live?type=tpp&amp;family=payment" data-v-a827598a${_scopeId}>`);
              if (unref(totalTppCount) > unref(liveTpps).length) {
                _push2(`<span data-v-a827598a${_scopeId}> See all ${ssrInterpolate(unref(totalTppCount))} TPPs in the live ecosystem </span>`);
              } else {
                _push2(`<span data-v-a827598a${_scopeId}>View in the live ecosystem dashboard</span>`);
              }
              _push2(`<span class="ed-landing__live-cta-arrow" aria-hidden="true" data-v-a827598a${_scopeId}>→</span></a>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`</div></section><section class="ed-landing__contents" data-v-a827598a><div class="ed-landing__inner" data-v-a827598a><div class="ed-landing__contents-head" data-v-a827598a><div class="ed-landing__contents-eyebrow" data-v-a827598a><span class="ed-landing__eyebrow-dash" data-v-a827598a></span> Section contents </div><h2 class="ed-landing__contents-title" data-v-a827598a>Browse this section</h2><p class="ed-landing__contents-sub" data-v-a827598a>The full set of pages for the Payments (Service Initiation) API.</p></div><div class="ed-cap-grid" data-v-a827598a><!--[-->`);
      ssrRenderList(cards, (card) => {
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(card.url ? "a" : "div"), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="ed-cap-card__top" data-v-a827598a${_scopeId}></span><div class="ed-cap-card__head" data-v-a827598a${_scopeId}><div class="ed-cap-card__meta" data-v-a827598a${_scopeId}><span class="ed-cap-card__meta-dot" data-v-a827598a${_scopeId}></span> ${ssrInterpolate(card.category)}</div><h3 class="ed-cap-card__title" data-v-a827598a${_scopeId}>${ssrInterpolate(card.title)}</h3><p class="ed-cap-card__desc" data-v-a827598a${_scopeId}>${ssrInterpolate(card.desc)}</p></div>`);
              if (card.subs.length) {
                _push2(`<ul class="ed-cap-card__subs" data-v-a827598a${_scopeId}><!--[-->`);
                ssrRenderList(card.subs, (sub) => {
                  _push2(`<li data-v-a827598a${_scopeId}><a${ssrRenderAttr("href", sub.url)} class="ed-cap-card__sub" data-v-a827598a${_scopeId}><span class="ed-cap-card__sub-marker" data-v-a827598a${_scopeId}></span><span class="ed-cap-card__sub-main" data-v-a827598a${_scopeId}><span class="ed-cap-card__sub-title" data-v-a827598a${_scopeId}>${ssrInterpolate(sub.title)}</span><span class="ed-cap-card__sub-hint" data-v-a827598a${_scopeId}>${ssrInterpolate(sub.hint)}</span></span><span class="ed-cap-card__sub-arrow" aria-hidden="true" data-v-a827598a${_scopeId}>→</span></a></li>`);
                });
                _push2(`<!--]--></ul>`);
              } else {
                _push2(`<!---->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a827598a"]]);
export {
  index as default
};
