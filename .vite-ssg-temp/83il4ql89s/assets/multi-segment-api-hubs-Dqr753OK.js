...
import { u as useMermaidDiagram, _ as __unplugin_components_5$1 } from "./APIFlowViewer-BRjrby73.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-fa4f2fd9>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-fa4f2fd9${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-fa4f2fd9${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The API Hub is more than a proxy — it acts as the <strong data-v-fa4f2fd9${_scopeId2}>OIDC Authorization Server</strong> for the LFI within the Open Finance ecosystem. When a TPP drives an end user through an authorization flow, the API Hub is the entity that:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fa4f2fd9${_scopeId2}>Exposes the single OIDC <code data-v-fa4f2fd9${_scopeId2}>/authorize</code> endpoint the TPP redirects the end user to</li><li data-v-fa4f2fd9${_scopeId2}>Issues the access tokens the TPP uses to call APIs</li><li data-v-fa4f2fd9${_scopeId2}>Holds the authoritative record of consents</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Because the API Hub must behave as a conformant OIDC Authorization Server, it has <strong data-v-fa4f2fd9${_scopeId2}>one authorization endpoint</strong> that redirects the end user into the LFI&#39;s own authentication experience (see the <a href="/tech/lfi-api-hub/v2.1/consent-journey/api-guide" data-v-fa4f2fd9${_scopeId2}>Consent Journey API Guide</a> and the <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/auth-endpoint" data-v-fa4f2fd9${_scopeId2}>Authorization Endpoint configuration</a>).`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`In that situation the LFI needs <strong data-v-fa4f2fd9${_scopeId2}>one API Hub per distinct authentication context</strong>:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fa4f2fd9${_scopeId2}>Retail end users → Retail API Hub → Retail authentication endpoint</li><li data-v-fa4f2fd9${_scopeId2}>SME end users → SME API Hub → SME authentication endpoint</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>One Trust Framework organisation</strong> — the LFI is a single legal entity in the UAE Open Finance ecosystem and is registered as one organisation regardless of how many segments it serves.</li><li data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>One API Hub deployment per authentication context</strong> — e.g. one for retail, one for SME. Each Hub has its own authorization endpoint, its own environment-specific onboarding, and its own base URLs.</li><li data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>One shared <code data-v-fa4f2fd9${_scopeId2}>C3-hh-cm-client</code> application</strong> — both Hubs use the same client registration. This means the LFI&#39;s client-side identity and signing material is created once and reused.</li><li data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>One shared Ozone Connect deployment</strong> — the LFI exposes a single set of Ozone Connect APIs, and routes incoming Hub requests to the correct downstream core using the <code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code> header.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-fa4f2fd9${_scopeId}>LFI-held certificates — maintained once, shared across Hubs</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`LFI-held certificates live on the LFI&#39;s Trust Framework organisation and are held by the LFI. Because both Hubs sit under the same organisation and share the same <code data-v-fa4f2fd9${_scopeId2}>C3-hh-cm-client</code> application, the LFI maintains <strong data-v-fa4f2fd9${_scopeId2}>one set</strong> of these certificates:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-fa4f2fd9${_scopeId2}><thead data-v-fa4f2fd9${_scopeId2}><tr data-v-fa4f2fd9${_scopeId2}><th data-v-fa4f2fd9${_scopeId2}>Certificate</th><th data-v-fa4f2fd9${_scopeId2}>Purpose</th><th data-v-fa4f2fd9${_scopeId2}>Reused across Hubs</th></tr></thead><tbody data-v-fa4f2fd9${_scopeId2}><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>C3</strong></td><td data-v-fa4f2fd9${_scopeId2}>LFI client cert used when calling Consent Manager &amp; Headless Heimdall</td><td data-v-fa4f2fd9${_scopeId2}>✅</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>S4</strong></td><td data-v-fa4f2fd9${_scopeId2}>LFI server cert identifying Ozone Connect to the API Hub</td><td data-v-fa4f2fd9${_scopeId2}>✅</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>Sig4</strong></td><td data-v-fa4f2fd9${_scopeId2}>LFI JWT Auth signing key (only if <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/application-layer-auth#jwt-auth" data-v-fa4f2fd9${_scopeId2}>JWT Auth</a> is selected)</td><td data-v-fa4f2fd9${_scopeId2}>✅</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>Enc1</strong></td><td data-v-fa4f2fd9${_scopeId2}>LFI encryption key used to decrypt PII</td><td data-v-fa4f2fd9${_scopeId2}>✅</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`See <a href="/tech/lfi-api-hub/v2.1/api-hub/connectivity/" data-v-fa4f2fd9${_scopeId2}>API Hub Connectivity &amp; Certificates</a> for the full certificate model and the existing &quot;Certificate reuse across brands&quot; note.`);
                } else {
                  return [
                    createTextVNode("See "),
            ...
            _push2(`<h3 data-v-fa4f2fd9${_scopeId}>Ozone-held certificates — additional material added per Hub</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Each additional API Hub requires its own server-side certificates — most visibly <strong data-v-fa4f2fd9${_scopeId2}>S1</strong>, the server transport certificate that identifies the Hub instance to TPPs. These are added to the LFI&#39;s Trust Framework organisation so TPPs can validate the Hub&#39;s identity, but the private keys are held and maintained by Ozone.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-fa4f2fd9${_scopeId2}><thead data-v-fa4f2fd9${_scopeId2}><tr data-v-fa4f2fd9${_scopeId2}><th data-v-fa4f2fd9${_scopeId2}>Certificate</th><th data-v-fa4f2fd9${_scopeId2}>Purpose</th><th data-v-fa4f2fd9${_scopeId2}>Added per Hub</th><th data-v-fa4f2fd9${_scopeId2}>Private key held by</th></tr></thead><tbody data-v-fa4f2fd9${_scopeId2}><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>S1</strong></td><td data-v-fa4f2fd9${_scopeId2}>Identifies the Hub instance to TPPs</td><td data-v-fa4f2fd9${_scopeId2}>✅</td><td data-v-fa4f2fd9${_scopeId2}>Ozone</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>S3</strong></td><td data-v-fa4f2fd9${_scopeId2}>Identifies CM &amp; HH servers to the LFI</td><td data-v-fa4f2fd9${_scopeId2}>✅</td><td data-v-fa4f2fd9${_scopeId2}>Ozone</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>Sig2</strong></td><td data-v-fa4f2fd9${_scopeId2}>Signs API Hub responses / <code data-v-fa4f2fd9${_scopeId2}>id_token</code> to TPPs</td><td data-v-fa4f2fd9${_scopeId2}>✅</td><td data-v-fa4f2fd9${_scopeId2}>Ozone</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>C4</strong></td><td data-v-fa4f2fd9${_scopeId2}>Hub client cert when calling Ozone Connect (held in Ozone&#39;s org)</td><td data-v-fa4f2fd9${_scopeId2}>✅</td><td data-v-fa4f2fd9${_scopeId2}>Ozone</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}><strong data-v-fa4f2fd9${_scopeId2}>Sig3</strong></td><td data-v-fa4f2fd9${_scopeId2}>Signs Hub-side JWT Auth headers (held in Ozone&#39;s org, only when JWT Auth is used)</td><td data-v-fa4f2fd9${_scopeId2}>✅</td><td data-v-fa4f2fd9${_scopeId2}>Ozone</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The API Hub tells the LFI which Hub the request originated from via the <strong data-v-fa4f2fd9${_scopeId2}><code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code></strong> request header. The value sent on every request <strong data-v-fa4f2fd9${_scopeId2}>is the LFI Code</strong> for the Hub that originated it — the same code that forms part of that Hub&#39;s TPP-facing and LFI-facing hostnames (see <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/prerequisites#lfi-code" data-v-fa4f2fd9${_scopeId2}>Prerequisites — LFI Code</a>). Because each segment Hub is onboarded with its own LFI Code, Ozone Connect can use <code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code> directly to identify the segment.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`For example, FAB operates separate retail and business Hubs in production with LFI Codes <code data-v-fa4f2fd9${_scopeId2}>fabretail</code> and <code data-v-fa4f2fd9${_scopeId2}>fabbusiness</code> respectively — Ozone Connect receives those exact values in the <code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code> header on each request.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-fa4f2fd9${_scopeId2}><thead data-v-fa4f2fd9${_scopeId2}><tr data-v-fa4f2fd9${_scopeId2}><th data-v-fa4f2fd9${_scopeId2}>Request</th><th data-v-fa4f2fd9${_scopeId2}><code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code> value (FAB example)</th><th data-v-fa4f2fd9${_scopeId2}>LFI action</th></tr></thead><tbody data-v-fa4f2fd9${_scopeId2}><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}>Retail Hub → Ozone Connect</td><td data-v-fa4f2fd9${_scopeId2}><code data-v-fa4f2fd9${_scopeId2}>fabretail</code></td><td data-v-fa4f2fd9${_scopeId2}>Route to retail core banking system</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}>Business Hub → Ozone Connect</td><td data-v-fa4f2fd9${_scopeId2}><code data-v-fa4f2fd9${_scopeId2}>fabbusiness</code></td><td data-v-fa4f2fd9${_scopeId2}>Route to SME / business core banking system</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 data-v-fa4f2fd9${_scopeId}>Implementation guidance</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fa4f2fd9${_scopeId2}>The <code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code> value is fixed at onboarding when each Hub&#39;s LFI Code is agreed with Nebras. There is no separate configuration step.</li><li data-v-fa4f2fd9${_scopeId2}>Treat <code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code> as the <strong data-v-fa4f2fd9${_scopeId2}>first branching decision</strong> inside Ozone Connect. All downstream logic (account lookup, customer lookup, payment execution, consent validation) should resolve through the segment&#39;s own core.</li><li data-v-fa4f2fd9${_scopeId2}>Validate the header on every request — reject calls with a missing or unknown <code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code>.</li><li data-v-fa4f2fd9${_scopeId2}>Keep segment boundaries clean: a consent created via the retail Hub <strong data-v-fa4f2fd9${_scopeId2}>MUST</strong> be served by the retail core; a consent created via the business Hub <strong data-v-fa4f2fd9${_scopeId2}>MUST</strong> be served by the business core. Do not allow cross-segment resolution.</li><li data-v-fa4f2fd9${_scopeId2}><code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code> is the supported identifier. <code data-v-fa4f2fd9${_scopeId2}>o3-aspsp-id</code> is a deprecated alias retained for backward compatibility only — see the request header tables in each API guide (e.g. <a href="/tech/lfi-api-hub/v2.1/banking/data-sharing/api-guide/" data-v-fa4f2fd9${_scopeId2}>Bank Data Sharing API Guide</a>).</li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      createTextVNode("The "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-fa4f2fd9${_scopeId2}><thead data-v-fa4f2fd9${_scopeId2}><tr data-v-fa4f2fd9${_scopeId2}><th data-v-fa4f2fd9${_scopeId2}>Concern</th><th data-v-fa4f2fd9${_scopeId2}>Recommendation</th></tr></thead><tbody data-v-fa4f2fd9${_scopeId2}><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}>Trust Framework organisations</td><td data-v-fa4f2fd9${_scopeId2}>One</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}>API Hub deployments</td><td data-v-fa4f2fd9${_scopeId2}>One per distinct authentication context (e.g. retail, SME)</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}><code data-v-fa4f2fd9${_scopeId2}>C3-hh-cm-client</code> application</td><td data-v-fa4f2fd9${_scopeId2}>One, shared</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}>LFI-held certificates (C3, S4, Sig4, Enc1)</td><td data-v-fa4f2fd9${_scopeId2}>One set, shared across Hubs</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}>Ozone-held certificates (S1 etc.)</td><td data-v-fa4f2fd9${_scopeId2}>Added per Hub; maintained by Ozone</td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}>Ozone Connect</td><td data-v-fa4f2fd9${_scopeId2}>One deployment, routing on <code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code></td></tr><tr data-v-fa4f2fd9${_scopeId2}><td data-v-fa4f2fd9${_scopeId2}>Downstream cores</td><td data-v-fa4f2fd9${_scopeId2}>One per segment, selected by <code data-v-fa4f2fd9${_scopeId2}>o3-provider-id</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
...
const multiSegmentApiHubs = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fa4f2fd9"]]);
export {
