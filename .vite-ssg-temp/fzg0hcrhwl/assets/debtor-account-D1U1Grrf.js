...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-ac939aa0><section class="ed-doc__hero" data-v-ac939aa0><div class="ed-doc__inner" data-v-ac939aa0><div class="ed-doc__eyebrow" data-v-ac939aa0><span class="ed-doc__eyebrow-dash" data-v-ac939aa0></span> LFI · Banking · Service Initiation · PII </div><h1 class="ed-doc__title" data-v-ac939aa0> Debtor Account <span class="ed-doc__read" data-v-ac939aa0>2 min read</span></h1>`);
      _push(ssrRenderComponent(_component_EdNote, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-ac939aa0${_scopeId}><code data-v-ac939aa0${_scopeId}>Initiation.DebtorAccount</code> is only present in the PII the LFI receives at <span class="endpoint" data-v-ac939aa0${_scopeId}><span class="http-method http-method--post" data-v-ac939aa0${_scopeId}>POST</span><code data-v-ac939aa0${_scopeId}>/consent/action/validate</code></span> (consent validation). It is <strong data-v-ac939aa0${_scopeId}>not part of the PII delivered with a payment instruction via Ozone Connect</strong> — by the time a payment is created, the debtor account has been fixed by the consent authorisation journey. </p>`);
          } else {
            return [
              createVNode("p", null, [
      ...
      _push(`<p class="ed-doc__lede" data-v-ac939aa0> When a TPP supplies <code data-v-ac939aa0>Initiation.DebtorAccount</code> in the consent PII, the LFI MUST validate it during consent validation — <span class="endpoint" data-v-ac939aa0><span class="http-method http-method--post" data-v-ac939aa0>POST</span><code data-v-ac939aa0>/consent/action/validate</code></span>. At this stage the customer has <strong data-v-ac939aa0>not yet authenticated</strong>, so the LFI cannot check ownership. The checks are limited to whether the account exists at this LFI, is reachable through this API Hub, and is eligible for payment initiation. </p>`);
      _push(ssrRenderComponent(_component_EdNote, {
        type: "tip",
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Perform these checks after <a href="./api-guide/decrypt-pii" data-v-ac939aa0${_scopeId2}>decrypting the PII</a> in the <span class="endpoint" data-v-ac939aa0${_scopeId2}><span class="http-method http-method--post" data-v-ac939aa0${_scopeId2}>POST</span><code data-v-ac939aa0${_scopeId2}>/consent/action/validate</code></span> handler: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-ac939aa0${_scopeId2}><thead data-v-ac939aa0${_scopeId2}><tr data-v-ac939aa0${_scopeId2}><th data-v-ac939aa0${_scopeId2}>Check</th><th data-v-ac939aa0${_scopeId2}>Rule</th></tr></thead><tbody data-v-ac939aa0${_scopeId2}><tr data-v-ac939aa0${_scopeId2}><td data-v-ac939aa0${_scopeId2}>Schema</td><td data-v-ac939aa0${_scopeId2}><code data-v-ac939aa0${_scopeId2}>DebtorAccount</code> conforms to <code data-v-ac939aa0${_scopeId2}>AEDomesticPaymentPII</code> — see <a href="./api-schema/pii-par" data-v-ac939aa0${_scopeId2}>PII Schema — Consent</a></td></tr><tr data-v-ac939aa0${_scopeId2}><td data-v-ac939aa0${_scopeId2}>Scheme</td><td data-v-ac939aa0${_scopeId2}><code data-v-ac939aa0${_scopeId2}>SchemeName</code> MUST be <code data-v-ac939aa0${_scopeId2}>IBAN</code></td></tr><tr data-v-ac939aa0${_scopeId2}><td data-v-ac939aa0${_scopeId2}>Account exists</td><td data-v-ac939aa0${_scopeId2}><code data-v-ac939aa0${_scopeId2}>Identification</code> (IBAN) corresponds to an account held at this LFI and reachable through this API Hub</td></tr><tr data-v-ac939aa0${_scopeId2}><td data-v-ac939aa0${_scopeId2}>Payments enabled</td><td data-v-ac939aa0${_scopeId2}>The account is in a state that permits payment initiation (e.g. not blocked, dormant, or closed)</td></tr></tbody></table>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If any check fails, the LFI MUST mark the consent invalid in its <span class="endpoint" data-v-ac939aa0${_scopeId2}><span class="http-method http-method--post" data-v-ac939aa0${_scopeId2}>POST</span><code data-v-ac939aa0${_scopeId2}>/consent/action/validate</code></span> response. The API Hub will then reject the consent back to the TPP. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/lfi-api-hub/v2.1/consent-events/api-guide" data-v-ac939aa0${_scopeId2}>Consent Events &amp; Actions — API Guide</a> for the full <span class="endpoint" data-v-ac939aa0${_scopeId2}><span class="http-method http-method--post" data-v-ac939aa0${_scopeId2}>POST</span><code data-v-ac939aa0${_scopeId2}>/consent/action/validate</code></span> flow and response schema. `);
                } else {
                  return [
                    createTextVNode(" See "),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/banking/service-initiation/personal-identifiable-information/debtor-account.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const debtorAccount = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ac939aa0"]]);
export {
