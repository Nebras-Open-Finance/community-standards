...
<template>
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        <li>
          ...
          <a href="/tech/tpp-standards/v2.2-draft/consent/api-guide">Payment Consent API Guide</a>.
        </li>
        <li>
    ...
    >
      ...
      <EdProse>
        See
        <a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/personal-identifiable-information/creditor">Creditor
