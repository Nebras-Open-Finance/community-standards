...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-56d93b0c><section class="ed-doc__hero" data-v-56d93b0c><div class="ed-doc__inner" data-v-56d93b0c><div class="ed-doc__eyebrow" data-v-56d93b0c><span class="ed-doc__eyebrow-dash" data-v-56d93b0c></span> TPP · Insurance · Data Sharing · API Guide </div><h1 class="ed-doc__title" data-v-56d93b0c> Encrypted Premiums <span class="ed-doc__read" data-v-56d93b0c>5 min read</span></h1><p class="ed-doc__lede" data-v-56d93b0c> When a TPP holds the <code data-v-56d93b0c>ReadInsurancePremium</code> permission and calls any <code data-v-56d93b0c>/{type}-insurance-policies</code> endpoint, the LFI MAY return the <code data-v-56d93b0c>Premium</code> field as an encrypted JWE rather than a structured object. The TPP MUST present the premium to the customer without the unencrypted value ever reaching or being stored on its servers — decryption happens locally on the customer’s device. </p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-56d93b0c${_scopeId2}>Premium</code> field on every insurance policy response is defined as <code data-v-56d93b0c${_scopeId2}>anyOf</code> a structured <code data-v-56d93b0c${_scopeId2}>AEInsuranceDataSharingPremiumProperties</code> object or an <code data-v-56d93b0c${_scopeId2}>AEInsurancePremiumJWE</code> compact string. Each LFI decides, per policy, whether to return the premium in cleartext or as an encrypted JWE. A TPP holding <code data-v-56d93b0c${_scopeId2}>ReadInsurancePremium</code> MUST therefore be ready for either shape on every call. `);
                } else {
                  return [
                    createTextVNode(" The "),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-56d93b0c${_scopeId2}><strong data-v-56d93b0c${_scopeId2}>Cleartext</strong> — <code data-v-56d93b0c${_scopeId2}>Premium</code> is a JSON object containing <code data-v-56d93b0c${_scopeId2}>PremiumAmountExcludingVAT</code>, <code data-v-56d93b0c${_scopeId2}>PremiumVATAmount</code>, <code data-v-56d93b0c${_scopeId2}>TotalPremiumAmount</code>, <code data-v-56d93b0c${_scopeId2}>Currency</code>, and <code data-v-56d93b0c${_scopeId2}>PremiumFrequency</code>. Render directly. No special handling required. </li><li data-v-56d93b0c${_scopeId2}><strong data-v-56d93b0c${_scopeId2}>Encrypted (JWE)</strong> — <code data-v-56d93b0c${_scopeId2}>Premium</code> is a compact JWE string. The TPP server MUST forward this opaque string to the customer’s device without inspecting, logging, or persisting it. Decryption happens in the browser or mobile app using key material tied to the customer’s authenticated session. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-56d93b0c${_scopeId2}> Some insurers treat the premium as commercially sensitive — in particular for switching and quote-comparison use cases where premium parity is a competitive lever. The encrypted JWE shape lets the premium flow through the TPP to the customer’s screen without the TPP ever holding the cleartext value. </p>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-56d93b0c${_scopeId2}><strong data-v-56d93b0c${_scopeId2}>A consent that includes <code data-v-56d93b0c${_scopeId2}>ReadInsurancePremium</code></strong> for the relevant <code data-v-56d93b0c${_scopeId2}>InsuranceType</code> — this permission MUST be present in the per-sector block of <code data-v-56d93b0c${_scopeId2}>authorization_details.consent.Permissions</code> when the TPP creates the consent. See <a href="/tech/tpp-standards/v2.1/insurance/data-sharing/api-guide/#authorization-details" data-v-56d93b0c${_scopeId2}> Constructing Authorization Details</a>. </li><li data-v-56d93b0c${_scopeId2}><strong data-v-56d93b0c${_scopeId2}>The <em data-v-56d93b0c${_scopeId2}>Access Encrypted Resource Data</em> optional certification</strong> — before requesting <code data-v-56d93b0c${_scopeId2}>ReadInsurancePremium</code> on a live LFI, the TPP MUST hold this certification with Nebras. See <a href="/tech/tpp-standards/production/testing-certification/optional/access-encrypted-resource-data" data-v-56d93b0c${_scopeId2}> Access Encrypted Resource Data</a>. </li><li data-v-56d93b0c${_scopeId2}><strong data-v-56d93b0c${_scopeId2}>A valid access token and the standard FAPI headers</strong> — <code data-v-56d93b0c${_scopeId2}>x-fapi-interaction-id</code>, <code data-v-56d93b0c${_scopeId2}>x-fapi-auth-date</code>, and <code data-v-56d93b0c${_scopeId2}>x-fapi-customer-ip-address</code>. See <a href="/tech/tpp-standards/security/request-headers" data-v-56d93b0c${_scopeId2}>Request Headers</a>. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      ...
                      createVNode("a", { href: "/tech/tpp-standards/v2.1/insurance/data-sharing/api-guide/#authorization-details" }, " Constructing Authorization Details"),
                      createTextVNode(". ")
                    ]),
                    createVNode("li", null, [
                      createVNode("strong", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-56d93b0c${_scopeId}><span class="http-badge http-get" data-v-56d93b0c${_scopeId}>GET</span><code class="ed-doc__endpoint-path" data-v-56d93b0c${_scopeId}>/{type}-insurance-policies/{InsurancePolicyId}</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Premium values are returned on the per-policy detail endpoint. Use an <code data-v-56d93b0c${_scopeId2}>InsurancePolicyId</code> obtained from a prior <code data-v-56d93b0c${_scopeId2}>GET /{type}-insurance-policies</code> call (Step 8 of the <a href="/tech/tpp-standards/v2.1/insurance/data-sharing/api-guide/#step-8-get-policies" data-v-56d93b0c${_scopeId2}>API Guide</a>) and request the detailed policy. `);
                } else {
                  return [
                    ...
                    createVNode("a", { href: "/tech/tpp-standards/v2.1/insurance/data-sharing/api-guide/#step-8-get-policies" }, "API Guide"),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Whether the LFI returns cleartext or an encrypted JWE for <code data-v-56d93b0c${_scopeId2}>Premium</code>, the request itself is unchanged. Make the call as you would for any other Insurance Data Sharing endpoint: `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-56d93b0c${_scopeId}>Example response — cleartext</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: exampleCleartextResponse,
              lang: "json",
              filename: "cleartext Premium"
            }, null, _parent2, _scopeId));
            _push2(`<h3 class="ed-doc__subhead" data-v-56d93b0c${_scopeId}>Example response — encrypted JWE</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Apart from <code data-v-56d93b0c${_scopeId2}>Premium</code>, every other field on the policy is returned in cleartext in both shapes — <code data-v-56d93b0c${_scopeId2}>PolicyNumber</code>, <code data-v-56d93b0c${_scopeId2}>PolicyStatus</code>, <code data-v-56d93b0c${_scopeId2}>Insurer</code>, dates, coverage, riders, and so on. Only <code data-v-56d93b0c${_scopeId2}>Premium</code> is ever encrypted. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-56d93b0c${_scopeId2}> The encrypted JWE is opaque to the TPP. Pass it through to the customer device and discard the server-side copy as soon as the response is sent. Do not write the JWE to application logs, request traces, or analytics pipelines — even though it is encrypted, persisting it would put the TPP in scope of the encrypted-data handling requirements documented in <a href="/tech/tpp-standards/production/testing-certification/optional/access-encrypted-resource-data" data-v-56d93b0c${_scopeId2}> Access Encrypted Resource Data</a>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    ...
                    createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/api-guide/finance-rates" }, "Encrypted FinanceRates"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-56d93b0c${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/data-sharing/api-guide/finance-rates" data-v-56d93b0c${_scopeId2}>Encrypted FinanceRates</a> — the Bank Data Sharing equivalent. Insurance follows the same mechanism, only the field name and consented permission differ. </li><li data-v-56d93b0c${_scopeId2}><a href="/tech/tpp-standards/production/testing-certification/optional/access-encrypted-resource-data" data-v-56d93b0c${_scopeId2}> Access Encrypted Resource Data</a> — the optional certification a TPP must hold before requesting any encrypted resource field, including <code data-v-56d93b0c${_scopeId2}>Premium</code>. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/api-guide/finance-rates" }, "Encrypted FinanceRates"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/insurance/data-sharing/api-guide/premiums.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const premiums = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-56d93b0c"]]);
export {
  premiums as default
};
