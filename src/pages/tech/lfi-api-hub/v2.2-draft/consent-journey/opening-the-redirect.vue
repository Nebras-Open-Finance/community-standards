  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdProse>
        ...
        and the <a href="/tech/lfi-api-hub/v2.2-draft/consent-journey/api-guide">Consent Journey API Guide</a>
        for the full flow.
      </EdProse>
      ...
      <template #web-desktop="{ num }">
        ...
        >
          ...
          <EdBullets>
            ...
            <li><strong>Desktop cross-device journeys</strong> &mdash; where the customer started on a desktop browser and authenticated on their phone &mdash; complete on your Authorization Endpoint page, which polls for completion and then performs this redirect. See <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/auth-endpoint#desktop-browser">Authorization Endpoint &mdash; Desktop browser behaviour</a>.</li>
          </EdBullets>
