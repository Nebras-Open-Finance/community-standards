  ...
  sections: [
    ...
    },
    {
      ...
      rules: [
        ...
        { field: 'OpenAPI schema', rule: 'The request must conform exactly to the <a href="/tech/tpp-standards/v2.2-draft/banking/confirmation-of-payee/open-api/discovery">POST <code>/discovery</code> OpenAPI schema</a>. No additional or undocumented parameters are permitted.', validatedBy: 'API Hub' },
    ...
    },
    {
      ...
      rules: [
        ...
        { field: 'OpenAPI schema', rule: 'The request must conform exactly to the <a href="/tech/tpp-standards/v2.2-draft/banking/confirmation-of-payee/open-api/confirmation">POST <code>/confirmation</code> OpenAPI schema</a>. No additional or undocumented parameters are permitted.', validatedBy: 'API Hub' },
