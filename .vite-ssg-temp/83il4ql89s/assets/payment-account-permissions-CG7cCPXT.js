...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-c156fd9a>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-c156fd9a${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-c156fd9a${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-c156fd9a${_scopeId2}><strong data-v-c156fd9a${_scopeId2}>Display the payer&#39;s debit account</strong> — the user should be able to confirm which account they are paying from before authorizing.</li><li data-v-c156fd9a${_scopeId2}><strong data-v-c156fd9a${_scopeId2}>Show the available balance</strong> — helps the user check they have sufficient funds before approving the payment.</li><li data-v-c156fd9a${_scopeId2}><strong data-v-c156fd9a${_scopeId2}>Pre-fill the debit account</strong> — some UX patterns let the user pick an account; <code data-v-c156fd9a${_scopeId2}>ReadAccountsBasic</code> provides the list.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c156fd9a${_scopeId2}><thead data-v-c156fd9a${_scopeId2}><tr data-v-c156fd9a${_scopeId2}><th data-v-c156fd9a${_scopeId2}>Permission</th><th data-v-c156fd9a${_scopeId2}>Endpoint unlocked</th><th data-v-c156fd9a${_scopeId2}>What it returns</th></tr></thead><tbody data-v-c156fd9a${_scopeId2}><tr data-v-c156fd9a${_scopeId2}><td data-v-c156fd9a${_scopeId2}><code data-v-c156fd9a${_scopeId2}>ReadAccountsBasic</code></td><td data-v-c156fd9a${_scopeId2}><code data-v-c156fd9a${_scopeId2}>GET /accounts</code></td><td data-v-c156fd9a${_scopeId2}>List of accounts with basic metadata (account type, currency, nickname). Does <strong data-v-c156fd9a${_scopeId2}>not</strong> include the full account number or IBAN.</td></tr><tr data-v-c156fd9a${_scopeId2}><td data-v-c156fd9a${_scopeId2}><code data-v-c156fd9a${_scopeId2}>ReadAccountsDetail</code></td><td data-v-c156fd9a${_scopeId2}><code data-v-c156fd9a${_scopeId2}>GET /accounts/{AccountId}</code></td><td data-v-c156fd9a${_scopeId2}>Full account record including the IBAN/account identification. Requires <code data-v-c156fd9a${_scopeId2}>ReadAccountsBasic</code> to first retrieve an <code data-v-c156fd9a${_scopeId2}>AccountId</code>.</td></tr><tr data-v-c156fd9a${_scopeId2}><td data-v-c156fd9a${_scopeId2}><code data-v-c156fd9a${_scopeId2}>ReadBalances</code></td><td data-v-c156fd9a${_scopeId2}><code data-v-c156fd9a${_scopeId2}>GET /accounts/{AccountId}/balances</code></td><td data-v-c156fd9a${_scopeId2}>Current balance for a specific account (available balance, credit/debit indicator, and currency).</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-c156fd9a${_scopeId2}>ReadRefundAccount</code> is a fourth permission on a payment consent. It unlocks <code data-v-c156fd9a${_scopeId2}>GET /payment-consents/{ConsentId}/refund</code> and is used to retrieve account details for routing a refund — it is not an account-reading permission in the same sense.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Including any of the three permissions above <strong data-v-c156fd9a${_scopeId2}>changes the required scope</strong> in the <code data-v-c156fd9a${_scopeId2}>/par</code> Request JWT.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c156fd9a${_scopeId2}><thead data-v-c156fd9a${_scopeId2}><tr data-v-c156fd9a${_scopeId2}><th data-v-c156fd9a${_scopeId2}>Consent includes</th><th data-v-c156fd9a${_scopeId2}>Scope in Request JWT</th></tr></thead><tbody data-v-c156fd9a${_scopeId2}><tr data-v-c156fd9a${_scopeId2}><td data-v-c156fd9a${_scopeId2}>Payment only (no account permissions)</td><td data-v-c156fd9a${_scopeId2}><code data-v-c156fd9a${_scopeId2}>payments openid</code></td></tr><tr data-v-c156fd9a${_scopeId2}><td data-v-c156fd9a${_scopeId2}>Payment <strong data-v-c156fd9a${_scopeId2}>with</strong> <code data-v-c156fd9a${_scopeId2}>ReadAccountsBasic</code>, <code data-v-c156fd9a${_scopeId2}>ReadAccountsDetail</code>, or <code data-v-c156fd9a${_scopeId2}>ReadBalances</code></td><td data-v-c156fd9a${_scopeId2}><code data-v-c156fd9a${_scopeId2}>accounts payments openid</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, { type: "warning" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-c156fd9a${_scopeId2}>If account-reading permissions are present in <code data-v-c156fd9a${_scopeId2}>authorization_details</code> but <code data-v-c156fd9a${_scopeId2}>accounts</code> is omitted from the <code data-v-c156fd9a${_scopeId2}>scope</code>, the API Hub will reject the <code data-v-c156fd9a${_scopeId2}>/par</code> request.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Add the <code data-v-c156fd9a${_scopeId2}>Permissions</code> array to <code data-v-c156fd9a${_scopeId2}>authorization_details.consent</code> in your <code data-v-c156fd9a${_scopeId2}>/par</code> request alongside the payment fields:`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-c156fd9a${_scopeId}>GET /accounts — requires <code data-v-c156fd9a${_scopeId}>ReadAccountsBasic</code></h3>`);
            _push2(ssrRenderComponent(_component_EdCodeGroup, { tabs: accountsCallTabs }, null, _parent2, _scopeId));
            _push2(`<h3 data-v-c156fd9a${_scopeId}>GET /accounts/{AccountId} — requires <code data-v-c156fd9a${_scopeId}>ReadAccountsDetail</code></h3>`);
            _push2(ssrRenderComponent(_component_EdCodeGroup, { tabs: accountDetailCallTabs }, null, _parent2, _scopeId));
            _push2(`<h3 data-v-c156fd9a${_scopeId}>GET /accounts/{AccountId}/balances — requires <code data-v-c156fd9a${_scopeId}>ReadBalances</code></h3>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`These permissions follow the same permission model as <a href="/tech/tpp-standards/v2.1/banking/data-sharing/api-guide/" data-v-c156fd9a${_scopeId2}>Bank Data Sharing</a> but are scoped to the payment context:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-c156fd9a${_scopeId2}>Access <strong data-v-c156fd9a${_scopeId2}>expires when the payment consent expires</strong>.</li><li data-v-c156fd9a${_scopeId2}>Access is <strong data-v-c156fd9a${_scopeId2}>limited to the accounts the user authorized</strong> at the LFI.</li><li data-v-c156fd9a${_scopeId2}>Only these three account endpoints are available — no transactions, beneficiaries, statements, or other sub-resources.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
...
const paymentAccountPermissions = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c156fd9a"]]);
export {
