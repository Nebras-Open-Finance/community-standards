    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a class="ed-link-card" href="/tech/lfi-api-hub/v2.1/banking/data-sharing/requirements" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
          ...
          <a class="ed-link-card" href="/tech/lfi-api-hub/v2.1/banking/data-sharing/api-guide/" :style="{ '--card-color': 'var(--at-teal)' }">
            <span class="ed-link-card__top" />
          ...
          <a class="ed-link-card" href="/tech/lfi-api-hub/v2.1/banking/data-sharing/user-journeys" :style="{ '--card-color': 'var(--at-navy)' }">
            <span class="ed-link-card__top" />
