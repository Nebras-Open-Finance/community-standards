...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-08ccc970><section class="ed-doc__hero" data-v-08ccc970><div class="ed-doc__inner" data-v-08ccc970><div class="ed-doc__eyebrow" data-v-08ccc970><span class="ed-doc__eyebrow-dash" data-v-08ccc970></span> LFI · Banking · Service Initiation · Refunds </div><h1 class="ed-doc__title" data-v-08ccc970> Payment Refunds — API Guide <span class="ed-doc__read" data-v-08ccc970>2 min read</span></h1><p class="ed-doc__lede" data-v-08ccc970> The Payment Refunds endpoint lets the API Hub retrieve the debtor&#39;s payment account details from your LFI after a payment has been made. The TPP uses those details to initiate a refund back to the original payer. This endpoint does <strong data-v-08ccc970>not</strong> execute the refund itself — it only returns the account details needed to initiate one. </p></div></section>`);
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-08ccc970${_scopeId}><span class="http-badge http-get" data-v-08ccc970${_scopeId}>GET</span><code class="ed-doc__endpoint-path" data-v-08ccc970${_scopeId}>/payment-consents/{consentId}/refund</code></div><h3 class="ed-doc__subhead" data-v-08ccc970${_scopeId}>Request headers</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-08ccc970${_scopeId2}><thead data-v-08ccc970${_scopeId2}><tr data-v-08ccc970${_scopeId2}><th data-v-08ccc970${_scopeId2}>Header</th><th data-v-08ccc970${_scopeId2}>Required</th><th data-v-08ccc970${_scopeId2}>Description</th></tr></thead><tbody data-v-08ccc970${_scopeId2}><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>o3-provider-id</code></td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>Identifier for your LFI registered in the Hub</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>o3-aspsp-id</code></td><td data-v-08ccc970${_scopeId2}>Yes <em data-v-08ccc970${_scopeId2}>(deprecated)</em></td><td data-v-08ccc970${_scopeId2}>Deprecated alias for <code data-v-08ccc970${_scopeId2}>o3-provider-id</code>. Will be removed in a future version — use <code data-v-08ccc970${_scopeId2}>o3-provider-id</code></td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>o3-caller-org-id</code></td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>Organisation ID of the TPP making the underlying request</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>o3-caller-client-id</code></td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>OIDC client ID of the TPP application</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>o3-caller-software-statement-id</code></td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>Software statement ID of the TPP application</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>o3-api-uri</code></td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>The parameterised URL of the API being called by the TPP</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>o3-api-operation</code></td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>The HTTP method of the operation carried out by the TPP (e.g. <code data-v-08ccc970${_scopeId2}>GET</code>)</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>o3-ozone-interaction-id</code></td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>Hub-generated interaction ID. Equals <code data-v-08ccc970${_scopeId2}>o3-caller-interaction-id</code> if the TPP provided one</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>o3-caller-interaction-id</code></td><td data-v-08ccc970${_scopeId2}>No</td><td data-v-08ccc970${_scopeId2}>Interaction ID passed in by the TPP, if present</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>o3-psu-identifier</code></td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>Base64-encoded representation of the customer identifier JSON object</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-08ccc970${_scopeId}>Path parameters</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-08ccc970${_scopeId2}><thead data-v-08ccc970${_scopeId2}><tr data-v-08ccc970${_scopeId2}><th data-v-08ccc970${_scopeId2}>Parameter</th><th data-v-08ccc970${_scopeId2}>Required</th><th data-v-08ccc970${_scopeId2}>Description</th></tr></thead><tbody data-v-08ccc970${_scopeId2}><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>consentId</code></td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>The consent ID of the original payment consent</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-08ccc970${_scopeId}>Response</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-08ccc970${_scopeId2}>Content-Type: application/json</code>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Return <code data-v-08ccc970${_scopeId2}>200</code> with the debtor&#39;s refund account details. The Hub wraps the response in a signed JWS before returning it to the TPP — your LFI returns plain JSON. `);
                } else {
                  return [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-08ccc970${_scopeId}><code data-v-08ccc970${_scopeId}>200</code> — Refund account found</h4>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Return the debtor&#39;s account details under <code data-v-08ccc970${_scopeId2}>data.refundAccount</code>. The <code data-v-08ccc970${_scopeId2}>refundAccount</code> object is required and must contain the debtor&#39;s IBAN and name. `);
                } else {
                  return [
            ...
            _push2(`<h5 class="ed-doc__subhead ed-doc__subhead--xs" data-v-08ccc970${_scopeId}><code data-v-08ccc970${_scopeId}>data.refundAccount</code></h5>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-08ccc970${_scopeId2}><thead data-v-08ccc970${_scopeId2}><tr data-v-08ccc970${_scopeId2}><th data-v-08ccc970${_scopeId2}>Field</th><th data-v-08ccc970${_scopeId2}>Type</th><th data-v-08ccc970${_scopeId2}>Required</th><th data-v-08ccc970${_scopeId2}>Description</th></tr></thead><tbody data-v-08ccc970${_scopeId2}><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>schemeName</code></td><td data-v-08ccc970${_scopeId2}>string</td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>Account identifier scheme — always <code data-v-08ccc970${_scopeId2}>IBAN</code></td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>identification</code></td><td data-v-08ccc970${_scopeId2}>string</td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>The debtor&#39;s IBAN</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>name</code></td><td data-v-08ccc970${_scopeId2}>object</td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>The account holder name</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>name.en</code></td><td data-v-08ccc970${_scopeId2}>string</td><td data-v-08ccc970${_scopeId2}>Yes</td><td data-v-08ccc970${_scopeId2}>Account holder name in English (max 70 characters)</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>name.ar</code></td><td data-v-08ccc970${_scopeId2}>string</td><td data-v-08ccc970${_scopeId2}>No</td><td data-v-08ccc970${_scopeId2}>Account holder name in Arabic (max 70 characters)</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-08ccc970${_scopeId}>Error responses</h4>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`All error bodies must include <code data-v-08ccc970${_scopeId2}>errorCode</code> and <code data-v-08ccc970${_scopeId2}>errorMessage</code>.`);
                } else {
                  return [
            ...
            _push2(`<h5 class="ed-doc__subhead ed-doc__subhead--xs" data-v-08ccc970${_scopeId}><code data-v-08ccc970${_scopeId}>403</code> — Forbidden</h5>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-08ccc970${_scopeId2}><thead data-v-08ccc970${_scopeId2}><tr data-v-08ccc970${_scopeId2}><th data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>errorCode</code></th><th data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>errorMessage</code></th><th data-v-08ccc970${_scopeId2}>When to use</th></tr></thead><tbody data-v-08ccc970${_scopeId2}><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>Consent.AccountTemporarilyBlocked</code></td><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>The debtor account is blocked from receiving payments.</code></td><td data-v-08ccc970${_scopeId2}>The account is blocked from receiving payments for a temporary reason — e.g. account status is <code data-v-08ccc970${_scopeId2}>Suspended</code>, or the account is otherwise unable to receive a credit transaction refund on a transient basis</td></tr><tr data-v-08ccc970${_scopeId2}><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>Consent.PermanentAccountAccessFailure</code></td><td data-v-08ccc970${_scopeId2}><code data-v-08ccc970${_scopeId2}>The debtor account is blocked from receiving payments.</code></td><td data-v-08ccc970${_scopeId2}>The account is blocked from receiving payments permanently — e.g. account status is <code data-v-08ccc970${_scopeId2}>Closed</code>, <code data-v-08ccc970${_scopeId2}>Deceased</code>, or <code data-v-08ccc970${_scopeId2}>Unclaimed</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payment-consents-ConsentId-refund" data-v-08ccc970${_scopeId2}>GET <code data-v-08ccc970${_scopeId2}>/payment-consents/{consentId}/refund</code> API Reference</a> for the full request and response schema. `);
                } else {
                  return [
                    createTextVNode(" See the "),
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payment-consents-ConsentId-refund" }, [
                      createTextVNode("GET "),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/refunds/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-08ccc970"]]);
export {
  apiGuide as default
};
