...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-32371207><section class="ed-doc__hero" data-v-32371207><div class="ed-doc__inner" data-v-32371207><div class="ed-doc__eyebrow" data-v-32371207><span class="ed-doc__eyebrow-dash" data-v-32371207></span> Insurance · Quotation · LFI hosted screens </div><h1 class="ed-doc__title" data-v-32371207> User Journeys <span class="ed-doc__read" data-v-32371207>3 min read</span></h1><p class="ed-doc__lede" data-v-32371207> Insurance Quotation does not have a Hub-mediated consent journey — the TPP authenticates with the Client Credentials Grant and the customer interacts either with the TPP\\&#39;s own UI or with screens your LFI hosts. This page describes what your LFI hosts and when. </p></div></section>`);
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<h3 class="ed-doc__subhead" data-v-32371207${_scopeId}>Screens your LFI hosts</h3>`);
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-32371207${_scopeId2}><strong data-v-32371207${_scopeId2}>Quote summary</strong> — confirms the quote details (sums insured, premium, coverage period, exclusions) before the customer commits. </li><li data-v-32371207${_scopeId2}><strong data-v-32371207${_scopeId2}>Customer verification (KYC)</strong> — Emirates ID capture, address confirmation, and any additional declarations required for underwriting. </li><li data-v-32371207${_scopeId2}><strong data-v-32371207${_scopeId2}>Payment</strong> — premium collection through your LFI\\&#39;s payment provider (card, wallet, or direct debit, as supported). </li><li data-v-32371207${_scopeId2}><strong data-v-32371207${_scopeId2}>Confirmation</strong> — on successful issuance, an in-LFI confirmation screen that hands the customer back to the originating TPP (typically via a return URL the TPP supplied on quote creation). </li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(`<h3 class="ed-doc__subhead" data-v-32371207${_scopeId}>Status emission</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` At each transition (KYC submitted, payment confirmed, policy issued), emit the matching quote-log status via <code data-v-32371207${_scopeId2}>PATCH /insurance-quote-log/{logId}</code> so the TPP — and any subscribed webhook — sees the lifecycle progress. The TPP uses these events to update its own customer-facing UI in parallel. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` In TPP-Led mode, the TPP collects KYC in its own UI and submits it to your LFI via PATCH on the quote. Your LFI\\&#39;s only hosted screen is the <strong data-v-32371207${_scopeId2}>payment page</strong> — delivered to the TPP as a <code data-v-32371207${_scopeId2}>BrokerInstructions.Url</code> on the <code data-v-32371207${_scopeId2}>ApplicationApproved</code> event, then surfaced to the customer by the TPP as a redirect. `);
            } else {
              return [
        ...
        _push2(`<h3 class="ed-doc__subhead" data-v-32371207${_scopeId}>Payment page requirements</h3>`);
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-32371207${_scopeId2}><strong data-v-32371207${_scopeId2}>Branded as LFI</strong> — the customer must clearly see they are paying the insurer, not the TPP. </li><li data-v-32371207${_scopeId2}><strong data-v-32371207${_scopeId2}>Single-use URL</strong> — the URL MUST be invalidated after first redemption or after a reasonable session window (15–30 minutes). The TPP MUST NOT cache or replay it. </li><li data-v-32371207${_scopeId2}><strong data-v-32371207${_scopeId2}>Return handling</strong> — on payment success or cancellation, return the customer to a destination the TPP specified when subscribing to events. The customer\\&#39;s status thereafter is observable to the TPP via subsequent quote-log events (<code data-v-32371207${_scopeId2}>PolicyIssued</code>, <code data-v-32371207${_scopeId2}>CustomerCancelled</code>, etc.). </li><li data-v-32371207${_scopeId2}><strong data-v-32371207${_scopeId2}>No KYC capture</strong> — KYC has already been collected by the TPP and accepted by the LFI before the payment URL is issued. The payment page MUST NOT re-prompt for it. </li>`);
            } else {
              return [
                createVNode("li", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-32371207${_scopeId2}><thead data-v-32371207${_scopeId2}><tr data-v-32371207${_scopeId2}><th data-v-32371207${_scopeId2}>Screen / responsibility</th><th data-v-32371207${_scopeId2}>LFI-Led</th><th data-v-32371207${_scopeId2}>TPP-Led</th></tr></thead><tbody data-v-32371207${_scopeId2}><tr data-v-32371207${_scopeId2}><td data-v-32371207${_scopeId2}>Quote summary &amp; acceptance</td><td data-v-32371207${_scopeId2}>LFI</td><td data-v-32371207${_scopeId2}>TPP</td></tr><tr data-v-32371207${_scopeId2}><td data-v-32371207${_scopeId2}>Customer verification (KYC)</td><td data-v-32371207${_scopeId2}>LFI</td><td data-v-32371207${_scopeId2}>TPP</td></tr><tr data-v-32371207${_scopeId2}><td data-v-32371207${_scopeId2}>Premium payment</td><td data-v-32371207${_scopeId2}>LFI</td><td data-v-32371207${_scopeId2}>LFI (via redirect from TPP)</td></tr><tr data-v-32371207${_scopeId2}><td data-v-32371207${_scopeId2}>Policy document delivery</td><td data-v-32371207${_scopeId2}>LFI (direct to customer)</td><td data-v-32371207${_scopeId2}>TPP (via Documents on PolicyIssued event)</td></tr><tr data-v-32371207${_scopeId2}><td data-v-32371207${_scopeId2}>Post-issuance customer support</td><td data-v-32371207${_scopeId2}>LFI</td><td data-v-32371207${_scopeId2}>LFI (per standard insurance regulatory obligations)</td></tr></tbody></table>`);
            } else {
              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/insurance/quotation/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-32371207"]]);
export {
