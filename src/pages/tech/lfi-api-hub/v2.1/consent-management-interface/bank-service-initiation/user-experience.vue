...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          LFI &middot; CMI &middot; Bank Service Initiation &middot; UX
        </div>
        <h1 class="ed-doc__title">
          Bank Service Initiation &mdash; User Experience
          <span class="ed-doc__read">2 min read</span>
        </h1>
        <p class="ed-doc__lede">
          The LFI Consent Management Interface for Bank Service Initiation (payment) consents.
          Customers see the single payments and Flexi Pay (multi-payment) permissions they have
          granted to third party providers, the payer and payee details, and can cancel an active
    ...
    <EdSectionBand
      ...
      title="LFI Connections &mdash; Payments view"
      tone="cream"
    >
      <EdProse>
        The component below shows the LFI Connections page filtered to payment consents. Tap any
        consent card to open its details and manage it.
      </EdProse>
      ...
      <h3 class="ed-doc__sub">Configure simulated consents and watch the preview respond</h3>
      <EdProse>
        Use the editor below to add, remove, and adjust the simulated consents. Every change is
        reflected immediately in the preview above.
      </EdProse>
      <ConsentConnectionsEditor mode="payments" />
    </EdSectionBand>
