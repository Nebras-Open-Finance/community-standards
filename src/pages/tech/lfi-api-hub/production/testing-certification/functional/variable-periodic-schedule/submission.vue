...
import { variablePeriodicScheduleArea as area } from '@/data/functional-certification/multi-payments'

const explainerPath =
  '/tech/lfi-api-hub/production/testing-certification/functional/variable-periodic-schedule'
</script>
...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          Functional Certification &middot; Variable Periodic Schedule
        </div>
        ...
        <p class="ed-doc__lede">
          ...
          <strong>{{ area.certType }}</strong> Service Desk ticket. New here?
    ...
    <div class="ed-doc__body">
      <div class="ed-doc__inner">
        <FcMultiPaymentPortal :area="area" />
      </div>
    </div>
  </div>
</template>
