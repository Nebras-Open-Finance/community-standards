    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_RedocWrapper, {
          spec: "/openapi/v2.2-rc1/ozone-connect/uae-ozone-connect-health-check-openapi.yaml",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/health-check/open-api/hello-mtls.vue");
