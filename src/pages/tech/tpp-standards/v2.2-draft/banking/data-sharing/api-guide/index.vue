  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        ...
        <li>
          ...
          intend to create a Bank Data Sharing consent.
        </li>
        <li>
        ...
        <li>
          <strong>Understanding of <a href="/tech/tpp-standards/v2.2-draft/consent/">Consents</a></strong>
    ...
    >
      ...
      <EdProse>
        ...
        (<code>urn:openfinanceuae:account-access-consent:v2.2</code>).
      </EdProse>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>enum</td>
              <td>Must be <code>urn:openfinanceuae:account-access-consent:v2.2</code></td>
              <td><code>urn:openfinanceuae:account-access-consent:v2.2</code></td>
            </tr>
            <tr>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>Permissions</code>*</td><td>array&lt;enum&gt;</td><td>List of account access permissions being consented by the user</td><td><code>ReadAccountsBasic</code>, <code>ReadBalances</code></td></tr>
            ...
            <tr><td><code>FromDate</code></td><td>date</td><td>Start date for transaction access (ISO 8601 format)</td><td><code>2023-11-03</code></td></tr>
            <tr><td><code>ToDate</code></td><td>date</td><td>End date for transaction access (ISO 8601 format)</td><td><code>2025-11-03</code></td></tr>
            <tr><td><code>AccountType</code></td><td>array&lt;enum&gt;</td><td>Allowed: <code>Retail</code>, <code>SME</code>, <code>Corporate</code></td><td><code>Retail</code></td></tr>
            <tr><td><code>AccountSubType</code></td><td>array&lt;enum&gt;</td><td>Allowed: <code>CurrentAccount</code>, <code>Savings</code>, <code>CreditCard</code>, <code>Mortgage</code>, <code>Finance</code></td><td><code>Savings</code></td></tr>
    ...
    >
      <EdProse>
        ...
        helper from the FAPI page, passing <code>accounts openid</code> as the scope.
      </EdProse>
    ...
    >
      ...
      <EdNote type="tip" title="User Experience">
        <p>
          See <a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/user-journeys">User Experience</a> for screen mockups of the
      ...
      <EdBullets>
        ...
        <li>Review the consent &mdash; accounts, permissions, and expiry &mdash; on the bank's authorization screen.</li>
    ...
    >
      <EdProse>
        After the user approves, the bank redirects them back to your <code>redirect_uri</code>. The
    ...
    >
      ...
      <EdProse>
        With a valid access token, retrieve all accounts the user consented to share. Include
        <code>x-fapi-interaction-id</code> on every request, and when the customer is present also send
        <code>x-fapi-customer-ip-address</code> and <code>x-customer-user-agent</code> and
        <code>x-fapi-auth-date</code> if the customer has been authenticated. See
      ...
      <EdProse>
        See the
        <a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/open-api/accounts">GET /accounts</a> API
    ...
    >
      <EdProse>
        Use a stored <code>AccountId</code> to fetch data from a specific account's sub-resources. Each
        endpoint requires the matching <code>Read*</code> permission in your consent. Apply the same FAPI
        headers as Step 8.
      </EdProse>

      <EdCodeGroup :tabs="step9Tabs" />

      <EdProse>All available sub-resources and their required permissions:</EdProse>

      <EdRefTable>
        <table>
          <thead>
            <tr><th>Endpoint</th><th>Required Permission</th><th>API Reference</th></tr>
          </thead>
          <tbody>
            <tr><td><code>/accounts/{AccountId}/balances</code></td><td><code>ReadBalances</code></td><td><a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-balances">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/transactions</code></td><td><code>ReadTransactionsBasic</code></td><td><a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-transactions">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/beneficiaries</code></td><td><code>ReadBeneficiariesBasic</code></td><td><a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-beneficiaries">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/direct-debits</code></td><td><code>ReadDirectDebits</code></td><td><a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-direct-debits">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/standing-orders</code></td><td><code>ReadStandingOrdersBasic</code></td><td><a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-standing-orders">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/scheduled-payments</code></td><td><code>ReadScheduledPaymentsBasic</code></td><td><a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-scheduled-payments">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/statements</code></td><td><code>ReadStatements</code></td><td><a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-statements">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/parties</code></td><td><code>ReadParty</code></td><td><a href="/tech/tpp-standards/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-parties">reference</a></td></tr>
          </tbody>
        </table>
      </EdRefTable>
