...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-2b5f1f10><section class="ed-doc__hero" data-v-2b5f1f10><div class="ed-doc__inner" data-v-2b5f1f10><div class="ed-doc__eyebrow" data-v-2b5f1f10><span class="ed-doc__eyebrow-dash" data-v-2b5f1f10></span> TPP · Banking · Service Initiation · Delegated SCA </div><h1 class="ed-doc__title" data-v-2b5f1f10> Delegated SCA — API Guide <span class="ed-doc__read" data-v-2b5f1f10>4 min read</span></h1><p class="ed-doc__lede" data-v-2b5f1f10> A Delegated SCA consent authorises a TPP to initiate <strong data-v-2b5f1f10>multiple payments</strong> at variable amounts over the lifetime of the consent. The user authorises the consent once. Unlike other multi-payments a Delegated SCA consent does not contain predefined control parameters. Instead, the TPP is responsible for performing Strong Customer Authentication (SCA) on the user before each payment request (POST /payments). </p><p class="ed-doc__lede" data-v-2b5f1f10> Common use cases include digital wallet experiences where the TPP authenticates the user within its own app, as well as usage-based services such as taxi rides, EV charging sessions, and other metered services where the final charge is presented to the user after the service is completed. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-2b5f1f10${_scopeId2}><strong data-v-2b5f1f10${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-2b5f1f10${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the <strong data-v-2b5f1f10${_scopeId2}>BSIP role</strong> as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-2b5f1f10${_scopeId2}>Roles</a>. </li><li data-v-2b5f1f10${_scopeId2}><strong data-v-2b5f1f10${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-2b5f1f10${_scopeId2}>Transport Certificate</a></strong> — an active transport certificate must be issued and registered in the Trust Framework to establish secure <strong data-v-2b5f1f10${_scopeId2}>mTLS communication</strong>. </li><li data-v-2b5f1f10${_scopeId2}><strong data-v-2b5f1f10${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-2b5f1f10${_scopeId2}>Signing Certificate</a></strong> — an active signing certificate must be issued and registered in the Trust Framework. This certificate is used to sign request objects and client assertions. </li><li data-v-2b5f1f10${_scopeId2}><strong data-v-2b5f1f10${_scopeId2}>Registration with the relevant <a href="/tech/tpp-standards/registration/api-guide" data-v-2b5f1f10${_scopeId2}>API Hub (Authorisation Server)</a></strong> — the application must be registered with the API Hub (Server) of the LFI with which you intend to initiate payments. </li><li data-v-2b5f1f10${_scopeId2}><strong data-v-2b5f1f10${_scopeId2}>Understanding of the <a href="/tech/tpp-standards/security/fapi/" data-v-2b5f1f10${_scopeId2}>FAPI Security Profile</a></strong> and <strong data-v-2b5f1f10${_scopeId2}><a href="/tech/tpp-standards/security/tokens/" data-v-2b5f1f10${_scopeId2}>Tokens &amp; Assertions</a></strong> — you should understand how request object signing, client authentication, and access token validation underpin secure API interactions. </li><li data-v-2b5f1f10${_scopeId2}><strong data-v-2b5f1f10${_scopeId2}>Understanding of <a href="/tech/tpp-standards/security/fapi/message-encryption" data-v-2b5f1f10${_scopeId2}>Message Encryption</a></strong> — PII (creditor name and account details) must be encrypted as a JWE before being embedded in the consent. You will need the LFI&#39;s public encryption key from their JWKS. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-2b5f1f10${_scopeId}><span class="http-badge http-post" data-v-2b5f1f10${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-2b5f1f10${_scopeId}>/par</code></div>`);
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2b5f1f10${_scopeId2}> Unlike standard payment flows, Delegated SCA <strong data-v-2b5f1f10${_scopeId2}>MUST</strong> prove the SCA already performed at the TPP. At minimum, <code data-v-2b5f1f10${_scopeId2}>Risk.DebtorIndicators.Authentication</code> must demonstrate MFA with two distinct factors, and the wider <code data-v-2b5f1f10${_scopeId2}>Risk</code> block must be fully populated with everything derivable from your system. </p>`);
                  _push3(ssrRenderComponent(_component_EdCode, {
                    code: riskJson,
                    lang: "jsonc",
                    filename: "Risk block"
                  }, null, _parent3, _scopeId2));
                  _push3(`<p data-v-2b5f1f10${_scopeId2}> See the <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/risk#delegated-sca-payment" data-v-2b5f1f10${_scopeId2}>Delegated SCA Payment example</a> for a fully-populated version and the <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/risk" data-v-2b5f1f10${_scopeId2}>Risk reference</a> for the field-by-field schema. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                    ...
                    createVNode("p", null, [
                      ...
                      createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/risk#delegated-sca-payment" }, "Delegated SCA Payment example"),
                      createTextVNode(" for a fully-populated version and the "),
                      createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/risk" }, "Risk reference"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` With the encrypted PII ready, construct the <code data-v-2b5f1f10${_scopeId2}>authorization_details</code> of type <code data-v-2b5f1f10${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.1</code>. For Delegated SCA you <strong data-v-2b5f1f10${_scopeId2}>must</strong> set <code data-v-2b5f1f10${_scopeId2}>ControlParameters.IsDelegatedAuthentication</code> to <code data-v-2b5f1f10${_scopeId2}>true</code> and leave <code data-v-2b5f1f10${_scopeId2}>ConsentSchedule</code> empty, indicating that the TPP will perform SCA on the user before each <span class="endpoint" data-v-2b5f1f10${_scopeId2}><span class="http-method http-method--post" data-v-2b5f1f10${_scopeId2}>POST</span><code data-v-2b5f1f10${_scopeId2}>/payments</code></span> request. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-2b5f1f10${_scopeId}>authorization_details</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-2b5f1f10${_scopeId2}><thead data-v-2b5f1f10${_scopeId2}><tr data-v-2b5f1f10${_scopeId2}><th data-v-2b5f1f10${_scopeId2}>Field</th><th data-v-2b5f1f10${_scopeId2}>Type</th><th data-v-2b5f1f10${_scopeId2}>Description</th><th data-v-2b5f1f10${_scopeId2}>Example</th></tr></thead><tbody data-v-2b5f1f10${_scopeId2}><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>type</code>*</td><td data-v-2b5f1f10${_scopeId2}>enum</td><td data-v-2b5f1f10${_scopeId2}>Must be <code data-v-2b5f1f10${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.1</code></td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.1</code></td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>consent</code>*</td><td data-v-2b5f1f10${_scopeId2}>object</td><td data-v-2b5f1f10${_scopeId2}>Consent properties agreed by the User with the TPP. <em data-v-2b5f1f10${_scopeId2}>Described below.</em></td><td data-v-2b5f1f10${_scopeId2}>—</td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>subscription</code></td><td data-v-2b5f1f10${_scopeId2}>object</td><td data-v-2b5f1f10${_scopeId2}>Optional subscription to Event Notifications via Webhook. <em data-v-2b5f1f10${_scopeId2}>Described below.</em></td><td data-v-2b5f1f10${_scopeId2}>—</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-2b5f1f10${_scopeId}>consent (Required) | <code data-v-2b5f1f10${_scopeId}>authorization_details.consent</code></h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-2b5f1f10${_scopeId2}><thead data-v-2b5f1f10${_scopeId2}><tr data-v-2b5f1f10${_scopeId2}><th data-v-2b5f1f10${_scopeId2}>Field</th><th data-v-2b5f1f10${_scopeId2}>Type</th><th data-v-2b5f1f10${_scopeId2}>Description</th><th data-v-2b5f1f10${_scopeId2}>Example</th></tr></thead><tbody data-v-2b5f1f10${_scopeId2}><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>ConsentId</code>*</td><td data-v-2b5f1f10${_scopeId2}>string (uuid)</td><td data-v-2b5f1f10${_scopeId2}>Unique ID assigned by the TPP (1–128 chars)</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>b8f42378-10ac-46a1-8d20-4e020484216d</code></td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>IsSingleAuthorization</code>*</td><td data-v-2b5f1f10${_scopeId2}>boolean</td><td data-v-2b5f1f10${_scopeId2}>Whether the payment requires only one authorizing party</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>true</code></td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>ExpirationDateTime</code>*</td><td data-v-2b5f1f10${_scopeId2}>date-time</td><td data-v-2b5f1f10${_scopeId2}>Consent expiry (ISO 8601 with timezone, max 1 year)</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>2027-03-02T00:00:00+00:00</code></td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>AuthorizationExpirationDateTime</code></td><td data-v-2b5f1f10${_scopeId2}>date-time</td><td data-v-2b5f1f10${_scopeId2}>Deadline by which all authorizers must have acted (multi-authorization only). SHOULD be set when <code data-v-2b5f1f10${_scopeId2}>IsSingleAuthorization</code> is <code data-v-2b5f1f10${_scopeId2}>false</code>; SHOULD NOT be set when <code data-v-2b5f1f10${_scopeId2}>IsSingleAuthorization</code> is <code data-v-2b5f1f10${_scopeId2}>true</code>. MUST NOT be after <code data-v-2b5f1f10${_scopeId2}>ExpirationDateTime</code>.</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>2026-03-03T10:00:00+00:00</code></td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>BaseConsentId</code></td><td data-v-2b5f1f10${_scopeId2}>string (uuid)</td><td data-v-2b5f1f10${_scopeId2}>Links to prior consent if renewing — see <a href="/knowledge-base/articles/base-consent-id" data-v-2b5f1f10${_scopeId2}>Base Consent ID</a></td><td data-v-2b5f1f10${_scopeId2}>—</td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>Permissions</code></td><td data-v-2b5f1f10${_scopeId2}>array&lt;enum&gt;</td><td data-v-2b5f1f10${_scopeId2}>Optional access permissions granted alongside the payment consent</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>ReadAccountsBasic</code>, <code data-v-2b5f1f10${_scopeId2}>ReadBalances</code></td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>ControlParameters</code>*</td><td data-v-2b5f1f10${_scopeId2}>object</td><td data-v-2b5f1f10${_scopeId2}>Must include <code data-v-2b5f1f10${_scopeId2}>IsDelegatedAuthentication: true</code> and an empty <code data-v-2b5f1f10${_scopeId2}>ConsentSchedule</code></td><td data-v-2b5f1f10${_scopeId2}>—</td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>PersonalIdentifiableInformation</code>*</td><td data-v-2b5f1f10${_scopeId2}>string (JWE)</td><td data-v-2b5f1f10${_scopeId2}>Encrypted creditor and risk data — the <code data-v-2b5f1f10${_scopeId2}>encryptedPII</code> string from Step 1</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>eyJhbGci...</code></td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>PaymentPurposeCode</code>*</td><td data-v-2b5f1f10${_scopeId2}>string (3 chars)</td><td data-v-2b5f1f10${_scopeId2}>AANI payment purpose code</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>ACM</code></td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>DebtorReference</code></td><td data-v-2b5f1f10${_scopeId2}>string</td><td data-v-2b5f1f10${_scopeId2}>Reference shown on the debtor&#39;s statement</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>Subscription</code></td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>CreditorReference</code></td><td data-v-2b5f1f10${_scopeId2}>string</td><td data-v-2b5f1f10${_scopeId2}>Reference shown on the creditor&#39;s statement</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>Subscription</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-2b5f1f10${_scopeId}>ControlParameters — Delegated SCA</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-2b5f1f10${_scopeId2}><thead data-v-2b5f1f10${_scopeId2}><tr data-v-2b5f1f10${_scopeId2}><th data-v-2b5f1f10${_scopeId2}>Field</th><th data-v-2b5f1f10${_scopeId2}>Required</th><th data-v-2b5f1f10${_scopeId2}>Description</th><th data-v-2b5f1f10${_scopeId2}>Example</th></tr></thead><tbody data-v-2b5f1f10${_scopeId2}><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>IsDelegatedAuthentication</code></td><td data-v-2b5f1f10${_scopeId2}>Yes</td><td data-v-2b5f1f10${_scopeId2}>Must be <code data-v-2b5f1f10${_scopeId2}>true</code> to indicate the TPP will perform SCA before every payment request</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>true</code></td></tr><tr data-v-2b5f1f10${_scopeId2}><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>ConsentSchedule</code></td><td data-v-2b5f1f10${_scopeId2}>Yes</td><td data-v-2b5f1f10${_scopeId2}>Leave empty <code data-v-2b5f1f10${_scopeId2}>{}</code> — no bank-enforced caps or schedules are defined on the consent</td><td data-v-2b5f1f10${_scopeId2}><code data-v-2b5f1f10${_scopeId2}>{}</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2b5f1f10${_scopeId2}> Any spend, frequency are enforced by the TPP and Strong Customer Authentication must be done before each Payment. </p>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-2b5f1f10${_scopeId}>Example request</h3>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2b5f1f10${_scopeId2}> Save <code data-v-2b5f1f10${_scopeId2}>codeVerifier</code> in your server-side session or an <code data-v-2b5f1f10${_scopeId2}>httpOnly</code> cookie — you will need it in <a href="#step-8-post-token-authorization-code" data-v-2b5f1f10${_scopeId2}>Step 8</a> to exchange the authorization code for tokens. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/fapi/request-jwt" data-v-2b5f1f10${_scopeId2}>Preparing the Request JWT</a> for the full JWT claim reference and PKCE helpers. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-2b5f1f10${_scopeId2}>authorization_endpoint</code> is found in the LFI&#39;s <code data-v-2b5f1f10${_scopeId2}>.well-known/openid-configuration</code> — not constructed from the issuer URL directly. `);
                } else {
                  return [
                    createTextVNode(" The "),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-2b5f1f10${_scopeId2}>The TPP name and purpose.</li><li data-v-2b5f1f10${_scopeId2}>That payments will be authenticated by the TPP (Delegated SCA).</li><li data-v-2b5f1f10${_scopeId2}>The consent expiry date.</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2b5f1f10${_scopeId2}> See <a href="./user-journeys" data-v-2b5f1f10${_scopeId2}>User Experience</a> for screen mockups of the Delegated SCA <strong data-v-2b5f1f10${_scopeId2}>Consent</strong> and <strong data-v-2b5f1f10${_scopeId2}>Authorization</strong> pages the user sees at the bank. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" See "),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-2b5f1f10${_scopeId}><span class="http-badge http-post" data-v-2b5f1f10${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-2b5f1f10${_scopeId}>/token</code></div>`);
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-2b5f1f10${_scopeId}><span class="http-badge http-post" data-v-2b5f1f10${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-2b5f1f10${_scopeId}>/payments</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Include <code data-v-2b5f1f10${_scopeId2}>x-fapi-interaction-id</code> and <code data-v-2b5f1f10${_scopeId2}>x-idempotency-key</code>. As the customer must always have been present and authenticated for the TPP to instruct a delegated SCA payment, also send <code data-v-2b5f1f10${_scopeId2}>x-fapi-customer-ip-address</code>, <code data-v-2b5f1f10${_scopeId2}>x-customer-user-agent</code> and <code data-v-2b5f1f10${_scopeId2}>x-fapi-auth-date</code>. See <a href="/tech/tpp-standards/security/request-headers" data-v-2b5f1f10${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2b5f1f10${_scopeId2}> Unlike Single Instant Payment, multi-payment consents do not require <code data-v-2b5f1f10${_scopeId2}>PaymentPurposeCode</code>, <code data-v-2b5f1f10${_scopeId2}>DebtorReference</code>, <code data-v-2b5f1f10${_scopeId2}>CreditorReference</code>, or <code data-v-2b5f1f10${_scopeId2}>OpenFinanceBilling</code> to match the consent exactly. Only <code data-v-2b5f1f10${_scopeId2}>ConsentId</code> must match the authorized consent. <code data-v-2b5f1f10${_scopeId2}>Instruction.Amount</code> must be within the parameters the consent allows for this payment type. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2b5f1f10${_scopeId2}> After each successful payment, the consent remains in the <code data-v-2b5f1f10${_scopeId2}>Authorized</code> state until it expires or is revoked. You do <strong data-v-2b5f1f10${_scopeId2}>not</strong> need to re-initiate the authorization flow. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/multi-payments/delegated-sca/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2b5f1f10"]]);
export {
  apiGuide as default
};
