...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-84327717><section class="ed-doc__hero" data-v-84327717><div class="ed-doc__inner" data-v-84327717><div class="ed-doc__eyebrow" data-v-84327717><span class="ed-doc__eyebrow-dash" data-v-84327717></span> LFI · Banking · Service Initiation · PII · API Guide </div><h1 class="ed-doc__title" data-v-84327717> Verifying the TPP JWS Signature <span class="ed-doc__read" data-v-84327717>2 min read</span></h1>`);
      _push(ssrRenderComponent(_component_EdNote, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-84327717${_scopeId}> The <code data-v-84327717${_scopeId}>PersonalIdentifiableInformation</code> field is embedded within a request that the API Hub has already verified was signed by the TPP. The outer JWS signature confirms that the PII was submitted by the authenticated TPP and has not been modified in transit. </p><p data-v-84327717${_scopeId}> Verifying the inner JWS signature on the PII payload is therefore <strong data-v-84327717${_scopeId}>not required</strong>, but LFIs may choose to implement it as a defence-in-depth measure. </p>`);
          } else {
            return [
              createVNode("p", null, [
                createTextVNode(" The "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-84327717${_scopeId2}>Your security policy requires independent verification of all signed payloads, regardless of upstream validation.</li><li data-v-84327717${_scopeId2}>You want to confirm the specific TPP identity that constructed the PII (available in the <code data-v-84327717${_scopeId2}>iss</code> and <code data-v-84327717${_scopeId2}>sub</code> claims).</li><li data-v-84327717${_scopeId2}>You are building an audit trail that requires cryptographic proof tied to the TPP&#39;s signing key.</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The inner JWS (the result of decrypting the JWE) is signed by the TPP using their signing key. The JWS header contains the <code data-v-84327717${_scopeId2}>kid</code> of the TPP&#39;s signing key, and the <code data-v-84327717${_scopeId2}>iss</code> / <code data-v-84327717${_scopeId2}>sub</code> claims identify the TPP&#39;s <code data-v-84327717${_scopeId2}>client_id</code>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-84327717${_scopeId}>Step 1 — Discover the TPP&#39;s JWKS</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The TPP&#39;s public signing keys are published through the Trust Framework directory. You can resolve the TPP&#39;s JWKS URI using the <code data-v-84327717${_scopeId2}>o3-caller-software-statement-id</code> header from the inbound request: `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-84327717${_scopeId}>Step 2 — Verify the JWS</h3>`);
            _push2(ssrRenderComponent(_component_EdCodeGroup, { tabs: verifyTabs }, null, _parent2, _scopeId));
            _push2(`<h3 class="ed-doc__subhead" data-v-84327717${_scopeId}>Claims to validate</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-84327717${_scopeId2}><thead data-v-84327717${_scopeId2}><tr data-v-84327717${_scopeId2}><th data-v-84327717${_scopeId2}>Claim</th><th data-v-84327717${_scopeId2}>Validation</th></tr></thead><tbody data-v-84327717${_scopeId2}><tr data-v-84327717${_scopeId2}><td data-v-84327717${_scopeId2}><code data-v-84327717${_scopeId2}>iss</code></td><td data-v-84327717${_scopeId2}>Must match the TPP&#39;s <code data-v-84327717${_scopeId2}>client_id</code> (available in the <code data-v-84327717${_scopeId2}>o3-caller-client-id</code> request header)</td></tr><tr data-v-84327717${_scopeId2}><td data-v-84327717${_scopeId2}><code data-v-84327717${_scopeId2}>sub</code></td><td data-v-84327717${_scopeId2}>Must match the TPP&#39;s <code data-v-84327717${_scopeId2}>client_id</code></td></tr><tr data-v-84327717${_scopeId2}><td data-v-84327717${_scopeId2}><code data-v-84327717${_scopeId2}>aud</code></td><td data-v-84327717${_scopeId2}>Must contain your LFI&#39;s issuer identifier</td></tr><tr data-v-84327717${_scopeId2}><td data-v-84327717${_scopeId2}><code data-v-84327717${_scopeId2}>exp</code></td><td data-v-84327717${_scopeId2}>Must not be expired</td></tr><tr data-v-84327717${_scopeId2}><td data-v-84327717${_scopeId2}><code data-v-84327717${_scopeId2}>iat</code></td><td data-v-84327717${_scopeId2}>Must be in the past</td></tr><tr data-v-84327717${_scopeId2}><td data-v-84327717${_scopeId2}><code data-v-84327717${_scopeId2}>jti</code></td><td data-v-84327717${_scopeId2}>Record for replay detection if required by your security policy</td></tr></tbody></table>`);
                } else {
                  return [
...
const verifyTppSignature = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-84327717"]]);
export {
