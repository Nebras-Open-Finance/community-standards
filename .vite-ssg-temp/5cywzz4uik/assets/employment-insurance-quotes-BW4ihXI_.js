    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_RedocWrapper, {
          ...
          filterPath: "/employment-insurance-quotes",
          filterMethod: "post",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/insurance/quotation/open-api/employment-insurance-quotes.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const employmentInsuranceQuotes = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  employmentInsuranceQuotes as default
};
