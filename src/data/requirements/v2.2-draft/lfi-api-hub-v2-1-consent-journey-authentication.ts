...
export const data: RequirementsPageData = {
  ...
  preconditions: 'For the full <code>doFail</code> API specification, see the <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/open-api/auth-interactionId-doFail"><code>POST /auth/{interactionId}/doFail</code> API Reference</a>.',
  sections: [
    {
      id: 'error-scenarios',
      num: '01',
