...
import { W as WireframePreview, A as AccountSetup, U as UIBehaviour, E as ExampleJourneys } from "./ExampleJourneys-BkIFyqnA.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const myCustomValidator = (value) => {
      ...
      const periodStartDate2 = (_O = (_N = (_M = (_L = (_K = value == null ? void 0 : value.Data) == null ? void 0 : _K.ControlParameters) == null ? void 0 : _L.ConsentSchedule) == null ? void 0 : _M.MultiPayment) == null ? void 0 : _N.PeriodicSchedule) == null ? void 0 : _O.PeriodStartDate;
      if (periodStartDate2) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-0a80d0bc><section class="ed-doc__hero" data-v-0a80d0bc><div class="ed-doc__inner" data-v-0a80d0bc><div class="ed-doc__eyebrow" data-v-0a80d0bc><span class="ed-doc__eyebrow-dash" data-v-0a80d0bc></span> Banking · Service Initiation · Fixed On Demand · UX </div><h1 class="ed-doc__title" data-v-0a80d0bc> Fixed On Demand — User Experience <span class="ed-doc__read" data-v-0a80d0bc>4 min read</span></h1><p class="ed-doc__lede" data-v-0a80d0bc> When a customer is redirected to you to authorize a Fixed On Demand payment consent through Open Finance, you must present an <strong data-v-0a80d0bc>Authorization Page</strong> that clearly explains the payment the customer is authorizing — that multiple payments of a fixed amount will be made at any time of the TPP&#39;s choosing. The page must collect the customer&#39;s explicit and informed consent, and it must accurately reflect the key details of the consent (payee, the fixed amount per payment, the first payment date, etc.) </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-0a80d0bc> The examples and interactive wireframes provided below define the expected structure, content, and behavior of the Authorization Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-0a80d0bc> While you may adapt visual elements such as color palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the payment information shown. The representation of <strong data-v-0a80d0bc>AlTareq</strong> (including logos, naming, and action buttons) must be preserved at all times. The customer must be able to clearly understand what payment they are authorizing and that the authorization is part of the AlTareq ecosystem. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-0a80d0bc> Your Authorization Page must be submitted as part of <strong data-v-0a80d0bc>CX certification</strong> prior to production. Any material changes to a production Authorization Page must also be resubmitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the request body fields below and watch the <strong data-v-0a80d0bc${_scopeId2}>Consent</strong> and <strong data-v-0a80d0bc${_scopeId2}>Authorisation</strong> page previews update live. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-on-demand/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0a80d0bc"]]);
export {
