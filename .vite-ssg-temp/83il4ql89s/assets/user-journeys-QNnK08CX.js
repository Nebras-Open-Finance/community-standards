...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const myCustomValidator = (value) => {
      var _a, _b, _c;
      if (!(value == null ? void 0 : value.consent) || !((_a = value == null ? void 0 : value.consent) == null ? void 0 : _a.ControlParameters) || ((_c = (_b = value == null ? void 0 : value.consent) == null ? void 0 : _b.ControlParameters) == null ? void 0 : _c.IsDelegatedAuthentication) !== true) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-f98e9348><section class="ed-doc__hero" data-v-f98e9348><div class="ed-doc__inner" data-v-f98e9348><div class="ed-doc__eyebrow" data-v-f98e9348><span class="ed-doc__eyebrow-dash" data-v-f98e9348></span> Banking · Service Initiation · Delegated SCA · UX </div><h1 class="ed-doc__title" data-v-f98e9348> Delegated SCA — User Experience <span class="ed-doc__read" data-v-f98e9348>4 min read</span></h1><p class="ed-doc__lede" data-v-f98e9348> Before a customer authorises a Delegated SCA payment consent through Open Finance, you must present a <strong data-v-f98e9348>Consent Page</strong> that clearly explains that you are seeking permission to initiate payments on their behalf, but that the customer will be required to authenticate and approve each individual payment before it is executed — no payment will be taken automatically. This page must accurately reflect the payee and the nature of the delegated consent being granted. No payment amounts or schedule are shown at this stage as each payment will require separate customer authorisation. The examples and interactive wireframes below define the expected structure, content, and behaviour of the Consent Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-f98e9348> While you may adapt visual elements such as colour palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the payment information shown, and the representation of <strong data-v-f98e9348>AlTareq</strong> (including logos, naming, and action buttons) must be preserved. The customer must always be able to clearly understand what payment they are consenting to and that it is part of the AlTareq ecosystem. Your Consent Page must be submitted as part of <strong data-v-f98e9348>CX certification</strong> prior to production, and any material changes to a production Consent Page must be re-submitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the request body fields below and watch the <strong data-v-f98e9348${_scopeId2}>Consent</strong> and <strong data-v-f98e9348${_scopeId2}>Authorisation</strong> page previews update live. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/delegated-sca/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f98e9348"]]);
export {
