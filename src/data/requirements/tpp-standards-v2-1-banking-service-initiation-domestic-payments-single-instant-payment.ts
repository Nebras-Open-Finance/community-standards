...
export const data: RequirementsPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      rules: [
        { field: '<code>Initiation.DebtorAccount</code> ownership', rule: 'If <code>Initiation.DebtorAccount</code> was provided on the consent and the authenticated PSU does not hold that account, the consent will be set to <code>Rejected</code> with <code>error</code>: <code>invalid_request</code> and <code>error_description</code>: <code>user_does_not_own_debtor_account</code>.', validatedBy: 'LFI' },
        { field: '<code>consent.IsSingleAuthorization</code>', rule: 'If <code>true</code>, only accounts that the authenticated PSU can solely authorize (no subsequent approvers required) may be offered and selected. If <code>false</code> or not provided (default), accounts where the PSU is one of multiple required authorizers may also be offered; subsequent authorizers must then approve the consent before the consent reaches <code>Authorized</code> status and any payment can be executed. See <a href="/tech/tpp-standards/v2.1/banking/service-initiation/multi-authorization">Multi-Authorization</a>.', validatedBy: 'LFI' },
        { field: 'Eligible payment accounts', rule: 'If the authenticated PSU does not hold any account eligible to initiate a payment under this consent, the consent will be set to <code>Rejected</code> with <code>error</code>: <code>invalid_request</code> and <code>error_description</code>: <code>user_lacks_eligible_accounts</code>. The eligible set is constrained by <code>consent.IsSingleAuthorization</code> as described above.', validatedBy: 'LFI' },
      ],
    },
    {
