import { _ as __unplugin_components_6$2, a as __unplugin_components_7$1 } from "./EdRelatedCards-D4uHHv56.js";
import { _ as __unplugin_components_5 } from "./EdNote-61YjJPRT.js";
import { _ as __unplugin_components_7, a as __unplugin_components_8 } from "./EdCompareCards-C6m0qiyo.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-39d5bec2>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-39d5bec2${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-39d5bec2${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-39d5bec2${_scopeId2}><thead data-v-39d5bec2${_scopeId2}><tr data-v-39d5bec2${_scopeId2}><th data-v-39d5bec2${_scopeId2}>You need…</th><th data-v-39d5bec2${_scopeId2}>Use</th></tr></thead><tbody data-v-39d5bec2${_scopeId2}><tr data-v-39d5bec2${_scopeId2}><td data-v-39d5bec2${_scopeId2}>Exactly one payment, executed immediately</td><td data-v-39d5bec2${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/api-guide" data-v-39d5bec2${_scopeId2}>Single Instant Payment</a></td></tr><tr data-v-39d5bec2${_scopeId2}><td data-v-39d5bec2${_scopeId2}>More than one payment under the same authorisation</td><td data-v-39d5bec2${_scopeId2}>One of the six <a href="#multi" data-v-39d5bec2${_scopeId2}>Multi-Payment</a> variants</td></tr></tbody></table>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-39d5bec2${_scopeId2}><strong data-v-39d5bec2${_scopeId2}>When to use:</strong> A checkout, an ad-hoc bill, a one-off transfer — any situation where the user is making a single payment decision in the moment.</li><li data-v-39d5bec2${_scopeId2}><strong data-v-39d5bec2${_scopeId2}>What&#39;s known up front:</strong> The exact amount, the creditor, the payment purpose.</li><li data-v-39d5bec2${_scopeId2}><strong data-v-39d5bec2${_scopeId2}>Re-authorisation:</strong> Every payment is its own consent. There is no &quot;next payment&quot; under the same authorisation.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-39d5bec2${_scopeId2}><strong data-v-39d5bec2${_scopeId2}>How much is each payment for?</strong> — <strong data-v-39d5bec2${_scopeId2}>Fixed</strong> means every payment is the same amount; <strong data-v-39d5bec2${_scopeId2}>Variable</strong> means each payment is capped at a per-payment ceiling but can come in for less.</li><li data-v-39d5bec2${_scopeId2}><strong data-v-39d5bec2${_scopeId2}>When does each payment run?</strong> — <strong data-v-39d5bec2${_scopeId2}>OnDemand</strong> means the TPP triggers each payment whenever it wants; <strong data-v-39d5bec2${_scopeId2}>PeriodicSchedule</strong> means one payment per recurring period (monthly, weekly, etc.); <strong data-v-39d5bec2${_scopeId2}>DefinedSchedule</strong> means a pre-agreed list of specific calendar dates.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-39d5bec2${_scopeId2}><thead data-v-39d5bec2${_scopeId2}><tr data-v-39d5bec2${_scopeId2}><th data-v-39d5bec2${_scopeId2}>Amount</th><th data-v-39d5bec2${_scopeId2}>Timing</th><th data-v-39d5bec2${_scopeId2}>Variant</th></tr></thead><tbody data-v-39d5bec2${_scopeId2}><tr data-v-39d5bec2${_scopeId2}><td data-v-39d5bec2${_scopeId2}>Fixed per payment</td><td data-v-39d5bec2${_scopeId2}>TPP triggers each payment</td><td data-v-39d5bec2${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/multi-payments/fixed-on-demand/api-guide" data-v-39d5bec2${_scopeId2}>FixedOnDemand</a></td></tr><tr data-v-39d5bec2${_scopeId2}><td data-v-39d5bec2${_scopeId2}>Variable up to a per-payment cap</td><td data-v-39d5bec2${_scopeId2}>TPP triggers each payment</td><td data-v-39d5bec2${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/multi-payments/variable-on-demand/api-guide" data-v-39d5bec2${_scopeId2}>VariableOnDemand</a></td></tr><tr data-v-39d5bec2${_scopeId2}><td data-v-39d5bec2${_scopeId2}>Fixed per payment</td><td data-v-39d5bec2${_scopeId2}>One per recurring period (e.g. monthly)</td><td data-v-39d5bec2${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/multi-payments/fixed-periodic-schedule/api-guide" data-v-39d5bec2${_scopeId2}>FixedPeriodicSchedule</a></td></tr><tr data-v-39d5bec2${_scopeId2}><td data-v-39d5bec2${_scopeId2}>Variable up to a per-payment cap</td><td data-v-39d5bec2${_scopeId2}>One per recurring period</td><td data-v-39d5bec2${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/multi-payments/variable-periodic-schedule/api-guide" data-v-39d5bec2${_scopeId2}>VariablePeriodicSchedule</a></td></tr><tr data-v-39d5bec2${_scopeId2}><td data-v-39d5bec2${_scopeId2}>Exact amount known for each dated payment</td><td data-v-39d5bec2${_scopeId2}>List of specific calendar dates</td><td data-v-39d5bec2${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/multi-payments/fixed-defined-schedule/api-guide" data-v-39d5bec2${_scopeId2}>FixedDefinedSchedule</a></td></tr><tr data-v-39d5bec2${_scopeId2}><td data-v-39d5bec2${_scopeId2}>Per-date ceiling, actual amount may differ</td><td data-v-39d5bec2${_scopeId2}>List of specific calendar dates</td><td data-v-39d5bec2${_scopeId2}><a href="/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/multi-payments/variable-defined-schedule/api-guide" data-v-39d5bec2${_scopeId2}>VariableDefinedSchedule</a></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 data-v-39d5bec2${_scopeId}>On-demand — the TPP triggers each payment</h3>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-39d5bec2${_scopeId3}><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>When to use:</strong> Fixed-amount subscription billing, regular instalment collection, membership fees — the charge is always the same, and the TPP (not the calendar) decides when to take it.</li><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>What&#39;s known up front:</strong> The per-payment amount (<code data-v-39d5bec2${_scopeId3}>PeriodicSchedule.Amount</code>), the creditor, and cumulative caps via <code data-v-39d5bec2${_scopeId3}>PeriodicSchedule.PeriodType</code>.</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                            createVNode("li", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-39d5bec2${_scopeId3}><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>When to use:</strong> Metered billing, utility top-ups, variable-charge subscriptions, TPP-managed savings sweeps — both the amount and the timing depend on usage or TPP logic, not a calendar.</li><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>What&#39;s known up front:</strong> The per-payment ceiling (<code data-v-39d5bec2${_scopeId3}>MaximumIndividualAmount</code>), cumulative caps via <code data-v-39d5bec2${_scopeId3}>PeriodicSchedule.PeriodType</code>, and optional <code data-v-39d5bec2${_scopeId3}>Controls</code> on total count and total value across the consent.</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                            createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-39d5bec2${_scopeId2}>On on-demand variants, <code data-v-39d5bec2${_scopeId2}>PeriodicSchedule.PeriodType</code> (<code data-v-39d5bec2${_scopeId2}>Day</code>, <code data-v-39d5bec2${_scopeId2}>Week</code>, <code data-v-39d5bec2${_scopeId2}>Month</code>, …) defines the <strong data-v-39d5bec2${_scopeId2}>reference window for cumulative limits</strong> — e.g. &quot;no more than N payments totalling X AED per rolling month&quot;. It is <strong data-v-39d5bec2${_scopeId2}>not</strong> a recurrence schedule. The TPP still triggers every payment explicitly.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 data-v-39d5bec2${_scopeId}>Periodic schedule — one payment per period</h3>`);
            _push2(ssrRenderComponent(_component_EdCompareCards, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-39d5bec2${_scopeId3}><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>When to use:</strong> Fixed-price subscriptions, loan repayments, membership dues — predictable recurring charges that follow a calendar.</li><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>What&#39;s known up front:</strong> The per-payment amount and the period cadence. The LFI will only permit <strong data-v-39d5bec2${_scopeId3}>one payment per period</strong> under this consent.</li><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>vs FixedOnDemand:</strong> Same fixed amount, but the calendar — not the TPP — gates payment frequency.</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                            createVNode("li", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-39d5bec2${_scopeId3}><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>When to use:</strong> Utility bills, variable monthly service charges, TPP-managed savings where the amount differs each period but must stay within a pre-approved cap.</li><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>What&#39;s known up front:</strong> The per-payment ceiling (<code data-v-39d5bec2${_scopeId3}>MaximumIndividualAmount</code>) and the period cadence. One payment per period, actual amount variable within the cap.</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                            createVNode("li", null, [
            ...
            _push2(`<h3 data-v-39d5bec2${_scopeId}>Defined schedule — a pre-agreed list of dates</h3>`);
            _push2(ssrRenderComponent(_component_EdCompareCards, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-39d5bec2${_scopeId3}><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>When to use:</strong> Structured instalment plans, staged loan repayments, any case where both dates and amounts are known and agreed up front (e.g. &quot;AED 500 on the 1st of each of Jan/Apr/Jul/Oct&quot;).</li><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>What&#39;s known up front:</strong> Every <code data-v-39d5bec2${_scopeId3}>(PaymentExecutionDate, Amount)</code> pair in the <code data-v-39d5bec2${_scopeId3}>Schedule</code> array. The TPP submits exactly one payment per scheduled entry, for exactly the listed amount.</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                            createVNode("li", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-39d5bec2${_scopeId3}><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>When to use:</strong> Milestone-based project billing, staged payments where the dates are fixed but the final amount on each date depends on delivered work or usage.</li><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>What&#39;s known up front:</strong> Every <code data-v-39d5bec2${_scopeId3}>(PaymentExecutionDate, MaximumIndividualAmount)</code> pair. The TPP submits one payment per scheduled entry, at or below the listed ceiling.</li><li data-v-39d5bec2${_scopeId3}><strong data-v-39d5bec2${_scopeId3}>vs FixedDefinedSchedule:</strong> Same schedule shape, same dates, same <code data-v-39d5bec2${_scopeId3}>Schedule</code> array — the only structural difference is whether each entry carries a locked <code data-v-39d5bec2${_scopeId3}>Amount</code> or a <code data-v-39d5bec2${_scopeId3}>MaximumIndividualAmount</code> ceiling.</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                            createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-39d5bec2${_scopeId2}><strong data-v-39d5bec2${_scopeId2}>Default flow:</strong> The LFI authenticates the user at each step of the consent journey and SCA for the payment itself.</li><li data-v-39d5bec2${_scopeId2}><strong data-v-39d5bec2${_scopeId2}>With Delegated SCA:</strong> The TPP has already performed SCA at its own surface (biometrics, secure enclave, MFA) and asserts this to the LFI via a fully-populated <code data-v-39d5bec2${_scopeId2}>Risk.DebtorIndicators.Authentication</code> block on every <code data-v-39d5bec2${_scopeId2}>POST /par</code> and <code data-v-39d5bec2${_scopeId2}>POST /payments</code>.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-39d5bec2${_scopeId2}>When to use:</strong> Apps that already run a compliant SCA flow on the user&#39;s device at the point of every payment, so do not need to rely on the other control parameters.`);
                } else {
                  return [
                    createVNode("strong", null, "When to use:"),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-39d5bec2${_scopeId}>Treating <code data-v-39d5bec2${_scopeId}>PeriodicSchedule.PeriodType</code> as a cadence on on-demand variants</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`On <code data-v-39d5bec2${_scopeId2}>FixedOnDemand</code> and <code data-v-39d5bec2${_scopeId2}>VariableOnDemand</code>, <code data-v-39d5bec2${_scopeId2}>PeriodType</code> is a <strong data-v-39d5bec2${_scopeId2}>cap reference window</strong>, not a recurrence schedule. The TPP still triggers every payment.`);
                } else {
                  return [
                    createTextVNode("On "),
            ...
            _push2(`<h3 data-v-39d5bec2${_scopeId}>Picking <code data-v-39d5bec2${_scopeId}>FixedDefinedSchedule</code> when dates are known but amounts aren&#39;t</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`If amounts may vary per date, use <code data-v-39d5bec2${_scopeId2}>VariableDefinedSchedule</code> with a <code data-v-39d5bec2${_scopeId2}>MaximumIndividualAmount</code> per entry — <code data-v-39d5bec2${_scopeId2}>FixedDefinedSchedule</code> locks the amount up front and the LFI will reject any payment for a different value.`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-39d5bec2${_scopeId}>Assuming <code data-v-39d5bec2${_scopeId}>PeriodicSchedule</code> means &quot;periodic payments&quot;</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The object is named for its role in the schema, not its semantics in every variant. For <code data-v-39d5bec2${_scopeId2}>OnDemand</code> variants it governs caps; for <code data-v-39d5bec2${_scopeId2}>PeriodicSchedule</code> variants it governs cadence; for <code data-v-39d5bec2${_scopeId2}>DefinedSchedule</code> variants it carries the date list.`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-39d5bec2${_scopeId}>Setting the <code data-v-39d5bec2${_scopeId}>Type</code> on the wrong object</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The OpenAPI discriminator is on <code data-v-39d5bec2${_scopeId2}>PeriodicSchedule.Type</code> (e.g. <code data-v-39d5bec2${_scopeId2}>&quot;FixedOnDemand&quot;</code>), <strong data-v-39d5bec2${_scopeId2}>not</strong> on <code data-v-39d5bec2${_scopeId2}>MultiPayment.Type</code>. A mis-placed discriminator is rejected with <code data-v-39d5bec2${_scopeId2}>400 invalid_message_format</code>.`);
                } else {
                  return [
...
const choosingAPaymentType = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-39d5bec2"]]);
export {
