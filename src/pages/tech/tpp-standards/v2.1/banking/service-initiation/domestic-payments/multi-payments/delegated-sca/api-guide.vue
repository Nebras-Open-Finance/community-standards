  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdNote type="warning" title="Delegated SCA requires a populated Risk block">
        ...
        <p>
          See the
          <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/risk#delegated-sca-payment">Delegated
          SCA Payment example</a> for a fully-populated version and the
          <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/risk">Risk
    ...
    >
      <EdProse>
        ...
        <code>urn:openfinanceuae:service-initiation-consent:v2.1</code>. For Delegated SCA you
