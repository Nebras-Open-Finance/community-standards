...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const counterparty = computed(() => {
      var _a;
      return `[${entityLabel.value} ${(_a = props.connection) == null ? void 0 : _a.lfiDigit}]`;
    });
    const payerBankLabel = computed(
      () => {
        var _a;
        return isLfi.value ? "[LFI]" : `[LFI ${(_a = props.connection) == null ? void 0 : _a.lfiDigit}]`;
      }
    );
    const confirmImpactText = computed(() => {
      if (isLfi.value) {
        if (confirmAction.value === "pause") {
          return isDataSharing.value ? `Contact ${counterparty.value} to fully understand what pausing this connection means for the service they provide you. While it is paused we will share no data with them, and you can resume sharing here at any time.` : `Contact ${counterparty.value} to fully understand what pausing this permission means for the service they provide you. While it is paused no payments will be made under this permission, and you can resume it here at any time.`;
        }
        if (confirmAction.value === "reactivate") {
          return isDataSharing.value ? `Contact ${counterparty.value} to fully understand what resuming this connection means for the service they provide you. Once you confirm, we will start sharing your data with them again straight away.` : `Contact ${counterparty.value} to fully understand what resuming this permission means for the service they provide you. Once you confirm, payments can be made under this permission again.`;
        }
        return isDataSharing.value ? `Contact ${counterparty.value} to fully understand what cancelling this connection means for the service they provide you. Once you confirm, we will stop sharing your data with them immediately.` : `Contact ${counterparty.value} to fully understand what cancelling this permission means for the service they provide you. Once you confirm, no further payments will be made under it. Payments already submitted cannot be cancelled here.`;
      }
      if (confirmAction.value === "pause") {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-a8dcda2c><div class="cmd-screen-name" data-v-a8dcda2c><div class="cmd-screen-bar" data-v-a8dcda2c></div><button type="button" class="cmd-back-button" aria-label="Back" data-v-a8dcda2c><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-v-a8dcda2c><path d="M14.5 5.5L8.5 12L14.5 18.5" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path></svg></button><div class="cmd-screen-title" data-v-a8dcda2c>${ssrInterpolate(barTitle.value)}</div></div>`);
      if (confirmAction.value === null && !showUpdates.value) {
        _push(`<!--[--><div class="cmd-card-shell" data-v-a8dcda2c><div class="cmd-meta-card" data-v-a8dcda2c><div class="cmd-meta-header" data-v-a8dcda2c><div class="cmd-meta-lfi" data-v-a8dcda2c>[${ssrInterpolate(entityLabel.value)} ${ssrInterpolate(__props.connection.lfiDigit)}]</div><div class="${ssrRenderClass([statusClass.value, "cmd-status"])}" data-v-a8dcda2c>${ssrInterpolate(displayStatus.value)}</div></div><div class="cmd-meta-rows" data-v-a8dcda2c>`);
        if (isDataSharing.value) {
          _push(`<div class="cmd-meta-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Consent type</span><span class="cmd-meta-row-value" data-v-a8dcda2c>Data Sharing</span></div>`);
        } else if (isMultiPayment.value) {
          _push(`<div class="cmd-meta-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Consent type</span><span class="cmd-meta-row-value" data-v-a8dcda2c>Flexi Pay</span></div>`);
        } else {
          _push(`<div class="cmd-meta-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Consent type</span><span class="cmd-meta-row-value" data-v-a8dcda2c>Single Payment</span></div>`);
        }
        _push(`<button type="button" class="${ssrRenderClass([{ "is-copied": copied.value }, "cmd-meta-row cmd-consent-id"])}"${ssrRenderAttr("aria-label", `Consent ID: ${CONSENT_ID}. Click to copy.`)} data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Consent ID</span><span class="cmd-consent-id-right" data-v-a8dcda2c><span class="cmd-consent-id-action" data-v-a8dcda2c>${ssrInterpolate(copied.value ? "Copied!" : "Copy")}</span><span class="cmd-consent-id-value" data-v-a8dcda2c>${ssrInterpolate(truncatedConsentId)}</span></span></button>`);
        if (isDataSharing.value) {
          _push(`<div class="cmd-meta-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Last data received</span><span class="cmd-meta-row-value" data-v-a8dcda2c>${ssrInterpolate(lastDataReceivedDate.value)}</span></div>`);
        } else if (isMultiPayment.value) {
          _push(`<div class="cmd-meta-row cmd-meta-amount-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Total paid to date</span>`);
          _push(ssrRenderComponent(DirhamAmount, {
        ...
        _push(`</div></div>`);
        if (isDataSharing.value) {
          _push(`<div class="cmd-accounts-card" data-v-a8dcda2c><div class="cmd-accounts-header-section" data-v-a8dcda2c><div class="cmd-accounts-header-text" data-v-a8dcda2c>Accounts</div></div><div class="cmd-accounts-list" data-v-a8dcda2c><!--[-->`);
          ssrRenderList(EXAMPLE_ACCOUNTS, (account) => {
            _push(`<div class="cmd-account-card" data-v-a8dcda2c><div class="cmd-account-title-text" data-v-a8dcda2c>${ssrInterpolate(account.name)}</div><div class="cmd-account-subtext" data-v-a8dcda2c>${ssrInterpolate(account.iban)}</div></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
        ...
        if (isSinglePayment.value) {
          _push(`<div class="cmd-accounts-card" data-v-a8dcda2c><div class="cmd-accounts-header-section" data-v-a8dcda2c><div class="cmd-accounts-header-text" data-v-a8dcda2c>Payment details</div></div><div class="cmd-detail-rows" data-v-a8dcda2c><div class="cmd-detail-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Amount</span>`);
          _push(ssrRenderComponent(DirhamAmount, {
            amount: SIP_EXAMPLE.amount,
            class: "cmd-sip-amount"
          }, null, _parent));
          _push(`</div><div class="cmd-detail-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Reference</span><span class="cmd-meta-row-value" data-v-a8dcda2c>${ssrInterpolate(SIP_EXAMPLE.reference)}</span></div><div class="cmd-detail-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Payment purpose</span><span class="cmd-meta-row-value" data-v-a8dcda2c>${ssrInterpolate(SIP_EXAMPLE.purpose)}</span></div>`);
          if (__props.connection.status === "Authorized") {
            _push(`<div class="cmd-detail-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Status</span><div class="cmd-sip-badge cmd-sip-badge-authorized" data-v-a8dcda2c>Authorized</div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div>`);
        ...
        if (!isDataSharing.value) {
          _push(`<div class="cmd-accounts-card" data-v-a8dcda2c><div class="cmd-accounts-header-section" data-v-a8dcda2c><div class="cmd-accounts-header-text" data-v-a8dcda2c>From account</div></div><div class="cmd-detail-rows" data-v-a8dcda2c><div class="cmd-detail-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Bank</span><span class="cmd-meta-row-value" data-v-a8dcda2c>${ssrInterpolate(payerBankLabel.value)}</span></div><div class="cmd-detail-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Payer Name</span><span class="cmd-meta-row-value" data-v-a8dcda2c>Mohammed Al Rashidi</span></div><div class="cmd-detail-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>IBAN</span><span class="cmd-meta-row-value cmd-iban-value" data-v-a8dcda2c>${ssrInterpolate(unmaskIban(__props.connection.maskedIban))}</span></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (!isDataSharing.value) {
          _push(`<div class="cmd-accounts-card" data-v-a8dcda2c>`);
          if (!isOpenBeneficiary.value) {
            _push(`<div class="cmd-accounts-header-section" data-v-a8dcda2c><div class="cmd-accounts-header-text" data-v-a8dcda2c>${ssrInterpolate(toAccountHeader.value)}</div></div>`);
          } else {
            _push(`<!---->`);
          }
          if (isOpenBeneficiary.value) {
            _push(`<div class="cmd-detail-rows" data-v-a8dcda2c><p class="cmd-open-benef-text" data-v-a8dcda2c>${ssrInterpolate(openBeneficiaryText.value)}</p></div>`);
          } else if (isMultiBeneficiary.value) {
            _push(`<div class="cmd-benef-card" data-v-a8dcda2c><button type="button" class="cmd-benef-header"${ssrRenderAttr("aria-expanded", benefListOpen.value)} data-v-a8dcda2c><span class="cmd-benef-label" data-v-a8dcda2c>Beneficiary List</span><svg class="${ssrRenderClass([{ "cmd-benef-arrow-collapsed": !benefListOpen.value }, "cmd-benef-arrow"])}" width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-v-a8dcda2c><path d="M1 1L7 6.5L1 12" stroke="#0C1441" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path></svg></button>`);
            if (benefListOpen.value) {
              _push(`<div class="cmd-benef-items" data-v-a8dcda2c><!--[-->`);
              ssrRenderList(EXAMPLE_BENEFICIARIES, (benef) => {
                _push(`<div class="cmd-benef-item" data-v-a8dcda2c><div class="cmd-benef-name" data-v-a8dcda2c>${ssrInterpolate(benef.name)}</div><div class="cmd-detail-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>IBAN</span><span class="cmd-meta-row-value cmd-iban-value" data-v-a8dcda2c>${ssrInterpolate(benef.iban)}</span></div></div>`);
              });
              _push(`<!--]--></div>`);
            } else {
              _push(`<!---->`);
            ...
            _push(`<div class="cmd-detail-rows" data-v-a8dcda2c><div class="cmd-detail-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>Payee Name</span><span class="cmd-meta-row-value" data-v-a8dcda2c>${ssrInterpolate(EXAMPLE_BENEFICIARIES[0].name)}</span></div><div class="cmd-detail-row" data-v-a8dcda2c><span class="cmd-meta-row-label" data-v-a8dcda2c>IBAN</span><span class="cmd-meta-row-value cmd-iban-value" data-v-a8dcda2c>${ssrInterpolate(EXAMPLE_BENEFICIARIES[0].iban)}</span></div></div>`);
          }
          _push(`</div>`);
        } else {
          _push(`<!---->`);
        ...
        if (isDataSharing.value && !isLfi.value && __props.connection.status !== "Rejected") {
          _push(`<div class="cmd-usage-card" data-v-a8dcda2c><div class="cmd-usage-header" data-v-a8dcda2c><div class="cmd-usage-title" data-v-a8dcda2c>${ssrInterpolate(__props.connection.status === "Revoked" ? "You cancelled this connection" : "How we are using your data")}</div><div class="cmd-usage-subtitle" data-v-a8dcda2c>[Detail purpose for which data will be used].</div></div><div class="cmd-usage-dates" data-v-a8dcda2c><div class="cmd-usage-date-block" data-v-a8dcda2c><div class="cmd-usage-date-row" data-v-a8dcda2c><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="${ssrRenderStyle({ "flex-shrink": "0" })}" data-v-a8dcda2c><path d="M5.33301 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.667 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M2.33301 6.05859H13.6663" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M14 5.66536V11.332C14 13.332 13 14.6654 10.6667 14.6654H5.33333C3 14.6654 2 13.332 2 11.332V5.66536C2 3.66536 3 2.33203 5.33333 2.33203H10.6667C13 2.33203 14 3.66536 14 5.66536Z" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.4635 9.13411H10.4694" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.4635 11.1341H10.4694" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M7.99666 9.13411H8.00265" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M7.99666 11.1341H8.00265" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M5.52987 9.13411H5.53585" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M5.52987 11.1341H5.53585" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path></svg><span class="cmd-usage-date-label" data-v-a8dcda2c>First Connected</span></div><div class="cmd-usage-date-value" data-v-a8dcda2c>${ssrInterpolate(firstConnectedDate.value)}</div></div><div class="cmd-usage-date-block" data-v-a8dcda2c><div class="cmd-usage-date-row" data-v-a8dcda2c><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="${ssrRenderStyle({ "flex-shrink": "0" })}" data-v-a8dcda2c><path d="M5.33301 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.667 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M2.33301 6.05859H13.6663" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M14 5.66536V11.332C14 13.332 13 14.6654 10.6667 14.6654H5.33333C3 14.6654 2 13.332 2 11.332V5.66536C2 3.66536 3 2.33203 5.33333 2.33203H10.6667C13 2.33203 14 3.66536 14 5.66536Z" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.4635 9.13411H10.4694" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.4635 11.1341H10.4694" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M7.99666 9.13411H8.00265" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M7.99666 11.1341H8.00265" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M5.52987 9.13411H5.53585" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M5.52987 11.1341H5.53585" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path></svg><span class="cmd-usage-date-label" data-v-a8dcda2c>${ssrInterpolate(__props.connection.status === "Expired" ? "Connection Expired" : "Connection Expires")}</span></div><div class="cmd-usage-date-value" data-v-a8dcda2c>${ssrInterpolate(unref(formatDate)((_a = consentState.value) == null ? void 0 : _a.ExpirationDateTime))}</div></div>`);
          if (__props.connection.baseConsentId) {
            _push(`<div class="cmd-usage-date-block" data-v-a8dcda2c><div class="cmd-usage-date-row" data-v-a8dcda2c><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="${ssrRenderStyle({ "flex-shrink": "0" })}" data-v-a8dcda2c><rect x="1.33301" y="1.33203" width="13.334" height="13.334" rx="2" stroke="#36BFD4" stroke-width="1.5" data-v-a8dcda2c></rect><path d="M10.167 6.16536C9.667 5.33203 8.667 4.66536 7.5 4.83203C6.167 5.0487 5.167 6.16536 5.0003 7.4987C4.8003 9.16536 6.0003 10.6654 7.6003 10.832C8.667 10.9487 9.6003 10.4987 10.167 9.83203" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.5 4.5V6.5H8.5" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path></svg><span class="cmd-usage-date-label" data-v-a8dcda2c>Last Updated</span></div><div class="cmd-usage-date-value" data-v-a8dcda2c>${ssrInterpolate(lastDataReceivedDate.value)}</div><div class="cmd-usage-updates-link" data-v-a8dcda2c>List of Updates</div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div>`);
        ...
        if (isMultiPayment.value && __props.connection.status !== "Rejected") {
          _push(`<div class="cmd-usage-card" data-v-a8dcda2c><div class="cmd-usage-dates" data-v-a8dcda2c><div class="cmd-usage-date-block" data-v-a8dcda2c><div class="cmd-usage-date-row" data-v-a8dcda2c><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="${ssrRenderStyle({ "flex-shrink": "0" })}" data-v-a8dcda2c><path d="M5.33301 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.667 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M2.33301 6.05859H13.6663" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M14 5.66536V11.332C14 13.332 13 14.6654 10.6667 14.6654H5.33333C3 14.6654 2 13.332 2 11.332V5.66536C2 3.66536 3 2.33203 5.33333 2.33203H10.6667C13 2.33203 14 3.66536 14 5.66536Z" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.4635 9.13411H10.4694" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.4635 11.1341H10.4694" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M7.99666 9.13411H8.00265" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M7.99666 11.1341H8.00265" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M5.52987 9.13411H5.53585" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M5.52987 11.1341H5.53585" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path></svg><span class="cmd-usage-date-label" data-v-a8dcda2c>You started this permission</span></div><div class="cmd-usage-date-value" data-v-a8dcda2c>${ssrInterpolate(firstConnectedDate.value)}</div></div><div class="cmd-usage-date-block" data-v-a8dcda2c><div class="cmd-usage-date-row" data-v-a8dcda2c><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="${ssrRenderStyle({ "flex-shrink": "0" })}" data-v-a8dcda2c><path d="M5.33301 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.667 1.33203V3.33203" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M2.33301 6.05859H13.6663" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M14 5.66536V11.332C14 13.332 13 14.6654 10.6667 14.6654H5.33333C3 14.6654 2 13.332 2 11.332V5.66536C2 3.66536 3 2.33203 5.33333 2.33203H10.6667C13 2.33203 14 3.66536 14 5.66536Z" stroke="#36BFD4" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.4635 9.13411H10.4694" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.4635 11.1341H10.4694" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M7.99666 9.13411H8.00265" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M7.99666 11.1341H8.00265" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M5.52987 9.13411H5.53585" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M5.52987 11.1341H5.53585" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path></svg><span class="cmd-usage-date-label" data-v-a8dcda2c>${ssrInterpolate(__props.connection.status === "Expired" ? "Payments expired" : __props.connection.status === "Revoked" ? "You cancelled payments on" : "We will make these payments until")}</span></div><div class="cmd-usage-date-value" data-v-a8dcda2c>${ssrInterpolate(unref(formatDate)((_b = consentState.value) == null ? void 0 : _b.ExpirationDateTime))}</div></div>`);
          if (__props.connection.baseConsentId) {
            _push(`<div class="cmd-usage-date-block" data-v-a8dcda2c><div class="cmd-usage-date-row" data-v-a8dcda2c><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="${ssrRenderStyle({ "flex-shrink": "0" })}" data-v-a8dcda2c><rect x="1.33301" y="1.33203" width="13.334" height="13.334" rx="2" stroke="#36BFD4" stroke-width="1.5" data-v-a8dcda2c></rect><path d="M10.167 6.16536C9.667 5.33203 8.667 4.66536 7.5 4.83203C6.167 5.0487 5.167 6.16536 5.0003 7.4987C4.8003 9.16536 6.0003 10.6654 7.6003 10.832C8.667 10.9487 9.6003 10.4987 10.167 9.83203" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path><path d="M10.5 4.5V6.5H8.5" stroke="#36BFD4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-a8dcda2c></path></svg><span class="cmd-usage-date-label" data-v-a8dcda2c>Last Updated</span></div><div class="cmd-usage-date-value" data-v-a8dcda2c>${ssrInterpolate(lastDataReceivedDate.value)}</div><div class="cmd-usage-updates-link" data-v-a8dcda2c>List of Updates</div></div>`);
          } else {
            _push(`<!---->`);
        ...
        if (showDisconnect.value || showReactivate.value) {
          _push(`<div class="cmd-footer" data-v-a8dcda2c>`);
          if (showReactivate.value) {
            _push(`<button type="button" class="cmd-reactivate-btn" data-v-a8dcda2c>Reactivate</button>`);
          } else {
            _push(`<!---->`);
          }
          if (showPause.value) {
            _push(`<button type="button" class="cmd-pause-btn" data-v-a8dcda2c>Pause</button>`);
          } else {
            _push(`<!---->`);
          }
          if (showDisconnect.value) {
            _push(`<button type="button" class="cmd-revoke-btn" data-v-a8dcda2c>${ssrInterpolate(disconnectLabel.value)}</button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        _push(`<div class="cmd-card-shell" data-v-a8dcda2c><div class="cmd-updates-card" data-v-a8dcda2c><div class="cmd-updates-inner" data-v-a8dcda2c><div class="cmd-updates-title" data-v-a8dcda2c>List of Updates</div><div class="cmd-updates-subtitle" data-v-a8dcda2c>List of all changes that you made to this connection since first authorization.</div></div></div><div class="cmd-updates-list" data-v-a8dcda2c><!--[-->`);
        ssrRenderList(relatedConsents.value, (related, idx) => {
          _push(`<div class="cmd-updates-item" role="button" tabindex="0" data-v-a8dcda2c><div class="cmd-updates-item-name" data-v-a8dcda2c>${ssrInterpolate(extractDate(related.lastDataReceived))}</div><div class="cmd-updates-item-count" data-v-a8dcda2c>[${ssrInterpolate(entityLabel.value)} ${ssrInterpolate(related.lfiDigit)}]</div><div class="cmd-updates-item-meta cmd-updates-item-meta-row" data-v-a8dcda2c><span class="cmd-updates-item-meta-label" data-v-a8dcda2c>Consent Type:</span><span class="cmd-updates-item-meta-value" data-v-a8dcda2c>${ssrInterpolate(related.type)}</span></div><div class="cmd-updates-item-meta cmd-updates-item-meta-row" data-v-a8dcda2c><span class="cmd-updates-item-meta-label" data-v-a8dcda2c>Last data received:</span><span class="cmd-updates-item-meta-value" data-v-a8dcda2c>${ssrInterpolate(extractDate(related.lastDataReceived))}</span></div><div class="cmd-updates-item-meta cmd-updates-item-meta-row" data-v-a8dcda2c><span class="cmd-updates-item-meta-label" data-v-a8dcda2c>Connection expires:</span><span class="cmd-updates-item-meta-value" data-v-a8dcda2c>${ssrInterpolate(extractDate(related.expiry))}</span></div><svg class="cmd-updates-chevron" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" data-v-a8dcda2c><path d="M9 18l6-6-6-6" data-v-a8dcda2c></path></svg></div>`);
        });
        _push(`<!--]--></div>`);
        if (relatedConsents.value.length === 0) {
          _push(`<div class="cmd-updates-empty" data-v-a8dcda2c> No related updates found. </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      } else {
        _push(`<!--[--><div class="cmd-confirm-card cmd-confirm-title-card" data-v-a8dcda2c><div class="cmd-confirm-title" data-v-a8dcda2c>${ssrInterpolate(confirmTitle.value)}</div><div class="cmd-confirm-subtitle" data-v-a8dcda2c>Are you sure you want to proceed?</div></div><div class="cmd-confirm-card" data-v-a8dcda2c><div class="cmd-confirm-impact-header" data-v-a8dcda2c>What this will mean</div><p class="cmd-confirm-impact-text" data-v-a8dcda2c>${ssrInterpolate(confirmImpactText.value)}</p></div><div class="cmd-confirm-footer" data-v-a8dcda2c><button type="button" class="${ssrRenderClass([confirmAction.value === "pause" ? "cmd-confirm-btn-pause" : confirmAction.value === "reactivate" ? "cmd-confirm-btn-reactivate" : "cmd-confirm-btn-revoke", "cmd-confirm-btn"])}" data-v-a8dcda2c>${ssrInterpolate(confirmButtonLabel.value)}</button><button type="button" class="cmd-confirm-back-btn" data-v-a8dcda2c>Go back</button></div><!--]-->`);
      }
      _push(`</div>`);
    };
  }
...
const ConsentManagementDetail = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a8dcda2c"]]);
const EMPTY_DATE = "--/--/----";
const _sfc_main = {
