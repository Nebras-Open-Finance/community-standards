            ...
            <div class="consent-page-text-inner-frame">
                ...
                <div class="consent-page-text-section">
                    <div class="consent-page-text">
                        To make a payment from your bank, we need your permission to securely initiate the payment
                    </div>

                    <div class="consent-page-accounts-section">
                        <div 
                            class="consent-page-account-card">
                            <div class="consent-page-account-title">
                                <div class="consent-page-account-title-icon">
                                    <div class="consent-page-account-title-icon-2">
                                        <svg class="consent-page-account-title-icon-3" width="21" height="16"
                                            viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M0 1.19393H10.6V2.39393H1.2V14.1939H18V10.3739H19.2V15.3939H0V1.19393ZM18 2.39393H13.143V1.19393H19.2V6.24563H18V2.39393Z"
                                                fill="white" />
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M18.6661 5.0243H3.53262V3.8243H18.6661V5.0243Z" fill="white" />
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M12.2702 0L15.0882 3.94519L14.1118 4.64268L11.9298 1.58787L6.40232 4.8122L5.79768 3.77567L12.2702 0Z"
                                                fill="white" />
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M10 6.19393H20.2V11.3939H10V6.19393ZM11.2 7.39393V10.1939H19V7.39393H11.2Z"
                                                fill="white" />
                                            <path
                                                d="M13.2455 8.86667C13.2455 9.18298 12.989 9.4394 12.6727 9.4394C12.3564 9.4394 12.1 9.18298 12.1 8.86667C12.1 8.55035 12.3564 8.29393 12.6727 8.29393C12.989 8.29393 13.2455 8.55035 13.2455 8.86667Z"
                                                fill="white" />
                                        </svg>
                                    </div>
                                    <div class="consent-page-account-title-elipse"></div>

                                    <div class="consent-page-account-title-text">
                                        Payment Total
                                    </div>
                            ...
                            <div class="consent-page-account-subtext-container">
    ...
    <div class="consent-page-account-subtext-container-2">
                    ...
                    <div class="consent-page-text-mini-header-section">
                        <div class="consent-page-text-mini-header-section-header"
                            @click="show_payer_information = !show_payer_information">
                            <div class="consent-page-text-min-header-section-header-text">
                                Payer Information
                            </div>
                            <svg class="consent-page-mini-header-icon" :class="{ 'is-open': show_payer_information }" width="15"
                                ...
                                <div v-if="show_payer_information" class="consent-page-account-subtext-container-2">
                    ...
                    <div class="consent-page-text-mini-header-section">
                        <div class="consent-page-text-mini-header-section-header"
                            @click="show_payee_information = !show_payee_information">
                            <div class="consent-page-text-min-header-section-header-text">
                                Payee Information
                            </div>
                            <svg class="consent-page-mini-header-icon" :class="{ 'is-open': show_payee_information }" width="15"
                                height="8" viewBox="0 0 15 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M1.28033 0.21967C0.987438 -0.0732232 0.512563 -0.0732232 0.21967 0.21967C-0.0732235 0.512563 -0.0732235 0.987437 0.21967 1.28033L1.28033 0.21967ZM14.4803 1.28033C14.7732 0.987437 14.7732 0.512563 14.4803 0.21967C14.1874 -0.0732226 13.7126 -0.0732226 13.4197 0.21967L14.4803 1.28033ZM0.21967 1.28033L5.653 6.71366L6.71366 5.653L1.28033 0.21967L0.21967 1.28033ZM5.653 6.71366C6.58756 7.64822 8.11244 7.64822 9.047 6.71366L7.98634 5.653C7.63756 6.00178 7.06244 6.00178 6.71366 5.653L5.653 6.71366ZM9.047 6.71366L14.4803 1.28033L13.4197 0.21967L7.98634 5.653L9.047 6.71366Z"
                                    fill="#36BFD4" />
                                                    ...
                                                    <div v-if="show_payee_information" class="consent-page-account-subtext-container-2">
