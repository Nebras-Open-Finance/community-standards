...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-491b1122><section class="ed-doc__hero" data-v-491b1122><div class="ed-doc__inner" data-v-491b1122><div class="ed-doc__eyebrow" data-v-491b1122><span class="ed-doc__eyebrow-dash" data-v-491b1122></span> LFI · API Hub · Admin Portal · Reports </div><h1 class="ed-doc__title" data-v-491b1122> Reports <span class="ed-doc__read" data-v-491b1122>2 min read</span></h1><p class="ed-doc__lede" data-v-491b1122> The Admin Portal provides a set of operational reports covering API performance, error rates, call volumes, payment activity, and consent statistics. All reports can be filtered by date range, sorted by any column, and exported to <strong data-v-491b1122>CSV</strong> for further analysis. </p></div></section>`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-491b1122${_scopeId2}><thead data-v-491b1122${_scopeId2}><tr data-v-491b1122${_scopeId2}><th data-v-491b1122${_scopeId2}>Column</th><th data-v-491b1122${_scopeId2}>Description</th></tr></thead><tbody data-v-491b1122${_scopeId2}><tr data-v-491b1122${_scopeId2}><td data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>LFI Name</strong></td><td data-v-491b1122${_scopeId2}>Your organisation name (always your LFI for your portal)</td></tr><tr data-v-491b1122${_scopeId2}><td data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>TPP Name</strong></td><td data-v-491b1122${_scopeId2}>The TPP that made the request — blank for requests that do not involve a TPP (e.g. LFI-to-Hub calls)</td></tr><tr data-v-491b1122${_scopeId2}><td data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Date</strong></td><td data-v-491b1122${_scopeId2}>The date of the aggregated data</td></tr><tr data-v-491b1122${_scopeId2}><td data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Endpoint</strong></td><td data-v-491b1122${_scopeId2}>The API endpoint called (e.g. accounts, balances, beneficiaries, payments)</td></tr><tr data-v-491b1122${_scopeId2}><td data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Response Code</strong></td><td data-v-491b1122${_scopeId2}>The HTTP response status code</td></tr><tr data-v-491b1122${_scopeId2}><td data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Max Response Time (ms)</strong></td><td data-v-491b1122${_scopeId2}>The slowest response time for the endpoint in the period</td></tr><tr data-v-491b1122${_scopeId2}><td data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Min Response Time (ms)</strong></td><td data-v-491b1122${_scopeId2}>The fastest response time for the endpoint in the period</td></tr><tr data-v-491b1122${_scopeId2}><td data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Average Response Time (ms)</strong></td><td data-v-491b1122${_scopeId2}>The mean response time across all calls to the endpoint in the period</td></tr><tr data-v-491b1122${_scopeId2}><td data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Number of Calls</strong></td><td data-v-491b1122${_scopeId2}>Total number of requests to the endpoint in the period</td></tr></tbody></table>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Response times represent the <strong data-v-491b1122${_scopeId2}>end-to-end request duration</strong> as observed by the API Hub — from receiving the inbound request to returning the response. This includes the LFI&#39;s response time. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-491b1122${_scopeId2}>Endpoints with elevated error rates</li><li data-v-491b1122${_scopeId2}>TPPs that are consistently sending malformed requests</li><li data-v-491b1122${_scopeId2}>Trends in error volumes over time</li>`);
            } else {
              return [
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h3 data-v-491b1122${_scopeId}>Payment values</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(`<h3 data-v-491b1122${_scopeId}>Payment volumes</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Date range filter</strong> — adjust the reporting period using the date picker</li><li data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Column sorting</strong> — click any column header to sort ascending or descending</li><li data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Column filters</strong> — filter rows by specific values (e.g. a specific TPP, endpoint, or response code)</li><li data-v-491b1122${_scopeId2}><strong data-v-491b1122${_scopeId2}>Export</strong> — download the current report view as a <strong data-v-491b1122${_scopeId2}>CSV</strong> file for offline analysis in Excel or other tools</li>`);
            } else {
              return [
                createVNode("li", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/api-hub/admin-portal/reports.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const reports = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-491b1122"]]);
export {
  reports as default
};
