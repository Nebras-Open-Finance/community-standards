  ...
  <div class="ed-landing">
    ...
    <div class="ed-cov" role="table" style="grid-template-columns: minmax(7rem, 10rem) 1fr minmax(8rem, 12rem);">
      ...
      <div class="ed-cov__row" role="row">
        ...
        <div class="ed-cov__cell ed-cov__cell--label"><span class="endpoint"><span class="http-method http-method--post">POST</span><code>/open-finance/confirmation-of-payee/v2.1/discovery</code></span></div>
    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/banking/confirmation-of-payee/requirements" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
          ...
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/banking/confirmation-of-payee/api-guide" :style="{ '--card-color': 'var(--at-teal)' }">
            <span class="ed-link-card__top" />
          ...
          <a class="ed-link-card" href="/tech/tpp-standards/v2.1/banking/confirmation-of-payee/user-journeys" :style="{ '--card-color': 'var(--at-navy)' }">
            <span class="ed-link-card__top" />
