...
import { W as WireframePreview, A as AccountSetup, U as UIBehaviour, E as ExampleJourneys } from "./ExampleJourneys-AHML4VWI.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-95a77686><section class="ed-doc__hero" data-v-95a77686><div class="ed-doc__inner" data-v-95a77686><div class="ed-doc__eyebrow" data-v-95a77686><span class="ed-doc__eyebrow-dash" data-v-95a77686></span> Banking · Service Initiation · Single Instant Payment · UX </div><h1 class="ed-doc__title" data-v-95a77686> Single Instant Payment — User Experience <span class="ed-doc__read" data-v-95a77686>4 min read</span></h1><p class="ed-doc__lede" data-v-95a77686> When a customer is redirected to you to authorize an Open Finance consent for a single instant payment, you must present an <strong data-v-95a77686>Authorization Page</strong> that clearly explains the payment the customer is authorizing. The page must collect the customer&#39;s explicit and informed consent, and it must accurately reflect the payee, amount, schedule, and all material terms of the payment consent. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-95a77686> The examples and interactive wireframes provided below define the expected structure, content, and behavior of the Authorization Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-95a77686> While you may adapt visual elements such as color palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the payment information shown. The representation of <strong data-v-95a77686>AlTareq</strong> (including logos, naming, and action buttons) must be preserved at all times. The customer must be able to clearly understand what payment they are authorizing and that the authorization is part of the AlTareq ecosystem. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-95a77686> Your Authorization Page must be submitted as part of <strong data-v-95a77686>CX certification</strong> prior to production. Any material changes to a production Authorization Page must also be resubmitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the request body fields below and watch the <strong data-v-95a77686${_scopeId2}>Consent</strong> and <strong data-v-95a77686${_scopeId2}>Authorisation</strong> page previews update live. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EditableJson, {
              ...
              "endpoint-href": "/openapi/v2.1/api-hub/uae-api-hub-consent-manager-openapi.yaml",
            ...
            _push2(`<div class="sim-card" data-v-95a77686${_scopeId}><div class="sim-card__head" data-v-95a77686${_scopeId}>Simulated Accounts Behaviour</div><div class="sim-card__body" data-v-95a77686${_scopeId}><label class="sim-card__row" data-v-95a77686${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(simulateDuplicatePayment)) ? ssrLooseContain(unref(simulateDuplicatePayment), null) : unref(simulateDuplicatePayment)) ? " checked" : ""} data-v-95a77686${_scopeId}><span data-v-95a77686${_scopeId}>Duplicate Payment Alert</span></label><label class="sim-card__row" data-v-95a77686${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(simulatePaymentLimitExceeded)) ? ssrLooseContain(unref(simulatePaymentLimitExceeded), null) : unref(simulatePaymentLimitExceeded)) ? " checked" : ""} data-v-95a77686${_scopeId}><span data-v-95a77686${_scopeId}>Payment Limit Exceeded</span></label><label class="sim-card__row" data-v-95a77686${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(simulateAlreadyTrustedPayee)) ? ssrLooseContain(unref(simulateAlreadyTrustedPayee), null) : unref(simulateAlreadyTrustedPayee)) ? " checked" : ""} data-v-95a77686${_scopeId}><span data-v-95a77686${_scopeId}>Already a Trusted Payee</span></label></div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-95a77686"]]);
export {
