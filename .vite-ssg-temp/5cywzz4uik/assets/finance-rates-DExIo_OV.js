...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-6c74c1e7><section class="ed-doc__hero" data-v-6c74c1e7><div class="ed-doc__inner" data-v-6c74c1e7><div class="ed-doc__eyebrow" data-v-6c74c1e7><span class="ed-doc__eyebrow-dash" data-v-6c74c1e7></span> LFI · Banking · Bank Data Sharing · API Guide </div><h1 class="ed-doc__title" data-v-6c74c1e7> Encrypted FinanceRates <span class="ed-doc__read" data-v-6c74c1e7>7 min read</span></h1><p class="ed-doc__lede" data-v-6c74c1e7> When a TPP holds the <code data-v-6c74c1e7>ReadProductFinanceRates</code> permission and calls <code data-v-6c74c1e7>GET /accounts/{AccountId}/product</code> for a credit card, finance, or mortgage product, the LFI MAY return the <code data-v-6c74c1e7>FinanceRates</code> field as a JWE rather than a cleartext object. This guide covers how to generate the one-time code, deliver it to the customer, build the JWE, and rate-limit the endpoint so the customer&#39;s encrypted rates remain protected end-to-end. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Before doing anything else — before deciding to encrypt, before generating an OTP, before delivering the code, before building a JWE — the LFI MUST check that the consent underlying this request includes <code data-v-6c74c1e7${_scopeId2}>ReadProductFinanceRates</code>. If the permission is absent, the LFI MUST omit the <code data-v-6c74c1e7${_scopeId2}>FinanceRates</code> field from the response entirely. The rest of the product payload (<code data-v-6c74c1e7${_scopeId2}>Charges</code>, <code data-v-6c74c1e7${_scopeId2}>DepositRates</code>, <code data-v-6c74c1e7${_scopeId2}>ProductName</code>, etc.) is returned as usual. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-6c74c1e7${_scopeId}>How to read the permission</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The API Hub sets the <code data-v-6c74c1e7${_scopeId2}>o3-consent-id</code> header on every Ozone Connect call made under a consent. That ID identifies the consent the customer authorised; the LFI&#39;s job is to retrieve the consent, read the <code data-v-6c74c1e7${_scopeId2}>Permissions</code> array off it, and check that <code data-v-6c74c1e7${_scopeId2}>ReadProductFinanceRates</code> is present. The LFI does NOT re-validate the access token — that is the Hub&#39;s responsibility. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-6c74c1e7${_scopeId2}><thead data-v-6c74c1e7${_scopeId2}><tr data-v-6c74c1e7${_scopeId2}><th data-v-6c74c1e7${_scopeId2}>Option</th><th data-v-6c74c1e7${_scopeId2}>How it works</th><th data-v-6c74c1e7${_scopeId2}>When to choose it</th></tr></thead><tbody data-v-6c74c1e7${_scopeId2}><tr data-v-6c74c1e7${_scopeId2}><td data-v-6c74c1e7${_scopeId2}><strong data-v-6c74c1e7${_scopeId2}>A — Local consent store</strong></td><td data-v-6c74c1e7${_scopeId2}>The LFI persists consent records locally as the Hub calls <a href="/tech/lfi-api-hub/v2.1/consent-events/api-guide" data-v-6c74c1e7${_scopeId2}><code data-v-6c74c1e7${_scopeId2}>/consent/event/{operation}</code></a> during the consent-events flow at authorization. At request time the LFI looks up the consent by ID in its own store.</td><td data-v-6c74c1e7${_scopeId2}>You already maintain a consent table for revocation handling, account-list patching, or customer attribution. Lowest per-request latency.</td></tr><tr data-v-6c74c1e7${_scopeId2}><td data-v-6c74c1e7${_scopeId2}><strong data-v-6c74c1e7${_scopeId2}>B — Fetch from the Hub</strong></td><td data-v-6c74c1e7${_scopeId2}>The LFI calls <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId" data-v-6c74c1e7${_scopeId2}><code data-v-6c74c1e7${_scopeId2}>GET /consents/{consentId}</code></a> on the Hub&#39;s Consent Manager (<code data-v-6c74c1e7${_scopeId2}>https://cm.{LFICODE}.apihub.openfinance.ae</code>) to fetch the consent on demand. The response includes the <code data-v-6c74c1e7${_scopeId2}>Permissions</code> array.</td><td data-v-6c74c1e7${_scopeId2}>You do not maintain a local consent store, or you do but treat the Hub as the source of truth. Adds one Hub round-trip per request unless you cache the response.</td></tr></tbody></table>`);
                } else {
                  return [
                      ...
                      createVNode("tbody", null, [
                        createVNode("tr", null, [
                          ...
                          createVNode("td", null, [
                            ...
                            createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-events/api-guide" }, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Whichever option you use, the check itself is the same: <code data-v-6c74c1e7${_scopeId2}>permissions.includes(&#39;ReadProductFinanceRates&#39;)</code>. If false — omit <code data-v-6c74c1e7${_scopeId2}>FinanceRates</code>. If true — proceed to the cleartext or encrypted path based on LFI policy for the product type. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-6c74c1e7${_scopeId2}> The Hub&#39;s <code data-v-6c74c1e7${_scopeId2}>GET /consents/{consentId}</code> response is safe to cache for the lifetime of the consent — the <code data-v-6c74c1e7${_scopeId2}>Permissions</code> array is set at authorization and never mutates. Cache invalidation comes from the consent-events flow: when the Hub notifies your <code data-v-6c74c1e7${_scopeId2}>/consent/event/{operation}</code> endpoint that a consent has been revoked or modified, drop the cached entry. A short positive TTL (e.g. 5 minutes) is a reasonable defence against missed events. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6c74c1e7${_scopeId2}> The check applies equally to the cleartext and encrypted paths. If <code data-v-6c74c1e7${_scopeId2}>ReadProductFinanceRates</code> is missing, the LFI MUST NOT return cleartext rates and MUST NOT trigger the code-generation, delivery, or JWE flow. </li><li data-v-6c74c1e7${_scopeId2}> When the field is omitted, do not substitute <code data-v-6c74c1e7${_scopeId2}>null</code>, an empty object, or a placeholder JWE. The <code data-v-6c74c1e7${_scopeId2}>FinanceRates</code> key simply does not appear on the <code data-v-6c74c1e7${_scopeId2}>Product</code> object. </li><li data-v-6c74c1e7${_scopeId2}> The same <code data-v-6c74c1e7${_scopeId2}>o3-consent-id</code> header is used to attribute the call for logging, rate-limit accounting (<a href="#rate-limits" data-v-6c74c1e7${_scopeId2}>Step 6</a>), and audit. Read it once and carry it through the request handler. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-6c74c1e7${_scopeId2}><thead data-v-6c74c1e7${_scopeId2}><tr data-v-6c74c1e7${_scopeId2}><th data-v-6c74c1e7${_scopeId2}>Property</th><th data-v-6c74c1e7${_scopeId2}>Requirement</th></tr></thead><tbody data-v-6c74c1e7${_scopeId2}><tr data-v-6c74c1e7${_scopeId2}><td data-v-6c74c1e7${_scopeId2}>Format</td><td data-v-6c74c1e7${_scopeId2}>6 digits, numeric. Leading zeros MUST be preserved in transit.</td></tr><tr data-v-6c74c1e7${_scopeId2}><td data-v-6c74c1e7${_scopeId2}>Source</td><td data-v-6c74c1e7${_scopeId2}>Cryptographically secure RNG (e.g. <code data-v-6c74c1e7${_scopeId2}>crypto.randomInt</code> in Node.js, <code data-v-6c74c1e7${_scopeId2}>secrets.randbelow</code> in Python). MUST NOT use <code data-v-6c74c1e7${_scopeId2}>Math.random</code>, the default <code data-v-6c74c1e7${_scopeId2}>random</code> module, or any non-CSPRNG source.</td></tr><tr data-v-6c74c1e7${_scopeId2}><td data-v-6c74c1e7${_scopeId2}>Reusability</td><td data-v-6c74c1e7${_scopeId2}>The OTP is reusable for decryption attempts within the 30-minute JWE window. A new call to <code data-v-6c74c1e7${_scopeId2}>GET /accounts/{AccountId}/product</code> MUST issue a fresh OTP, even if the previous JWE has not yet expired.</td></tr><tr data-v-6c74c1e7${_scopeId2}><td data-v-6c74c1e7${_scopeId2}>Storage</td><td data-v-6c74c1e7${_scopeId2}>The OTP MUST NOT be persisted in cleartext at the LFI after the JWE has been built. Hold it only long enough to use it as the PBES2 password and deliver it to the customer, then discard.</td></tr><tr data-v-6c74c1e7${_scopeId2}><td data-v-6c74c1e7${_scopeId2}>Logging</td><td data-v-6c74c1e7${_scopeId2}>The OTP MUST NOT appear in application logs, audit trails, request traces, monitoring tools, or any other system the LFI operates.</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-6c74c1e7${_scopeId2}> The message MUST NOT include the cleartext finance rate, any link inviting the customer to continue their journey somewhere other than the TPP application, or any other product data beyond the brand, code, TPP name, product description, and expiry. </p>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-6c74c1e7${_scopeId}>Message template</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` A recommended template the LFI substitutes from the request context — the <code data-v-6c74c1e7${_scopeId2}>TPP_TRADING_NAME</code> comes from the consent&#39;s TPP organisation registration, the <code data-v-6c74c1e7${_scopeId2}>PRODUCT_NAME</code> from the product the call is for, and <code data-v-6c74c1e7${_scopeId2}>OTP</code> from <a href="#step-2-otp" data-v-6c74c1e7${_scopeId2}>Step 2</a>. The example is written for SMS; the same content requirements apply whatever channel the LFI delivers on: `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-6c74c1e7${_scopeId}>Example SMS as the customer receives it</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: smsExample,
              lang: "text",
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The wording is intentionally explicit about <em data-v-6c74c1e7${_scopeId2}>where</em> the code is to be entered — the message arrives from the bank but the form sits inside the TPP application, and the customer needs to bridge those two contexts. Naming the TPP makes that connection. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-6c74c1e7${_scopeId2}> The example above is English. LFIs SHOULD localise the message to the customer&#39;s registered language preference; in practice this usually means English alongside Arabic. The content requirements above apply to every localised variant. </p>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The cleartext <code data-v-6c74c1e7${_scopeId2}>FinanceRates</code> object is encrypted as a JOSE compact JWE using <strong data-v-6c74c1e7${_scopeId2}>PBES2-HS512+A256KW</strong> for key wrapping and <strong data-v-6c74c1e7${_scopeId2}>A256GCM</strong> for content encryption. PBES2 takes the OTP as a password and derives the content-encryption key inside the JWE library; the LFI never needs to handle key material directly. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-6c74c1e7${_scopeId}>Resulting protected header (decoded)</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: exampleProtectedHeader,
              lang: "json",
              filename: "example protected header"
            }, null, _parent2, _scopeId));
            _push2(`<h3 class="ed-doc__subhead" data-v-6c74c1e7${_scopeId}>JWT-style expiry inside the JWE payload</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The JWE&#39;s PBES2 envelope does not itself express an expiry, and the OTP does not stop working once 30 minutes have passed — a JWE and its OTP can technically be decrypted at any later time. The 30-minute limit is therefore not enforced by the cryptography. It is enforced by the <code data-v-6c74c1e7${_scopeId2}>exp</code> claim the LFI embeds in the plaintext, which the TPP MUST honour, backed by the TPP&#39;s <em data-v-6c74c1e7${_scopeId2}>Access Encrypted Resource Data</em> certification obligations. The LFI embeds <code data-v-6c74c1e7${_scopeId2}>iat</code> and <code data-v-6c74c1e7${_scopeId2}>exp</code> inside the JSON plaintext alongside the <code data-v-6c74c1e7${_scopeId2}>FinanceRates</code> object — so the TPP can stop displaying the rate and show a &quot;this code has expired&quot; message once the window closes — and MUST set <code data-v-6c74c1e7${_scopeId2}>exp = iat + 1800</code> seconds exactly; longer windows are not permitted. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The OpenAPI schema makes the response trivial to assemble: <code data-v-6c74c1e7${_scopeId2}>FinanceRates</code> is either an <code data-v-6c74c1e7${_scopeId2}>AEProductFinanceRates</code> object or an <code data-v-6c74c1e7${_scopeId2}>AEJwe</code> string. Replace the cleartext object with the compact JWE produced in <a href="#step-4-build-jwe" data-v-6c74c1e7${_scopeId2}>Step 4</a> and leave every other field untouched. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the corresponding <a href="/tech/tpp-standards/v2.1/banking/data-sharing/api-guide/finance-rates" data-v-6c74c1e7${_scopeId2}>TPP API guide</a> for how the TPP detects the JWE shape, forwards it to the user&#39;s device, and decrypts using the OTP the customer types in. `);
                } else {
                  return [
                    createTextVNode(" See the corresponding "),
                    createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/api-guide/finance-rates" }, "TPP API guide"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` These limits are LFI-enforced and apply only to the <code data-v-6c74c1e7${_scopeId2}>FinanceRates</code>-encryption path. Cleartext calls to <code data-v-6c74c1e7${_scopeId2}>GET /accounts/{AccountId}/product</code> (for product types where the LFI does not encrypt) follow the standard rate limits documented elsewhere. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-6c74c1e7${_scopeId}>The 429 response</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When either limit would be breached, the LFI MUST <strong data-v-6c74c1e7${_scopeId2}>reject the entire request</strong> rather than returning a partial response with <code data-v-6c74c1e7${_scopeId2}>FinanceRates</code> omitted. The customer is on the TPP&#39;s screen expecting a complete product view; the 429 is the signal the TPP needs to render a clear, actionable error rather than a silently degraded payload. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The response uses the same <code data-v-6c74c1e7${_scopeId2}>429Error</code> envelope already defined for <code data-v-6c74c1e7${_scopeId2}>GET /accounts/{AccountId}/product</code> in the <a href="/tech/lfi-api-hub/v2.1/banking/data-sharing/open-api/accounts-AccountId-products" data-v-6c74c1e7${_scopeId2}> OpenAPI specification</a> — HTTP <code data-v-6c74c1e7${_scopeId2}>429</code>, no response body, two headers: `);
                } else {
                  return [
                    ...
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.1/banking/data-sharing/open-api/accounts-AccountId-products" }, " OpenAPI specification"),
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-6c74c1e7${_scopeId2}> The API Hub forwards the LFI&#39;s <code data-v-6c74c1e7${_scopeId2}>429</code> response (status, <code data-v-6c74c1e7${_scopeId2}>Retry-After</code>, and <code data-v-6c74c1e7${_scopeId2}>x-fapi-interaction-id</code>) to the TPP without modification. There is no Hub-side translation step — the TPP receives the same response the LFI emitted. See the corresponding <a href="/tech/tpp-standards/v2.1/banking/data-sharing/api-guide/finance-rates#rate-limits" data-v-6c74c1e7${_scopeId2}>TPP API guide</a> for the customer-facing handling on the other end of the pipe. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      ...
                      createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/api-guide/finance-rates#rate-limits" }, "TPP API guide"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/banking/data-sharing/api-guide/finance-rates.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const financeRates = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6c74c1e7"]]);
export {
