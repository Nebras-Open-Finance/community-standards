    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_RedocWrapper, {
          ...
          filterPath: "/organisations/export/open-data",
          displayPath: "/participants",
          overrideServers: [{ url: "https://data.directory.openfinance.ae" }, { url: "https://data.sandbox.directory.openfinance.ae" }],
          hideSecurity: true
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/trust-framework/open-api/participants.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const participants = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
