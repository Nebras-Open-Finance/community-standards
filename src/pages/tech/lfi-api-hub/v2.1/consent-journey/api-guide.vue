  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        ...
        <li>
          ...
          <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/">Headless Heimdall</a> and
          <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/">Consent Manager</a> base URLs to
          verify. See <a href="/tech/lfi-api-hub/v2.1/api-hub/connectivity/">Connectivity &amp; Certificates</a>
        </li>
        <li>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/open-api/auth" class="endpoint"><span class="http-method http-method--get">GET</span><code>/auth</code></a></td>
              <td>LFI &rarr; API Hub</td>
              <td>Initiate the authorization interaction</td>
            </tr>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/consents/{consentId}</code></a></td>
              <td>LFI &rarr; API Hub</td>
            ...
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/open-api/auth-interactionId-doFail" class="endpoint"><span class="http-method http-method--post">POST</span><code>/auth/{interactionId}/doFail</code></a></td>
              <td>LFI &rarr; API Hub</td>
    ...
    >
      ...
      <EdProse>
        ...
        Request JWT. See the
        <a href="/tech/tpp-standards/v2.1/consent/api-guide">TPP Consent API Guide</a>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.1/consent-events/open-api/validate">Validate Consent API Reference</a>
      ...
      <EdProse>
        If your LFI has configured the
        <a href="/tech/lfi-api-hub/v2.1/consent-events/open-api/event-op" class="endpoint"><span class="http-method http-method--post">POST</span><code>/consent/event/{operation}</code></a>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/open-api/auth"><span class="endpoint"><span class="http-method http-method--get">GET</span><code>/auth</code></span> API Reference</a>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/consents-consentId"><span class="endpoint"><span class="http-method http-method--get">GET</span><code>/consents/{consentId}</code></span> API Reference</a>
        for the full response schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td><a href="/tech/lfi-api-hub/v2.1/banking/data-sharing/user-journeys">User Experience</a></td>
            </tr>
            <tr>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/patch-consents-consentId"><span class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/consents/{consentId}</code></span> API Reference</a>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm"><span class="endpoint"><span class="http-method http-method--post">POST</span><code>/auth/{interactionId}/doConfirm</code></span> API Reference</a>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/open-api/auth-interactionId-doFail"><span class="endpoint"><span class="http-method http-method--post">POST</span><code>/auth/{interactionId}/doFail</code></span> API Reference</a>
        for the full specification.
      </EdProse>
    </EdSectionBand>
