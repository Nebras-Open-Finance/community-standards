...
import { domesticPaymentsTppArea } from '@/data/functional-certification/domestic-payments-tpp'

const explainerPath =
  '/tech/tpp-standards/production/testing-certification/functional/domestic-payments'
</script>
...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          Functional Certification &middot; Domestic Payments
        </div>
        <h1 class="ed-doc__title">Build your submission</h1>
        <p class="ed-doc__lede">
          Complete each step, provide the Consent and Risk objects for every payment type you offer, and
          download a ZIP to attach to your
          <strong>{{ domesticPaymentsTppArea.certType }}</strong> Service Desk ticket. New here?
    ...
    <div class="ed-doc__body">
      <div class="ed-doc__inner">
        <FcPaymentTppPortal :area="domesticPaymentsTppArea" />
      </div>
    </div>
  </div>
</template>
