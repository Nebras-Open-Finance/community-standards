...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-d9f9bb3c><section class="ed-doc__hero" data-v-d9f9bb3c><div class="ed-doc__inner" data-v-d9f9bb3c><div class="ed-doc__eyebrow" data-v-d9f9bb3c><span class="ed-doc__eyebrow-dash" data-v-d9f9bb3c></span> Banking · Products &amp; Leads · UX </div><h1 class="ed-doc__title" data-v-d9f9bb3c> Products and Leads — User Experience <span class="ed-doc__read" data-v-d9f9bb3c>5 min read</span></h1><p class="ed-doc__lede" data-v-d9f9bb3c> The following wireframes and guidelines outline the essential information and functionality that must be provided to the User, while enabling TPPs to implement additional features and capabilities to address their commercial and service-specific needs. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-d9f9bb3c> While you may adapt visual elements such as colour palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the product information presented to the User. The style and presentation of the returned product information within the &#39;Product Features &amp; Characteristics&#39; section falls within the competitive domain of TPPs, enabling them to design and implement their own customer experience — including how product information is summarised and how detailed information is presented. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-d9f9bb3c> Your Products and Leads user experience must be submitted as part of <strong data-v-d9f9bb3c>CX certification</strong> prior to production, and any material changes to a production implementation must be re-submitted for review and approval. </p></div></section>`);
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-d9f9bb3c${_scopeId2}><thead data-v-d9f9bb3c${_scopeId2}><tr data-v-d9f9bb3c${_scopeId2}><th data-v-d9f9bb3c${_scopeId2}>ID</th><th data-v-d9f9bb3c${_scopeId2}>Requirement</th><th data-v-d9f9bb3c${_scopeId2}>UX Guidelines Statement</th></tr></thead><tbody data-v-d9f9bb3c${_scopeId2}><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>1</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MAY</strong></td><td data-v-d9f9bb3c${_scopeId2}>Include additional text and information about the service they will be providing to the User. This additional information should clarify that the products returned will NOT include: <ul data-v-d9f9bb3c${_scopeId2}><li data-v-d9f9bb3c${_scopeId2}>tailored individual quotes, or</li><li data-v-d9f9bb3c${_scopeId2}>confirmation of pre-approval for the product by the LFI</li></ul></td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>1.1</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST</strong></td><td data-v-d9f9bb3c${_scopeId2}>Request that the User selects the LFI into which their salary is currently deposited, and confirm whether they would be willing to switch banks and have their salary deposited into a different LFI if required by the product&#39;s eligibility criteria. This information is necessary for LFIs to determine whether the User is an existing customer and to assess eligibility for specific products or rates.</td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>1.2</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST</strong></td><td data-v-d9f9bb3c${_scopeId2}>Allow the User to select whether they only wish to see Shari&#39;a compliant banking products. When Shari&#39;a compliant products are displayed, the appropriate Shari&#39;a compliant product names must be used.</td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>1.3</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST</strong></td><td data-v-d9f9bb3c${_scopeId2}>Allow the User to select the type of Banking products they are interested in.</td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>1.4</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST</strong></td><td data-v-d9f9bb3c${_scopeId2}>Display a list of optional Preference options that the User can populate to filter LFI products that do not meet their requirements or personal circumstances. TPPs <strong data-v-d9f9bb3c${_scopeId2}>MAY</strong>: <ul data-v-d9f9bb3c${_scopeId2}><li data-v-d9f9bb3c${_scopeId2}>Include different and/or additional Preferences to assess the suitability of each returned LFI product</li><li data-v-d9f9bb3c${_scopeId2}>Make a Preference option mandatory if the information is essential for the TPP&#39;s product assessment or User service</li><li data-v-d9f9bb3c${_scopeId2}>Decide what option values are displayed in each Preference drop-down list</li></ul></td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>1.5</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST</strong></td><td data-v-d9f9bb3c${_scopeId2}>Provide the User the option on what order or ranking the returned products are displayed to them, and ensure products are displayed in the selected order. Depending on the product type the order options could be: <ul data-v-d9f9bb3c${_scopeId2}><li data-v-d9f9bb3c${_scopeId2}>Rate</li><li data-v-d9f9bb3c${_scopeId2}>Annual Return</li><li data-v-d9f9bb3c${_scopeId2}>Minimum Opening Balance</li><li data-v-d9f9bb3c${_scopeId2}>Minimum Salary</li><li data-v-d9f9bb3c${_scopeId2}>Minimum Balance Required</li><li data-v-d9f9bb3c${_scopeId2}>Annual Fee</li><li data-v-d9f9bb3c${_scopeId2}>Alphabetically</li></ul></td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>1.6</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST</strong></td><td data-v-d9f9bb3c${_scopeId2}>Show a list of LFIs the product information will be requested from, using LFI logos and brand names as defined in the Trust Framework Directory (or the Alternative Brand Name provided by the LFI for Shari&#39;a compliant products). The User must be able to de-select specific LFIs they do not wish to receive products from. By default &quot;All LFIs&quot; must be selected.</td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>1.7</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST</strong></td><td data-v-d9f9bb3c${_scopeId2}>Show a &quot;Loading Products&quot; screen when the User selects &quot;View Products&quot; to indicate that products are being requested from the selected LFIs.</td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>2.1</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST NOT</strong></td><td data-v-d9f9bb3c${_scopeId2}>Give preference to or recommend products based on commercial agreements with specific LFIs.</td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>2.2</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MAY</strong></td><td data-v-d9f9bb3c${_scopeId2}>Choose how they show the returned product information and the level of data displayed to the User based on the service they wish to provide.</td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>2.3</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST</strong></td><td data-v-d9f9bb3c${_scopeId2}>Provide three options when the User selects an individual product: <ul data-v-d9f9bb3c${_scopeId2}><li data-v-d9f9bb3c${_scopeId2}>Apply Now</li><li data-v-d9f9bb3c${_scopeId2}>Request contact from bank</li><li data-v-d9f9bb3c${_scopeId2}>Cancel</li></ul> The User must be able to exit the individual product view and return to the product list. </td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>2.4</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST</strong></td><td data-v-d9f9bb3c${_scopeId2}>When the User selects the &quot;Apply Now&quot; option: <ul data-v-d9f9bb3c${_scopeId2}><li data-v-d9f9bb3c${_scopeId2}>If the LFI has provided a URI in the <code data-v-d9f9bb3c${_scopeId2}>ApplicationUri</code> field, confirm that the User will be redirected to the LFI to commence the application process</li><li data-v-d9f9bb3c${_scopeId2}>If no <code data-v-d9f9bb3c${_scopeId2}>ApplicationUri</code> is provided, display the alternative application channels provided by the LFI: <code data-v-d9f9bb3c${_scopeId2}>ApplicationPhoneNumber</code>, <code data-v-d9f9bb3c${_scopeId2}>ApplicationEmail</code>, and/or <code data-v-d9f9bb3c${_scopeId2}>ApplicationDescription</code></li><li data-v-d9f9bb3c${_scopeId2}>When a telephone number is provided and the User is on a mobile device, allow the User to initiate a phone call to the LFI</li></ul></td></tr><tr data-v-d9f9bb3c${_scopeId2}><td data-v-d9f9bb3c${_scopeId2}>2.5</td><td data-v-d9f9bb3c${_scopeId2}><strong data-v-d9f9bb3c${_scopeId2}>MUST</strong></td><td data-v-d9f9bb3c${_scopeId2}>When the User selects the &quot;Request contact from bank&quot; option: <ul data-v-d9f9bb3c${_scopeId2}><li data-v-d9f9bb3c${_scopeId2}>Display the User information that must be provided or will be shared with the LFI when already held by the TPP</li><li data-v-d9f9bb3c${_scopeId2}>Confirm to the User that the displayed or provided information will be shared with the LFI for follow-up regarding the specific product</li><li data-v-d9f9bb3c${_scopeId2}>Capture the User&#39;s Emirates ID as part of generating a lead for an LFI</li><li data-v-d9f9bb3c${_scopeId2}>Provide an acknowledgement window or message when the User information has been successfully provided to the LFI</li></ul> TPPs <strong data-v-d9f9bb3c${_scopeId2}>MAY</strong> include a free text box for the User to specify the reason for the LFI follow-up request. </td></tr></tbody></table>`);
            } else {
              return [
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h3 data-v-d9f9bb3c${_scopeId}>Example 1 — User requests product comparison and selects &#39;Apply Now&#39;</h3>`);
        ...
        _push2(`<h3 data-v-d9f9bb3c${_scopeId}>Example 2 — User requests product comparison and selects &#39;Request contact from bank&#39;</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(`<h3 data-v-d9f9bb3c${_scopeId}>Example 3 — User requests product comparison and selects &#39;Apply Now&#39; — No Application URL Provided</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/products-leads/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-d9f9bb3c"]]);
export {
