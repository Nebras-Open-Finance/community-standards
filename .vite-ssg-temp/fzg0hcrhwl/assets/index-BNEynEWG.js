...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-fcfe7fa0><section class="ed-doc__hero" data-v-fcfe7fa0><div class="ed-doc__inner" data-v-fcfe7fa0><div class="ed-doc__eyebrow" data-v-fcfe7fa0><span class="ed-doc__eyebrow-dash" data-v-fcfe7fa0></span> LFI · Insurance · Data Sharing </div><h1 class="ed-doc__title" data-v-fcfe7fa0> Insurance Data Sharing — API Guide <span class="ed-doc__read" data-v-fcfe7fa0>5 min read</span></h1><p class="ed-doc__lede" data-v-fcfe7fa0> How your Ozone Connect server receives, processes, and responds to Insurance Data Sharing requests proxied by the API Hub. The end-to-end flow — consent validation, authorisation, token issuance — is identical to Bank Data Sharing; this page focuses on the insurance-specific differences. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-fcfe7fa0${_scopeId2}><thead data-v-fcfe7fa0${_scopeId2}><tr data-v-fcfe7fa0${_scopeId2}><th data-v-fcfe7fa0${_scopeId2}>Endpoint</th><th data-v-fcfe7fa0${_scopeId2}>Purpose</th></tr></thead><tbody data-v-fcfe7fa0${_scopeId2}><tr data-v-fcfe7fa0${_scopeId2}><td data-v-fcfe7fa0${_scopeId2}><span class="endpoint" data-v-fcfe7fa0${_scopeId2}><span class="http-method http-method--get" data-v-fcfe7fa0${_scopeId2}>GET</span><code data-v-fcfe7fa0${_scopeId2}>/{type}-insurance-policies</code></span></td><td data-v-fcfe7fa0${_scopeId2}>Return every policy of the named sector the consent grants access to.</td></tr><tr data-v-fcfe7fa0${_scopeId2}><td data-v-fcfe7fa0${_scopeId2}><span class="endpoint" data-v-fcfe7fa0${_scopeId2}><span class="http-method http-method--get" data-v-fcfe7fa0${_scopeId2}>GET</span><code data-v-fcfe7fa0${_scopeId2}>/{type}-insurance-policies/{InsurancePolicyId}</code></span></td><td data-v-fcfe7fa0${_scopeId2}>Return the single policy identified by the path parameter, after checking it belongs to the consented customer.</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Substitute the sector slug (<code data-v-fcfe7fa0${_scopeId2}>employment</code>, <code data-v-fcfe7fa0${_scopeId2}>health</code>, <code data-v-fcfe7fa0${_scopeId2}>home</code>, <code data-v-fcfe7fa0${_scopeId2}>life</code>, <code data-v-fcfe7fa0${_scopeId2}>motor</code>, <code data-v-fcfe7fa0${_scopeId2}>renters</code>, <code data-v-fcfe7fa0${_scopeId2}>travel</code>) for <code data-v-fcfe7fa0${_scopeId2}>{type}</code>. Implement only the sectors your LFI underwrites — the API Hub will not route requests for unmounted sectors. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` During consent creation, if your LFI has configured the <a href="/tech/lfi-api-hub/v2.1/consent-events/open-api/validate" class="endpoint" data-v-fcfe7fa0${_scopeId2}><span class="http-method http-method--post" data-v-fcfe7fa0${_scopeId2}>POST</span><code data-v-fcfe7fa0${_scopeId2}>/consent/action/validate</code></a> endpoint, the API Hub forwards the full insurance consent payload to your Ozone Connect server before the consent is created. For Insurance Data Sharing consents, <code data-v-fcfe7fa0${_scopeId2}>consentType</code> is <code data-v-fcfe7fa0${_scopeId2}>cbuae-insurance-consents</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The mechanics are identical to Bank Data Sharing — respond with <code data-v-fcfe7fa0${_scopeId2}>data.status: valid</code> to allow the consent, or <code data-v-fcfe7fa0${_scopeId2}>invalid</code> with an error if the requested permissions cannot be granted. See the <a href="/tech/lfi-api-hub/v2.1/consent-journey/api-guide#step-2-optional-validate-the-consent" data-v-fcfe7fa0${_scopeId2}>Consent Journey API Guide — Validate the consent</a> for the request and response shapes. `);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    ...
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.1/banking/data-sharing/api-guide#consent-flow" }, "Bank Data Sharing — Consent flow"),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 class="ed-doc__subhead" data-v-fcfe7fa0${_scopeId}>Field population</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Every field that <strong data-v-fcfe7fa0${_scopeId2}>exists</strong> on the LFI’s systems, or is <strong data-v-fcfe7fa0${_scopeId2}>derivable</strong> from them, MUST be populated in the response. TPPs rely on this data to serve customer use cases end-to-end — a field omitted by the LFI is a feature the TPP cannot build. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-fcfe7fa0${_scopeId}>Common request headers</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Insurance endpoints receive the same set of <code data-v-fcfe7fa0${_scopeId2}>o3-*</code> headers from the API Hub as Bank Data Sharing. See <a href="/tech/lfi-api-hub/v2.1/banking/data-sharing/api-guide#common-request-headers" data-v-fcfe7fa0${_scopeId2}>Common request headers</a> for the full table. `);
                } else {
                  return [
                    ...
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.1/banking/data-sharing/api-guide#common-request-headers" }, "Common request headers"),
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-fcfe7fa0${_scopeId}>No pagination</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Insurance policy endpoints return the full set of consented policies for the named sector in a single response. There is no <code data-v-fcfe7fa0${_scopeId2}>page</code> query parameter, and <code data-v-fcfe7fa0${_scopeId2}>Meta</code> does not carry <code data-v-fcfe7fa0${_scopeId2}>TotalPages</code> or <code data-v-fcfe7fa0${_scopeId2}>TotalRecords</code>. If the consent grants access to twelve motor policies, your <code data-v-fcfe7fa0${_scopeId2}>/motor-insurance-policies</code> response MUST contain all twelve. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-fcfe7fa0${_scopeId}>Error responses</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Use the same UAE Open Finance error envelope and HTTP status codes as Bank Data Sharing. <code data-v-fcfe7fa0${_scopeId2}>404</code> for an <code data-v-fcfe7fa0${_scopeId2}>InsurancePolicyId</code> the consent does not grant access to. <code data-v-fcfe7fa0${_scopeId2}>403</code> if the policy exists but is not in a state your LFI surfaces (e.g. cancelled and outside the retention window). The Hub validates token, consent, and TPP role before the request reaches your endpoint; you do not re-validate any of those. `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-fcfe7fa0${_scopeId}><span class="http-badge http-get" data-v-fcfe7fa0${_scopeId}>GET</span><code class="ed-doc__endpoint-path" data-v-fcfe7fa0${_scopeId}>/{type}-insurance-policies</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Return every active policy of the named sector the consent grants access to. Each <code data-v-fcfe7fa0${_scopeId2}>Policy</code> entry MUST include the fields required by the OpenAPI spec for that sector, plus every optional field your LFI holds. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-fcfe7fa0${_scopeId}>Required permission</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The Hub only routes the request to your endpoint if the consent contains <code data-v-fcfe7fa0${_scopeId2}>ReadInsurancePolicies</code> for the named sector. You do not need to re-check the permission. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-fcfe7fa0${_scopeId}>Example response</h3>`);
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-fcfe7fa0${_scopeId}><span class="http-badge http-get" data-v-fcfe7fa0${_scopeId}>GET</span><code class="ed-doc__endpoint-path" data-v-fcfe7fa0${_scopeId}>/{type}-insurance-policies/{InsurancePolicyId}</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Return the single policy identified by <code data-v-fcfe7fa0${_scopeId2}>InsurancePolicyId</code>. The <code data-v-fcfe7fa0${_scopeId2}>InsurancePolicyId</code> MUST belong to a policy your LFI underwrites for the customer identified by the <code data-v-fcfe7fa0${_scopeId2}>o3-psu-identifier</code> header — if it does not, respond with <code data-v-fcfe7fa0${_scopeId2}>404</code>. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-fcfe7fa0${_scopeId2}>Premium</code> field on every policy is defined as <code data-v-fcfe7fa0${_scopeId2}>anyOf</code> a structured <code data-v-fcfe7fa0${_scopeId2}>AEInsurance.AEInsuranceDataSharingPremiumProperties</code> object or an <code data-v-fcfe7fa0${_scopeId2}>AEInsurance.AEInsurancePremiumJWE</code> compact string. Your LFI decides, per policy, whether to return the premium in cleartext or as an encrypted JWE. `);
                } else {
                  return [
                    createTextVNode(" The "),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fcfe7fa0${_scopeId2}><strong data-v-fcfe7fa0${_scopeId2}>Cleartext</strong> — populate the structured object with <code data-v-fcfe7fa0${_scopeId2}>PremiumAmountExcludingVAT</code>, <code data-v-fcfe7fa0${_scopeId2}>PremiumVATAmount</code>, <code data-v-fcfe7fa0${_scopeId2}>TotalPremiumAmount</code>, <code data-v-fcfe7fa0${_scopeId2}>Currency</code>, and <code data-v-fcfe7fa0${_scopeId2}>PremiumFrequency</code>. </li><li data-v-fcfe7fa0${_scopeId2}><strong data-v-fcfe7fa0${_scopeId2}>Encrypted (JWE)</strong> — encrypt the same structured object as a compact JWE using key material the customer’s device can unwrap. The TPP MUST NOT decrypt the JWE on its server — this lets you surface premium values that are commercially sensitive without the TPP backend ever holding the cleartext. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Whichever shape you choose, return it under the <code data-v-fcfe7fa0${_scopeId2}>Premium</code> key in the policy object. The TPP guide explains the customer-device decryption flow in detail at <a href="/tech/tpp-standards/v2.1/insurance/data-sharing/api-guide/premiums" data-v-fcfe7fa0${_scopeId2}>Encrypted Premiums</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-fcfe7fa0${_scopeId2}> The Hub only routes the request with <code data-v-fcfe7fa0${_scopeId2}>Premium</code> in scope if the consent contains <code data-v-fcfe7fa0${_scopeId2}>ReadInsurancePremium</code> for the relevant sector. If the consent does not include this permission, omit the <code data-v-fcfe7fa0${_scopeId2}>Premium</code> field entirely from the response. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/insurance/data-sharing/api-guide/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fcfe7fa0"]]);
export {
  index as default
};
