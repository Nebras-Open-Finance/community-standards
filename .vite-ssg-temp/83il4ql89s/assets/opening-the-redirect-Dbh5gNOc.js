...
import { _ as __unplugin_components_4$1 } from "./RedirectLaunchGuidance-BDZLiFJe.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-4468ce09><section class="ed-doc__hero" data-v-4468ce09><div class="ed-doc__inner" data-v-4468ce09><div class="ed-doc__eyebrow" data-v-4468ce09><span class="ed-doc__eyebrow-dash" data-v-4468ce09></span> LFI · Consent Journey · Redirect </div><h1 class="ed-doc__title" data-v-4468ce09> Opening the Return Redirect <span class="ed-doc__read" data-v-4468ce09>4 min read</span></h1><p class="ed-doc__lede" data-v-4468ce09> Once the customer has authenticated and made their decision, you complete the interaction by calling <code data-v-4468ce09>doConfirm</code> or <code data-v-4468ce09>doFail</code> on the Headless Heimdall Auth Server. The response returns the URL to send the customer <strong data-v-4468ce09>back to the TPP</strong>. <strong data-v-4468ce09>How</strong> your app opens that URL is security-critical — get it wrong and you break app-to-app redirection or expose the customer to credential theft. </p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` After you post the customer&#39;s decision, Headless Heimdall responds with an HTTP <code data-v-4468ce09${_scopeId2}>303</code> whose <code data-v-4468ce09${_scopeId2}>Location</code> header carries the redirect URI — the URL that returns the authorization result (or error) to the TPP. Your app is responsible for opening it: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` This URL is the TPP&#39;s registered <code data-v-4468ce09${_scopeId2}>redirect_uri</code>. On mobile it may be a verified deep link into the TPP&#39;s app, so opening it correctly can hand the customer straight back into the app they started in. See the endpoint references for <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm" data-v-4468ce09${_scopeId2}><code data-v-4468ce09${_scopeId2}>doConfirm</code></a> and <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/open-api/auth-interactionId-doFail" data-v-4468ce09${_scopeId2}><code data-v-4468ce09${_scopeId2}>doFail</code></a>, and the <a href="/tech/lfi-api-hub/v2.1/consent-journey/api-guide" data-v-4468ce09${_scopeId2}>Consent Journey API Guide</a> for the full flow. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-4468ce09${_scopeId2}> This page covers the <strong data-v-4468ce09${_scopeId2}>outbound</strong> redirect — sending the customer from your app back to the TPP. For the <strong data-v-4468ce09${_scopeId2}>inbound</strong> direction — how the customer&#39;s arrival at your Authorization Endpoint opens your own app — see <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/auth-endpoint" data-v-4468ce09${_scopeId2}>Authorization Endpoint</a>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdProse, null, {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(` If the customer authenticated in a web browser — your desktop or mobile web channel — instead of your native app, opening the return redirect is simpler. Just follow the <code data-v-4468ce09${_scopeId3}>doConfirm</code> / <code data-v-4468ce09${_scopeId3}>doFail</code> <code data-v-4468ce09${_scopeId3}>303</code> as a normal <strong data-v-4468ce09${_scopeId3}>full-page browser redirect</strong> back to the TPP&#39;s <code data-v-4468ce09${_scopeId3}>redirect_uri</code>. `);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_EdBullets, null, {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<li data-v-4468ce09${_scopeId3}><strong data-v-4468ce09${_scopeId3}>Follow the <code data-v-4468ce09${_scopeId3}>Location</code> header at the top level of the browser</strong> — a standard <code data-v-4468ce09${_scopeId3}>303</code> redirect. Do not wrap the return in an <code data-v-4468ce09${_scopeId3}>&lt;iframe&gt;</code> or embedded frame.</li><li data-v-4468ce09${_scopeId3}><strong data-v-4468ce09${_scopeId3}>Desktop cross-device journeys</strong> — where the customer started on a desktop browser and authenticated on their phone — complete on your Authorization Endpoint page, which polls for completion and then performs this redirect. See <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/auth-endpoint#desktop-browser" data-v-4468ce09${_scopeId3}>Authorization Endpoint — Desktop browser behaviour</a>.</li>`);
                      } else {
                        return [
                          createVNode("li", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/consent-journey/opening-the-redirect.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const openingTheRedirect = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4468ce09"]]);
export {
