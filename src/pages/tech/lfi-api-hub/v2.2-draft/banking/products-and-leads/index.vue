  ...
  <div class="ed-landing">
    <section class="ed-landing__hero">
      <div class="ed-landing__inner">
        ...
        <p class="ed-landing__lede">The Products &amp; Leads API allows LFIs to publish their banking product catalogue and to receive customer leads forwarded by TPPs. Customers browse products in the TPP application and either apply directly via a channel the LFI configures (redirect URI, phone, email, or written instructions), or request follow-up contact &mdash; in which case the API Hub forwards the lead and the LFI follows up within 30 days.</p>
      </div>
    </section>
    ...
    <section class="ed-landing__role">
      <div class="ed-landing__inner">
        <div class="ed-landing__role-card">
          ...
          <p class="ed-landing__role-body">Access to the Products &amp; Leads API requires TPPs to hold the <strong>BDSP</strong> role. The API Hub validates the role on every request before proxying it to the LFI.</p>
        </div>
      </div>
    </section>
    ...
    <section class="ed-landing__live">
      <div class="ed-landing__inner">
        <div class="ed-landing__live-head">
          ...
          <h2 class="ed-landing__live-title">Who's consuming Products & Leads</h2>
          <p class="ed-landing__live-sub">TPPs currently calling the Products &amp; Leads API across UAE Open Finance.</p>
        </div>
    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a class="ed-link-card" href="/tech/lfi-api-hub/v2.2-draft/banking/products-and-leads/requirements" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
            ...
            <p class="ed-link-card__desc">Validation rules and behaviour your Ozone Connect Products &amp; Leads endpoints must follow.</p>
            <div class="ed-link-card__foot"><span class="ed-link-card__cta">Open</span><span class="ed-link-card__arrow">&rarr;</span></div>
          </a>
          <a class="ed-link-card" href="/tech/lfi-api-hub/v2.2-draft/banking/products-and-leads/api-guide" :style="{ '--card-color': 'var(--at-teal)' }">
            <span class="ed-link-card__top" />
