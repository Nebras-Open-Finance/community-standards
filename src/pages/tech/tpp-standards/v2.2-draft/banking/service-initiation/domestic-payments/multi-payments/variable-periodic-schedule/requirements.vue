...
import { data } from '@/data/requirements/v2.2-draft/tpp-standards-v2-1-banking-service-initiation-domestic-payments-multi-payments-variable-periodic-schedule'
