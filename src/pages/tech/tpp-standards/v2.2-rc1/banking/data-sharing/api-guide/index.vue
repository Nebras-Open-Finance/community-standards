  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        ...
        <li>
          <strong>Understanding of <a href="/tech/tpp-standards/v2.2-rc1/consent/">Consents</a></strong>
    ...
    >
      ...
      <EdNote type="tip" title="User Experience">
        <p>
          See <a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/user-journeys">User Experience</a> for screen mockups of the
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts">GET /accounts</a> API
    ...
    >
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            <tr><td><code>/accounts/{AccountId}/balances</code></td><td><code>ReadBalances</code></td><td><a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-balances">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/transactions</code></td><td><code>ReadTransactionsBasic</code></td><td><a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-transactions">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/beneficiaries</code></td><td><code>ReadBeneficiariesBasic</code></td><td><a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-beneficiaries">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/direct-debits</code></td><td><code>ReadDirectDebits</code></td><td><a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-direct-debits">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/standing-orders</code></td><td><code>ReadStandingOrdersBasic</code></td><td><a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-standing-orders">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/scheduled-payments</code></td><td><code>ReadScheduledPaymentsBasic</code></td><td><a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-scheduled-payments">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/statements</code></td><td><code>ReadStatements</code></td><td><a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-statements">reference</a></td></tr>
            <tr><td><code>/accounts/{AccountId}/parties</code></td><td><code>ReadParty</code></td><td><a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-parties">reference</a></td></tr>
          </tbody>
        </table>
      </EdRefTable>
