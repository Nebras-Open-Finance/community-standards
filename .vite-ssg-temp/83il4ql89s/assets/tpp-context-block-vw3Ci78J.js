...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-e710b270>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-e710b270${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-e710b270${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e710b270${_scopeId2}>Verified the TPP&#39;s mTLS transport certificate against the Trust Framework directory</li><li data-v-e710b270${_scopeId2}>Verified the TPP&#39;s signing certificate against the SSA&#39;s <code data-v-e710b270${_scopeId2}>jwks_uri</code></li><li data-v-e710b270${_scopeId2}>Confirmed the TPP&#39;s role (<code data-v-e710b270${_scopeId2}>BSIP</code>, <code data-v-e710b270${_scopeId2}>BDSP</code>, etc.) entitles it to call this endpoint</li><li data-v-e710b270${_scopeId2}>Confirmed the consent referenced by the request belongs to this TPP</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`If your LFI&#39;s payment processing logic does not look at <code data-v-e710b270${_scopeId2}>tpp</code> or <code data-v-e710b270${_scopeId2}>decodedSsa</code>, no rule is being broken. They are passed through so the LFI <strong data-v-e710b270${_scopeId2}>can</strong> consume them when it has a reason to — they are not a validation surface.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e710b270${_scopeId2}><thead data-v-e710b270${_scopeId2}><tr data-v-e710b270${_scopeId2}><th data-v-e710b270${_scopeId2}>Use case</th><th data-v-e710b270${_scopeId2}>What you&#39;d read</th></tr></thead><tbody data-v-e710b270${_scopeId2}><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}>Audit log enrichment</strong> — labelling each Ozone Connect call with the human-readable identity of the TPP that triggered it</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>tpp.tppName</code>, <code data-v-e710b270${_scopeId2}>tpp.tppId</code>, <code data-v-e710b270${_scopeId2}>decodedSsa.client_name</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}>Customer-facing display</strong> — surfacing the TPP brand in app history (e.g. &quot;Payment initiated by Mario Money&quot;)</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>decodedSsa.client_name</code>, <code data-v-e710b270${_scopeId2}>decodedSsa.logo_uri</code>, <code data-v-e710b270${_scopeId2}>decodedSsa.client_uri</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}>Fraud and risk signals</strong> — feeding TPP identity, organisation, and roles into your scoring model</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>tpp.clientId</code>, <code data-v-e710b270${_scopeId2}>tpp.orgId</code>, <code data-v-e710b270${_scopeId2}>decodedSsa.roles</code>, <code data-v-e710b270${_scopeId2}>decodedSsa.organisation_id</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}>Compliance / regulatory reporting</strong> — producing per-TPP volume and value reports for the CBUAE</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>tpp.tppId</code>, <code data-v-e710b270${_scopeId2}>tpp.tppName</code>, <code data-v-e710b270${_scopeId2}>tpp.softwareStatementId</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}>Support investigations</strong> — correlating an incident to a specific TPP application without round-tripping through Nebras</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>tpp.softwareStatementId</code>, <code data-v-e710b270${_scopeId2}>decodedSsa.client_id</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}>Privacy / right-to-be-forgotten</strong> — pinning the directory record at the moment of the call so the LFI can prove what was advertised about the TPP at that point in time</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>tpp.directoryRecord</code></td></tr></tbody></table>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e710b270${_scopeId2}><thead data-v-e710b270${_scopeId2}><tr data-v-e710b270${_scopeId2}><th data-v-e710b270${_scopeId2}>Field</th><th data-v-e710b270${_scopeId2}>Type</th><th data-v-e710b270${_scopeId2}>Required</th><th data-v-e710b270${_scopeId2}>Description</th><th data-v-e710b270${_scopeId2}>Example</th></tr></thead><tbody data-v-e710b270${_scopeId2}><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>clientId</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>Yes</td><td data-v-e710b270${_scopeId2}>The OIDC client identifier issued to the TPP by the Trust Framework. Stable for the life of the TPP application.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>1675793e-d6e3-4954-96c8-acb9aaa83c53</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>orgId</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>Yes</td><td data-v-e710b270${_scopeId2}>The organisation identifier issued to the TPP&#39;s parent organisation by the Trust Framework. One organisation may own many <code data-v-e710b270${_scopeId2}>clientId</code>s.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>a1b2c3d4-e5f6-7890-abcd-ef0123456789</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>tppId</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>Yes</td><td data-v-e710b270${_scopeId2}>The identifier the API Hub uses internally to uniquely identify the TPP. Useful when raising support cases with Nebras.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>fdd6e0ac-ba7a-4bc4-a986-c45c5daaaf00</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>tppName</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>Yes</td><td data-v-e710b270${_scopeId2}>The TPP&#39;s registered name as recorded in the Trust Framework.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>Example TPP</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>softwareStatementId</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>Yes</td><td data-v-e710b270${_scopeId2}>The identifier of the specific software statement (i.e. the registered application) being used. A single <code data-v-e710b270${_scopeId2}>clientId</code> may have multiple software statements over time.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>XvAjPeeYZAdWwrFF..</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>directoryRecord</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>No</td><td data-v-e710b270${_scopeId2}>The full TPP directory record retrieved from the CBUAE Trust Framework directory at the time of the call, encoded as a Base64 string. Only present when the Hub fetched it for this request.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>eyJhbW91bnQiOiIxMDAuMDAi..</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>decodedSsa</code></td><td data-v-e710b270${_scopeId2}>object</td><td data-v-e710b270${_scopeId2}>Yes</td><td data-v-e710b270${_scopeId2}>The decoded Software Statement Assertion — see the next section.</td><td data-v-e710b270${_scopeId2}>—</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 data-v-e710b270${_scopeId}><code data-v-e710b270${_scopeId}>clientId</code> vs <code data-v-e710b270${_scopeId}>tppId</code> vs <code data-v-e710b270${_scopeId}>softwareStatementId</code></h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>clientId</code></strong> — issued by the Trust Framework when the TPP registers an OIDC client. This is the value the TPP uses as <code data-v-e710b270${_scopeId2}>iss</code> and <code data-v-e710b270${_scopeId2}>sub</code> on its client assertions, and what the API Hub records against tokens.</li><li data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>softwareStatementId</code></strong> — issued by the Trust Framework when the TPP registers a <em data-v-e710b270${_scopeId2}>specific application</em> (the SSA). One <code data-v-e710b270${_scopeId2}>clientId</code> typically has one active SSA, but the SSA can be re-issued (for example after rotating keys) without a new <code data-v-e710b270${_scopeId2}>clientId</code>.</li><li data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>tppId</code></strong> — the Hub&#39;s internal identifier. Use this when raising tickets with Nebras; use <code data-v-e710b270${_scopeId2}>clientId</code> or <code data-v-e710b270${_scopeId2}>softwareStatementId</code> when correlating with anything published in the Trust Framework.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e710b270${_scopeId2}><thead data-v-e710b270${_scopeId2}><tr data-v-e710b270${_scopeId2}><th data-v-e710b270${_scopeId2}>Field</th><th data-v-e710b270${_scopeId2}>Type</th><th data-v-e710b270${_scopeId2}>Required</th><th data-v-e710b270${_scopeId2}>Description</th><th data-v-e710b270${_scopeId2}>Example</th></tr></thead><tbody data-v-e710b270${_scopeId2}><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>client_id</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>Yes</td><td data-v-e710b270${_scopeId2}>Globally unique TPP client identifier issued by the Trust Framework. Matches <code data-v-e710b270${_scopeId2}>tpp.clientId</code>.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>1675793e-d6e3-4954-96c8-acb9aaa83c53</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>client_name</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>No</td><td data-v-e710b270${_scopeId2}>Human-readable name of the client as the TPP wants it displayed to end users during authorization flows. Suitable for surfacing in customer-facing app history.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>Example TPP</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>client_uri</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>No</td><td data-v-e710b270${_scopeId2}>Home page URI of the TPP&#39;s client application. Suitable for linking from a &quot;Connected apps&quot; screen.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>https://example.com</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>logo_uri</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>No</td><td data-v-e710b270${_scopeId2}>URL of the TPP&#39;s logo. Suitable for inline display next to historical activity.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>https://example.com/logo.png</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>jwks_uri</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>No</td><td data-v-e710b270${_scopeId2}>URL where the TPP&#39;s JSON Web Key Set is hosted. The Hub uses this to verify the TPP&#39;s signed requests; the LFI does <strong data-v-e710b270${_scopeId2}>not</strong> need to fetch it.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>https://example.com/jwks.json</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>redirect_uris</code></td><td data-v-e710b270${_scopeId2}>array of string</td><td data-v-e710b270${_scopeId2}>No</td><td data-v-e710b270${_scopeId2}>The OAuth redirect endpoints registered for this client. Useful for a sanity check during incident response — never call them directly from the LFI.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>[&quot;https://example.com/callback&quot;]</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>roles</code></td><td data-v-e710b270${_scopeId2}>array of string</td><td data-v-e710b270${_scopeId2}>No</td><td data-v-e710b270${_scopeId2}>The Open Finance roles the TPP is entitled to. The presence of <code data-v-e710b270${_scopeId2}>BSIP</code> (payment initiation), <code data-v-e710b270${_scopeId2}>BDSP</code> (data sharing), etc. tells you what categories of API the TPP can call.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>[&quot;BSIP&quot;, &quot;BDSP&quot;]</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>sector_identifier_uri</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>No</td><td data-v-e710b270${_scopeId2}>OIDC sector identifier URI used for pairwise subject identifiers. Rarely consumed by an LFI.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>https://example.com/sector</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>application_type</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>No</td><td data-v-e710b270${_scopeId2}>OAuth application type — <code data-v-e710b270${_scopeId2}>web</code> or <code data-v-e710b270${_scopeId2}>native</code>. Can feed into device-aware fraud rules.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>web</code></td></tr><tr data-v-e710b270${_scopeId2}><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>organisation_id</code></td><td data-v-e710b270${_scopeId2}>string</td><td data-v-e710b270${_scopeId2}>No</td><td data-v-e710b270${_scopeId2}>Identifier of the organisation that owns the client. Matches <code data-v-e710b270${_scopeId2}>tpp.orgId</code>.</td><td data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>org-1234</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-e710b270${_scopeId2}><code data-v-e710b270${_scopeId2}>client_name</code>, <code data-v-e710b270${_scopeId2}>client_uri</code>, and <code data-v-e710b270${_scopeId2}>logo_uri</code> are values the TPP set when it registered the SSA. They are signed by the Trust Framework, so they have not been tampered with in transit, but the LFI is trusting that the Trust Framework&#39;s onboarding controls are sufficient for these to be safe to display to customers. Treat them as trusted display strings, not as authoritative identifiers — use <code data-v-e710b270${_scopeId2}>client_id</code> / <code data-v-e710b270${_scopeId2}>tpp.tppId</code> for anything that needs to be a primary key.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createVNode("code", null, "client_name"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}>Do not re-authenticate the TPP.</strong> The Hub has already verified the SSA&#39;s signature, the TPP&#39;s mTLS certificate, and the consent ownership. There is no scenario where re-fetching <code data-v-e710b270${_scopeId2}>jwks_uri</code> from the LFI side adds security.</li><li data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}>Do not enforce role checks the Hub already enforces.</strong> If <code data-v-e710b270${_scopeId2}>decodedSsa.roles</code> does not include the role required for the endpoint, the request would not have reached your Ozone Connect surface in the first place.</li><li data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}>Do not call any URI in the SSA from the LFI.</strong> <code data-v-e710b270${_scopeId2}>client_uri</code>, <code data-v-e710b270${_scopeId2}>redirect_uris</code>, <code data-v-e710b270${_scopeId2}>sector_identifier_uri</code>, and <code data-v-e710b270${_scopeId2}>jwks_uri</code> are TPP-controlled URLs. The only system that should fetch them is the API Hub.</li><li data-v-e710b270${_scopeId2}><strong data-v-e710b270${_scopeId2}>Do not reject requests for missing optional fields.</strong> Optional means optional; the TPP may legitimately not have set them at registration time.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
...
const tppContextBlock = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e710b270"]]);
export {
