...
const altOps: AltOp[] = [
  {
    ...
    href: '/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/consents-consentId',
    useWhen: 'You need a single consent by its ID',
  },
  {
    method: 'GET',
    path: '/accounts/{accountId}/consents',
    href: '/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/accounts-accountId-consents',
    useWhen: 'You need all consents linked to a specific account',
  },
  {
    method: 'GET',
    path: '/consents',
    href: '/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/consents',
...
const dataSharingRows: MapRow[] = [
  ...
  },
  {
    ...
    guidelines:
      'Map to user-friendly label per <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/bank-service-initiation/requirements#status-labels">Status labels</a>.',
  },
  {
    num: 5,
    field: 'Consent ID',
...
const sipRows: MapRow[] = [
  ...
  },
  {
    ...
    guidelines:
      'The displayed properties depend on the values found in control parameters, which differ by payment type. Refer to the <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/psu-userId-consents">API spec</a> for available properties.',
  },
  {
    num: 11,
  ...
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          ...
          (<a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/bank-data-sharing/requirements">Bank Data Sharing</a>,
          <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/bank-service-initiation/requirements">Bank Service Initiation</a>,
          <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/insurance-data-sharing/requirements">Insurance Data Sharing</a>)
    ...
    >
      ...
      <ol class="ed-doc__steps">
        <li>
          ...
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/hello-mtls" class="endpoint"><span class="http-method http-method--get">GET</span><code>/hello-mtls</code></a>
        </li>
        <li>
    ...
    >
      ...
      <div class="ed-doc__endpoint">
        ...
        <a
          href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/psu-userId-consents"
    ...
    >
      <EdProse>
        ...
        (<a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/bank-data-sharing/requirements#dashboard-card-content">Bank Data Sharing</a>,
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/bank-service-initiation/requirements#dashboard-card-content">Bank Service Initiation</a>,
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/insurance-data-sharing/requirements#dashboard-card-content">Insurance Data Sharing</a>)
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/bank-data-sharing/requirements#detail-page">Bank Data Sharing Requirements</a>,
        use:
      </EdProse>
      ...
      <div class="ed-doc__endpoint">
        <span class="http-badge http-get">GET</span>
        <a
          href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/consent-groups-consentGroupId-consents"
          class="ed-doc__endpoint-path"
      ...
      <EdNote type="info">
        <p>
          The
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/consents-consentId-audit" class="endpoint"><span class="http-method http-method--get">GET</span><code>/consents/{consentId}/audit</code></a>
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/bank-service-initiation/requirements#detail-page">Bank Service Initiation Requirements</a>,
        use:
      </EdProse>
      ...
      <div class="ed-doc__endpoint">
        <span class="http-badge http-get">GET</span>
        <a
          href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/payment-log"
          class="ed-doc__endpoint-path"
    ...
    >
      ...
      <div class="ed-doc__endpoint">
        ...
        <a
          href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/consents-consentId-action-revoke"
          class="ed-doc__endpoint-path"
      ...
      <div class="ed-doc__endpoint">
        <span class="http-badge http-post">POST</span>
        <a
          href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/consent-groups-consentGroupId-consents-action-revoke"
          class="ed-doc__endpoint-path"
    ...
    >
      ...
      <div class="ed-doc__endpoint">
        <span class="http-badge http-get">GET</span>
        <a
          href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/consents-consentId-audit"
          class="ed-doc__endpoint-path"
    ...
    >
      <EdProse>
        ...
        See
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/bank-service-initiation/requirements#status-labels">Status labels (Bank Service Initiation)</a>
