  ...
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede ed-doc__lede--tight">
          ...
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/connectivity/">API Hub Connectivity &amp; Certificates</a>.
        </p>
      </div>
    </section>
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/prerequisites">prerequisites onboarding</a>.
      </EdProse>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td style="text-align:center">LFI</td>
              <td>The base URL on which your Ozone Connect endpoints are hosted. See <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/ozone-connect-url">Ozone Connect Base URL</a> for details.</td>
            </tr>
            <tr>
              <td><strong>Authorisation URL</strong></td>
              <td style="text-align:center">LFI</td>
              <td>The OIDC authorisation URL for your institution. See <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/auth-endpoint">Authorization Endpoint</a> for details.</td>
            </tr>
          </tbody>
        </table>
      </EdRefTable>
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/ozone-connect-url">Ozone Connect Base URL</a>
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            <tr>
              <td><strong><a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/">Data Sharing</a></strong></td>
              <td><code>/accounts</code>, <code>/balances</code>, <code>/transactions</code></td>
              <td><code>OzoneConnectURL/&lt;path&gt;/accounts</code></td>
            </tr>
            <tr>
              <td><strong><a href="/tech/lfi-api-hub/v2.2-draft/banking/service-initiation/">Service Initiation</a></strong></td>
              <td><code>/domestic-payments</code>, <code>/multi-payments</code></td>
              <td><code>OzoneConnectURL/&lt;path&gt;/domestic-payments</code></td>
            </tr>
            <tr>
              <td><strong><a href="/tech/lfi-api-hub/v2.2-draft/banking/products-and-leads/">Products</a></strong></td>
            ...
            <tr>
              <td><strong><a href="/tech/lfi-api-hub/v2.2-draft/health-check/">Health Check</a></strong></td>
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/certificate-walkthroughs">Certificate Walkthroughs</a>
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/configuring-authentication/mtls-server#3b-pin-to-the-api-hubs-c4-client">Configuring Inbound mTLS</a>
      ...
      <EdNote type="info">
        <p>
          ...
          <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/application-layer-auth#jwt-auth">JWT Auth</a>
    ...
    >
      ...
      <EdBullets>
        <li>
          ...
          endpoints (e.g. the
          <a href="/tech/lfi-api-hub/v2.2-draft/health-check/">health check endpoints</a>
