    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          LFI · API Hub · v2.2-draft · Consent Management Interface
        </div>
      ...
      <div class="ed-doc__levels">
        <article class="ed-doc__level">
          ...
          <p class="ed-doc__level-body">
            ...
            identify each one. The information shown varies by consent type; see the per-product
            Requirements pages for
            <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/bank-data-sharing/requirements">Bank Data Sharing</a>,
            <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/bank-service-initiation/requirements">Bank Service Initiation</a>, and
