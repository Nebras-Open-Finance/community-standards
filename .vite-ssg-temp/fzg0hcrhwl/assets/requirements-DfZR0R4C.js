...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-8d2d00cc><section class="ed-doc__hero" data-v-8d2d00cc><div class="ed-doc__inner" data-v-8d2d00cc><div class="ed-doc__eyebrow" data-v-8d2d00cc><span class="ed-doc__eyebrow-dash" data-v-8d2d00cc></span> TPP Standards · v2.1 · Consent · Requirements </div><h1 class="ed-doc__title" data-v-8d2d00cc> Consent Requirements <span class="ed-doc__read" data-v-8d2d00cc>2 min read</span></h1><p class="ed-doc__lede" data-v-8d2d00cc> These requirements apply to all TPPs operating within UAE Open Finance, regardless of the service type. They are assessed as part of the <a href="/tech/tpp-standards/production/testing-certification/functional/bank-data-sharing" data-v-8d2d00cc>Functional Certification</a> certification process. </p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` A consent must be <strong data-v-8d2d00cc${_scopeId2}>minimally scoped</strong> — it may only request the permissions genuinely necessary to deliver the service being offered to the user at the time of authorisation. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, { type: "warning" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-8d2d00cc${_scopeId2}> LFIs may reject a consent at the <code data-v-8d2d00cc${_scopeId2}>/par</code> stage if the <code data-v-8d2d00cc${_scopeId2}>authorization_details</code> object contains values that are unsupported or disproportionate to the service offered and described via the <a href="/tech/tpp-standards/trust-framework/api-discovery" data-v-8d2d00cc${_scopeId2}><code data-v-8d2d00cc${_scopeId2}>/participants</code> endpoint</a>. This includes: </p><ul data-v-8d2d00cc${_scopeId2}><li data-v-8d2d00cc${_scopeId2}>A <code data-v-8d2d00cc${_scopeId2}>Permissions</code> set broader than the service the LFI supports</li><li data-v-8d2d00cc${_scopeId2}> Field values the LFI does not support — for example, requesting <code data-v-8d2d00cc${_scopeId2}>AccountSubType: CreditCard</code> at an LFI that only supports <code data-v-8d2d00cc${_scopeId2}>CurrentAccount</code> and <code data-v-8d2d00cc${_scopeId2}>Savings</code></li></ul>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` A consent&#39;s <code data-v-8d2d00cc${_scopeId2}>ExpirationDateTime</code> must not exceed <strong data-v-8d2d00cc${_scopeId2}>one year</strong> from the date of consent creation. Consents submitted with an expiry beyond this limit will be rejected by the API Hub. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-8d2d00cc${_scopeId2}>ExpirationDateTime</code> must reflect the minimum period required for the service. A consent must not be issued with an unnecessarily long expiry when the underlying service covers a shorter, defined period. `);
                } else {
                  return [
                    createTextVNode(" The "),
                    createVNode("code", null, "ExpirationDateTime"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The consent screen is rendered by the LFI during the authorization flow and is driven directly by the <code data-v-8d2d00cc${_scopeId2}>authorization_details</code> submitted in the <code data-v-8d2d00cc${_scopeId2}>/par</code> request — the permissions, account scope, and expiry the user sees must <strong data-v-8d2d00cc${_scopeId2}>exactly match</strong> what the TPP requested. TPPs must not present users with a pre-consent screen that describes a different scope than what is ultimately submitted to <code data-v-8d2d00cc${_scopeId2}>/par</code>. `);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    ...
                    createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/data-sharing/user-journeys" }, "Bank Data Sharing User Experience"),
                    createTextVNode(". ")
                  ];
                }
              }),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="ed-doc__methods" data-v-8d2d00cc${_scopeId}><article class="ed-doc__method" data-v-8d2d00cc${_scopeId}><header class="ed-doc__method-head" data-v-8d2d00cc${_scopeId}><span class="ed-doc__method-tag" data-v-8d2d00cc${_scopeId}>Mechanism A</span><h3 class="ed-doc__method-title" data-v-8d2d00cc${_scopeId}>Polling</h3></header><p class="ed-doc__method-body" data-v-8d2d00cc${_scopeId}> The TPP periodically calls the consent status endpoint to check the current state: </p><ul class="ed-doc__method-list" data-v-8d2d00cc${_scopeId}><li data-v-8d2d00cc${_scopeId}><span class="endpoint" data-v-8d2d00cc${_scopeId}><span class="http-method http-method--get" data-v-8d2d00cc${_scopeId}>GET</span><code data-v-8d2d00cc${_scopeId}>/account-access-consents/{ConsentId}</code></span> for Bank Data Sharing consents </li><li data-v-8d2d00cc${_scopeId}><span class="endpoint" data-v-8d2d00cc${_scopeId}><span class="http-method http-method--get" data-v-8d2d00cc${_scopeId}>GET</span><code data-v-8d2d00cc${_scopeId}>/payment-consents/{ConsentId}</code></span> for Bank Service Initiation consents </li></ul><p class="ed-doc__method-body" data-v-8d2d00cc${_scopeId}> Polling should be performed at a reasonable interval. Excessive polling rates are subject to rate limiting by LFIs. </p></article><article class="ed-doc__method ed-doc__method--recommended" data-v-8d2d00cc${_scopeId}><header class="ed-doc__method-head" data-v-8d2d00cc${_scopeId}><span class="ed-doc__method-tag" data-v-8d2d00cc${_scopeId}>Mechanism B</span><h3 class="ed-doc__method-title" data-v-8d2d00cc${_scopeId}> Webhooks <span class="ed-doc__method-sub" data-v-8d2d00cc${_scopeId}>Event Subscriptions</span></h3></header><p class="ed-doc__method-body" data-v-8d2d00cc${_scopeId}> The TPP subscribes to consent status events and is notified by the API Hub whenever a consent transitions between states (e.g. <code data-v-8d2d00cc${_scopeId}>Authorized</code>, <code data-v-8d2d00cc${_scopeId}>Revoked</code>, <code data-v-8d2d00cc${_scopeId}>Expired</code>). This avoids the latency and overhead of polling. See <a href="/tech/tpp-standards/v2.1/webhooks/consent-status/api-guide" data-v-8d2d00cc${_scopeId}>Consent Status Event</a> for the event payload and subscription model. </p></article></div>`);
          } else {
            return [
              createVNode(_component_EdProse, null, {
                default: withCtx(() => [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/consent/requirements.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const requirements = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8d2d00cc"]]);
export {
