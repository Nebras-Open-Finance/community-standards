...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-95c13204><section class="ed-doc__hero" data-v-95c13204><div class="ed-doc__inner" data-v-95c13204><div class="ed-doc__eyebrow" data-v-95c13204><span class="ed-doc__eyebrow-dash" data-v-95c13204></span> LFI · Insurance · Quotation · TPP-Led </div><h1 class="ed-doc__title" data-v-95c13204> TPP-Led Flow <span class="ed-doc__read" data-v-95c13204>7 min read</span></h1><p class="ed-doc__lede" data-v-95c13204> The TPP collects KYC in its own UI and surfaces an LFI-hosted payment URL to the customer. Your LFI is responsible for underwriting, premium pricing, payment hosting, and policy document generation — but customer interaction outside the payment page lives entirely with the TPP. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Create Quote behaves identically to LFI-Led mode — mint a <code data-v-95c13204${_scopeId2}>QuoteId</code>, run underwriting, return <code data-v-95c13204${_scopeId2}>201</code> with the quote details (or <code data-v-95c13204${_scopeId2}>204</code> to decline). The mode forks on PATCH Accept, not on Create. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Respond <code data-v-95c13204${_scopeId2}>200</code> with <code data-v-95c13204${_scopeId2}>data.PolicyIssuanceAllowed</code> declaring which steps the TPP may perform. All three booleans are required. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Immediately after responding, PATCH the quote-log with <code data-v-95c13204${_scopeId2}>QuoteStatus: ApplicationPending</code> so the TPP knows the application has been registered. The TPP will then collect KYC in its own UI. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If KYC fails, respond <code data-v-95c13204${_scopeId2}>400</code> with a descriptive <code data-v-95c13204${_scopeId2}>errorMessage</code>; the TPP will surface the error to the customer and let them retry. If KYC passes, respond <code data-v-95c13204${_scopeId2}>200</code> (no body) and proceed to issue the payment URL. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-95c13204${_scopeId2}> Invalidate the URL after first redemption or after a session window of 15–30 minutes. The TPP MUST NOT cache or replay it. If the customer abandons and returns later, you can emit a fresh <code data-v-95c13204${_scopeId2}>PaymentRequired</code> event with a new URL. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Once payment is confirmed, the TPP calls POST to create the policy. The body carries the originating <code data-v-95c13204${_scopeId2}>QuoteId</code> plus any additional data your LFI requires (most KYC was already submitted via the second PATCH). Issue the policy and respond <code data-v-95c13204${_scopeId2}>201</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If the TPP retries with the same <code data-v-95c13204${_scopeId2}>QuoteId</code>, return the same policy reference — policy creation MUST be idempotent. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Documents MUST be PDFs (<code data-v-95c13204${_scopeId2}>application/pdf</code>) or images (<code data-v-95c13204${_scopeId2}>image/jpeg</code>, <code data-v-95c13204${_scopeId2}>image/png</code>). The TPP verifies each <code data-v-95c13204${_scopeId2}>Hash</code> against the decoded <code data-v-95c13204${_scopeId2}>Content</code> before surfacing to the customer. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Same as LFI-Led: emit a final Completed Status event with the finalised premium breakdown, policy term, and (where applicable) the <code data-v-95c13204${_scopeId2}>Commission</code> due to the TPP. The Hub rejects any subsequent PATCH for this <code data-v-95c13204${_scopeId2}>logId</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-95c13204${_scopeId2}>Commission.PaymentMethod</code> controls how the LFI pays the TPP: <code data-v-95c13204${_scopeId2}>DirectToTPP</code> for direct bilateral settlement, or <code data-v-95c13204${_scopeId2}>ThroughAPIHub</code> for Hub-routed payment. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/insurance/quotation/api-guide/tpp-led.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const tppLed = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-95c13204"]]);
export {
  tppLed as default
};
