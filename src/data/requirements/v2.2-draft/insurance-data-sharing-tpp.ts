...
export const data: RequirementsPageData = {
  ...
  readTime: '10 min',
  lede:
    'The validation rules that apply to Insurance Data Sharing. The <strong>Validated by</strong> column on each table indicates where each rule is enforced. Read alongside the <a href="/tech/tpp-standards/v2.2-draft/consent/requirements">Consent requirements</a> and the <a href="./user-journeys">User Journeys</a>.',
  preconditions:
