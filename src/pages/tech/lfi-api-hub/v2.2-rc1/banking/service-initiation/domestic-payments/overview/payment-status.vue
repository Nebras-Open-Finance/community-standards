  ...
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          ...
          <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/">Consent Manager</a> section.
        </p>
      </div>
    </section>
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments">Ozone Connect
      ...
      <EdNote type="info" title="Received status">
        <p>
          ...
          not yet documented in v2.2 &mdash; for the domestic single and multi-payments covered by this
    ...
    >
      ...
      <EdBullets>
        ...
        <li>
          Call
          <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/payment-log" class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/payment-log/{paymentId}</code></a>
        ...
        <li>
          ...
          <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments" class="endpoint"><span class="http-method http-method--get">GET</span><code>/payments/{paymentId}</code></a>
