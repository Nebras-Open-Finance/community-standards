...
const explainerPath =
  '/tech/lfi-api-hub/production/testing-certification/functional/single-instant-payment'
</script>
...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          Functional Certification &middot; Single Instant Payment
        </div>
        ...
        <p class="ed-doc__lede">
          ...
          <strong>{{ singleInstantPaymentArea.certType }}</strong> Service Desk ticket. New here?
    ...
    <div class="ed-doc__body">
      <div class="ed-doc__inner">
        <FcPaymentPortal :area="singleInstantPaymentArea" />
      </div>
    </div>
  </div>
</template>
