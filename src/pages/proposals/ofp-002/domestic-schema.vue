...
// Renders the co-located OFP-002 domestic draft schema with the shared Redoc
// wrapper and EndpointPage chrome — the same presentation as the published API
// specs. See the sibling international-schema.vue for notes on the raw import +
// specText + client-side download approach.
