...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-5b27b10f><section class="ed-doc__hero" data-v-5b27b10f><div class="ed-doc__inner" data-v-5b27b10f><div class="ed-doc__eyebrow" data-v-5b27b10f><span class="ed-doc__eyebrow-dash" data-v-5b27b10f></span> LFI · CAAP · User Experience </div><h1 class="ed-doc__title" data-v-5b27b10f> User Experience <span class="ed-doc__read" data-v-5b27b10f>5 min read</span></h1><p class="ed-doc__lede" data-v-5b27b10f> When an LFI adopts CAAP, the end user&#39;s authentication and consent authorisation experience is delivered by CAAP — not by an LFI-operated application. This page describes what the end user sees, where the LFI is still on the path, and what is and is not the LFI&#39;s responsibility across the journey. </p></div></section>`);
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The journey starts in the TPP application. After the TPP requests a consent via <code data-v-5b27b10f${_scopeId2}>POST /par</code> against the API Hub, the TPP redirects the end user to the API Hub authorization endpoint with the returned <code data-v-5b27b10f${_scopeId2}>request_uri</code>. From there, the API Hub redirects the end user into CAAP for authentication and consent approval. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-5b27b10f${_scopeId2}> The authorization page shown is the <strong data-v-5b27b10f${_scopeId2}>Bank Data Sharing</strong> variant. CAAP renders a different authorization page for each consent type — the same surrounding journey (authenticate, register, review, confirm), with a layout suited to what the end user is consenting to. For comparison, see the equivalent journeys for <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/user-journeys" data-v-5b27b10f${_scopeId2}>Bank Service Initiation</a> and <a href="/tech/lfi-api-hub/v2.1/insurance/data-sharing/user-journeys" data-v-5b27b10f${_scopeId2}>Insurance Data Sharing</a>. </p>`);
            } else {
              return [
                createVNode("p", null, [
                  ...
                  createVNode("a", { href: "/tech/lfi-api-hub/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/user-journeys" }, "Bank Service Initiation"),
                  createTextVNode(" and "),
                  createVNode("a", { href: "/tech/lfi-api-hub/v2.1/insurance/data-sharing/user-journeys" }, "Insurance Data Sharing"),
                  createTextVNode(". ")
                ])
              ];
            }
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-5b27b10f${_scopeId2}><strong data-v-5b27b10f${_scopeId2}>Identify.</strong> The end user provides identifying details (e.g. Emirates ID or other LFI-recognised identifiers).</li><li data-v-5b27b10f${_scopeId2}><strong data-v-5b27b10f${_scopeId2}>Challenge.</strong> CAAP issues a challenge against the LFI — calling the LFI&#39;s <code data-v-5b27b10f${_scopeId2}>/users/actions/challenge/initialize</code> and <code data-v-5b27b10f${_scopeId2}>/users/actions/challenge/complete</code> CAAP Operations endpoints — so the LFI&#39;s authentication system verifies the end user.</li><li data-v-5b27b10f${_scopeId2}><strong data-v-5b27b10f${_scopeId2}>Review consent.</strong> CAAP displays the requested consent (permissions, expiry, accounts, payment details where applicable). For consents carrying encrypted PII, CAAP calls the LFI&#39;s <code data-v-5b27b10f${_scopeId2}>/users/actions/pii/decrypt</code> endpoint to display cleartext to the end user.</li><li data-v-5b27b10f${_scopeId2}><strong data-v-5b27b10f${_scopeId2}>Select accounts or policies.</strong> Where the consent requires selecting accounts or insurance policies, CAAP retrieves them via the LFI&#39;s CAAP-specific <code data-v-5b27b10f${_scopeId2}>/accounts</code>, <code data-v-5b27b10f${_scopeId2}>/accounts/{accountId}</code>, and <code data-v-5b27b10f${_scopeId2}>/{type}-insurance-policies</code> endpoints.</li><li data-v-5b27b10f${_scopeId2}><strong data-v-5b27b10f${_scopeId2}>Validate.</strong> Before completion, CAAP calls the LFI&#39;s <code data-v-5b27b10f${_scopeId2}>/consent/actions/validate</code> endpoint. If validation fails, the journey ends with the user-facing message returned by the LFI.</li><li data-v-5b27b10f${_scopeId2}><strong data-v-5b27b10f${_scopeId2}>Confirm.</strong> The end user confirms the consent; CAAP completes the interaction with the API Hub, and the API Hub redirects the end user back to the TPP.</li>`);
            } else {
              return [
                createVNode("li", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              return [
                ...
                createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-events" }, "Ozone Connect Consent Events"),
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-5b27b10f${_scopeId2}> The LFI&#39;s own <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/" data-v-5b27b10f${_scopeId2}>Consent Management Interface</a> requirements and UX guidance are <strong data-v-5b27b10f${_scopeId2}>not applicable</strong> when the LFI adopts CAAP — CAAP delivers that interface. </p>`);
            } else {
              return [
                createVNode("p", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/caap/user-experience.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userExperience = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-5b27b10f"]]);
export {
