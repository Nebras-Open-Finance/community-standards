  ...
  <div class="ed-doc">
    ...
    >
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-journey/api-guide#step-2-optional-validate-the-consent">Consent
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/requirements#consent-validation">Bank Data Sharing Requirements &mdash; Consent
        Validation</a>.
      </EdProse>
    ...
    >
      ...
      <EdRefTable>
        <table>
          ...
          <tbody>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/open-api/auth" class="endpoint"><span class="http-method http-method--get">GET</span><code>/auth</code></a></td>
              <td>LFI &rarr; API Hub</td>
              <td>Initiate the authorization interaction</td>
            </tr>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/consents-consentId" class="endpoint"><span class="http-method http-method--get">GET</span><code>/consents/{consentId}</code></a></td>
              <td>LFI &rarr; API Hub</td>
              <td>Retrieve the full consent details</td>
            </tr>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/patch-consents-consentId" class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/consents/{consentId}</code></a></td>
              <td>LFI &rarr; API Hub</td>
              <td>Update consent status, customer identifiers, and account IDs</td>
            </tr>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm" class="endpoint"><span class="http-method http-method--post">POST</span><code>/auth/{interactionId}/doConfirm</code></a></td>
              <td>LFI &rarr; API Hub</td>
              <td>Complete the interaction and redirect back to the TPP successfully</td>
            </tr>
            <tr>
              <td><a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/open-api/auth-interactionId-doFail" class="endpoint"><span class="http-method http-method--post">POST</span><code>/auth/{interactionId}/doFail</code></a></td>
              <td>LFI &rarr; API Hub</td>
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/requirements">Bank Data Sharing Requirements</a> call out fields that are always
      ...
      <EdProse>
        ...
        trusted to be valid. See <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/requirements">Bank Data Sharing Requirements</a> for what
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/requirements#account-status-handling">Account Status Handling</a> mapping:
      </EdProse>
      <EdRefTable>
        <table>
          <thead>
      ...
      <EdProse>See <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/api-guide/pagination">Pagination</a> for the full behaviour.</EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/requirements#get-accounts">GET /accounts rules</a> for field-level requirements.
      </EdProse>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts">GET <code>/accounts</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId">GET <code>/accounts/{accountId}</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-balances">GET <code>/accounts/{accountId}/balances</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        ...
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/api-guide/pagination">Pagination</a>.
      </EdProse>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-transactions">GET <code>/accounts/{accountId}/transactions</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-statements">GET <code>/accounts/{accountId}/statements</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-beneficiaries">GET <code>/accounts/{accountId}/beneficiaries</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-direct-debits">GET <code>/accounts/{accountId}/direct-debits</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-scheduled-payments">GET <code>/accounts/{accountId}/scheduled-payments</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-standing-orders">GET <code>/accounts/{accountId}/standing-orders</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        ...
        JSON or as a JWE compact string &mdash; see <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/api-guide/finance-rates">Encrypted FinanceRates</a>.
      </EdProse>
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-products">GET <code>/accounts/{accountId}/products</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/accounts-AccountId-customer">GET <code>/accounts/{accountId}/customer</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
    ...
    >
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/open-api/customer">GET <code>/customer</code> API Reference</a>
        for the full schema.
      </EdProse>
    </EdSectionBand>
