...
<template>
  <div class="ed-doc">
    ...
    >
      ...
      <EdBullets>
        <li>
          ...
          <a href="/tech/tpp-standards/v2.1/consent/api-guide">Payment Consent API Guide</a>.
        </li>
        <li>
    ...
    >
      ...
      <EdProse>
        See
        <a href="/tech/tpp-standards/v2.1/banking/service-initiation/personal-identifiable-information/creditor">Creditor
