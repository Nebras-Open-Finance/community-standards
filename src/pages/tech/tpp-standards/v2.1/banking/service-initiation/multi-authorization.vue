    ...
    >
      <EdBullets>
        ...
        <li>
          ...
          <a href="/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/api-guide">Service Initiation API Guide</a>.
          Multi-authorization applies after the first authorizer has completed their step.
        </li>
        <li>
          <strong>Understanding of the <a href="/tech/tpp-standards/v2.1/consent/">Consent Lifecycle</a></strong>
