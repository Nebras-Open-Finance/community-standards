...
import { delegatedScaArea as area } from '@/data/functional-certification/delegated-sca'

const explainerPath =
  '/tech/lfi-api-hub/production/testing-certification/functional/delegated-sca'
</script>
...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          Functional Certification &middot; Delegated SCA
        </div>
    ...
    <div class="ed-doc__body">
      <div class="ed-doc__inner">
        <FcDelegatedScaPortal :area="area" />
      </div>
    </div>
  </div>
</template>
