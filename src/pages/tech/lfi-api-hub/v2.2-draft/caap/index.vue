...
const cards: OverviewCard[] = [
  {
    href: '/tech/lfi-api-hub/v2.2-draft/caap/user-experience',
    cat: 'User Experience',
    color: 'var(--at-gold)',
  ...
  {
    href: '/tech/lfi-api-hub/v2.2-draft/caap/api-guide',
    cat: 'API Guide',
    color: 'var(--at-teal)',
    title: 'API Guide',
  ...
  {
    href: '/tech/lfi-api-hub/v2.2-draft/caap/pricing',
    cat: 'Pricing',
    color: 'var(--at-navy)',
    title: 'Pricing',
  ...
  <div class="ed-doc">
    ...
    >
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>LFI &mdash; see <a href="/tech/lfi-api-hub/v2.2-draft/consent-journey/authentication">Consent Journey &rarr; Authentication</a> and <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/onboarding/environment-specific/auth-endpoint">Authorization Endpoint</a>.</td>
              <td>CAAP</td>
            </tr>
            <tr>
              <td><strong>Consent Management Interface</strong></td>
              <td>LFI &mdash; see <a href="/tech/lfi-api-hub/v2.2-draft/consent-management-interface/">Consent Management Interface</a>.</td>
              <td>CAAP</td>
            </tr>
            <tr>
              <td><strong>Headless Heimdall and Consent Manager integration</strong></td>
              <td>LFI &mdash; see <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/headless-heimdall/">Headless Heimdall</a> and <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/">Consent Manager</a>.</td>
              <td>CAAP</td>
            </tr>
          </tbody>
        </table>
      ...
      <EdNote type="info" title="Still in scope for the LFI">
        <p>
          The LFI MUST still implement its Ozone Connect endpoints for <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/">Bank Data Sharing</a>,
          <a href="/tech/lfi-api-hub/v2.2-draft/banking/service-initiation/">Bank Service Initiation</a>,
          <a href="/tech/lfi-api-hub/v2.2-draft/insurance/">Insurance Data Sharing</a>, and the other
