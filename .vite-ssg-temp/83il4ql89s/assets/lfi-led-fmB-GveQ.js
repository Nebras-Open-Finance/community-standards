...
import { _ as _sfc_main$1 } from "./APIFlowsInsuranceQuotationLFILed-sSe71Zmy.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-41cd8347><section class="ed-doc__hero" data-v-41cd8347><div class="ed-doc__inner" data-v-41cd8347><div class="ed-doc__eyebrow" data-v-41cd8347><span class="ed-doc__eyebrow-dash" data-v-41cd8347></span> TPP · Insurance · Quotation · LFI-Led </div><h1 class="ed-doc__title" data-v-41cd8347> LFI-Led Flow <span class="ed-doc__read" data-v-41cd8347>6 min read</span></h1><p class="ed-doc__lede" data-v-41cd8347> You collect quote inputs in your app and hand the customer to the LFI on accept. The LFI hosts customer verification, payment, and document delivery. Your role after acceptance is to observe status events — either via webhook subscription or polling — and surface progress to the customer. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Authenticate with the Client Credentials Grant using a signed client assertion. Request the <code data-v-41cd8347${_scopeId2}>insurance</code> scope. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The returned <code data-v-41cd8347${_scopeId2}>access_token</code> is valid for all Insurance Quotation calls until expiry. There is no per-customer token in this flow. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Send the quote request as an <code data-v-41cd8347${_scopeId2}>application/jwt</code> signed Request JWT. The body carries a <code data-v-41cd8347${_scopeId2}>QuoteReference</code> you generate (for your own tracking), a <code data-v-41cd8347${_scopeId2}>QuoteType</code> of <code data-v-41cd8347${_scopeId2}>New</code>, <code data-v-41cd8347${_scopeId2}>Renewal</code>, or <code data-v-41cd8347${_scopeId2}>Switch</code>, and sector-specific risk and policy holder data. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The LFI returns <code data-v-41cd8347${_scopeId2}>201</code> with one or more quotes, or <code data-v-41cd8347${_scopeId2}>204</code> if it declines to quote. Each entry includes a <code data-v-41cd8347${_scopeId2}>QuoteId</code> (LFI-minted) you use for subsequent calls. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-41cd8347${_scopeId2}><code data-v-41cd8347${_scopeId2}>QuoteId</code> is the LFI’s identifier — required for every subsequent call. <code data-v-41cd8347${_scopeId2}>QuoteReference</code> is your own tracking identifier, echoed back by the LFI so you can correlate quotes to your internal session. Persist both. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createVNode("code", null, "QuoteId"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customer picks a quote in your UI. PATCH the chosen <code data-v-41cd8347${_scopeId2}>QuoteId</code> with the accept data and a <code data-v-41cd8347${_scopeId2}>Subscription.Webhook</code> object if you want event notifications. Send as a signed <code data-v-41cd8347${_scopeId2}>application/jwt</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` In LFI-Led mode the LFI responds <code data-v-41cd8347${_scopeId2}>204 No Content</code>. The customer is now in the LFI’s hosted journey. Your app should surface a &quot;your application is being processed&quot; state and wait for the first event. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The mechanism for handing the customer off depends on the LFI — typically a hosted application URL returned at quote creation time or out-of-band. From this point until the <code data-v-41cd8347${_scopeId2}>PolicyIssued</code> event, the customer interacts with the LFI’s screens, not yours. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Your app receives <code data-v-41cd8347${_scopeId2}>ApplicationPending</code> (and any interim status updates the LFI emits) through the webhook. Surface them in the customer’s timeline so they can re-enter your app and see where their application has reached. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-41cd8347${_scopeId2}><code data-v-41cd8347${_scopeId2}>ApplicationPending</code> — LFI has registered the application.</li><li data-v-41cd8347${_scopeId2}>(optional intermediate events with <code data-v-41cd8347${_scopeId2}>BrokerInstructions</code>) — LFI surfacing status the customer needs to see.</li><li data-v-41cd8347${_scopeId2}><code data-v-41cd8347${_scopeId2}>PolicyIssued</code> — carries the <code data-v-41cd8347${_scopeId2}>InsurancePolicyId</code>.</li><li data-v-41cd8347${_scopeId2}><code data-v-41cd8347${_scopeId2}>Completed</code> — finalised premium, term, and commission. Terminal event.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      createVNode("code", null, "ApplicationPending"),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Verify each event’s signature and dedupe by <code data-v-41cd8347${_scopeId2}>QuoteId</code>. The <code data-v-41cd8347${_scopeId2}>PolicyIssued</code> event in LFI-Led mode carries only <code data-v-41cd8347${_scopeId2}>InsurancePolicyId</code> — the LFI has delivered the policy documents directly to the customer through its hosted journey. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` After the customer has progressed through the LFI’s hosted KYC and payment, your app calls POST to formally create the policy resource. In LFI-Led mode the body is minimal — just the <code data-v-41cd8347${_scopeId2}>QuoteId</code>. The LFI runs its issuance and responds <code data-v-41cd8347${_scopeId2}>201 Created</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The final <code data-v-41cd8347${_scopeId2}>InsurancePolicyId</code> arrives via the <code data-v-41cd8347${_scopeId2}>PolicyIssued</code> webhook event, not in this response body. Retries are safe: the LFI is required to return the same policy reference for the same <code data-v-41cd8347${_scopeId2}>QuoteId</code>. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` On the <code data-v-41cd8347${_scopeId2}>Completed</code> event, finalise the customer-facing timeline: policy is live, documents are with the customer (delivered by the LFI), and any commission owed is being processed via <code data-v-41cd8347${_scopeId2}>Commission.PaymentMethod</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Manage subscription lifecycle in your own systems — you can let the subscription lapse (it’s tied to the <code data-v-41cd8347${_scopeId2}>QuoteId</code>) or PATCH with <code data-v-41cd8347${_scopeId2}>IsActive: false</code> if you explicitly want to stop delivery (for example, before deprovisioning a webhook URL). `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/insurance/quotation/api-guide/lfi-led.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const lfiLed = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-41cd8347"]]);
export {
  lfiLed as default
};
