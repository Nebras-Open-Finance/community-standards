...
import { variableOnDemandArea as area } from '@/data/functional-certification/multi-payments'

const explainerPath =
  '/tech/lfi-api-hub/production/testing-certification/functional/variable-on-demand'
</script>
    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          Functional Certification &middot; Variable On-Demand
        </div>
