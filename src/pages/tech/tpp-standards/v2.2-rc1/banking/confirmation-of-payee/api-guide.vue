...
<template>
  <div class="ed-doc">
    ...
    >
      ...
      <EdProse>
        See <a href="/tech/tpp-standards/v2.2-rc1/banking/service-initiation/personal-identifiable-information/creditor">Creditor</a>
        for the full PII creditor schema and the creditor models (single, multiple, and open beneficiary).
      </EdProse>

      <EdProse>
        See <a href="/tech/tpp-standards/v2.2-rc1/banking/confirmation-of-payee/user-journeys">Confirmation of
