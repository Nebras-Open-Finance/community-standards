...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_EndpointPage, mergeProps({
    ...
    method: "GET",
    path: "/organisations/{OrganisationId}/authorisationservers/{AuthorisationServerId}/apiresources"
  }, _attrs), {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/trust-framework/api/api-resources.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiResources = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
