import { defineComponent, computed, ref, onMounted, reactive, resolveComponent, mergeProps, unref, withCtx, createTextVNode, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const tppGoLive = ref(/* @__PURE__ */ new Map());
    onMounted(async () => {
      try {
        const [lfiRes, apiRes, payRes, trustRes] = await Promise.all([
          ...
          fetch("/api/trust-framework.json").then((r) => r.json()).catch(() => [])
        ]);
    ...
    function processTppGoLive(data) {
    ...
    function tppGoLiveFields(name) {
      const g = tppGoLive.value.get(String(name).trim().toUpperCase()) || null;
      return {
        goLiveDate: (g == null ? void 0 : g.date) || null,
        goLiveScheduled: (g == null ? void 0 : g.scheduled) === true,
    ...
    const liveTppCount = computed(
      () => filteredTpps.value.filter((t) => t.isLive).length
    );
    const tppGroups = computed(() => {
      const live = filteredTpps.value.filter((t) => t.isLive).sort((a, b) => {
        var _a, _b;
        return (((_a = a.goLiveDate) == null ? void 0 : _a.getTime()) || 0) - (((_b = b.goLiveDate) == null ? void 0 : _b.getTime()) || 0);
      });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-le" }, _attrs))} data-v-c7d5a082><section class="ed-le-masthead" data-v-c7d5a082><div class="ed-le-masthead__inner" data-v-c7d5a082><div class="ed-le-masthead__meta" data-v-c7d5a082><div class="ed-le-masthead__label" data-v-c7d5a082><span class="ed-le-masthead__label-dash" data-v-c7d5a082></span> Section · In Production </div><div class="ed-le-masthead__updated" data-v-c7d5a082>${ssrInterpolate(unref(updatedLabel))}</div></div><h1 class="ed-le-masthead__title" data-v-c7d5a082> Open Finance<br data-v-c7d5a082> in production today. </h1><div class="ed-le-masthead__count" data-v-c7d5a082>${ssrInterpolate(unref(summaryCount))} <span class="ed-le-masthead__count-unit" data-v-c7d5a082>${ssrInterpolate(unref(summaryUnit))}</span></div></div><p class="ed-le-masthead__sub" data-v-c7d5a082>${ssrInterpolate(unref(summarySub))}</p></section><section class="ed-le-controls" data-v-c7d5a082><div class="ed-le-controls__inner" data-v-c7d5a082><div class="ed-le-mode" role="tablist" aria-label="View by participant type" data-v-c7d5a082><button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(mode) === "lfi-bank" ? "true" : "false")} class="${ssrRenderClass([{ "is-active": unref(mode) === "lfi-bank" }, "ed-le-mode__btn"])}" data-v-c7d5a082> LFI (Bank) <span class="ed-le-mode__count" data-v-c7d5a082>${ssrInterpolate(unref(bankServerCount))}</span></button><button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(mode) === "lfi-insurer" ? "true" : "false")} class="${ssrRenderClass([{ "is-active": unref(mode) === "lfi-insurer" }, "ed-le-mode__btn"])}" data-v-c7d5a082> LFI (Insurer) <span class="ed-le-mode__count" data-v-c7d5a082>${ssrInterpolate(unref(insurerServerCount))}</span></button><button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(mode) === "tpp" ? "true" : "false")} class="${ssrRenderClass([{ "is-active": unref(mode) === "tpp" }, "ed-le-mode__btn"])}" data-v-c7d5a082> TPPs <span class="ed-le-mode__count" data-v-c7d5a082>${ssrInterpolate(unref(liveTppCount))}</span></button></div><nav class="ed-le-filter"${ssrRenderAttr("aria-label", unref(mode) === "lfi-insurer" ? "Filter by insurance type" : "Filter by service")} data-v-c7d5a082><button type="button" class="${ssrRenderClass([{ "is-active": unref(family) === "all" }, "ed-le-filter__btn"])}" data-v-c7d5a082>${ssrInterpolate(unref(mode) === "lfi-insurer" ? "All types" : "All services")}</button><!--[-->`);
      ssrRenderList(unref(filterChips), (chip) => {
        _push(`<button type="button" class="${ssrRenderClass([{ "is-active": unref(family) === chip.key }, "ed-le-filter__btn"])}" data-v-c7d5a082>${ssrInterpolate(chip.label)}</button>`);
      });
      _push(`<!--]--></nav></div></section><section class="ed-le-body" data-v-c7d5a082><div class="ed-le-body__inner" data-v-c7d5a082>`);
      if (unref(loading)) {
        _push(`<div class="ed-le-loading" data-v-c7d5a082><div class="ed-le-spinner" data-v-c7d5a082></div> Loading live data… </div>`);
      } else if (unref(error)) {
        _push(`<div class="ed-le-empty" data-v-c7d5a082><span class="ed-le-empty-kicker" data-v-c7d5a082>Error</span><h3 data-v-c7d5a082>Could not load live data</h3><p data-v-c7d5a082>${ssrInterpolate(unref(error))}</p></div>`);
      } else if (unref(isLfi)) {
        _push(`<!--[-->`);
        if (unref(visibleServers).length === 0) {
          _push(`<div class="ed-le-empty" data-v-c7d5a082><span class="ed-le-empty-kicker" data-v-c7d5a082>No match</span>`);
          if (unref(mode) === "lfi-insurer") {
            _push(`<h3 data-v-c7d5a082> No insurers offering ${ssrInterpolate(unref(family) === "all" ? "insurance" : filterLabel(unref(family)))} yet. </h3>`);
          } else {
            _push(`<h3 data-v-c7d5a082>No banks offering ${ssrInterpolate(unref(family) === "all" ? "this service" : filterLabel(unref(family)))} yet.</h3>`);
          }
          _push(`<button class="ed-le-clear" data-v-c7d5a082>${ssrInterpolate(unref(mode) === "lfi-insurer" ? "Show all types" : "Show all services")} → </button></div>`);
        } else {
          _push(`<!--[-->`);
          ssrRenderList(unref(serverGroups), (group) => {
            _push(`<section class="${ssrRenderClass([`ed-le-group--${group.key}`, "ed-le-group"])}" data-v-c7d5a082><header class="ed-le-group__head" data-v-c7d5a082><h2 class="ed-le-group__title" data-v-c7d5a082>`);
            if (group.key === "live") {
              _push(`<span class="ed-le-group__star" aria-hidden="true" data-v-c7d5a082>★</span>`);
            } else {
              _push(`<!---->`);
            }
            _push(` ${ssrInterpolate(group.title)} <span class="ed-le-group__count" data-v-c7d5a082>${ssrInterpolate(group.servers.length)}</span></h2><p class="ed-le-group__note" data-v-c7d5a082>${ssrInterpolate(group.note)}</p></header><div class="ed-le-grid" data-v-c7d5a082><!--[-->`);
            ssrRenderList(group.servers, (server) => {
              _push(`<article class="${ssrRenderClass([{ "ed-le-card--live": server.isLive }, "ed-le-card"])}" data-v-c7d5a082><header class="ed-le-card__head" data-v-c7d5a082><div class="ed-le-card__logo" data-v-c7d5a082><img${ssrRenderAttr("src", server.logo)}${ssrRenderAttr("alt", server.name)} loading="lazy" data-v-c7d5a082></div><div class="ed-le-card__title" data-v-c7d5a082><h3 data-v-c7d5a082>${ssrInterpolate(server.name)}</h3>`);
              if (server.goLiveDate) {
                _push(`<div class="${ssrRenderClass([{ "is-scheduled": server.goLiveScheduled }, "ed-le-card__golive"])}" data-v-c7d5a082><span class="ed-le-card__golive-star" aria-hidden="true" data-v-c7d5a082>★</span><span data-v-c7d5a082>${ssrInterpolate(server.goLiveScheduled ? "Go-live approved for" : "Live since")} ${ssrInterpolate(formatGoLive(server.goLiveDate))}</span></div>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<div class="ed-le-card__types" data-v-c7d5a082><!--[-->`);
              ssrRenderList(server.accountTypes, (t) => {
                _push(`<span class="ed-le-pill ed-le-pill--type" data-v-c7d5a082>${ssrInterpolate(t)}</span>`);
              });
              _push(`<!--]--></div></div></header><ul class="ed-le-card__services" data-v-c7d5a082><!--[-->`);
              ssrRenderList(visibleServices(server), (svc) => {
                _push(`<li class="${ssrRenderClass([{ "is-expanded": svc.expanded }, "ed-le-card__service"])}" data-v-c7d5a082><button type="button" class="ed-le-card__service-head"${ssrRenderAttr("aria-expanded", svc.expanded ? "true" : "false")} data-v-c7d5a082><span class="ed-le-card__service-name" data-v-c7d5a082>${ssrInterpolate(svc.label)}</span><span class="ed-le-card__service-versions" data-v-c7d5a082>${ssrInterpolate(svc.versions.map((v) => v.version).join(", "))}</span><span class="${ssrRenderClass([{ "is-open": svc.expanded }, "ed-le-chev ed-le-chev--small"])}" data-v-c7d5a082>›</span></button>`);
                if (svc.expanded) {
                  _push(`<div class="ed-le-card__service-detail" data-v-c7d5a082><!--[-->`);
                  ssrRenderList(svc.versions, (v) => {
                    _push(`<div class="ed-le-card__version" data-v-c7d5a082>`);
                    if (svc.familyKey !== "insurance") {
                      _push(`<!--[--><div class="ed-le-card__version-head" data-v-c7d5a082><span class="ed-le-card__version-label" data-v-c7d5a082>${ssrInterpolate(v.version)}</span><!--[-->`);
                      ssrRenderList(v.paymentTypes, (t) => {
                        _push(`<span class="ed-le-pill ed-le-pill--meta" data-v-c7d5a082>${ssrInterpolate(t)}</span>`);
                      });
                      _push(`<!--]--><!--[-->`);
                      ssrRenderList(v.accountSubTypes, (t) => {
                        _push(`<span class="ed-le-pill ed-le-pill--subtype" data-v-c7d5a082>${ssrInterpolate(t)}</span>`);
                      });
                      _push(`<!--]-->`);
                      if (svc.familyKey === "account-information") {
                        _push(`<span class="ed-le-pill ed-le-pill--meta" data-v-c7d5a082>Over-limit fee: AED ${ssrInterpolate(v.overLimitFees)}</span>`);
                      } else {
                        _push(`<!---->`);
                      }
                      _push(`</div>`);
                      if (v.endpoints.length) {
                        _push(`<button type="button" class="ed-le-card__endpoints-toggle"${ssrRenderAttr("aria-expanded", v.expanded ? "true" : "false")} data-v-c7d5a082><span class="${ssrRenderClass([{ "is-open": v.expanded }, "ed-le-chev ed-le-chev--small"])}" data-v-c7d5a082>›</span> ${ssrInterpolate(v.expanded ? "Hide" : "Show")} endpoints (${ssrInterpolate(v.endpoints.length)}) </button>`);
                      } else {
                        _push(`<!---->`);
                      }
                      if (v.expanded) {
                        _push(`<ul class="ed-le-card__endpoints" data-v-c7d5a082><!--[-->`);
                        ssrRenderList(v.endpoints, (ep) => {
                          _push(`<li data-v-c7d5a082><code data-v-c7d5a082>${ssrInterpolate(ep)}</code></li>`);
                        });
                        _push(`<!--]--></ul>`);
                      } else {
                        _push(`<!---->`);
                      ...
                      ssrRenderList(v.insuranceTypes, (t) => {
                        _push(`<span class="ed-le-pill ed-le-pill--subtype" data-v-c7d5a082>${ssrInterpolate(INSURANCE_TYPE_LABELS[t])}</span>`);
                      });
                      _push(`<!--]--></div><!--[-->`);
                      ssrRenderList(visibleInsuranceGroups(v), (g) => {
                        _push(`<div class="ed-le-card__ins-group" data-v-c7d5a082><button type="button" class="ed-le-card__endpoints-toggle"${ssrRenderAttr("aria-expanded", g.expanded ? "true" : "false")} data-v-c7d5a082><span class="${ssrRenderClass([{ "is-open": g.expanded }, "ed-le-chev ed-le-chev--small"])}" data-v-c7d5a082>›</span> ${ssrInterpolate(g.label)} (${ssrInterpolate(g.endpoints.length)}) </button>`);
                        if (g.expanded) {
                          _push(`<ul class="ed-le-card__endpoints" data-v-c7d5a082><!--[-->`);
        ...
        if (unref(filteredTpps).length === 0) {
          _push(`<div class="ed-le-empty" data-v-c7d5a082><span class="ed-le-empty-kicker" data-v-c7d5a082>No match</span><h3 data-v-c7d5a082>No TPPs consuming ${ssrInterpolate(unref(family) === "all" ? "this service" : filterLabel(unref(family)))} in the last ${ssrInterpolate(DAYS_WINDOW)} days.</h3><button class="ed-le-clear" data-v-c7d5a082>Show all services →</button></div>`);
        } else {
          _push(`<!--[-->`);
          ssrRenderList(unref(tppGroups), (group) => {
            _push(`<section class="${ssrRenderClass([`ed-le-group--${group.key}`, "ed-le-group"])}" data-v-c7d5a082><header class="ed-le-group__head" data-v-c7d5a082><h2 class="ed-le-group__title" data-v-c7d5a082>`);
            if (group.key === "live") {
              _push(`<span class="ed-le-group__star" aria-hidden="true" data-v-c7d5a082>★</span>`);
            } else {
            ...
            _push(` ${ssrInterpolate(group.title)} <span class="ed-le-group__count" data-v-c7d5a082>${ssrInterpolate(group.tpps.length)}</span></h2><p class="ed-le-group__note" data-v-c7d5a082>${ssrInterpolate(group.note)}</p></header><div class="ed-le-grid" data-v-c7d5a082><!--[-->`);
            ssrRenderList(group.tpps, (tpp) => {
              _push(`<article class="${ssrRenderClass([{ "ed-le-card--live": tpp.isLive }, "ed-le-card ed-le-card--tpp"])}" data-v-c7d5a082><header class="ed-le-card__head ed-le-card__head--tpp" data-v-c7d5a082><div class="ed-le-card__title" data-v-c7d5a082><div class="ed-le-card__kicker" data-v-c7d5a082>TPP</div><h3 data-v-c7d5a082>${ssrInterpolate(tpp.name)}</h3>`);
              if (tpp.goLiveDate) {
                _push(`<div class="${ssrRenderClass([{ "is-scheduled": tpp.goLiveScheduled }, "ed-le-card__golive"])}" data-v-c7d5a082><span class="ed-le-card__golive-star" aria-hidden="true" data-v-c7d5a082>★</span><span data-v-c7d5a082>${ssrInterpolate(tpp.goLiveScheduled ? "Go-live approved for" : "Live since")} ${ssrInterpolate(formatGoLive(tpp.goLiveDate))}</span></div>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</div><div class="ed-le-card__total" data-v-c7d5a082><div class="ed-le-card__total-num" data-v-c7d5a082>${ssrInterpolate(formatNumber(unref(paymentOnly) ? tpp.totalPayments : tpp.totalRequests))}</div><div class="ed-le-card__total-unit" data-v-c7d5a082>${ssrInterpolate(unref(paymentOnly) ? "payments" : "requests")}</div></div></header><div class="ed-le-card__lfis" data-v-c7d5a082><div class="ed-le-card__lfis-label" data-v-c7d5a082>Consumed at</div><div class="ed-le-card__lfis-pills" data-v-c7d5a082><!--[-->`);
              ssrRenderList(tpp.lfis, (lfi) => {
                _push(`<span class="ed-le-pill ed-le-pill--lfi" data-v-c7d5a082>${ssrInterpolate(lfi)}</span>`);
              });
              _push(`<!--]--></div></div>`);
              if (!unref(paymentOnly)) {
                _push(`<ul class="ed-le-card__services" data-v-c7d5a082><!--[-->`);
                ssrRenderList(tpp.services, (svc) => {
                  _push(`<li class="${ssrRenderClass([{ "is-expanded": isTppServiceExpanded(tpp.name, svc.familyKey) }, "ed-le-card__service"])}" data-v-c7d5a082><button type="button" class="ed-le-card__service-head"${ssrRenderAttr("aria-expanded", isTppServiceExpanded(tpp.name, svc.familyKey) ? "true" : "false")} data-v-c7d5a082><span class="ed-le-card__service-name" data-v-c7d5a082>${ssrInterpolate(svc.label)}</span><span class="ed-le-card__service-versions" data-v-c7d5a082>${ssrInterpolate(svc.versions.map((v) => v.version).join(", "))}</span><span class="${ssrRenderClass([{ "is-open": isTppServiceExpanded(tpp.name, svc.familyKey) }, "ed-le-chev ed-le-chev--small"])}" data-v-c7d5a082>›</span></button>`);
                  if (isTppServiceExpanded(tpp.name, svc.familyKey)) {
                    _push(`<div class="ed-le-card__service-detail" data-v-c7d5a082><!--[-->`);
                    ssrRenderList(svc.versions, (v) => {
                      _push(`<div class="ed-le-card__version" data-v-c7d5a082><div class="ed-le-card__version-head" data-v-c7d5a082><span class="ed-le-card__version-label" data-v-c7d5a082>${ssrInterpolate(v.version)}</span><span class="ed-le-pill ed-le-pill--meta" data-v-c7d5a082>${ssrInterpolate(formatNumber(v.requests))} requests </span></div>`);
                      if (v.endpoints.length) {
                        _push(`<ul class="ed-le-card__endpoints" data-v-c7d5a082><!--[-->`);
                        ssrRenderList(v.endpoints, (ep) => {
                          _push(`<li data-v-c7d5a082><code data-v-c7d5a082>${ssrInterpolate(ep.key)}</code><span class="ed-le-card__endpoint-count" data-v-c7d5a082>${ssrInterpolate(formatNumber(ep.count))}</span></li>`);
                        });
                        _push(`<!--]--></ul>`);
                      } else {
                        _push(`<!---->`);
                ...
                ssrRenderList(tpp.consentTypes, (ct) => {
                  _push(`<li class="ed-le-card__service ed-le-card__service--static" data-v-c7d5a082><span class="ed-le-card__service-name" data-v-c7d5a082>${ssrInterpolate(prettifyConsentType(ct.type))}</span><span class="ed-le-card__endpoint-count" data-v-c7d5a082>${ssrInterpolate(formatNumber(ct.count))}</span></li>`);
                });
                _push(`<!--]--></ul>`);
              }
              _push(`</article>`);
      ...
      _push(`<aside class="ed-le-source" data-v-c7d5a082><div class="ed-le-source__icon" aria-hidden="true" data-v-c7d5a082><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" data-v-c7d5a082><circle cx="12" cy="12" r="9" data-v-c7d5a082></circle><path d="M12 7v5l3 2" stroke-linecap="round" data-v-c7d5a082></path></svg></div>`);
      if (unref(isLfi)) {
        _push(`<div class="ed-le-source__text" data-v-c7d5a082><strong data-v-c7d5a082>How live status is determined.</strong> Every LFI listed here is deployed in the production environment — services and certifications come from the Nebras Open Finance production directory. An LFI is marked live once its authorisation server holds a certified <em data-v-c7d5a082>Commercial Go-Live Approval</em>; the approval start date is the go-live date shown on the card. Everything else is in production testing. All listed institutions are CBUAE-licensed. </div>`);
      } else {
        _push(`<div class="ed-le-source__text" data-v-c7d5a082><strong data-v-c7d5a082>How live status is determined.</strong> Every TPP listed here is calling the APIs in the production environment. A TPP is marked live once it has been signed off for go-live and the trust framework records its go-live date — the same field the `);
        _push(ssrRenderComponent(_component_router_link, { to: "/doc-repository/" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`document repository`);
            } else {
              return [
                createTextVNode("document repository")
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(` uses; that date is shown on the card. Everything else is in production testing. Activity is aggregated from production API Hub access logs over a rolling ${ssrInterpolate(DAYS_WINDOW)}-day window. All listed TPPs are CBUAE-licensed. </div>`);
      }
      _push(`</aside></div></section></div>`);
    };
  }
});
...
const whatsLive = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c7d5a082"]]);
export {
