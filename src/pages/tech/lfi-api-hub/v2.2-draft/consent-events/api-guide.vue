  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdProse>
        ...
        page (e.g.
        <a href="/tech/lfi-api-hub/v2.2-draft/banking/data-sharing/requirements">Bank Data Sharing &mdash; Requirements</a>).
      ...
      <EdProse>
        See the
        <a href="/tech/lfi-api-hub/v2.2-draft/consent-events/open-api/validate"><span class="endpoint"><span class="http-method http-method--post">POST</span><code>/consent/action/validate</code></span> API Reference</a>
      ...
      <EdNote type="info" title="No retry, no rollback">
        ...
        <ul>
          ...
          <li>
            ...
            <a href="/tech/lfi-api-hub/v2.2-draft/api-hub/consent-manager/open-api/psu-userId-consents" class="endpoint"><span class="http-method http-method--get">GET</span><code>/psu/{userId}/consents</code></a>
    ...
    >
      <EdBullets>
        <li><a href="/tech/lfi-api-hub/v2.2-draft/consent-events/open-api/validate" class="endpoint"><span class="http-method http-method--post">POST</span><code>/consent/action/validate</code></a> &mdash; Full request and response schema</li>
        <li><a href="/tech/lfi-api-hub/v2.2-draft/consent-events/open-api/event-op" class="endpoint"><span class="http-method http-method--post">POST</span><code>/consent/event/{operation}</code></a> &mdash; Full request and response schema</li>
      </EdBullets>
    </EdSectionBand>
  </div>
</template>
