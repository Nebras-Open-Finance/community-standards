...
const explainerPath =
  '/tech/tpp-standards/production/testing-certification/functional/insurance-data-sharing'
</script>
...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          ...
          <strong>{{ insuranceDataSharingTppArea.certType }}</strong> Service Desk ticket. New here?
    ...
    <div class="ed-doc__body">
      <div class="ed-doc__inner">
        <FcTppPortal :area="insuranceDataSharingTppArea" />
      </div>
    </div>
  </div>
</template>
