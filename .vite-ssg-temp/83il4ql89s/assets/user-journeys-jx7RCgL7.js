...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-dc316d1e><section class="ed-doc__hero" data-v-dc316d1e><div class="ed-doc__inner" data-v-dc316d1e><div class="ed-doc__eyebrow" data-v-dc316d1e><span class="ed-doc__eyebrow-dash" data-v-dc316d1e></span> Banking · Service Initiation · Fixed Periodic Schedule · UX </div><h1 class="ed-doc__title" data-v-dc316d1e> Fixed Periodic Schedule — User Experience <span class="ed-doc__read" data-v-dc316d1e>4 min read</span></h1><p class="ed-doc__lede" data-v-dc316d1e> Before a customer authorises a Fixed Periodic Schedule payment consent through Open Finance, you must present a <strong data-v-dc316d1e>Consent Page</strong> that clearly explains that you are seeking permission to make recurring payments of a fixed amount at a set frequency. This page must accurately reflect the key details of the consent (payee, amount per payment, payment frequency, etc.) The examples and interactive wireframes below define the expected structure, content, and behaviour of the Consent Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-dc316d1e> While you may adapt visual elements such as colour palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the payment information shown, and the representation of <strong data-v-dc316d1e>AlTareq</strong> (including logos, naming, and action buttons) must be preserved. The customer must always be able to clearly understand what payment they are consenting to and that it is part of the AlTareq ecosystem. Your Consent Page must be submitted as part of <strong data-v-dc316d1e>CX certification</strong> prior to production, and any material changes to a production Consent Page must be re-submitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the request body fields below and watch the <strong data-v-dc316d1e${_scopeId2}>Consent</strong> and <strong data-v-dc316d1e${_scopeId2}>Authorisation</strong> page previews update live. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/multi-payments/fixed-periodic-schedule/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dc316d1e"]]);
export {
