...
export const data: RequirementsPageData = {
  ...
  preconditions: 'The tables below list the rules that apply to Confirmation of Payee. The Hub receives and validates the TPP\'s request, then calls your Ozone Connect <a href="/tech/lfi-api-hub/v2.2-draft/banking/confirmation-of-payee/open-api/cop-query"><code>POST /customers/action/cop-query</code></a> endpoint with the IBAN alone. You are responsible for returning the name(s) you hold against that account, accurately — the Hub performs the name matching.',
  sections: [
    {
      id: 'create-cop-query',
      num: '01',
