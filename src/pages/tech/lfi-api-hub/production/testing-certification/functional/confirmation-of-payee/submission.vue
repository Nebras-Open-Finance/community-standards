...
const explainerPath =
  '/tech/lfi-api-hub/production/testing-certification/functional/confirmation-of-payee'
</script>
...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          ...
          <strong>{{ confirmationOfPayeeArea.certType }}</strong> Service Desk ticket. New here?
    ...
    <div class="ed-doc__body">
      <div class="ed-doc__inner">
        <FcCopPortal :area="confirmationOfPayeeArea" />
      </div>
    </div>
  </div>
</template>
