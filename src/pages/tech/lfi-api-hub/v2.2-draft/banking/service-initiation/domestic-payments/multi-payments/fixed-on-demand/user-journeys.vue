...
import WireframePreview from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/fixed-on-demand/_shared/WireframePreview.vue'
import AccountSetup from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/fixed-on-demand/_shared/AccountSetup.vue'
import UIBehaviour from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/fixed-on-demand/_shared/UIBehaviour.vue'
import ExampleJourneys from '../../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/multi-payments/fixed-on-demand/_shared/ExampleJourneys.vue'
...
const myCustomValidator = (value) => {
  ...
  if (
    ...
    value?.Data?.ControlParameters?.ConsentSchedule?.MultiPayment?.PeriodicSchedule?.Type !== 'FixedOnDemand' ||
    ...
    if (
        !value?.Data?.ControlParameters?.ConsentSchedule?.MultiPayment?.PeriodicSchedule?.Controls?.MaximumCumulativeNumberOfPaymentsPerPeriod &&
        !value?.Data?.ControlParameters?.ConsentSchedule?.MultiPayment?.PeriodicSchedule?.Controls?.MaximumCumulativeValueOfPaymentsPerPeriod?.Amount
        )
        {
    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          Banking · Service Initiation · Fixed On Demand · UX
        </div>
        <h1 class="ed-doc__title">
          Fixed On Demand &mdash; User Experience
          <span class="ed-doc__read">4 min read</span>
        </h1>
        <p class="ed-doc__lede">
          When a customer is redirected to you to authorize a Fixed On Demand payment consent through Open
          Finance, you must present an <strong>Authorization Page</strong> that clearly explains the payment
          the customer is authorizing &mdash; that multiple payments of a fixed amount will be made at any
          time of the TPP's choosing. The page must collect the customer's explicit and informed consent, and
          it must accurately reflect the key details of the consent (payee, the fixed amount per payment, the
