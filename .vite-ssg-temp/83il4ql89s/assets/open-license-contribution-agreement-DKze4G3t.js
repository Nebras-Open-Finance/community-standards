...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-6f85da35>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6f85da35${_scopeId2}>Accesses or implements the UAE Open Finance Standards</li><li data-v-6f85da35${_scopeId2}>Contributes to the development of the Standards</li><li data-v-6f85da35${_scopeId2}>Participates in consultations, working groups, or technical discussions</li>`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-6f85da35${_scopeId}>It establishes</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6f85da35${_scopeId2}>The open copyright license granted by the Central Bank of the United Arab Emirates (CBUAE)</li><li data-v-6f85da35${_scopeId2}>The rights and obligations of Contributors</li><li data-v-6f85da35${_scopeId2}>The intellectual property framework governing Contributions</li><li data-v-6f85da35${_scopeId2}>Confidentiality and governing law provisions</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdCallout, { color: "var(--at-gold)" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-6f85da35${_scopeId2}><strong data-v-6f85da35${_scopeId2}>Agreement to these terms is mandatory before submitting any Contribution.</strong></p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6f85da35${_scopeId2}>The UAE Open Finance Standards, specifications, documentation, and related materials (the &quot;Standards&quot;)</li><li data-v-6f85da35${_scopeId2}>All Contributions submitted now or in the future</li><li data-v-6f85da35${_scopeId2}>All draft and final versions of the Standards</li><li data-v-6f85da35${_scopeId2}>Participation in working groups, consultations, and development activities</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdCallout, { color: "var(--at-blue)" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-6f85da35${_scopeId2}><strong data-v-6f85da35${_scopeId2}>Copyright © 2024 — Central Bank of the United Arab Emirates</strong></p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6f85da35${_scopeId2}>Reproduce</li><li data-v-6f85da35${_scopeId2}>Prepare derivative works</li><li data-v-6f85da35${_scopeId2}>Distribute</li><li data-v-6f85da35${_scopeId2}>Perform</li><li data-v-6f85da35${_scopeId2}>Display</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Attribution must be made to CBUAE as the source of the material. Such attribution must <strong data-v-6f85da35${_scopeId2}>not imply endorsement</strong> by CBUAE.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6f85da35${_scopeId2}>Merchantability</li><li data-v-6f85da35${_scopeId2}>Fitness for a particular purpose</li><li data-v-6f85da35${_scopeId2}>Non-infringement</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6f85da35${_scopeId2}>Use of the Standards</li><li data-v-6f85da35${_scopeId2}>Implementation of the Standards</li><li data-v-6f85da35${_scopeId2}>Contributions made by any party</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`The Standards, amendments, and Contributions are considered a &quot;Collective Work&quot; under <strong data-v-6f85da35${_scopeId2}>UAE Federal Decree-Law No. 38/2021</strong>, which governs copyright protection for innovative literary, artistic, and scientific creations in the United Arab Emirates.`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-6f85da35${_scopeId}>General principles</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<h3 data-v-6f85da35${_scopeId}>Contributor representations and warranties</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-6f85da35${_scopeId3}><li data-v-6f85da35${_scopeId3}>Contributions are made by employees within the scope of employment, or</li><li data-v-6f85da35${_scopeId3}>Independent contractors under written IP assignment obligations</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdCompareCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul data-v-6f85da35${_scopeId3}><li data-v-6f85da35${_scopeId3}>The employer has authorized the Contribution, waived relevant rights, or</li><li data-v-6f85da35${_scopeId3}>Has entered into a separate agreement with CBUAE</li></ul>`);
                      } else {
                        return [
                          createVNode("ul", null, [
            ...
            _push2(`<h3 data-v-6f85da35${_scopeId}>2. No conflicting obligations</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-6f85da35${_scopeId2}>Participating in working groups</li><li data-v-6f85da35${_scopeId2}>Making Contributions</li><li data-v-6f85da35${_scopeId2}>Granting rights in intellectual property</li>`);
                } else {
                  return [
...
const openLicenseContributionAgreement = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6f85da35"]]);
export {
