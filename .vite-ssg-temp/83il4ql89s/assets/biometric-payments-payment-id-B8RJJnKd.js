...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "biometric-payments-payment-id",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_EndpointPage, mergeProps({
        ...
        title: "Retrieve a payment by PaymentId",
        version: "Draft · 0.1",
        method: "GET",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_RedocWrapper, {
              ...
              "filter-path": "/biometric-payments/{PaymentId}",
              "filter-method": "get",
              "display-path": "/biometric-payments/{PaymentId}",
              "override-servers": servers,
              "container-id": "redoc-biopay-payment-by-id"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/biopay/payment/api-reference/biometric-payments-payment-id.vue");
