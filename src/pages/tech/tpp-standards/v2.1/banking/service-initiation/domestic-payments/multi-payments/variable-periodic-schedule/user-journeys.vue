    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          Before a customer authorises a Variable Periodic Schedule payment consent through Open Finance, you
          must present a <strong>Consent Page</strong> that clearly explains that you are seeking permission
          to make recurring payments of varying amounts at a set frequency. This page must accurately reflect
          the key details of the consent (payee, the maximum amount per payment, payment frequency, etc.) The
          examples and interactive wireframes below define the expected structure, content, and behaviour of
          the Consent Page and must be followed.
        </p>
