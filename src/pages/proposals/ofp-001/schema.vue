...
// Renders the co-located OFP-001 bulk/batch draft schema with the shared Redoc
// wrapper and EndpointPage chrome — the same presentation as the published API
// specs and the OFP-002 schema pages. The YAML lives in this folder, is imported
// raw, handed to RedocWrapper via `specText`, and offered as a Download .yaml.
