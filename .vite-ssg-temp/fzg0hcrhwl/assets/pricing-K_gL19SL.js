...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-007dd917><section class="ed-doc__hero" data-v-007dd917><div class="ed-doc__inner" data-v-007dd917><div class="ed-doc__eyebrow" data-v-007dd917><span class="ed-doc__eyebrow-dash" data-v-007dd917></span> LFI · CAAP · Pricing </div><h1 class="ed-doc__title" data-v-007dd917> Pricing <span class="ed-doc__read" data-v-007dd917>2 min read</span></h1><p class="ed-doc__lede" data-v-007dd917> CAAP is a Nebras-operated service offered to LFIs as an alternative to building their own authentication, consent authorisation, and consent management interface. This page describes how CAAP is charged and what is included. </p></div></section>`);
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-007dd917${_scopeId2}> CAAP commercial terms are being finalised between Nebras and the participating LFIs. This page is a placeholder; the published pricing will appear here once agreed. In the meantime, LFIs evaluating CAAP should contact Nebras via the Service Desk for an indicative quote. </p>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-007dd917${_scopeId2}>The end user-facing authentication and consent authorisation experience — web and (where applicable) mobile.</li><li data-v-007dd917${_scopeId2}>The end user-facing consent management interface, including consent review and revocation.</li><li data-v-007dd917${_scopeId2}>Integration with the API Hub&#39;s <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/" data-v-007dd917${_scopeId2}>Headless Heimdall</a> and <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/" data-v-007dd917${_scopeId2}>Consent Manager</a> — the LFI does not call these directly.</li><li data-v-007dd917${_scopeId2}>Language and accessibility support for the CAAP screens.</li><li data-v-007dd917${_scopeId2}>Operational support, monitoring, and incident management for the CAAP service.</li>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-007dd917${_scopeId2}>The Ozone Connect endpoints for <a href="/tech/lfi-api-hub/v2.2-rc1/banking/data-sharing/" data-v-007dd917${_scopeId2}>Bank Data Sharing</a>, <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/" data-v-007dd917${_scopeId2}>Bank Service Initiation</a>, <a href="/tech/lfi-api-hub/v2.2-rc1/insurance/" data-v-007dd917${_scopeId2}>Insurance Data Sharing</a>, Products &amp; Leads, Confirmation of Payee, and ATMs.</li><li data-v-007dd917${_scopeId2}>The LFI&#39;s <a href="/tech/lfi-api-hub/v2.2-rc1/consent-events" data-v-007dd917${_scopeId2}>Consent Events</a> handlers for receiving consent lifecycle notifications from the API Hub.</li><li data-v-007dd917${_scopeId2}>The new <strong data-v-007dd917${_scopeId2}>CAAP Operations</strong> endpoints documented in this section — user verification, registration, PII decryption, consent validation, and the CAAP-specific accounts and insurance policy GETs.</li><li data-v-007dd917${_scopeId2}>Underlying LFI infrastructure: authentication systems, customer records, account systems, payment rails, fraud and risk checks.</li>`);
            } else {
              return [
                createVNode("li", null, [
                ...
                createVNode("li", null, [
                  ...
                  createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/consent-events" }, "Consent Events"),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` LFIs declare whether they intend to adopt CAAP when completing the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/prerequisites" data-v-007dd917${_scopeId2}>Prerequisites Questionnaire</a>. Reach out via the Service Desk to discuss commercials and the implementation plan for the CAAP Operations APIs. `);
            } else {
              return [
                createTextVNode(" LFIs declare whether they intend to adopt CAAP when completing the "),
                createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/prerequisites" }, "Prerequisites Questionnaire"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/caap/pricing.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const pricing = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-007dd917"]]);
export {
  pricing as default
};
