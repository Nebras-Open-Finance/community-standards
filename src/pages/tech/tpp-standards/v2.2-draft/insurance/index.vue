...
const capabilities: Capability[] = [
  {
    href: '/tech/tpp-standards/v2.2-draft/insurance/data-sharing/',
  ...
  {
    href: '/tech/tpp-standards/v2.2-draft/insurance/quotation/',
    ...
    <section class="ed-landing__hero">
      <div class="ed-landing__inner">
        <div class="ed-landing__eyebrow">
          ...
          TPP Standards &middot; v2.2-draft &middot; Insurance
        </div>
        ...
        <p class="ed-landing__lede">
          The Open Finance Insurance capabilities enable secure, consent-driven access to a customer&rsquo;s
          insurance policy data across the UAE&rsquo;s major insurance sectors. These services empower licensed
          third-party providers (TPPs) to deliver policy aggregation, switching, advisory, and value-added
          digital insurance services.
        </p>
        <p class="ed-landing__lede ed-landing__lede--tight">
          All services are provided with strict consent management, granular permission scopes, and full
          auditability.
        </p>
      </div>
    </section>
    ...
    <section class="ed-landing__live">
      <div class="ed-landing__inner">
        <div class="ed-landing__live-head">
          ...
          <h2 class="ed-landing__live-title">Which LFIs are live for Insurance</h2>
      ...
      <div class="ed-landing__inner">
        <div class="ed-landing__contents-head">
          ...
          <p class="ed-landing__contents-sub">
            The full set of capability areas covered by the TPP Insurance standards.
          </p>
        </div>
