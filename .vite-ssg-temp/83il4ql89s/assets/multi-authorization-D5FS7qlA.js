...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-fb5ed2f6><section class="ed-doc__hero" data-v-fb5ed2f6><div class="ed-doc__inner" data-v-fb5ed2f6><div class="ed-doc__eyebrow" data-v-fb5ed2f6><span class="ed-doc__eyebrow-dash" data-v-fb5ed2f6></span> Service Initiation · Multi-Authorization </div><h1 class="ed-doc__title" data-v-fb5ed2f6> Multi-Authorization <span class="ed-doc__read" data-v-fb5ed2f6>2 min read</span></h1><p class="ed-doc__lede" data-v-fb5ed2f6> The Open Finance standards support payment journeys that require more than one authorizer. This guide explains how TPPs and LFIs must coordinate multi-authorization for payment consents and how the consent lifecycle is reflected in API calls and responses. </p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fb5ed2f6${_scopeId2}><strong data-v-fb5ed2f6${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-fb5ed2f6${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the <strong data-v-fb5ed2f6${_scopeId2}>BSIP role</strong> as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-fb5ed2f6${_scopeId2}>Roles</a>. </li><li data-v-fb5ed2f6${_scopeId2}><strong data-v-fb5ed2f6${_scopeId2}>An active payment consent</strong> — a payment consent must have been created through the relevant <a href="/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/api-guide" data-v-fb5ed2f6${_scopeId2}>Service Initiation API Guide</a>. Multi-authorization applies after the first authorizer has completed their step. </li><li data-v-fb5ed2f6${_scopeId2}><strong data-v-fb5ed2f6${_scopeId2}>Understanding of the <a href="/tech/tpp-standards/v2.1/consent/" data-v-fb5ed2f6${_scopeId2}>Consent Lifecycle</a></strong> — you should understand consent status transitions, including <code data-v-fb5ed2f6${_scopeId2}>AwaitingAuthorization</code>, <code data-v-fb5ed2f6${_scopeId2}>Authorized</code>, and <code data-v-fb5ed2f6${_scopeId2}>Rejected</code>. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
                    ...
                    createVNode("li", null, [
                      ...
                      createVNode("a", { href: "/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/single-instant-payment/api-guide" }, "Service Initiation API Guide"),
                    ...
                    createVNode("li", null, [
                      createVNode("strong", null, [
                        ...
                        createVNode("a", { href: "/tech/tpp-standards/v2.1/consent/" }, "Consent Lifecycle")
                      ]),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When submitting the Pushed Authorization Request (PAR), the TPP MUST set <code data-v-fb5ed2f6${_scopeId2}>IsSingleAuthorization</code> inside <code data-v-fb5ed2f6${_scopeId2}>authorization_details[].consent</code>: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fb5ed2f6${_scopeId2}><code data-v-fb5ed2f6${_scopeId2}>true</code> — only a single authorizer is supported for the payment.</li><li data-v-fb5ed2f6${_scopeId2}><code data-v-fb5ed2f6${_scopeId2}>false</code> — multiple authorizers are supported (multi-authorization enabled).</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When <code data-v-fb5ed2f6${_scopeId2}>IsSingleAuthorization</code> is <code data-v-fb5ed2f6${_scopeId2}>false</code>, the TPP SHOULD also set <code data-v-fb5ed2f6${_scopeId2}>AuthorizationExpirationDateTime</code> inside <code data-v-fb5ed2f6${_scopeId2}>authorization_details[].consent</code>. This field represents the deadline by which <strong data-v-fb5ed2f6${_scopeId2}>all</strong> remaining authorizers must have acted — that is, the consent MUST reach <code data-v-fb5ed2f6${_scopeId2}>Status=Authorized</code> before this time, otherwise the consent transitions to rejected/expired. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fb5ed2f6${_scopeId2}><code data-v-fb5ed2f6${_scopeId2}>AuthorizationExpirationDateTime</code> MUST NOT be after <code data-v-fb5ed2f6${_scopeId2}>ExpirationDateTime</code>. </li><li data-v-fb5ed2f6${_scopeId2}> When <code data-v-fb5ed2f6${_scopeId2}>IsSingleAuthorization</code> is <code data-v-fb5ed2f6${_scopeId2}>true</code>, TPPs SHOULD NOT include <code data-v-fb5ed2f6${_scopeId2}>AuthorizationExpirationDateTime</code>. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      createVNode("code", null, "AuthorizationExpirationDateTime"),
            ...
            _push2(ssrRenderComponent(_component_EdNote, { type: "tip" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-fb5ed2f6${_scopeId2}> These fields are carried in the Rich Authorization Request (<code data-v-fb5ed2f6${_scopeId2}>authorization_details[].consent.IsSingleAuthorization</code>, <code data-v-fb5ed2f6${_scopeId2}>authorization_details[].consent.AuthorizationExpirationDateTime</code>). See the Authorization Endpoints OpenAPI for the full schema reference. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Before showing eligible accounts during the consent journey, the LFI checks <code data-v-fb5ed2f6${_scopeId2}>IsSingleAuthorization</code> from the PAR request: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fb5ed2f6${_scopeId2}> If <code data-v-fb5ed2f6${_scopeId2}>true</code>: allow selection only from accounts that require a single authorizer. If none exist, decline the consent, cancel the journey, and redirect the user to the TPP with an appropriate error. </li><li data-v-fb5ed2f6${_scopeId2}> If <code data-v-fb5ed2f6${_scopeId2}>false</code>: allow selection from accounts that require either single or multiple authorizers. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
                      createTextVNode(" If "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fb5ed2f6${_scopeId2}><strong data-v-fb5ed2f6${_scopeId2}>Inform OFH of required authorizers</strong> by PATCHing the consent to include <code data-v-fb5ed2f6${_scopeId2}>Meta.MultipleAuthorizers</code>. </li><li data-v-fb5ed2f6${_scopeId2}><strong data-v-fb5ed2f6${_scopeId2}>Keep consent status as <code data-v-fb5ed2f6${_scopeId2}>AwaitingAuthorization</code></strong> — do <strong data-v-fb5ed2f6${_scopeId2}>not</strong> set <code data-v-fb5ed2f6${_scopeId2}>Status=Authorized</code> yet. </li><li data-v-fb5ed2f6${_scopeId2}><strong data-v-fb5ed2f6${_scopeId2}>Redirect back to the TPP</strong> via <code data-v-fb5ed2f6${_scopeId2}>/doConfirm</code> once the PATCH is accepted. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The TPP receives the redirect/callback, exchanges the authorization code at <code data-v-fb5ed2f6${_scopeId2}>/token</code>, and receives an access token <strong data-v-fb5ed2f6${_scopeId2}>plus</strong> the consent object still marked <code data-v-fb5ed2f6${_scopeId2}>AwaitingAuthorization</code>, including the <code data-v-fb5ed2f6${_scopeId2}>Meta.MultipleAuthorizers</code> structure above. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fb5ed2f6${_scopeId2}>If any required authorizer rejects → set <code data-v-fb5ed2f6${_scopeId2}>Status=Rejected</code>.</li><li data-v-fb5ed2f6${_scopeId2}>When all required authorizers approve → set <code data-v-fb5ed2f6${_scopeId2}>Status=Authorized</code>.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-fb5ed2f6${_scopeId2}>The TPP MAY initiate the payment only after <code data-v-fb5ed2f6${_scopeId2}>Status=Authorized</code>.</li><li data-v-fb5ed2f6${_scopeId2}> Additional authorizers must act before <code data-v-fb5ed2f6${_scopeId2}>AuthorizationExpirationDateTime</code> if set, otherwise before <code data-v-fb5ed2f6${_scopeId2}>ExpirationDateTime</code>. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-fb5ed2f6${_scopeId2}>TPPs can monitor progress by:</p><ul data-v-fb5ed2f6${_scopeId2}><li data-v-fb5ed2f6${_scopeId2}>Subscribing to event notifications; or</li><li data-v-fb5ed2f6${_scopeId2}> Polling <a href="/tech/tpp-standards/v2.1/consent/open-api/payment-consents-ConsentId" class="endpoint" data-v-fb5ed2f6${_scopeId2}><span class="http-method http-method--get" data-v-fb5ed2f6${_scopeId2}>GET</span><code data-v-fb5ed2f6${_scopeId2}>/payment-consents/{ConsentId}</code></a>. </li></ul>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Once the consent is <code data-v-fb5ed2f6${_scopeId2}>Authorized</code>, the TPP can exchange the refresh token for a new access token via <a href="/tech/tpp-standards/security/tokens/" data-v-fb5ed2f6${_scopeId2}><code data-v-fb5ed2f6${_scopeId2}>/token</code></a> and proceed to initiate the payment. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/multi-authorization.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const multiAuthorization = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fb5ed2f6"]]);
export {
