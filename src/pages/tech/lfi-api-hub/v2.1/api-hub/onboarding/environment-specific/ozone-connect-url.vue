    ...
    >
      ...
      <EdBullets>
        ...
        <li>
          ...
          <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/#values-provided-by-ozone">Environment Specific Configuration</a>)
        </li>
        <li><strong>Not</strong> include a trailing slash</li>
        <li><strong>Not</strong> include path segments beyond the root (e.g. <code>/v2.1</code> is not required &mdash; the API Hub manages versioned routing)</li>
      </EdBullets>
    </EdSectionBand>
