...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-ba41afb1><section class="ed-doc__hero" data-v-ba41afb1><div class="ed-doc__inner" data-v-ba41afb1><div class="ed-doc__eyebrow" data-v-ba41afb1><span class="ed-doc__eyebrow-dash" data-v-ba41afb1></span> TPP · Insurance · Quotation </div><h1 class="ed-doc__title" data-v-ba41afb1> Insurance Quotation — API Guide <span class="ed-doc__read" data-v-ba41afb1>8 min read</span></h1><p class="ed-doc__lede" data-v-ba41afb1> End-to-end walkthrough of the Insurance Quotation flow from the TPP perspective. The flow runs on the Client Credentials Grant — no per-customer consent journey. After accepting a quote, you can subscribe to webhook events to receive status updates without polling. This page covers the subscription mechanism and the full event schema; the per-mode pages walk through the specific call sequences. </p></div></section>`);
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__cards" data-v-ba41afb1${_scopeId}><a class="ed-doc__card" href="/tech/tpp-standards/v2.2-rc1/insurance/quotation/api-guide/lfi-led" data-v-ba41afb1${_scopeId}><span class="ed-doc__card-cat" data-v-ba41afb1${_scopeId}>LFI-Led</span><h3 class="ed-doc__card-title" data-v-ba41afb1${_scopeId}>The LFI hosts the customer through completion</h3><p class="ed-doc__card-desc" data-v-ba41afb1${_scopeId}> Single-PATCH accept flow. Your app collects quote inputs, the LFI hosts everything from acceptance through to issuance. You observe progress via webhook events or polling. </p><span class="ed-doc__card-arrow" data-v-ba41afb1${_scopeId}>Open →</span></a><a class="ed-doc__card" href="/tech/tpp-standards/v2.2-rc1/insurance/quotation/api-guide/tpp-led" data-v-ba41afb1${_scopeId}><span class="ed-doc__card-cat" data-v-ba41afb1${_scopeId}>TPP-Led</span><h3 class="ed-doc__card-title" data-v-ba41afb1${_scopeId}>You collect KYC; the LFI hosts only payment</h3><p class="ed-doc__card-desc" data-v-ba41afb1${_scopeId}> Two-PATCH flow. You submit KYC, the LFI returns a payment URL via webhook event, you redirect the customer to pay, then deliver documents in your app. </p><span class="ed-doc__card-arrow" data-v-ba41afb1${_scopeId}>Open →</span></a></div>`);
          } else {
            return [
              createVNode("div", { class: "ed-doc__cards" }, [
                createVNode("a", {
                  class: "ed-doc__card",
                  href: "/tech/tpp-standards/v2.2-rc1/insurance/quotation/api-guide/lfi-led"
                }, [
                ...
                createVNode("a", {
                  class: "ed-doc__card",
                  href: "/tech/tpp-standards/v2.2-rc1/insurance/quotation/api-guide/tpp-led"
                }, [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When you PATCH a quote to accept it, you can attach a <code data-v-ba41afb1${_scopeId2}>Subscription.Webhook</code> object to register for event notifications. The Hub will POST status events to your registered URL whenever the LFI emits a quote-log update. Subscribing once on accept covers the entire lifecycle — you do not need to re-subscribe for each status. The webhook delivery surface is documented in <a href="/tech/tpp-standards/v2.2-rc1/webhooks/insurance-status/api-guide" data-v-ba41afb1${_scopeId2}>Insurance Quote Status Event — API Guide</a>, with the OpenAPI schema at <a href="/tech/tpp-standards/v2.2-rc1/webhooks/insurance-status/open-api" data-v-ba41afb1${_scopeId2}>Insurance Quote Status Change Event</a>. `);
                } else {
                  return [
                    ...
                    createVNode("a", { href: "/tech/tpp-standards/v2.2-rc1/webhooks/insurance-status/api-guide" }, "Insurance Quote Status Event — API Guide"),
                    createTextVNode(", with the OpenAPI schema at "),
                    createVNode("a", { href: "/tech/tpp-standards/v2.2-rc1/webhooks/insurance-status/open-api" }, "Insurance Quote Status Change Event"),
                    createTextVNode(". ")
                  ];
                }
              }),
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ba41afb1${_scopeId}>Subscription object</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-ba41afb1${_scopeId2}><thead data-v-ba41afb1${_scopeId2}><tr data-v-ba41afb1${_scopeId2}><th data-v-ba41afb1${_scopeId2}>Field</th><th data-v-ba41afb1${_scopeId2}>Type</th><th data-v-ba41afb1${_scopeId2}>Required</th><th data-v-ba41afb1${_scopeId2}>Description</th></tr></thead><tbody data-v-ba41afb1${_scopeId2}><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Webhook.Url</code></td><td data-v-ba41afb1${_scopeId2}>string (HTTPS URL)</td><td data-v-ba41afb1${_scopeId2}>On first registration</td><td data-v-ba41afb1${_scopeId2}>Your HTTPS endpoint that will receive event POSTs. Must match <code data-v-ba41afb1${_scopeId2}>^https://.+</code>.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Webhook.IsActive</code></td><td data-v-ba41afb1${_scopeId2}>boolean</td><td data-v-ba41afb1${_scopeId2}>Always</td><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>true</code> enables delivery; <code data-v-ba41afb1${_scopeId2}>false</code> pauses without removing the URL.</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ba41afb1${_scopeId}>Updating the subscription mid-lifecycle</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` You can PATCH the quote again at any time with only a <code data-v-ba41afb1${_scopeId2}>Subscription</code> object to update or pause webhook delivery. Omit the <code data-v-ba41afb1${_scopeId2}>Data</code> field; the LFI will not treat this as a re-acceptance. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ba41afb1${_scopeId2}> If you do not register a webhook, poll <code data-v-ba41afb1${_scopeId2}>GET /{type}-insurance-quotes/{QuoteId}</code> to retrieve the current status. Do not exceed one request per minute under normal load — the Hub may rate-limit aggressive polling. Webhooks are strongly preferred. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Every event delivered to your webhook conforms to one of three schemas, drawn from the API Hub Consent Manager spec. The <code data-v-ba41afb1${_scopeId2}>QuoteStatus</code> field identifies which schema applies. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ba41afb1${_scopeId}>1. Pending Completion Status</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Sent when the quote is making progress but not yet final. <code data-v-ba41afb1${_scopeId2}>QuoteStatus</code> is one of: <code data-v-ba41afb1${_scopeId2}>ApplicationPending</code>, <code data-v-ba41afb1${_scopeId2}>ApplicationApproved</code>, <code data-v-ba41afb1${_scopeId2}>PaymentRequired</code>, <code data-v-ba41afb1${_scopeId2}>PolicyIssued</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-ba41afb1${_scopeId2}><thead data-v-ba41afb1${_scopeId2}><tr data-v-ba41afb1${_scopeId2}><th data-v-ba41afb1${_scopeId2}>Field</th><th data-v-ba41afb1${_scopeId2}>Required</th><th data-v-ba41afb1${_scopeId2}>Notes</th></tr></thead><tbody data-v-ba41afb1${_scopeId2}><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>QuoteStatus</code></td><td data-v-ba41afb1${_scopeId2}>Always</td><td data-v-ba41afb1${_scopeId2}>One of the pending-completion enum values above.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>BrokerInstructions[]</code></td><td data-v-ba41afb1${_scopeId2}>When LFI requires TPP action</td><td data-v-ba41afb1${_scopeId2}>Each entry: <code data-v-ba41afb1${_scopeId2}>ActionRequired</code> (text), <code data-v-ba41afb1${_scopeId2}>Reason</code> (text), <code data-v-ba41afb1${_scopeId2}>Url</code> (e.g. payment URL).</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Documents[]</code></td><td data-v-ba41afb1${_scopeId2}>On <code data-v-ba41afb1${_scopeId2}>PolicyIssued</code> in TPP-Led mode</td><td data-v-ba41afb1${_scopeId2}>Base64-encoded policy documents with SHA-256 hashes. See &quot;Documents&quot; below.</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ba41afb1${_scopeId}>2. Completed Status</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Final event for a successful flow. <code data-v-ba41afb1${_scopeId2}>QuoteStatus: Completed</code>. Carries the finalised premium, policy term, and commission information. No further events follow. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-ba41afb1${_scopeId2}><thead data-v-ba41afb1${_scopeId2}><tr data-v-ba41afb1${_scopeId2}><th data-v-ba41afb1${_scopeId2}>Field</th><th data-v-ba41afb1${_scopeId2}>Required</th><th data-v-ba41afb1${_scopeId2}>Notes</th></tr></thead><tbody data-v-ba41afb1${_scopeId2}><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>QuoteStatus</code></td><td data-v-ba41afb1${_scopeId2}>Always</td><td data-v-ba41afb1${_scopeId2}>Always <code data-v-ba41afb1${_scopeId2}>&quot;Completed&quot;</code>.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>PolicyTerm</code></td><td data-v-ba41afb1${_scopeId2}>Always</td><td data-v-ba41afb1${_scopeId2}>ISO 8601 duration, e.g. <code data-v-ba41afb1${_scopeId2}>P1Y</code>, <code data-v-ba41afb1${_scopeId2}>P2Y3M</code>.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Premium</code></td><td data-v-ba41afb1${_scopeId2}>Always</td><td data-v-ba41afb1${_scopeId2}>Object with <code data-v-ba41afb1${_scopeId2}>OneYearPremiumExcludingVAT</code>, <code data-v-ba41afb1${_scopeId2}>VATAmount</code>, <code data-v-ba41afb1${_scopeId2}>TotalOneYearPremium</code>, and (optionally) <code data-v-ba41afb1${_scopeId2}>TotalPolicyPremium</code>.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>CustomerPaidInFull</code></td><td data-v-ba41afb1${_scopeId2}>Always</td><td data-v-ba41afb1${_scopeId2}>Boolean indicating full payment was received.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>PolicyCountrySubDivision</code></td><td data-v-ba41afb1${_scopeId2}>Always</td><td data-v-ba41afb1${_scopeId2}>UAE Emirate where the policy was issued.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>PolicyStartDate</code> / <code data-v-ba41afb1${_scopeId2}>PolicyEndDate</code></td><td data-v-ba41afb1${_scopeId2}>Recommended</td><td data-v-ba41afb1${_scopeId2}>ISO 8601 date.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>CustomerSalary</code></td><td data-v-ba41afb1${_scopeId2}>Required for Health</td><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Under4K</code> or <code data-v-ba41afb1${_scopeId2}>Over4K</code> (AED/month).</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Commission</code></td><td data-v-ba41afb1${_scopeId2}>When TPP commission applies</td><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>CommissionAmount</code> + <code data-v-ba41afb1${_scopeId2}>PaymentMethod</code> (<code data-v-ba41afb1${_scopeId2}>DirectToTPP</code> or <code data-v-ba41afb1${_scopeId2}>ThroughAPIHub</code>).</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Documents[]</code></td><td data-v-ba41afb1${_scopeId2}>Optional</td><td data-v-ba41afb1${_scopeId2}>Final policy documents if not already delivered on <code data-v-ba41afb1${_scopeId2}>PolicyIssued</code>.</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ba41afb1${_scopeId}>3. Terminal Status</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Negative terminal events. <code data-v-ba41afb1${_scopeId2}>QuoteStatus</code> is one of: <code data-v-ba41afb1${_scopeId2}>Expired</code>, <code data-v-ba41afb1${_scopeId2}>Rejected</code>, <code data-v-ba41afb1${_scopeId2}>CustomerCancelled</code>, <code data-v-ba41afb1${_scopeId2}>LFICancelled</code>. No further events follow. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-ba41afb1${_scopeId2}><thead data-v-ba41afb1${_scopeId2}><tr data-v-ba41afb1${_scopeId2}><th data-v-ba41afb1${_scopeId2}>Field</th><th data-v-ba41afb1${_scopeId2}>Required</th><th data-v-ba41afb1${_scopeId2}>Notes</th></tr></thead><tbody data-v-ba41afb1${_scopeId2}><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>QuoteStatus</code></td><td data-v-ba41afb1${_scopeId2}>Always</td><td data-v-ba41afb1${_scopeId2}>One of the four terminal enum values.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Reason</code></td><td data-v-ba41afb1${_scopeId2}>Optional</td><td data-v-ba41afb1${_scopeId2}>Free-text (1–1000 chars) explaining the termination — surface to the customer where helpful.</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ba41afb1${_scopeId}>PolicyIssued with documents (TPP-Led)</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` In TPP-Led mode, the <code data-v-ba41afb1${_scopeId2}>PolicyIssued</code> event carries every customer-facing document the LFI would normally deliver itself. Your TPP becomes the document delivery channel — the LFI will not email or post the documents. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ba41afb1${_scopeId}>Document object</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-ba41afb1${_scopeId2}><thead data-v-ba41afb1${_scopeId2}><tr data-v-ba41afb1${_scopeId2}><th data-v-ba41afb1${_scopeId2}>Field</th><th data-v-ba41afb1${_scopeId2}>Notes</th></tr></thead><tbody data-v-ba41afb1${_scopeId2}><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Type</code></td><td data-v-ba41afb1${_scopeId2}>Document category (e.g. &quot;Policy Booklet&quot;, &quot;Terms &amp; Conditions&quot;, &quot;IPID&quot;). Free-text.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>FileName</code></td><td data-v-ba41afb1${_scopeId2}>Original file name with extension. No path components.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>ContentType</code></td><td data-v-ba41afb1${_scopeId2}>One of <code data-v-ba41afb1${_scopeId2}>application/pdf</code>, <code data-v-ba41afb1${_scopeId2}>image/jpeg</code>, <code data-v-ba41afb1${_scopeId2}>image/png</code>.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Content</code></td><td data-v-ba41afb1${_scopeId2}>Base64-encoded file bytes.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>HashType</code></td><td data-v-ba41afb1${_scopeId2}>Always <code data-v-ba41afb1${_scopeId2}>SHA256</code>.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>Hash</code></td><td data-v-ba41afb1${_scopeId2}>SHA-256 of the raw file bytes (decoded <code data-v-ba41afb1${_scopeId2}>Content</code>). Required for integrity verification.</td></tr><tr data-v-ba41afb1${_scopeId2}><td data-v-ba41afb1${_scopeId2}><code data-v-ba41afb1${_scopeId2}>AdditionalInformation</code></td><td data-v-ba41afb1${_scopeId2}>Optional free text (max 1000 chars).</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ba41afb1${_scopeId}>Verification</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Before surfacing a document to the customer, decode <code data-v-ba41afb1${_scopeId2}>Content</code>, compute its SHA-256, and compare against <code data-v-ba41afb1${_scopeId2}>Hash</code>. Mismatches indicate corruption or tampering — do not deliver. Log the <code data-v-ba41afb1${_scopeId2}>x-fapi-interaction-id</code> from the event delivery and raise a support ticket including that ID and the <code data-v-ba41afb1${_scopeId2}>QuoteId</code>. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Events delivered to your webhook are signed by the Hub. You MUST verify the signature on every event before applying it. See <a href="/tech/tpp-standards/security/fapi/receiving-events" data-v-ba41afb1${_scopeId2}>Receiving Event Notifications</a> for the signature scheme. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The Hub may redeliver an event after a transient delivery failure. Treat events as idempotent — apply the latest <code data-v-ba41afb1${_scopeId2}>QuoteStatus</code> for the <code data-v-ba41afb1${_scopeId2}>QuoteId</code>, do not count events. Tracking by <code data-v-ba41afb1${_scopeId2}>QuoteId</code> + <code data-v-ba41afb1${_scopeId2}>QuoteStatus</code> + event timestamp is sufficient to dedupe. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The semantic differences between <code data-v-ba41afb1${_scopeId2}>New</code>, <code data-v-ba41afb1${_scopeId2}>Renewal</code>, and <code data-v-ba41afb1${_scopeId2}>Switch</code> — and the per-type field requirements — are documented in the shared <a href="/tech/lfi-api-hub/v2.2-rc1/insurance/quotation/quote-types" data-v-ba41afb1${_scopeId2}>Quote Types</a> explainer. Read it before issuing Renewal or Switch quotes; both require referencing a prior policy retrieved through Insurance Data Sharing under a customer consent. `);
                } else {
                  return [
                    ...
                    createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/insurance/quotation/quote-types" }, "Quote Types"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/insurance/quotation/api-guide/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ba41afb1"]]);
export {
  index as default
};
