...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-de1f3ca7><section class="ed-doc__hero" data-v-de1f3ca7><div class="ed-doc__inner" data-v-de1f3ca7><div class="ed-doc__eyebrow" data-v-de1f3ca7><span class="ed-doc__eyebrow-dash" data-v-de1f3ca7></span> LFI · API Hub · Onboarding · Configuring Auth </div><h1 class="ed-doc__title" data-v-de1f3ca7> Configuring Outbound mTLS <span class="ed-doc__read" data-v-de1f3ca7>3 min read</span></h1><p class="ed-doc__lede" data-v-de1f3ca7> This page describes how the LFI MUST configure outbound mutual TLS (mTLS) when its authorisation server calls the API Hub&#39;s Consent Manager and Headless Heimdall Auth Server endpoints during consent and authorisation flows. </p></div></section>`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-de1f3ca7${_scopeId2}><strong data-v-de1f3ca7${_scopeId2}>Present</strong> the C3 client certificate and its private key on every outbound connection, and</li><li data-v-de1f3ca7${_scopeId2}><strong data-v-de1f3ca7${_scopeId2}>Trust</strong> the API Hub&#39;s server certificate chain so the TLS handshake succeeds.</li>`);
            } else {
              return [
                createVNode("li", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-de1f3ca7${_scopeId2}><strong data-v-de1f3ca7${_scopeId2}>Production</strong> API Hub → <strong data-v-de1f3ca7${_scopeId2}>Production</strong> Trust Framework</li><li data-v-de1f3ca7${_scopeId2}><strong data-v-de1f3ca7${_scopeId2}>Pre-production</strong> API Hub → <strong data-v-de1f3ca7${_scopeId2}>Sandbox</strong> Trust Framework</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The Root and Issuing CA details for each environment are documented on <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/configuring-authentication/mtls-server#trust-framework-cas" data-v-de1f3ca7${_scopeId2}>Configuring Inbound mTLS — Section 2</a>. The same CA bundle assembled for inbound mTLS is re-used on the outbound direction. `);
            } else {
              return [
                createTextVNode(" The Root and Issuing CA details for each environment are documented on "),
                createVNode("a", { href: "/tech/lfi-api-hub/v2.1/api-hub/onboarding/configuring-authentication/mtls-server#trust-framework-cas" }, "Configuring Inbound mTLS — Section 2"),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-de1f3ca7${_scopeId2}><strong data-v-de1f3ca7${_scopeId2}>Present the C3 client certificate</strong> so the API Hub accepts the TLS handshake and can identify your organisation.</li><li data-v-de1f3ca7${_scopeId2}><strong data-v-de1f3ca7${_scopeId2}>Trust the API Hub&#39;s server chain</strong> so the handshake completes and your client does not fall back to an untrusted state.</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(`<h3 data-v-de1f3ca7${_scopeId}>3a. Present the C3 client certificate</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The C3 transport client certificate is created inside the <code data-v-de1f3ca7${_scopeId2}>C3-hh-cm-client</code> Application in your Trust Framework Organisation. The same Application also holds the <strong data-v-de1f3ca7${_scopeId2}>Sig4</strong> signing certificate used for <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/configuring-authentication/jwt-client" data-v-de1f3ca7${_scopeId2}>JWT Auth — Client-side</a> when JWT Auth is enabled on the LFI → Hub direction. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-de1f3ca7${_scopeId2}>In your Trust Framework Organisation, open the <strong data-v-de1f3ca7${_scopeId2}><code data-v-de1f3ca7${_scopeId2}>C3-hh-cm-client</code></strong> Application.</li><li data-v-de1f3ca7${_scopeId2}>Create (or reuse) the <strong data-v-de1f3ca7${_scopeId2}>C3</strong> transport client certificate, following the code snippets provided in the Trust Framework.</li><li data-v-de1f3ca7${_scopeId2}>Export the C3 certificate and its private key in a format your HTTP client accepts (typically PEM or PKCS#12).</li><li data-v-de1f3ca7${_scopeId2}>Load the C3 certificate and private key into the HTTP client used by your authorisation server when calling the API Hub&#39;s Consent Manager and Headless Heimdall Auth Server endpoints.</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-de1f3ca7${_scopeId2}> The C3 certificate created in your Sandbox Trust Framework Organisation is only valid against the Pre-production API Hub. For Production, the C3 is issued by the Production Trust Framework. Do not share key material between environments. </p>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The C3 certificate subject — specifically its <code data-v-de1f3ca7${_scopeId2}>OU</code> and <code data-v-de1f3ca7${_scopeId2}>O</code> — also determines the JWKS URL where the API Hub looks up your Sig4 public key when JWT Auth is enabled. See <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/configuring-authentication/jwt-client" data-v-de1f3ca7${_scopeId2}>JWT Auth — Client-side</a> for how the subject binds the transport and application layers. `);
            } else {
              return [
        ...
        _push2(`<h3 data-v-de1f3ca7${_scopeId}>3b. Trust the API Hub&#39;s server chain</h3>`);
        _push2(ssrRenderComponent(_component_EdNote, {
          type: "warning",
          title: "Open question"
        }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-de1f3ca7${_scopeId2}> This section depends on whether the API Hub&#39;s Consent Manager and Headless Heimdall endpoints present a Trust Framework-issued server certificate or a commercial (public Web PKI) certificate. Confirm with Ozone before finalising. </p>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` If the API Hub presents a <strong data-v-de1f3ca7${_scopeId2}>Trust Framework-issued</strong> server certificate, the LFI&#39;s outbound HTTP client MUST load the Trust Framework bundle (Issuing CA + Root CA) as a trust anchor. This is the same bundle assembled for <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/configuring-authentication/mtls-server#trust-ca-bundle" data-v-de1f3ca7${_scopeId2}>Configuring Inbound mTLS — Section 3a</a>. `);
            } else {
              return [
                ...
                createVNode("a", { href: "/tech/lfi-api-hub/v2.1/api-hub/onboarding/configuring-authentication/mtls-server#trust-ca-bundle" }, "Configuring Inbound mTLS — Section 3a"),
                createTextVNode(". ")
              ];
            }
          }),
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` If the API Hub presents a <strong data-v-de1f3ca7${_scopeId2}>commercial</strong> server certificate, most HTTP clients will validate it against the operating-system trust store without any LFI-side configuration. In that case no additional trust setup is required beyond ensuring the OS trust store is up to date. `);
            } else {
              return [
                createTextVNode(" If the API Hub presents a "),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-de1f3ca7${_scopeId2}>Establish a mutual TLS session with the Consent Manager presenting the C3 certificate issued by the paired Trust Framework, and</li><li data-v-de1f3ca7${_scopeId2}>Establish a mutual TLS session with the Headless Heimdall Auth Server presenting the same C3 certificate.</li>`);
            } else {
              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/api-hub/onboarding/configuring-authentication/mtls-client.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const mtlsClient = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-de1f3ca7"]]);
export {
