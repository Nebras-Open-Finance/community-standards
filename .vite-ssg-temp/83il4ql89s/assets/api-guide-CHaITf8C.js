...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-4a3ebc9f><section class="ed-doc__hero" data-v-4a3ebc9f><div class="ed-doc__inner" data-v-4a3ebc9f><div class="ed-doc__eyebrow" data-v-4a3ebc9f><span class="ed-doc__eyebrow-dash" data-v-4a3ebc9f></span> TPP · Banking · Service Initiation · Fixed Periodic Schedule </div><h1 class="ed-doc__title" data-v-4a3ebc9f> Fixed Periodic Schedule — API Guide <span class="ed-doc__read" data-v-4a3ebc9f>5 min read</span></h1><p class="ed-doc__lede" data-v-4a3ebc9f> A Fixed Periodic Schedule consent authorises a TPP to initiate <strong data-v-4a3ebc9f>one payment per period</strong> at a <strong data-v-4a3ebc9f>fixed amount</strong> over the lifetime of the consent. The user authorises once — approving a specific payment amount and the recurring period — and the TPP submits one payment per period without requiring re-authorisation each time. </p><p class="ed-doc__lede" data-v-4a3ebc9f> Common use cases include fixed monthly subscriptions, regular instalment collection, and recurring membership fees where the charge is always the same and payments follow a predictable calendar. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-4a3ebc9f${_scopeId2}><strong data-v-4a3ebc9f${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-4a3ebc9f${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the <strong data-v-4a3ebc9f${_scopeId2}>BSIP role</strong> as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-4a3ebc9f${_scopeId2}>Roles</a>. </li><li data-v-4a3ebc9f${_scopeId2}><strong data-v-4a3ebc9f${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-4a3ebc9f${_scopeId2}>Transport Certificate</a></strong> — an active transport certificate must be issued and registered in the Trust Framework to establish secure <strong data-v-4a3ebc9f${_scopeId2}>mTLS communication</strong>. </li><li data-v-4a3ebc9f${_scopeId2}><strong data-v-4a3ebc9f${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-4a3ebc9f${_scopeId2}>Signing Certificate</a></strong> — an active signing certificate must be issued and registered in the Trust Framework. This certificate is used to sign request objects and client assertions. </li><li data-v-4a3ebc9f${_scopeId2}><strong data-v-4a3ebc9f${_scopeId2}>Registration with the relevant <a href="/tech/tpp-standards/registration/api-guide" data-v-4a3ebc9f${_scopeId2}>API Hub (Authorisation Server)</a></strong> — the application must be registered with the API Hub (Server) of the LFI with which you intend to initiate payments. </li><li data-v-4a3ebc9f${_scopeId2}><strong data-v-4a3ebc9f${_scopeId2}>Understanding of the <a href="/tech/tpp-standards/security/fapi/" data-v-4a3ebc9f${_scopeId2}>FAPI Security Profile</a></strong> and <strong data-v-4a3ebc9f${_scopeId2}><a href="/tech/tpp-standards/security/tokens/" data-v-4a3ebc9f${_scopeId2}>Tokens &amp; Assertions</a></strong> — you should understand how request object signing, client authentication, and access token validation underpin secure API interactions. </li><li data-v-4a3ebc9f${_scopeId2}><strong data-v-4a3ebc9f${_scopeId2}>Understanding of <a href="/tech/tpp-standards/security/fapi/message-encryption" data-v-4a3ebc9f${_scopeId2}>Message Encryption</a></strong> — PII (creditor name and account details) must be encrypted as a JWE before being embedded in the consent. You will need the LFI&#39;s public encryption key from their JWKS. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-4a3ebc9f${_scopeId}><span class="http-badge http-post" data-v-4a3ebc9f${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-4a3ebc9f${_scopeId}>/par</code></div>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` With the encrypted PII ready, construct the <code data-v-4a3ebc9f${_scopeId2}>authorization_details</code> of type <code data-v-4a3ebc9f${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.2</code>. Set <code data-v-4a3ebc9f${_scopeId2}>PeriodicSchedule.Type</code> to <code data-v-4a3ebc9f${_scopeId2}>&quot;FixedPeriodicSchedule&quot;</code>. The payment amount <strong data-v-4a3ebc9f${_scopeId2}>is fixed at consent time</strong> via <code data-v-4a3ebc9f${_scopeId2}>PeriodicSchedule.Amount</code> — every <span class="endpoint" data-v-4a3ebc9f${_scopeId2}><span class="http-method http-method--post" data-v-4a3ebc9f${_scopeId2}>POST</span><code data-v-4a3ebc9f${_scopeId2}>/payments</code></span> call under this consent must use exactly this amount, and only one payment may be submitted per period. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-4a3ebc9f${_scopeId}>authorization_details</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-4a3ebc9f${_scopeId2}><thead data-v-4a3ebc9f${_scopeId2}><tr data-v-4a3ebc9f${_scopeId2}><th data-v-4a3ebc9f${_scopeId2}>Field</th><th data-v-4a3ebc9f${_scopeId2}>Type</th><th data-v-4a3ebc9f${_scopeId2}>Description</th><th data-v-4a3ebc9f${_scopeId2}>Example</th></tr></thead><tbody data-v-4a3ebc9f${_scopeId2}><tr data-v-4a3ebc9f${_scopeId2}><td data-v-4a3ebc9f${_scopeId2}><code data-v-4a3ebc9f${_scopeId2}>type</code>*</td><td data-v-4a3ebc9f${_scopeId2}>enum</td><td data-v-4a3ebc9f${_scopeId2}>Must be <code data-v-4a3ebc9f${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.2</code></td><td data-v-4a3ebc9f${_scopeId2}><code data-v-4a3ebc9f${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.2</code></td></tr><tr data-v-4a3ebc9f${_scopeId2}><td data-v-4a3ebc9f${_scopeId2}><code data-v-4a3ebc9f${_scopeId2}>consent</code>*</td><td data-v-4a3ebc9f${_scopeId2}>object</td><td data-v-4a3ebc9f${_scopeId2}>Consent properties agreed by the User with the TPP. <em data-v-4a3ebc9f${_scopeId2}>Described below.</em></td><td data-v-4a3ebc9f${_scopeId2}>—</td></tr><tr data-v-4a3ebc9f${_scopeId2}><td data-v-4a3ebc9f${_scopeId2}><code data-v-4a3ebc9f${_scopeId2}>subscription</code></td><td data-v-4a3ebc9f${_scopeId2}>object</td><td data-v-4a3ebc9f${_scopeId2}>Optional subscription to Event Notifications via Webhook. <em data-v-4a3ebc9f${_scopeId2}>Described below.</em></td><td data-v-4a3ebc9f${_scopeId2}>—</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-4a3ebc9f${_scopeId}>ControlParameters — Fixed Periodic Schedule</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-4a3ebc9f${_scopeId2}>ControlParameters.ConsentSchedule.MultiPayment</code> carries the control definition. Set <code data-v-4a3ebc9f${_scopeId2}>PeriodicSchedule.Type</code> to <code data-v-4a3ebc9f${_scopeId2}>&quot;FixedPeriodicSchedule&quot;</code>. Only <strong data-v-4a3ebc9f${_scopeId2}>one payment is permitted per period</strong>. There is no <code data-v-4a3ebc9f${_scopeId2}>Controls</code> block — the period itself acts as the limiting boundary. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-4a3ebc9f${_scopeId2}>Cumulative Control Parameters</strong> — apply across the entire consent lifetime: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-4a3ebc9f${_scopeId2}>Periodic Schedule Parameters</strong> — define the fixed amount and period, set directly inside <code data-v-4a3ebc9f${_scopeId2}>PeriodicSchedule</code>: `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-4a3ebc9f${_scopeId}>Example request</h3>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-4a3ebc9f${_scopeId2}> Save <code data-v-4a3ebc9f${_scopeId2}>codeVerifier</code> in your server-side session or an <code data-v-4a3ebc9f${_scopeId2}>httpOnly</code> cookie — you will need it in <a href="#step-8-post-token-authorization-code" data-v-4a3ebc9f${_scopeId2}>Step 8</a> to exchange the authorization code for tokens. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/fapi/request-jwt" data-v-4a3ebc9f${_scopeId2}>Preparing the Request JWT</a> for the full JWT claim reference and PKCE helpers. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-4a3ebc9f${_scopeId2}>authorization_endpoint</code> is found in the LFI&#39;s <code data-v-4a3ebc9f${_scopeId2}>.well-known/openid-configuration</code> — not constructed from the issuer URL directly. `);
                } else {
                  return [
                    createTextVNode(" The "),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-4a3ebc9f${_scopeId2}>The TPP name and purpose.</li><li data-v-4a3ebc9f${_scopeId2}>The fixed payment <code data-v-4a3ebc9f${_scopeId2}>Amount</code> (e.g. &quot;AED 150.00 per payment&quot;).</li><li data-v-4a3ebc9f${_scopeId2}>The period type and start date (e.g. &quot;Monthly from 1 March 2026&quot;).</li><li data-v-4a3ebc9f${_scopeId2}>Any lifetime cumulative caps.</li><li data-v-4a3ebc9f${_scopeId2}>The consent expiry date.</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-4a3ebc9f${_scopeId2}> See <a href="./user-journeys" data-v-4a3ebc9f${_scopeId2}>User Experience</a> for screen mockups of the Fixed Periodic Schedule <strong data-v-4a3ebc9f${_scopeId2}>Consent</strong> and <strong data-v-4a3ebc9f${_scopeId2}>Authorization</strong> pages the user sees at the bank. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" See "),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-4a3ebc9f${_scopeId}><span class="http-badge http-post" data-v-4a3ebc9f${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-4a3ebc9f${_scopeId}>/token</code></div>`);
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-4a3ebc9f${_scopeId}><span class="http-badge http-post" data-v-4a3ebc9f${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-4a3ebc9f${_scopeId}>/payments</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Include <code data-v-4a3ebc9f${_scopeId2}>x-fapi-interaction-id</code> and <code data-v-4a3ebc9f${_scopeId2}>x-idempotency-key</code>. If the customer is present at this point in the flow, also send <code data-v-4a3ebc9f${_scopeId2}>x-fapi-customer-ip-address</code>, <code data-v-4a3ebc9f${_scopeId2}>x-customer-user-agent</code> and <code data-v-4a3ebc9f${_scopeId2}>x-fapi-auth-date</code> if the customer has been authenticated. See <a href="/tech/tpp-standards/security/request-headers" data-v-4a3ebc9f${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-4a3ebc9f${_scopeId2}> Unlike Single Instant Payment, multi-payment consents do not require <code data-v-4a3ebc9f${_scopeId2}>PaymentPurposeCode</code>, <code data-v-4a3ebc9f${_scopeId2}>DebtorReference</code>, <code data-v-4a3ebc9f${_scopeId2}>CreditorReference</code>, or <code data-v-4a3ebc9f${_scopeId2}>OpenFinanceBilling</code> to match the consent exactly. Only <code data-v-4a3ebc9f${_scopeId2}>ConsentId</code> must match the authorized consent. <code data-v-4a3ebc9f${_scopeId2}>Instruction.Amount</code> must be within the parameters the consent allows for this payment type. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-4a3ebc9f${_scopeId2}> The API Hub will reject a payment if <code data-v-4a3ebc9f${_scopeId2}>Instruction.Amount</code> does not exactly match <code data-v-4a3ebc9f${_scopeId2}>PeriodicSchedule.Amount</code>, if a payment has already been submitted in the current period, or if any lifetime cumulative cap has been reached. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-4a3ebc9f${_scopeId2}> After each successful payment, the consent remains in the <code data-v-4a3ebc9f${_scopeId2}>Authorized</code> state until the next period begins (unless lifetime cumulative caps are reached or the consent expires). You do <strong data-v-4a3ebc9f${_scopeId2}>not</strong> need to re-initiate the authorization flow. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-periodic-schedule/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4a3ebc9f"]]);
export {
  apiGuide as default
};
