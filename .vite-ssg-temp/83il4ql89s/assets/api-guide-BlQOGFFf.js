...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-2d34763c><section class="ed-doc__hero" data-v-2d34763c><div class="ed-doc__inner" data-v-2d34763c><div class="ed-doc__eyebrow" data-v-2d34763c><span class="ed-doc__eyebrow-dash" data-v-2d34763c></span> TPP · Banking · Service Initiation · Fixed On-Demand </div><h1 class="ed-doc__title" data-v-2d34763c> Fixed On-Demand — API Guide <span class="ed-doc__read" data-v-2d34763c>5 min read</span></h1><p class="ed-doc__lede" data-v-2d34763c> A Fixed On-Demand consent authorises a TPP to initiate <strong data-v-2d34763c>multiple payments</strong> at a <strong data-v-2d34763c>fixed amount</strong> over the lifetime of the consent. The user authorises once — approving a specific per-payment amount and periodic limits — and the TPP can then submit individual payments on-demand without requiring re-authorisation for each one. </p><p class="ed-doc__lede" data-v-2d34763c> Common use cases include fixed-amount subscription billing, regular instalment collection, and scheduled membership fees where the charge is always the same. </p></div></section>`);
      _push(ssrRenderComponent(_component_EdSectionBand, {
        id: "prerequisites",
        num: "01",
        color: "var(--at-teal)",
        eyebrow: "Prerequisites",
        title: "What you need before initiating a Fixed On-Demand payment",
        tone: "cream"
      }, {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Before initiating a Fixed On-Demand payment, ensure the following requirements are met:`);
                } else {
                  return [
                    createTextVNode("Before initiating a Fixed On-Demand payment, ensure the following requirements are met:")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-2d34763c${_scopeId2}><strong data-v-2d34763c${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-2d34763c${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the <strong data-v-2d34763c${_scopeId2}>BSIP role</strong> as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-2d34763c${_scopeId2}>Roles</a>. </li><li data-v-2d34763c${_scopeId2}><strong data-v-2d34763c${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-2d34763c${_scopeId2}>Transport Certificate</a></strong> — an active transport certificate must be issued and registered in the Trust Framework to establish secure <strong data-v-2d34763c${_scopeId2}>mTLS communication</strong>. </li><li data-v-2d34763c${_scopeId2}><strong data-v-2d34763c${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-2d34763c${_scopeId2}>Signing Certificate</a></strong> — an active signing certificate must be issued and registered in the Trust Framework. This certificate is used to sign request objects and client assertions. </li><li data-v-2d34763c${_scopeId2}><strong data-v-2d34763c${_scopeId2}>Registration with the relevant <a href="/tech/tpp-standards/registration/api-guide" data-v-2d34763c${_scopeId2}>API Hub (Authorisation Server)</a></strong> — the application must be registered with the API Hub (Server) of the LFI with which you intend to initiate payments. </li><li data-v-2d34763c${_scopeId2}><strong data-v-2d34763c${_scopeId2}>Understanding of the <a href="/tech/tpp-standards/security/fapi/" data-v-2d34763c${_scopeId2}>FAPI Security Profile</a></strong> and <strong data-v-2d34763c${_scopeId2}><a href="/tech/tpp-standards/security/tokens/" data-v-2d34763c${_scopeId2}>Tokens &amp; Assertions</a></strong> — you should understand how request object signing, client authentication, and access token validation underpin secure API interactions. </li><li data-v-2d34763c${_scopeId2}><strong data-v-2d34763c${_scopeId2}>Understanding of <a href="/tech/tpp-standards/security/fapi/message-encryption" data-v-2d34763c${_scopeId2}>Message Encryption</a></strong> — PII (creditor name and account details) must be encrypted as a JWE before being embedded in the consent. You will need the LFI&#39;s public encryption key from their JWKS. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-2d34763c${_scopeId}><span class="http-badge http-post" data-v-2d34763c${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-2d34763c${_scopeId}>/par</code></div>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` With the encrypted PII ready, construct the <code data-v-2d34763c${_scopeId2}>authorization_details</code> of type <code data-v-2d34763c${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.1</code>. The key difference from Variable On-Demand is that <code data-v-2d34763c${_scopeId2}>PeriodicSchedule.Amount</code> is a <strong data-v-2d34763c${_scopeId2}>mandatory fixed amount</strong> — every payment under this consent must be for exactly this value. `);
                } else {
                  return [
                    ...
                    createTextVNode(". The key difference from Variable On-Demand is that "),
                    createVNode("code", null, "PeriodicSchedule.Amount"),
                    createTextVNode(" is a "),
                    createVNode("strong", null, "mandatory fixed amount"),
                    createTextVNode(" — every payment under this consent must be for exactly this value. ")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<h3 class="ed-doc__subhead" data-v-2d34763c${_scopeId}>authorization_details</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-2d34763c${_scopeId2}><thead data-v-2d34763c${_scopeId2}><tr data-v-2d34763c${_scopeId2}><th data-v-2d34763c${_scopeId2}>Field</th><th data-v-2d34763c${_scopeId2}>Type</th><th data-v-2d34763c${_scopeId2}>Description</th><th data-v-2d34763c${_scopeId2}>Example</th></tr></thead><tbody data-v-2d34763c${_scopeId2}><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>type</code>*</td><td data-v-2d34763c${_scopeId2}>enum</td><td data-v-2d34763c${_scopeId2}>Must be <code data-v-2d34763c${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.1</code></td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.1</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>consent</code>*</td><td data-v-2d34763c${_scopeId2}>object</td><td data-v-2d34763c${_scopeId2}>Consent properties agreed by the User with the TPP. <em data-v-2d34763c${_scopeId2}>Described below.</em></td><td data-v-2d34763c${_scopeId2}>—</td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>subscription</code></td><td data-v-2d34763c${_scopeId2}>object</td><td data-v-2d34763c${_scopeId2}>Optional subscription to Event Notifications via Webhook. <em data-v-2d34763c${_scopeId2}>Described below.</em></td><td data-v-2d34763c${_scopeId2}>—</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-2d34763c${_scopeId}>consent (Required) | <code data-v-2d34763c${_scopeId}>authorization_details.consent</code></h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-2d34763c${_scopeId2}><thead data-v-2d34763c${_scopeId2}><tr data-v-2d34763c${_scopeId2}><th data-v-2d34763c${_scopeId2}>Field</th><th data-v-2d34763c${_scopeId2}>Type</th><th data-v-2d34763c${_scopeId2}>Description</th><th data-v-2d34763c${_scopeId2}>Example</th></tr></thead><tbody data-v-2d34763c${_scopeId2}><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>ConsentId</code>*</td><td data-v-2d34763c${_scopeId2}>string (uuid)</td><td data-v-2d34763c${_scopeId2}>Unique ID assigned by the TPP (1–128 chars)</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>b8f42378-10ac-46a1-8d20-4e020484216d</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>IsSingleAuthorization</code>*</td><td data-v-2d34763c${_scopeId2}>boolean</td><td data-v-2d34763c${_scopeId2}>Whether the payment requires only one authorizing party</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>true</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>ExpirationDateTime</code>*</td><td data-v-2d34763c${_scopeId2}>date-time</td><td data-v-2d34763c${_scopeId2}>Consent expiry (ISO 8601 with timezone, max 1 year)</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>2027-03-02T00:00:00+00:00</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>AuthorizationExpirationDateTime</code></td><td data-v-2d34763c${_scopeId2}>date-time</td><td data-v-2d34763c${_scopeId2}>Deadline by which all authorizers must have acted (multi-authorization only). SHOULD be set when <code data-v-2d34763c${_scopeId2}>IsSingleAuthorization</code> is <code data-v-2d34763c${_scopeId2}>false</code>; SHOULD NOT be set when <code data-v-2d34763c${_scopeId2}>IsSingleAuthorization</code> is <code data-v-2d34763c${_scopeId2}>true</code>. MUST NOT be after <code data-v-2d34763c${_scopeId2}>ExpirationDateTime</code>.</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>2026-03-03T10:00:00+00:00</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>BaseConsentId</code></td><td data-v-2d34763c${_scopeId2}>string (uuid)</td><td data-v-2d34763c${_scopeId2}>Links to prior consent if renewing — see <a href="/knowledge-base/articles/base-consent-id" data-v-2d34763c${_scopeId2}>Base Consent ID</a></td><td data-v-2d34763c${_scopeId2}>—</td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>Permissions</code></td><td data-v-2d34763c${_scopeId2}>array&lt;enum&gt;</td><td data-v-2d34763c${_scopeId2}>Optional access permissions granted alongside the payment consent</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>ReadAccountsBasic</code>, <code data-v-2d34763c${_scopeId2}>ReadBalances</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>ControlParameters</code>*</td><td data-v-2d34763c${_scopeId2}>object</td><td data-v-2d34763c${_scopeId2}>Payment controls — <strong data-v-2d34763c${_scopeId2}>see below</strong></td><td data-v-2d34763c${_scopeId2}>—</td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PersonalIdentifiableInformation</code>*</td><td data-v-2d34763c${_scopeId2}>string (JWE)</td><td data-v-2d34763c${_scopeId2}>Encrypted creditor and risk data — the <code data-v-2d34763c${_scopeId2}>encryptedPII</code> string from Step 1</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>eyJhbGci...</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PaymentPurposeCode</code>*</td><td data-v-2d34763c${_scopeId2}>string (3 chars)</td><td data-v-2d34763c${_scopeId2}>AANI payment purpose code</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>ACM</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>DebtorReference</code></td><td data-v-2d34763c${_scopeId2}>string</td><td data-v-2d34763c${_scopeId2}>Reference shown on the debtor&#39;s statement</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>Subscription</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>CreditorReference</code></td><td data-v-2d34763c${_scopeId2}>string</td><td data-v-2d34763c${_scopeId2}>Reference shown on the creditor&#39;s statement</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>Subscription</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-2d34763c${_scopeId}>ControlParameters — Fixed On-Demand</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-2d34763c${_scopeId2}>ControlParameters.ConsentSchedule.MultiPayment</code> carries the control definition. Set <code data-v-2d34763c${_scopeId2}>PeriodicSchedule.Type</code> to <code data-v-2d34763c${_scopeId2}>&quot;FixedOnDemand&quot;</code>. The payment amount <strong data-v-2d34763c${_scopeId2}>is fixed at consent time</strong> via <code data-v-2d34763c${_scopeId2}>PeriodicSchedule.Amount</code> — every <span class="endpoint" data-v-2d34763c${_scopeId2}><span class="http-method http-method--post" data-v-2d34763c${_scopeId2}>POST</span><code data-v-2d34763c${_scopeId2}>/payments</code></span> call under this consent must use exactly this amount. `);
                } else {
                  return [
                    ...
                    createTextVNode(" call under this consent must use exactly this amount. ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-2d34763c${_scopeId2}>Cumulative Control Parameters</strong> — apply across the entire consent lifetime: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-2d34763c${_scopeId2}><thead data-v-2d34763c${_scopeId2}><tr data-v-2d34763c${_scopeId2}><th data-v-2d34763c${_scopeId2}>Field</th><th data-v-2d34763c${_scopeId2}>Required</th><th data-v-2d34763c${_scopeId2}>Description</th><th data-v-2d34763c${_scopeId2}>Example</th></tr></thead><tbody data-v-2d34763c${_scopeId2}><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>MaximumCumulativeValueOfPayments.Amount</code></td><td data-v-2d34763c${_scopeId2}>No</td><td data-v-2d34763c${_scopeId2}>Maximum total value of all payments over the consent lifetime</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>10000.00</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>MaximumCumulativeValueOfPayments.Currency</code></td><td data-v-2d34763c${_scopeId2}>No</td><td data-v-2d34763c${_scopeId2}>ISO 4217 currency code</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>AED</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>MaximumCumulativeNumberOfPayments</code></td><td data-v-2d34763c${_scopeId2}>No</td><td data-v-2d34763c${_scopeId2}>Maximum total number of payments over the consent lifetime</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>24</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PeriodicSchedule.PeriodType</code> sets the <strong data-v-2d34763c${_scopeId2}>unit</strong> for the periodic controls — change it from <code data-v-2d34763c${_scopeId2}>&quot;Month&quot;</code> to <code data-v-2d34763c${_scopeId2}>&quot;Week&quot;</code>, <code data-v-2d34763c${_scopeId2}>&quot;Day&quot;</code>, or <code data-v-2d34763c${_scopeId2}>&quot;Year&quot;</code> and the per-period caps (<code data-v-2d34763c${_scopeId2}>MaximumCumulativeValueOfPaymentsPerPeriod</code>, <code data-v-2d34763c${_scopeId2}>MaximumCumulativeNumberOfPaymentsPerPeriod</code>) rescope to that unit. For example, with <code data-v-2d34763c${_scopeId2}>PeriodType: &quot;Month&quot;</code> and <code data-v-2d34763c${_scopeId2}>MaximumCumulativeNumberOfPaymentsPerPeriod: 3</code>, the TPP may submit at most 3 payments in any calendar month under this consent. </p><p data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PeriodType</code> <strong data-v-2d34763c${_scopeId2}>does not schedule payments</strong> — the TPP still triggers each <span class="endpoint" data-v-2d34763c${_scopeId2}><span class="http-method http-method--post" data-v-2d34763c${_scopeId2}>POST</span><code data-v-2d34763c${_scopeId2}>/payments</code></span> on-demand. This differs from the periodic variants (<a href="../fixed-periodic-schedule/api-guide" data-v-2d34763c${_scopeId2}>FixedPeriodicSchedule</a>, <a href="../variable-periodic-schedule/api-guide" data-v-2d34763c${_scopeId2}>VariablePeriodicSchedule</a>) and the defined variants (<a href="../fixed-defined-schedule/api-guide" data-v-2d34763c${_scopeId2}>FixedDefinedSchedule</a>, <a href="../variable-defined-schedule/api-guide" data-v-2d34763c${_scopeId2}>VariableDefinedSchedule</a>), where the schedule itself governs when payments may be submitted. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-2d34763c${_scopeId2}>Periodic Control Parameters</strong> — apply per recurring period, defined inside <code data-v-2d34763c${_scopeId2}>PeriodicSchedule</code>: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-2d34763c${_scopeId2}><thead data-v-2d34763c${_scopeId2}><tr data-v-2d34763c${_scopeId2}><th data-v-2d34763c${_scopeId2}>Field</th><th data-v-2d34763c${_scopeId2}>Required</th><th data-v-2d34763c${_scopeId2}>Description</th><th data-v-2d34763c${_scopeId2}>Example</th></tr></thead><tbody data-v-2d34763c${_scopeId2}><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PeriodicSchedule.PeriodType</code></td><td data-v-2d34763c${_scopeId2}>Yes</td><td data-v-2d34763c${_scopeId2}>The period length: <code data-v-2d34763c${_scopeId2}>Day</code>, <code data-v-2d34763c${_scopeId2}>Week</code>, <code data-v-2d34763c${_scopeId2}>Month</code>, or <code data-v-2d34763c${_scopeId2}>Year</code></td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>Month</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PeriodicSchedule.PeriodStartDate</code></td><td data-v-2d34763c${_scopeId2}>Yes</td><td data-v-2d34763c${_scopeId2}>The date from which the period starts. For <code data-v-2d34763c${_scopeId2}>Day</code> and <code data-v-2d34763c${_scopeId2}>Year</code>, this is when payments may begin. Must not be in the past (today is accepted) and must be before <code data-v-2d34763c${_scopeId2}>ExpirationDateTime</code></td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>2027-01-01</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PeriodicSchedule.Amount.Amount</code></td><td data-v-2d34763c${_scopeId2}>Yes</td><td data-v-2d34763c${_scopeId2}>The <strong data-v-2d34763c${_scopeId2}>fixed</strong> payment amount. Every payment submitted under this consent must be for exactly this value</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>150.00</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PeriodicSchedule.Amount.Currency</code></td><td data-v-2d34763c${_scopeId2}>Yes</td><td data-v-2d34763c${_scopeId2}>ISO 4217 currency code</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>AED</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PeriodicSchedule.Controls.MaximumCumulativeValueOfPaymentsPerPeriod.Amount</code></td><td data-v-2d34763c${_scopeId2}>At least one of two</td><td data-v-2d34763c${_scopeId2}>Maximum cumulative value of payments within the period. Must be greater than <code data-v-2d34763c${_scopeId2}>Amount</code></td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>450.00</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PeriodicSchedule.Controls.MaximumCumulativeValueOfPaymentsPerPeriod.Currency</code></td><td data-v-2d34763c${_scopeId2}>At least one of two</td><td data-v-2d34763c${_scopeId2}>ISO 4217 currency code</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>AED</code></td></tr><tr data-v-2d34763c${_scopeId2}><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>PeriodicSchedule.Controls.MaximumCumulativeNumberOfPaymentsPerPeriod</code></td><td data-v-2d34763c${_scopeId2}>At least one of two</td><td data-v-2d34763c${_scopeId2}>Maximum number of payments within the period</td><td data-v-2d34763c${_scopeId2}><code data-v-2d34763c${_scopeId2}>3</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2d34763c${_scopeId2}> At least one of <code data-v-2d34763c${_scopeId2}>MaximumCumulativeValueOfPaymentsPerPeriod</code> or <code data-v-2d34763c${_scopeId2}>MaximumCumulativeNumberOfPaymentsPerPeriod</code> must be present inside <code data-v-2d34763c${_scopeId2}>PeriodicSchedule.Controls</code>. Both may be provided. When <code data-v-2d34763c${_scopeId2}>MaximumCumulativeValueOfPaymentsPerPeriod</code> is provided, it must be greater than <code data-v-2d34763c${_scopeId2}>Amount</code>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      ...
                      createTextVNode(". Both may be provided. When "),
                      createVNode("code", null, "MaximumCumulativeValueOfPaymentsPerPeriod"),
                      createTextVNode(" is provided, it must be greater than "),
                      createVNode("code", null, "Amount"),
                      createTextVNode(". ")
                    ])
                  ];
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-2d34763c${_scopeId}>Example request</h3>`);
            ...
            return [
              ...
              createVNode("h3", { class: "ed-doc__subhead" }, "ControlParameters — Fixed On-Demand"),
              createVNode(_component_EdProse, null, {
                default: withCtx(() => [
                  createVNode("code", null, "ControlParameters.ConsentSchedule.MultiPayment"),
                  createTextVNode(" carries the control definition. Set "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2d34763c${_scopeId2}> Save <code data-v-2d34763c${_scopeId2}>codeVerifier</code> in your server-side session or an <code data-v-2d34763c${_scopeId2}>httpOnly</code> cookie — you will need it in <a href="#step-8-post-token-authorization-code" data-v-2d34763c${_scopeId2}>Step 8</a> to exchange the authorization code for tokens. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/fapi/request-jwt" data-v-2d34763c${_scopeId2}>Preparing the Request JWT</a> for the full JWT claim reference and PKCE helpers. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-2d34763c${_scopeId2}>authorization_endpoint</code> is found in the LFI&#39;s <code data-v-2d34763c${_scopeId2}>.well-known/openid-configuration</code> — not constructed from the issuer URL directly. `);
                } else {
                  return [
                    createTextVNode(" The "),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-2d34763c${_scopeId2}>The TPP name and purpose.</li><li data-v-2d34763c${_scopeId2}>The fixed payment <code data-v-2d34763c${_scopeId2}>Amount</code> (e.g. &quot;AED 150.00 per payment&quot;).</li><li data-v-2d34763c${_scopeId2}>Any periodic caps (per-period count and value limits).</li><li data-v-2d34763c${_scopeId2}>Any lifetime cumulative caps.</li><li data-v-2d34763c${_scopeId2}>The consent expiry date.</li>`);
                } else {
                  return [
                    ...
                    createVNode("li", null, "Any periodic caps (per-period count and value limits)."),
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2d34763c${_scopeId2}> See <a href="./user-journeys" data-v-2d34763c${_scopeId2}>User Experience</a> for screen mockups of the Fixed On-Demand <strong data-v-2d34763c${_scopeId2}>Consent</strong> and <strong data-v-2d34763c${_scopeId2}>Authorization</strong> pages the user sees at the bank. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" See "),
                      createVNode("a", { href: "./user-journeys" }, "User Experience"),
                      createTextVNode(" for screen mockups of the Fixed On-Demand "),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-2d34763c${_scopeId}><span class="http-badge http-post" data-v-2d34763c${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-2d34763c${_scopeId}>/token</code></div>`);
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-2d34763c${_scopeId}><span class="http-badge http-post" data-v-2d34763c${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-2d34763c${_scopeId}>/payments</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Include <code data-v-2d34763c${_scopeId2}>x-fapi-interaction-id</code> and <code data-v-2d34763c${_scopeId2}>x-idempotency-key</code>. If the customer is present at this point in the flow, also send <code data-v-2d34763c${_scopeId2}>x-fapi-customer-ip-address</code>, <code data-v-2d34763c${_scopeId2}>x-customer-user-agent</code> and <code data-v-2d34763c${_scopeId2}>x-fapi-auth-date</code> if the customer has been authenticated. See <a href="/tech/tpp-standards/security/request-headers" data-v-2d34763c${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` This step can be called <strong data-v-2d34763c${_scopeId2}>multiple times</strong> under the same consent. Unlike Variable On-Demand, the <code data-v-2d34763c${_scopeId2}>Instruction.Amount</code> must exactly match the fixed <code data-v-2d34763c${_scopeId2}>Amount</code> defined in <code data-v-2d34763c${_scopeId2}>PeriodicSchedule</code> — the API Hub will reject any payment where the amount does not match. `);
                } else {
                  return [
                    createTextVNode(" This step can be called "),
                    createVNode("strong", null, "multiple times"),
                    createTextVNode(" under the same consent. Unlike Variable On-Demand, the "),
                    createVNode("code", null, "Instruction.Amount"),
                    createTextVNode(" must exactly match the fixed "),
                    createVNode("code", null, "Amount"),
                    createTextVNode(" defined in "),
                    createVNode("code", null, "PeriodicSchedule"),
                    createTextVNode(" — the API Hub will reject any payment where the amount does not match. ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2d34763c${_scopeId2}> Unlike Single Instant Payment, multi-payment consents do not require <code data-v-2d34763c${_scopeId2}>PaymentPurposeCode</code>, <code data-v-2d34763c${_scopeId2}>DebtorReference</code>, <code data-v-2d34763c${_scopeId2}>CreditorReference</code>, or <code data-v-2d34763c${_scopeId2}>OpenFinanceBilling</code> to match the consent exactly. Only <code data-v-2d34763c${_scopeId2}>ConsentId</code> must match the authorized consent. <code data-v-2d34763c${_scopeId2}>Instruction.Amount</code> must be within the parameters the consent allows for this payment type. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              type: "warning",
              title: "Fixed amount enforcement"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2d34763c${_scopeId2}> The API Hub will reject a payment if <code data-v-2d34763c${_scopeId2}>Instruction.Amount</code> does not exactly match the <code data-v-2d34763c${_scopeId2}>PeriodicSchedule.Amount</code> from the consent, or if any periodic or lifetime cumulative cap has already been reached. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" The API Hub will reject a payment if "),
                      createVNode("code", null, "Instruction.Amount"),
                      createTextVNode(" does not exactly match the "),
                      createVNode("code", null, "PeriodicSchedule.Amount"),
                      createTextVNode(" from the consent, or if any periodic or lifetime cumulative cap has already been reached. ")
                    ])
                  ];
                }
              }),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-2d34763c${_scopeId2}> After each successful payment, the consent remains in the <code data-v-2d34763c${_scopeId2}>Authorized</code> state (unless cumulative caps are reached or the consent expires). You do <strong data-v-2d34763c${_scopeId2}>not</strong> need to re-initiate the authorization flow. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/multi-payments/fixed-on-demand/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2d34763c"]]);
export {
  apiGuide as default
};
