...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/api-hub/consent-manager/open-api/psu-userId-consents.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const psuUserIdConsents = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  psuUserIdConsents as default
};
