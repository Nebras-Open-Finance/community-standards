...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-5a2bd230><section class="ed-doc__hero" data-v-5a2bd230><div class="ed-doc__inner" data-v-5a2bd230><div class="ed-doc__eyebrow" data-v-5a2bd230><span class="ed-doc__eyebrow-dash" data-v-5a2bd230></span> LFI · API Hub · Onboarding · Prerequisites </div><h1 class="ed-doc__title" data-v-5a2bd230> Prerequisites <span class="ed-doc__read" data-v-5a2bd230>4 min read</span></h1><p class="ed-doc__lede" data-v-5a2bd230> Before your API Hub can be provisioned, you MUST complete the prerequisites questionnaire via a Service Desk ticket. This page describes the information you will need to provide and why it is required. </p>`);
  _push(ssrRenderComponent(_component_EdNote, { type: "info" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p data-v-5a2bd230${_scopeId}> Ensure your organisation is registered in the Trust Framework before starting the prerequisites process. See <a href="/tech/lfi-api-hub/trust-framework/onboarding" data-v-5a2bd230${_scopeId}>Trust Framework Onboarding</a> for details. </p>`);
      } else {
        return [
          createVNode("p", null, [
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-5a2bd230${_scopeId2}><thead data-v-5a2bd230${_scopeId2}><tr data-v-5a2bd230${_scopeId2}><th data-v-5a2bd230${_scopeId2}>Field</th><th data-v-5a2bd230${_scopeId2}>Description</th></tr></thead><tbody data-v-5a2bd230${_scopeId2}><tr data-v-5a2bd230${_scopeId2}><td data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>LFI Legal Name</strong></td><td data-v-5a2bd230${_scopeId2}>Your legal name as it appears on your Trust Framework organisation page.</td></tr><tr data-v-5a2bd230${_scopeId2}><td data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>IBAN Bank Code</strong></td><td data-v-5a2bd230${_scopeId2}>The IBAN bank code for the brand associated with this onboarding. Not applicable for insurers.</td></tr><tr data-v-5a2bd230${_scopeId2}><td data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Primary Technical Contact (PTC)</strong></td><td data-v-5a2bd230${_scopeId2}>Email address of the main technical contact for integration queries.</td></tr><tr data-v-5a2bd230${_scopeId2}><td data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Primary Business Contact (PBC)</strong></td><td data-v-5a2bd230${_scopeId2}>Email address of the main business contact.</td></tr></tbody></table>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Your <strong data-v-5a2bd230${_scopeId2}>LFI Code</strong> is the short identifier that represents your institution across the API Hub. It is used in two places: `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Hostnames.</strong> It forms part of the URL for both the TPP-facing and LFI-facing domain names — including your API Hub&#39;s well-known discovery document URI. See <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/" data-v-5a2bd230${_scopeId2}>Environment Specific Configuration</a> for the full list of <code data-v-5a2bd230${_scopeId2}>auth1.{lfiCode}.*</code>, <code data-v-5a2bd230${_scopeId2}>rs1.{lfiCode}.*</code>, <code data-v-5a2bd230${_scopeId2}>hh.{lfiCode}.*</code>, <code data-v-5a2bd230${_scopeId2}>cm.{lfiCode}.*</code>, and <code data-v-5a2bd230${_scopeId2}>admin.{lfiCode}.*</code> hostnames. </li><li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>The <code data-v-5a2bd230${_scopeId2}>o3-provider-id</code> request header.</strong> Every request the API Hub forwards to your Ozone Connect endpoints carries <code data-v-5a2bd230${_scopeId2}>o3-provider-id</code> set to your LFI Code, so Ozone Connect can identify which Hub the call originated from. This matters most for <a href="/knowledge-base/articles/multi-segment-api-hubs" data-v-5a2bd230${_scopeId2}>multi-segment LFIs</a>. </li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(`<h3 data-v-5a2bd230${_scopeId}>Choosing a value</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Short</strong> — typically 3–8 characters. It will appear in every TPP integration and every URL.</li><li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Lowercase alphanumeric</strong> — no spaces, hyphens, underscores, or special characters (it must be DNS-safe).</li><li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Recognisable as your brand</strong> — usually an abbreviation of your legal or trading name.</li><li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Stable</strong> — once you go live, the LFI Code is effectively immutable. Changing it later means re-issuing every URL TPPs depend on, and is highly disruptive.</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(`<h3 data-v-5a2bd230${_scopeId}>Multi-brand institutions</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` If your institution operates multiple brands (e.g. retail and business), each brand will have its own API Hub and its own LFI Code, and each brand is onboarded separately. The common convention is to take your single-brand short code and append the segment as a single lowercase token — for example, FAB uses <code data-v-5a2bd230${_scopeId2}>fabretail</code> for its retail Hub and <code data-v-5a2bd230${_scopeId2}>fabbusiness</code> for its business Hub. See <a href="/knowledge-base/articles/multi-segment-api-hubs" data-v-5a2bd230${_scopeId2}>Multi-Segment LFIs</a> for the full deployment model. `);
            } else {
              return [
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h3 data-v-5a2bd230${_scopeId}>Hosting Environment</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-5a2bd230${_scopeId2}>Azure</li><li data-v-5a2bd230${_scopeId2}>AWS</li><li data-v-5a2bd230${_scopeId2}>OCI (Oracle Cloud Infrastructure)</li><li data-v-5a2bd230${_scopeId2}>GCP (Google Cloud Platform)</li><li data-v-5a2bd230${_scopeId2}>On-premises</li>`);
            } else {
              return [
        ...
        _push2(`<h3 data-v-5a2bd230${_scopeId}>Digital Channels</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-5a2bd230${_scopeId2}>Web</li><li data-v-5a2bd230${_scopeId2}>Mobile</li><li data-v-5a2bd230${_scopeId2}>Both</li>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Indicate whether you intend to adopt <strong data-v-5a2bd230${_scopeId2}>CAAP</strong> — the Nebras-operated Central Authentication and Authorization Platform — for the end user&#39;s authentication and consent authorisation experience. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Yes — CAAP.</strong> When a TPP creates a consent, the end user is redirected to CAAP for authentication and consent approval, and CAAP delivers the Consent Management Interface. You do not provide an Authorization Endpoint URL, and you do not implement the LFI-side Consent Management Interface or build directly against Headless Heimdall. You MUST implement the CAAP Operations endpoints on Ozone Connect — see <a href="/tech/lfi-api-hub/v2.1/caap/" data-v-5a2bd230${_scopeId2}>CAAP</a>.</li><li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>No — LFI-operated.</strong> The end user is redirected to your <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/auth-endpoint" data-v-5a2bd230${_scopeId2}>Authorization Endpoint</a>; you implement the <a href="/tech/lfi-api-hub/v2.1/consent-journey/authentication" data-v-5a2bd230${_scopeId2}>authentication and consent authorisation</a> UX and the <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/" data-v-5a2bd230${_scopeId2}>Consent Management Interface</a> yourself.</li>`);
            } else {
              return [
                createVNode("li", null, [
                  ...
                  createVNode("a", { href: "/tech/lfi-api-hub/v2.1/caap/" }, "CAAP"),
                  createTextVNode(".")
                ]),
                createVNode("li", null, [
                  ...
                  createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-journey/authentication" }, "authentication and consent authorisation"),
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-5a2bd230${_scopeId2}> Adopting CAAP does not change the LFI&#39;s responsibility to deliver the Ozone Connect endpoints for Bank Data Sharing, Bank Service Initiation, Insurance Data Sharing, and the other Open Finance services exposed to TPPs. </p>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Bank Data Sharing</strong> — account information, balances, transactions, and related data</li><li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Bank &amp; FX Service Initiation</strong> — payment initiation, including domestic transfers</li><li data-v-5a2bd230${_scopeId2}><strong data-v-5a2bd230${_scopeId2}>Consent Events &amp; Actions</strong> — consent lifecycle event notifications</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-5a2bd230${_scopeId2}>Insurance API families (e.g. Health, Motor, Travel) will be covered in a future update to this documentation.</p>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The following health check endpoints are <strong data-v-5a2bd230${_scopeId2}>mandatory</strong> for all LFI implementations: `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-5a2bd230${_scopeId2}><thead data-v-5a2bd230${_scopeId2}><tr data-v-5a2bd230${_scopeId2}><th data-v-5a2bd230${_scopeId2}>Endpoint</th><th data-v-5a2bd230${_scopeId2}>Description</th></tr></thead><tbody data-v-5a2bd230${_scopeId2}><tr data-v-5a2bd230${_scopeId2}><td data-v-5a2bd230${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/health-check/open-api/hello" class="endpoint" data-v-5a2bd230${_scopeId2}><span class="http-method http-method--get" data-v-5a2bd230${_scopeId2}>GET</span><code data-v-5a2bd230${_scopeId2}>/hello</code></a></td><td data-v-5a2bd230${_scopeId2}>Basic connectivity check.</td></tr><tr data-v-5a2bd230${_scopeId2}><td data-v-5a2bd230${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/health-check/open-api/hello-mtls" class="endpoint" data-v-5a2bd230${_scopeId2}><span class="http-method http-method--get" data-v-5a2bd230${_scopeId2}>GET</span><code data-v-5a2bd230${_scopeId2}>/hello-mtls</code></a></td><td data-v-5a2bd230${_scopeId2}>Verifies mutual TLS is correctly configured.</td></tr><tr data-v-5a2bd230${_scopeId2}><td data-v-5a2bd230${_scopeId2}><a href="/tech/lfi-api-hub/v2.1/health-check/open-api/echo-cert" class="endpoint" data-v-5a2bd230${_scopeId2}><span class="http-method http-method--get" data-v-5a2bd230${_scopeId2}>GET</span><code data-v-5a2bd230${_scopeId2}>/echo-cert</code></a></td><td data-v-5a2bd230${_scopeId2}>Returns the client certificate details received by your server, used to verify certificate propagation.</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
                  ...
                  createVNode("tbody", null, [
                    createVNode("tr", null, [
                      createVNode("td", null, [
                        createVNode("a", {
                          href: "/tech/lfi-api-hub/v2.1/health-check/open-api/hello",
                          class: "endpoint"
                        }, [
                    ...
                    createVNode("tr", null, [
                      createVNode("td", null, [
                        createVNode("a", {
                          href: "/tech/lfi-api-hub/v2.1/health-check/open-api/hello-mtls",
                          class: "endpoint"
                        }, [
                          createVNode("span", { class: "http-method http-method--get" }, "GET"),
                    ...
                    createVNode("tr", null, [
                      createVNode("td", null, [
                        createVNode("a", {
                          href: "/tech/lfi-api-hub/v2.1/health-check/open-api/echo-cert",
                          class: "endpoint"
                        }, [
                          createVNode("span", { class: "http-method http-method--get" }, "GET"),
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` These endpoints MUST be implemented and reachable before your integration can proceed to testing. See <a href="/tech/lfi-api-hub/v2.1/health-check/" data-v-5a2bd230${_scopeId2}>Ozone Connect — Health Check</a> for full API reference and usage. `);
            } else {
              return [
                createTextVNode(" These endpoints MUST be implemented and reachable before your integration can proceed to testing. See "),
                createVNode("a", { href: "/tech/lfi-api-hub/v2.1/health-check/" }, "Ozone Connect — Health Check"),
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<h3 data-v-5a2bd230${_scopeId}>Consent Pre-Validation</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-5a2bd230${_scopeId2}> Consent Pre-Validation is <strong data-v-5a2bd230${_scopeId2}>strongly recommended</strong> for all LFI implementations. Implementing this feature allows you to catch invalid consent parameters early — before the end user begins the authorization journey — resulting in a significantly better customer experience. This feature may become a <strong data-v-5a2bd230${_scopeId2}>mandatory requirement</strong> in a future version of the specification if adoption is insufficient. </p>`);
            } else {
              return [
                createVNode("p", null, [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` See <a href="/tech/lfi-api-hub/v2.1/consent-events/" data-v-5a2bd230${_scopeId2}>Consent Events &amp; Actions</a> for details. `);
            } else {
              return [
                createTextVNode(" See "),
                createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-events/" }, "Consent Events & Actions"),
                createTextVNode(" for details. ")
              ];
            }
          }),
        ...
        _push2(`<h3 data-v-5a2bd230${_scopeId}>Consent Event Notification</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(`<h3 data-v-5a2bd230${_scopeId}>Consent Augmentation</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Enables the <span class="endpoint" data-v-5a2bd230${_scopeId2}><span class="http-method http-method--post" data-v-5a2bd230${_scopeId2}>POST</span><code data-v-5a2bd230${_scopeId2}>/consent/action/augment</code></span> endpoint on your Ozone Connect implementation, which the API Hub calls to request an augmented consent payload during consent creation. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-5a2bd230${_scopeId2}> LFIs SHOULD NOT enable Consent Augmentation. Select <strong data-v-5a2bd230${_scopeId2}>No</strong> on the onboarding form unless Nebras has specifically advised you to enable it. The feature may be revisited in a future version of the specification. </p>`);
            } else {
              return [
                createVNode("p", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/api-hub/onboarding/prerequisites.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const prerequisites = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-5a2bd230"]]);
export {
