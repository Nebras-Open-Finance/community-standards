  ...
  <div class="ed-doc">
    ...
    >
      ...
      <EdNote type="warning" title="Delegated SCA requires a populated Risk block">
        ...
        <p>
          See the
          <a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/personal-identifiable-information/risk#delegated-sca-payment">Delegated
          SCA Payment example</a> for a fully-populated version and the
          <a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/personal-identifiable-information/risk">Risk
