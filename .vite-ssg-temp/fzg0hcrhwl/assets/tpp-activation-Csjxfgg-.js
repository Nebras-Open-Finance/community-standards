...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-daade55a><section class="ed-doc__hero" data-v-daade55a><div class="ed-doc__inner" data-v-daade55a><div class="ed-doc__eyebrow" data-v-daade55a><span class="ed-doc__eyebrow-dash" data-v-daade55a></span> LFI · API Hub · Admin Portal · TPP Management </div><h1 class="ed-doc__title" data-v-daade55a> TPP Management &amp; Activation <span class="ed-doc__read" data-v-daade55a>3 min read</span></h1><p class="ed-doc__lede" data-v-daade55a> The <strong data-v-daade55a>TPP Management</strong> section of the Admin Portal is where you manage all TPPs that have registered with your API Hub. It contains three sub-sections: <strong data-v-daade55a>TPP List</strong>, <strong data-v-daade55a>Software Statements</strong>, and <strong data-v-daade55a>Clients</strong>. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-daade55a> All three levels — TPP, software statement, and client — MUST be active for a TPP to make API requests. If any one of the three is blocked, the TPP&#39;s requests will be rejected. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-daade55a${_scopeId2}> You will see TPP entries for <strong data-v-daade55a${_scopeId2}>Nebras</strong> and <strong data-v-daade55a${_scopeId2}>Ozone</strong> with active clients against them. These are used internally to validate and monitor your API Hub — they MUST remain active. If any of these clients&#39; requests are causing issues, contact Nebras before blocking them. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The activation is done in three steps and <strong data-v-daade55a${_scopeId2}>MUST be performed in this order.</strong>`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-daade55a${_scopeId}>Step 1 — Activate the TPP</h3>`);
            ...
            _push2(`<h3 data-v-daade55a${_scopeId}>Step 2 — Activate the Software Statement</h3>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<h3 data-v-daade55a${_scopeId}>Step 3 — Activate the Client</h3>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-daade55a${_scopeId2}><strong data-v-daade55a${_scopeId2}>Block the client</strong> — immediately stops requests from that specific client</li><li data-v-daade55a${_scopeId2}><strong data-v-daade55a${_scopeId2}>Block the software statement</strong> — stops all clients under that software statement</li><li data-v-daade55a${_scopeId2}><strong data-v-daade55a${_scopeId2}>Block the TPP</strong> — stops all software statements and clients for the entire TPP organisation</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` To block, navigate to the relevant entity (TPP, software statement, or client), open its detail page, and click <strong data-v-daade55a${_scopeId2}>Block</strong>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` To restore access, open the blocked entity and click <strong data-v-daade55a${_scopeId2}>Activate</strong>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-daade55a${_scopeId2}> Do NOT block a TPP, software statement, or client without explicit instruction from Nebras. If you observe issues with a specific TPP&#39;s traffic, raise it with Nebras first. In cases where the Central Bank revokes a TPP&#39;s licence, Nebras will remove the TPP from the ecosystem centrally — no LFI action is required. </p>`);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/tpp-activation.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const tppActivation = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-daade55a"]]);
export {
