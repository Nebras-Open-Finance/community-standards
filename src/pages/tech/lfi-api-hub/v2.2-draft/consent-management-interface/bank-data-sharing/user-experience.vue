...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          LFI &middot; CMI &middot; Bank Data Sharing &middot; UX
        </div>
        ...
        <p class="ed-doc__lede">
          The LFI Consent Management Interface for Bank Data Sharing consents. Customers see all
          third party providers connected to their accounts, the data permissions they have
          granted, and can cancel a connection at any time.
        </p>
    ...
    <EdSectionBand
      ...
      title="LFI Connections &mdash; Data Sharing view"
      tone="cream"
    >
      <EdProse>
        The component below shows the LFI Connections page filtered to Data Sharing consents. Tap
        any consent card to open its details and manage it.
      </EdProse>

      <ClientOnly>
        <div class="ed-doc__previews">
          <figure class="ed-doc__preview">
            <ConsentManagementConnections mode="data-sharing" perspective="lfi" />
          </figure>
        </div>
      </ClientOnly>
      ...
      <ConsentConnectionsEditor mode="data-sharing" />
    </EdSectionBand>
