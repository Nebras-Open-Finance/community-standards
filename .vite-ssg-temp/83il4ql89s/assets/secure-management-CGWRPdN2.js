...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-e5ad4b1f>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e5ad4b1f${_scopeId2}>Generation, storage, use, rotation, revocation, and destruction of cryptographic keys and credentials</li><li data-v-e5ad4b1f${_scopeId2}>Authentication, authorization, and token handling in Open Finance APIs and consent flows</li><li data-v-e5ad4b1f${_scopeId2}>Integration with <strong data-v-e5ad4b1f${_scopeId2}>Key Management Systems (KMS)</strong>, <strong data-v-e5ad4b1f${_scopeId2}>Hardware Security Modules (HSMs)</strong>, and other cryptographic infrastructure</li><li data-v-e5ad4b1f${_scopeId2}>Roles and responsibilities for LFIs, TPPs, and ecosystem participants</li>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-e5ad4b1f${_scopeId}>Key requirements</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e5ad4b1f${_scopeId2}><strong data-v-e5ad4b1f${_scopeId2}>Key lifecycle management</strong> — secure generation, storage, distribution, rotation, revocation, and destruction</li><li data-v-e5ad4b1f${_scopeId2}><strong data-v-e5ad4b1f${_scopeId2}>Protection of sensitive material</strong> — secret and private keys must be protected against unauthorized access, loss, or disclosure</li><li data-v-e5ad4b1f${_scopeId2}><strong data-v-e5ad4b1f${_scopeId2}>Auditing and logging</strong> — all key usage and lifecycle activities must be logged and auditable</li><li data-v-e5ad4b1f${_scopeId2}><strong data-v-e5ad4b1f${_scopeId2}>Certification and revocation</strong> — procedures to maintain trust across ecosystem participants</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`LFIs and TPPs must implement these controls to ensure <strong data-v-e5ad4b1f${_scopeId2}>confidentiality, integrity, and availability</strong> of Open Finance systems.`);
                } else {
                  return [
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-e5ad4b1f${_scopeId3}>Use <strong data-v-e5ad4b1f${_scopeId3}>FIPS 140-3 certified HSMs</strong> for key generation, signing, encryption, and storage. Ensure centralized key management using modern <strong data-v-e5ad4b1f${_scopeId3}>KMS</strong> (on-premises or cloud) that supports UAE data governance and local control principles, such as data residency and access controls.</p>`);
                      } else {
                        return [
                          createVNode("p", null, [
                            createTextVNode("Use "),
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-e5ad4b1f${_scopeId3}>Rotate transport and signing keys at least <strong data-v-e5ad4b1f${_scopeId3}>every 13 months</strong> or more frequently if mandated. Define clear policies for key <strong data-v-e5ad4b1f${_scopeId3}>expiration, recovery, and destruction</strong>. Maintain <strong data-v-e5ad4b1f${_scopeId3}>audit logs</strong> of all key usage.</p>`);
                      } else {
                        return [
                          createVNode("p", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-e5ad4b1f${_scopeId3}>Use phishing-resistant, modern authentication methods:</p>`);
                        _push4(ssrRenderComponent(_component_EdBullets, { tight: "" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<li data-v-e5ad4b1f${_scopeId4}><strong data-v-e5ad4b1f${_scopeId4}>FIDO2 / Passkeys</strong> for customer authentication</li><li data-v-e5ad4b1f${_scopeId4}><strong data-v-e5ad4b1f${_scopeId4}>OAuth 2.0 + FAPI 2.0</strong> for secure API access</li><li data-v-e5ad4b1f${_scopeId4}><strong data-v-e5ad4b1f${_scopeId4}>Mutual TLS (mTLS)</strong> for client-server authentication</li>`);
                            } else {
                              return [
                                createVNode("li", null, [
                        ...
                        _push4(`<p data-v-e5ad4b1f${_scopeId3}>Ensure secure handling of <strong data-v-e5ad4b1f${_scopeId3}>credentials and tokens</strong> throughout consent and API flows.</p>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-e5ad4b1f${_scopeId3}>Implement <strong data-v-e5ad4b1f${_scopeId3}>role-based access control (RBAC)</strong> and <strong data-v-e5ad4b1f${_scopeId3}>separation of duties</strong> for key access. Limit key access to <strong data-v-e5ad4b1f${_scopeId3}>authorized personnel and system components only</strong>.</p>`);
                      } else {
                        return [
                          createVNode("p", null, [
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-e5ad4b1f${_scopeId3}>LFIs may use <strong data-v-e5ad4b1f${_scopeId3}>Bring Your Own Key (BYOK)</strong> or <strong data-v-e5ad4b1f${_scopeId3}>Manage Your Own Key (MYOK)</strong> strategies to maintain control over sensitive key material while leveraging cloud infrastructure.</p>`);
                      } else {
                        return [
                          createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e5ad4b1f${_scopeId2}>Protect user and organizational data</li><li data-v-e5ad4b1f${_scopeId2}>Maintain regulatory compliance</li><li data-v-e5ad4b1f${_scopeId2}>Enable secure, consented financial data sharing</li><li data-v-e5ad4b1f${_scopeId2}>Foster trust and resilience across the Open Finance ecosystem</li>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-refs" data-v-e5ad4b1f${_scopeId}><!--[-->`);
            ssrRenderList(references, (r, i) => {
              _push2(`<a${ssrRenderAttr("href", r.href)} target="_blank" rel="noopener" class="ed-ref" data-v-e5ad4b1f${_scopeId}><span class="ed-ref__num" data-v-e5ad4b1f${_scopeId}>${ssrInterpolate(String(i + 1).padStart(2, "0"))}</span><span class="ed-ref__body" data-v-e5ad4b1f${_scopeId}><span class="ed-ref__title" data-v-e5ad4b1f${_scopeId}>${ssrInterpolate(r.title)}</span><span class="ed-ref__desc" data-v-e5ad4b1f${_scopeId}>${ssrInterpolate(r.desc)}</span></span><span class="ed-ref__arrow" data-v-e5ad4b1f${_scopeId}>↗</span></a>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
...
const secureManagement = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e5ad4b1f"]]);
export {
