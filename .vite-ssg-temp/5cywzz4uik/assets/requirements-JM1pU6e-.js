  ...
  sections: [
    {
      ...
      rules: [
        ...
        { field: "<code>consent.ControlParameters.ConsentSchedule.MultiPayment.PeriodicSchedule.Type</code>", rule: 'Must be <code>"VariableOnDemand"</code>. <code>SinglePayment</code> and <code>FilePayment</code> must not be present.', validatedBy: "API Hub" },
        { field: "<code>consent.ControlParameters.ConsentSchedule.MultiPayment.PeriodicSchedule.Controls</code>", rule: "At least one of <code>MaximumIndividualAmount</code>, <code>MaximumCumulativeNumberOfPaymentsPerPeriod</code>, or <code>MaximumCumulativeValueOfPaymentsPerPeriod</code> must be provided.", validatedBy: "API Hub" },
        { field: "<code>MaximumIndividualAmount</code>", rule: "If set, <code>MaximumIndividualAmount.Currency</code> must be set to <code>AED</code>.", validatedBy: "API Hub" },
        { field: "<code>MaximumCumulativeValueOfPaymentsPerPeriod</code>", rule: "If set, <code>MaximumCumulativeValueOfPaymentsPerPeriod.Currency</code> must be set to <code>AED</code>.", validatedBy: "API Hub" },
        { field: "<code>consent.ControlParameters.ConsentSchedule.MultiPayment.PeriodicSchedule.PeriodStartDate</code>", rule: "If provided, must not be in the past. Must not be after <code>consent.ExpirationDateTime</code>.", validatedBy: "API Hub" },
        { field: "<code>MaximumCumulativeValueOfPayments</code>", rule: "If set, <code>MaximumCumulativeValueOfPayments.Currency</code> must be set to <code>AED</code>.", validatedBy: "API Hub" },
        { field: "Consent (unsupported)", rule: 'The LFI must advertise Variable On Demand as supported for the requested beneficiary model via the corresponding flag on its authorisation server entry in the <a href="/tech/tpp-standards/trust-framework/api-discovery">Trust Framework</a>: <code>ApiMetadata.VariableOnDemand.SingleBeneficiarySupported</code> (exactly 1 creditor entry), <code>ApiMetadata.VariableOnDemand.MultipleBeneficiariesSupported</code> (2–10 entries), or <code>ApiMetadata.VariableOnDemand.OpenBeneficiariesSupported</code> (<code>Initiation.Creditor</code> omitted). If the payment type is not supported for the requested beneficiary model, the consent validation will fail.', validatedBy: "LFI (/consent/action/validate)" },
    ...
    },
    {
      ...
      rules: [
        ...
        { field: "<code>MaximumIndividualAmount</code>", rule: "If set on the consent, <code>Data.Instruction.Amount.Amount</code> must be ≤ <code>MaximumIndividualAmount.Amount</code>.", validatedBy: "API Hub" },
        { field: "<code>MaximumIndividualAmount</code>", rule: "If set on the consent, <code>Data.Instruction.Amount.Currency</code> must exactly match <code>MaximumIndividualAmount.Currency</code>.", validatedBy: "API Hub" },
        { field: "<code>MaximumCumulativeNumberOfPaymentsPerPeriod</code>", rule: "If set on the consent, the payment must not cause the count of payments in the current period to exceed <code>MaximumCumulativeNumberOfPaymentsPerPeriod</code>.", validatedBy: "API Hub" },
        { field: "<code>MaximumCumulativeValueOfPaymentsPerPeriod</code>", rule: "If set on the consent, the payment must not cause the value of payments in the current period to exceed <code>MaximumCumulativeValueOfPaymentsPerPeriod.Amount</code>.", validatedBy: "API Hub" },
        { field: "<code>MaximumCumulativeValueOfPaymentsPerPeriod</code>", rule: "If set on the consent, <code>Data.Instruction.Amount.Currency</code> must exactly match <code>MaximumCumulativeValueOfPaymentsPerPeriod.Currency</code>.", validatedBy: "API Hub" },
        ...
        { field: "<code>PersonalIdentifiableInformation</code> (Creditor)", rule: 'Depends on the beneficiary model set at consent time. <strong>Single beneficiary</strong> (<code>Initiation.Creditor[]</code> had 1 entry at consent time): the submitted creditor must exactly match that consent-time entry. <strong>Multiple beneficiaries</strong> (2–10 entries): the submitted creditor must exactly match one entry from the pre-approved consent-time list. <strong>Open beneficiary</strong> (<code>Initiation.Creditor[]</code> omitted at consent): no consent-time match — the submitted creditor must independently satisfy the <a href="/tech/tpp-standards/v2.2-rc1/banking/service-initiation/personal-identifiable-information/creditor#validation-requirement">creditor field validation requirements</a> (mandatory fields, valid UAE IBAN, and BIC derivation rules) and must be a valid UAE domestic creditor reachable on AANI or UAEFTS. See <a href="/tech/tpp-standards/v2.2-rc1/banking/service-initiation/personal-identifiable-information/creditor">Creditor</a>.', validatedBy: "LFI" },
        { field: "<code>x-fapi-interaction-id</code>", rule: "Should be included. Should be a valid UUID (RFC 4122). An invalid value will not cause a failure but tracing will not be possible.", validatedBy: "N/A" },
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-req" }, _attrs))} data-v-c42dd155><section class="ed-req-hero" data-v-c42dd155><div class="ed-req-hero__inner" data-v-c42dd155><div class="ed-req-hero__label" data-v-c42dd155><span class="ed-req-hero__label-dash" data-v-c42dd155></span> ${ssrInterpolate(unref(eyebrow))}</div><h1 class="ed-req-hero__title" data-v-c42dd155>${ssrInterpolate(unref(data).title)} `);
      if (unref(data).version) {
        _push(`<span class="ed-req-hero__badge" data-v-c42dd155>${ssrInterpolate(unref(data).version)}</span>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(data).readTime) {
        _push(`<span class="ed-req-hero__read" data-v-c42dd155>${ssrInterpolate(unref(data).readTime)} read</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</h1><p class="ed-req-hero__sub" data-v-c42dd155>${unref(data).lede ?? ""}</p>`);
      if (unref(data).preconditions) {
        _push(`<p class="ed-req-hero__sub ed-req-hero__sub--tight" data-v-c42dd155>${unref(data).preconditions ?? ""}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></section><!--[-->`);
      ssrRenderList(unref(data).sections, (s, i) => {
        _push(ssrRenderComponent(_component_EdSectionBand, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (s.method && s.path) {
                _push2(`<div class="ed-req-endpoint" data-v-c42dd155${_scopeId}><span class="${ssrRenderClass([methodClass(s.method), "http-badge"])}" data-v-c42dd155${_scopeId}>${ssrInterpolate(s.method)}</span><code class="ed-req-endpoint__path" data-v-c42dd155${_scopeId}>${ssrInterpolate(s.path)}</code></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--[-->`);
              ssrRenderList(s.callouts || [], (c, ci) => {
                _push2(`<div class="${ssrRenderClass([`ed-req-callout--${c.kind}`, "ed-req-callout"])}" data-v-c42dd155${_scopeId}>`);
                if (c.title) {
                  _push2(`<div class="ed-req-callout__title" data-v-c42dd155${_scopeId}>${ssrInterpolate(c.title)}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<div class="ed-req-callout__body" data-v-c42dd155${_scopeId}>${c.html ?? ""}</div></div>`);
              });
              _push2(`<!--]--><!--[-->`);
              ssrRenderList(s.blocks || [], (b, bi) => {
                _push2(`<!--[-->`);
                if (b.kind === "prose") {
                  _push2(`<p class="ed-req-intro" data-v-c42dd155${_scopeId}>${b.html ?? ""}</p>`);
                } else if (b.kind === "table") {
                  _push2(`<div class="ed-req-table ed-req-table--generic" role="table"${ssrRenderAttr("aria-label", s.title)} style="${ssrRenderStyle({ gridTemplateColumns: genericGridTemplate(b.table.headers) })}" data-v-c42dd155${_scopeId}><div class="ed-req-row ed-req-row--head" role="row" data-v-c42dd155${_scopeId}><!--[-->`);
                  ssrRenderList(b.table.headers, (h, hi) => {
                    _push2(`<div class="ed-req-cell" role="columnheader" data-v-c42dd155${_scopeId}>${ssrInterpolate(h)}</div>`);
                  });
                  _push2(`<!--]--></div><!--[-->`);
                  ssrRenderList(b.table.rows, (r, ri) => {
                    _push2(`<div class="ed-req-row" role="row" data-v-c42dd155${_scopeId}><!--[-->`);
                    ssrRenderList(r.cells, (c, ci) => {
                      _push2(`<div class="ed-req-cell ed-req-cell--generic" role="cell" data-v-c42dd155${_scopeId}>${c ?? ""}</div>`);
                    });
                    _push2(`<!--]--></div>`);
                  });
                  _push2(`<!--]--></div>`);
              ...
              if (s.rules && s.rules.length) {
                _push2(`<div class="ed-req-table" role="table"${ssrRenderAttr("aria-label", s.title)} data-v-c42dd155${_scopeId}><div class="ed-req-row ed-req-row--head" role="row" data-v-c42dd155${_scopeId}><div class="ed-req-cell ed-req-cell--num" role="columnheader" data-v-c42dd155${_scopeId}>#</div><div class="ed-req-cell ed-req-cell--field" role="columnheader" data-v-c42dd155${_scopeId}>Field</div><div class="ed-req-cell ed-req-cell--rule" role="columnheader" data-v-c42dd155${_scopeId}>Rule</div><div class="ed-req-cell ed-req-cell--validator" role="columnheader" data-v-c42dd155${_scopeId}>Validated by</div></div><!--[-->`);
                ssrRenderList(s.rules, (r, idx) => {
                  _push2(`<div class="ed-req-row" role="row" data-v-c42dd155${_scopeId}><div class="ed-req-cell ed-req-cell--num" role="cell" data-v-c42dd155${_scopeId}>${ssrInterpolate(idx + 1)}</div><div class="ed-req-cell ed-req-cell--field" role="cell" data-v-c42dd155${_scopeId}>${r.field ?? ""}</div><div class="ed-req-cell ed-req-cell--rule" role="cell" data-v-c42dd155${_scopeId}>${r.rule ?? ""}</div><div class="ed-req-cell ed-req-cell--validator" role="cell" data-v-c42dd155${_scopeId}><span class="${ssrRenderClass([validatorClass(r.validatedBy), "ed-req-validator"])}" data-v-c42dd155${_scopeId}><span class="ed-req-validator__label" data-v-c42dd155${_scopeId}>${ssrInterpolate(splitValidator(r.validatedBy).label)}</span>`);
                  if (splitValidator(r.validatedBy).detail) {
                    _push2(`<span class="ed-req-validator__detail" data-v-c42dd155${_scopeId}>${ssrInterpolate(splitValidator(r.validatedBy).detail)}</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</span></div></div>`);
              ...
              if (s.table) {
                _push2(`<div class="ed-req-table ed-req-table--generic" role="table"${ssrRenderAttr("aria-label", s.title)} style="${ssrRenderStyle({ gridTemplateColumns: genericGridTemplate(s.table.headers) })}" data-v-c42dd155${_scopeId}><div class="ed-req-row ed-req-row--head" role="row" data-v-c42dd155${_scopeId}><!--[-->`);
              ...
              ssrRenderList(s.subsections || [], (sub, si) => {
                _push2(`<div class="ed-req-sub" data-v-c42dd155${_scopeId}><h3 class="ed-req-sub__heading" data-v-c42dd155${_scopeId}>${ssrInterpolate(sub.heading)}</h3><!--[-->`);
                ...
                ssrRenderList(sub.blocks || [], (b, bi) => {
                  _push2(`<!--[-->`);
                  if (b.kind === "prose") {
                    _push2(`<p class="ed-req-sub__intro" data-v-c42dd155${_scopeId}>${b.html ?? ""}</p>`);
                  } else if (b.kind === "table") {
                    _push2(`<div class="ed-req-table ed-req-table--generic ed-req-table--sub" role="table"${ssrRenderAttr("aria-label", sub.heading)} style="${ssrRenderStyle({ gridTemplateColumns: genericGridTemplate(b.table.headers) })}" data-v-c42dd155${_scopeId}><div class="ed-req-row ed-req-row--head" role="row" data-v-c42dd155${_scopeId}><!--[-->`);
                    ssrRenderList(b.table.headers, (h, hi) => {
                      _push2(`<div class="ed-req-cell" role="columnheader" data-v-c42dd155${_scopeId}>${ssrInterpolate(h)}</div>`);
                    });
                    _push2(`<!--]--></div><!--[-->`);
                ...
                ssrRenderList(sub.subsections || [], (sub2, s2i) => {
                  _push2(`<div class="ed-req-sub ed-req-sub--nested" data-v-c42dd155${_scopeId}><h4 class="ed-req-sub__heading ed-req-sub__heading--nested" data-v-c42dd155${_scopeId}>${ssrInterpolate(sub2.heading)}</h4><!--[-->`);
                  ...
                  ssrRenderList(sub2.blocks || [], (b, bi) => {
                    ...
                    if (b.kind === "prose") {
                      ...
                      _push2(`<div class="ed-req-table ed-req-table--generic ed-req-table--sub" role="table"${ssrRenderAttr("aria-label", sub2.heading)} style="${ssrRenderStyle({ gridTemplateColumns: genericGridTemplate(b.table.headers) })}" data-v-c42dd155${_scopeId}><div class="ed-req-row ed-req-row--head" role="row" data-v-c42dd155${_scopeId}><!--[-->`);
                      ssrRenderList(b.table.headers, (h, hi) => {
                        _push2(`<div class="ed-req-cell" role="columnheader" data-v-c42dd155${_scopeId}>${ssrInterpolate(h)}</div>`);
                      });
                      _push2(`<!--]--></div><!--[-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/variable-on-demand/requirements.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const requirements = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c42dd155"]]);
export {
