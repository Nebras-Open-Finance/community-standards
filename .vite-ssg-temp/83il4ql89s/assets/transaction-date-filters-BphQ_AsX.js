...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-d184849d>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-d184849d${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-d184849d${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
      ...
      _push(`<div class="ed-page__intro" data-v-d184849d>`);
      _push(ssrRenderComponent(_component_EdProse, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Both list endpoints take an optional, open-ended date range. <code data-v-d184849d${_scopeId}>GET /accounts/{accountId}/transactions</code> uses <code data-v-d184849d${_scopeId}>fromBookingDateTime</code> / <code data-v-d184849d${_scopeId}>toBookingDateTime</code>; <code data-v-d184849d${_scopeId}>GET /accounts/{accountId}/statements</code> uses <code data-v-d184849d${_scopeId}>fromStatementDate</code> / <code data-v-d184849d${_scopeId}>toStatementDate</code>. The behaviour is identical — the examples below use transactions. `);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Both parameters are optional. They narrow the result to transactions booked <strong data-v-d184849d${_scopeId2}>on or after</strong> <code data-v-d184849d${_scopeId2}>fromBookingDateTime</code> and <strong data-v-d184849d${_scopeId2}>on or before</strong> <code data-v-d184849d${_scopeId2}>toBookingDateTime</code>; omit either bound for an open-ended range. A well-formed range is always accepted — <strong data-v-d184849d${_scopeId2}>even when it matches nothing</strong>. In particular, the following are valid requests, not errors: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-d184849d${_scopeId2}>a range reaching <strong data-v-d184849d${_scopeId2}>beyond two years</strong> into the past — the LFI returns the records it holds, and <strong data-v-d184849d${_scopeId2}>MAY</strong> return records older than two years where it has them;</li><li data-v-d184849d${_scopeId2}>a <strong data-v-d184849d${_scopeId2}>quiet period</strong> with no activity;</li><li data-v-d184849d${_scopeId2}>a <code data-v-d184849d${_scopeId2}>fromBookingDateTime</code> set <strong data-v-d184849d${_scopeId2}>in the future</strong> or later than any booked transaction — coherent, it simply matches nothing.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` In each of these cases the response is <code data-v-d184849d${_scopeId2}>200</code> with the matching subset in <code data-v-d184849d${_scopeId2}>data</code> — an empty array where nothing matches. A <code data-v-d184849d${_scopeId2}>404</code><strong data-v-d184849d${_scopeId2}>MUST NOT</strong> be used to signal &quot;no transactions in range&quot;. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <strong data-v-d184849d${_scopeId2}>API Hub</strong> validates the date range before proxying the request to the LFI. It returns <code data-v-d184849d${_scopeId2}>400</code> with <code data-v-d184849d${_scopeId2}>Resource.InvalidFormat</code> in three cases: `);
                } else {
                  return [
                    createTextVNode(" The "),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-d184849d${_scopeId2}>a date-time parameter <strong data-v-d184849d${_scopeId2}>cannot be parsed</strong>;</li><li data-v-d184849d${_scopeId2}>the range is <strong data-v-d184849d${_scopeId2}>contradictory</strong> — <code data-v-d184849d${_scopeId2}>fromBookingDateTime</code> is after <code data-v-d184849d${_scopeId2}>toBookingDateTime</code>;</li><li data-v-d184849d${_scopeId2}><code data-v-d184849d${_scopeId2}>toBookingDateTime</code> is <strong data-v-d184849d${_scopeId2}>in the future</strong> — an upper bound on when a transaction was booked cannot lie past the current moment.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Note the asymmetry: only the <strong data-v-d184849d${_scopeId2}>upper</strong> bound is checked against the clock. A future <code data-v-d184849d${_scopeId2}>fromBookingDateTime</code> is coherent — it just matches nothing — so it is accepted and returns <code data-v-d184849d${_scopeId2}>200</code>. The identical three checks apply to <code data-v-d184849d${_scopeId2}>fromStatementDate</code> / <code data-v-d184849d${_scopeId2}>toStatementDate</code> on the statements endpoint. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-d184849d${_scopeId2}><strong data-v-d184849d${_scopeId2}>Filter</strong> to transactions whose booking date-time falls within the supplied bounds, then apply pagination — so <code data-v-d184849d${_scopeId2}>meta.totalRecords</code> and <code data-v-d184849d${_scopeId2}>meta.totalPages</code> describe the filtered set.</li><li data-v-d184849d${_scopeId2}><strong data-v-d184849d${_scopeId2}>Ignore any timezone offset</strong> on the supplied values — compare the wall-clock date-time as given.</li><li data-v-d184849d${_scopeId2}>Make <strong data-v-d184849d${_scopeId2}>at least two years</strong> of history available; you <strong data-v-d184849d${_scopeId2}>MAY</strong> hold and return more. The two-year figure is a minimum availability floor, not a query limit.</li><li data-v-d184849d${_scopeId2}>Return <code data-v-d184849d${_scopeId2}>200</code> with the matching subset — an <strong data-v-d184849d${_scopeId2}>empty <code data-v-d184849d${_scopeId2}>data</code> array</strong> where nothing matches. Never <code data-v-d184849d${_scopeId2}>404</code>.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
...
const transactionDateFilters = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d184849d"]]);
export {
