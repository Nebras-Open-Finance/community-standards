...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const cards = [
      {
        href: "/tech/lfi-api-hub/v2.1/caap/user-experience",
        cat: "User Experience",
        color: "var(--at-gold)",
      ...
      {
        href: "/tech/lfi-api-hub/v2.1/caap/api-guide",
        cat: "API Guide",
        color: "var(--at-teal)",
        title: "API Guide",
      ...
      {
        href: "/tech/lfi-api-hub/v2.1/caap/pricing",
        cat: "Pricing",
        color: "var(--at-navy)",
        title: "Pricing",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-68b956bb><section class="ed-doc__hero" data-v-68b956bb><div class="ed-doc__inner" data-v-68b956bb><div class="ed-doc__eyebrow" data-v-68b956bb><span class="ed-doc__eyebrow-dash" data-v-68b956bb></span> LFI · CAAP </div><h1 class="ed-doc__title" data-v-68b956bb> Central Authentication and Authorization Platform <span class="ed-doc__read" data-v-68b956bb>3 min read</span></h1><p class="ed-doc__lede" data-v-68b956bb><strong data-v-68b956bb>CAAP</strong> is a Nebras-operated platform that handles the customer-facing authentication and consent authorisation experience on behalf of an LFI. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Adopting CAAP removes two substantial pieces of Open Finance delivery from the LFI&#39;s scope. The documentation for these areas remains in this site for LFIs that operate their own implementations, but is <strong data-v-68b956bb${_scopeId2}>not applicable</strong> if you adopt CAAP: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-68b956bb${_scopeId2}><thead data-v-68b956bb${_scopeId2}><tr data-v-68b956bb${_scopeId2}><th data-v-68b956bb${_scopeId2}>Capability</th><th data-v-68b956bb${_scopeId2}>Who delivers it without CAAP</th><th data-v-68b956bb${_scopeId2}>Who delivers it with CAAP</th></tr></thead><tbody data-v-68b956bb${_scopeId2}><tr data-v-68b956bb${_scopeId2}><td data-v-68b956bb${_scopeId2}><strong data-v-68b956bb${_scopeId2}>Authentication and consent authorisation UX</strong></td><td data-v-68b956bb${_scopeId2}>LFI — see <a href="/tech/lfi-api-hub/v2.1/consent-journey/authentication" data-v-68b956bb${_scopeId2}>Consent Journey → Authentication</a> and <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/auth-endpoint" data-v-68b956bb${_scopeId2}>Authorization Endpoint</a>.</td><td data-v-68b956bb${_scopeId2}>CAAP</td></tr><tr data-v-68b956bb${_scopeId2}><td data-v-68b956bb${_scopeId2}><strong data-v-68b956bb${_scopeId2}>Consent Management Interface</strong></td><td data-v-68b956bb${_scopeId2}>LFI — see <a href="/tech/lfi-api-hub/v2.1/consent-management-interface/" data-v-68b956bb${_scopeId2}>Consent Management Interface</a>.</td><td data-v-68b956bb${_scopeId2}>CAAP</td></tr><tr data-v-68b956bb${_scopeId2}><td data-v-68b956bb${_scopeId2}><strong data-v-68b956bb${_scopeId2}>Headless Heimdall and Consent Manager integration</strong></td><td data-v-68b956bb${_scopeId2}>LFI — see <a href="/tech/lfi-api-hub/v2.1/api-hub/headless-heimdall/" data-v-68b956bb${_scopeId2}>Headless Heimdall</a> and <a href="/tech/lfi-api-hub/v2.1/api-hub/consent-manager/" data-v-68b956bb${_scopeId2}>Consent Manager</a>.</td><td data-v-68b956bb${_scopeId2}>CAAP</td></tr></tbody></table>`);
                } else {
                  return [
                      ...
                      createVNode("tbody", null, [
                        createVNode("tr", null, [
                          ...
                          createVNode("td", null, [
                            ...
                            createVNode("a", { href: "/tech/lfi-api-hub/v2.1/consent-journey/authentication" }, "Consent Journey → Authentication"),
                            createTextVNode(" and "),
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-68b956bb${_scopeId2}> The LFI MUST still implement its Ozone Connect endpoints for <a href="/tech/lfi-api-hub/v2.1/banking/data-sharing/" data-v-68b956bb${_scopeId2}>Bank Data Sharing</a>, <a href="/tech/lfi-api-hub/v2.1/banking/service-initiation/" data-v-68b956bb${_scopeId2}>Bank Service Initiation</a>, <a href="/tech/lfi-api-hub/v2.1/insurance/" data-v-68b956bb${_scopeId2}>Insurance Data Sharing</a>, and the other Ozone Connect APIs. CAAP handles authentication and consent, not data and payments. In addition, the LFI MUST implement the CAAP Operations APIs documented in this section so that CAAP can drive end user verification, registration, PII decryption, and consent validation against the LFI&#39;s own systems of record. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
      ...
      _push(`<section class="ed-doc__cards" data-v-68b956bb><div class="ed-doc__inner" data-v-68b956bb><div class="ed-doc__cards-head" data-v-68b956bb><div class="ed-doc__cards-eyebrow" data-v-68b956bb><span class="ed-doc__eyebrow-dash" data-v-68b956bb></span> Browse this section </div><h2 class="ed-doc__cards-title" data-v-68b956bb>Where to go next</h2></div><div class="ed-doc__cards-grid" data-v-68b956bb><!--[-->`);
      ssrRenderList(cards, (card) => {
        _push(`<a class="ed-link-card"${ssrRenderAttr("href", card.href)} style="${ssrRenderStyle({ "--card-color": card.color })}" data-v-68b956bb><span class="ed-link-card__top" data-v-68b956bb></span><div class="ed-link-card__meta" data-v-68b956bb><span class="ed-link-card__cat" data-v-68b956bb>${ssrInterpolate(card.cat)}</span></div><h3 class="ed-link-card__title" data-v-68b956bb>${ssrInterpolate(card.title)}</h3><p class="ed-link-card__desc" data-v-68b956bb>${card.desc ?? ""}</p><div class="ed-link-card__foot" data-v-68b956bb><span class="ed-link-card__cta" data-v-68b956bb>Open</span><span class="ed-link-card__arrow" data-v-68b956bb>→</span></div></a>`);
      });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/caap/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-68b956bb"]]);
export {
  index as default
};
