...
const capabilities: { title: string; html: string }[] = [
  ...
  },
  {
    ...
    html: 'Each quote request specifies a <code>QuoteType</code> of <code>New</code>, <code>Renewal</code> (the customer is renewing an existing policy with you), or <code>Switch</code> (the customer is moving from an incumbent insurer). See <a href="/tech/lfi-api-hub/v2.2-draft/insurance/quotation/quote-types">Quote Types</a> for the per-type validation differences.',
  },
  {
    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a
            class="ed-link-card"
            href="/tech/lfi-api-hub/v2.2-draft/insurance/quotation/requirements"
          ...
          <a
            class="ed-link-card"
            href="/tech/lfi-api-hub/v2.2-draft/insurance/quotation/api-guide/"
          ...
          <a
            class="ed-link-card"
            href="/tech/lfi-api-hub/v2.2-draft/insurance/quotation/user-journeys"
