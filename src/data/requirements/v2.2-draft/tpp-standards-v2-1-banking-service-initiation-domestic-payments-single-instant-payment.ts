  ...
  sections: [
    {
      ...
      rules: [
        ...
        { field: '<code>consent.PersonalIdentifiableInformation</code>', rule: 'The decrypted PII payload must conform exactly to the <a href="/tech/tpp-standards/v2.2-draft/banking/service-initiation/personal-identifiable-information/api-schema/pii-par">Domestic Payment PII Schema Object (<code>POST /par</code>)</a>. All required properties must be present with values of the correct type, and no additional or undocumented properties are permitted (<code>additionalProperties: false</code>).', validatedBy: 'LFI (/consent/action/validate)' },
