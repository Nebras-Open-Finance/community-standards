...
import { fixedOnDemandArea as area } from '@/data/functional-certification/multi-payments'

const explainerPath =
  '/tech/lfi-api-hub/production/testing-certification/functional/fixed-on-demand'
</script>
    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          Functional Certification &middot; Fixed On-Demand
        </div>
