...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-18a31e57>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-18a31e57${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-18a31e57${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_EdNote, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-18a31e57${_scopeId}>These endpoints accept raw private key material. They exist <strong data-v-18a31e57${_scopeId}>exclusively in the sandbox</strong> environment and are <strong data-v-18a31e57${_scopeId}>not available in production</strong>. Never send a production private key to any external service.</p>`);
          } else {
            return [
              createVNode("p", null, [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Setting up JWT signing and JWE encryption from scratch involves several independent components — certificate loading, algorithm selection, claim assembly, PKCE generation, and JWKS discovery. A mistake in any one of these produces a cryptic rejection at <code data-v-18a31e57${_scopeId2}>/par</code> or <code data-v-18a31e57${_scopeId2}>/token</code> with little indication of which step failed.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-18a31e57${_scopeId2}><thead data-v-18a31e57${_scopeId2}><tr data-v-18a31e57${_scopeId2}><th data-v-18a31e57${_scopeId2}>If you&#39;re unsure whether…</th><th data-v-18a31e57${_scopeId2}>Use…</th></tr></thead><tbody data-v-18a31e57${_scopeId2}><tr data-v-18a31e57${_scopeId2}><td data-v-18a31e57${_scopeId2}>Your private key and <code data-v-18a31e57${_scopeId2}>kid</code> are correctly configured</td><td data-v-18a31e57${_scopeId2}><strong data-v-18a31e57${_scopeId2}>Prepare private key JWT</strong></td></tr><tr data-v-18a31e57${_scopeId2}><td data-v-18a31e57${_scopeId2}>Your client assertion claims are correct</td><td data-v-18a31e57${_scopeId2}><strong data-v-18a31e57${_scopeId2}>Prepare private key JWT for PAR end-point</strong></td></tr><tr data-v-18a31e57${_scopeId2}><td data-v-18a31e57${_scopeId2}>Your PII payload structure and encryption key are working</td><td data-v-18a31e57${_scopeId2}><strong data-v-18a31e57${_scopeId2}>Prepare Encrypted PII</strong></td></tr></tbody></table>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-18a31e57${_scopeId2}><thead data-v-18a31e57${_scopeId2}><tr data-v-18a31e57${_scopeId2}><th data-v-18a31e57${_scopeId2}>Variable</th><th data-v-18a31e57${_scopeId2}>Description</th></tr></thead><tbody data-v-18a31e57${_scopeId2}><tr data-v-18a31e57${_scopeId2}><td data-v-18a31e57${_scopeId2}><code data-v-18a31e57${_scopeId2}>kid-local</code></td><td data-v-18a31e57${_scopeId2}>The <code data-v-18a31e57${_scopeId2}>kid</code> of your signing certificate from the Trust Framework</td></tr><tr data-v-18a31e57${_scopeId2}><td data-v-18a31e57${_scopeId2}><code data-v-18a31e57${_scopeId2}>pem-local</code></td><td data-v-18a31e57${_scopeId2}>Your signing private key in PEM format, with <code data-v-18a31e57${_scopeId2}>\\n</code> replacing literal newlines</td></tr><tr data-v-18a31e57${_scopeId2}><td data-v-18a31e57${_scopeId2}><code data-v-18a31e57${_scopeId2}>_clientId</code></td><td data-v-18a31e57${_scopeId2}>Your application&#39;s <code data-v-18a31e57${_scopeId2}>client_id</code> from the Trust Framework</td></tr><tr data-v-18a31e57${_scopeId2}><td data-v-18a31e57${_scopeId2}><code data-v-18a31e57${_scopeId2}>jwksUrl</code></td><td data-v-18a31e57${_scopeId2}>The LFI&#39;s JWKS URI — required for encryption only</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-18a31e57${_scopeId2}>Postman environment variables cannot contain literal newlines. Convert your key with:</p>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-18a31e57${_scopeId2}>Saves to:</strong> <code data-v-18a31e57${_scopeId2}>${ssrInterpolate(PM_ENCRYPTED_PII)}</code>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Takes a structured payload containing creditor and risk data, signs it with your private key, then encrypts it using the LFI&#39;s public encryption key (fetched from <code data-v-18a31e57${_scopeId2}>jwksUrl</code>). The result is a Nested JWT (JWS wrapped in JWE) ready to drop straight into <code data-v-18a31e57${_scopeId2}>PersonalIdentifiableInformation</code> inside <code data-v-18a31e57${_scopeId2}>authorization_details</code>.`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-18a31e57${_scopeId}>Request body</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: piiBody,
              lang: "json"
            }, null, _parent2, _scopeId));
            _push2(`<h3 data-v-18a31e57${_scopeId}>Test script</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: piiTest,
              lang: "javascript"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`See <a href="/tech/tpp-standards/security/fapi/message-encryption" data-v-18a31e57${_scopeId2}>Message Encryption</a> for how to produce this token in your own code.`);
                } else {
                  return [
                    createTextVNode("See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-18a31e57${_scopeId2}>Saves to:</strong> <code data-v-18a31e57${_scopeId2}>${ssrInterpolate(PM_PRIVATE_KEY_JWT)}</code>`);
                } else {
                  return [
                    createVNode("strong", null, "Saves to:"),
                    createTextVNode(),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Produces a <strong data-v-18a31e57${_scopeId2}>client assertion JWT</strong> for authenticating at <code data-v-18a31e57${_scopeId2}>/par</code>. The assertion contains your <code data-v-18a31e57${_scopeId2}>client_id</code> as both <code data-v-18a31e57${_scopeId2}>iss</code> and <code data-v-18a31e57${_scopeId2}>sub</code>, a short <code data-v-18a31e57${_scopeId2}>exp</code>, and a unique <code data-v-18a31e57${_scopeId2}>jti</code>. The Authorization Server verifies it using your public key from the Trust Framework JWKS.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Use this as the <code data-v-18a31e57${_scopeId2}>client_assertion</code> parameter when calling <code data-v-18a31e57${_scopeId2}>/par</code>.`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-18a31e57${_scopeId}>Pre-request script</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: parPre,
              lang: "javascript"
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`See <a href="/tech/tpp-standards/security/tokens/client-assertion" data-v-18a31e57${_scopeId2}>Client Assertion</a> for the full claim set.`);
                } else {
                  return [
                    createTextVNode("See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Identical request body and output to the PAR variant above. Use this to generate a <strong data-v-18a31e57${_scopeId2}>fresh client assertion for <code data-v-18a31e57${_scopeId2}>/token</code></strong> — for example when exchanging an authorization code for tokens or refreshing an access token.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`A new assertion with a unique <code data-v-18a31e57${_scopeId2}>jti</code> must be generated for every request. The Authorization Server tracks seen <code data-v-18a31e57${_scopeId2}>jti</code> values and will reject replayed assertions.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Postman&#39;s <code data-v-18a31e57${_scopeId2}>${ssrInterpolate(PM_GUID)}</code> generates a new UUID on every request, so replays are avoided automatically.`);
                } else {
                  return [
...
const o3Utils = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-18a31e57"]]);
export {
  o3Utils as default
};
