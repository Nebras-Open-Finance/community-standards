...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const capabilities = [
      {
        href: "/tech/lfi-api-hub/v2.1/banking/data-sharing/",
      ...
      {
        href: "/tech/lfi-api-hub/v2.1/banking/service-initiation/",
      ...
      {
        href: "/tech/lfi-api-hub/v2.1/banking/confirmation-of-payee/",
      ...
      {
        href: "/tech/lfi-api-hub/v2.1/banking/products-and-leads/",
        cat: "Products & Leads",
        color: "var(--at-navy)",
      ...
      {
        href: "/tech/lfi-api-hub/v2.1/banking/atms/",
        cat: "ATMs",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-landing" }, _attrs))} data-v-0af6185b><section class="ed-landing__hero" data-v-0af6185b><div class="ed-landing__inner" data-v-0af6185b><div class="ed-landing__eyebrow" data-v-0af6185b><span class="ed-landing__eyebrow-dash" data-v-0af6185b></span> LFI Standards · v2.1 · Banking </div><h1 class="ed-landing__title" data-v-0af6185b> Banking <span class="ed-landing__read" data-v-0af6185b>2 min read</span></h1><p class="ed-landing__lede" data-v-0af6185b> The Open Finance Banking capabilities enable secure and efficient financial data sharing, payment initiation, and verification — empowering third-party providers (TPPs) with the tools they need to enhance user experience and financial services. </p><p class="ed-landing__lede ed-landing__lede--tight" data-v-0af6185b> All services operate under strict consent management and granular data access permissions, mediated and validated by the API Hub. </p></div></section><section class="ed-landing__live" data-v-0af6185b><div class="ed-landing__inner" data-v-0af6185b><div class="ed-landing__live-head" data-v-0af6185b><div class="ed-landing__live-eyebrow" data-v-0af6185b><span class="ed-landing__eyebrow-dash" data-v-0af6185b></span> Live ecosystem </div><h2 class="ed-landing__live-title" data-v-0af6185b>Which TPPs are consuming Banking APIs</h2><p class="ed-landing__live-sub" data-v-0af6185b> TPPs currently calling Banking endpoints — across data sharing, payments, CoP, products, and ATMs — in the last 30 days. </p></div>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {
        placeholder: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-landing__live-grid" data-v-0af6185b${_scopeId}><!--[-->`);
            ssrRenderList(6, (i) => {
              _push2(`<div class="ed-landing__tpp ed-landing__tpp--skel" data-v-0af6185b${_scopeId}></div>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            if (unref(liveTpps).length) {
              ...
              ssrRenderList(unref(liveTpps), (tpp) => {
                _push2(`<a class="ed-landing__tpp"${ssrRenderAttr("title", tpp.legalName)} href="/program/whats-live?type=tpp" data-v-0af6185b${_scopeId}><div class="ed-landing__tpp-logo" data-v-0af6185b${_scopeId}>`);
                if (tpp.logoUri) {
                  _push2(`<img${ssrRenderAttr("src", tpp.logoUri)}${ssrRenderAttr("alt", tpp.legalName)} data-v-0af6185b${_scopeId}>`);
                } else {
                  _push2(`<span class="ed-landing__tpp-initials" data-v-0af6185b${_scopeId}>${ssrInterpolate(initials(tpp.name))}</span>`);
                }
                _push2(`</div><div class="ed-landing__tpp-name" data-v-0af6185b${_scopeId}>${ssrInterpolate(tpp.name)}</div></a>`);
              });
              _push2(`<!--]-->`);
              if (unref(totalTppCount) > unref(liveTpps).length) {
                _push2(`<a class="ed-landing__tpp ed-landing__tpp--more" href="/program/whats-live?type=tpp"${ssrRenderAttr("title", `See all ${unref(totalTppCount)} TPPs`)} data-v-0af6185b${_scopeId}><span class="ed-landing__tpp-more-dots" data-v-0af6185b${_scopeId}>…</span><span class="ed-landing__tpp-more-label" data-v-0af6185b${_scopeId}>+${ssrInterpolate(unref(totalTppCount) - unref(liveTpps).length)} more</span></a>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            } else if (unref(loadError)) {
              _push2(`<p class="ed-landing__live-empty" data-v-0af6185b${_scopeId}>Live data is currently unavailable.</p>`);
            } else {
              _push2(`<p class="ed-landing__live-empty" data-v-0af6185b${_scopeId}>No TPPs are currently consuming Banking APIs.</p>`);
            }
            if (unref(totalTppCount) > 0) {
              _push2(`<a class="ed-landing__live-cta" href="/program/whats-live?type=tpp" data-v-0af6185b${_scopeId}>`);
              if (unref(totalTppCount) > unref(liveTpps).length) {
                _push2(`<span data-v-0af6185b${_scopeId}> See all ${ssrInterpolate(unref(totalTppCount))} TPPs in the live ecosystem </span>`);
              } else {
                _push2(`<span data-v-0af6185b${_scopeId}>View in the live ecosystem dashboard</span>`);
              }
              _push2(`<span class="ed-landing__live-cta-arrow" aria-hidden="true" data-v-0af6185b${_scopeId}>→</span></a>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`</div></section><section class="ed-landing__contents" data-v-0af6185b><div class="ed-landing__inner" data-v-0af6185b><div class="ed-landing__contents-head" data-v-0af6185b><div class="ed-landing__contents-eyebrow" data-v-0af6185b><span class="ed-landing__eyebrow-dash" data-v-0af6185b></span> Capabilities </div><h2 class="ed-landing__contents-title" data-v-0af6185b>Browse the Banking capabilities</h2><p class="ed-landing__contents-sub" data-v-0af6185b>The full set of capability areas an LFI implements as part of UAE Open Finance Banking.</p></div><div class="ed-landing__contents-grid ed-landing__contents-grid--lg" data-v-0af6185b><!--[-->`);
      ssrRenderList(capabilities, (cap) => {
        _push(`<a class="ed-link-card ed-link-card--lg"${ssrRenderAttr("href", cap.href)} style="${ssrRenderStyle({ "--card-color": cap.color })}" data-v-0af6185b><span class="ed-link-card__top" data-v-0af6185b></span><div class="ed-link-card__meta" data-v-0af6185b><span class="ed-link-card__cat" data-v-0af6185b>${ssrInterpolate(cap.cat)}</span></div><h3 class="ed-link-card__title" data-v-0af6185b>${ssrInterpolate(cap.title)}</h3><p class="ed-link-card__desc" data-v-0af6185b>${cap.body ?? ""}</p><ul class="ed-link-card__highlights" data-v-0af6185b><!--[-->`);
        ssrRenderList(cap.highlights, (h) => {
          _push(`<li data-v-0af6185b>${ssrInterpolate(h)}</li>`);
        });
        _push(`<!--]--></ul><div class="ed-link-card__foot" data-v-0af6185b><span class="ed-link-card__cta" data-v-0af6185b>Open</span><span class="ed-link-card__arrow" data-v-0af6185b>→</span></div></a>`);
      });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/banking/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0af6185b"]]);
export {
  index as default
};
