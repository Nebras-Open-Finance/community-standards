...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-9d16e1cb>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-9d16e1cb${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-9d16e1cb${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Populate <code data-v-9d16e1cb${_scopeId2}>OnBehalfOf</code> when the caller (TPP) is requesting authorisation for <strong data-v-9d16e1cb${_scopeId2}>bank or insurance data sharing only</strong>, but is doing so on behalf of another legal or regulated entity:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-9d16e1cb${_scopeId2}>A TPP provides technology services to an LFI and stages the PAR on behalf of that LFI.</li><li data-v-9d16e1cb${_scopeId2}>A licensed aggregator or reseller acts as the technical integration layer for another regulated entity.</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`If the TPP is representing itself (no other regulated entity is involved), <code data-v-9d16e1cb${_scopeId2}>OnBehalfOf</code> is not required.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-9d16e1cb${_scopeId2}><thead data-v-9d16e1cb${_scopeId2}><tr data-v-9d16e1cb${_scopeId2}><th data-v-9d16e1cb${_scopeId2}>Field</th><th data-v-9d16e1cb${_scopeId2}>Description</th></tr></thead><tbody data-v-9d16e1cb${_scopeId2}><tr data-v-9d16e1cb${_scopeId2}><td data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>TradingName</code></td><td data-v-9d16e1cb${_scopeId2}>The trading name of the entity being represented.</td></tr><tr data-v-9d16e1cb${_scopeId2}><td data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>LegalName</code></td><td data-v-9d16e1cb${_scopeId2}>The registered legal name of the entity.</td></tr><tr data-v-9d16e1cb${_scopeId2}><td data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>IdentifierType</code></td><td data-v-9d16e1cb${_scopeId2}>Identifier scheme — currently <code data-v-9d16e1cb${_scopeId2}>&quot;Other&quot;</code> in the published schema.</td></tr><tr data-v-9d16e1cb${_scopeId2}><td data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>Identifier</code></td><td data-v-9d16e1cb${_scopeId2}>The identifier value for the represented entity.</td></tr></tbody></table>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-9d16e1cb${_scopeId2}><thead data-v-9d16e1cb${_scopeId2}><tr data-v-9d16e1cb${_scopeId2}><th data-v-9d16e1cb${_scopeId2}>Consent type</th><th data-v-9d16e1cb${_scopeId2}>OnBehalfOf supported?</th><th data-v-9d16e1cb${_scopeId2}>Notes</th></tr></thead><tbody data-v-9d16e1cb${_scopeId2}><tr data-v-9d16e1cb${_scopeId2}><td data-v-9d16e1cb${_scopeId2}>Bank Data Sharing</td><td data-v-9d16e1cb${_scopeId2}>Yes</td><td data-v-9d16e1cb${_scopeId2}>Declare the legal entity the TPP is acting for within the rich authorisation request.</td></tr><tr data-v-9d16e1cb${_scopeId2}><td data-v-9d16e1cb${_scopeId2}>Insurance Data Sharing</td><td data-v-9d16e1cb${_scopeId2}>Yes</td><td data-v-9d16e1cb${_scopeId2}>References a common <code data-v-9d16e1cb${_scopeId2}>AEOnBehalfOf</code> object — same intent and fields.</td></tr><tr data-v-9d16e1cb${_scopeId2}><td data-v-9d16e1cb${_scopeId2}>Bank Service Initiation (payments)</td><td data-v-9d16e1cb${_scopeId2}><strong data-v-9d16e1cb${_scopeId2}>No</strong></td><td data-v-9d16e1cb${_scopeId2}>Not used. Merchant identity is carried via the creditor fields in the payment consent.</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`For payment consents, the user must be shown who the payment is going to. This information is provided via the creditor fields in the payment consent — not via <code data-v-9d16e1cb${_scopeId2}>OnBehalfOf</code>.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-9d16e1cb${_scopeId2}>Prefer <strong data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>Creditor.Name</code></strong> when it is provided.</li><li data-v-9d16e1cb${_scopeId2}>If <code data-v-9d16e1cb${_scopeId2}>Creditor.Name</code> is not present, fall back to <strong data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>CreditorAccount.Name.en</code></strong> or <strong data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>CreditorAccount.Name.ar</code></strong> as applicable.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, { type: "warning" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-9d16e1cb${_scopeId2}>Do not attempt to carry merchant identity in an <code data-v-9d16e1cb${_scopeId2}>OnBehalfOf</code> object for payment consents — it is not part of the service initiation schema and will be ignored or rejected.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 data-v-9d16e1cb${_scopeId}>Merchant Name on the authorisation page</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`If the TPP populates <code data-v-9d16e1cb${_scopeId2}>Risk.CreditorIndicators.MerchantDetails.MerchantName</code> in the PII payload, the LFI <strong data-v-9d16e1cb${_scopeId2}>must</strong> reflect this on the authorisation page by displaying the merchant name in the permission header:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-9d16e1cb${_scopeId2}><strong data-v-9d16e1cb${_scopeId2}>[TPP trading name] needs your permission on-behalf of [MerchantName] to make the payment below:</strong></p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`When <code data-v-9d16e1cb${_scopeId2}>MerchantName</code> is not present, the standard wording is shown:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-9d16e1cb${_scopeId2}><strong data-v-9d16e1cb${_scopeId2}>[TPP trading name] needs your permission to make the payment below:</strong></p>`);
                } else {
                  return [
                    createVNode("p", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-9d16e1cb${_scopeId}>Bank Data Sharing PAR (with OnBehalfOf)</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<h3 data-v-9d16e1cb${_scopeId}>Bank Service Initiation PAR (payment) — creditor fields for merchant identity</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Use the creditor fields to identify the payment recipient — not <code data-v-9d16e1cb${_scopeId2}>OnBehalfOf</code>:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, { type: "info" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-9d16e1cb${_scopeId2}>In production, <code data-v-9d16e1cb${_scopeId2}>PersonalIdentifiableInformation</code> is a JWE encrypted with the LFI&#39;s encryption key. The structure above shows the decrypted payload for illustration.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-9d16e1cb${_scopeId2}>If acting on behalf of another regulated entity, include <code data-v-9d16e1cb${_scopeId2}>OnBehalfOf</code> in <strong data-v-9d16e1cb${_scopeId2}>Bank Data Sharing</strong> or <strong data-v-9d16e1cb${_scopeId2}>Insurance Data Sharing</strong> PARs.</li><li data-v-9d16e1cb${_scopeId2}>For payment consents, populate <strong data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>Creditor.Name</code></strong> — or <strong data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>CreditorAccount.Name.en</code></strong> / <strong data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>CreditorAccount.Name.ar</code></strong> if <code data-v-9d16e1cb${_scopeId2}>Creditor.Name</code> is not available — so the LFI can display the recipient to the user.</li><li data-v-9d16e1cb${_scopeId2}>If the TPP is acting as a payment facilitator for a sub-merchant, populate <strong data-v-9d16e1cb${_scopeId2}><code data-v-9d16e1cb${_scopeId2}>Risk.CreditorIndicators.MerchantDetails.MerchantName</code></strong> in the PII payload so the LFI can display the merchant name on the authorisation page.</li><li data-v-9d16e1cb${_scopeId2}>Do <strong data-v-9d16e1cb${_scopeId2}>not</strong> use <code data-v-9d16e1cb${_scopeId2}>OnBehalfOf</code> in service initiation (payment) PARs.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
...
const onBehalfOf = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9d16e1cb"]]);
export {
