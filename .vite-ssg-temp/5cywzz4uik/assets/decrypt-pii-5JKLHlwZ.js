...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-7225ddd7><section class="ed-doc__hero" data-v-7225ddd7><div class="ed-doc__inner" data-v-7225ddd7><div class="ed-doc__eyebrow" data-v-7225ddd7><span class="ed-doc__eyebrow-dash" data-v-7225ddd7></span> LFI · Banking · Service Initiation · PII · API Guide </div><h1 class="ed-doc__title" data-v-7225ddd7> How to Decrypt PII <span class="ed-doc__read" data-v-7225ddd7>3 min read</span></h1><p class="ed-doc__lede" data-v-7225ddd7> The <code data-v-7225ddd7>PersonalIdentifiableInformation</code> field is a compact JWE (JSON Web Encryption) string. It was encrypted by the TPP using your LFI&#39;s public encryption key (<a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/#enc1-encryption-key" data-v-7225ddd7>Enc1</a>). To decrypt it, you need the corresponding <strong data-v-7225ddd7>Enc1 private key</strong>. </p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The JWE protected header contains the <code data-v-7225ddd7${_scopeId2}>kid</code> (Key ID) of the encryption key that was used. Decode the first segment of the JWE to identify which private key to use: `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-7225ddd7${_scopeId2}> The JWS is signed by the TPP. You may optionally verify this signature against the TPP&#39;s public signing key. However, this is <strong data-v-7225ddd7${_scopeId2}>not required</strong> — the entire request containing the PII field is itself sent as a JWS that the API Hub has already verified was signed by the TPP. The PII therefore cannot have been tampered with in transit. </p><p data-v-7225ddd7${_scopeId2}> If you choose to implement JWS verification for defence-in-depth, see <a href="./verify-tpp-signature" data-v-7225ddd7${_scopeId2}>Verify TPP Signature (Optional)</a>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7225ddd7${_scopeId2}><thead data-v-7225ddd7${_scopeId2}><tr data-v-7225ddd7${_scopeId2}><th data-v-7225ddd7${_scopeId2}>Stage</th><th data-v-7225ddd7${_scopeId2}>Spec file</th><th data-v-7225ddd7${_scopeId2}>Schema</th></tr></thead><tbody data-v-7225ddd7${_scopeId2}><tr data-v-7225ddd7${_scopeId2}><td data-v-7225ddd7${_scopeId2}>Consent</td><td data-v-7225ddd7${_scopeId2}><code data-v-7225ddd7${_scopeId2}>uae-api-hub-consent-manager-openapi.yaml</code></td><td data-v-7225ddd7${_scopeId2}><code data-v-7225ddd7${_scopeId2}>AEBankServiceInitiationRichAuthorizationRequests.AEDomesticPaymentPII</code></td></tr><tr data-v-7225ddd7${_scopeId2}><td data-v-7225ddd7${_scopeId2}>Payment</td><td data-v-7225ddd7${_scopeId2}><code data-v-7225ddd7${_scopeId2}>uae-ozone-connect-bank-service-initiation-openapi.yaml</code></td><td data-v-7225ddd7${_scopeId2}><code data-v-7225ddd7${_scopeId2}>AEBankServiceInitiation.AEDomesticPaymentPIIProperties</code></td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-7225ddd7${_scopeId}>Obtaining the OpenAPI specification</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<p data-v-7225ddd7${_scopeId}><a href="https://github.com/Nebras-Open-Finance/api-specs" target="_blank" rel="noopener" class="ed-doc__github-link" data-v-7225ddd7${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="18" height="18" aria-hidden="true" data-v-7225ddd7${_scopeId}><path d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.31 2.69.94 0 .67.01 1.3.01 1.49 0 .21-.15.45-.55.38A7.995 7.995 0 0 1 0 8c0-4.42 3.58-8 8-8Z" data-v-7225ddd7${_scopeId}></path></svg> Nebras-Open-Finance/api-specs </a></p>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Spec files are located under <code data-v-7225ddd7${_scopeId2}>dist/</code> by category:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-7225ddd7${_scopeId2}><thead data-v-7225ddd7${_scopeId2}><tr data-v-7225ddd7${_scopeId2}><th data-v-7225ddd7${_scopeId2}>Stage</th><th data-v-7225ddd7${_scopeId2}>Path</th></tr></thead><tbody data-v-7225ddd7${_scopeId2}><tr data-v-7225ddd7${_scopeId2}><td data-v-7225ddd7${_scopeId2}>Consent</td><td data-v-7225ddd7${_scopeId2}><code data-v-7225ddd7${_scopeId2}>dist/api-hub/{version}/openapi/uae-api-hub-consent-manager-openapi.yaml</code></td></tr><tr data-v-7225ddd7${_scopeId2}><td data-v-7225ddd7${_scopeId2}>Payment</td><td data-v-7225ddd7${_scopeId2}><code data-v-7225ddd7${_scopeId2}>dist/ozone-connect/{version}/openapi/uae-ozone-connect-bank-service-initiation-openapi.yaml</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-7225ddd7${_scopeId2}> Specifications may have errata releases (e.g. <code data-v-7225ddd7${_scopeId2}>v2.1.x-errata1</code>) that contain targeted corrections. When multiple version folders exist for the same major.minor version, use the <strong data-v-7225ddd7${_scopeId2}>highest errata</strong> that contains the file you need. If a file is not present in an errata folder, fall back to the base version. Always check for errata before bundling a spec into your service. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-7225ddd7${_scopeId}>Validating against the schema</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Extract the relevant <code data-v-7225ddd7${_scopeId2}>components/schemas</code> entry from the YAML file and validate the decrypted PII payload against it. The PII schemas in the OpenAPI specification already declare the constraints needed for validation: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-7225ddd7${_scopeId2}><strong data-v-7225ddd7${_scopeId2}><code data-v-7225ddd7${_scopeId2}>additionalProperties: false</code></strong> is set at every level of the PII schema — any unexpected fields will cause validation to fail.</li><li data-v-7225ddd7${_scopeId2}><strong data-v-7225ddd7${_scopeId2}><code data-v-7225ddd7${_scopeId2}>required</code> arrays</strong> are declared on sub-schemas (e.g. <code data-v-7225ddd7${_scopeId2}>CreditorAccount</code> is required on each creditor entry, <code data-v-7225ddd7${_scopeId2}>SchemeName</code> and <code data-v-7225ddd7${_scopeId2}>Identification</code> are required on account objects) — missing mandatory fields will cause validation to fail.</li><li data-v-7225ddd7${_scopeId2}><strong data-v-7225ddd7${_scopeId2}><code data-v-7225ddd7${_scopeId2}>enum</code> constraints</strong> restrict values to allowed options (e.g. <code data-v-7225ddd7${_scopeId2}>SchemeName</code> must be <code data-v-7225ddd7${_scopeId2}>IBAN</code>).</li><li data-v-7225ddd7${_scopeId2}><strong data-v-7225ddd7${_scopeId2}><code data-v-7225ddd7${_scopeId2}>$ref</code> pointers</strong> link to nested schemas (creditor, debtor, risk). For validation to work correctly, all <code data-v-7225ddd7${_scopeId2}>components/schemas</code> entries from the spec MUST be registered with the validator so that <code data-v-7225ddd7${_scopeId2}>$ref</code> pointers resolve.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When you register the full set of component schemas and compile the PII schema, standard JSON Schema validators (<code data-v-7225ddd7${_scopeId2}>ajv</code> for Node.js, <code data-v-7225ddd7${_scopeId2}>jsonschema</code> for Python) will enforce all of these constraints automatically. No custom validation logic is needed for schema conformance — the OpenAPI spec is the single source of truth. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-7225ddd7${_scopeId2}> If the decrypted PII fails schema validation, the LFI MUST reject the consent or payment. Do not attempt to process a payment with malformed PII — return an appropriate error response. See <a href="../" data-v-7225ddd7${_scopeId2}>Personal Identifiable Information</a> for the full set of validation rules. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
...
const decryptPii = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7225ddd7"]]);
export {
