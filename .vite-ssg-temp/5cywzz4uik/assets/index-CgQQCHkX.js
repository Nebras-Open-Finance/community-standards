...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-0f01a814><section class="ed-doc__hero" data-v-0f01a814><div class="ed-doc__inner" data-v-0f01a814><div class="ed-doc__eyebrow" data-v-0f01a814><span class="ed-doc__eyebrow-dash" data-v-0f01a814></span> LFI · API Hub · Onboarding </div><h1 class="ed-doc__title" data-v-0f01a814> API Hub Onboarding <span class="ed-doc__read" data-v-0f01a814>2 min read</span></h1><p class="ed-doc__lede" data-v-0f01a814> This section covers the end-to-end process for onboarding your institution to the <strong data-v-0f01a814>API Hub</strong>. Onboarding is managed through the <strong data-v-0f01a814>Nebras Service Desk</strong> and involves providing configuration details, exchanging certificates, and provisioning your API Hub instance. </p></div></section>`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>Trust Framework registration</strong> — Your organisation MUST be onboarded to the appropriate Trust Framework environment: <ul data-v-0f01a814${_scopeId2}><li data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>Pre-production</strong> API Hub → <a href="https://web.sandbox.directory.openfinance.ae/" data-v-0f01a814${_scopeId2}>Sandbox Trust Framework</a></li><li data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>Production</strong> API Hub → <a href="https://web.directory.openfinance.ae/" data-v-0f01a814${_scopeId2}>Production Trust Framework</a></li></ul> See <a href="/tech/lfi-api-hub/trust-framework/onboarding" data-v-0f01a814${_scopeId2}>Trust Framework Onboarding</a> for details. </li><li data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>Primary Technical Contact (PTC)</strong> — A Primary Technical Contact MUST have been registered for your organisation so that applications, servers, and certificates can be created in the Trust Framework. The PTC is responsible for managing the technical connectivity between your institution and the API Hub. </li>`);
            } else {
              return [
                createVNode("li", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` To begin onboarding, send the following email to <a href="mailto:support@nebrasopenfinance.ae" data-v-0f01a814${_scopeId2}>support@nebrasopenfinance.ae</a>: `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdNote, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>To:</strong><a href="mailto:support@nebrasopenfinance.ae" data-v-0f01a814${_scopeId2}>support@nebrasopenfinance.ae</a></p><p data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>Subject:</strong> API Hub Onboarding Request — [Your Organisation Name] — [Environment]</p><hr data-v-0f01a814${_scopeId2}><p data-v-0f01a814${_scopeId2}>Dear Nebras Support,</p><p data-v-0f01a814${_scopeId2}>I wish to begin API Hub onboarding for the following:</p><ul data-v-0f01a814${_scopeId2}><li data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>Organisation:</strong> [Your Organisation Name]</li><li data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>Environment:</strong> [Pre-production / Production]</li><li data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>Primary Technical Contact (PTC):</strong> [Name and email of the PTC who will manage the technical connectivity]</li></ul><p data-v-0f01a814${_scopeId2}>Please raise the onboarding tickets and provide the next steps.</p>`);
            } else {
              return [
                createVNode("p", null, [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Once received, the Nebras support team will raise <strong data-v-0f01a814${_scopeId2}>JIRA tickets</strong> to track each stage of the onboarding process. `);
            } else {
              return [
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<h3 data-v-0f01a814${_scopeId}>1. Prerequisites Questionnaire</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` See <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/prerequisites" data-v-0f01a814${_scopeId2}>Prerequisites</a> for the full list of fields. `);
            } else {
              return [
                createTextVNode(" See "),
                createVNode("a", { href: "/tech/lfi-api-hub/v2.1/api-hub/onboarding/prerequisites" }, "Prerequisites"),
        ...
        _push2(`<h3 data-v-0f01a814${_scopeId}>2. Application Layer Authentication</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-0f01a814${_scopeId2}>mTLS Only</li><li data-v-0f01a814${_scopeId2}>API Key</li><li data-v-0f01a814${_scopeId2}>Client Credentials Grant</li><li data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>JWT Auth</strong> (recommended)</li>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` See <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/application-layer-auth" data-v-0f01a814${_scopeId2}>Application Layer Authentication</a> for a comparison of methods, and <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/configuring-authentication/mtls-server" data-v-0f01a814${_scopeId2}>Configuring Authentication</a> for implementation guidance on the mTLS and JWT Auth layers. `);
            } else {
              return [
                createTextVNode(" See "),
                ...
                createVNode("a", { href: "/tech/lfi-api-hub/v2.1/api-hub/onboarding/configuring-authentication/mtls-server" }, "Configuring Authentication"),
        ...
        _push2(`<h3 data-v-0f01a814${_scopeId}>3. Environment-Specific Configuration</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` You will exchange certificates, URLs, and domain-specific values with Ozone. This process MUST be completed <strong data-v-0f01a814${_scopeId2}>separately for each environment</strong> (pre-production and production). `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` See <a href="/tech/lfi-api-hub/v2.1/api-hub/onboarding/environment-specific/" data-v-0f01a814${_scopeId2}>Environment-Specific Configuration</a> for the full list of fields and certificate details. `);
            } else {
              return [
                createTextVNode(" See "),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>Publish your API Hub as a server</strong> in the Trust Framework so that TPPs can discover your institution. See <a href="/tech/lfi-api-hub/trust-framework/servers/creating" data-v-0f01a814${_scopeId2}>Creating a Server</a>. </li><li data-v-0f01a814${_scopeId2}><strong data-v-0f01a814${_scopeId2}>Implement your Ozone Connect endpoints</strong></li>`);
            } else {
              return [
                createVNode("li", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/api-hub/onboarding/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-0f01a814"]]);
export {
  index as default
};
