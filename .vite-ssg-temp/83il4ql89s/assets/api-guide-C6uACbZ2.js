...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-c7e5390e><section class="ed-doc__hero" data-v-c7e5390e><div class="ed-doc__inner" data-v-c7e5390e><div class="ed-doc__eyebrow" data-v-c7e5390e><span class="ed-doc__eyebrow-dash" data-v-c7e5390e></span> LFI · Banking · Service Initiation · Single Instant Payment </div><h1 class="ed-doc__title" data-v-c7e5390e> Single Instant Payment — API Guide <span class="ed-doc__read" data-v-c7e5390e>14 min read</span></h1><p class="ed-doc__lede" data-v-c7e5390e> Single Instant Payment lets a TPP initiate a one-off domestic payment from a customer&#39;s account at your LFI via the API Hub. The payment runs on AANI as the primary rail with UAEFTS as the fallback. This guide covers the Ozone Connect endpoints your LFI MUST implement so the Hub can serve a TPP payment from consent creation through to execution and status retrieval. </p><p class="ed-doc__lede" data-v-c7e5390e> The behavioural rules for each endpoint — validation conditions, error mappings, post-execution lifecycle — are in the <a href="./requirements" data-v-c7e5390e>Single Instant Payment Requirements</a>. This guide covers the request and response shape of each endpoint, with code walkthroughs for the parts that need them: decrypting the PII, validating the creditor, matching the payment-time PII against the consent, and reading the FAPI customer headers. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>API Hub onboarded</strong> — Your API Hub instance is provisioned and your <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/" data-v-c7e5390e${_scopeId2}>environment-specific configuration</a> is complete. </li><li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>Enc1 key pair generated and registered</strong> — The TPP encrypts PII to your LFI&#39;s <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/#enc1-encryption-key" data-v-c7e5390e${_scopeId2}>Enc1 public key</a>. Your LFI MUST hold the corresponding private key and be able to look it up by <code data-v-c7e5390e${_scopeId2}>kid</code>. </li><li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>Consent Journey implemented</strong> — The <a href="/tech/lfi-api-hub/v2.2-rc1/consent-journey/api-guide" data-v-c7e5390e${_scopeId2}>Consent Journey API Guide</a> MUST be implemented first. A payment cannot be initiated without an authorized consent. </li><li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>Ozone Connect connectivity verified</strong> — Bidirectional mTLS connectivity is confirmed between the API Hub and your Ozone Connect base URL. See <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/connectivity/" data-v-c7e5390e${_scopeId2}>Connectivity &amp; Certificates</a>. </li><li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>Single Instant Payment advertised</strong> — <code data-v-c7e5390e${_scopeId2}>ApiMetadata.SingleInstantPayment.Supported</code> is set to <code data-v-c7e5390e${_scopeId2}>true</code> on your authorisation server entry in the Trust Framework. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When a TPP creates a payment consent, the API Hub calls your <a href="/tech/lfi-api-hub/v2.2-rc1/consent-events/open-api/validate" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--post" data-v-c7e5390e${_scopeId2}>POST</span><code data-v-c7e5390e${_scopeId2}>/consent/action/validate</code></a> endpoint <strong data-v-c7e5390e${_scopeId2}>before</strong> the consent is created. Your LFI MUST validate the consent and respond with <code data-v-c7e5390e${_scopeId2}>data.status: &quot;valid&quot;</code> or <code data-v-c7e5390e${_scopeId2}>data.status: &quot;invalid&quot;</code>. An <code data-v-c7e5390e${_scopeId2}>invalid</code> response prevents the consent being created and the TPP receives an error. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The full set of validation rules — <code data-v-c7e5390e${_scopeId2}>standardVersion</code>, <code data-v-c7e5390e${_scopeId2}>Initiation.DebtorAccount</code>, <code data-v-c7e5390e${_scopeId2}>BaseConsentId</code>, <code data-v-c7e5390e${_scopeId2}>CurrencyRequest</code>, payment-type support, PII conformance, creditor checks — is enumerated in <a href="./requirements#consent-validation" data-v-c7e5390e${_scopeId2}>Single Instant Payment Requirements — Consent Validation</a>. The two parts that need a code walkthrough are <strong data-v-c7e5390e${_scopeId2}>decrypting the PII</strong> and <strong data-v-c7e5390e${_scopeId2}>validating the creditor</strong>; both are covered below. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-c7e5390e${_scopeId2}>Read the <code data-v-c7e5390e${_scopeId2}>kid</code> from the JWE protected header and look up the matching Enc1 private key.</li><li data-v-c7e5390e${_scopeId2}>Decrypt the JWE → recover the inner JWS.</li><li data-v-c7e5390e${_scopeId2}>Decode the JWS payload (signature verification is <strong data-v-c7e5390e${_scopeId2}>optional</strong> — the outer Ozone Connect request is itself a JWS that the API Hub has already verified, so the PII cannot have been tampered with in transit).</li><li data-v-c7e5390e${_scopeId2}>Validate the decoded payload against the consent-time PII schema — <code data-v-c7e5390e${_scopeId2}>AEBankServiceInitiationRichAuthorizationRequests.AEDomesticPaymentPII</code> in <code data-v-c7e5390e${_scopeId2}>uae-api-hub-consent-manager-openapi.yaml</code>. <code data-v-c7e5390e${_scopeId2}>additionalProperties: false</code> is set at every level, so any unexpected field fails validation.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` For the per-step deep dive — <code data-v-c7e5390e${_scopeId2}>kid</code> lookup conventions, key import options, the optional JWS signature verification, building the <code data-v-c7e5390e${_scopeId2}>ajv</code> / <code data-v-c7e5390e${_scopeId2}>jsonschema</code> validator with all <code data-v-c7e5390e${_scopeId2}>$ref</code> schemas registered — see <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/api-guide/decrypt-pii" data-v-c7e5390e${_scopeId2}>How to Decrypt PII</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If decryption fails, schema validation fails, or any required field is missing, respond with <code data-v-c7e5390e${_scopeId2}>invalid</code> per <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/creditor#rejecting-an-invalid-consent" data-v-c7e5390e${_scopeId2}>Rejecting an invalid consent</a>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Validating the Creditor</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` For Single Instant Payment, <code data-v-c7e5390e${_scopeId2}>Initiation.Creditor</code> MUST be an array of exactly <strong data-v-c7e5390e${_scopeId2}>one</strong> entry. The full Creditor rules — cardinality, mandatory fields, BIC derivation — are in <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/creditor" data-v-c7e5390e${_scopeId2}>Creditor</a>. This section walks through the validation in code. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>Cardinality</strong> — exactly one entry.</li><li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>Mandatory fields</strong> — <code data-v-c7e5390e${_scopeId2}>CreditorAccount.SchemeName == &quot;IBAN&quot;</code>, <code data-v-c7e5390e${_scopeId2}>Identification</code> is a syntactically valid UAE IBAN, at least one of <code data-v-c7e5390e${_scopeId2}>Name.en</code> or <code data-v-c7e5390e${_scopeId2}>Name.ar</code> is present.</li><li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>BIC consistency</strong> — derive the BIC from the IBAN; if <code data-v-c7e5390e${_scopeId2}>CreditorAgent.Identification</code> was supplied it MUST match.</li><li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>Domestic rail reachability</strong> — the receiving bank is reachable on AANI or UAEFTS, and (where the LFI can determine it) the receiving account is in a state that can accept a payment.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Steps 1–3 are universal. Step 4 depends on each LFI&#39;s BIC directory and rail integration — the snippet below uses a stubbed <code data-v-c7e5390e${_scopeId2}>lookupRailReachability(bic)</code> interface that your LFI replaces with its own implementation. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Validating the DebtorAccount</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If the TPP supplied <code data-v-c7e5390e${_scopeId2}>Initiation.DebtorAccount</code> in the consent PII, your LFI MUST also validate it before approving the consent: <code data-v-c7e5390e${_scopeId2}>SchemeName</code> is <code data-v-c7e5390e${_scopeId2}>IBAN</code>, the IBAN corresponds to an account held at this LFI and reachable through this API Hub integration, and the account is in a state that permits payment initiation (not blocked, dormant, or closed). Customer ownership of the account is <strong data-v-c7e5390e${_scopeId2}>not</strong> checked here — it is checked later during the authorisation journey, once the customer has authenticated. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The full check list and the <code data-v-c7e5390e${_scopeId2}>invalid</code> response shape (with <code data-v-c7e5390e${_scopeId2}>code: InvalidDebtorAccount</code>) are in <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/personal-identifiable-information/debtor-account" data-v-c7e5390e${_scopeId2}>Debtor Account</a>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Returning the validate response</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If <code data-v-c7e5390e${_scopeId2}>validateCreditor</code> (or the DebtorAccount checks) returns a non-null result, return it inside <code data-v-c7e5390e${_scopeId2}>data</code> on the validate response: `);
                } else {
                  return [
                    createTextVNode(" If "),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/lfi-api-hub/v2.2-rc1/consent-events/api-guide#validate-post-consent-action-validate" data-v-c7e5390e${_scopeId2}>Consent Events &amp; Actions — API Guide</a> for the full validate request and response schema. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` After consent creation passes validation, the TPP redirects the customer to your LFI&#39;s <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/auth-endpoint" data-v-c7e5390e${_scopeId2}>authorization endpoint</a> and your LFI runs the standard consent journey: authenticate the customer, retrieve the consent, present the debtor account selection screen subject to the rules in <a href="./requirements#authorization-account-selection" data-v-c7e5390e${_scopeId2}>Authorization — Account Selection</a>, patch the selected debtor account and customer identifier onto the consent, and redirect back to the Hub. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Endpoint</th><th data-v-c7e5390e${_scopeId2}>Direction</th><th data-v-c7e5390e${_scopeId2}>Purpose</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--get" data-v-c7e5390e${_scopeId2}>GET</span><code data-v-c7e5390e${_scopeId2}>/auth</code></a></td><td data-v-c7e5390e${_scopeId2}>LFI → API Hub</td><td data-v-c7e5390e${_scopeId2}>Initiate the authorization interaction</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/consents-consentId" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--get" data-v-c7e5390e${_scopeId2}>GET</span><code data-v-c7e5390e${_scopeId2}>/consents/{consentId}</code></a></td><td data-v-c7e5390e${_scopeId2}>LFI → API Hub</td><td data-v-c7e5390e${_scopeId2}>Retrieve the full consent details</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/patch-consents-consentId" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--patch" data-v-c7e5390e${_scopeId2}>PATCH</span><code data-v-c7e5390e${_scopeId2}>/consents/{consentId}</code></a></td><td data-v-c7e5390e${_scopeId2}>LFI → API Hub</td><td data-v-c7e5390e${_scopeId2}>Update consent status, customer identifiers, and the selected debtor account</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--post" data-v-c7e5390e${_scopeId2}>POST</span><code data-v-c7e5390e${_scopeId2}>/auth/{interactionId}/doConfirm</code></a></td><td data-v-c7e5390e${_scopeId2}>LFI → API Hub</td><td data-v-c7e5390e${_scopeId2}>Complete the interaction and redirect back to the TPP successfully</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doFail" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--post" data-v-c7e5390e${_scopeId2}>POST</span><code data-v-c7e5390e${_scopeId2}>/auth/{interactionId}/doFail</code></a></td><td data-v-c7e5390e${_scopeId2}>LFI → API Hub</td><td data-v-c7e5390e${_scopeId2}>Complete the interaction and redirect back to the TPP with a failure</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Full details are in the <a href="/tech/lfi-api-hub/v2.2-rc1/consent-journey/api-guide" data-v-c7e5390e${_scopeId2}>Consent Journey API Guide</a>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>After the consent is authorized</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When the TPP submits a payment instruction to the API Hub&#39;s resource server, the API Hub validates the access token, checks the consent is <code data-v-c7e5390e${_scopeId2}>Authorised</code>, checks the amount/currency match the consent control parameters, and validates the request against the OpenAPI schema — all before forwarding to your Ozone Connect <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--post" data-v-c7e5390e${_scopeId2}>POST</span><code data-v-c7e5390e${_scopeId2}>/payments</code></a> endpoint covered in the next section. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The Hub does <strong data-v-c7e5390e${_scopeId2}>not</strong> decrypt or inspect the PII. Re-validating the PII and matching it against the consent at payment time is the LFI&#39;s responsibility, covered below. `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-c7e5390e${_scopeId}><span class="http-badge http-post" data-v-c7e5390e${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-c7e5390e${_scopeId}>/payments</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--post" data-v-c7e5390e${_scopeId2}>POST</span><code data-v-c7e5390e${_scopeId2}>/payments</code></span> is the central endpoint your LFI implements for payment execution. The API Hub calls it after a TPP payment instruction has passed all Hub-side validations. Your LFI MUST decrypt and validate the PII, match it against the consent, run the synchronous validations listed in <a href="./requirements#post-payments-payment-execution" data-v-c7e5390e${_scopeId2}>POST <code data-v-c7e5390e${_scopeId2}>/payments</code> Requirements</a>, create the payment record, and return <code data-v-c7e5390e${_scopeId2}>201</code> with the assigned <code data-v-c7e5390e${_scopeId2}>PaymentId</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Screening, rail submission, and status propagation happen <strong data-v-c7e5390e${_scopeId2}>after</strong> the <code data-v-c7e5390e${_scopeId2}>201</code> response — see <a href="#after-returning-201" data-v-c7e5390e${_scopeId2}>After returning 201</a>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Common request headers</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Header</th><th data-v-c7e5390e${_scopeId2}>Required</th><th data-v-c7e5390e${_scopeId2}>Description</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-provider-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Identifier for your LFI registered in the Hub</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-aspsp-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes <em data-v-c7e5390e${_scopeId2}>(deprecated)</em></td><td data-v-c7e5390e${_scopeId2}>Deprecated alias for <code data-v-c7e5390e${_scopeId2}>o3-provider-id</code>. Will be removed in a future version — use <code data-v-c7e5390e${_scopeId2}>o3-provider-id</code></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-caller-org-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Organisation ID of the TPP making the underlying request</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-caller-client-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>OIDC client ID of the TPP application</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-caller-software-statement-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Software statement ID of the TPP application</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-api-uri</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The parameterised URL of the API being called by the TPP</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-api-operation</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The HTTP method of the operation carried out by the TPP (<code data-v-c7e5390e${_scopeId2}>POST</code>)</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-ozone-interaction-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Hub-generated interaction ID. Equals <code data-v-c7e5390e${_scopeId2}>o3-caller-interaction-id</code> if the TPP provided one</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-consent-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The <code data-v-c7e5390e${_scopeId2}>consentId</code> for which this call is being made — the lookup key for the stored consent context (see <a href="#matching-the-pii-against-the-consent" data-v-c7e5390e${_scopeId2}>Matching the PII against the consent</a>)</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-psu-identifier</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Base64-encoded customer identifier JSON object — the opaque LFI-issued reference patched onto the consent at authorization</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-caller-interaction-id</code></td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>Interaction ID passed in by the TPP, if present</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-c7e5390e${_scopeId2}> The headers the TPP set on its original call to the API Hub — including <code data-v-c7e5390e${_scopeId2}>x-fapi-customer-ip-address</code>, <code data-v-c7e5390e${_scopeId2}>x-fapi-auth-date</code>, <code data-v-c7e5390e${_scopeId2}>x-fapi-interaction-id</code>, <code data-v-c7e5390e${_scopeId2}>x-customer-user-agent</code>, and <code data-v-c7e5390e${_scopeId2}>x-idempotency-key</code> — are forwarded to your LFI <strong data-v-c7e5390e${_scopeId2}>inside the request body</strong> as <code data-v-c7e5390e${_scopeId2}>requestHeaders</code>, not on the HTTP headers of the API Hub → LFI call. See <a href="#reading-the-fapi-customer-headers" data-v-c7e5390e${_scopeId2}>Reading the FAPI customer headers</a>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Request body</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-c7e5390e${_scopeId2}>Content-Type: application/json</code>`);
                } else {
                  return [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}>Top-level fields</h4>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Field</th><th data-v-c7e5390e${_scopeId2}>Type</th><th data-v-c7e5390e${_scopeId2}>Required</th><th data-v-c7e5390e${_scopeId2}>Description</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>requestUrl</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>The TPP-facing resource URL the TPP called, e.g. <code data-v-c7e5390e${_scopeId2}>https://rs1.[LFICode].apihub.openfinance.ae/open-finance/payment/v2.2/payments</code></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>paymentType</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The payment type. MUST be <code data-v-c7e5390e${_scopeId2}>cbuae-payment</code> for domestic Single Instant Payment</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>request.Data</code></td><td data-v-c7e5390e${_scopeId2}>object</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The payment payload — see <code data-v-c7e5390e${_scopeId2}>request.Data</code> below</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>requestHeaders</code></td><td data-v-c7e5390e${_scopeId2}>object</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The complete set of HTTP headers the TPP sent to the API Hub. The TPP&#39;s FAPI headers live here — see <a href="#reading-the-fapi-customer-headers" data-v-c7e5390e${_scopeId2}>Reading the FAPI customer headers</a></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>tpp</code></td><td data-v-c7e5390e${_scopeId2}>object</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The TPP&#39;s directory record (<code data-v-c7e5390e${_scopeId2}>clientId</code>, <code data-v-c7e5390e${_scopeId2}>orgId</code>, <code data-v-c7e5390e${_scopeId2}>tppId</code>, <code data-v-c7e5390e${_scopeId2}>tppName</code>, <code data-v-c7e5390e${_scopeId2}>softwareStatementId</code>, <code data-v-c7e5390e${_scopeId2}>decodedSsa</code>, optional <code data-v-c7e5390e${_scopeId2}>directoryRecord</code>). Not required for payment execution — see <a href="/knowledge-base/articles/tpp-context-block" data-v-c7e5390e${_scopeId2}>The <code data-v-c7e5390e${_scopeId2}>tpp</code> and <code data-v-c7e5390e${_scopeId2}>decodedSsa</code> Context Blocks</a> for field-by-field detail and the situations where an LFI uses them</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>supplementaryInformation</code></td><td data-v-c7e5390e${_scopeId2}>object</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>Free-form pass-through context. The LFI MUST safely ignore unrecognised properties</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}><code data-v-c7e5390e${_scopeId}>request.Data</code></h4>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Field</th><th data-v-c7e5390e${_scopeId2}>Type</th><th data-v-c7e5390e${_scopeId2}>Required</th><th data-v-c7e5390e${_scopeId2}>Description</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>ConsentId</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The consent the payment is being executed under. MUST equal the <code data-v-c7e5390e${_scopeId2}>o3-consent-id</code> header</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Instruction.Amount.Amount</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Decimal amount with two fraction digits, e.g. <code data-v-c7e5390e${_scopeId2}>100.00</code></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Instruction.Amount.Currency</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>ISO-4217 currency code. MUST be <code data-v-c7e5390e${_scopeId2}>AED</code> for domestic payments</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>PaymentPurposeCode</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>3-letter ISO 20022 purpose code, e.g. <code data-v-c7e5390e${_scopeId2}>ACM</code></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>PersonalIdentifiableInformation</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>Encrypted PII payload as a JWE compact string. Required for the Creditor at payment time — see <a href="#reading-the-pii-at-payment-time" data-v-c7e5390e${_scopeId2}>Reading the PII at payment time</a></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>DebtorReference</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>Reference shown on the debtor&#39;s statement</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>CreditorReference</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>Reference shown on the creditor&#39;s statement</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>OpenFinanceBilling.Type</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Billing type, e.g. <code data-v-c7e5390e${_scopeId2}>Collection</code>, <code data-v-c7e5390e${_scopeId2}>PushP2P</code>, <code data-v-c7e5390e${_scopeId2}>PullP2P</code>, <code data-v-c7e5390e${_scopeId2}>Me2Me</code></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>OpenFinanceBilling.MerchantId</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>Optional merchant identifier</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` For the full schema — including <code data-v-c7e5390e${_scopeId2}>tpp</code> and <code data-v-c7e5390e${_scopeId2}>decodedSsa</code> field-by-field — see the <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments" data-v-c7e5390e${_scopeId2}>POST <code data-v-c7e5390e${_scopeId2}>/payments</code> API Reference</a>. `);
                } else {
                  return [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}>Request example</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: postPaymentsRequestExample,
              lang: "json",
              filename: "POST /payments request body"
            }, null, _parent2, _scopeId));
            _push2(`<h3 id="reading-the-pii-at-payment-time" class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Reading the PII at payment time</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Initiation.Creditor</code> is a single object</strong>, not an array — the consent fixed exactly one creditor at consent time.</li><li data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>DebtorAccount</code> is absent</strong> — the debtor was selected and pinned during consent authorisation.</li><li data-v-c7e5390e${_scopeId2}>The schema to validate against is <code data-v-c7e5390e${_scopeId2}>AEBankServiceInitiation.AEDomesticPaymentPIIProperties</code> in <code data-v-c7e5390e${_scopeId2}>uae-ozone-connect-bank-service-initiation-openapi.yaml</code> — <strong data-v-c7e5390e${_scopeId2}>not</strong> the consent-time schema.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The decrypt + decode flow is identical to consent time — read the <code data-v-c7e5390e${_scopeId2}>kid</code>, decrypt with the matching Enc1 private key, decode the JWS payload. Re-use the helper from <a href="#consent-validation" data-v-c7e5390e${_scopeId2}>Decrypting and validating the PII</a>; only swap the schema: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If decryption fails, reject with <code data-v-c7e5390e${_scopeId2}>400 JWE.DecryptionError</code>. If schema validation fails (missing required field, wrong type, additional property), reject with <code data-v-c7e5390e${_scopeId2}>400 Body.InvalidFormat</code>. `);
                } else {
                  return [
            ...
            _push2(`<h3 id="matching-the-pii-against-the-consent" class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Matching the PII against the consent</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Per <a href="./requirements#post-payments-payment-execution" data-v-c7e5390e${_scopeId2}>POST <code data-v-c7e5390e${_scopeId2}>/payments</code> Requirements</a> rule 2, the submitted creditor at payment time MUST exactly match the single creditor entry that was on the consent at consent time. Mismatch → <code data-v-c7e5390e${_scopeId2}>400 Consent.FailsControlParameters</code>. `);
                } else {
                  return [
                    createTextVNode(" Per "),
                    createVNode("a", { href: "./requirements#post-payments-payment-execution" }, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The link between the payment and the consent is the <code data-v-c7e5390e${_scopeId2}>o3-consent-id</code> request header (also surfaced as <code data-v-c7e5390e${_scopeId2}>request.Data.ConsentId</code> in the body). Two implementation patterns are valid; pick whichever matches your LFI&#39;s persistence model: `);
                } else {
                  return [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}>Pattern A — LFI persisted the decrypted creditor at consent time</h4>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The most common pattern. At consent validation, after you decrypted and validated the consent-time PII, you persisted the single creditor entry keyed by <code data-v-c7e5390e${_scopeId2}>consentId</code>. At payment time you fetch it and deep-compare against the payment-time creditor. `);
                } else {
                  return [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}>Pattern B — LFI did not persist the consent-time PII</h4>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` If your LFI did not persist the decrypted PII at consent time, fetch the consent from the API Hub via <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/consents-consentId" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--get" data-v-c7e5390e${_scopeId2}>GET</span><code data-v-c7e5390e${_scopeId2}>/consents/{consentId}</code></a>, decrypt the consent&#39;s <code data-v-c7e5390e${_scopeId2}>PersonalIdentifiableInformation</code> field, and run the same <code data-v-c7e5390e${_scopeId2}>isExactMatch</code> comparison against <code data-v-c7e5390e${_scopeId2}>Initiation.Creditor[0]</code> (the consent-time creditor is an array of one). `);
                } else {
                  return [
            ...
            _push2(`<h3 id="reading-the-fapi-customer-headers" class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Reading the FAPI customer headers</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The TPP&#39;s FAPI headers (<code data-v-c7e5390e${_scopeId2}>x-fapi-customer-ip-address</code>, <code data-v-c7e5390e${_scopeId2}>x-fapi-auth-date</code>, <code data-v-c7e5390e${_scopeId2}>x-fapi-interaction-id</code>, <code data-v-c7e5390e${_scopeId2}>x-customer-user-agent</code>, <code data-v-c7e5390e${_scopeId2}>x-idempotency-key</code>) are forwarded inside <code data-v-c7e5390e${_scopeId2}>body.requestHeaders</code> — they are not on the actual HTTP headers of the API Hub → LFI call. Read them off the body. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The validated IP is typically logged on the payment record and surfaced to fraud and screening systems alongside <code data-v-c7e5390e${_scopeId2}>x-fapi-auth-date</code> and <code data-v-c7e5390e${_scopeId2}>x-customer-user-agent</code>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Response</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-c7e5390e${_scopeId2}>Content-Type: application/json</code>`);
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Return <code data-v-c7e5390e${_scopeId2}>201</code> on successful payment record creation.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Field</th><th data-v-c7e5390e${_scopeId2}>Type</th><th data-v-c7e5390e${_scopeId2}>Required</th><th data-v-c7e5390e${_scopeId2}>Description</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>data.id</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The LFI-assigned <code data-v-c7e5390e${_scopeId2}>PaymentId</code>. MUST be unique within your payment system, MUST NOT be reassigned, and MUST resolve to the same payment for the full 1-year <span class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--get" data-v-c7e5390e${_scopeId2}>GET</span><code data-v-c7e5390e${_scopeId2}>/payments/{paymentId}</code></span> sustain window — see <a href="./requirements#post-payments-payment-execution" data-v-c7e5390e${_scopeId2}>Rule 7 of POST <code data-v-c7e5390e${_scopeId2}>/payments</code> Requirements</a></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>data.consentId</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>The consent under which the payment was created</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>data.paymentTransactionId</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>End-to-end identifier from the rail. Omit until AANI/UAEFTS has assigned one — do not return an empty string</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>data.status</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>One of <code data-v-c7e5390e${_scopeId2}>Pending</code>, <code data-v-c7e5390e${_scopeId2}>AcceptedSettlementCompleted</code>, <code data-v-c7e5390e${_scopeId2}>AcceptedCreditSettlementCompleted</code>, <code data-v-c7e5390e${_scopeId2}>AcceptedWithoutPosting</code>, <code data-v-c7e5390e${_scopeId2}>Rejected</code>, <code data-v-c7e5390e${_scopeId2}>Received</code></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>data.statusUpdateDateTime</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>ISO 8601 timestamp of the last status update</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>data.creationDateTime</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>ISO 8601 timestamp the payment record was created</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>data.instruction.Amount.amount</code> / <code data-v-c7e5390e${_scopeId2}>Amount.currency</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>The payment amount and currency</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>data.paymentPurposeCode</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The purpose code from the request</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>data.openFinanceBilling.Type</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The billing type from the request</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>meta</code></td><td data-v-c7e5390e${_scopeId2}>object</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>Free-form metadata</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}>Example — successful initiation</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: postPaymentsResponseExample,
              lang: "json",
              filename: "201 Created"
            }, null, _parent2, _scopeId));
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Error responses</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Only return an error when the request is invalid or a server condition prevents you from responding. All error bodies MUST include <code data-v-c7e5390e${_scopeId2}>errorCode</code> and <code data-v-c7e5390e${_scopeId2}>errorMessage</code>. The <code data-v-c7e5390e${_scopeId2}>errorCode</code> values are drawn from the <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments" data-v-c7e5390e${_scopeId2}>POST <code data-v-c7e5390e${_scopeId2}>/payments</code> OpenAPI schema</a> <code data-v-c7e5390e${_scopeId2}>Error400</code> / <code data-v-c7e5390e${_scopeId2}>Error403</code> enums. `);
                } else {
                  return [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}><code data-v-c7e5390e${_scopeId}>400</code> — Bad request</h4>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>errorCode</code></th><th data-v-c7e5390e${_scopeId2}>When to use</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Body.InvalidFormat</code></td><td data-v-c7e5390e${_scopeId2}>Body is absent, not valid JSON, fails schema validation, or <code data-v-c7e5390e${_scopeId2}>x-fapi-customer-ip-address</code> is missing/malformed</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Resource.InvalidFormat</code></td><td data-v-c7e5390e${_scopeId2}>A field is present but not syntactically valid</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Consent.Invalid</code></td><td data-v-c7e5390e${_scopeId2}>The consent referenced by <code data-v-c7e5390e${_scopeId2}>o3-consent-id</code> is unknown to the LFI or has been revoked</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Consent.FailsControlParameters</code></td><td data-v-c7e5390e${_scopeId2}>The payment-time creditor does not match the consent-time creditor</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Consent.BusinessRuleViolation</code></td><td data-v-c7e5390e${_scopeId2}>An LFI-side business rule blocks the payment</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>JWE.DecryptionError</code></td><td data-v-c7e5390e${_scopeId2}>PII JWE cannot be decrypted with any registered Enc1 key</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>JWE.InvalidHeader</code></td><td data-v-c7e5390e${_scopeId2}>PII JWE header is malformed</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>JWS.InvalidSignature</code> / <code data-v-c7e5390e${_scopeId2}>JWS.Malformed</code> / <code data-v-c7e5390e${_scopeId2}>JWS.InvalidClaim</code> / <code data-v-c7e5390e${_scopeId2}>JWS.InvalidHeader</code></td><td data-v-c7e5390e${_scopeId2}>PII inner JWS fails verification (only relevant if you have opted in to verifying the TPP&#39;s signature)</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>GenericRecoverableError</code></td><td data-v-c7e5390e${_scopeId2}>Recoverable validation error not covered above — Hub may retry</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>GenericError</code></td><td data-v-c7e5390e${_scopeId2}>Unrecoverable validation error not covered above</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}><code data-v-c7e5390e${_scopeId}>403</code> — Forbidden</h4>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>errorCode</code></th><th data-v-c7e5390e${_scopeId2}>When to use</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>AccessToken.InvalidScope</code></td><td data-v-c7e5390e${_scopeId2}>The Hub&#39;s token does not include the required scope</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Consent.AccountTemporarilyBlocked</code></td><td data-v-c7e5390e${_scopeId2}>Debtor account is <code data-v-c7e5390e${_scopeId2}>Inactive</code>, <code data-v-c7e5390e${_scopeId2}>Dormant</code>, or <code data-v-c7e5390e${_scopeId2}>Suspended</code></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Consent.PermanentAccountAccessFailure</code></td><td data-v-c7e5390e${_scopeId2}>Debtor account is <code data-v-c7e5390e${_scopeId2}>Closed</code>, <code data-v-c7e5390e${_scopeId2}>Deceased</code>, or <code data-v-c7e5390e${_scopeId2}>Unclaimed</code></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Consent.TransientAccountAccessFailure</code></td><td data-v-c7e5390e${_scopeId2}>Debtor account temporarily inaccessible — Hub may retry after a delay</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>GenericRecoverableError</code> / <code data-v-c7e5390e${_scopeId2}>GenericError</code></td><td data-v-c7e5390e${_scopeId2}>Other forbidden conditions</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}><code data-v-c7e5390e${_scopeId}>409</code> / <code data-v-c7e5390e${_scopeId}>500</code></h4>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-c7e5390e${_scopeId2}>409</code> for conflict conditions and <code data-v-c7e5390e${_scopeId2}>500</code> for transient/unrecoverable server errors. Use <code data-v-c7e5390e${_scopeId2}>GenericRecoverableError</code> if the Hub may retry, <code data-v-c7e5390e${_scopeId2}>GenericError</code> otherwise. `);
                } else {
                  return [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}>Example error response</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: errorResponseExample,
              lang: "json",
              filename: "error response"
            }, null, _parent2, _scopeId));
            _push2(`<h3 id="after-returning-201" class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>After returning 201</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-c7e5390e${_scopeId2}>201</code> returned to the API Hub means the payment record exists at your LFI; it does <strong data-v-c7e5390e${_scopeId2}>not</strong> mean the payment has settled. The lifecycle from here is asynchronous and is the LFI&#39;s responsibility: `);
                } else {
                  return [
                    createTextVNode(" The "),
                    createVNode("code", null, "201"),
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Stage</th><th data-v-c7e5390e${_scopeId2}>LFI behaviour</th><th data-v-c7e5390e${_scopeId2}>Reference</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}>Screening</td><td data-v-c7e5390e${_scopeId2}>Run the LFI&#39;s standard fraud / sanctions / AML controls on the payment record. SHOULD complete within 3 seconds. On a screening failure, immediately PATCH the payment to <code data-v-c7e5390e${_scopeId2}>Rejected</code> with an <code data-v-c7e5390e${_scopeId2}>LFI.</code>-namespaced reject reason</td><td data-v-c7e5390e${_scopeId2}><a href="./requirements#screening-checks" data-v-c7e5390e${_scopeId2}>Screening Checks</a></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}>Rail submission</td><td data-v-c7e5390e${_scopeId2}>Submit to AANI as primary. Fall back to UAEFTS automatically if AANI is unavailable or the receiving bank cannot receive via AANI — no TPP/customer intervention</td><td data-v-c7e5390e${_scopeId2}><a href="./requirements#rail-submission" data-v-c7e5390e${_scopeId2}>Rail Submission</a></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}>Status propagation</td><td data-v-c7e5390e${_scopeId2}>On every rail status change that maps to an Open Finance status, call <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/payment-log" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--patch" data-v-c7e5390e${_scopeId2}>PATCH</span><code data-v-c7e5390e${_scopeId2}>/payment-log/{id}</code></a> on the API Hub Consent Manager. Once AANI/UAEFTS assigns the end-to-end identifier, include it as <code data-v-c7e5390e${_scopeId2}>paymentTransactionId</code> on the next PATCH</td><td data-v-c7e5390e${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/overview/payment-status" data-v-c7e5390e${_scopeId2}>Payment Status</a></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}>Rail rejection</td><td data-v-c7e5390e${_scopeId2}>If the rail rejects the payment, PATCH <code data-v-c7e5390e${_scopeId2}>paymentResponse.status: Rejected</code> with <code data-v-c7e5390e${_scopeId2}>RejectReasonCode.Code</code> namespaced as <code data-v-c7e5390e${_scopeId2}>AANI.</code> or <code data-v-c7e5390e${_scopeId2}>FTS.</code> and a sanitised <code data-v-c7e5390e${_scopeId2}>Message</code> for relay to the TPP</td><td data-v-c7e5390e${_scopeId2}><a href="./requirements#rail-submission" data-v-c7e5390e${_scopeId2}>Rail Submission</a></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}>Status retrieval</td><td data-v-c7e5390e${_scopeId2}>Continue serving <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments-PaymentId" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--get" data-v-c7e5390e${_scopeId2}>GET</span><code data-v-c7e5390e${_scopeId2}>/payments/{paymentId}</code></a> for at least 1 year, with <code data-v-c7e5390e${_scopeId2}>Status</code> and <code data-v-c7e5390e${_scopeId2}>paymentTransactionId</code> consistent with the most recent PATCH</td><td data-v-c7e5390e${_scopeId2}><a href="#behavioural-rules" data-v-c7e5390e${_scopeId2}>GET <code data-v-c7e5390e${_scopeId2}>/payments/{paymentId}</code> rules below</a></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` PATCH delivery is durable: retry transient <code data-v-c7e5390e${_scopeId2}>5xx</code>/timeout failures with exponential backoff; raise <code data-v-c7e5390e${_scopeId2}>4xx</code> failures for operational investigation rather than retrying. `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-c7e5390e${_scopeId}><span class="http-badge http-patch" data-v-c7e5390e${_scopeId}>PATCH</span><code class="ed-doc__endpoint-path" data-v-c7e5390e${_scopeId}>/payment-log/:id</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` This endpoint updates the payment status on the API Hub. The Hub uses the update to send asynchronous notifications to TPPs and to maintain accurate state for billing and limit calculations. The LFI calls it for every Open Finance-relevant status transition after the <code data-v-c7e5390e${_scopeId2}>201</code> has been returned to the Hub on <span class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--post" data-v-c7e5390e${_scopeId2}>POST</span><code data-v-c7e5390e${_scopeId2}>/payments</code></span>. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Request headers</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Header</th><th data-v-c7e5390e${_scopeId2}>Required</th><th data-v-c7e5390e${_scopeId2}>Description</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-provider-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Identifier for your LFI registered in the Hub</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-caller-org-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Organisation ID of the TPP making the underlying request</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-caller-client-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>OIDC client ID of the TPP application</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-api-uri</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The parameterised URL of the API being called by the TPP</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-api-operation</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The HTTP method of the operation carried out by the TPP (<code data-v-c7e5390e${_scopeId2}>PATCH</code>)</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-ozone-interaction-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Hub-generated interaction ID. Equals <code data-v-c7e5390e${_scopeId2}>o3-caller-interaction-id</code> if the TPP provided one</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-consent-id</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>The consent backing this payment</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-psu-identifier</code></td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}>Base64-encoded psuIdentifier JSON object</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>o3-caller-interaction-id</code></td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>Interaction ID passed in by the TPP, if present</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Path parameters</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Parameter</th><th data-v-c7e5390e${_scopeId2}>Type</th><th data-v-c7e5390e${_scopeId2}>Description</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>id</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Identifier of the payment log entry being updated — the <code data-v-c7e5390e${_scopeId2}>data.id</code> returned from <span class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--post" data-v-c7e5390e${_scopeId2}>POST</span><code data-v-c7e5390e${_scopeId2}>/payments</code></span></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Field</th><th data-v-c7e5390e${_scopeId2}>Type</th><th data-v-c7e5390e${_scopeId2}>Required</th><th data-v-c7e5390e${_scopeId2}>Description</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>paymentResponse.status</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes</td><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Pending</code>, <code data-v-c7e5390e${_scopeId2}>AcceptedSettlementCompleted</code>, <code data-v-c7e5390e${_scopeId2}>AcceptedCreditSettlementCompleted</code>, <code data-v-c7e5390e${_scopeId2}>AcceptedWithoutPosting</code>, or <code data-v-c7e5390e${_scopeId2}>Rejected</code>. See <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/overview/payment-status" data-v-c7e5390e${_scopeId2}>Payment Status</a></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>paymentResponse.paymentTransactionId</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Conditional</td><td data-v-c7e5390e${_scopeId2}>The end-to-end identifier assigned by the rail (AANI or UAEFTS). Set on the first PATCH that carries it; once set, MUST NOT change</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>paymentResponse.OpenFinanceBilling.numberOfSuccessfulTransactions</code></td><td data-v-c7e5390e${_scopeId2}>integer</td><td data-v-c7e5390e${_scopeId2}>No</td><td data-v-c7e5390e${_scopeId2}>Number of successful transactions (typically <code data-v-c7e5390e${_scopeId2}>1</code> for a Single Instant Payment)</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>paymentResponse.RejectReasonCode[]</code></td><td data-v-c7e5390e${_scopeId2}>array</td><td data-v-c7e5390e${_scopeId2}>Conditional</td><td data-v-c7e5390e${_scopeId2}>Required when <code data-v-c7e5390e${_scopeId2}>paymentResponse.status</code> is <code data-v-c7e5390e${_scopeId2}>Rejected</code>. Append new reasons rather than replacing — preserves history</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>paymentResponse.RejectReasonCode[].Code</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes (in array)</td><td data-v-c7e5390e${_scopeId2}>Namespaced rejection code: <code data-v-c7e5390e${_scopeId2}>LFI.…</code> for an LFI-side rejection (e.g. screening), <code data-v-c7e5390e${_scopeId2}>AANI.…</code> or <code data-v-c7e5390e${_scopeId2}>FTS.…</code> for a rail rejection. Pattern: <code data-v-c7e5390e${_scopeId2}>^(LFI|AANI|FTS)\\.[A-Za-z0-9]+$</code></td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>paymentResponse.RejectReasonCode[].Message</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>Yes (in array)</td><td data-v-c7e5390e${_scopeId2}>Sanitised, customer-relayable description. MUST NOT reveal detection logic, sanctions matches, or internal case identifiers</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}>Example — successful settlement</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: patchSettlementExample,
              lang: "json",
              filename: "successful settlement"
            }, null, _parent2, _scopeId));
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}>Example — rail rejection</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: patchRailRejectionExample,
              lang: "json",
              filename: "rail rejection"
            }, null, _parent2, _scopeId));
            _push2(`<h4 class="ed-doc__subhead ed-doc__subhead--small" data-v-c7e5390e${_scopeId}>Example — LFI screening rejection</h4>`);
            _push2(ssrRenderComponent(_component_EdCode, {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` A successful PATCH returns <code data-v-c7e5390e${_scopeId2}>204 No Content</code> with no body. See the <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/payment-log" data-v-c7e5390e${_scopeId2}>PATCH <code data-v-c7e5390e${_scopeId2}>/payment-log/:id</code> API Reference</a> for the full schema. `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-c7e5390e${_scopeId}><span class="http-badge http-get" data-v-c7e5390e${_scopeId}>GET</span><code class="ed-doc__endpoint-path" data-v-c7e5390e${_scopeId}>/payments/:paymentId</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Backs the TPP request <code data-v-c7e5390e${_scopeId2}>GET https://rs1.LFICODE.apihub.openfinance.ae/open-finance/payment/v2.2/payments/{PaymentId}</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Returns the current state of a payment your LFI created via <span class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--post" data-v-c7e5390e${_scopeId2}>POST</span><code data-v-c7e5390e${_scopeId2}>/payments</code></span>. The TPP polls this to observe screening outcomes, rail settlement, and any subsequent rejection. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`See <a href="#post-payments" data-v-c7e5390e${_scopeId2}>Common request headers</a>.`);
                } else {
                  return [
                    createTextVNode("See "),
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Parameter</th><th data-v-c7e5390e${_scopeId2}>Type</th><th data-v-c7e5390e${_scopeId2}>Description</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>paymentId</code></td><td data-v-c7e5390e${_scopeId2}>string</td><td data-v-c7e5390e${_scopeId2}>The <code data-v-c7e5390e${_scopeId2}>PaymentId</code> your LFI returned from <span class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--post" data-v-c7e5390e${_scopeId2}>POST</span><code data-v-c7e5390e${_scopeId2}>/payments</code></span></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The response shape mirrors the <span class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--post" data-v-c7e5390e${_scopeId2}>POST</span><code data-v-c7e5390e${_scopeId2}>/payments</code></span> <code data-v-c7e5390e${_scopeId2}>201</code> response — same <code data-v-c7e5390e${_scopeId2}>data</code> envelope, with the current <code data-v-c7e5390e${_scopeId2}>Status</code>, <code data-v-c7e5390e${_scopeId2}>paymentTransactionId</code> (once assigned by the rail), and any rejection details. `);
                } else {
                  return [
            ...
            _push2(`<h3 id="behavioural-rules" class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Behavioural rules</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Per <a href="./requirements#get-payments-paymentid-payment-status-retrieval" data-v-c7e5390e${_scopeId2}>GET <code data-v-c7e5390e${_scopeId2}>/payments/{paymentId}</code> Requirements</a>: `);
                } else {
                  return [
                    createTextVNode(" Per "),
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>#</th><th data-v-c7e5390e${_scopeId2}>Rule</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}>1</td><td data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>Sustain period</strong> — Serve <span class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--get" data-v-c7e5390e${_scopeId2}>GET</span><code data-v-c7e5390e${_scopeId2}>/payments/{paymentId}</code></span> for at least <strong data-v-c7e5390e${_scopeId2}>1 year from the payment&#39;s creation date</strong>. Within this window, the response MUST reflect the current status, including any later screening, rail, or reversal outcomes</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}>2</td><td data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}>Status consistency with the API Hub</strong> — The <code data-v-c7e5390e${_scopeId2}>Status</code> returned MUST exactly match the most recent value PATCHed to the API Hub Consent Manager via <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/consent-manager/open-api/payment-log" class="endpoint" data-v-c7e5390e${_scopeId2}><span class="http-method http-method--patch" data-v-c7e5390e${_scopeId2}>PATCH</span><code data-v-c7e5390e${_scopeId2}>/payment-log/{id}</code></a>. Any change in the LFI&#39;s systems MUST be reflected on both surfaces before it becomes observable to the TPP</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}>3</td><td data-v-c7e5390e${_scopeId2}><strong data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>paymentTransactionId</code> consistency</strong> — Once the rail has assigned the end-to-end identifier and the LFI has PATCHed it to the Consent Manager, this endpoint MUST return the same value. Before assignment, omit the field entirely — do not return an empty string</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-c7e5390e${_scopeId}>Errors</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-c7e5390e${_scopeId2}><thead data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><th data-v-c7e5390e${_scopeId2}>Status</th><th data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>errorCode</code></th><th data-v-c7e5390e${_scopeId2}>When to use</th></tr></thead><tbody data-v-c7e5390e${_scopeId2}><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>404</code></td><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Resource.NotFound</code></td><td data-v-c7e5390e${_scopeId2}>No payment exists for the supplied <code data-v-c7e5390e${_scopeId2}>paymentId</code> (or the payment exists but belongs to a different consent)</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>403</code></td><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>Consent.AccountTemporarilyBlocked</code> / <code data-v-c7e5390e${_scopeId2}>Consent.PermanentAccountAccessFailure</code></td><td data-v-c7e5390e${_scopeId2}>The debtor account has become inaccessible since the payment was created</td></tr><tr data-v-c7e5390e${_scopeId2}><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>500</code></td><td data-v-c7e5390e${_scopeId2}><code data-v-c7e5390e${_scopeId2}>GenericRecoverableError</code> / <code data-v-c7e5390e${_scopeId2}>GenericError</code></td><td data-v-c7e5390e${_scopeId2}>Transient or unrecoverable server error</td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/open-api/payments-PaymentId" data-v-c7e5390e${_scopeId2}>GET <code data-v-c7e5390e${_scopeId2}>/payments/{paymentId}</code> API Reference</a> for the full schema. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/single-instant-payment/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c7e5390e"]]);
export {
  apiGuide as default
};
