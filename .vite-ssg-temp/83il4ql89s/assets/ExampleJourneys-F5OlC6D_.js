...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "wf-frame" }, _attrs))} data-v-12fa6922>`);
  _push(ssrRenderComponent(_component_ConsentAuthLayout, null, {
    consent: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_ConsentDefinedSchedule, { scheduleType: "fixed" }, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_ConsentDefinedSchedule, { scheduleType: "fixed" })
        ];
      }
    }),
    auth: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_AuthorizationDefinedSchedule, { scheduleType: "fixed" }, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_AuthorizationDefinedSchedule, { scheduleType: "fixed" })
        ];
      }
    }),
    _: 1
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-defined-schedule/_shared/WireframePreview.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const WireframePreview = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-12fa6922"]]);
const _sfc_main$2 = {};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-defined-schedule/_shared/AccountSetup.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_EdRefTable, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<table${_scopeId}><thead${_scopeId}><tr${_scopeId}><th${_scopeId}>Field</th><th${_scopeId}>UI Label</th><th${_scopeId}>Behaviour</th></tr></thead><tbody${_scopeId}><tr${_scopeId}><td${_scopeId}><code${_scopeId}>PaymentExecutionDate</code></td><td${_scopeId}><em${_scopeId}>Date</em></td><td${_scopeId}>The specific date on which this payment may be executed. Each date must be unique across the schedule.</td></tr><tr${_scopeId}><td${_scopeId}><code${_scopeId}>Amount</code></td><td${_scopeId}><em${_scopeId}>Per Payment</em></td><td${_scopeId}>The amount allowed for a single payment. Always shown.</td></tr><tr${_scopeId}><td${_scopeId}><em${_scopeId}>(implicit)</em></td><td${_scopeId}><em${_scopeId}>Payments per Date</em></td><td${_scopeId}>Only 1 payment is allowed per <code${_scopeId}>PaymentExecutionDate</code>. Always enforced.</td></tr></tbody></table>`);
      } else {
        return [
          createVNode("table", null, [
            createVNode("thead", null, [
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-defined-schedule/_shared/UIBehaviour.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_ImageViewer, {
    src: "/images/user-experience/fixed-defined-schedule/1.png",
    alt: "fixed-defined-schedule"
  }, null, _parent));
  _push(`<h3>Example 2 — Account Selected at LFI</h3>`);
  _push(ssrRenderComponent(_component_ImageViewer, {
    src: "/images/user-experience/fixed-defined-schedule/2.png",
    alt: "fixed-defined-schedule"
  }, null, _parent));
  _push(`<h3>Example 3 — Account Selected at LFI (Less Control Parameters)</h3>`);
  _push(ssrRenderComponent(_component_ImageViewer, {
    src: "/images/user-experience/fixed-defined-schedule/3.png",
    alt: "fixed-defined-schedule"
  }, null, _parent));
  _push(`<h3>Example 4 — Account Selected at LFI (Large Schedule)</h3>`);
  _push(ssrRenderComponent(_component_ImageViewer, {
    src: "/images/user-experience/fixed-defined-schedule/4.png",
    alt: "fixed-defined-schedule"
  }, null, _parent));
  _push(`<!--]-->`);
}
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/fixed-defined-schedule/_shared/ExampleJourneys.vue");
