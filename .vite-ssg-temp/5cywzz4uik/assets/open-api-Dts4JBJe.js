  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_EndpointPage, mergeProps({
        eyebrow: "TPP · Webhooks · Insurance Quote Status",
        title: "Insurance Quote Status Change Event",
        version: "v2.2-rc1",
        method: "POST",
        path: "[subscription.Webhook.Url]"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_RedocWrapper, {
              spec: "/openapi/v2.2-rc1/standards/uae-webhook-template-openapi.yaml",
              patchSchemas,
              overrideServers
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/webhooks/insurance-status/open-api.vue");
