...
const exampleCleartextResponse = `{
  ...
  "Links": {
    "Self": "https://rs1.altareq1.sandbox.apihub.openfinance.ae/open-finance/v2.2/accounts/acc-001/product"
  },
  "Meta": { "TotalPages": 1 }
}
`;
...
const productResponse = await fetch(
  \`\${LFI_API_BASE}/open-finance/v2.2/accounts/\${accountId}/product\`,
  {
    headers: {
...
product_response = httpx.get(
    f"{LFI_API_BASE}/open-finance/v2.2/accounts/{account_id}/product",
    headers={
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-1b1bb0e9><section class="ed-doc__hero" data-v-1b1bb0e9><div class="ed-doc__inner" data-v-1b1bb0e9><div class="ed-doc__eyebrow" data-v-1b1bb0e9><span class="ed-doc__eyebrow-dash" data-v-1b1bb0e9></span> TPP · Banking · Bank Data Sharing · API Guide </div><h1 class="ed-doc__title" data-v-1b1bb0e9> Encrypted FinanceRates <span class="ed-doc__read" data-v-1b1bb0e9>6 min read</span></h1><p class="ed-doc__lede" data-v-1b1bb0e9> When a TPP holds the <code data-v-1b1bb0e9>ReadProductFinanceRates</code> permission and calls <code data-v-1b1bb0e9>GET /accounts/{AccountId}/product</code> for a credit card, finance, or mortgage account, the LFI MAY return the <code data-v-1b1bb0e9>FinanceRates</code> field as an encrypted JWE rather than a structured object. The TPP MUST present the rates to the customer without the unencrypted values ever reaching or being stored on its servers — decryption happens locally on the user&#39;s device using a one-time code sent to the customer by the LFI. </p></div></section>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code> field on <a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-product" data-v-1b1bb0e9${_scopeId2}><code data-v-1b1bb0e9${_scopeId2}>GET /accounts/{AccountId}/product</code></a> is defined as <code data-v-1b1bb0e9${_scopeId2}>anyOf</code> a structured <code data-v-1b1bb0e9${_scopeId2}>AEProductFinanceRates</code> object or an <code data-v-1b1bb0e9${_scopeId2}>AEJwe</code> compact string. Each LFI decides, per product, whether to return the rate in cleartext or as an encrypted JWE. A TPP holding <code data-v-1b1bb0e9${_scopeId2}>ReadProductFinanceRates</code> MUST therefore be ready for either shape on every call. `);
                } else {
                  return [
                    createTextVNode(" The "),
                    createVNode("code", null, "FinanceRates"),
                    createTextVNode(" field on "),
                    createVNode("a", { href: "/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-product" }, [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>Cleartext</strong> — <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code> is a JSON object. Render the rates directly. No special handling required. </li><li data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>Encrypted (JWE)</strong> — <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code> is a compact JWE string. The TPP server MUST forward this opaque string to the user&#39;s device without inspecting, logging, or persisting it. Decryption happens in the browser using a one-time code the LFI sends to the customer. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>The <em data-v-1b1bb0e9${_scopeId2}>Access Encrypted Resource Data</em> optional certification</strong> — the TPP MUST hold this certification with Nebras <em data-v-1b1bb0e9${_scopeId2}>before</em> it requests <code data-v-1b1bb0e9${_scopeId2}>ReadProductFinanceRates</code> on any consent. An uncertified TPP MUST NOT include <code data-v-1b1bb0e9${_scopeId2}>ReadProductFinanceRates</code> in the <code data-v-1b1bb0e9${_scopeId2}>authorization_details</code> at consent creation; the API Hub rejects the consent if it does. See <a href="/tech/tpp-standards/production/testing-certification/optional/access-encrypted-resource-data" data-v-1b1bb0e9${_scopeId2}> Access Encrypted Resource Data</a>. </li><li data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>A consent that includes <code data-v-1b1bb0e9${_scopeId2}>ReadProductFinanceRates</code></strong> — this permission MUST be requested in the <code data-v-1b1bb0e9${_scopeId2}>authorization_details</code> when the TPP creates the consent. See <a href="/tech/tpp-standards/v2.2-rc1/banking/data-sharing/api-guide#step-1-authorization-details" data-v-1b1bb0e9${_scopeId2}> Step 1 — Constructing Authorization Details</a>. </li><li data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>An active customer-present session</strong> — when the consent carries <code data-v-1b1bb0e9${_scopeId2}>ReadProductFinanceRates</code>, the TPP MUST only call <code data-v-1b1bb0e9${_scopeId2}>GET /accounts/{AccountId}/product</code> while the customer is actively using the TPP application. Background or scheduled calls are not permitted on a consent that carries this permission, because the encrypted-rate flow requires the customer to receive and enter the one-time code in real time. </li><li data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>A valid access token and the FAPI headers for a customer-present call</strong> — <code data-v-1b1bb0e9${_scopeId2}>x-fapi-interaction-id</code>, <code data-v-1b1bb0e9${_scopeId2}>x-fapi-auth-date</code>, and <code data-v-1b1bb0e9${_scopeId2}>x-fapi-customer-ip-address</code>. Because the call is always customer-present (see above), <code data-v-1b1bb0e9${_scopeId2}>x-fapi-customer-ip-address</code> MUST be set to the customer&#39;s device IP on every request; omitting it is not permitted on this endpoint when the consent carries <code data-v-1b1bb0e9${_scopeId2}>ReadProductFinanceRates</code>. See <a href="/tech/tpp-standards/security/request-headers" data-v-1b1bb0e9${_scopeId2}>Request Headers</a>. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
                    ...
                    createVNode("li", null, [
                      ...
                      createVNode("a", { href: "/tech/tpp-standards/v2.2-rc1/banking/data-sharing/api-guide#step-1-authorization-details" }, " Step 1 — Constructing Authorization Details"),
                      createTextVNode(". ")
                    ]),
                    createVNode("li", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-1b1bb0e9${_scopeId}><span class="http-badge http-get" data-v-1b1bb0e9${_scopeId}>GET</span><code class="ed-doc__endpoint-path" data-v-1b1bb0e9${_scopeId}>/accounts/{AccountId}/product</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-1b1bb0e9${_scopeId}>Example response — cleartext</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: exampleCleartextResponse,
              lang: "json",
              filename: "cleartext FinanceRates"
            }, null, _parent2, _scopeId));
            _push2(`<h3 class="ed-doc__subhead" data-v-1b1bb0e9${_scopeId}>Example response — encrypted JWE</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Apart from <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code>, every other field in the response is returned in cleartext in both shapes — <code data-v-1b1bb0e9${_scopeId2}>Charges</code>, <code data-v-1b1bb0e9${_scopeId2}>DepositRates</code>, <code data-v-1b1bb0e9${_scopeId2}>ProductName</code>, <code data-v-1b1bb0e9${_scopeId2}>Tenor</code>, and so on. Only <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code> is ever encrypted. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-1b1bb0e9${_scopeId2}> The encrypted JWE is opaque to the TPP. Pass it through to the browser response and discard the server-side copy as soon as the response is sent. Do not write the JWE to application logs, request traces, or analytics pipelines — even though it is encrypted, persisting it would put the TPP in scope of the encrypted-rate handling requirements documented in <a href="/tech/tpp-standards/production/testing-certification/optional/access-encrypted-resource-data" data-v-1b1bb0e9${_scopeId2}> Access Encrypted Resource Data</a>. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When the LFI returns an encrypted <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code>, it also sends a one-time code to the customer directly, through a channel the LFI controls — an SMS, an email, or a push notification in the LFI&#39;s banking app. The TPP MUST display an input field where the customer can type that code, and a short explanation that matches the wording shown to the customer on the consent screen (“Your bank has sent you a one-time code — enter it below to see your finance rate”). `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-1b1bb0e9${_scopeId}>What the customer receives</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The LFI sends the code to the customer directly — the TPP never sees it. The message names the product, names your <code data-v-1b1bb0e9${_scopeId2}>TradingName</code> so the customer can tie it back to your application, and carries a 30-minute validity. Knowing the shape of the message helps you word your own prompt consistently with what the customer is reading on their phone: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>Customer-present only</strong> — this flow only works when the customer is actively using the TPP. Do not call <code data-v-1b1bb0e9${_scopeId2}>GET /accounts/{AccountId}/product</code> on a schedule when you require the encrypted rate; there is no way to decrypt the JWE without the customer entering the OTP. </li><li data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>Display the rate types you are about to reveal</strong> — tell the customer which product the OTP unlocks (for example, “Platinum Credit Card — purchase APR”). </li><li data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>Offer to resend</strong> — if the customer does not receive the code, the TPP may re-call <code data-v-1b1bb0e9${_scopeId2}>GET /accounts/{AccountId}/product</code> to ask the LFI to issue a fresh code. Respect the rate limits described in <a href="#rate-limits" data-v-1b1bb0e9${_scopeId2}>Step 6 — Rate limits and retries</a>. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The JWE is encrypted with <strong data-v-1b1bb0e9${_scopeId2}>PBES2-HS512+A256KW</strong> for key wrapping and <strong data-v-1b1bb0e9${_scopeId2}>A256GCM</strong> for content encryption. The customer&#39;s one-time code is the PBES2 password; the JWE header carries the salt and iteration count, so the TPP does not need any additional material to decrypt. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The JWE carries a fixed 30-minute lifetime as an <code data-v-1b1bb0e9${_scopeId2}>exp</code> claim inside its plaintext, set by the LFI. Within that window the TPP MAY re-decrypt and re-render the rate as the customer navigates between screens, provided the OTP is still held in browser memory. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Decryption does not stop working when the window closes — a JWE and its OTP can technically be decrypted at any later time, so the 30-minute limit is not enforced by the cryptography. The TPP MUST enforce it: after decrypting, the TPP MUST read the <code data-v-1b1bb0e9${_scopeId2}>exp</code> claim from the plaintext and MUST NOT display the rate, or re-decrypt it for display, once <code data-v-1b1bb0e9${_scopeId2}>exp</code> has passed. This obligation is part of the TPP&#39;s <a href="/tech/tpp-standards/production/testing-certification/optional/access-encrypted-resource-data" data-v-1b1bb0e9${_scopeId2}> Access Encrypted Resource Data</a> certification. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-1b1bb0e9${_scopeId2}> The OTP keeps working after 30 minutes — nothing in the JWE itself prevents a late decryption. The window is held closed only by the TPP checking <code data-v-1b1bb0e9${_scopeId2}>exp</code> and by the certification commitments the TPP makes to Nebras. Treating <code data-v-1b1bb0e9${_scopeId2}>exp</code> as advisory, or relying on decryption to “just fail”, is a certification breach. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When the window closes mid-session, prompt the customer to request a fresh code via a new call to <code data-v-1b1bb0e9${_scopeId2}>GET /accounts/{AccountId}/product</code> rather than continuing to show a stale rate. The customer&#39;s consent is unaffected — only the 30-minute display window has expired. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Each call to <code data-v-1b1bb0e9${_scopeId2}>GET /accounts/{AccountId}/product</code> that returns an encrypted <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code> triggers a fresh OTP to the customer. LFIs MUST rate-limit these requests per consent to prevent OTP spam, while leaving enough headroom for legitimate retries (a code not received, a typo, an expired window). `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-1b1bb0e9${_scopeId2}><thead data-v-1b1bb0e9${_scopeId2}><tr data-v-1b1bb0e9${_scopeId2}><th data-v-1b1bb0e9${_scopeId2}>Rule</th><th data-v-1b1bb0e9${_scopeId2}>Limit</th><th data-v-1b1bb0e9${_scopeId2}>Rationale</th></tr></thead><tbody data-v-1b1bb0e9${_scopeId2}><tr data-v-1b1bb0e9${_scopeId2}><td data-v-1b1bb0e9${_scopeId2}>Minimum interval between requests</td><td data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>60 seconds</strong> per consent per account</td><td data-v-1b1bb0e9${_scopeId2}>Lets the customer ask for a fresh OTP if the first code is delayed, without enabling rapid-fire spam.</td></tr><tr data-v-1b1bb0e9${_scopeId2}><td data-v-1b1bb0e9${_scopeId2}>Daily cap</td><td data-v-1b1bb0e9${_scopeId2}><strong data-v-1b1bb0e9${_scopeId2}>12 fresh OTPs</strong> per consent per account per rolling 24 hours</td><td data-v-1b1bb0e9${_scopeId2}>Covers retries and repeated re-display across the day, and acts as a backstop against runaway message volume rather than a limit normal traffic should approach.</td></tr><tr data-v-1b1bb0e9${_scopeId2}><td data-v-1b1bb0e9${_scopeId2}>Decryption attempts</td><td data-v-1b1bb0e9${_scopeId2}>Unbounded within the 30-minute window of a single JWE</td><td data-v-1b1bb0e9${_scopeId2}>Re-decrypting an already-issued JWE in the customer&#39;s browser does not contact the LFI and so is not rate-limited.</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-1b1bb0e9${_scopeId}>Handling the 429 response</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` When either limit is breached, the LFI rejects the entire <code data-v-1b1bb0e9${_scopeId2}>GET /accounts/{AccountId}/product</code> request with <code data-v-1b1bb0e9${_scopeId2}>429 Too Many Requests</code>. The API Hub forwards the response unchanged, so the TPP receives the same status and headers the LFI emitted — HTTP <code data-v-1b1bb0e9${_scopeId2}>429</code>, no response body, a <code data-v-1b1bb0e9${_scopeId2}>Retry-After</code> header containing the integer seconds until the next call would succeed, and the echoed <code data-v-1b1bb0e9${_scopeId2}>x-fapi-interaction-id</code> for correlation. `);
                } else {
                  return [
...
`
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-1b1bb0e9${_scopeId2}> Read <code data-v-1b1bb0e9${_scopeId2}>Retry-After</code> and surface a customer-facing message that includes the wait — &quot;Please wait about a minute and try again&quot; for short waits, &quot;You&#39;ve reached today&#39;s limit for viewing this rate — please try again later&quot; when the daily cap is the cause. </li><li data-v-1b1bb0e9${_scopeId2}> Do not auto-retry inside the wait window. The LFI will reject again and the customer will receive another code request that cannot succeed. </li><li data-v-1b1bb0e9${_scopeId2}> A <code data-v-1b1bb0e9${_scopeId2}>429</code> never means the consent is invalid — it means too many fresh OTPs have been requested in too short a window. Other Data Sharing endpoints continue to work normally for this consent during the wait. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-1b1bb0e9${_scopeId2}> If the TPP did not request <code data-v-1b1bb0e9${_scopeId2}>ReadProductFinanceRates</code> on the consent, the response is a normal <code data-v-1b1bb0e9${_scopeId2}>200</code> with the <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code> field simply absent from the <code data-v-1b1bb0e9${_scopeId2}>Product</code> object — not a <code data-v-1b1bb0e9${_scopeId2}>429</code>, not a <code data-v-1b1bb0e9${_scopeId2}>403</code>. Treat these as two distinct conditions in your UI: permission-not-granted should prompt the customer to grant the permission on a new consent; <code data-v-1b1bb0e9${_scopeId2}>429</code> should prompt them to wait. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-1b1bb0e9${_scopeId2}> The TPP MUST NOT transmit, store, log, or otherwise process the unencrypted <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code> on its servers in any form or capacity. The decrypted value lives only in the customer&#39;s browser session. </li><li data-v-1b1bb0e9${_scopeId2}> The TPP MUST perform all decryption of <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code> locally on the user&#39;s device, solely for the purpose of displaying the rate to the customer. </li><li data-v-1b1bb0e9${_scopeId2}> The TPP MUST NOT interact with the encrypted or unencrypted <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code> in any manner other than as described in this guide. </li><li data-v-1b1bb0e9${_scopeId2}> The TPP MUST submit its architectural plan for decryption and display of <code data-v-1b1bb0e9${_scopeId2}>FinanceRates</code> — including the relevant browser-side source — to Nebras for inspection and approval as part of the <a href="/tech/tpp-standards/production/testing-certification/optional/access-encrypted-resource-data" data-v-1b1bb0e9${_scopeId2}> Access Encrypted Resource Data</a> certification. Material changes to that process post go-live require Nebras sign-off before they are deployed. </li><li data-v-1b1bb0e9${_scopeId2}> The TPP MUST present the decrypted rate accurately and in context — for example, labelling a credit card APR as “purchase APR” rather than “interest rate” — so the customer sees the rate faithfully as the LFI provided it. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/data-sharing/api-guide/finance-rates.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const financeRates = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1b1bb0e9"]]);
export {
