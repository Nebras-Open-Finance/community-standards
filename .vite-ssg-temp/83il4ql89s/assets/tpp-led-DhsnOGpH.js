...
import { _ as _sfc_main$1 } from "./APIFlowsInsuranceQuotationTPPLed-D4CODUSF.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-4f53ae3c><section class="ed-doc__hero" data-v-4f53ae3c><div class="ed-doc__inner" data-v-4f53ae3c><div class="ed-doc__eyebrow" data-v-4f53ae3c><span class="ed-doc__eyebrow-dash" data-v-4f53ae3c></span> TPP · Insurance · Quotation · TPP-Led </div><h1 class="ed-doc__title" data-v-4f53ae3c> TPP-Led Flow <span class="ed-doc__read" data-v-4f53ae3c>8 min read</span></h1><p class="ed-doc__lede" data-v-4f53ae3c> You collect quote inputs, KYC, and surface the LFI’s hosted payment URL to the customer inside your own app. Document delivery also lives with you. The LFI handles underwriting, payment hosting, and policy issuance; your TPP is the customer-facing surface for everything else. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Obtain a Client Credentials token (<code data-v-4f53ae3c${_scopeId2}>insurance</code> scope) and POST the quote request exactly as in <a href="./lfi-led" data-v-4f53ae3c${_scopeId2}>LFI-Led</a>. The mode is not declared on Create Quote — it’s determined by the LFI’s response to PATCH Accept. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customer picks a quote; PATCH it with the accept data and your <code data-v-4f53ae3c${_scopeId2}>Subscription.Webhook</code>. The LFI’s response signals whether the flow is TPP-Led: a <code data-v-4f53ae3c${_scopeId2}>200</code> response with <code data-v-4f53ae3c${_scopeId2}>data.PolicyIssuanceAllowed</code> means you are responsible for the steps listed as <code data-v-4f53ae3c${_scopeId2}>true</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` All three flags <code data-v-4f53ae3c${_scopeId2}>true</code> is the full TPP-Led mode. You MUST honour the declaration — do not perform a step set to <code data-v-4f53ae3c${_scopeId2}>false</code> even if you can technically do so. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` After <code data-v-4f53ae3c${_scopeId2}>ApplicationPending</code> arrives, collect the customer’s KYC in your app (see <a href="../user-journeys#tpp-led-kyc" data-v-4f53ae3c${_scopeId2}>User Journeys — KYC capture</a> for the screens to present). Submit by PATCHing the same quote endpoint a second time with the gathered data. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The body conforms to the sector’s accept-quote schema. Required fields vary by sector — consult the <a href="../open-api/patch-motor-insurance-quotes-QuoteId" data-v-4f53ae3c${_scopeId2}>OpenAPI spec</a>. If KYC fails, you receive <code data-v-4f53ae3c${_scopeId2}>400</code> with a descriptive message; surface it to the customer and allow retry. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The LFI processes KYC asynchronously and, on success, emits <code data-v-4f53ae3c${_scopeId2}>ApplicationApproved</code> with a <code data-v-4f53ae3c${_scopeId2}>BrokerInstructions[].Url</code> pointing at its hosted payment page. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Redirect the customer to <code data-v-4f53ae3c${_scopeId2}>BrokerInstructions[0].Url</code>. They pay on the LFI’s page; the LFI redirects them back to a return URL you nominated when configuring your webhook or out-of-band with the LFI. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-4f53ae3c${_scopeId2}> Do not cache, log, or replay the URL. If the customer abandons and returns, request a fresh URL by asking the LFI to re-emit (typically via your support process or by re-triggering the flow). The LFI will emit a new <code data-v-4f53ae3c${_scopeId2}>PaymentRequired</code> event. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` After payment confirmation (which you can correlate with the customer’s return from the LFI’s payment page or by waiting for the LFI’s next status event), call POST <code data-v-4f53ae3c${_scopeId2}>/{type}-insurance-policies</code> with the <code data-v-4f53ae3c${_scopeId2}>QuoteId</code>. The body is similar to the KYC submission but represents the formal policy creation request. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The LFI runs its issuance and responds <code data-v-4f53ae3c${_scopeId2}>201</code>. The <code data-v-4f53ae3c${_scopeId2}>InsurancePolicyId</code> and policy documents arrive in the subsequent <code data-v-4f53ae3c${_scopeId2}>PolicyIssued</code> event — not in this response body. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` In TPP-Led mode the <code data-v-4f53ae3c${_scopeId2}>PolicyIssued</code> event carries every customer-facing document the LFI would normally deliver itself. Verify each <code data-v-4f53ae3c${_scopeId2}>Hash</code> against the decoded <code data-v-4f53ae3c${_scopeId2}>Content</code> before presenting to the customer. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-4f53ae3c${_scopeId}>Hash verification</h3>`);
            _push2(ssrRenderComponent(_component_EdCode, {
              code: verifyHashNode,
              lang: "ts",
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-4f53ae3c${_scopeId2}> If a document’s computed hash does not match the supplied <code data-v-4f53ae3c${_scopeId2}>Hash</code>, treat the document as corrupt or tampered. Do not surface it to the customer. Log the <code data-v-4f53ae3c${_scopeId2}>x-fapi-interaction-id</code> from the event delivery, raise a support ticket including that ID and the <code data-v-4f53ae3c${_scopeId2}>QuoteId</code>, and request the LFI re-emit the event. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` On <code data-v-4f53ae3c${_scopeId2}>Completed</code>, finalise the policy in your records, surface it as live to the customer, and reconcile any commission against the event’s <code data-v-4f53ae3c${_scopeId2}>Commission</code> block. <code data-v-4f53ae3c${_scopeId2}>PaymentMethod: ThroughAPIHub</code> means the Hub will route payment to you; the commission and timing are governed by the <a href="/pricing/" data-v-4f53ae3c${_scopeId2}>AlTareq Commercial and Pricing Model</a>. `);
                } else {
                  return [
                    createTextVNode(" On "),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` No further events follow. You can let the subscription lapse, or explicitly PATCH the quote with <code data-v-4f53ae3c${_scopeId2}>IsActive: false</code> if you prefer to clean up — though no further events would be sent regardless. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/insurance/quotation/api-guide/tpp-led.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const tppLed = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4f53ae3c"]]);
export {
  tppLed as default
};
