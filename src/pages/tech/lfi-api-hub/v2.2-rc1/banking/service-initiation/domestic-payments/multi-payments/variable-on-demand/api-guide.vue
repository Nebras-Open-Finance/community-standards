    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          ...
          The customer authorises the consent once &mdash; approving the per-payment maximum and periodic
    ...
    >
      ...
      <EdNote type="warning" title="Customer-set FAPI headers are inside the body, not the HTTP request">
        <p>
          ...
          <code>x-fapi-customer-ip-address</code> on every payment &mdash; the customer may not be
