...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const principles = [
      ...
      },
      {
        ...
        detail: `Unlike an LFI's online channels which may require authentication for login and again
             ...
             <a href="/tech/lfi-api-hub/v2.2-rc1/consent-journey/authentication/sca#step-up-authentication-for-payment-consents">step-up authentication for payment consents</a>.`
      },
      {
        num: 4,
        name: "No obstacles",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-92a3d2d8><section class="ed-doc__hero" data-v-92a3d2d8><div class="ed-doc__inner" data-v-92a3d2d8><div class="ed-doc__eyebrow" data-v-92a3d2d8><span class="ed-doc__eyebrow-dash" data-v-92a3d2d8></span> LFI · Consent Journey · Authentication </div><h1 class="ed-doc__title" data-v-92a3d2d8> Authentication <span class="ed-doc__read" data-v-92a3d2d8>3 min read</span></h1><p class="ed-doc__lede" data-v-92a3d2d8> When a TPP initiates a consent journey, the API Hub redirects the end user (Payment Services User) to the LFI&#39;s <strong data-v-92a3d2d8>Authorization Endpoint</strong> so the end user can prove their identity. This is the <strong data-v-92a3d2d8>authentication</strong> step — the end user demonstrates to the LFI that they are who they claim to be, using the same credentials and methods they use when accessing the LFI&#39;s own digital channels. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-92a3d2d8> Authentication is distinct from <a href="/tech/lfi-api-hub/v2.2-rc1/consent-journey/authorization/" data-v-92a3d2d8>authorization</a>, which is the subsequent step where the authenticated end user reviews and approves the consent (e.g. selecting accounts, confirming a payment). </p></div></section>`);
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<ol class="ed-doc__flow" data-v-92a3d2d8${_scopeId}><!--[-->`);
            ssrRenderList(flowSteps, (s) => {
              _push2(`<li data-v-92a3d2d8${_scopeId}><span class="ed-doc__flow-num" data-v-92a3d2d8${_scopeId}>${ssrInterpolate(s.num)}</span><span class="ed-doc__flow-text" data-v-92a3d2d8${_scopeId}>${s.text ?? ""}</span></li>`);
            });
            _push2(`<!--]--></ol>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<ol class="ed-doc__principles" data-v-92a3d2d8${_scopeId}><!--[-->`);
            ssrRenderList(principles, (p) => {
              _push2(`<li data-v-92a3d2d8${_scopeId}><header class="ed-doc__principle-head" data-v-92a3d2d8${_scopeId}><span class="ed-doc__principle-num" data-v-92a3d2d8${_scopeId}>${ssrInterpolate(p.num.toString().padStart(2, "0"))}</span><h3 class="ed-doc__principle-name" data-v-92a3d2d8${_scopeId}>${ssrInterpolate(p.name)}</h3></header><p class="ed-doc__principle-detail" data-v-92a3d2d8${_scopeId}>${p.detail ?? ""}</p></li>`);
            });
            _push2(`<!--]--></ol>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The LFI&#39;s <strong data-v-92a3d2d8${_scopeId2}>Authorization Endpoint</strong> MUST support two scenarios based on the end user&#39;s device: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-92a3d2d8${_scopeId2}><thead data-v-92a3d2d8${_scopeId2}><tr data-v-92a3d2d8${_scopeId2}><th data-v-92a3d2d8${_scopeId2}>Scenario</th><th data-v-92a3d2d8${_scopeId2}>Behaviour</th></tr></thead><tbody data-v-92a3d2d8${_scopeId2}><!--[-->`);
                  ssrRenderList(scenarios, (s) => {
                    _push3(`<tr data-v-92a3d2d8${_scopeId2}><td data-v-92a3d2d8${_scopeId2}><strong data-v-92a3d2d8${_scopeId2}>${ssrInterpolate(s.scenario)}</strong></td><td data-v-92a3d2d8${_scopeId2}>${ssrInterpolate(s.behaviour)}</td></tr>`);
                  });
                  _push3(`<!--]--></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__sub" data-v-92a3d2d8${_scopeId}>Immediate authentication challenge</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-92a3d2d8${_scopeId2}><thead data-v-92a3d2d8${_scopeId2}><tr data-v-92a3d2d8${_scopeId2}><th data-v-92a3d2d8${_scopeId2}>Channel</th><th data-v-92a3d2d8${_scopeId2}>What “immediate” means</th></tr></thead><tbody data-v-92a3d2d8${_scopeId2}><!--[-->`);
                  ssrRenderList(immediate, (r) => {
                    _push3(`<tr data-v-92a3d2d8${_scopeId2}><td data-v-92a3d2d8${_scopeId2}><strong data-v-92a3d2d8${_scopeId2}>${ssrInterpolate(r.channel)}</strong></td><td data-v-92a3d2d8${_scopeId2}>${r.meaning ?? ""}</td></tr>`);
                  });
                  _push3(`<!--]--></tbody></table>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__nextcards" data-v-92a3d2d8${_scopeId}><a href="/tech/lfi-api-hub/v2.2-rc1/consent-journey/authentication/sca" class="ed-doc__nextcard" data-v-92a3d2d8${_scopeId}><span class="ed-doc__nextcard-tag" data-v-92a3d2d8${_scopeId}>Standards</span><h3 class="ed-doc__nextcard-title" data-v-92a3d2d8${_scopeId}>Strong Customer Authentication</h3><p class="ed-doc__nextcard-desc" data-v-92a3d2d8${_scopeId}> SCA requirements, prohibited methods, and CBUAE regulatory alignment. </p><span class="ed-doc__nextcard-arrow" data-v-92a3d2d8${_scopeId}>→</span></a><a href="/tech/lfi-api-hub/v2.2-rc1/consent-journey/authentication/implementation" class="ed-doc__nextcard" data-v-92a3d2d8${_scopeId}><span class="ed-doc__nextcard-tag" data-v-92a3d2d8${_scopeId}>Guide</span><h3 class="ed-doc__nextcard-title" data-v-92a3d2d8${_scopeId}>Implementation Guide</h3><p class="ed-doc__nextcard-desc" data-v-92a3d2d8${_scopeId}> Best-practice approaches for biometric authentication, device binding, and step-up flows. </p><span class="ed-doc__nextcard-arrow" data-v-92a3d2d8${_scopeId}>→</span></a></div>`);
          } else {
            return [
              createVNode("div", { class: "ed-doc__nextcards" }, [
                createVNode("a", {
                  href: "/tech/lfi-api-hub/v2.2-rc1/consent-journey/authentication/sca",
                ...
                createVNode("a", {
                  href: "/tech/lfi-api-hub/v2.2-rc1/consent-journey/authentication/implementation",
                  class: "ed-doc__nextcard"
                }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/consent-journey/authentication/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-92a3d2d8"]]);
export {
  index as default
};
