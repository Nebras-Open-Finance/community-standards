    ...
    >
      ...
      <EdBullets>
        ...
        <li>
          ...
          <a href="/tech/lfi-api-hub/v2.2-draft/banking/service-initiation/domestic-payments/single-instant-payment/api-guide">Service
          Initiation API Guide</a>. Multi-authorization applies after the first authorizer has
          completed their step.
        </li>
        <li>
          <strong>Understanding of the
          <a href="/tech/lfi-api-hub/v2.2-draft/consent-journey/api-guide">Consent Journey</a></strong>
