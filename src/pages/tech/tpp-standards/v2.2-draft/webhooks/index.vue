        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td><a href="/tech/tpp-standards/v2.2-draft/webhooks/consent-status/api-guide">Consent Status Event</a></td>
            </tr>
            <tr>
              <td>Payment Status</td>
              <td>Payment status update on a consent with <code>subscription.Webhook.IsActive: true</code></td>
              <td><a href="/tech/tpp-standards/v2.2-draft/webhooks/payment-status/api-guide">Payment Status Event</a></td>
            </tr>
            <tr>
              ...
              <td><a href="/tech/tpp-standards/v2.2-draft/webhooks/insurance-status/api-guide">Insurance Quote Status Event</a></td>
            </tr>
          </tbody>
        </table>
      </EdRefTable>
    ...
    <section class="ed-doc__contents">
      <div class="ed-doc__inner">
        ...
        <div class="ed-doc__contents-grid">
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/webhooks/consent-status/api-guide" :style="{ '--card-color': 'var(--at-teal)' }">
          ...
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/webhooks/payment-status/api-guide" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
            <span class="ed-link-card__top" />
            <div class="ed-link-card__meta"><span class="ed-link-card__cat">Sub-section</span></div>
          ...
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/webhooks/insurance-status/api-guide" :style="{ '--card-color': 'var(--at-violet, #6d28d9)' }">
            <span class="ed-link-card__top" />
            <div class="ed-link-card__meta"><span class="ed-link-card__cat">Sub-section</span></div>
