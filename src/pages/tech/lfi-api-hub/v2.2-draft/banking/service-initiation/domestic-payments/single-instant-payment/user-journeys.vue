...
import WireframePreview from '../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/single-instant-payment/_shared/WireframePreview.vue'
import AccountSetup from '../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/single-instant-payment/_shared/AccountSetup.vue'
import UIBehaviour from '../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/single-instant-payment/_shared/UIBehaviour.vue'
import ExampleJourneys from '../../../../../../tpp-standards/v2.2-draft/banking/service-initiation/domestic-payments/single-instant-payment/_shared/ExampleJourneys.vue'
...
const myCustomValidator = (value) => {
  if (
    ...
    value.Data.ControlParameters.ConsentSchedule.SinglePayment.Type !== 'SingleInstantPayment' ||
  ...
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          When a customer is redirected to you to authorize an Open Finance consent for a single instant
          payment, you must present an <strong>Authorization Page</strong> that clearly explains the payment
          the customer is authorizing. The page must collect the customer's explicit and informed consent,
          and it must accurately reflect the payee, amount, schedule, and all material terms of the payment
          consent.
        </p>
    ...
    >
      ...
      <EditableJson
        ...
        endpoint-href="/openapi-drafts/v2.2-draft/uae-api-hub-consent-manager-openapi.yaml"
