    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_EndpointPage, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ofp-schema-toolbar" data-v-5f4901e3${_scopeId}>`);
            _push2(ssrRenderComponent(_component_RouterLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span aria-hidden="true" data-v-5f4901e3${_scopeId2}>←</span> Back to OFP-002 `);
                } else {
                  return [
            ...
            _push2(`<button type="button" class="ofp-schema-download" data-v-5f4901e3${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-5f4901e3${_scopeId}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" data-v-5f4901e3${_scopeId}></path><polyline points="7 10 12 15 17 10" data-v-5f4901e3${_scopeId}></polyline><line x1="12" y1="15" x2="12" y2="3" data-v-5f4901e3${_scopeId}></line></svg> Download .yaml </button></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/internal/proposals/ofp-002/international-schema.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const internationalSchema = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5f4901e3"]]);
export {
  internationalSchema as default
};
