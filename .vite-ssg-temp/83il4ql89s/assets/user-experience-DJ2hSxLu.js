...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-25061fab><section class="ed-doc__hero" data-v-25061fab><div class="ed-doc__inner" data-v-25061fab><div class="ed-doc__eyebrow" data-v-25061fab><span class="ed-doc__eyebrow-dash" data-v-25061fab></span> TPP · CMI · Bank Data Sharing · UX </div><h1 class="ed-doc__title" data-v-25061fab> Bank Data Sharing — User Experience <span class="ed-doc__read" data-v-25061fab>2 min read</span></h1><p class="ed-doc__lede" data-v-25061fab> The TPP Consent Management Interface for Bank Data Sharing consents. Users see their connected accounts, the data permissions they granted, and can pause, reactivate, or revoke at any time. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-25061fab> While you may adapt visual elements such as colour palette, fonts, and styling to align with your brand, you must not alter the meaning, clarity, or completeness of the consent management content. The representation of <strong data-v-25061fab>AlTareq</strong> — including logos, naming, and action buttons — must be preserved. Your Consent Management Interface must be submitted as part of <strong data-v-25061fab>CX certification</strong> prior to production, and any material changes to a production CMI must be re-submitted for review and approval. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="ed-doc__previews" data-v-25061fab${_scopeId2}><figure class="ed-doc__preview" data-v-25061fab${_scopeId2}>`);
            ...
            _push2(`<h3 class="ed-doc__sub" data-v-25061fab${_scopeId}>Configure simulated consents and watch the preview respond</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__examples" data-v-25061fab${_scopeId}><!--[-->`);
            ssrRenderList(examples, (ex) => {
              _push2(`<figure class="ed-doc__example" data-v-25061fab${_scopeId}><figcaption class="ed-doc__example-caption" data-v-25061fab${_scopeId}><span class="ed-doc__example-num" data-v-25061fab${_scopeId}>Example ${ssrInterpolate(ex.num)}</span><span class="ed-doc__example-title" data-v-25061fab${_scopeId}>${ssrInterpolate(ex.title)}</span></figcaption>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/consent/consent-management-interface/bank-data-sharing/user-experience.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userExperience = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-25061fab"]]);
export {
