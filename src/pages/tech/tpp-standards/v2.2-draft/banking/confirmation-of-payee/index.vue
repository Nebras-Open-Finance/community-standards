      ...
      <div class="ed-landing__inner">
        <div class="ed-landing__contents-head">
          ...
          <p class="ed-landing__contents-sub">
            ...
            <a href="/tech/tpp-standards/v2.2-draft/banking/confirmation-of-payee/user-journeys">User Journeys</a> for the required consent and authorisation page behaviour.
          </p>
        </div>
    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/banking/confirmation-of-payee/requirements" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
          ...
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/banking/confirmation-of-payee/api-guide" :style="{ '--card-color': 'var(--at-teal)' }">
            <span class="ed-link-card__top" />
          ...
          <a class="ed-link-card" href="/tech/tpp-standards/v2.2-draft/banking/confirmation-of-payee/user-journeys" :style="{ '--card-color': 'var(--at-navy)' }">
            <span class="ed-link-card__top" />
