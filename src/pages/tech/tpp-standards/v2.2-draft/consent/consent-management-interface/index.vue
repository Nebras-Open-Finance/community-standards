    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          TPP Standards · v2.2-draft · Consent · Consent Management Interface
        </div>
      ...
      <div class="ed-doc__levels">
        <article class="ed-doc__level">
          ...
          <p class="ed-doc__level-body">
            ...
            pages for
            <a href="/tech/tpp-standards/v2.2-draft/consent/consent-management-interface/bank-data-sharing/requirements">Bank Data Sharing</a>,
            <a href="/tech/tpp-standards/v2.2-draft/consent/consent-management-interface/bank-service-initiation/requirements">Bank Service Initiation</a>, and
            <a href="/tech/tpp-standards/v2.2-draft/consent/consent-management-interface/insurance-data-sharing/requirements">Insurance Data Sharing</a>.
          </p>
          <p class="ed-doc__level-body">
      ...
      <ol class="ed-doc__steps">
        ...
        <li>
          ...
          <ul class="ed-doc__substeps">
            <li>
              Data Sharing:
              <a href="/tech/tpp-standards/v2.2-draft/consent/open-api/patch-account-access-consents-ConsentId" class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/account-access-consents/{ConsentId}</code></a>
            </li>
            <li>
              Service Initiation:
              <a href="/tech/tpp-standards/v2.2-draft/consent/open-api/patch-payment-consents-ConsentId" class="endpoint"><span class="http-method http-method--patch">PATCH</span><code>/payment-consents/{ConsentId}</code></a>
            </li>
          </ul>
        </li>
      </ol>
