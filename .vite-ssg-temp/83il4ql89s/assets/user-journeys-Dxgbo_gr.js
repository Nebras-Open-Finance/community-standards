...
import { W as WireframePreview, A as AccountSetup, U as UIBehaviour, E as ExampleJourneys } from "./ExampleJourneys-CU9aUvE2.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const myCustomValidator = (value) => {
      if (!value.Data || !value.Data.ControlParameters || !value.Data.ControlParameters.ConsentSchedule || !value.Data.ControlParameters.ConsentSchedule.SinglePayment || value.Data.ControlParameters.ConsentSchedule.SinglePayment.Type !== "SingleInstantPayment" || value.Data.ControlParameters.ConsentSchedule.MultiPayment || value.Data.ControlParameters.ConsentSchedule.FilePayment) {
        return "Data.ControlParameters.ConsentSchedule.SinglePayment.Type must be 'SingleInstantPayment'";
      }
      if ((() => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-e144ccfa><section class="ed-doc__hero" data-v-e144ccfa><div class="ed-doc__inner" data-v-e144ccfa><div class="ed-doc__eyebrow" data-v-e144ccfa><span class="ed-doc__eyebrow-dash" data-v-e144ccfa></span> Banking · Service Initiation · Single Instant Payment · UX </div><h1 class="ed-doc__title" data-v-e144ccfa> Single Instant Payment — User Experience <span class="ed-doc__read" data-v-e144ccfa>4 min read</span></h1><p class="ed-doc__lede" data-v-e144ccfa> When a customer is redirected to you to authorize an Open Finance consent for a single instant payment, you must present an <strong data-v-e144ccfa>Authorization Page</strong> that clearly explains the payment the customer is authorizing. The page must collect the customer&#39;s explicit and informed consent, and it must accurately reflect the payee, amount, schedule, and all material terms of the payment consent. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-e144ccfa> The examples and interactive wireframes provided below define the expected structure, content, and behavior of the Authorization Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-e144ccfa> While you may adapt visual elements such as color palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the payment information shown. The representation of <strong data-v-e144ccfa>AlTareq</strong> (including logos, naming, and action buttons) must be preserved at all times. The customer must be able to clearly understand what payment they are authorizing and that the authorization is part of the AlTareq ecosystem. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-e144ccfa> Your Authorization Page must be submitted as part of <strong data-v-e144ccfa>CX certification</strong> prior to production. Any material changes to a production Authorization Page must also be resubmitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the request body fields below and watch the <strong data-v-e144ccfa${_scopeId2}>Consent</strong> and <strong data-v-e144ccfa${_scopeId2}>Authorisation</strong> page previews update live. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EditableJson, {
              ...
              "endpoint-href": "/openapi/v2.2-rc1/api-hub/uae-api-hub-consent-manager-openapi.yaml",
            ...
            _push2(`<div class="sim-card" data-v-e144ccfa${_scopeId}><div class="sim-card__head" data-v-e144ccfa${_scopeId}>Simulated Accounts Behaviour</div><div class="sim-card__body" data-v-e144ccfa${_scopeId}><label class="sim-card__row" data-v-e144ccfa${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(simulateDuplicatePayment)) ? ssrLooseContain(unref(simulateDuplicatePayment), null) : unref(simulateDuplicatePayment)) ? " checked" : ""} data-v-e144ccfa${_scopeId}><span data-v-e144ccfa${_scopeId}>Duplicate Payment Alert</span></label><label class="sim-card__row" data-v-e144ccfa${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(simulatePaymentLimitExceeded)) ? ssrLooseContain(unref(simulatePaymentLimitExceeded), null) : unref(simulatePaymentLimitExceeded)) ? " checked" : ""} data-v-e144ccfa${_scopeId}><span data-v-e144ccfa${_scopeId}>Payment Limit Exceeded</span></label><label class="sim-card__row" data-v-e144ccfa${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(simulateAlreadyTrustedPayee)) ? ssrLooseContain(unref(simulateAlreadyTrustedPayee), null) : unref(simulateAlreadyTrustedPayee)) ? " checked" : ""} data-v-e144ccfa${_scopeId}><span data-v-e144ccfa${_scopeId}>Already a Trusted Payee</span></label></div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/banking/service-initiation/domestic-payments/single-instant-payment/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e144ccfa"]]);
export {
