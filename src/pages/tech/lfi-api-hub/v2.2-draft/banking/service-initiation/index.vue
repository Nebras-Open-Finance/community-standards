...
const SI_BASE = '/tech/lfi-api-hub/v2.2-draft/banking/service-initiation'
    ...
    <section class="ed-landing__live">
      <div class="ed-landing__inner">
        <div class="ed-landing__live-head">
          ...
          <h2 class="ed-landing__live-title">Who's initiating Payments</h2>
          <p class="ed-landing__live-sub">TPPs currently submitting payments across UAE Open Finance.</p>
        </div>
