    ...
    <section class="ed-landing__contents">
      <div class="ed-landing__inner">
        ...
        <div class="ed-landing__contents-grid">
          <a class="ed-link-card" href="/tech/lfi-api-hub/v2.2-rc1/banking/products-and-leads/requirements" :style="{ '--card-color': 'var(--at-gold, #b08800)' }">
          ...
          <a class="ed-link-card" href="/tech/lfi-api-hub/v2.2-rc1/banking/products-and-leads/api-guide" :style="{ '--card-color': 'var(--at-teal)' }">
            <span class="ed-link-card__top" />
