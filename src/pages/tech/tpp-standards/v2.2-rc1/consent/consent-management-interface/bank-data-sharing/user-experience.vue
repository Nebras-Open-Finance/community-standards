...
<template>
  <div class="ed-doc">
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        <div class="ed-doc__eyebrow">
          ...
          TPP &middot; CMI &middot; Bank Data Sharing &middot; UX
        </div>
        ...
        <p class="ed-doc__lede">
          The TPP Consent Management Interface for Bank Data Sharing consents. Users see their
          connected accounts, the data permissions they granted, and can pause, reactivate, or
          revoke at any time.
        </p>
    ...
    <EdSectionBand
      ...
      title="AlTareq Connections &mdash; Data Sharing view"
      tone="cream"
    >
      <EdProse>
        The component below shows the AlTareq Connections page filtered to Data Sharing consents.
        Tap any consent card to open its details and manage it.
      </EdProse>
