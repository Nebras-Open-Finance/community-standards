...
import { r as rememberSignInReturn, _ as _export_sfc, b as block0 } from "../main.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-f9dd938b>`);
      if (!unref(org)) {
        _push(`<section class="ed-doc-gate" data-v-f9dd938b><div class="ed-doc-gate__inner" data-v-f9dd938b><h2 class="ed-doc-gate__title" data-v-f9dd938b>Organisation not found</h2><p class="ed-doc-gate__sub" data-v-f9dd938b> No organisation matches <strong data-v-f9dd938b>${ssrInterpolate(unref(orgId))}</strong>. </p>`);
        ...
        if (unref(sessionLoading) || unref(redirecting)) {
          _push(`<section class="ed-doc-gate" data-v-f9dd938b><div class="ed-doc-gate__inner" data-v-f9dd938b><div class="ed-doc-gate__spinner" data-v-f9dd938b></div><div class="ed-doc-gate__text" data-v-f9dd938b>${ssrInterpolate(unref(redirecting) ? "Redirecting to sign-in…" : "Checking access…")}</div></div></section>`);
        } else if (unref(loopDetected)) {
          _push(`<section class="ed-doc-gate" data-v-f9dd938b><div class="ed-doc-gate__inner" data-v-f9dd938b><h2 class="ed-doc-gate__title" data-v-f9dd938b>Sign-in didn&#39;t complete</h2><p class="ed-doc-gate__sub" data-v-f9dd938b> We tried to sign you in but the session didn&#39;t stick. Try again, and if this keeps happening, check that third-party cookies are allowed for this site. </p><button type="button" class="ed-doc-button" data-v-f9dd938b>Try again</button></div></section>`);
        } else if (unref(sessionError)) {
          _push(`<section class="ed-doc-gate" data-v-f9dd938b><div class="ed-doc-gate__inner" data-v-f9dd938b><h2 class="ed-doc-gate__title" data-v-f9dd938b>Couldn&#39;t load this page</h2><p class="ed-doc-gate__sub" data-v-f9dd938b><strong data-v-f9dd938b>${ssrInterpolate(unref(sessionError))}</strong></p><button type="button" class="ed-doc-button" data-v-f9dd938b>Try again</button></div></section>`);
        } else {
          _push(`<!--[--><section class="ed-doc-back" data-v-f9dd938b><div class="ed-doc-back__inner" data-v-f9dd938b>`);
          _push(ssrRenderComponent(_component_router_link, {
            to: "/doc-repository/",
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="ed-doc-back__arrow" data-v-f9dd938b${_scopeId}>←</span><span class="ed-doc-back__text" data-v-f9dd938b${_scopeId}>All organisations</span>`);
              } else {
                return [
          ...
          _push(`</div></section><section class="ed-doc-hero" style="${ssrRenderStyle({ "--accent": unref(typeColor) })}" data-v-f9dd938b><div class="ed-doc-hero__inner" data-v-f9dd938b><div class="ed-doc-hero__main" data-v-f9dd938b>`);
          if (unref(typeLabel)) {
            _push(`<div class="ed-doc-hero__label" data-v-f9dd938b><span class="ed-doc-hero__label-dash" data-v-f9dd938b></span> ${ssrInterpolate(unref(typeLabel))}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="ed-doc-hero__head" data-v-f9dd938b>`);
          if (unref(orgLogo)) {
            _push(`<img${ssrRenderAttr("src", unref(orgLogo))}${ssrRenderAttr("alt", unref(orgName))} class="ed-doc-hero__logo" data-v-f9dd938b>`);
          } else {
            _push(`<div class="ed-doc-hero__logo ed-doc-hero__logo--placeholder" data-v-f9dd938b>${ssrInterpolate(unref(orgName).charAt(0))}</div>`);
          }
          _push(`<div data-v-f9dd938b><h1 class="ed-doc-hero__title" data-v-f9dd938b>${ssrInterpolate(unref(orgName))}</h1>`);
          if (unref(orgLegalName) && unref(orgLegalName) !== unref(orgName)) {
            _push(`<p class="ed-doc-hero__legal" data-v-f9dd938b>${ssrInterpolate(unref(orgLegalName))}</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div><p class="ed-doc-hero__sub" data-v-f9dd938b> Documents published by this organisation as part of UAE Open Finance. Public documents are visible to all participants. Protected documents are visible to this organisation and any other organisation it chooses to share with. Private documents are visible only to authorised users within this organisation. </p></div></div></section><section class="ed-doc-body" data-v-f9dd938b><div class="ed-doc-body__inner" data-v-f9dd938b><div class="ed-doc-tabs" role="tablist" data-v-f9dd938b><button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(activeTab) === "public")} class="${ssrRenderClass([{ "ed-doc-tab--active": unref(activeTab) === "public" }, "ed-doc-tab"])}" style="${ssrRenderStyle(unref(activeTab) === "public" ? { background: unref(typeColor), borderColor: unref(typeColor), color: "var(--at-bg-cream)" } : {})}" data-v-f9dd938b><svg class="ed-doc-tab__icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" data-v-f9dd938b><circle cx="12" cy="12" r="10" data-v-f9dd938b></circle><path d="M2 12h20" data-v-f9dd938b></path><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" data-v-f9dd938b></path></svg> Public Documents <span class="ed-doc-tab__count" data-v-f9dd938b>(${ssrInterpolate(unref(publicFiles).length)})</span></button>`);
          if (unref(canSeeProtected)) {
            _push(`<button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(activeTab) === "protected")} class="${ssrRenderClass([{ "ed-doc-tab--active": unref(activeTab) === "protected" }, "ed-doc-tab"])}" style="${ssrRenderStyle(unref(activeTab) === "protected" ? { background: unref(typeColor), borderColor: unref(typeColor), color: "var(--at-bg-cream)" } : {})}" data-v-f9dd938b><svg class="ed-doc-tab__icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" data-v-f9dd938b><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" data-v-f9dd938b></path></svg> Protected Documents <span class="ed-doc-tab__count" data-v-f9dd938b>(${ssrInterpolate(unref(protectedFiles).length)})</span></button>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(canSeePrivate)) {
            _push(`<button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(activeTab) === "private")} class="${ssrRenderClass([{ "ed-doc-tab--active": unref(activeTab) === "private" }, "ed-doc-tab"])}" style="${ssrRenderStyle(unref(activeTab) === "private" ? { background: unref(typeColor), borderColor: unref(typeColor), color: "var(--at-bg-cream)" } : {})}" data-v-f9dd938b><svg class="ed-doc-tab__icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" data-v-f9dd938b><rect x="3" y="11" width="18" height="11" rx="2" ry="2" data-v-f9dd938b></rect><path d="M7 11V7a5 5 0 0 1 10 0v4" data-v-f9dd938b></path></svg> Private Documents <span class="ed-doc-tab__count" data-v-f9dd938b>(${ssrInterpolate(unref(privateFiles).length)})</span></button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
          if (unref(isNebras) && !UPLOADS_ENABLED) {
            _push(`<div class="ed-doc-upload" data-v-f9dd938b><div class="ed-doc-upload__empty" data-v-f9dd938b> Document uploads are currently disabled. </div></div>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(isNebras) && UPLOADS_ENABLED) ;
          ...
          if (unref(activeTab) === "protected" && unref(canManageGrants)) {
            _push(`<div class="ed-doc-share" data-v-f9dd938b><div class="ed-doc-share__head" data-v-f9dd938b><span class="ed-doc-share__title" data-v-f9dd938b>Shared with</span><span class="ed-doc-share__hint" data-v-f9dd938b> Choose which organisations can read ${ssrInterpolate(unref(orgName))}&#39;s protected documents. Any member of a shared organisation gains access. </span></div>`);
            if (unref(grantsLoading)) {
              _push(`<div class="ed-doc-share__empty" data-v-f9dd938b>Loading shares…</div>`);
            } else {
              _push(`<!--[-->`);
              if (unref(grantedOrgs).length) {
                _push(`<div class="ed-doc-share__chips" data-v-f9dd938b><!--[-->`);
                ssrRenderList(unref(grantedOrgs), (g) => {
                  _push(`<span class="ed-doc-share__chip" data-v-f9dd938b>${ssrInterpolate(g.name)} <button type="button" class="ed-doc-share__chip-remove"${ssrIncludeBooleanAttr(unref(grantsSaving)) ? " disabled" : ""}${ssrRenderAttr("aria-label", `Stop sharing with ${g.name}`)} data-v-f9dd938b>×</button></span>`);
                });
                _push(`<!--]--></div>`);
              } else {
                _push(`<div class="ed-doc-share__empty" data-v-f9dd938b> Not shared with any organisation yet. Only ${ssrInterpolate(unref(orgName))} and Nebras can see these documents. </div>`);
              }
              _push(`<div class="ed-doc-share__row" data-v-f9dd938b><select class="ed-doc-upload__select"${ssrIncludeBooleanAttr(unref(grantsSaving)) ? " disabled" : ""} data-v-f9dd938b><option value="" disabled data-v-f9dd938b${ssrIncludeBooleanAttr(Array.isArray(unref(grantSelect)) ? ssrLooseContain(unref(grantSelect), "") : ssrLooseEqual(unref(grantSelect), "")) ? " selected" : ""}>Add an organisation…</option><!--[-->`);
              ssrRenderList(unref(ungrantedOrgs), (o) => {
                _push(`<option${ssrRenderAttr("value", o.id)} data-v-f9dd938b${ssrIncludeBooleanAttr(Array.isArray(unref(grantSelect)) ? ssrLooseContain(unref(grantSelect), o.id) : ssrLooseEqual(unref(grantSelect), o.id)) ? " selected" : ""}>${ssrInterpolate(o.name)}</option>`);
              });
              _push(`<!--]--></select><button type="button" class="ed-doc-button"${ssrIncludeBooleanAttr(unref(grantsSaving) || !unref(grantSelect)) ? " disabled" : ""} data-v-f9dd938b>${ssrInterpolate(unref(grantsSaving) ? "Saving…" : "Add")}</button></div>`);
              if (unref(grantsError)) {
                _push(`<div class="ed-doc-upload__error" data-v-f9dd938b>${ssrInterpolate(unref(grantsError))}</div>`);
              } else {
                _push(`<!---->`);
              }
              if (unref(grantsSuccess)) {
                _push(`<div class="ed-doc-upload__success" data-v-f9dd938b>${ssrInterpolate(unref(grantsSuccess))}</div>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
          ...
          _push(`<div class="ed-doc-search" data-v-f9dd938b><svg class="ed-doc-search__icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" data-v-f9dd938b><circle cx="11" cy="11" r="8" data-v-f9dd938b></circle><path d="m21 21-4.35-4.35" data-v-f9dd938b></path></svg><input${ssrRenderAttr("value", unref(search))} class="ed-doc-search__input" type="search" placeholder="Search documents…" aria-label="Search documents" data-v-f9dd938b>`);
          if (unref(search)) {
            _push(`<button type="button" class="ed-doc-search__clear" aria-label="Clear search" data-v-f9dd938b>×</button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
          if (unref(activeLoading)) {
            _push(`<div class="ed-doc-list" data-v-f9dd938b><!--[-->`);
            ssrRenderList(3, (n) => {
              _push(`<div class="ed-doc-row ed-doc-row--skeleton" data-v-f9dd938b><span class="ed-doc-skel ed-doc-skel--name" data-v-f9dd938b></span><span class="ed-doc-skel ed-doc-skel--meta" data-v-f9dd938b></span><span class="ed-doc-skel ed-doc-skel--btn" data-v-f9dd938b></span></div>`);
            });
            _push(`<!--]--></div>`);
          } else if (unref(activeError)) {
            _push(`<div class="ed-doc-list" data-v-f9dd938b><div class="ed-doc-empty" data-v-f9dd938b> Could not load documents: <strong data-v-f9dd938b>${ssrInterpolate(unref(activeError))}</strong></div></div>`);
          } else {
            _push(`<!--[--><!--[-->`);
            ssrRenderList(unref(filteredMonthlyGroups), (group) => {
              _push(`<section class="ed-doc-group" data-v-f9dd938b><div class="ed-doc-group__head" data-v-f9dd938b><h2 class="ed-doc-group__title" data-v-f9dd938b>${ssrInterpolate(group.label)}</h2><span class="ed-doc-group__count" data-v-f9dd938b>${ssrInterpolate(monthCount(group))} ${ssrInterpolate(monthCount(group) === 1 ? "month" : "months")}</span></div><div class="ed-doc-list" data-v-f9dd938b><!--[-->`);
              ssrRenderList(group.items, (item) => {
                _push(`<div class="ed-doc-row" data-v-f9dd938b><div class="ed-doc-row__icon" style="${ssrRenderStyle({ borderColor: unref(typeColor), color: unref(typeColor) })}" data-v-f9dd938b><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" data-v-f9dd938b><rect x="3" y="4" width="18" height="18" rx="2" ry="2" data-v-f9dd938b></rect><line x1="16" y1="2" x2="16" y2="6" data-v-f9dd938b></line><line x1="8" y1="2" x2="8" y2="6" data-v-f9dd938b></line><line x1="3" y1="10" x2="21" y2="10" data-v-f9dd938b></line></svg></div><div class="ed-doc-row__body" data-v-f9dd938b><h3 class="ed-doc-row__title" data-v-f9dd938b>${ssrInterpolate(formatMonth(item.month))}`);
                if (item.typeLabel) {
                  _push(`<!--[--> · ${ssrInterpolate(item.typeLabel)}<!--]-->`);
                } else {
                  _push(`<!---->`);
                }
                _push(`</h3><div class="ed-doc-row__meta" data-v-f9dd938b>`);
                if (fileType(item.entry.file)) {
                  _push(`<span data-v-f9dd938b>${ssrInterpolate(fileType(item.entry.file))}</span>`);
                } else {
                  _push(`<!---->`);
                }
                if (fileType(item.entry.file) && item.entry.date) {
                  _push(`<span class="ed-doc-row__sep" data-v-f9dd938b>·</span>`);
                } else {
                  _push(`<!---->`);
                }
                if (item.entry.date) {
                  _push(`<span data-v-f9dd938b>Uploaded ${ssrInterpolate(formatDate(item.entry.date))}</span>`);
                } else {
                  _push(`<!---->`);
                }
                if (expiryInfo(item.entry)) {
                  _push(`<!--[--><span class="ed-doc-row__sep" data-v-f9dd938b>·</span><span class="${ssrRenderClass([`ed-doc-row__expiry--${expiryInfo(item.entry).state}`, "ed-doc-row__expiry"])}" data-v-f9dd938b>${ssrInterpolate(expiryInfo(item.entry).text)}</span><!--]-->`);
                } else {
                  _push(`<!---->`);
                }
                _push(`</div></div><button type="button" class="ed-doc-button" data-v-f9dd938b> Download </button></div>`);
              });
              _push(`<!--]--></div></section>`);
            });
            _push(`<!--]-->`);
            if (unref(filteredFiles).length) {
              ...
              ssrRenderList(unref(filteredFiles), (file) => {
                _push(`<div class="ed-doc-row" data-v-f9dd938b><div class="ed-doc-row__icon" style="${ssrRenderStyle({ borderColor: unref(typeColor), color: unref(typeColor) })}" data-v-f9dd938b><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" data-v-f9dd938b><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" data-v-f9dd938b></path><polyline points="14 2 14 8 20 8" data-v-f9dd938b></polyline></svg></div><div class="ed-doc-row__body" data-v-f9dd938b><h3 class="ed-doc-row__title" data-v-f9dd938b>${ssrInterpolate(file.file)}</h3><div class="ed-doc-row__meta" data-v-f9dd938b>`);
                if (fileType(file.file)) {
                  _push(`<span data-v-f9dd938b>${ssrInterpolate(fileType(file.file))}</span>`);
                } else {
                  _push(`<!---->`);
                }
                ...
                if (file.date) {
                  _push(`<span data-v-f9dd938b>${ssrInterpolate(formatDate(file.date))}</span>`);
                } else {
                  _push(`<!---->`);
                }
                if (expiryInfo(file)) {
                  _push(`<!--[--><span class="ed-doc-row__sep" data-v-f9dd938b>·</span><span class="${ssrRenderClass([`ed-doc-row__expiry--${expiryInfo(file).state}`, "ed-doc-row__expiry"])}" data-v-f9dd938b>${ssrInterpolate(expiryInfo(file).text)}</span><!--]-->`);
                } else {
                  _push(`<!---->`);
                }
                _push(`</div></div><button type="button" class="ed-doc-button" data-v-f9dd938b> Download </button></div>`);
            ...
            if (!unref(hasAnyFiles)) {
              _push(`<div class="ed-doc-list" data-v-f9dd938b><div class="ed-doc-empty" data-v-f9dd938b>`);
              if (unref(search)) {
                _push(`<!--[--> No documents match <strong data-v-f9dd938b>&quot;${ssrInterpolate(unref(search))}&quot;</strong>. <!--]-->`);
              } else {
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f9dd938b"]]);
export {
  _id_ as default
};
