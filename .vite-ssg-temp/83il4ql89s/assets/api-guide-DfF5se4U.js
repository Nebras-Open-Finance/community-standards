...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-ce0b6bd6><section class="ed-doc__hero" data-v-ce0b6bd6><div class="ed-doc__inner" data-v-ce0b6bd6><div class="ed-doc__eyebrow" data-v-ce0b6bd6><span class="ed-doc__eyebrow-dash" data-v-ce0b6bd6></span> TPP · Banking · Service Initiation · Variable Defined Schedule </div><h1 class="ed-doc__title" data-v-ce0b6bd6> Variable Defined Schedule — API Guide <span class="ed-doc__read" data-v-ce0b6bd6>5 min read</span></h1><p class="ed-doc__lede" data-v-ce0b6bd6> A Variable Defined Schedule consent authorises a TPP to initiate payments on a <strong data-v-ce0b6bd6>pre-agreed set of specific dates</strong>, each with its own <strong data-v-ce0b6bd6>maximum amount ceiling</strong>. Rather than a recurring period, the TPP supplies an explicit schedule at consent time — listing each <code data-v-ce0b6bd6>PaymentExecutionDate</code> alongside the maximum amount permitted on that date. The user authorises once, approving the full schedule, and the TPP submits one payment per scheduled date without requiring re-authorisation. </p><p class="ed-doc__lede" data-v-ce0b6bd6> Common use cases include milestone-based project billing, staged instalment plans, and seasonal payment programmes where both the dates and indicative amounts are known upfront but the final charge may vary per date. </p><p class="ed-doc__lede" data-v-ce0b6bd6> Variable Defined Schedule is the <strong data-v-ce0b6bd6>ceiling variant</strong> of <a href="../fixed-defined-schedule/api-guide" data-v-ce0b6bd6>Fixed Defined Schedule</a> — same schedule shape, but each entry carries a <code data-v-ce0b6bd6>MaximumIndividualAmount</code> rather than a locked <code data-v-ce0b6bd6>Amount</code>. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ce0b6bd6${_scopeId2}><strong data-v-ce0b6bd6${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-ce0b6bd6${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the <strong data-v-ce0b6bd6${_scopeId2}>BSIP role</strong> as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-ce0b6bd6${_scopeId2}>Roles</a>. </li><li data-v-ce0b6bd6${_scopeId2}><strong data-v-ce0b6bd6${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-ce0b6bd6${_scopeId2}>Transport Certificate</a></strong> — an active transport certificate must be issued and registered in the Trust Framework to establish secure <strong data-v-ce0b6bd6${_scopeId2}>mTLS communication</strong>. </li><li data-v-ce0b6bd6${_scopeId2}><strong data-v-ce0b6bd6${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-ce0b6bd6${_scopeId2}>Signing Certificate</a></strong> — an active signing certificate must be issued and registered in the Trust Framework. This certificate is used to sign request objects and client assertions. </li><li data-v-ce0b6bd6${_scopeId2}><strong data-v-ce0b6bd6${_scopeId2}>Registration with the relevant <a href="/tech/tpp-standards/registration/api-guide" data-v-ce0b6bd6${_scopeId2}>API Hub (Authorisation Server)</a></strong> — the application must be registered with the API Hub (Server) of the LFI with which you intend to initiate payments. </li><li data-v-ce0b6bd6${_scopeId2}><strong data-v-ce0b6bd6${_scopeId2}>Understanding of the <a href="/tech/tpp-standards/security/fapi/" data-v-ce0b6bd6${_scopeId2}>FAPI Security Profile</a></strong> and <strong data-v-ce0b6bd6${_scopeId2}><a href="/tech/tpp-standards/security/tokens/" data-v-ce0b6bd6${_scopeId2}>Tokens &amp; Assertions</a></strong> — you should understand how request object signing, client authentication, and access token validation underpin secure API interactions. </li><li data-v-ce0b6bd6${_scopeId2}><strong data-v-ce0b6bd6${_scopeId2}>Understanding of <a href="/tech/tpp-standards/security/fapi/message-encryption" data-v-ce0b6bd6${_scopeId2}>Message Encryption</a></strong> — PII (creditor name and account details) must be encrypted as a JWE before being embedded in the consent. You will need the LFI&#39;s public encryption key from their JWKS. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-ce0b6bd6${_scopeId}><span class="http-badge http-post" data-v-ce0b6bd6${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-ce0b6bd6${_scopeId}>/par</code></div>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` With the encrypted PII ready, construct the <code data-v-ce0b6bd6${_scopeId2}>authorization_details</code> of type <code data-v-ce0b6bd6${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.2</code>. Set <code data-v-ce0b6bd6${_scopeId2}>PeriodicSchedule.Type</code> to <code data-v-ce0b6bd6${_scopeId2}>&quot;VariableDefinedSchedule&quot;</code>. Unlike a Periodic Schedule, there is no recurring period — instead, the <code data-v-ce0b6bd6${_scopeId2}>Schedule</code> array lists each specific <code data-v-ce0b6bd6${_scopeId2}>PaymentExecutionDate</code> and the maximum amount permitted on that date. The TPP submits one <span class="endpoint" data-v-ce0b6bd6${_scopeId2}><span class="http-method http-method--post" data-v-ce0b6bd6${_scopeId2}>POST</span><code data-v-ce0b6bd6${_scopeId2}>/payments</code></span> per scheduled entry. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ce0b6bd6${_scopeId}>authorization_details</h3>`);
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-ce0b6bd6${_scopeId2}><thead data-v-ce0b6bd6${_scopeId2}><tr data-v-ce0b6bd6${_scopeId2}><th data-v-ce0b6bd6${_scopeId2}>Field</th><th data-v-ce0b6bd6${_scopeId2}>Type</th><th data-v-ce0b6bd6${_scopeId2}>Description</th><th data-v-ce0b6bd6${_scopeId2}>Example</th></tr></thead><tbody data-v-ce0b6bd6${_scopeId2}><tr data-v-ce0b6bd6${_scopeId2}><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>type</code>*</td><td data-v-ce0b6bd6${_scopeId2}>enum</td><td data-v-ce0b6bd6${_scopeId2}>Must be <code data-v-ce0b6bd6${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.2</code></td><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>urn:openfinanceuae:service-initiation-consent:v2.2</code></td></tr><tr data-v-ce0b6bd6${_scopeId2}><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>consent</code>*</td><td data-v-ce0b6bd6${_scopeId2}>object</td><td data-v-ce0b6bd6${_scopeId2}>Consent properties agreed by the User with the TPP. <em data-v-ce0b6bd6${_scopeId2}>Described below.</em></td><td data-v-ce0b6bd6${_scopeId2}>—</td></tr><tr data-v-ce0b6bd6${_scopeId2}><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>subscription</code></td><td data-v-ce0b6bd6${_scopeId2}>object</td><td data-v-ce0b6bd6${_scopeId2}>Optional subscription to Event Notifications via Webhook. <em data-v-ce0b6bd6${_scopeId2}>Described below.</em></td><td data-v-ce0b6bd6${_scopeId2}>—</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ce0b6bd6${_scopeId}>ControlParameters — Variable Defined Schedule</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-ce0b6bd6${_scopeId2}>ControlParameters.ConsentSchedule.MultiPayment</code> carries the control definition. Set <code data-v-ce0b6bd6${_scopeId2}>PeriodicSchedule.Type</code> to <code data-v-ce0b6bd6${_scopeId2}>&quot;VariableDefinedSchedule&quot;</code>. The <code data-v-ce0b6bd6${_scopeId2}>Schedule</code> array defines every execution date and its per-date amount ceiling — the TPP submits a payment on or around each date, and the actual amount must be ≤ the <code data-v-ce0b6bd6${_scopeId2}>MaximumIndividualAmount</code> for that entry. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-ce0b6bd6${_scopeId2}>Cumulative Control Parameters</strong> — apply across the entire consent lifetime: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-ce0b6bd6${_scopeId2}>Schedule Parameters</strong> — the explicit list of execution dates, set inside <code data-v-ce0b6bd6${_scopeId2}>PeriodicSchedule.Schedule</code>: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-ce0b6bd6${_scopeId2}><thead data-v-ce0b6bd6${_scopeId2}><tr data-v-ce0b6bd6${_scopeId2}><th data-v-ce0b6bd6${_scopeId2}>Field</th><th data-v-ce0b6bd6${_scopeId2}>Required</th><th data-v-ce0b6bd6${_scopeId2}>Description</th><th data-v-ce0b6bd6${_scopeId2}>Example</th></tr></thead><tbody data-v-ce0b6bd6${_scopeId2}><tr data-v-ce0b6bd6${_scopeId2}><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>PeriodicSchedule.Type</code></td><td data-v-ce0b6bd6${_scopeId2}>Yes</td><td data-v-ce0b6bd6${_scopeId2}>Must be <code data-v-ce0b6bd6${_scopeId2}>&quot;VariableDefinedSchedule&quot;</code></td><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>VariableDefinedSchedule</code></td></tr><tr data-v-ce0b6bd6${_scopeId2}><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>PeriodicSchedule.Schedule</code></td><td data-v-ce0b6bd6${_scopeId2}>Yes</td><td data-v-ce0b6bd6${_scopeId2}>Array of schedule entries. Must be non-empty.</td><td data-v-ce0b6bd6${_scopeId2}>—</td></tr><tr data-v-ce0b6bd6${_scopeId2}><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>PeriodicSchedule.Schedule[*].PaymentExecutionDate</code></td><td data-v-ce0b6bd6${_scopeId2}>Yes</td><td data-v-ce0b6bd6${_scopeId2}>The date on which the TPP intends to submit a payment. Must be unique within the schedule, today or in the future, and before <code data-v-ce0b6bd6${_scopeId2}>ExpirationDateTime</code>.</td><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>2026-08-01</code></td></tr><tr data-v-ce0b6bd6${_scopeId2}><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>PeriodicSchedule.Schedule[*].MaximumIndividualAmount.Amount</code></td><td data-v-ce0b6bd6${_scopeId2}>Yes</td><td data-v-ce0b6bd6${_scopeId2}>The maximum amount permitted for the payment on this date. Each <span class="endpoint" data-v-ce0b6bd6${_scopeId2}><span class="http-method http-method--post" data-v-ce0b6bd6${_scopeId2}>POST</span><code data-v-ce0b6bd6${_scopeId2}>/payments</code></span> call must be ≤ this value.</td><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>500.00</code></td></tr><tr data-v-ce0b6bd6${_scopeId2}><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>PeriodicSchedule.Schedule[*].MaximumIndividualAmount.Currency</code></td><td data-v-ce0b6bd6${_scopeId2}>Yes</td><td data-v-ce0b6bd6${_scopeId2}>ISO 4217 currency code</td><td data-v-ce0b6bd6${_scopeId2}><code data-v-ce0b6bd6${_scopeId2}>AED</code></td></tr></tbody></table>`);
                } else {
                  return [
                    createVNode("table", null, [
                      createVNode("thead", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ce0b6bd6${_scopeId2}> Each entry in the <code data-v-ce0b6bd6${_scopeId2}>Schedule</code> array corresponds to exactly one <span class="endpoint" data-v-ce0b6bd6${_scopeId2}><span class="http-method http-method--post" data-v-ce0b6bd6${_scopeId2}>POST</span><code data-v-ce0b6bd6${_scopeId2}>/payments</code></span> call. Once a payment has been submitted for a given <code data-v-ce0b6bd6${_scopeId2}>PaymentExecutionDate</code>, the LFI will reject further payments for that date. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-ce0b6bd6${_scopeId}>Example request</h3>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ce0b6bd6${_scopeId2}> Save <code data-v-ce0b6bd6${_scopeId2}>codeVerifier</code> in your server-side session or an <code data-v-ce0b6bd6${_scopeId2}>httpOnly</code> cookie — you will need it in <a href="#step-8-post-token-authorization-code" data-v-ce0b6bd6${_scopeId2}>Step 8</a> to exchange the authorization code for tokens. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/fapi/request-jwt" data-v-ce0b6bd6${_scopeId2}>Preparing the Request JWT</a> for the full JWT claim reference and PKCE helpers. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-ce0b6bd6${_scopeId2}>authorization_endpoint</code> is found in the LFI&#39;s <code data-v-ce0b6bd6${_scopeId2}>.well-known/openid-configuration</code> — not constructed from the issuer URL directly. `);
                } else {
                  return [
                    createTextVNode(" The "),
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-ce0b6bd6${_scopeId2}>The TPP name and purpose.</li><li data-v-ce0b6bd6${_scopeId2}>The full payment schedule — each date alongside its maximum amount ceiling.</li><li data-v-ce0b6bd6${_scopeId2}>Any lifetime cumulative caps.</li><li data-v-ce0b6bd6${_scopeId2}>The consent expiry date.</li>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ce0b6bd6${_scopeId2}> See <a href="./user-journeys" data-v-ce0b6bd6${_scopeId2}>User Experience</a> for screen mockups of the Variable Defined Schedule <strong data-v-ce0b6bd6${_scopeId2}>Consent</strong> and <strong data-v-ce0b6bd6${_scopeId2}>Authorization</strong> pages the user sees at the bank. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" See "),
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-ce0b6bd6${_scopeId}><span class="http-badge http-post" data-v-ce0b6bd6${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-ce0b6bd6${_scopeId}>/token</code></div>`);
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-ce0b6bd6${_scopeId}><span class="http-badge http-post" data-v-ce0b6bd6${_scopeId}>POST</span><code class="ed-doc__endpoint-path" data-v-ce0b6bd6${_scopeId}>/payments</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Include <code data-v-ce0b6bd6${_scopeId2}>x-fapi-interaction-id</code> and <code data-v-ce0b6bd6${_scopeId2}>x-idempotency-key</code>. If the customer is present at this point in the flow, also send <code data-v-ce0b6bd6${_scopeId2}>x-fapi-customer-ip-address</code>, <code data-v-ce0b6bd6${_scopeId2}>x-customer-user-agent</code> and <code data-v-ce0b6bd6${_scopeId2}>x-fapi-auth-date</code> if the customer has been authenticated. See <a href="/tech/tpp-standards/security/request-headers" data-v-ce0b6bd6${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Submit <strong data-v-ce0b6bd6${_scopeId2}>one payment per scheduled date</strong> under this consent. On or around each <code data-v-ce0b6bd6${_scopeId2}>PaymentExecutionDate</code>, call <span class="endpoint" data-v-ce0b6bd6${_scopeId2}><span class="http-method http-method--post" data-v-ce0b6bd6${_scopeId2}>POST</span><code data-v-ce0b6bd6${_scopeId2}>/payments</code></span> with the actual amount for that date — it must be ≤ the <code data-v-ce0b6bd6${_scopeId2}>MaximumIndividualAmount</code> defined for that entry. The API Hub will reject any payment that exceeds the per-date ceiling, duplicates a date already paid, or is submitted after the consent has expired. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ce0b6bd6${_scopeId2}> Unlike Single Instant Payment, multi-payment consents do not require <code data-v-ce0b6bd6${_scopeId2}>PaymentPurposeCode</code>, <code data-v-ce0b6bd6${_scopeId2}>DebtorReference</code>, <code data-v-ce0b6bd6${_scopeId2}>CreditorReference</code>, or <code data-v-ce0b6bd6${_scopeId2}>OpenFinanceBilling</code> to match the consent exactly. Only <code data-v-ce0b6bd6${_scopeId2}>ConsentId</code> must match the authorized consent. <code data-v-ce0b6bd6${_scopeId2}>Instruction.Amount</code> must be within the parameters the consent allows for this payment type. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ce0b6bd6${_scopeId2}> Each <code data-v-ce0b6bd6${_scopeId2}>PaymentExecutionDate</code> in the schedule may only be used for a single <span class="endpoint" data-v-ce0b6bd6${_scopeId2}><span class="http-method http-method--post" data-v-ce0b6bd6${_scopeId2}>POST</span><code data-v-ce0b6bd6${_scopeId2}>/payments</code></span> call. Submitting a second payment for the same date will be rejected, regardless of the amount. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ce0b6bd6${_scopeId2}> The API Hub will reject a payment if <code data-v-ce0b6bd6${_scopeId2}>Instruction.Amount</code> exceeds the <code data-v-ce0b6bd6${_scopeId2}>MaximumIndividualAmount</code> for the corresponding <code data-v-ce0b6bd6${_scopeId2}>PaymentExecutionDate</code>, if that date has already been paid, or if any lifetime cumulative cap has been reached. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-ce0b6bd6${_scopeId2}> After each successful payment, the consent remains in the <code data-v-ce0b6bd6${_scopeId2}>Authorized</code> state. You do <strong data-v-ce0b6bd6${_scopeId2}>not</strong> need to re-initiate the authorization flow between scheduled dates — use the token refresh flow to maintain a valid access token. </p>`);
                } else {
                  return [
                    createVNode("p", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/service-initiation/domestic-payments/multi-payments/variable-defined-schedule/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ce0b6bd6"]]);
export {
  apiGuide as default
};
