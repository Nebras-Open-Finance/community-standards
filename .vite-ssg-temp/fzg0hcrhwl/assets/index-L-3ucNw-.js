...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-77d028d1><section class="ed-doc__hero" data-v-77d028d1><div class="ed-doc__inner" data-v-77d028d1><div class="ed-doc__eyebrow" data-v-77d028d1><span class="ed-doc__eyebrow-dash" data-v-77d028d1></span> TPP · Trust Framework · Certificates </div><h1 class="ed-doc__title" data-v-77d028d1> Certificates with a SAN <span class="ed-doc__read" data-v-77d028d1>2 min read</span></h1><p class="ed-doc__lede" data-v-77d028d1> The Subject Alternative Name (SAN) extension is required on server-side certificates — specifically the transport certificates LFIs present at their API Hub endpoints. </p>`);
      _push(ssrRenderComponent(_component_EdNote, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-77d028d1${_scopeId}> The Subject Alternative Name (SAN) extension is required on <strong data-v-77d028d1${_scopeId}>server-side</strong> certificates — specifically the transport certificates LFIs present at their API Hub endpoints. TPPs generating client certificates (transport, signing, or encryption) do <strong data-v-77d028d1${_scopeId}>not</strong> add a SAN; they set the <code data-v-77d028d1${_scopeId}>CN</code> to their application&#39;s Client ID instead. See <a href="/tech/tpp-standards/trust-framework/certificates/" data-v-77d028d1${_scopeId}>Keys and Certificates</a> for client certificate requirements. </p>`);
          } else {
            return [
              createVNode("p", null, [
                ...
                createVNode("a", { href: "/tech/tpp-standards/trust-framework/certificates/" }, "Keys and Certificates"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` To include a SAN directly in the CSR without needing a separate config file, you can use the <code data-v-77d028d1${_scopeId2}>-addext</code> option: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` In this example, <code data-v-77d028d1${_scopeId2}>some.hostname.com</code> will appear in the SAN extension of the CSR. `);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-77d028d1${_scopeId2}><strong data-v-77d028d1${_scopeId2}>CN is deprecated</strong> — as of RFC 2818 and subsequent updates, browsers and certificate authorities have stopped using CN for hostname validation on server certificates.</li><li data-v-77d028d1${_scopeId2}><strong data-v-77d028d1${_scopeId2}>SAN is mandatory</strong> — the Subject Alternative Name is now the authoritative field for hostname checking.</li><li data-v-77d028d1${_scopeId2}><strong data-v-77d028d1${_scopeId2}>Multiple hostnames</strong> — SAN supports multiple DNS names (and IP addresses), whereas CN supports only one.</li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The <code data-v-77d028d1${_scopeId2}>-addext</code> option was introduced in OpenSSL 1.1.1 (released September 2018). If you are using OpenSSL 1.1.1 or later, you can add SANs inline as shown above. `);
                } else {
                  return [
                    createTextVNode(" The "),
                    createVNode("code", null, "-addext"),
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` On older versions of OpenSSL, you will need to use an external configuration file (<code data-v-77d028d1${_scopeId2}>openssl.cnf</code>) to include SANs. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/trust-framework/certificates-san/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-77d028d1"]]);
export {
  index as default
};
