...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-9d17fbac><section class="ed-doc__hero" data-v-9d17fbac><div class="ed-doc__inner" data-v-9d17fbac><div class="ed-doc__eyebrow" data-v-9d17fbac><span class="ed-doc__eyebrow-dash" data-v-9d17fbac></span> LFI · Consent Journey · Authentication · SCA </div><h1 class="ed-doc__title" data-v-9d17fbac> Strong Customer Authentication <span class="ed-doc__read" data-v-9d17fbac>4 min read</span></h1><p class="ed-doc__lede" data-v-9d17fbac> Strong Customer Authentication (SCA) is multi-factor authentication (MFA) that requires the end user to authenticate using at least two independent factors. SCA is a regulatory requirement under the CBUAE directive <em data-v-9d17fbac>Prevention of Fraud Incidents Impacting Consumers</em> (Notice No. 3057/2025) and applies to all Open Finance consent journeys. </p></div></section>`);
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`SCA requires at least <strong data-v-9d17fbac${_scopeId2}>two</strong> of the following three factors:`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-9d17fbac${_scopeId2}><thead data-v-9d17fbac${_scopeId2}><tr data-v-9d17fbac${_scopeId2}><th data-v-9d17fbac${_scopeId2}>Factor</th><th data-v-9d17fbac${_scopeId2}>Category</th><th data-v-9d17fbac${_scopeId2}>Examples</th></tr></thead><tbody data-v-9d17fbac${_scopeId2}><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}><strong data-v-9d17fbac${_scopeId2}>Possession</strong></td><td data-v-9d17fbac${_scopeId2}>Something you have</td><td data-v-9d17fbac${_scopeId2}>A bound mobile device, hardware token, SIM card</td></tr><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}><strong data-v-9d17fbac${_scopeId2}>Inherence</strong></td><td data-v-9d17fbac${_scopeId2}>Something you are</td><td data-v-9d17fbac${_scopeId2}>Fingerprint, facial recognition, voice recognition</td></tr><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}><strong data-v-9d17fbac${_scopeId2}>Knowledge</strong></td><td data-v-9d17fbac${_scopeId2}>Something you know</td><td data-v-9d17fbac${_scopeId2}>PIN, password, passphrase</td></tr></tbody></table>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`The following methods are <strong data-v-9d17fbac${_scopeId2}>prohibited</strong> in Open Finance consent journeys:`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-9d17fbac${_scopeId2}><thead data-v-9d17fbac${_scopeId2}><tr data-v-9d17fbac${_scopeId2}><th data-v-9d17fbac${_scopeId2}>Method</th><th data-v-9d17fbac${_scopeId2}>Status</th><th data-v-9d17fbac${_scopeId2}>Rationale</th></tr></thead><tbody data-v-9d17fbac${_scopeId2}><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}>SMS OTP (as standalone)</td><td data-v-9d17fbac${_scopeId2}><strong data-v-9d17fbac${_scopeId2}>MUST NOT</strong> be used</td><td data-v-9d17fbac${_scopeId2}>Prohibited by CBUAE directive as a standalone authentication method</td></tr><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}>Email OTP (as standalone)</td><td data-v-9d17fbac${_scopeId2}><strong data-v-9d17fbac${_scopeId2}>MUST NOT</strong> be used</td><td data-v-9d17fbac${_scopeId2}>Prohibited by CBUAE directive as a standalone authentication method</td></tr><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}>Static passcodes (as standalone)</td><td data-v-9d17fbac${_scopeId2}><strong data-v-9d17fbac${_scopeId2}>MUST NOT</strong> be used</td><td data-v-9d17fbac${_scopeId2}>Prohibited by CBUAE directive as a standalone authentication method</td></tr><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}>SMS OTP (as a factor in Open Finance MFA)</td><td data-v-9d17fbac${_scopeId2}><strong data-v-9d17fbac${_scopeId2}>MUST NOT</strong> be used</td><td data-v-9d17fbac${_scopeId2}>Open Finance authentication MUST NOT introduce methods that are more obstructive or weaker than the LFI&#39;s existing digital channels. If the LFI does not use SMS OTP in its own mobile banking authentication, it MUST NOT introduce it for Open Finance.</td></tr><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}>Email OTP (as a factor in Open Finance MFA)</td><td data-v-9d17fbac${_scopeId2}><strong data-v-9d17fbac${_scopeId2}>MUST NOT</strong> be used</td><td data-v-9d17fbac${_scopeId2}>Same rationale as above. These methods add friction and latency that degrade the customer experience below the standard of the LFI&#39;s own channels.</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
        ...
        _push2(ssrRenderComponent(_component_EdNote, { type: "warning" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p data-v-9d17fbac${_scopeId2}> LFIs MUST NOT introduce authentication factors into the Open Finance journey that are not used in their existing digital channels. Open Finance authentication MUST be equivalent to — not more burdensome than — the LFI&#39;s current authentication experience. </p>`);
            } else {
              return [
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h3 data-v-9d17fbac${_scopeId}>Data sharing consents</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For data sharing consents, a <strong data-v-9d17fbac${_scopeId2}>single MFA ceremony</strong> at the start of the consent journey is sufficient. No step-up authentication is required. `);
            } else {
              return [
        ...
        _push2(`<h3 id="step-up-authentication-for-payment-consents" data-v-9d17fbac${_scopeId}>Payment consents — step-up authentication</h3>`);
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For payment consents (single payments and multi-payment consents), the CBUAE directive requires <strong data-v-9d17fbac${_scopeId2}>step-up authentication</strong> for sensitive actions including the initiation of payments. This means an additional authentication gesture is required at the point the end user confirms the payment authorization. `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-9d17fbac${_scopeId2}><thead data-v-9d17fbac${_scopeId2}><tr data-v-9d17fbac${_scopeId2}><th data-v-9d17fbac${_scopeId2}>Touchpoint</th><th data-v-9d17fbac${_scopeId2}>Purpose</th><th data-v-9d17fbac${_scopeId2}>What happens</th></tr></thead><tbody data-v-9d17fbac${_scopeId2}><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}><strong data-v-9d17fbac${_scopeId2}>Initial authentication</strong></td><td data-v-9d17fbac${_scopeId2}>Establish the end user&#39;s identity</td><td data-v-9d17fbac${_scopeId2}>The end user opens the LFI app (or web page) and completes MFA — typically device possession + biometric or PIN. This is identical to how the end user would normally open their banking app.</td></tr><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}><strong data-v-9d17fbac${_scopeId2}>Payment confirmation</strong></td><td data-v-9d17fbac${_scopeId2}>Confirm intent for the specific payment</td><td data-v-9d17fbac${_scopeId2}>After reviewing the payment details, the end user confirms authorization with a <strong data-v-9d17fbac${_scopeId2}>native biometric gesture</strong> (e.g. Face ID, fingerprint). This is identical to how the end user would confirm a payment in their banking app.</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The table below maps specific clauses from CBUAE Notice No. 3057/2025 <em data-v-9d17fbac${_scopeId2}>Prevention of Fraud Incidents Impacting Consumers</em> to Open Finance requirements: `);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-9d17fbac${_scopeId2}><thead data-v-9d17fbac${_scopeId2}><tr data-v-9d17fbac${_scopeId2}><th style="${ssrRenderStyle({ "width": "3rem" })}" data-v-9d17fbac${_scopeId2}>#</th><th data-v-9d17fbac${_scopeId2}>CBUAE requirement</th><th data-v-9d17fbac${_scopeId2}>Open Finance alignment</th></tr></thead><tbody data-v-9d17fbac${_scopeId2}><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}>1</td><td data-v-9d17fbac${_scopeId2}>LFIs are prohibited from using weak authentication methods (SMS OTP, Email OTP, static passcodes) as standalone methods for any transaction, enrolment, provisioning, or channel access</td><td data-v-9d17fbac${_scopeId2}>All Open Finance consent journeys MUST use SCA with at least two independent factors. Weak methods are prohibited as standalone or as factors introduced specifically for Open Finance.</td></tr><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}>2</td><td data-v-9d17fbac${_scopeId2}>For 3D Secure transactions, LFIs must use strong authentication (in-app verification, soft tokens, biometrics)</td><td data-v-9d17fbac${_scopeId2}>Open Finance payment consent journeys MUST employ strong in-app or biometric verification for step-up authentication at the point of payment authorization.</td></tr><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}>3</td><td data-v-9d17fbac${_scopeId2}>For recurring logins from trusted devices, LFIs may use passcodes or device-native biometrics</td><td data-v-9d17fbac${_scopeId2}>For Open Finance authentication on a trusted (bound) device, LFIs may use device-native biometrics (inherence) alongside the trusted device (possession) to satisfy two-factor SCA.</td></tr><tr data-v-9d17fbac${_scopeId2}><td data-v-9d17fbac${_scopeId2}>4</td><td data-v-9d17fbac${_scopeId2}>LFIs must implement step-up authentication for sensitive actions including payment initiation</td><td data-v-9d17fbac${_scopeId2}>For payment consents, an additional biometric confirmation MUST be performed at the point the end user authorizes the consent. See <a href="#step-up-authentication-for-payment-consents" data-v-9d17fbac${_scopeId2}>step-up authentication</a> above.</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-9d17fbac${_scopeId2}>An audit trail linking the authentication to a specific consent</li><li data-v-9d17fbac${_scopeId2}>Foundations for fraud prevention and dispute resolution</li><li data-v-9d17fbac${_scopeId2}>Assurance to relying parties (API Hub) that authentication occurred</li>`);
            } else {
              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/consent-journey/authentication/sca.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const sca = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-9d17fbac"]]);
export {
  sca as default
};
