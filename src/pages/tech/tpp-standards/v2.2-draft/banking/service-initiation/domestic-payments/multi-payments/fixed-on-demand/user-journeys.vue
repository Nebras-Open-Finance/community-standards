    ...
    <section class="ed-doc__hero">
      <div class="ed-doc__inner">
        ...
        <p class="ed-doc__lede">
          Before a customer authorises a Fixed On Demand payment consent through Open Finance, you must
          present a <strong>Consent Page</strong> that clearly explains that you are seeking permission to
          make multiple payments of a fixed amount at any time of your choosing. This page must accurately
          reflect the key details of the consent (payee, the fixed amount per payment, the first payment
          date, etc.) The examples and interactive wireframes below define the expected structure, content,
          and behaviour of the Consent Page and must be followed.
        </p>
