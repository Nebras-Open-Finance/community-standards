...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-e7af322f>`);
      ...
      _push(ssrRenderComponent(_component_EdHero, {
        ...
        lede: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-tags" data-v-e7af322f${_scopeId}><!--[-->`);
            ssrRenderList(tags, (t) => {
              _push2(`<span class="ed-tag" data-v-e7af322f${_scopeId}>${ssrInterpolate(t)}</span>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-e7af322f${_scopeId}>Consent continuation</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`When a user&#39;s consent has <strong data-v-e7af322f${_scopeId2}>expired</strong> (i.e. the <code data-v-e7af322f${_scopeId2}>ExpirationDateTime</code> is in the past), but the user wishes to continue using the TPP&#39;s service, the TPP must create a new consent (with a new <code data-v-e7af322f${_scopeId2}>consentId</code>) for the same permissions.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`To maintain continuity, the TPP should set the <strong data-v-e7af322f${_scopeId2}>original <code data-v-e7af322f${_scopeId2}>ConsentId</code></strong> as the <code data-v-e7af322f${_scopeId2}>BaseConsentId</code> for the new consent.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-e7af322f${_scopeId2}>If the original consent already had a <code data-v-e7af322f${_scopeId2}>BaseConsentId</code>, the TPP <strong data-v-e7af322f${_scopeId2}>must reuse that same <code data-v-e7af322f${_scopeId2}>BaseConsentId</code></strong>, not the immediate prior <code data-v-e7af322f${_scopeId2}>ConsentId</code>. This ensures the entire chain of consents is consistently linked.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 data-v-e7af322f${_scopeId}>Consent re-establishment after revocation</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`If a user <strong data-v-e7af322f${_scopeId2}>revokes</strong> consent and later wants to re-establish access to the TPP&#39;s services, the TPP should create a new consent with the same permissions.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`As with consent continuation, the TPP should reference the original <code data-v-e7af322f${_scopeId2}>ConsentId</code> as the <code data-v-e7af322f${_scopeId2}>BaseConsentId</code> — or, if applicable, reuse the existing <code data-v-e7af322f${_scopeId2}>BaseConsentId</code> — to maintain the logical association.`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-e7af322f${_scopeId}>Consent update (permission expansion)</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Suppose a user originally grants consent with specific permissions (e.g. <code data-v-e7af322f${_scopeId2}>ReadAccountsBasic</code>, <code data-v-e7af322f${_scopeId2}>ReadAccountsDetail</code>, <code data-v-e7af322f${_scopeId2}>ReadBalances</code>), and the TPP later introduces new functionality (e.g. access to <code data-v-e7af322f${_scopeId2}>ReadDirectDebits</code>). If the user opts in to this expanded scope, the TPP should:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-e7af322f${_scopeId2}>Create a new consent with the updated set of permissions</li><li data-v-e7af322f${_scopeId2}>Revoke the old consent</li><li data-v-e7af322f${_scopeId2}>Link the new consent to the original one by referencing the appropriate <code data-v-e7af322f${_scopeId2}>BaseConsentId</code></li>`);
                } else {
                  return [
            ...
            _push2(`<h3 data-v-e7af322f${_scopeId}>User identity consistency</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`It is assumed that all consents linked via a <code data-v-e7af322f${_scopeId2}>BaseConsentId</code> are associated with the <strong data-v-e7af322f${_scopeId2}>same end user</strong>. Therefore, if during authentication the LFI determines that the <code data-v-e7af322f${_scopeId2}>userId</code> associated with a newly submitted consent <strong data-v-e7af322f${_scopeId2}>differs</strong> from the user who authorised the previous consent in the chain, the LFI <strong data-v-e7af322f${_scopeId2}>should reject</strong> the new consent.`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdRefTable, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<table data-v-e7af322f${_scopeId2}><thead data-v-e7af322f${_scopeId2}><tr data-v-e7af322f${_scopeId2}><th data-v-e7af322f${_scopeId2}>Scenario</th><th data-v-e7af322f${_scopeId2}>Action</th></tr></thead><tbody data-v-e7af322f${_scopeId2}><tr data-v-e7af322f${_scopeId2}><td data-v-e7af322f${_scopeId2}>Consent expired, user continues service</td><td data-v-e7af322f${_scopeId2}>Set original <code data-v-e7af322f${_scopeId2}>ConsentId</code> as <code data-v-e7af322f${_scopeId2}>BaseConsentId</code></td></tr><tr data-v-e7af322f${_scopeId2}><td data-v-e7af322f${_scopeId2}>Consent revoked, user re-establishes access</td><td data-v-e7af322f${_scopeId2}>Set original <code data-v-e7af322f${_scopeId2}>ConsentId</code> (or existing <code data-v-e7af322f${_scopeId2}>BaseConsentId</code>) as <code data-v-e7af322f${_scopeId2}>BaseConsentId</code></td></tr><tr data-v-e7af322f${_scopeId2}><td data-v-e7af322f${_scopeId2}>Permissions expanded</td><td data-v-e7af322f${_scopeId2}>Create new consent, revoke old, link via <code data-v-e7af322f${_scopeId2}>BaseConsentId</code></td></tr><tr data-v-e7af322f${_scopeId2}><td data-v-e7af322f${_scopeId2}>User identity mismatch detected</td><td data-v-e7af322f${_scopeId2}>LFI rejects the new consent</td></tr></tbody></table>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdNote, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-e7af322f${_scopeId2}>Always trace back to the <strong data-v-e7af322f${_scopeId2}>root</strong> <code data-v-e7af322f${_scopeId2}>ConsentId</code> when setting <code data-v-e7af322f${_scopeId2}>BaseConsentId</code>. Never use the most recent consent in a chain as the <code data-v-e7af322f${_scopeId2}>BaseConsentId</code> if it already has one — doing so would break the link back to the original consent.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
...
const baseConsentId = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e7af322f"]]);
export {
