...
import { W as WireframePreview, P as PolicySetup, _ as _sfc_main$1 } from "./UIBehaviour-Di3cuEQY.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-295091fc><section class="ed-doc__hero" data-v-295091fc><div class="ed-doc__inner" data-v-295091fc><div class="ed-doc__eyebrow" data-v-295091fc><span class="ed-doc__eyebrow-dash" data-v-295091fc></span> LFI · Insurance · Data Sharing · UX </div><h1 class="ed-doc__title" data-v-295091fc> Insurance Data Sharing — User Experience <span class="ed-doc__read" data-v-295091fc>2 min read</span></h1><p class="ed-doc__lede" data-v-295091fc> When a customer is redirected to you to authorize an Open Finance consent for Insurance Data Sharing, you must present an <strong data-v-295091fc>Authorization Page</strong> that clearly explains what they are authorizing. The page must collect the customer’s explicit and informed consent, and it must accurately reflect each insurance type and permission set requested. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-295091fc> Policies must be presented grouped by status — <strong data-v-295091fc>Active</strong> policies are selectable by default; policies in an end state (<code data-v-295091fc>Expired</code>, <code data-v-295091fc>Lapsed</code>, <code data-v-295091fc>Cancelled</code>, <code data-v-295091fc>Surrendered</code>, <code data-v-295091fc>Converted</code>, <code data-v-295091fc>DeathClaim</code>, <code data-v-295091fc>RiderClaim</code>) appear in a collapsible <strong data-v-295091fc>Inactive Policies</strong> group so the customer can see what is in scope but not select policies that can’t be shared. Statuses follow the <code data-v-295091fc>AEInsurancePolicyStatusCodes</code> enum defined in the Insurance OpenAPI spec. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-295091fc> The wireframe below is interactive: edit the consent body and the simulated policies, and watch the LFI screen filter to the insurance types the TPP requested and bucket them by status. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the <code data-v-295091fc${_scopeId2}>consentBody</code> below and watch the wireframes above update live. The LFI screen only shows policies whose <code data-v-295091fc${_scopeId2}>InsuranceType</code> appears in <code data-v-295091fc${_scopeId2}>Data.Permissions</code>, and groups them by status. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.1/insurance/data-sharing/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-295091fc"]]);
export {
