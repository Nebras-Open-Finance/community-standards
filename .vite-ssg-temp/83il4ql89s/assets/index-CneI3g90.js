...
import { _ as _sfc_main$1 } from "./APIFlowsAPIHubArchitecture-0HLhCYqj.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-ccb71c20><section class="ed-doc__hero" data-v-ccb71c20><div class="ed-doc__inner" data-v-ccb71c20><div class="ed-doc__eyebrow" data-v-ccb71c20><span class="ed-doc__eyebrow-dash" data-v-ccb71c20></span> LFI · API Hub · Overview </div><h1 class="ed-doc__title" data-v-ccb71c20> API Hub Overview <span class="ed-doc__read" data-v-ccb71c20>5 min read</span></h1><p class="ed-doc__lede" data-v-ccb71c20> The <strong data-v-ccb71c20>API Hub</strong> — powered by Ozone — is the central Open Finance gateway that connects Licensed Financial Institutions (LFIs) to the ecosystem. It acts as both the <strong data-v-ccb71c20>OIDC Authorization Server</strong> and the <strong data-v-ccb71c20>Open Finance Gateway</strong>, managing all incoming TPP traffic on your behalf. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-ccb71c20> As an LFI, you connect your Ozone Connect base URL and authorization endpoint to the Hub <strong data-v-ccb71c20>once</strong>. The Hub then handles TPP credential verification, security enforcement, request routing, and consent management. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-ccb71c20> All TPP traffic MUST flow through the API Hub — TPPs never call LFI Ozone Connect endpoints directly. </p></div></section>`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Each LFI&#39;s Hub instance is a <strong data-v-ccb71c20${_scopeId2}>dedicated isolated tenant</strong> — your consent store, audit logs, and configuration are on completely separate infrastructure from every other LFI in the ecosystem. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-ccb71c20${_scopeId2}><thead data-v-ccb71c20${_scopeId2}><tr data-v-ccb71c20${_scopeId2}><th data-v-ccb71c20${_scopeId2}>Responsibility</th><th data-v-ccb71c20${_scopeId2}>Detail</th></tr></thead><tbody data-v-ccb71c20${_scopeId2}><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>TPP credential verification</strong></td><td data-v-ccb71c20${_scopeId2}>Validates the TPP&#39;s certificate and software statement against the Trust Framework on every request</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>FAPI 2.0 security</strong></td><td data-v-ccb71c20${_scopeId2}>Enforces PAR, mTLS-bound access tokens, DPoP, and JWS message signing</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Consent lifecycle</strong></td><td data-v-ccb71c20${_scopeId2}>Stores and enforces all consent records — data sharing and payment consents. The API Hub is the <strong data-v-ccb71c20${_scopeId2}>single source of truth</strong> for all consent state</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Token issuance</strong></td><td data-v-ccb71c20${_scopeId2}>Issues all access tokens to TPPs after successful consent authorization. The API Hub is the sole token issuer — LFIs MUST NOT issue tokens to TPPs</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>API routing</strong></td><td data-v-ccb71c20${_scopeId2}>Routes inbound TPP requests to the correct Ozone Connect endpoint on your LFI, enriching each request with <code data-v-ccb71c20${_scopeId2}>customerId</code>, <code data-v-ccb71c20${_scopeId2}>accountIds</code>, and TPP information</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Participant discovery</strong></td><td data-v-ccb71c20${_scopeId2}>Publishes your <code data-v-ccb71c20${_scopeId2}>/.well-known/openid-configuration</code> so TPPs can discover your endpoints</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Error mapping</strong></td><td data-v-ccb71c20${_scopeId2}>Maps LFI error responses to the TPP-facing standard, normalizing response formats across the ecosystem</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Audit logging</strong></td><td data-v-ccb71c20${_scopeId2}>Maintains a tamper-evident log of all API interactions for regulatory purposes</td></tr></tbody></table>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-ccb71c20${_scopeId2}><thead data-v-ccb71c20${_scopeId2}><tr data-v-ccb71c20${_scopeId2}><th data-v-ccb71c20${_scopeId2}>Responsibility</th><th data-v-ccb71c20${_scopeId2}>Detail</th></tr></thead><tbody data-v-ccb71c20${_scopeId2}><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Ozone Connect endpoints</strong></td><td data-v-ccb71c20${_scopeId2}>Expose your banking APIs (accounts, payments, CoP, etc.) via Ozone Connect. The API Hub routes verified requests to these endpoints</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>End user authentication</strong></td><td data-v-ccb71c20${_scopeId2}>Authenticate the customer when they are redirected to your authorization endpoint during consent flows. The API Hub handles the OIDC authorization protocol; your system authenticates the person</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Business logic &amp; data retrieval</strong></td><td data-v-ccb71c20${_scopeId2}>Execute the requested operation — retrieve account data, initiate payments, check balances — and return the response per the LFI OpenAPI specification</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Fraud &amp; risk checks</strong></td><td data-v-ccb71c20${_scopeId2}>Apply your institution&#39;s fraud detection and risk assessment on incoming requests</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Consent authorization UX</strong></td><td data-v-ccb71c20${_scopeId2}>Present the consent details to the end user and capture their authorization decision via your application</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
  ...
  _push(ssrRenderComponent(_component_EdSectionBand, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h3 data-v-ccb71c20${_scopeId}>Consent authorization</h3>`);
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-ccb71c20${_scopeId2}>TPP initiates a consent request via <strong data-v-ccb71c20${_scopeId2}>Pushed Authorization Request (PAR)</strong> to the API Hub</li><li data-v-ccb71c20${_scopeId2}>API Hub creates and stores the consent record</li><li data-v-ccb71c20${_scopeId2}>End user is redirected to your <strong data-v-ccb71c20${_scopeId2}>authorization endpoint</strong></li><li data-v-ccb71c20${_scopeId2}>Your system <strong data-v-ccb71c20${_scopeId2}>authenticates the end user</strong> and presents the consent details for approval</li><li data-v-ccb71c20${_scopeId2}> Your system calls the API Hub (<a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doConfirm" data-v-ccb71c20${_scopeId2}><code data-v-ccb71c20${_scopeId2}>/doConfirm</code></a> or <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/open-api/auth-interactionId-doFail" data-v-ccb71c20${_scopeId2}><code data-v-ccb71c20${_scopeId2}>/doFail</code></a>) with the authorization result </li><li data-v-ccb71c20${_scopeId2}>API Hub issues an access token to the TPP</li>`);
            } else {
              return [
                createVNode("li", null, [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For full authorization server integration details, see <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/headless-heimdall/" data-v-ccb71c20${_scopeId2}>Headless Heimdall</a>. `);
            } else {
              return [
        ...
        _push2(`<h3 data-v-ccb71c20${_scopeId}>API request</h3>`);
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-ccb71c20${_scopeId2}>TPP sends an API request with its access token to the API Hub</li><li data-v-ccb71c20${_scopeId2}>API Hub validates the token and consent, enforces the OpenAPI schema, and enriches the request with customer and consent context</li><li data-v-ccb71c20${_scopeId2}>API Hub proxies the request to the corresponding <strong data-v-ccb71c20${_scopeId2}>Ozone Connect</strong> endpoint on your LFI</li><li data-v-ccb71c20${_scopeId2}>Your Ozone Connect endpoint executes the operation and returns the response per the LFI OpenAPI specification</li><li data-v-ccb71c20${_scopeId2}>API Hub normalizes the response and returns it to the TPP</li>`);
            } else {
              return [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` For request authentication details, see <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/application-layer-auth" data-v-ccb71c20${_scopeId2}>Application Layer Authentication</a>. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-ccb71c20${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/ozone-connect-url" data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Ozone Connect Base URL</strong></a> — your Ozone Connect base URL; the Hub forwards verified TPP requests here for accounts, payments, CoP, and other Open Finance APIs </li><li data-v-ccb71c20${_scopeId2}><a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/auth-endpoint" data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Authorization Endpoint</strong></a> — customers are redirected here to <strong data-v-ccb71c20${_scopeId2}>authenticate</strong> and authorize consent requests; this is where your institution verifies the end user&#39;s identity </li>`);
            } else {
              return [
                createVNode("li", null, [
                  createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/ozone-connect-url" }, [
                ...
                createVNode("li", null, [
                  createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/auth-endpoint" }, [
                    createVNode("strong", null, "Authorization Endpoint")
                  ]),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdRefTable, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<table data-v-ccb71c20${_scopeId2}><thead data-v-ccb71c20${_scopeId2}><tr data-v-ccb71c20${_scopeId2}><th data-v-ccb71c20${_scopeId2}>Environment</th><th data-v-ccb71c20${_scopeId2}>Trust Framework</th><th data-v-ccb71c20${_scopeId2}>Purpose</th></tr></thead><tbody data-v-ccb71c20${_scopeId2}><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Pre-production</strong></td><td data-v-ccb71c20${_scopeId2}>Sandbox</td><td data-v-ccb71c20${_scopeId2}>Register an application in the Sandbox Trust Framework and use it to act as a TPP against the pre-production Hub — complete consent journeys and call the APIs to verify your Ozone Connect implementation end-to-end</td></tr><tr data-v-ccb71c20${_scopeId2}><td data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Production</strong></td><td data-v-ccb71c20${_scopeId2}>Production</td><td data-v-ccb71c20${_scopeId2}>Live customer traffic</td></tr></tbody></table>`);
            } else {
              return [
                createVNode("table", null, [
                  createVNode("thead", null, [
        ...
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Both environments are structurally identical. The only differences are the mTLS certificates (issued from the production Trust Framework rather than Sandbox) and the environment-specific values for the Ozone Connect Base URL and Authorization Endpoint. See <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/onboarding/environment-specific/" data-v-ccb71c20${_scopeId2}>Environment Specific Configuration</a> for the full details. `);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_EdProse, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` The Hub provides an <a href="/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/" data-v-ccb71c20${_scopeId2}><strong data-v-ccb71c20${_scopeId2}>Admin Portal</strong></a> where your team can: `);
            } else {
              return [
                createTextVNode(" The Hub provides an "),
                createVNode("a", { href: "/tech/lfi-api-hub/v2.2-rc1/api-hub/admin-portal/" }, [
        ...
        _push2(ssrRenderComponent(_component_EdBullets, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li data-v-ccb71c20${_scopeId2}>Activate and manage TPP applications that have requested access to your APIs</li><li data-v-ccb71c20${_scopeId2}>View real-time and historical API traffic and audit logs</li><li data-v-ccb71c20${_scopeId2}>Manage your registered API resources and endpoint configuration</li><li data-v-ccb71c20${_scopeId2}>Monitor consent status across your customer base</li>`);
            } else {
              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/lfi-api-hub/v2.2-rc1/api-hub/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-ccb71c20"]]);
export {
  index as default
};
