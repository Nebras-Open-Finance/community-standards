...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-page" }, _attrs))} data-v-3a3c57b7>`);
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-3a3c57b7${_scopeId}>Out of scope</h3>`);
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-3a3c57b7${_scopeId2}>Sandbox or non-production environments</li><li data-v-3a3c57b7${_scopeId2}>Downtime caused by the API Hub, the TPP, or the broader internet</li><li data-v-3a3c57b7${_scopeId2}>Downtime caused by upstream payment rails (for example Aani) where the issue is demonstrably outside the LFI&#39;s control</li>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h3 data-v-3a3c57b7${_scopeId}>How unavailability is defined</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-3a3c57b7${_scopeId2}>Ozone Connect returns a <strong data-v-3a3c57b7${_scopeId2}>5xx response</strong></li><li data-v-3a3c57b7${_scopeId2}>The TLS connection cannot be established</li><li data-v-3a3c57b7${_scopeId2}>The response is not received within the API Hub&#39;s upstream timeout</li><li data-v-3a3c57b7${_scopeId2}>Ozone Connect rejects valid Hub traffic below the capacity the LFI has agreed to sustain</li>`);
                } else {
                  return [
                    createVNode("li", null, [
            ...
            _push2(ssrRenderComponent(_component_EdCallout, { color: "var(--at-gold)" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-3a3c57b7${_scopeId2}><strong data-v-3a3c57b7${_scopeId2}>Partial outages count.</strong> An outage affecting only <code data-v-3a3c57b7${_scopeId2}>POST /payments</code>, only one API family, or only a subset of TPPs is still an outage for the purposes of this policy.</p>`);
                } else {
                  return [
                    createVNode("p", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Before an LFI is signed off as compliant with this policy and approved to go live on the ecosystem, the LFI must complete a <strong data-v-3a3c57b7${_scopeId2}>live proving period</strong> with one or more TPPs.`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-3a3c57b7${_scopeId2}>During the proving period, the LFI operates its Ozone Connect endpoints against real TPP traffic in production</li><li data-v-3a3c57b7${_scopeId2}>The 99.5% availability target defined in this policy must be demonstrably met over the proving period</li><li data-v-3a3c57b7${_scopeId2}>Nebras reviews the results and confirms, or withholds, sign-off before the LFI is approved for general availability</li>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h3 data-v-3a3c57b7${_scopeId}>When the target is missed</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-3a3c57b7${_scopeId2}>A formal review meeting between Nebras and the LFI&#39;s engineering and operations leadership</li><li data-v-3a3c57b7${_scopeId2}>A written remediation plan, agreed with Nebras, setting out specific actions, owners, and target dates</li><li data-v-3a3c57b7${_scopeId2}>Enhanced reporting — typically weekly — until the LFI is consistently meeting the target</li><li data-v-3a3c57b7${_scopeId2}>Escalation to the relevant regulatory authority where non-compliance is persistent or where the interests of customers or TPPs require it</li>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-3a3c57b7${_scopeId}>Severity definitions</h3>`);
            _push2(ssrRenderComponent(_component_EdSeverityTable, { rows: severities }, null, _parent2, _scopeId));
            _push2(`<h3 data-v-3a3c57b7${_scopeId}>LFI obligations during an incident</h3>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-3a3c57b7${_scopeId3}>For <strong data-v-3a3c57b7${_scopeId3}>P1</strong> incidents, acknowledgement is expected within <strong data-v-3a3c57b7${_scopeId3}>15 minutes</strong> of the LFI becoming aware. For <strong data-v-3a3c57b7${_scopeId3}>P2</strong>, within <strong data-v-3a3c57b7${_scopeId3}>1 hour</strong>. For <strong data-v-3a3c57b7${_scopeId3}>P3</strong>, within the next business day.</p>`);
                      } else {
                        return [
                          createVNode("p", null, [
                            createTextVNode("For "),
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-3a3c57b7${_scopeId3}>Nebras operates a dedicated incident channel for each LFI. Incidents are not to be reported by email alone.</p>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-3a3c57b7${_scopeId3}>For <strong data-v-3a3c57b7${_scopeId3}>P1</strong>, updates at least every <strong data-v-3a3c57b7${_scopeId3}>30 minutes</strong> until service is restored. For <strong data-v-3a3c57b7${_scopeId3}>P2</strong>, at least every <strong data-v-3a3c57b7${_scopeId3}>2 hours</strong>.</p>`);
                      } else {
                        return [
                          createVNode("p", null, [
                            createTextVNode("For "),
                  ...
                  _push3(ssrRenderComponent(_component_EdStage, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-3a3c57b7${_scopeId3}>Only once service has been stable for a reasonable observation period (typically 15 minutes for P1, 30 minutes for P2).</p>`);
                      } else {
                        return [
            ...
            _push2(ssrRenderComponent(_component_EdCallout, { color: "var(--at-navy)" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-3a3c57b7${_scopeId2}>Nebras takes responsibility for cascading incident information to affected TPPs through its own communication channels. <strong data-v-3a3c57b7${_scopeId2}>LFIs are not expected to communicate directly with TPPs during incidents.</strong></p>`);
                } else {
                  return [
                    createVNode("p", null, [
            ...
            _push2(`<h3 data-v-3a3c57b7${_scopeId}>Post-incident review</h3>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`For every P1 incident — and for any P2 incident that recurs within 30 days — the LFI is expected to provide a post-incident review to Nebras within <strong data-v-3a3c57b7${_scopeId2}>five business days</strong> of resolution. The review should cover:`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-3a3c57b7${_scopeId2}>A factual timeline of the incident</li><li data-v-3a3c57b7${_scopeId2}>The root cause</li><li data-v-3a3c57b7${_scopeId2}>The customer and TPP impact</li><li data-v-3a3c57b7${_scopeId2}>The remediation already applied</li><li data-v-3a3c57b7${_scopeId2}>Any further actions the LFI will take to prevent recurrence, with owners and dates</li>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-3a3c57b7${_scopeId2}>Nebras and TPPs must be notified through the Nebras portal at least <strong data-v-3a3c57b7${_scopeId2}>72 hours in advance</strong></li><li data-v-3a3c57b7${_scopeId2}>The maintenance window must fall during a low-traffic period, typically between <strong data-v-3a3c57b7${_scopeId2}>02:00 and 05:00 Gulf Standard Time</strong></li><li data-v-3a3c57b7${_scopeId2}>The window must be kept as short as the change requires</li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-3a3c57b7${_scopeId2}>Track recurring causes of unavailability and address them at source</li><li data-v-3a3c57b7${_scopeId2}>Review monthly availability reports with their engineering and operations leadership</li><li data-v-3a3c57b7${_scopeId2}>Invest in the monitoring, alerting, and on-call capabilities required to detect and recover from incidents quickly</li><li data-v-3a3c57b7${_scopeId2}>Participate in ecosystem-wide reviews convened by Nebras to share practices and identify common causes of unavailability</li>`);
                } else {
                  return [
...
const ozoneConnectAvailability = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3a3c57b7"]]);
export {
