...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-1e9a576d><section class="ed-doc__hero" data-v-1e9a576d><div class="ed-doc__inner" data-v-1e9a576d><div class="ed-doc__eyebrow" data-v-1e9a576d><span class="ed-doc__eyebrow-dash" data-v-1e9a576d></span> Banking · Service Initiation · Variable Periodic Schedule · UX </div><h1 class="ed-doc__title" data-v-1e9a576d> Variable Periodic Schedule — User Experience <span class="ed-doc__read" data-v-1e9a576d>4 min read</span></h1><p class="ed-doc__lede" data-v-1e9a576d> Before a customer authorises a Variable Periodic Schedule payment consent through Open Finance, you must present a <strong data-v-1e9a576d>Consent Page</strong> that clearly explains that you are seeking permission to make recurring payments of varying amounts at a set frequency. This page must accurately reflect the key details of the consent (payee, the maximum amount per payment, payment frequency, etc.) The examples and interactive wireframes below define the expected structure, content, and behaviour of the Consent Page and must be followed. </p><p class="ed-doc__lede ed-doc__lede--tight" data-v-1e9a576d> While you may adapt visual elements such as colour palette, fonts, and styling, you must not alter the meaning, clarity, or completeness of the payment information shown, and the representation of <strong data-v-1e9a576d>AlTareq</strong> (including logos, naming, and action buttons) must be preserved. The customer must always be able to clearly understand what payment they are consenting to and that it is part of the AlTareq ecosystem. Your Consent Page must be submitted as part of <strong data-v-1e9a576d>CX certification</strong> prior to production, and any material changes to a production Consent Page must be re-submitted for review and approval. </p></div></section>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Customise the request body fields below and watch the <strong data-v-1e9a576d${_scopeId2}>Consent</strong> and <strong data-v-1e9a576d${_scopeId2}>Authorisation</strong> page previews update live. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.1/banking/service-initiation/domestic-payments/multi-payments/variable-periodic-schedule/user-journeys.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const userJourneys = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1e9a576d"]]);
export {
