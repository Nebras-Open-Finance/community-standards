...
const response = await fetch(\`\${API_BASE}/open-finance/atm/v2.2/atms\`, {
  method: 'GET',
  headers: {
...
response = httpx.get(
    f"{api_base}/open-finance/atm/v2.2/atms",
    headers={
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ed-doc" }, _attrs))} data-v-a7b49430><section class="ed-doc__hero" data-v-a7b49430><div class="ed-doc__inner" data-v-a7b49430><div class="ed-doc__eyebrow" data-v-a7b49430><span class="ed-doc__eyebrow-dash" data-v-a7b49430></span> TPP · Banking · ATMs </div><h1 class="ed-doc__title" data-v-a7b49430> ATMs — API Guide <span class="ed-doc__read" data-v-a7b49430>2 min read</span></h1><p class="ed-doc__lede" data-v-a7b49430> The ATM API exposes a single endpoint — <span class="endpoint" data-v-a7b49430><span class="http-method http-method--get" data-v-a7b49430>GET</span><code data-v-a7b49430>/atms</code></span> — that returns the details of all ATMs managed by the LFI. </p></div></section>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_EdBullets, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<li data-v-a7b49430${_scopeId2}><strong data-v-a7b49430${_scopeId2}>Registered <a href="/tech/tpp-standards/trust-framework/application" data-v-a7b49430${_scopeId2}>Application</a></strong> — the application must be created within the Trust Framework and assigned the <strong data-v-a7b49430${_scopeId2}>BDSP role</strong> as defined in <a href="/tech/tpp-standards/trust-framework/roles" data-v-a7b49430${_scopeId2}>Roles</a>. </li><li data-v-a7b49430${_scopeId2}><strong data-v-a7b49430${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-a7b49430${_scopeId2}>Transport Certificate</a></strong> — an active transport certificate must be issued and registered in the Trust Framework to establish secure <strong data-v-a7b49430${_scopeId2}>mTLS communication</strong> with the LFI. </li><li data-v-a7b49430${_scopeId2}><strong data-v-a7b49430${_scopeId2}>Valid <a href="/tech/tpp-standards/trust-framework/certificates" data-v-a7b49430${_scopeId2}>Signing Certificate</a></strong> — an active signing certificate must be issued and registered in the Trust Framework for client authentication. </li><li data-v-a7b49430${_scopeId2}><strong data-v-a7b49430${_scopeId2}>Understanding of <a href="/tech/tpp-standards/security/tokens/" data-v-a7b49430${_scopeId2}>Tokens &amp; Assertions</a></strong> — you should understand how client authentication works with <code data-v-a7b49430${_scopeId2}>private_key_jwt</code> before calling the token endpoint. </li>`);
                } else {
                  return [
                    createVNode("li", null, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` The ATM API uses the OAuth 2.0 <strong data-v-a7b49430${_scopeId2}>client credentials</strong> grant with <code data-v-a7b49430${_scopeId2}>scope=atm</code>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Use the <a href="/tech/tpp-standards/security/fapi/message-signing#signing-a-jwt" data-v-a7b49430${_scopeId2}><code data-v-a7b49430${_scopeId2}>signJWT()</code></a> helper to build a client assertion proving your application&#39;s identity: `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See <a href="/tech/tpp-standards/security/tokens/client-assertion" data-v-a7b49430${_scopeId2}>Client Assertion</a> for the full claims reference. `);
                } else {
                  return [
                    createTextVNode(" See "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` POST to the LFI&#39;s token endpoint with <code data-v-a7b49430${_scopeId2}>scope=atm</code>: `);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_component_EdSectionBand, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ed-doc__endpoint" data-v-a7b49430${_scopeId}><span class="http-badge http-get" data-v-a7b49430${_scopeId}>GET</span><code class="ed-doc__endpoint-path" data-v-a7b49430${_scopeId}>/atms</code></div>`);
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Call the endpoint with the access token. Include <code data-v-a7b49430${_scopeId2}>x-fapi-interaction-id</code> on every request. See <a href="/tech/tpp-standards/security/request-headers" data-v-a7b49430${_scopeId2}>Request Headers</a>. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-a7b49430${_scopeId2}>x-fapi-customer-ip-address</code> is <strong data-v-a7b49430${_scopeId2}>not</strong> required for ATMs — the data is static and public, so no customer is involved in the call. `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<code data-v-a7b49430${_scopeId2}>LFI_API_BASE</code> is the LFI&#39;s API Hub resource server — <code data-v-a7b49430${_scopeId2}>https://rs1.&lt;lfiCode&gt;.apihub.openfinance.ae</code> (production) or <code data-v-a7b49430${_scopeId2}>https://rs1.&lt;lfiCode&gt;.sandbox.apihub.openfinance.ae</code> (sandbox). Resolve the <code data-v-a7b49430${_scopeId2}>&lt;lfiCode&gt;</code> from the <a href="/tech/tpp-standards/trust-framework/api-discovery" data-v-a7b49430${_scopeId2}>Trust Framework Directory</a>. See <a href="/tech/tpp-standards/trust-framework/api-resources" data-v-a7b49430${_scopeId2}>API Resources</a> for the full endpoint format. `);
                } else {
                  return [
            ...
            _push2(`<h3 class="ed-doc__subhead" data-v-a7b49430${_scopeId}>Response structure</h3>`);
            ...
            _push2(ssrRenderComponent(_component_EdProse, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` See the <a href="./open-api/atms" data-v-a7b49430${_scopeId2}>GET /atms</a> API reference for the full response schema. `);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/atms/api-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const apiGuide = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a7b49430"]]);
export {
  apiGuide as default
};
