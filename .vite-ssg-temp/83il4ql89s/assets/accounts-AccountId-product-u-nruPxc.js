...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_EndpointPage, mergeProps({
    eyebrow: "TPP · Banking · Data Sharing",
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_RedocWrapper, {
          ...
          filterPath: "/accounts/{AccountId}/product"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/tech/tpp-standards/v2.2-rc1/banking/data-sharing/open-api/accounts-AccountId-product.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const accountsAccountIdProduct = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  accountsAccountIdProduct as default
};
